...
<%@ page import="gsan.gui.portal.caer.ConsultarTabelaServicosPortalCaerHelper" isELIgnored="false"%>
								...
								<tr>
									...
									<table summary="Tabela de contas">
										<logic:notEmpty name="colecaoServicoTipoHelper" scope="request">
											...
											<tbody>
												<logic:iterate name="colecaoServicoTipoHelper" type="ConsultarTabelaServicosPortalCaerHelper" 
													id="helper">
													 <%cont = cont + 1;
													if (cont % 2 == 0) {%>
