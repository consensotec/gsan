...
<%@ page import="gsan.cadastro.imovel.bean.ConsultarImovelRegistroAtendimentoHelper" %>
	...
	<head>
		...
		<style type="text/css">
			.serv-int table tbody tr.tr-21 {
				background:url(/gsan/imagens/portal/caer/general/tr2-1.png) no-repeat 0 0 transparent;			
			}
			.serv-int table tbody tr.tr-22 {
				background:url(/gsan/imagens/portal/caer/general/tr2-2.png) no-repeat 0 0 transparent;				
			}
		</style>
