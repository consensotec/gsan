...
<html:html>
	<head>
		...
		<script type="text/javascript">
			...
			function validateValidarCertidaoNegativaDebitoPortalCaemaActionForm(form) {                                                                   
				if (bCancel) 
			    	return true; 
			   	else 
			...
			function validarForm(form){
				...
				if(validateValidarCertidaoNegativaDebitoPortalCaemaActionForm(form)){
		...
		<div id="container">
			...
			<div id="content">
				...
				<div id="validar-certidao" class="serv-int">
	            	...
	            	<html:form action="/validarCertidaoNegativaDebitoPortalCaemaAction.do"
						name="ValidarCertidaoNegativaDebitoPortalCaemaActionForm"
						type="gsan.gui.portal.caema.ValidarCertidaoNegativaDebitoPortalCaemaActionForm" 
						method="post"
						onsubmit="return validateValidarCertidaoNegativaDebitoPortalCaemaActionForm(this);">
