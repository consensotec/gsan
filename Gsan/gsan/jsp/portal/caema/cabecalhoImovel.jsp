	...
	<body>
		...
		<logic:present scope="request" name="voltarServicos">
			<div id="seg-via-conta" class="serv-int" style="margin: 0px;">
				<a href="exibirServicosPortalCaemaAction.do?method=voltarServico" title="Voltar e selecionar outro serviço" class="btn-voltar-servicos">
			    	<img src="/gsan/imagens/portal/caema/general/btn-voltar-servicos.gif" alt="Voltar e selecionar outro serviço" />
			    </a>
			</div>
		</logic:present>
	</body>
