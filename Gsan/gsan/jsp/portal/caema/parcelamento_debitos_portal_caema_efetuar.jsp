...
<%@ page import="gsan.cobranca.bean.ContaValoresHelper" isELIgnored="false"%>
<%@ page import="gsan.cobranca.bean.GuiaPagamentoValoresHelper" isELIgnored="false"%>
			...
			<div id="content">
				...
				<div id="parc-debito" class="serv-int">
	            	...
	            	<html:form action="/efetuarParcelamentoDebitosPortalCaemaAction.do"
						...
						type="gsan.gui.portal.caema.EfetuarParcelamentoDebitosPortalCaemaAction" method="post">
									...
									<tr>
										...
										<table summary="Tabela de contas">
											...
											<logic:notEmpty name="colecaoContaValores" scope="session">
												<%if (((Collection<gsan.cobranca.bean.ContaValoresHelper>) session.getAttribute("colecaoContaValores")).size() 
