		...
		<script type="text/javascript">
			...
			function validarForm(){
				...
				if (!($('[name=telefoneContato]').val().length >= 13  && $('[name=telefoneContato]').val().length <= 14) ){
					...
					msg += ' - Telefone para contado deve conter entre 9 e 11 dígitos. EX:(XX) XXXX-XXXX.';
				}
			...
			function carregarEspecificacao(){
				if (parseInt($('[name=solicitacaoTipo] option:selected').val()) > 0){
					redirecionarSubmit('exibirInserirSolicitacaoServicosPortalCaemaAction.do');
				}
			}
		...
		<div id="container">
			...
			<div id="content">
				...
				<div id="solicitacao-serv" class="serv-int">
	            	...
	            	<html:form action="/inserirSolicitacaoServicosPortalCaemaAction.do"
						name="InserirSolicitacaoServicosPortalCaemaActionForm"
						type="gsan.gui.portal.caema.InserirSolicitacaoServicosPortalCaemaActionForm" method="post"
