		        	...
		        	<div id="teleatend" class="serv-int" style="width:890px;">	
							...
							<div>                  
				               <em>Teleatendimento (Call Center) 0800-7010-195</em>             
								...
								Serviço de atendimento ao cliente. Reclamações de falta d'água, solicitação de serviços, consertos de ramal e atualização cadastral.
				                	<em>0800 7010 195</em>
								<br />
								<br />
								</p>
								...
								<div id="atualizacao" style="background-image: url(/gsan/imagens/portal/caema/general/ultima_atualizacao.png);background-repeat: no-repeat;">
									<span style="position: absolute; padding-top: 7px;"> Última atualização (segunda, 19 de Janeiro de 2012)</span>
								</div>
