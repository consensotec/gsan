	...
	<body>
		<div id="container">
	        ...
	        <div id="content">
	        	<div id="text-top" style="text-align:justify;">
					A Loja Virtual &eacute; um ambiente onde se encontram dispon&iacute;veis os servi&ccedil;os da Companhia de Saneamento Ambiental do Maranh&atilde;o. A CAEMA, objetivando facilitar cada vez mais o acesso do cliente aos seus produtos e servi&ccedil;os, criou esta loja para assegurar mais rapidez, seguran&ccedil;a e transpar&ecirc;ncia nos processos e fornecimento de informa&ccedil;&otilde;es.	        	
	            </div>
	            <div id="info-index" class="box">
	            	<a href="exibirInformacoesPortalCaemaAction.do" title="Informações | Tire suas dúvidas e entenda sua conta">
	                    <span id="text-box" style="text-align:justify;">
	                    	Este acesso permitir&aacute; esclarecimentos sobre diversos servi&ccedil;os que a CAEMA oferece aos seus clientes. Para conhecer estes serviços ou tirar suas dúvidas clique no link informa&ccedil;&otilde;es.
	                    </span>
	                </a>
	            </div>
	            <div id="servicos-index" class="box">
				    ...
				    <html:form styleId="form-matricula" action="/exibirServicosPortalCaemaAction.do?method=servicos" method="post" 
						name="ExibirServicosPortalCaemaActionForm" type="gsan.gui.portal.ExibirServicosPortalCaemaActionForm" >
	                    <fieldset>
	    ...
	    <logic:present name="solicitarCpfCnpj" scope="request">
		    <div id="solicitarCpfCnpj" style="display:none; cursor: default;">
		    	...
		    	<html:form styleId="form-matricula" style="padding: 8px 0 0 0px; width: 100%;" action="/exibirServicosPortalCaemaAction.do?method=servicos&vcpf=true" method="post" 
					name="ExibirServicosPortalCaemaActionForm" type="gsan.gui.portal.caema.ExibirServicosPortalCaemaActionForm" >
                    <fieldset>
                        ...
                        <logic:present name="cpfCnpjNaoCadastrado" scope="request">
							<span style="display: block; background: url('/gsan/imagens/portal/caema/forms/cpf_cnpj_nao_cadastrado.png') no-repeat scroll 0pt 0pt transparent; width: 180px; margin-right: -12px;" id="cpfCnpjError"></span>
							<script>
