	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#btnPesquisar').click(function(){
				$('form')
						.attr('action', 'exibirServicosPortalCaemaAction.do?method=declaracaoAnual')
						.submit();
			});
		});
	</script>	
	...
	<div id="container">
		...
		<div id="content">
			...
			<div id="seg-via-conta" class="serv-int">
				<html:form 	action="/emitirSegundaViaContaPortalCaemaAction.do?method=emitirSegundaVia" method="post" style="width:100%;">
					<html:hidden property="matricula" value="${ExibirServicosPortalCaemaActionForm.matricula}" />
					<html:hidden property="nomeUsuario" value="${ExibirServicosPortalCaemaActionForm.nomeUsuario}" />
					...
					<ul id="desc-debito">
						<li>
							...
							${EmitirSegundaViaContaPortalCaemaActionForm.valorDebito} <span style="width:2px;float:none;padding:0;">|</span>
						</li>
						<li>
							<em>Data:</em> ${EmitirSegundaViaContaPortalCaemaActionForm.data} <span style="width:2px;float:none;padding:0;">|</span>
						</li>
						<li>
							<em>Valor do Débito a Cobrar: R$</em>
							${EmitirSegundaViaContaPortalCaemaActionForm.valorDebitoCobrado}
						</li>
					</ul>
					...
					<table summary="Tabela de contas" style="font-size:12px;">
						<thead>
							<tr>
								...
								<th width="205">Data de Vencimento</th>
								<th width="125">Valor (R$)</th>
								<th width="117">Imprimir</th>
								<th width="150">Pagar agora</th>
							</tr>
						</thead>
						<tbody>
							<%! int i = 3;%>
							<logic:iterate name="colecaoContasValores" id="contaValoresHelper" type="ContaValoresHelper">
								<tr id="tr-<%=(i%2) + 1%>-2">
									...
									<td><bean:write name="contaValoresHelper" property="vencimentoFormatado" /></td>
									...
									<td>
										<a href="javascript:abrirPopup('gerarRelatorio2ViaContaAction.do?cobrarTaxaEmissaoConta=N&idConta='+<%="" + contaValoresHelper.getConta().getId()%>, 400, 800);" 
											...
											<img src="imagens/portal/caema/icons/print.gif" alt="Imprimir Fatura" />
										</a>
									</td>	
										...
										<div>
											...
											<ul class="box-banco">
												<li><a href="javascript:abrirPopup('enviarDadosBancosAction.do?banco=BancoBrasil&idConta=<%="" + contaValoresHelper.getConta().getId()%>', 800, 600);" 
														...
														<img src="imagens/portal/caema/general/banco-brasil.gif" alt="Banco do Brasil" />
													</a>
												</li>
												<li><a href="javascript:window.open('http://www.bancoreal.com.br','mywindow','width=700,height=700,toolbar=yes,
														...
														<img src="imagens/portal/caema/general/banco-santander.gif" alt="Banco Santander" />
													</a>
												</li>
												<li><a href="javascript:
														...
														resizable=yes');window.close();" 
														title="Bradesco">
														<img src="imagens/portal/caema/general/banco-bradesco.gif" alt="Bradesco" />
												</a>
												</li>
												<li><a href="javascript:window.open('http://www.caixa.gov.br','mywindow','width=700,height=700,toolbar=yes,
														...
														<img src="imagens/portal/caema/general/banco-caixa.gif" alt="Caixa Econômica Federal" />
													</a>
												</li>
												<li class="close"><img
