...
<%@ page import="gsan.gui.portal.caema.LojaAtendimentoCaemaHelper"%>
	...
	<head>
		...
		<style type="text/css">
			...
			#lista-informacoes li {
				background: url("/gsan/imagens/portal/caema/general/arrow-link.gif") no-repeat;
				float: left;
				height: 39px;
				margin-bottom: 5px;
				position: relative;
			...
			#lista-informacoes li.localSelecionado {
				background: url("/gsan/imagens/portal/caema/general/arrow-link-hover.gif") no-repeat;
			}
		...
		<div id="container">
	        ...
	        <div id="content">
				...
				<div class="serv-int" style="width:880px;">
					...
					<p>&nbsp;</p>
					<p class="paragrafo">
						A CAEMA mantem Lojas de Atendimento em vários pontos da cidade, onde o cliente poderá fazer solicitações, 
						reclamações e verificar o andamento de sua solicitação.
					</p>
					<p>&nbsp;</p>
					...
					<ul style="width:100%;margin-top:25px;">
						<li style="width:100%;float:left;">
							<div class="box">
								<b>Horário das lojas de atendimento das gerências da superintendência 
								metropolitana e nas lojas de atendimento da gerência de Imperatriz 
								e lojas do Viva Cidadão:</b>
								<br /><br />
								De Segunda a Sexta-feira: 07:30 às 18:30 horas (ininterrupto)
								<br /><br />
								<b>Nas demais lojas (outras do Interior):</b>
								<br /><br />
								De Segunda a Sexta-feira: 08:00 às 12:00 horas  e das 14:00 às 18:00 horas
	        		...
	        		<ul id="lista-informacoes">
		        		<li class="link">
		            		<a href="exibirLojasAtendimentoPresencialPortalCaemaAction.do?local=regiaoMetropolitana" class="regiaoMetropolitana">
								<span>Região metropolitana de São Luis</span>
							</a>
		                </li>
		        		<li class="link">
		            		<a href="exibirLojasAtendimentoPresencialPortalCaemaAction.do?local=interior" class="interior">
		        	...
		        	<div id="solicitacao-serv">
			        	...
			        	<html:form action="/exibirLojasAtendimentoPresencialPortalCaemaAction.do"
								name="ExibirLojasAtendimentoPresencialPortalCaemaActionForm"
								type="gsan.gui.portal.caema.ExibirLojasAtendimentoPresencialPortalCaemaActionForm" method="post" >
			        	...
			        	<div id="details">
		        			<div id="lojas" style="width: 370px; float: left; margin-left: 2px; margin-top: 16px; min-height:370px;">
		        				<ul id="lista-informacoes">
		        					<logic:present name="colecaoLojas">
			        					<logic:iterate name="colecaoLojas" id="loja" scope="request" type="LojaAtendimentoCaemaHelper">
				        					<li class="lista-loja">
		        			...
		        			<div class="detshow" style="background: url(/gsan/imagens/portal/caema/general/info-servico-top.gif) no-repeat 0 0 #f5f6f6; width: 470px; float: left; margin-left: 2px; margin-top: 16px; min-height:370px;">
		        				<div id="content-detalhe"></div> 
	        				</div>
        					<span class="detshow" style="background: url(/gsan/imagens/portal/caema/general/info-servico-bottom.gif) no-repeat scroll 0 0 transparent; float: left; height: 10px; width: 470px; margin-left:375px; ">&nbsp;</span>
		        		</div>
		        	</div>
	        	</div>
	       </div>
