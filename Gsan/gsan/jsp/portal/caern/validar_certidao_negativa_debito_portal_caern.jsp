...
<html:html>
	<head>
		...
		<script type="text/javascript">
			...
			function validateValidarCertidaoNegativaDebitoPortalCaernActionForm(form) {                                                                   
				if (bCancel) 
			    	return true; 
			   	else 
			...
			function validarRequerido(form){
				...
				if (msg.length > 0){
					$.blockUI({
						message : '<img alt="Aviso" src="imagens/portal/caern/icons/warning.png" alt="Aviso" style="float: left; padding-right:15px; margin-top: 10px;">'
			...
			function validarForm(form){
				...
				if(validateValidarCertidaoNegativaDebitoPortalCaernActionForm(form)){
		...
		<div id="container">
			...
			<div id="content">
				...
				<div id="validar-certidao" class="serv-int">
	            	...
	            	<html:form action="/validarCertidaoNegativaDebitoPortalCaernAction.do"
						name="ValidarCertidaoNegativaDebitoPortalCaernActionForm"
						type="gsan.gui.portal.caern.ValidarCertidaoNegativaDebitoPortalCaernActionForm" 
						method="post"
						onsubmit="return validateValidarCertidaoNegativaDebitoPortalCaernActionForm(this);">
