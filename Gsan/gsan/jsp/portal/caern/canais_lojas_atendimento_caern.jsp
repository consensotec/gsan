...
<%@ page import="gsan.gui.portal.caern.LojaAtendimentoCaernHelper"%>
	...
	<head>
		...
		<style type="text/css">
			...
			#lista-informacoes li {
				background: url("/gsan/imagens/portal/caern/general/arrow-link.gif") no-repeat;
				float: left;
				height: 39px;
				margin-bottom: 5px;
				position: relative;
			...
			#lista-informacoes li.localSelecionado {
				background: url("/gsan/imagens/portal/caern/general/arrow-link-hover.gif") no-repeat;
			}
	        ...
	        <div id="content">
				...
				<div class="serv-int" style="width:880px;">
		        	...
		        	<div style="width:100%;margin-bottom:35px;">
						...
						<a href="http://get.adobe.com/br/reader/" title="Faça o download do Adobe Reader" class="adobe-reader" target="_blank"><img src="/gsan/imagens/portal/caern/general/adobe-reader.gif" alt="Download do Adobe Reader" /></a>
					...
					<p>&nbsp;</p>
					<p class="paragrafo">
						A CAERN mantem Lojas de Atendimento em vários pontos da cidade, onde o cliente poderá fazer solicitações, 
	        		...
	        		<ul id="lista-informacoes">
		        		<li class="link">
		            		<a href="exibirLojasAtendimentoPresencialPortalCaernAction.do?local=regiaoMetropolitana" class="regiaoMetropolitana">
								<span>Região metropolitana de Natal</span>
							</a>
		                </li>
		        		<li class="link">
		            		<a href="exibirLojasAtendimentoPresencialPortalCaernAction.do?local=interior" class="interior">
		        	...
		        	<div id="solicitacao-serv">
			        	...
			        	<html:form action="/exibirLojasAtendimentoPresencialPortalCaernAction.do"
								name="ExibirLojasAtendimentoPresencialPortalCaernActionForm"
								type="gsan.gui.portal.caern.ExibirLojasAtendimentoPresencialPortalCaernActionForm" method="post" >
			        	...
			        	<div id="details">
		        			<div id="lojas" style="width: 370px; float: left; margin-left: 2px; margin-top: 16px; min-height:370px;">
		        				<ul id="lista-informacoes">
		        					<logic:present name="colecaoLojas">
			        					<logic:iterate name="colecaoLojas" id="loja" scope="request" type="LojaAtendimentoCaernHelper">
				        					<li class="lista-loja">
		        			...
		        			<div class="detshow" style="background: url(/gsan/imagens/portal/caern/general/info-servico-top.gif) no-repeat 0 0 #f5f6f6; width: 470px; float: left; margin-left: 2px; margin-top: 16px; min-height:370px;">
		        				<div id="content-detalhe"></div> 
	        				</div>
        					<span class="detshow" style="background: url(/gsan/imagens/portal/caern/general/info-servico-bottom.gif) no-repeat scroll 0 0 transparent; float: left; height: 10px; width: 470px; margin-left:375px; ">&nbsp;</span>
		        		</div>
		        	</div>
	        	</div>
	       </div>
