		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$('#btnPesquisar').click(function(){
					...
					$('form')
						.attr('action', 'exibirServicosPortalCaernAction.do?method=declaracaoAnual')
						.submit();
				});
		...
		<div id="container">
			...
			<div id="content">
				...
				<div class="serv-int" id="seg-via-declaracao">
	            	...
	            	<html:form action="/emitir2viaDeclaracaoAnualQuitacaoDebitosAction.do?origem=portal&lojaVirtual=S" name="Emitir2viaDeclaracaoAnualQuitacaoDebitosActionForm"
	type="gsan.gui.faturamento.Emitir2viaDeclaracaoAnualQuitacaoDebitosActionForm" method="post">
						<html:text property="matriculaImovel" style="display:none;" value="${ExibirServicosPortalCaernActionForm.matricula}" />
	                	<fieldset>
