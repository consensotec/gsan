...
<html:html>
		...
		<div id="container">
			...
			<div id="content">
				...
				<div class="serv-int" id="vencimento-alt">
	            	...
	            	<html:form  action="/inserirDiaVencimentoAlternativoAction.do?lojaVirtual=S" 
	            				name="InformarVencimentoAlternativoActionForm"
								type="gsan.gui.faturamento.conta.InformarVencimentoAlternativoActionForm" method="post">
	...
	<logic:present name="VencimentoAlteradoComSucesso" scope="request">
		<div id="VencimentoAlteradoComSucesso" style="display:none; cursor: default;"> 
	        <img alt="Aviso" src="imagens/portal/caern/icons/warning.png" alt="Aviso" style="float: left; margin-top: 3px;">
	        <h3 style="text-align:center; padding-top:10px; padding-bottom: 10px;">
