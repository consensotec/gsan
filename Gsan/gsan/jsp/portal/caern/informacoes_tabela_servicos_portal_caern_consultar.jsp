...
<%@ page import="gsan.gui.portal.caern.ConsultarTabelaServicosPortalCaernHelper" isELIgnored="false"%>
			...
			<div id="content">
				...
				<div id="parc-debito" class="serv-int">
	            	...
	            	<form>
						...
						<div id="consumidoresMedidos" class="subTopicos" style="height: 300px; width: 660px; overflow: auto;">
							
							<!-- Início da estrutura tabelas de serviços -->
								...
								<tr>
									...
									<table summary="Tabela de contas">
										<logic:notEmpty name="colecaoServicoTipoHelper" scope="request">
											...
											<tbody>
												<logic:iterate name="colecaoServicoTipoHelper" type="ConsultarTabelaServicosPortalCaernHelper" 
													id="helper">
													 <%cont = cont + 1;
													if (cont % 2 == 0) {%>
