				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF" border="0">
						<tr bordercolor="#000000">
							<td width="68" bgcolor="#90c7fc" align="center"><strong><a
							...
							<td width="330" bgcolor="#90c7fc" align="center"><strong>Descri&ccedil;&atilde;o</strong></td>
							<td width="325" bgcolor="#90c7fc" align="center"><strong>Distrito Operacional</strong></td>
						</tr>
					</table>
					</td>
				</tr>
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF">
						<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
							...
							<pg:param name="pg" />
							<pg:param name="q" />
							<logic:present name="colecaoZonaPressao">
								<%int cont = 0;%>
								<logic:iterate name="colecaoZonaPressao" id="zonaPressao"
									scope="request">
									<pg:item>
										<%cont = cont + 1;
			if (cont % 2 == 0) {%>
										...
										<tr bgcolor="#FFFFFF">
											...
											<div align="center"><input type="checkbox"
												name="idRegistrosRemocao" value="${zonaPressao.id}"></div>
											</td>
											
											<td width="12%" align="center">${zonaPressao.id}</td>
											<td width="27%" align="center"><html:link
												page="/exibirAtualizarZonaPressaoAction.do"
												paramName="zonaPressao" paramProperty="id"
												paramId="idRegistroAtualizacao">${zonaPressao.descricaoZonaPressao}
													</html:link></td>

											<html:link href="/gsan/exibirManterZonaPressaoAction.do"
												paramId="codigo" paramProperty="id" paramName="zonaPressao">
											</html:link>
											...
											<td width="28%" align="center">
												<logic:notEmpty 
													...
													<bean:write
														name="zonaPressao"
														property="distritoOperacional.descricao" />																																						
												</logic:notEmpty>												
												<logic:empty 
														name="zonaPressao"												
														property="distritoOperacional">
