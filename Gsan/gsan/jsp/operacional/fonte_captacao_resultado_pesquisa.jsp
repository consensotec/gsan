  ...
  <tr>
    <td width="630" valign="top" class="centercoltext"> <table height="100%">
      ...
      <table width="100%" border="0" bgcolor="#90c7fc">
        <tr align="left" >
          <td width="15%" align="center"><strong>Tipo de Captação</strong></td>
          <td align="center" width="15%"><strong>Código Fonte de Captação</strong></td>
          <td width="35%" align="center"><strong>Descrição</strong></td>
          <td width="35%" align="center"><strong>Descrição Abreviada</strong></td>
        </tr>
