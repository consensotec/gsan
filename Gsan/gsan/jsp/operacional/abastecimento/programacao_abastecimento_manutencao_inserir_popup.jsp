...
<script language="JavaScript">
	...
	function validaForm() {
		...
		if(	validaCampos() && 
    		...
    		form.action='exibirInserirProgramacaoAbastecimentoManutencaoAction.do?tipoOperacao=I';
	    	form.submit();
...
<logic:present name="fechaPopup" scope="request">
	<body leftmargin="0" topmargin="0" onload="chamarReload('exibirInformarProgramacaoAbastecimentoManutencaoAction.do?tipoOperacao=I');window.close()">
</logic:present>


<html:form action="/exibirInserirProgramacaoAbastecimentoManutencaoAction.do"
	name="InformarProgramacaoAbastecimentoManutencaoActionForm"
	type="gsan.gui.operacional.abastecimento.InformarProgramacaoAbastecimentoManutencaoActionForm"
	method="post">
