...
<html:javascript staticJavascript="false"
	formName="AtualizarBaciaActionForm" />
...
<html:form action="/atualizarBaciaAction.do" method="post">

	<INPUT TYPE="hidden" name="removerBacia">
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para atualizar a bacia informe os
					dados abaixo:</td>
				<tr>
					<td><strong>C&oacute;digo:</strong></td>
					<td><html:hidden property="id" /> 
					<bean:write	name="AtualizarBaciaActionForm" property="id" />
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="2"><span class="style2"> <html:text
						property="descricao" size="32" maxlength="30" /> </span></td>
				</tr>
