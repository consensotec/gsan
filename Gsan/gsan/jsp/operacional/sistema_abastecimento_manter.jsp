...
<%@ page import="gsan.operacional.SistemaAbastecimento"%>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								<tr bordercolor="#FFFFFF" bgcolor="#79BBFD">
									...
									<td width="30%">
									<div align="center"><strong>Fonte de Captação</strong></div>
									</td>
									...
									<pg:item>
										...
										<%}%>
											...
											<div align="center"><input type="checkbox"
												...
												value="<bean:write name="sistemaAbastecimento" property="id"/>"></div>
											</td>
											...
											<html:link
												...
												<bean:write name="sistemaAbastecimento" property="id"/>
											</html:link>
											</td>
											...
											<td width="40%">
												<div align="center">
												<logic:notEmpty name="sistemaAbastecimento" property="fonteCaptacao">
													<bean:write name="sistemaAbastecimento" property="fonteCaptacao.descricao"/>
												</logic:notEmpty>
												</div>
											</td>
