...
<html:javascript staticJavascript="false"  formName="EmissaoHistogramaAguaEconomiaDadosInformarActionForm"/>
...
<script language="JavaScript">
	...
	function validarForm(indicadorSimulacao){
		
		var form = document.forms[0];
		
		if(validateEmissaoHistogramaAguaEconomiaDadosInformarActionForm(form) && 
			validaCamposObrigatorios() && 
			validaQtdeConsumoFaixa()){
			
			if(indicadorSimulacao==<%=ConstantesSistema.SIM%>){
				form.indicadorTarifaSimulacao.value = <%=ConstantesSistema.SIM%>;
			}else{
				form.indicadorTarifaSimulacao.value = <%=ConstantesSistema.NAO%>;
			}
			
			toggleBox('demodiv',1);
			
  			//form.action='gerarRelatorioHistogramaAguaEconomiaDadosInformarAction.do';
	...
	function limparSemOpcaoTotalizacao(){
  		...
  		form.action='emissaoHistogramaAguaEconomiaDadosInformarAction.do?menu=sim';
	    form.submit();
	...
	*/
	...
	function adcionarConsumo() {
		abrirPopup('emissaoHistogramaAguaEconomiaDadosInformarAction.do?acao=I', 300, 600);
	}
	...
	function removerConsumo(id){
		...
		if (where_to == true) {
		    ...
		    form.action='emissaoHistogramaAguaEconomiaDadosInformarAction.do?acao=R&idRemover='+id;
		    form.submit();
 		}
	}
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	    ...
	    //Consumo Medido e Consumo Não Medido
    		...
    		form.action='emissaoHistogramaAguaEconomiaDadosInformarAction.do?acao=A';
	    	form.submit();
	...
	function limparSetorComercial() {
  	...
  	function reloadForm(){
  		...
  		form.action='emissaoHistogramaAguaEconomiaDadosInformarAction.do';
	    form.submit();
  	}
	...
	function pesquisarSubcategorias(){
  		...
  		form.action='emissaoHistogramaAguaEconomiaDadosInformarAction.do?objetoConsulta=5';
	    form.submit();
  	}
  	...
  	function mudarTabelaConsumoFaixaCategoria(){
  		...
  		form.action='emissaoHistogramaAguaEconomiaDadosInformarAction.do?acao=M';
	    form.submit();
  	}
...
//   		form.opcaoTotalizacao.value = "1";
	...
	function trocarIndicadorTarifa(valor){
  		 window.location.assign('emissaoHistogramaAguaEconomiaDadosInformarAction.do?tipoRelatorio='+valor)
	}  	
...
<html:form action="/gerarRelatorioHistogramaAguaEconomiaDadosInformarAction.do"
	name="EmissaoHistogramaAguaEconomiaDadosInformarActionForm"
	type="gsan.gui.faturamento.EmissaoHistogramaAguaEconomiaDadosInformarActionForm"
	method="post">

	<html:hidden property="limiteInferiorFaixa"/>
	<html:hidden property="limiteSuperiorFaixa"/>
	<html:hidden property="tamanhoColecao"/>
	<html:hidden property="indicadorTarifaSimulacao"/>
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Informa&ccedil;&atilde;o de Dados para Emiss&atilde;o do Histograma de &Aacute;gua Por Economia</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="6">
	                	<strong> 
						  	<html:radio property="indicadorTarifaCategoria" value="1" onchange="trocarIndicadorTarifa(1);"/>Categoria
						  	<html:radio property="indicadorTarifaCategoria" value="2" onchange="trocarIndicadorTarifa(2);"/>Subcategoria
 						</strong> 
 					</td>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="eloPolo" 
							size="3"
							onkeypress="validaEnterComMensagem(event, 'emissaoHistogramaAguaEconomiaDadosInformarAction.do?objetoConsulta=1','eloPolo','Elo Pólo');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="localidade" 
							size="3"
							onkeypress="validaEnterComMensagem(event, 'emissaoHistogramaAguaEconomiaDadosInformarAction.do?objetoConsulta=2','localidade','Localidade');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							size="3"
							onkeypress="validaEnterComMensagem(event, 'emissaoHistogramaAguaEconomiaDadosInformarAction.do?objetoConsulta=3','setorComercial','Setor Comercial');"/>
					...
					<tr>
						...
						<td>
							...
							<html:text maxlength="4"
								...
								tabindex="3" 
								size="4"
								onkeypress="javascript:return validaEnterDependencia(event, 'emissaoHistogramaAguaEconomiaDadosInformarAction.do?objetoConsulta=4', this, document.forms[0].setorComercial.value, 'Setor Comercial');" />
 						...
 						<div align="center">
     						...
     						<table width="100%" align="center" bgcolor="#99CCFF">
								...
								<logic:iterate id="consumoFaixaCategoria" 
									...
									type="gsan.faturamento.ConsumoFaixaCategoria" 
									scope="session">
				...
				<tr>
					<td height="24" >
			          	<input type="button" 
			          		class="bottonRightCol" 
			          		value="Limpar" 
			          		onclick="window.location.href='<html:rewrite page="/emissaoHistogramaAguaEconomiaDadosInformarAction.do?menu=sim"/>'"
			          		/>
					</td>
					
					<td align="right">
					
						<logic:notEmpty name="indicadorTarifaSimulacao" > 
							<logic:equal name="indicadorTarifaSimulacao" value="1" >
					            <input type="button" 
									name="Button" 
									class="bottonRightCol" 
									value="Simular Histograma" 
									onClick="javascript:validarForm(<%=ConstantesSistema.SIM%>)"
									/>
					        </logic:equal>
					     </logic:notEmpty>
						...
						<input type="button" 
							name="Button" 
							class="bottonRightCol" 
							value="Emitir Histograma" 
							onClick="javascript:validarForm(<%=ConstantesSistema.NAO%>)" />
					</td>
...
<%@ include file="/jsp/util/rodape.jsp"%>	
	<jsp:include												   
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioHistogramaAguaEconomiaDadosInformarAction.do" />
</html:form>
</body>
