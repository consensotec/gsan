...
function abrirLimparFormulario(form){
	form.tipoPesquisa.value = "";
	abrirPopup('exibirPesquisarClienteAction.do?indicadorUsoTodos=1&limparForm=OK', 400, 800);
...
<html:form action="/filtrarImovelInserirManterContaAction"
	...
	type="gsan.gui.faturamento.conta.FiltrarImovelContaActionForm"
	method="post"
	...
	<html:hidden property="tipoPesquisa" value = ""/>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<html:text  property="codigoCliente" 
								...
								onkeyup="bloquearLSQLS();" /> 
									<a href="javascript:abrirLimparFormulario(document.forms[0]);"
