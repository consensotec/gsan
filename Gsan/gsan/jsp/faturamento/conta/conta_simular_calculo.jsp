...
<%@ page import="gsan.faturamento.bean.CalcularValoresAguaEsgotoHelper" %>
		    	...
		    	<tr>
		        	<td width="100%">
						...
						<table width="100%" border="0" >
						      			...
						      			<tr bgcolor="#cbe5fe">
									    	<td width="100%" align="center">
					                			<table width="100%" border="0">
													...
													<tr> 
		   							      				<td height="10"><strong>Consumo do Poço:</strong></td>
														<td>
							...
							<tr> 
			      				<td height="10"><strong>Pontos de Utilização:</strong></td>
								<td>
