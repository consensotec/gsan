...
<html:form
  ...
  type="gsan.gui.faturamento.conta.FiltrarMapaControleContaRelatorioActionForm"
	  ...
	  <table width="100%" border="0">
		...
		<tr>
			...
			<td width="90%"><strong> 
				...
				<html:radio	property="indicadorFichaCompensacao" value="2"/>Boleto Bancário</strong>
			</strong></td>
		</tr>                
        <tr>
          <td>&nbsp;</td>
