...
<%@ page import="gsan.faturamento.conta.ContaMotivoRetificacaoColuna"%>
...
function validarForm(form){
	...
	if(validateAtualizarMotivoRetificacaoActionForm(form)){
	    form.action="atualizarMotivoRetificacaoAction.do";
    ...
    if (tipoConsulta == 'TabelaColuna') {
    	form.descColuna.style.color = "#000000";
  		form.idColuna.value = descricaoRegistro;
   		...
   		form.idColunaPesquisada.value = codigoRegistro;
	}
	
	form.action = 'exibirAtualizarMotivoRetificacaoAction.do';
	form.submit();
} 
...
function adicionar() {
	...
	if (form.idColuna.value == '') {
		...
		form.action = 'exibirAtualizarMotivoRetificacaoAction.do?acao=adicionar';
		form.submit();
	}
...
function desfazer(){
	...
	form.action = 'exibirAtualizarMotivoRetificacaoAction.do?acao=desfazer';
	form.submit();
}
...
function remover(obj){
	...
	if (confirm('Confirma Remoção?')) {
		...
		form.action = 'exibirAtualizarMotivoRetificacaoAction.do?acao=remover&id='+obj;
		form.submit();
	}
}

function limparIdColunaPesquisada(){
	var form = document.forms[0];
   	form.idColunaPesquisada.value = "";
}
</script>
...
<html:javascript staticJavascript="false"
	formName="AtualizarMotivoRetificacaoActionForm" />
	
<body leftmargin="5" topmargin="5"
	onload="setarFoco('${requestScope.nomeCampo}');">

<html:form action="/atualizarMotivoRetificacaoAction"
	name="AtualizarMotivoRetificacaoActionForm"
	type="gsan.gui.faturamento.conta.AtualizarMotivoRetificacaoActionForm"
	method="post">

	<html:hidden property="idColunaPesquisada" />
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Motivo de Retificação</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">
					<p>Para atualizar o motivo de retificação da conta, informe os dados abaixo:</p>
					</td>
				...
				<tr>
					<td width="30%"><strong>Indicador de Uso:<font
						color="#FF0000">*</font></strong></td>
					<td><html:radio property="indicadorUso" value="1"
						tabindex="3" /> <strong>Sim</strong>&nbsp; <html:radio
						property="indicadorUso" value="2" tabindex="4" /> <strong>N&atilde;o</strong>
				</tr>
				<tr>
					<td colspan="2">&nbsp;</td>
				</tr>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td colspan="3">
						<html:text property="idColuna" style="text-transform: none;"
							...
							onkeypress="limparIdColunaPesquisada();pesquisaEnterSemUpperCase(event, 'exibirAtualizarMotivoRetificacaoAction.do', 'idColuna');" />
				...
				<tr>
					...
					<table width="100%" cellpadding="0" cellspacing="0">
						...
						<logic:present name="colecaoContaMotivoRetificacaoColuna">
							<tr>
								<td colspan="3">
								...
								<table width="100%" bgcolor="#99CCFF">
									...
									<logic:iterate name="colecaoContaMotivoRetificacaoColuna"
										id="contaMotivoRetificacaoColuna" type="ContaMotivoRetificacaoColuna">
										...
										<c:choose>
											...
											<td width="80%">
												<bean:write name="contaMotivoRetificacaoColuna"
													property="tabelaColuna.descricaoColuna" /></td>
										</tr>
					...
					<td valign="top">
						<logic:present name="manter"
							...
							<input type="button" name="ButtonReset" class="bottonRightCol"
								value="Voltar"
								onClick="javascript:window.location.href='/gsan/filtrarMotivoRetificacaoAction.do'">
						</logic:present><logic:notPresent name="manter" scope="session">
							<input type="button" name="ButtonReset" class="bottonRightCol"
								value="Voltar"
								onClick="javascript:window.location.href='/gsan/exibirFiltrarMotivoRetificacaoAction.do'">
						</logic:notPresent>
