...
function validarForm(form){
	...
	else if (form.contasEmExtratoDebito.value != null && form.contasEmExtratoDebito.value != ""){
		if (confirm("Confirma cancelamento da(s) conta(s)? A(s) conta(s) " + form.contasEmExtratoDebito.value + " está(ão) incluída(s) em extrato(s) de débito")) {
...
<logic:present name="reloadPage">
	<body leftmargin="0" topmargin="0" onload="chamarSubmitComUrl('exibirManterContaAction.do?cancelar=1'); window.close();">
</logic:present>

<logic:notPresent name="reloadPage">
	<body leftmargin="0" topmargin="0" onload="resizePageSemLink(600, 270);">
</logic:notPresent>
...
<html:hidden property="contasEmExtratoDebito"/>
      ...
      <table width="100%" border="0">
        <tr>
	      ...
	      <logic:present scope="application" name="urlHelp">
				<td align="right"><a href="javascript:abrirPopupHelp('${applicationScope.urlHelp}faturamentoContaCancelar', 500, 700);"><span style="font-weight: bold"><font color="#3165CE">Ajuda</font></span></a></td>									
		  </logic:present>
