...
<%@ page import="gsan.cadastro.imovel.Categoria" %>
<%@ page import="gsan.cadastro.imovel.Subcategoria" %>
<%@ page import="gsan.faturamento.debito.DebitoCobrado" isELIgnored="false"%>
<%@ page import="gsan.faturamento.credito.CreditoRealizado" %>
...
<%@ page import="gsan.financeiro.FinanciamentoTipo" %>
<%@ page import="gsan.faturamento.consumotarifa.ConsumoTarifa" %>

<%@ page import="gsan.cadastro.cliente.ClienteConta" %>
