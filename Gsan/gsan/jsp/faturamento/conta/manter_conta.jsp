													...
													<td width="10%" align="center">
														...
														<logic:equal name="usuarioPodeAtualizarRetificarContasPagas" value="true" >
															...
															<%
																	...
																	if(conta.getContaMotivoRevisao() == null || conta.getContaMotivoRevisao().getIndicadorBloqueioAlteracaoConta().equals(ConstantesSistema.NAO)){
															%>
