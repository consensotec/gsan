			...
			<table width="100%">
				...
				cor = "#FFFFFF";%>
										<tr bgcolor="#cbe5fe">
											...
											<td align="center"><a href="/gsan/exibirAtualizarMensagemContaAction.do?url=manter&idMensagemConta=<bean:write name="contaM" property="id"/>"><%= Util.formatarAnoMesParaMesAno(((gsan.faturamento.conta.ContaMensagem)contaM).getAnoMesRreferenciaFaturamento()) %></a></td>
