		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Motivo de Retificação da Conta</td>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="7" height="23"><font style="font-size: 10px;"
						...
						de Retificação Cadastrados:</strong> </font></td>
				</tr>
				<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								<tr bordercolor="#FFFFFF" bgcolor="#79BBFD">
									...
									<td width="43%">
									<div align="center"><strong>Descrição do Motivo da Retificação</strong></div>
									</td>
									<td width="25%">
									<div align="center"><strong>Limite de reincidência em doze meses</strong></div>
									</td>
									<td width="25%">
									<div align="center"><strong>Indicativo de Validar competência de consumo</strong></div>
									</td>
