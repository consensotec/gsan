...
<script>
	...
	function validaForm(){
		...
		if(validateCaracterEspecial(form) && 
			...
			referencia = '/gsan/exibirManterCategoriaFaixaConsumoTarifaAction.do?limpaFaixa=1&parametro1='
			+document.forms[0].slcCategoria.value+'&parametro2='
			+document.forms[0].consumoMinimo.value+'&parametro3='
			+document.forms[0].valorTarifaMinima.value;
			redirecionarSubmit(referencia);	
		}
	}
...
<logic:equal name="testeInserir" value="true" scope="request">
	<body leftmargin="0" topmargin="0"
		onload="chamarReload('exibirManterConsumoTarifaExistenteAction.do');window.close();">
</logic:equal>
<body leftmargin="0" topmargin="0"
	onload="resizePageSemLink(640,400); setarFoco('${requestScope.slcCategoria}');">

<html:form action="/manterCategoriaConsumoTarifaAction"
	name="InserirCategoriaConsumoTarifaActionForm"
	onsubmit="return validateInserirCategoriaConsumoTarifaActionForm(this);"
	type="gsan.gui.faturamento.consumotarifa.InserirCategoriaConsumoTarifaActionForm"
	method="post">
	...
	<table width="600" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="4">Preencha os campos para inserir uma categoria na
				...
				<tr>
					...
					<td colspan="3"><c:if
						...
						<logic:equal name="travar" value="true">
							...
							<html:select style="width: 230px;" property="slcCategoria" value="${sessionScope.categoriaSelected}" disabled="true">
						...
						<logic:equal name="travar" value="true">
							<html:hidden property="slcCategoria" value="${sessionScope.categoriaSelected}" />
							<html:select disabled="true" property="slcCategoria" style="width: 230px;">
							 <html:option value="-1">&nbsp;</html:option>
				...
				cor = "#cbe5fe";%>
								<tr bgcolor="#cbe5fe">
									...
									<div align="center" class="style9"><img
										...
										onclick="redirecionarSubmit('excluirCategoriaFaixaConsumoTarifaAction.do?manter=1&posicao=<bean:write name="faixa" property="ultimaAlteracao.time" />');"></div>
