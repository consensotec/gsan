...
function facilitador(objeto){
 ...
 function novoFiltro(){
	var formRed = "/gsan/exibirFiltrarConsumoTarifaAction.do";
 	...
 	function validarForm(objeto){ 
	   ...
	   var acumulador = 0;
    	...
    	for(indice = 0; indice < formulario.elements.length; indice++){
  		...
  		abrirPopup('/gsan/exibirInserirReajusteConsumoTarifaAction.do?id_r=' + ids, 500, 610);
	...
	function  remover(){
		if(CheckboxNaoVazio(document.ManutencaoRegistroActionForm.idRegistrosRemocao) && confirm('Confirma remoï¿½ï¿½o ?')){
    		...
    		form.action = "removerConsumoTarifaAction.do";
	    	form.submit()	
	    }
	}  	
...
<html:form action="/removerConsumoTarifaAction"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Tarifa de Consumo</td>
					<td width="11"><img border="0"
			...
			<table width="100%">
				...
				cor = "#cbe5fe";%>
										<tr bgcolor="#cbe5fe">
											...
											<td align="left"><a
												href="/gsan/exibirManterConsumoTarifaExistenteAction.do?idVigencia=<bean:write name="vigenciaF" property="id"/>"><bean:write
				...
				<td>
					...
					<gsan:controleAcessoBotao name="Button" value="Remover"
							  onclick="javascript:remover();" url="removerConsumoTarifaAction.do"/>
					<!--<html:button
