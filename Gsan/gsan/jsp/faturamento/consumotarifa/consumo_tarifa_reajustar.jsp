...
<body onunload = "javascript:chamarReload('exibirManterConsumoTarifaAction.do')">
<html:form action="/inserirReajusteConsumoTarifaAction"
	...
	type="gsan.gui.faturamento.consumotarifa.InserirReajusteConsumoTarifaActionForm"
	method="post">
