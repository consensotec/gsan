			...
			<table width="100%" border="0">	
				...
				<tr>
					...
					<td colspan="3"><html:text style="text-align:right;" maxlength="16"
						property="valorTarifaMinima" size="16"
						onkeyup="formataValorMonetario(this, 13)" /></td>
				</tr>
				<tr>
					<td height="25" colspan="3"><strong>Faixas de Consumo:<font color="#FF0000">*</font></strong></td>
