...
<script>
 ...
 function chamarFiltrar(){
  	...
  	if(validateFiltrarConsumoTarifaActionForm(form)){
	    form.action = 'filtrarConsumoTarifaAction.do'
	   	form.submit();  	
	}
 }
...
<html:form action="/filtrarConsumoTarifaAction"
	...
	type="gsan.gui.faturamento.consumotarifa.FiltrarConsumoTarifaActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Tarifa de Consumo</td>
					<td width="11"><img border="0"
			...
			<table width="100%">
				<tr>
					...
					<logic:present scope="application" name="urlHelp">
						<td align="right"><a href="javascript:abrirPopupHelp('${applicationScope.urlHelp}faturamentoTarifaConsumoFiltrar', 500, 700);"><span style="font-weight: bold"><font color="#3165CE">Ajuda</font></span></a></td>									
					</logic:present>
