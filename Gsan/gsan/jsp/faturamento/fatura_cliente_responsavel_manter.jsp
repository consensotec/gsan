...
function chamarRemover(){
	...
	if(CheckboxNaoVazio(document.forms[0].idRegistrosRemocao) && confirm('Confirma remoção?')){
...
<html:form action="/atualizarFaturaClienteResponsavelAction"
	...
	type="gsan.gui.faturamento.FiltrarFaturaClienteResponsavelActionForm" method="post">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img src="imagens/parahead_left.gif"
						...
						border="0" /></td>
					<td class="parabg">Manter Fatura de Cliente Responsável</td>
													...
													<tr bgcolor="#FFFFFF">
														...
														<td width="15%">
															...
															<logic:present name="faturaItem" property="contaGeral.contaHistorico">
																<div align="center">
																	<a href="javascript:abrirPopup('exibirConsultarContaAction.do?contaID=${faturaItem.contaGeral.contaHistorico.id}&tipoConsulta=contaHistorico', 600, 800);">
				...
				<td colspan="5">
					<table width="100%" border="0" cellspacing="1">
						<tr>
							...
							<input type="button" class="bottonRightCol" value="Histórico de Atualizações" style="width: 170px;"
