...
<html:form action="/emissaoHistogramaEsgotoDadosInformarAction.do"
						...
						<td colspan="1">
							<div align="left">
								<input name="Button" 
									...
									value="Inserir"
									onClick="javascript:validaForm('<bean:write property="tipoConsumo" name="EmissaoHistogramaEsgotoDadosInformarActionForm" />');">
