...
function validarForm(form){
	...
	if(confirm("Confirma retirada da situação especial de faturamento para " + form.quantidadeImoveisCOMSituacaoEspecialFaturamento.value + " imóvel(is) ?")){
...
<html:form action="/validarRetirarSituacaoEspecialFaturamentoAction"
	type="gsan.gui.faturamento.SituacaoEspecialFaturamentoActionForm"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Retirar Situação Especial de Faturamento</td>
					<td width="11"><img border="0"
			...
			<tr>
				<logic:present scope="application" name="urlHelp">
						<td align="right"><a href="javascript:abrirPopupHelp('${applicationScope.urlHelp}faturamentoSituacaoEspecialRetirar', 500, 700);"><span style="font-weight: bold"><font color="#3165CE">Ajuda</font></span></a></td>									
				</logic:present>
			...
			<tr>
				...
				<div align="right"><html:text property="quantidadeImoveisCOMSituacaoEspecialFaturamento"
