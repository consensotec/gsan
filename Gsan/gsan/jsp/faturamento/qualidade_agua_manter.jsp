...
<%@page import="gsan.faturamento.QualidadeAgua"%>
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Qualidade de Água</td>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="7" height="23"><font style="font-size: 10px;"
						color="#000000" face="Verdana, Arial, Helvetica, sans-serif"> <strong>Qualidade(s) de água
							...
							<table width="100%" border="0">
								...
								<tr>
									...
									<img border="0"
										...
										title="Imprimir Qualidade(s) de Água" /> </a></div>
									</td>
								</tr>
							</table>
							<table width="100%" border="0">
