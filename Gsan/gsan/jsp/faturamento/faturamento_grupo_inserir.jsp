...
<html:form action="/inserirFaturamentoGrupoAction.do"
	...
	type="gsan.gui.faturamento.InserirFaturamentoGrupoActionForm"
	method="post"
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<!-- RM3071 -->
				<tr>
					<td><strong>Exibir mensagem na conta da quitação anual de débitos?<font
						color="#FF0000">*</font></strong></td>
					<td><strong> <html:radio property="indicadorMensagemQuitacao"
						value="1" /> <strong>Sim <html:radio
						property="indicadorMensagemQuitacao" value="2"/> N&atilde;o</strong>
					</strong></td>
				</tr>
				<!-- Fim RM3071 -->
				<tr>
