...
<html:javascript staticJavascript="false"  formName="EmissaoHistogramaEsgotoDadosInformarActionForm"/>
...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if(validateEmissaoHistogramaEsgotoDadosInformarActionForm(form) && 
	...
	function validaQtdeConsumoFaixa(){
		...
		if(form.consumo[0].checked){
			
			
			if(form.tamanhoColecaoMedido.value == '0'){
				msg = 'Deve existir ao menos uma faixa para consumo medido.';
			}
			
			if (form.tamanhoColecaoNaoMedido.value == '0'){
				if(msg != ""){
					msg = msg + '\n Deve existir ao menos uma faixa para consumo não medido.';
				}else{
					msg = 'Deve existir ao menos uma faixa para consumo não medido.';
				}
			}
			
		}else if(form.consumo[1].checked){

			if(form.tamanhoColecaoMedido.value == '0'){
				msg = 'Deve existir ao menos uma faixa para consumo medido.';
			}
		
		}else if(form.consumo[2].checked){
	...
	function limparSemOpcaoTotalizacao(){
  		...
  		form.action='emissaoHistogramaEsgotoDadosInformarAction.do?menu=sim';
	    form.submit();
	...
	*/
	...
	function adcionarConsumo(tipoConsumo) {
		abrirPopup('emissaoHistogramaEsgotoDadosInformarAction.do?acao=I&tipoConsumo='+tipoConsumo, 300, 600);
	}
	
	/* Remove Faixa da grid */	
	function removerConsumo(tipoConsumo,id){
		...
		if (where_to == true) {
		    ...
		    form.action='emissaoHistogramaEsgotoDadosInformarAction.do?acao=R&tipoConsumo='+tipoConsumo+'&idRemover='+id;
		    form.submit();
 		}
	}
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	    ...
	    //Consumo Medido e Consumo Não Medido
	    	...
	    	form.tipoConsumo.value = descricaoRegistro[0];
	    	form.limiteInferiorFaixa.value = descricaoRegistro[1];
	    	form.limiteSuperiorFaixa.value = descricaoRegistro[2];

    		form.action='emissaoHistogramaEsgotoDadosInformarAction.do?acao=A';
	    	form.submit();
	...
	function limparSetorComercial() {
  	...
  	function limparQuadra() {
		...
		if(form.indicadorTarifaCategoria[0].checked){
	      	form.quadra.value = "";
  	...
  	function reloadForm(){
  		...
  		form.action='emissaoHistogramaEsgotoDadosInformarAction.do';
	    form.submit();
  	}
  	...
  	function limpar(){
		...
		form.indicadorTarifaCategoria[0].checked = true;
		form.indicadorTarifaCategoria[1].checked = false;
  	...
  	function limparIndicadores(){
  		...
  		form.consumo[0].checked = true;
  		form.consumo[1].checked = false;
  		form.consumo[2].checked = false;
  		
  		form.medicao[0].checked = true;
  		form.medicao[1].checked = false;
  		form.medicao[2].checked = false;
  		
  		form.poco[0].checked = true;
  		form.poco[1].checked = false;
  		form.poco[2].checked = false;
  		
  		form.volumoFixoEsgoto[0].checked = true;
  		form.volumoFixoEsgoto[1].checked = false;
  		form.volumoFixoEsgoto[2].checked = false;
  	}
  	
  	function pesquisarSubcategorias(){
  		var form = document.forms[0];

  		form.action='emissaoHistogramaEsgotoDadosInformarAction.do?objetoConsulta=5';
	    form.submit();
  	}  	
...
<html:form action="/gerarRelatorioHistogramaEsgotoDadosInformarAction.do"
	name="EmissaoHistogramaEsgotoDadosInformarActionForm"
	type="gsan.gui.faturamento.EmissaoHistogramaEsgotoDadosInformarActionForm"
	method="post">

	<html:hidden property="tipoConsumo"/>
	<html:hidden property="limiteInferiorFaixa"/>
	<html:hidden property="limiteSuperiorFaixa"/>
	<html:hidden property="tamanhoColecaoMedido"/>
	<html:hidden property="tamanhoColecaoNaoMedido"/>
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Informa&ccedil;&atilde;o de Dados para Emiss&atilde;o do Histograma de Esgoto</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="eloPolo" 
							size="3"
							onkeypress="validaEnterComMensagem(event, 'emissaoHistogramaEsgotoDadosInformarAction.do?objetoConsulta=1','eloPolo','Elo Pólo');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="localidade" 
							size="3"
							onkeypress="validaEnterComMensagem(event, 'emissaoHistogramaEsgotoDadosInformarAction.do?objetoConsulta=2','localidade','Localidade');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							size="3"
							onkeypress="validaEnterComMensagem(event, 'emissaoHistogramaEsgotoDadosInformarAction.do?objetoConsulta=3','setorComercial','Setor Comercial');"/>
					...
					<tr>
						...
						<td>
							...
							<html:text maxlength="4"
								...
								tabindex="3" 
								size="4"
								onkeypress="javascript:return validaEnterDependencia(event, 'emissaoHistogramaEsgotoDadosInformarAction.do?objetoConsulta=4', this, document.forms[0].setorComercial.value, 'Setor Comercial');" />
				...
				<tr>
              	...
              	<tr> 
	                <td><strong>Medi&ccedil;&atilde;o:</strong></td>
	                <td colspan="6">
	                	<strong> 
					  	<html:radio property="medicao" value=""/>Todos
					  	<html:radio property="medicao" value="1"/>Com Hidr&ocirc;metro
   					  	<html:radio property="medicao" value="2"/>Sem Hidr&ocirc;metro
 						</strong> 
 					</td>
              	</tr>           		
              	...
              	<tr> 
	                ...
	                <td colspan="6">
	                	<strong> 
					  	...
					  	<html:radio property="volumoFixoEsgoto" value="1"/>Com Volume Fixo
   					  	<html:radio property="volumoFixoEsgoto" value="2"/>Sem Volume Fixo
 						</strong> 
 					</td>
              	</tr>
				...
				<tr> 
 					<td>
 						<strong>
 							<font color="#000000">Faixas de Consumo para Medido: </font>
 						</strong>
 					</td>
 					<td colspan="3" align="right">
 						<div align="right"> 
     						<input type="button" 
     							...
     							value="Adicionar" 
     						    onclick="javascript:adcionarConsumo('M');">
   						</div>
   					</td>
				</tr>
				<tr> 
 					<td width="100%" colspan="4">
 						<div align="center">
     						...
     						<table width="100%" align="center" bgcolor="#99CCFF">
								...
								<tr bordercolor="#FFFFFF" bgcolor="#99CCFF">
                      				...
                      				<td colspan="2">
                      					<div align="center" class="style9">
                      						<strong>Faixa de Consumo para Medido </strong>
                      					</div>
                        			</td>
                    			</tr>
								...
								<logic:iterate id="consumoFaixaLigacaoMedido" 
									name="EmissaoHistogramaEsgotoDadosInformarActionForm" 
									property="colecaoConsumoFaixaLigacaoMedido" 
									type="gsan.faturamento.ConsumoFaixaLigacao" 
									scope="session">                      		  		
			                        	...
			                        	<div align="center">
			                        		<img src="<bean:message key='caminho.imagens'/>Error.gif" 
			                        			...
			                        			height="14" 
										 		style="cursor:hand;" 
										 		name="imagem"	
										 		onclick="removerConsumo('M','${count}');"
										 		alt="Remover">
										</div>
									</td>
			                        ...
			                        <td bordercolor="#90c7fc">
			                        	<div align="center">
			                        		<c:if test="${consumoFaixaLigacaoMedido.numeroFaixaInicio != null}">
			                        			<bean:write name="consumoFaixaLigacaoMedido" 
			                        ...
			                        <td bordercolor="#90c7fc">
			                        	<div align="center">
			                        		<c:if test="${consumoFaixaLigacaoMedido.numeroFaixaFim != null}">
			                        			<bean:write name="consumoFaixaLigacaoMedido" 
				...
				<tr> 
 					<td>
 						<strong>
 							<font color="#000000">Faixas de Consumo para N&atilde;o Medido: </font>
 						</strong>
 					</td>
 					<td colspan="3" align="right">
 						<div align="right"> 
     						<input type="button" 
     							...
     							class="bottonRightCol" 
     							value="Adicionar" 
     						    onclick="javascript:adcionarConsumo('N');">
   						</div>
   					</td>
				</tr>
 						...
 						<div align="center">
     						...
     						<table width="100%" align="center" bgcolor="#99CCFF">
								...
								<tr bordercolor="#FFFFFF" bgcolor="#99CCFF">
                      				...
                      				<td colspan="2">
                      					<div align="center" class="style9">
                      						<strong>Faixa de Consumo para N&atilde;o Medido </strong>
                      					</div>
                        			</td>
                    			</tr>
								...
								<logic:iterate id="consumoFaixaLigacaoNaoMedido" 
									name="EmissaoHistogramaEsgotoDadosInformarActionForm" 
									property="colecaoConsumoFaixaLigacaoNaoMedido" 
									type="gsan.faturamento.ConsumoFaixaLigacao" 
									scope="session"> 
			                        	...
			                        	<div align="center">
			                        		<img src="<bean:message key='caminho.imagens'/>Error.gif" 
			                        			...
			                        			height="14" 
										 		style="cursor:hand;" 
										 		name="imagem"	
										 		onclick="removerConsumo('N','${count}');"
										 		alt="Remover">
										</div>
									</td>
			                        ...
			                        <td bordercolor="#90c7fc">
			                        	<div align="center">
			                        		<c:if test="${consumoFaixaLigacaoNaoMedido.numeroFaixaInicio != null}">
			                        			<bean:write name="consumoFaixaLigacaoNaoMedido" 
			                        				property="numeroFaixaInicio" />
			                        		</c:if>
			                        	</div>
			                        </td>
			                        ...
			                        <td bordercolor="#90c7fc">
			                        	<div align="center">
			                        		<c:if test="${consumoFaixaLigacaoNaoMedido.numeroFaixaFim != null}">
			                        			<bean:write name="consumoFaixaLigacaoNaoMedido" 
			                        				property="numeroFaixaFim" />
			                        		</c:if>
			                        	</div>
				...
				<tr>
					...
					<td align="right">
						<input type="button" 
							name="Button" 
							class="bottonRightCol" 
							value="Emitir Histograma de Esgoto" 
