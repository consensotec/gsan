	...
	*/
	...
	function pesquisarSubcategorias(){
  	...
  	function trocarIndicadorTarifa(valor){
  		 ...
  		 window.location.assign('emissaoHistogramaEsgotoEconomiaDadosInformarAction.do?tipoRelatorio='+valor)
	} 
...
<html:form action="/gerarRelatorioHistogramaEsgotoEconomiaDadosInformarAction.do"
	...
	type="gsan.gui.faturamento.EmissaoHistogramaEsgotoEconomiaDadosInformarActionForm"
	method="post">
				...
				<tr>
					<td height="24" >
			          	<input type="button" 
			          		class="bottonRightCol" 
			          		value="Limpar" 
			          		onclick="window.location.href='<html:rewrite page="/emissaoHistogramaEsgotoEconomiaDadosInformarAction.do?menu=sim"/>'"/>
					</td>
