...
<script language="JavaScript">
	...
	function validaForm() {
		...
		if(validaLimite()){
			...
			lista[0] = form.limiteInferiorFaixa.value;
			lista[1] = form.limiteSuperiorFaixa.value;
...
<html:form action="/emissaoHistogramaAguaEconomiaDadosInformarAction.do"
			...
			<td width="550" valign="top" class="centercoltext">
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<td class="parabg">Adicionar Faixa no Consumo da Categoria</td>
						<td width="11"><img border="0"
