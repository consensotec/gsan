		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<logic:present name="inserirTodosAtivado" scope="request">
					...
					<tr>
						<td><strong>Coliformes Termotolerantes / E.Coli:</strong></td>
						<td align="center"><strong>Índice mensal:</strong> <html:text
					...
					<tr>
						<td><strong>Dureza Total</strong></td>
						<td align="center"><strong>Índice mensal:</strong>
							<html:text property="durezaTotal" size="5" maxlength="5"
									   tabindex="28" 
									   onkeydown="validarInteiro()"/>						
						</td>
						<td><strong>Padrão:</strong>
							<html:text property="descricaoDurezaTotal" size="20" 
				...
				<logic:notPresent name="inserirTodosAtivado" scope="request">
					...
					<tr>
						...
						<td align="center"><strong>Índice mensal:</strong>
							<html:text property="durezaTotal" size="5" maxlength="5"
									   tabindex="28" onkeydown="validarInteiro()"
									   onkeypress="return isCampoNumerico(event);"/>						
						</td>
						<td><strong>Padrão:</strong>
							<html:text property="descricaoDurezaTotal" size="20" 
