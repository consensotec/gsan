...
<%@page	import="gsan.faturamento.debito.DebitoTipoVigencia"%>
...
<html:form action="/replicarDebitoTipoVigenciaAction.do"
	...
	type="gsan.gui.faturamento.debito.ReplicarDebitoTipoVigenciaActionForm"
											...
											<pg:item>
												...
												<tr bgcolor="#cbe5fe">
													...
													<td width="20%" align="center">
														<%=gsan.util.Util.formatarData(debitoTipoVigencia.getDataVigenciaInicial())%>
													</td>
														
													<td width="20%" align="center">
														<%=gsan.util.Util.formatarData(debitoTipoVigencia.getDataVigenciaFinal())%>
													</td>											
	
													<td width="10%" align="right">
														<%=gsan.util.Util.formatarMoedaReal(debitoTipoVigencia.getValorDebito())%>
													</td>
