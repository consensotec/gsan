...
<html:form action="/removerDebitoTipoVigenciaAction"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Debito Tipo Vigencia</td>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="7" height="23"><font style="font-size: 10px;"
						color="#000000" face="Verdana, Arial, Helvetica, sans-serif"> <strong>Debitos Tipo Vigencia Cadastrados:</strong> </font></td>
				</tr>
				<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								<tr bordercolor="#FFFFFF" bgcolor="#79BBFD">
									...
									<td width="30%">
									<div align="center"><strong>Valor do Débito</strong></div>
									</td>
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<pg:param name="q" />
									<%int cont = 0;%>
									<logic:iterate name="colecaoDebitoTipoVigencia"
			...
			if (cont % 2 == 0) {%>
											...
											<tr bgcolor="#cbe5fe">
												...
												<div align="center"><input type="checkbox"
													...
													value="<bean:write name="debitoTipoVigencia" property="id"/>"></div>
												</td>
												<td width="25%">
													<html:link href="/gsan/exibirAtualizarDebitoTipoVigenciaAction.do"
															   paramId="idRegistroAtualizar" 
															   paramProperty="id"
															   paramName="debitoTipoVigencia"
															   title="<bean:write name='debitoTipoVigencia' property='debitoTipo.descricao'/>">
														<div align="center"><bean:write name="debitoTipoVigencia" property="debitoTipo.descricao"/></div>
													</html:link>
												</td>

												<td width="10%" align="center"><%=Util.formatarMoedaReal(debitoTipoVigencia.getValorDebito())%></td>
							...
							<table width="100%" border="0">
								...
								<tr>
									<td><font color="#FF0000"> <html:submit
										...
										onclick="window.location.href='<html:rewrite page="/exibirFiltrarDebitoTipoVigenciaAction.do?limpar=S"/>'"
