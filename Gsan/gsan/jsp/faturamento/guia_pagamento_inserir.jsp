...
<%@ page import="gsan.faturamento.debito.DebitoTipo, gsan.arrecadacao.pagamento.GuiaPagamentoItem"%>
...
<!--
	...
	function habilitaDesabilitaVlienteImovel(){
	...
	function adicionarItem(form){
		...
		if (form.registroAtendimento.value.length > 0 && form.nomeRegistroAtendimento.value.length < 1){

			alert('Registro de atendimento não foi identificado');
			} else {
...
<html:form action="/exibirInserirGuiaPagamentoAction" method="post"
	...
	type="gsan.gui.faturamento.InserirGuiaPagamentoActionForm">
				...
				<tr>
					...
					<td align="left">
						<html:text property="idImovel" 
							maxlength="9"
							size="9"
							onchange="javascript:habilitaDesabilitaVlienteImovel();"
