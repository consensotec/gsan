...
<html:form
  ...
  type="gsan.gui.faturamento.FiltrarAnalisarReleituraImoveisActionForm"
  method="post"
		    	...
		    	<span class="style2">
		    		<strong> 
						<html:select property="idSituacaoReleitura" style="width: 230px;">
							...
							<html:option value="<%=""+gsan.gui.faturamento.bean.AnalisarImoveisReleituraHelper.RELEITURA_PENDENTE%>">Releitura Pendente</html:option>
							<html:option value="<%=""+gsan.gui.faturamento.bean.AnalisarImoveisReleituraHelper.RELEITURA_REALIZADA%>">Releitura Concluida</html:option>
							<html:option value="<%=""+gsan.gui.faturamento.bean.AnalisarImoveisReleituraHelper.RELEITURA_NAO_REALIZADA%>">Releitura não Realizada</html:option>
						</html:select>
					</strong>                
				</span>
			</td>
		...
		<tr> 
			<td>
				<input name="Button" 
					...
					value="Limpar" 
					align="left"
					onclick="window.location.href='/gsan/exibirFiltrarReleituraImoveisAction.do?menu=sim'">
