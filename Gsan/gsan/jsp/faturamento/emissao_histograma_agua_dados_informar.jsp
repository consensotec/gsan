...
<html:javascript staticJavascript="false"  formName="EmissaoHistogramaAguaDadosInformarActionForm"/>
...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if(validateEmissaoHistogramaAguaDadosInformarActionForm(form) && 
	...
	function limparSemOpcaoTotalizacao(){
  		...
  		form.action='emissaoHistogramaAguaDadosInformarAction.do?menu=sim';
	    form.submit();
	...
	*/
	...
	function adcionarConsumo(tipoConsumo) {
		abrirPopup('emissaoHistogramaAguaDadosInformarAction.do?acao=I&tipoConsumo='+tipoConsumo, 300, 600);
	}
	...
	function removerConsumo(tipoConsumo,id){
		...
		if (where_to == true) {
		    ...
		    form.action='emissaoHistogramaAguaDadosInformarAction.do?acao=R&tipoConsumo='+tipoConsumo+'&idRemover='+id;
		    form.submit();
 		}
	}
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	    ...
	    //Consumo Medido e Consumo Não Medido
    		...
    		form.action='emissaoHistogramaAguaDadosInformarAction.do?acao=A';
	    	form.submit();
	...
	function limparSetorComercial() {
  	...
  	function reloadForm(){
  		...
  		form.action='emissaoHistogramaAguaDadosInformarAction.do';
	    form.submit();
  	}
  	...
  	function pesquisarSubcategorias(){
  		...
  		form.action='emissaoHistogramaAguaDadosInformarAction.do?objetoConsulta=5';
	    form.submit();
  	}
  	...
  	function limparIndicadores(){
  		...
  		form.volumoFixoAgua[0].checked = true;
  		form.volumoFixoAgua[1].checked = false;
  		form.volumoFixoAgua[2].checked = false;
  	}
...
<html:form action="/gerarRelatorioHistogramaAguaDadosInformarAction.do"
	name="EmissaoHistogramaAguaDadosInformarActionForm"
	type="gsan.gui.faturamento.EmissaoHistogramaAguaDadosInformarActionForm"
	method="post">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Informa&ccedil;&atilde;o de Dados para Emiss&atilde;o do Histograma de &Aacute;gua</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="eloPolo" 
							size="3"
							onkeypress="validaEnterComMensagem(event, 'emissaoHistogramaAguaDadosInformarAction.do?objetoConsulta=1','eloPolo','Elo Pólo');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="localidade" 
							size="3"
							onkeypress="validaEnterComMensagem(event, 'emissaoHistogramaAguaDadosInformarAction.do?objetoConsulta=2','localidade','Localidade');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							size="3"
							onkeypress="validaEnterComMensagem(event, 'emissaoHistogramaAguaDadosInformarAction.do?objetoConsulta=3','setorComercial','Setor Comercial');"/>
					...
					<tr>
						...
						<td>
							...
							<html:text maxlength="4"
								...
								tabindex="3" 
								size="4"
								onkeypress="javascript:return validaEnterDependencia(event, 'emissaoHistogramaAguaDadosInformarAction.do?objetoConsulta=4', this, document.forms[0].setorComercial.value, 'Setor Comercial');" />
				...
				<tr>
              	...
              	<tr> 
	                ...
	                <td colspan="6">
	                	<strong> 
					  	<html:radio property="volumoFixoAgua" value=""/>Todos
					  	<html:radio property="volumoFixoAgua" value="1"/>Com Volume Fixo
   					  	<html:radio property="volumoFixoAgua" value="2"/>Sem Volume Fixo
 						</strong> 
 					</td>
              	</tr>
				...
				<tr>
					...
					<td align="right">
						<input type="button" 
							name="Button" 
							class="bottonRightCol" 
							value="Emitir Histograma de &Aacute;gua" 
