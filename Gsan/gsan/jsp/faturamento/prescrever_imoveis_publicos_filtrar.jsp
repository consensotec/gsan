...
<html:form action="/prescreverImoveisPublicosAction.do" 
		   ...
		   type="gsan.gui.faturamento.PrescreverImoveisPublicosActionForm"
		   method="post">
      ...
      <table width="100%" border="0">
			  ...
			  <tr>
               ...
               <tr> 
                	...
                	<td colsan="3">	<span class="style2"><strong>					
						<html:text maxlength="7"
							tabindex="1"
							property="periodoInicial" 
							size="7" 
							onkeyup="mascaraAnoMes(this, event);replicaData();" onkeypress="return isCampoNumerico(event)"/>
						<strong>a</strong>
						<html:text maxlength="7"
							tabindex="1"
							property="periodoFinal" 
							size="7"
							onkeyup="mascaraAnoMes(this, event);" onkeypress="return isCampoNumerico(event)"/></strong>(mm/aaaa)</span>
					</td>
               </tr>
