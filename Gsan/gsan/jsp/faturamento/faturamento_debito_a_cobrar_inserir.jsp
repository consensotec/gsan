...
function validarForm(form, inserir){
		...
		if(form.idImovel != null){
		 ...
		 if(condicao){
			 ...
			 if( form.mesAnoInicialDaCobranca.value == "" ){
					alert("Mês/Ano Inicial da Cobrança não pode ser vazio");
					form.btnInserir.disabled = false;	
					condicao = false;
				}else if( !validaAnoMesSemAlert(form.mesAnoInicialDaCobranca) ){
					alert("Mês/Ano Inicial da Cobrança invalido!");
					form.btnInserir.disabled = false;	
					condicao = false; 					
				}else{

				sMes1 = form.mesAnoInicialDaCobranca.value.substr(0,2);
			    sAno1 = form.mesAnoInicialDaCobranca.value.substr(3,7);
			    smesAno1 = sAno1+sMes1 ;

			    sMes2 = form.valorMinimoMesAnoInicialDaCobranca.value.substr(0,2);
			    sAno2 = form.valorMinimoMesAnoInicialDaCobranca.value.substr(3,7);
			    smesAno2 = sAno2+sMes2;
			        
				if( parseInt(smesAno1) < parseInt(smesAno2)  ){
					alert("O mês/ano inicial da cobrança não pode ser inferior " + form.valorMinimoMesAnoInicialDaCobranca.value);
					form.btnInserir.disabled = false;	
					condicao = false;
				}		
			 }
			...
			<table width="100%" border="0">
				<tr>
					...
					<a	href="javascript:pesquisarRegistroAtendimento();"> <img width="23"
						height="21" title="Pesquisar Registro de Atendimento"
				...
				<tr>
					...
					<div align="left"><logic:present name="travarOrdemServico">
					 ...
					 <a href="javascript:pesquisarOrdemServico();">
					<img width="23" height="21" title="Pesquisar Ordem de Serviço"
				...
				<tr>
					<td><strong>Mês/Ano Inicial da Cobrança:</strong><font color="#FF0000">*</font></td>
					<td colspan="2" align="right">
						<div align="left">
							<html:text property="mesAnoInicialDaCobranca" maxlength="7"
							style="text-align: right;" size="8" tabindex="7" onkeyup="mascaraAnoMes(this, event);"
	                  		onkeypress="return isCampoNumerico(event);"/>&nbsp; mm/aaaa
	                    </div>
                   </td>
                   	<td align="right">
						<input type="button" name="calcularPrestacao"
						class="bottonRightCol" value="Calcular Presta&ccedil;&atilde;o"
						onclick="validarForm(document.forms[0], false);" tabindex="10">
					</td>
				</tr>
