...
<%@ page import="gsan.micromedicao.medicao.MedicaoTipo"%>
...
<html:javascript staticJavascript="false" formName="GerarRelatorioAnormalidadePorAmostragemActionForm" />
...
function verificarAnoMesReferencia(){
    ...
    if (form.referencia.value.length > 0){
   		form.action = 'exibirGerarRelatorioAnormalidadePorAmostragemAction.do';
   		form.submit();
    }
...
function validarForm(form){
	...
	if(validateGerarRelatorioAnormalidadePorAmostragemActionForm(form)){
...
function chamarReload(){
	var form = document.forms[0];
	form.action = 'exibirGerarRelatorioAnormalidadePorAmostragemAction.do?reload=OK';
    form.submit();
	
}

function validaAmostragem(){
	var form = document.forms[0];
	
	if( parseInt(form.amostragem.value) <= 0 || parseInt(form.amostragem.value) > 100){
		alert('O valor da Amostragem deverá ser um número Inteiro entre 1 e 100.');
		return false;
	}
...
<html:form  action="/gerarRelatorioAnormalidadePorAmostragemAction" method="post" 
			name="GerarRelatorioAnormalidadePorAmostragemActionForm"
			type="gsan.gui.faturamento.GerarRelatorioAnormalidadePorAmostragemActionForm"
			onsubmit="return validateGerarRelatorioAnormalidadePorAmostragemActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Relatório de Fiscalização de Leituras e Anormalidades</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td colspan="2">Para gerar Relatório de Fiscalização de Leituras e Anormalidades, informe os dados abaixo:</td>
				</tr>
				<tr>
					<td width="190">
				...
				<tr>
					...
					<td colspan="3">
						...
						onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioAnormalidadePorAmostragemAction.do', 'idLocalidadeInicial', 'Localidade Inicial');return isCampoNumerico(event);" />
				...
				<tr>
					...
					<td colspan="3">
						...
						onkeypress= "validaEnterComMensagem(event, 'exibirGerarRelatorioAnormalidadePorAmostragemAction.do', 'idLocalidadeFinal', 'Localidade Final');return isCampoNumerico(event);"/>
				...
				<tr>
					...
					<td colspan="3">
						...
						onkeypress="validaEnterDependencia(event, 'exibirGerarRelatorioAnormalidadePorAmostragemAction.do', this, document.forms[0].idLocalidadeInicial.value, 'Localidade Inicial');return isCampoNumerico(event);" />
                ...
                <tr>
					...
					<td colspan="3">
						...
						onkeypress="validaEnterDependencia(event, 'exibirGerarRelatorioAnormalidadePorAmostragemAction.do', this, document.forms[0].idLocalidadeFinal.value, 'Localidade Final');return isCampoNumerico(event);" />
				...
				<tr>
					...
					<td colspan="3">
						...
						onkeypress="validaEnterDependenciaComMensagem(event, 'exibirGerarRelatorioAnormalidadePorAmostragemAction.do', document.forms[0].quadraInicialNM, document.forms[0].codigoSetorComercialInicial.value, 'Setor Comercial Inicial','Quadra Inicial');return isCampoNumerico(event);"
						...
						<logic:present name="corQuadraOrigem">
						 	<logic:equal name="corQuadraOrigem" value="exception">
									<span style="color:#ff0000" id="msgOrigem"><bean:write name="GerarRelatorioAnormalidadePorAmostragemActionForm" property="quadraMensagemInicial"/></span>
							</logic:equal>	
			            </logic:present>	
				...
				<tr>
					...
					<td colspan="3">
						...
						onkeypress="validaEnterDependenciaComMensagem(event, 'exibirGerarRelatorioAnormalidadePorAmostragemAction.do', document.forms[0].quadraFinalNM, document.forms[0].codigoSetorComercialFinal.value, 'Setor Comercial Final','Quadra Final');return isCampoNumerico(event);"
						tabindex="9"  />
						<logic:present name="corQuadraDestino">
						 	<logic:equal name="corQuadraDestino" value="exception">
									<span style="color:#ff0000" id="msgQuadraDestino"><bean:write name="GerarRelatorioAnormalidadePorAmostragemActionForm" property="quadraMensagemFinal"/></span>
							</logic:equal>	
			            </logic:present>
				...
				<tr>
					<td width="190"><strong>Percentual da Amostra :<font color="#FF0000">*</font></strong></td>
					<td colspan="3">
						<html:text maxlength="3" 
								   property="amostragem" 
								   size="4"
								   onkeypress="return isCampoNumerico(event);"
								   onkeyup="javascript:validaAmostragem(this);"
								   tabindex="8" /> 
					</td>
				</tr>
				...
				<tr>
					<td>
						<input name="Button" 
							   ...
							   value="Limpar" 
							   align="left"
							   onclick="window.location.href='/gsan/exibirGerarRelatorioAnormalidadePorAmostragemAction.do?menu=sim'" tabindex="17">
						<input type="button" 
							   name="ButtonCancelar" 
							   class="bottonRightCol" 
							   value="Cancelar" 
