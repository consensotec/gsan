...
<script language="JavaScript">
	...
	function adicionarParametroEncontrado(form) {
		...
		if (validateParametrosPerdasFiscaisActionForm(form)) {
		 form.action = "exibirManterParametrosPerdasFiscaisAction.do?adicionarParametroEncontrado=S";
		 submeterFormPadrao(form);
		}
	}

	function pesquisarParametroInformado(form){
		document.forms[0].target = '';
		form.action = "exibirManterParametrosPerdasFiscaisAction.do?pesquisarParametroInformado=S";
		submeterFormPadrao(form);
	}

	function manterParametroEncontrado(form){
		document.forms[0].target = '';
		if (validateParametrosPerdasFiscaisActionForm(form)) {
			form.action = "manterParametrosPerdasFiscaisAction.do";
			submeterFormPadrao(form);
		}
	}
	...
	function habilitarDesabilitarCampos(){
		...
		if(form.anoMesReferenciaContabil.value == ''){

			form.valorABaixar.disabled = true;
			form.valorLimite.disabled = true;
			form.numeroMeses.disabled = true;
			form.situacaoCobranca.disabled = true;
		}else {
			form.valorABaixar.disabled = false;
			form.valorLimite.disabled = false;
			form.numeroMeses.disabled = false;
			form.situacaoCobranca.disabled = false;
			form.anoMesReferenciaContabil.readOnly = true;
		}
	}

	function habilitarValorMaximo() {
		var form = document.forms[0];
		if (form.valorABaixar.value!="") {
			formataValorMonetario(form.valorABaixar, 13);
			}
		} 	
...
<body leftmargin="5" topmargin="5" onload="javascript:habilitarDesabilitarCampos(); habilitarValorMaximo(); ">

	<html:form action="exibirManterParametrosPerdasFiscaisAction"
		name="ParametrosPerdasFiscaisActionForm"
		type="gsan.gui.financeiro.ParametrosPerdasFiscaisActionForm"
				...
				<td valign="top" class="centercoltext">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td class="parabg">Manter Parâmetros de Perdas Fiscais</td>
					...
					<table width="100%" border="0">
						<tr>
							<td colspan="3">Para atualizar parâmetros de perdas fiscais,
								informe a referência (mês/ano):</td>
						</tr>
						...
						<tr>
							...
							<td colspan="2"><html:text maxlength="7"
									...
									onkeypress="return isCampoNumerico(event);" size="5"
						...
						<tr>
							<td colspan="3" align="right"><input type="button"
								name="Button" class="bottonRightCol" value="Pesquisar"
								align="right" onKeyPress="javascript:habilitarDesabilitarCampos();"
								onClick="pesquisarParametroInformado(document.forms[0]);" /></td>
						</tr>
						...
						<tr>
							...
							<td colspan="2"><html:text property="valorABaixar"
									...
									onblur="formataValorMonetario(this, 13);" maxlength="13"
									size="15" />
						</tr>
						...
						<tr>
							...
							<td colspan="2"><html:text property="numeroMeses"  onclick="javascript:habilitarCampos();"
							...
							<td colspan="4">
								<table width="100%" border="0" bgcolor="90c7fc">
									...
									<logic:present name="parametrosPerdasFiscaisHelper">
                                       ...
                                       <logic:notEmpty name="parametrosPerdasFiscaisHelper"
												...
												<td width="10%">
													<div align="center">
														<font color="#333333"> <img width="14" height="14"
															...
															onclick="javascript:document.forms[0].target='';if(confirm('Confirma remoção?')){redirecionarSubmit('exibirManterParametrosPerdasFiscaisAction.do?removerSituacaoSelecionada=S&idParametroRemover=<bean:write name="parametrosPerdasFiscaisItensHelper" property="valorLimite"/>');}" />
														</font>
													</div>
												</td>
						...
						<tr>
							<td colspan="2"><input name="Button" type="button"
								...
								onclick="window.location.href='<html:rewrite page="/exibirManterParametrosPerdasFiscaisAction.do?menu=sim"/>'">
							...
							<td align="right" height="24"><input type="button"
								name="Button" class="bottonRightCol" value="Manter"onClick="manterParametroEncontrado(form)">
							</td>
