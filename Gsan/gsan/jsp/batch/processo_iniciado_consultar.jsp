									...
									<tr bgcolor="#FFFFFF">
										...
										<div align="left"><html:link
											...
											<bean:write name="processoIniciado"
												...
												<logic:notEmpty name="processoIniciado" property="complementoProcesso">
                                           		- <bean:write name="processoIniciado" property="complementoProcesso" />
                                           </logic:notEmpty>
										</html:link></div>
										</td>
										<td>
										...
										<td>
										<div align="left">
											<bean:write name="processoIniciado" property="processoSituacao.descricao" />
										</div>
										</td>
									</tr>
