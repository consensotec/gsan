...
<%@ page import="gsan.cadastro.funcionario.Funcionario"%>
<%@ page import="gsan.seguranca.acesso.usuario.Usuario"%>
<%@ page import="gsan.seguranca.acesso.PermissaoEspecial"%>
...
<html:form action="/exibirIncluirPermissaoEspecialAction"
	...
	type="gsan.gui.seguranca.acesso.usuario.IncluirPermissaoEspecialActionForm"
	method="post">
