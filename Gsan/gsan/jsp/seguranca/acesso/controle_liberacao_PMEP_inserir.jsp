...
<html:form action="/inserirControleLiberacaoPMEPAction.do" method="post" name="ExibirInserirControleLiberacaoPMEPActionForm" type="gsan.gui.seguranca.acesso.ExibirInserirControleLiberacaoPMEPActionForm" onsubmit="return validateExibirInserirControleLiberacaoPMEPActionForm(this);">
