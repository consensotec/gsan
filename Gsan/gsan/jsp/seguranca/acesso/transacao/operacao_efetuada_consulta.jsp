...
<%@ page import="java.util.Collection,java.util.HashMap,java.util.Iterator,gsan.util.ConstantesSistema" %>
...
//				}
            ...
            <logic:notPresent name="nomeUsuario">
            	...
            	if (((OperacaoEfetuada)operacaoEfetuada).getUsuarioAlteracoes() != null && !((OperacaoEfetuada)operacaoEfetuada).getUsuarioAlteracoes().isEmpty()) {
            		out.print(((gsan.seguranca.acesso.usuario.UsuarioAlteracao)((OperacaoEfetuada)operacaoEfetuada).getUsuarioAlteracoes().iterator().next()).getUsuario().getNomeUsuario());
               	}
                 %>
                </div></td>
            </logic:notPresent>
