...
<%@ page import="gsan.seguranca.transacao.TabelaLinhaAlteracao"%>
...
<html:form action="/FiltrarOperacaoEfetuadaAction" method="post"
	...
	<logic:notPresent name="icImovel" scope="session">
	<logic:notPresent name="icCliente" scope="session">
...
%>							
			...
			<table width="100%" border="0">
				...
				<logic:notPresent name="icImovel" scope="session">
					...
					<logic:notPresent name="icCliente" scope="session">
						<td>
							<input name="adicionar" class="bottonRightCol" value="Voltar"
								onclick="window.history.back();" type="button">
						</td>
						<td>&nbsp;</td>
					</logic:notPresent>
					
					<logic:present name="icCliente" scope="session">
						...
						<td align="right">
							<input name="adicionar" class="bottonRightCol" value="Fechar"
								onclick="window.close();" type="button"></td>
					</logic:present>
				</logic:notPresent>
				
				
				<logic:present name="icImovel" scope="session">
					<td>
						<input name="adicionar" class="bottonRightCol" value="Fechar"
							onclick="window.close();" type="button"></td>
					<td>&nbsp;</td>
