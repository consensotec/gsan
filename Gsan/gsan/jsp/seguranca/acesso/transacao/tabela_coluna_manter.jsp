...
<%@ page import="gsan.seguranca.transacao.Tabela"%>
<%@ page import="gsan.seguranca.transacao.TabelaColuna"%>
<%@ page import="gsan.seguranca.acesso.OperacaoTabela"%>
<%@ page import="gsan.seguranca.acesso.Operacao"%>
