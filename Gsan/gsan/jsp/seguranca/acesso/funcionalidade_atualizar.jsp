...
<%@page import="gsan.seguranca.acesso.Funcionalidade"%>
<%@page import="gsan.seguranca.acesso.FuncionalidadeDependencia"%>
...
<html:form action="/atualizarFuncionalidadeAction" method="post"
	...
	type="gsan.gui.seguranca.acesso.AtualizarFuncionalidadeActionForm"
