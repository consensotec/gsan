	...
	<tr>
		...
		<table width="100%" cellpadding="0" cellspacing="0">
			...
			<tr bordercolor="#000000">
				...
				<td width="30%" align="center" bgcolor="#90c7fc"><strong>Categoria Superior</strong></td>
				<td width="30%" align="center" bgcolor="#90c7fc"><strong>Modulo</strong></td>			
			</tr>
			<tr>
				<td colspan="5">
								...
								<%	}	%>
									...
									<td width="30%" align="center">
										<a href="javascript:enviarDados('<bean:write name="categoriaFuncionalidade" property="id"/>', '
											<bean:write name="categoriaFuncionalidade" property="nome"/>', 'categoriaFuncionalidade');">
										<bean:write name="categoriaFuncionalidade" property="nome"/>
									</td>
									
									<td width="30%" align="center">
										<logic:notEmpty name="categoriaFuncionalidade" property="funcionalidadeCategoriaSuperior">
											<bean:write name="categoriaFuncionalidade" property="funcionalidadeCategoriaSuperior.nome"/>
										</logic:notEmpty>
										<logic:empty name="categoriaFuncionalidade" property="funcionalidadeCategoriaSuperior">
											&nbsp;
										</logic:empty>
									</td>
		...
		<table width="100%" border="0">
			...
			<tr>
				<td height="24"><input type="button" class="bottonRightCol"
					...
					onclick="window.location.href='/gsan/exibirPesquisarCategoriaFuncionalidadeAction.do'"/></td>
			</tr>
		</table>
		</td>
	</tr>
