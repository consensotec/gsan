...
<html:javascript staticJavascript="false"
	formName="FiltrarAlteracaoTipoActionForm" dynamicJavascript="true" />
<script language="JavaScript"
...
<script language="JavaScript">
	...
	function validarForm(formulario){
		if(validateFiltrarAlteracaoTipoActionForm(formulario)){
...
<html:form action="/filtrarAlteracaoTipoAction"
	name="FiltrarAlteracaoTipoActionForm"
	type="gsan.gui.seguranca.acesso.FiltrarAlteracaoTipoActionForm"
	method="post"
	onsubmit="return validateFiltrarAlteracaoTipoActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Tipo de Altera&ccedil;&atilde;o</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para filtrar um tipo de altera&ccedil;&atilde;o, informe os dados
					abaixo:</td>
		       ...
		       <tr>
				...
				<tr>
					<td><input name="Button" type="button" class="bottonRightCol"
						...
						onclick="window.location.href='/gsan/exibirFiltrarAlteracaoTipoAction.do?menu=sim'"
						tabindex="8"></td>
