...
<script language="JavaScript">
    ...
    function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
      ...
      var form = document.AdicionarFuncionalidadeDependenciaActionForm;

       if (tipoConsulta == 'funcionalidade') {
        form.comp_id.value = codigoRegistro;
	...
	if(testarCampoValorZero(document.AdicionarFuncionalidadeDependenciaActionForm.comp_id, 'Funcionalidade')) {
	...
	function chamarReload(){
		...
		chamarSubmitComUrlSemUpperCase('/gsan/exibirInserirFuncionalidadeAction.do');
	}
...
<html:form action="/adicionarFuncionalidadeDependenciaAction"
	...
	type="gsan.gui.seguranca.acesso.AdicionarFuncionalidadeDependenciaActionForm"
	method="post">
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="3"><html:text property="comp_id" size="4"
						...
						onkeypress="return validaEnter(event, 'exibirAdicionarFuncionalidadeDependenciaAction.do?objetoConsulta=1', 'comp_id');" />
