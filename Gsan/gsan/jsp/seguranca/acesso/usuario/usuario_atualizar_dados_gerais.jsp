...
<%@ page import="gsan.seguranca.acesso.usuario.UsuarioTipo,gsan.cadastro.empresa.Empresa"%>
...
<script language="JavaScript">
    ...
    function DateValidations () { 
     	...
     	this.ab = new Array("dataFinal", "Data de Cadastramento Final não é uma data válida.", new Function ("varName", "this.datePattern='dd/MM/yyyy';  return this[varName];"));
     	this.ac = new Array("dataNascimento", "Data de Nascimento não é uma data válida.", new Function ("varName", "this.datePattern='dd/MM/yyyy';  return this[varName];"));
    } 
			...
			<table border="0" width="100%">
				<tbody>
					...
					<tr>
						...
						<td width="74%"><html:text property="cpf" size="12" onkeypress="return isCampoNumerico(event);"
							maxlength="11" /></td>
					</tr>
					<tr>
						...
						<td><html:text property="dataNascimento" 
							...
							onkeypress="return isCampoNumerico(event);" /> <a id="dataNascimento"
					...
					<tr>
						...
						<td width="74%"><html:text maxlength="9" property="idLotacao"
							size="9"
							onkeypress="javascript: validaEnterSemUpperCase(event, 'exibirAtualizarUsuarioDadosGeraisAction.do', 'idLotacao'); 
					...
					<tr>
						...
						&nbsp; 
							...
							<a href="javascript:abrirCalendario('AtualizarUsuarioDadosGeraisActionForm', 'dataFinal')">
