...
<%@page import="gsan.seguranca.acesso.usuario.SolicitacaoAcesso"%>
<%@page import="gsan.seguranca.acesso.usuario.SolicitacaoAcessoSituacao"%>
									...
									<logic:iterate name="colecaoSolicitacaoAcesso"
										...
										<pg:item>
											...
											<tr bgcolor="#FFFFFF">
												...
												<td width="7%">
													<div align="center">
														<%if (solicitacaoAcesso.getSolicitacaoAcessoSituacao().getCodigoSituacao().compareTo(SolicitacaoAcessoSituacao.AG_AUTORIZAÇÃO_SUP) == 0) {%>
															<input type="checkbox"
