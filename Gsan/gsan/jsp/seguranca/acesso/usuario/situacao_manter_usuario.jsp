...
<html:form action="/excluirSituacaoUsuarioAction"
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img src="imagens/parahead_left.gif"
						...
						border="0" /></td>
					<td class="parabg">Manter Situa&ccedil;&atilde;o do Usu&aacute;rio</td>
			...
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="5" height="23"><font color="#000000"
						...
						face="Verdana, Arial, Helvetica, sans-serif"><strong>Situações do
					Usuário Encontradas:</strong></font></td>
				</tr>
				<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#99CCFF">
								<tr bordercolor="#000000" bgcolor="#90c7fc">
									...
									<td bgcolor="#90c7fc">
									<div align="center"><strong>Indicador de Uso Exclusivo do
									Sistema</strong></div>
									</td>
									<td bgcolor="#90c7fc">
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<pg:param name="pg" />
									<pg:param name="q" />
									<logic:present name="colecaoSituacaoUsuario">
										<%int cont = 0;%>
										<logic:iterate name="colecaoSituacaoUsuario"
											id="usuarioSituacao" scope="session">
											<pg:item>
												<%cont = cont + 1;
			if (cont % 2 == 0) {%>
												<tr bgcolor="#FFFFFF">
												...
												<tr bgcolor="#cbe5fe">
													...
													<div align="center"><input type="checkbox"
														name="idRegistrosRemocao" value="${usuarioSituacao.id}"></div>
													</td>



													<td width="12%" align="center">${usuarioSituacao.id}</td>
													<td>
													<div align="center"><html:link
														page="/exibirAtualizarSituacaoUsuarioAction.do"
														paramName="usuarioSituacao" paramProperty="id"
														paramId="idRegistroAtualizacao">
									                            ${usuarioSituacao.descricaoUsuarioSituacao}    
							                              </html:link></div>
													</td>
													<td width="20%">
													<div align="center">${usuarioSituacao.descricaoAbreviada}</div>
													</td>
													<td width="25%">
													<div align="center"><c:if
														test="${usuarioSituacao.indicadorUsoSistema eq 1}">
														<div align="center">SIM</div>
													</c:if> <c:if
														test="${usuarioSituacao.indicadorUsoSistema eq 2}">
														<div align="center">NÃO</div>
													</c:if></div>
													</td>
													<td width="30%">
													<div align="center"><c:if
														test="${usuarioSituacao.indicadorUso eq 1}">
														<div align="center">SIM</div>
													</c:if> <c:if test="${usuarioSituacao.indicadorUso eq 2}">
														<div align="center">NÃO</div>
													</c:if></div>
