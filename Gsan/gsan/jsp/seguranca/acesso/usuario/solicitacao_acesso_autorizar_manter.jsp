...
<html:form action="/autorizarSolicitacaoAcessoAction"
	name="ManutencaoRegistroActionForm"
	type="gsan.gui.ManutencaoRegistroActionForm" method="post"
	onsubmit="return CheckboxNaoVazio(document.ManutencaoRegistroActionForm.idRegistrosAutorizar) && confirm('Confirmar Autorização?')">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Solicitação de Acesso</td>
								...
								<tr>
									<td>
										...
										<input name="button" type="button"
											   ...
											   onclick="window.location.href='<html:rewrite page="/exibirFiltrarSolicitacaoAcessoAction.do?objeto=autorizar&limpar=S"/>'"
