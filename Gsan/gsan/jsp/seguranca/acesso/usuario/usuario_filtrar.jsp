...
<%@ page import="gsan.seguranca.acesso.usuario.UsuarioTipo"%>
<%@ page import="gsan.seguranca.acesso.usuario.UsuarioAbrangencia,gsan.cadastro.empresa.Empresa"%>
			...
			<table border="0" width="100%">
				...
				<tr>
					...
					<td width="74%"><html:text maxlength="9" property="idFuncionario"
						size="9"
						onkeypress="javascript:validaEnter(event, 'exibirFiltrarUsuarioAction.do', 'idFuncionario'); 
				...
				<tr>
					...
					<td width="74%"><html:text maxlength="9" property="idLotacao"
						size="9"
						onkeypress="javascript:validaEnter(event, 'exibirFiltrarUsuarioAction.do', 'idLotacao'); 
												return isCampoNumerico(event);"
				...
				<tr>
					...
					<td width="74%"><html:text maxlength="9"
						...
						onkeypress="javascript: limparLocalidade(); validaEnterComMensagem(event, 'exibirFiltrarUsuarioAction.do', 'idElo','Elo Pólo'); 
												return isCampoNumerico(event); "
						onkeyup="javascript: limpaCampoPesquisa(document.forms[0].nomeElo); " /> <a
				...
				<tr>
					...
					<td width="74%"><html:text property="idLocalidade" size="5"
						maxlength="3"
						onkeypress="javascript: validaEnterComMensagem(event, 'exibirFiltrarUsuarioAction.do', 'idLocalidade', 'Localidade'); 
												return isCampoNumerico(event);"
						onkeyup="javascript: limpaCampoPesquisa(document.forms[0].nomeLocalidade);" />
					<a
