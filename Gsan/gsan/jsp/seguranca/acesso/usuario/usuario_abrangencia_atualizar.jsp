...
<html:form action="/atualizarAbrangenciaUsuarioAction"
	name="AtualizarAbrangenciaUsuarioActionForm"
	type="gsan.gui.seguranca.acesso.usuario.AtualizarAbrangenciaUsuarioActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Abrang&ecirc;ncia do Usu&aacute;rio</td>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td width="380"><html:text property="id" size="4" maxlength="4" />
					</td>
				</tr>
				...
				<tr>
					...
					<td width="380"><html:text property="descricao" size="30"
						maxlength="30" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<div align="left"><strong> <html:select
						property="usuarioAbrangenciaSuperior">
						<html:option value="-1">&nbsp;</html:option>
						<html:options collection="colecaoAbrangenciaSuperior"
				...
				<tr>
					<td><strong> <font color="#FF0000"></font></strong></td>
					<td align="right"><input type="Submit" name="Submit2"
