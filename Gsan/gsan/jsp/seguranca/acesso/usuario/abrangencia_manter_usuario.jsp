			...
			<table width="100%" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="5" height="23"><font color="#000000"
						...
						face="Verdana, Arial, Helvetica, sans-serif"><strong>Abrangências
					do Usuário Cadastradas:</strong></font></td>
				</tr>
				<tr>
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#99CCFF">
								<tr bordercolor="#000000" bgcolor="#90c7fc">
									...
									<td bgcolor="#90c7fc">
									<div align="center"><strong>Abrangência Superior</strong></div>
									</td>
									<td bgcolor="#90c7fc">
