...
<div id="formDiv"><html:form action="/atualizarSolicitacaoAcessoAction.do"
	name="AtualizarSolicitacaoAcessoActionForm"
	type="gsan.gui.seguranca.acesso.usuario.AtualizarSolicitacaoAcessoActionForm"
	method="post">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Solicitação de Acesso</td>
					<td width="11"><img border="0"
				...
				<tr>
                   ...
                   <td width="74%" height="24" colspan="3">
                   		<html:text maxlength="8" 
                   				   ...
                   				   size="8"  
                   				   tabindex="1" 
                   				   onkeypress="javascript:validaEnter(event, 'exibirAtualizarSolicitacaoAcessoAction.do?objetoConsulta=2', 'idFuncionario'); reloadTipoUsuario(); return isCampoNumerico(event);"
                   		/>
