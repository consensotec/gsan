						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								<tr bordercolor="#FFFFFF" bgcolor="#79BBFD">
									...
									<td width="10%">
										<div align="center"><strong>Data da Autorização</strong></div>
									</td>
									...
									<logic:iterate name="colecaoSolicitacaoAcesso"
										...
										<pg:item>
											...
											<tr bgcolor="#FFFFFF">
												...
												<td width="10%" align="center">
													<bean:write name="solicitacaoAcesso" property="dataAutorizacao" format="dd/MM/yyyy" />
												</td>
												...
												<td width="25%">
													<html:link href="/gsan/exibirInserirUsuarioAction.do?filtrar=sim"
														   	   paramId="idRegistroCadastrar" 
														       paramProperty="id"
								...
								<tr>
									<td>
										...
										<input name="button" type="button"
											   ...
											   onclick="window.location.href='<html:rewrite page="/exibirFiltrarSolicitacaoAcessoAction.do?objeto=cadastrar&limpar=S"/>'"
