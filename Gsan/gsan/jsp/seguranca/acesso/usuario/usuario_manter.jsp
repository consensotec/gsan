	   ...
	   if(!achou){
	    if(ids.checked){
	     ...
	     submeterFormPadrao(form);
	      ...
	      alert('Selecione um usuario para efetuar o controle de acessos.');
	    }
	   }else{
...
<html:form action="/removerUsuarioAction"
	...
	type="gsan.gui.seguranca.acesso.usuario.ExcluirUsuarioActionForm"
	method="post"
				...
				<tr>
					...
					<table border="0" bgcolor="#99CCFF" width="100%">
						<tr bordercolor="#000000">
							...
							<div align="center"><strong>Data de Expira&ccedil;&atilde;o do
							Acesso</strong></div>
							</td>
								...
								<logic:iterate name="collectionUsuariosGrupos" id="usuarioGrupo">
									...
									%>
										<tr bgcolor="#FFFFFF">
											...
											<td width="19%">
											<div align="center"><bean:write name="usuarioGrupo"
												property="dataExpiracaoAcesso" formatKey="date.format" /></div>
											</td>
										</tr>
									</pg:item>
								</logic:iterate>
