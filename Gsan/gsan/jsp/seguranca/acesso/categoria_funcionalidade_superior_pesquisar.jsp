...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js">
	</script><html:javascript staticJavascript="false"  formName="PesquisarCategoriaSuperiorActionForm"/>
...
<script language="JavaScript">
	...
	function validarForm(){
    	...
    	if(validatePesquisarCategoriaSuperiorActionForm(form)){
   			form.submit();
	  	}
    }
    ...
    function submitForm() {
    	...
    	form.action = 'exibirPesquisarCategoriaSuperiorAction.do';
    	form.submit();
    }
...
<body leftmargin="0" topmargin="0"
	onload="window.focus();resizePageSemLink(620, 330);javascript:setarFoco('${requestScope.nomeCampo}');">

<html:form action="/pesquisarCategoriaSuperiorAction" method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Pesquisar Categoria da Funcionaliadde Superior</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					<td colspan="2">Preencha o campo para pesquisar uma categoria superior:</td>
			...
			<table width="100%" border="0">
				...
				<tr >
					<td align="left" colspan="2">
						...
						&nbsp;	
						<logic:present name="caminhoRetornoTelaPesquisa">
				          		<input type="button" 
				          			class="bottonRightCol" 
				          			value="Voltar" 
				          			onclick="redirecionarSubmit('${caminhoRetornoTelaPesquisa}.do')"/>
				         </logic:present>
					</td>
