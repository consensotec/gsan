...
<html:javascript staticJavascript="false"
	formName="AtualizarAlteracaoTipoActionForm" />

<SCRIPT LANGUAGE="JavaScript">
<!--

function validarForm(formulario){
if(validateAtualizarAlteracaoTipoActionForm(formulario)){
...
<html:form action="/atualizarAlteracaoTipoAction.do" method="post">

	<INPUT TYPE="hidden" name="removerAlteracaoTipo">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Tipo de Altera&ccedil;&atilde;o</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para Atualizar um tipo de altera&ccedil;&atilde;o, informe os
					dados abaixo:</td>
				<tr>
					<td><strong>C&oacute;digo:</strong></td>
					<td><html:hidden property="id" /> <bean:write
						name="AtualizarAlteracaoTipoActionForm" property="id" /></td>
				</tr>
