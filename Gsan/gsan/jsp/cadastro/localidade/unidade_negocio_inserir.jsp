...
<html:javascript staticJavascript="false"
	formName="InserirUnidadeNegocioActionForm" />
<script language="JavaScript"
...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if (validateInserirUnidadeNegocioActionForm(form)){
	...
	function limparForm() {
		var form = document.InserirUnidadeNegocioActionForm;
		form.nome.value = "";
		...
		if(objetoRelacionado.disabled != true){
			if (objeto == null || codigoObjeto == null){
				...
				if (codigoObjeto.length < 1 || isNaN(codigoObjeto)){
					...
					abrirPopup(url + "?" + "tipo=" + tipo + "&" + objeto + "=" + codigoObjeto + "&menu=sim&caminhoRetornoTelaPesquisa=" + tipo, altura, largura);
				}
			}
		}
	}
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	    ...
	    if (tipoConsulta == 'cliente') {
	    	form.idCliente.value = codigoRegistro;
	      	form.action='exibirInserirUnidadeNegocioAction.do';
	      	form.submit();
	    }
...
<html:form action="/inserirUnidadeNegocioAction.do"
	name="InserirUnidadeNegocioActionForm"
	type="gsan.gui.cadastro.localidade.InserirUnidadeNegocioActionForm"
	method="post"
	onsubmit="return validateInserirUnidadeNegocioActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Unidade de Negócio</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td colspan="2">Para adicionar uma unidade de negócio, informe os
					dados abaixo:</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2"><html:text property="idCliente" size="10"
						...
						onkeypress="validaEnterComMensagem(event, 'exibirInserirUnidadeNegocioAction.do', 'idCliente', 'Cliente');" />
						<a href="javascript:chamarPopup('exibirPesquisarClienteAction.do', 'cliente', null, null, 800, 490, '',document.forms[0].idCliente);">
					<img title="Pesquisar Gerente da Unidade de Negócio" src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23" height="21" alt="Pesquisar" border="0"></a> 
				...
				<tr>
					...
					<td colspan="2"><html:text property="idGerenciaRegional" size="10"
						...
						onkeypress="validaEnterComMensagem(event, 'exibirInserirUnidadeNegocioAction.do', 'idGerenciaRegional', 'Cliente');" />
					<a href="javascript:chamarPopup('exibirPesquisarGerenciaRegionalAction.do', 'gerenciaRegional', null, null, 800, 490, '',document.forms[0].idGerenciaRegional);">
					<img title="Pesquisar Gerencial Regional" src="<bean:message key='caminho.imagens'/>pesquisa.gif" width="23" height="21" alt="Pesquisar" border="0"></a> 
				...
				<!--<tr>
					...
					<td><html:radio property="indicadorUso" tabindex="6" value="1" /><strong>Sim</strong>
					<html:radio property="indicadorUso" tabindex="7" value="2" /><strong>Não</strong>
					</td>
					<td>&nbsp;</td>
				</tr>
				--><tr>
