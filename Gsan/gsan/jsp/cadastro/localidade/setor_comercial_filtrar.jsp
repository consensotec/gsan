...
<html:javascript staticJavascript="false"
	formName="PesquisarFiltrarSetorComercialActionForm" />
...
<body leftmargin="5" topmargin="5"
	onload="javascript:verificarChecado('${sessionScope.indicadorAtualizar}');setarFoco('${requestScope.nomeCampo}');">
		...
		<table width="770" border="0" cellspacing="5" cellpadding="0">
			<tr>
				...
				<td width="625" valign="top" class="centercoltext">
					...
					<table width="100%" border="0">
						<tr>
							<td>Para atualizar um setor comercial, informe os dados
								abaixo:</td>
							<td width="84"><input type="checkbox"
								name="indicadorAtualizar" value="1" /><strong>Atualizar</strong>
							</td>
							<logic:present scope="application" name="urlHelp">
								<td align="right"><a
									href="javascript:abrirPopupHelp('${applicationScope.urlHelp}cadastroLocalizacaoSetorComercialFiltrar', 500, 700);"><span
					...
					<table width="100%" border="0">
						<tr>
							<td width="183" HEIGHT="30"><strong>Localidade:
							</td>
							<td width="432"><html:text property="localidadeID" size="5"
									maxlength="3" onkeyup="limpar(5);" tabindex="1"
									onkeypress="limpar(4);validaEnterComMensagem(event, 'exibirFiltrarSetorComercialAction.do?objetoConsulta=1', 'localidadeID', 'Localidade');" />
								<a
								href="javascript:abrirPopup('exibirPesquisarLocalidadeAction.do?indicadorUsoTodos=1', 250, 495);"><img
									...
									<logic:empty name="PesquisarFiltrarSetorComercialActionForm"
										property="localidadeID">
										<html:text property="localidadeNome" value="" size="45"
											readonly="true"
											style="background-color:#EFEFEF; border:0; color: #ff0000" />
									</logic:empty>
									<logic:notEmpty name="PesquisarFiltrarSetorComercialActionForm"
										property="localidadeID">
										<html:text property="localidadeNome" size="45" readonly="true"
											style="background-color:#EFEFEF; border:0; color: #000000" />
									</logic:notEmpty>
						...
						<tr>
							<td HEIGHT="30"><strong>C&oacute;digo do Setor
									Comercial:
							</td>
						...
						<tr>
							<td HEIGHT="30"><strong>Nome do Setor Comercial:
							</td>
							<td><html:text maxlength="30" property="setorComercialNome"
									size="45" tabindex="3" /></td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						...
						<tr>
							<td HEIGHT="30"><strong>Munic&iacute;pio:
							</td>
							<td><html:text property="municipioID" size="5" maxlength="4"
									onkeyup="limpar(6);" tabindex="4"
									onkeypress="validaEnterComMensagem(event, 'exibirFiltrarSetorComercialAction.do?objetoConsulta=3', 'municipioID', 'Município');" />
								<a
								href="javascript:abrirPopup('exibirPesquisarMunicipioAction.do?indicadorUsoTodos=1', 250, 495);"><img
									src="<bean:message key="caminho.imagens"/>pesquisa.gif"
									border="0" width="23" height="21" title="Pesquisar">
							</a> <logic:present name="corMunicipio">
								...
								</logic:notPresent> <a href="javascript:limpar(3);"> <img
									src="<bean:message key="caminho.imagens"/>limparcampo.gif"
									border="0" title="Apagar" /> </a></td>
						</tr>
						<tr>
							<td height="30"><strong>Indicador de uso:</strong>
							</td>
							<td><html:radio property="indicadorUso" value="1" /><strong>Ativo
									<html:radio property="indicadorUso" value="2" />Inativo</strong> <html:radio
									property="indicadorUso" tabindex="5" value="3" /><strong>Todos</strong>
							</td>
						</tr>
						<tr>
							<td height="30"><strong>Setor Alternativo:</strong>
							</td>
							<td><html:radio property="indicadorSetorAlternativo"
									value="1" /><strong>Sim <html:radio
										property="indicadorSetorAlternativo" value="2" />Não</strong> <html:radio
									property="indicadorSetorAlternativo" tabindex="5" value="3" /><strong>Todos</strong>
							</td>
						</tr>
						<tr>
							<td height="30"><strong>Setor Criado para Atualização Cadastral? <font color="#FF0000">*</font></strong>
							</td>
							<td><html:radio property="indicadorAtualizacaoCadastral"
									value="1" /><strong>Sim <html:radio
										property="indicadorAtualizacaoCadastral" value="2" />Não</strong> <html:radio
									property="indicadorAtualizacaoCadastral" tabindex="5" value="3" /><strong>Todos</strong>
							</td>
						</tr>
						<tr>
							...
							<td align="right"><gsan:controleAcessoBotao name="Button"
									...
									url="filtrarSetorComercialAction.do" /> <!-- 
		<INPUT type="button" onclick="validarForm(document.forms[0]);" name="botaoFiltrar" class="bottonRightCol" value="Filtrar" tabindex="5" style="width: 70px;"> -->
							</td>
						</tr>
					</table>
					<p>&nbsp;</p></td>
