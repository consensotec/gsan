...
<SCRIPT LANGUAGE="JavaScript">
	...
	function validarLocalidade() {
		...
		if (form.localidadeID.value == "") {
			...
			abrirPopup('exibirPesquisarSetorComercialAction.do?consulta=sim&idLocalidade='
	...
	function redirecionarSubmitAtualizar(idSetorComercial) {
		urlRedirect = "/gsan/exibirAtualizarSetorComercialAction.do?setorComercialID="
				+ idSetorComercial;
		redirecionarSubmit(urlRedirect);
	}
	...
	function remover(id) {
		...
		if (where_to == true) {
			form.action = 'exibirInserirSetorComercialAction.do?acao=R&idRemover='
					+ id;
			submeterFormPadrao(form);
		}
	}
			...
			<tr>
				...
				<td width="625" valign="top" class="centercoltext">
					...
					<table width="100%" border="0">
						<tr>
							<td colspan="2">Para adicionar o setor comercial, informe os
								dados abaixo:</td>
							<logic:present scope="application" name="urlHelp">
								<td align="right"><a
									href="javascript:abrirPopupHelp('${applicationScope.urlHelp}cadastroLocalizacaoSetorComercialInserir', 500, 700);"><span
					...
					<table width="100%" border="0">
						<tr>
							<td width="183"><strong>Localidade:<font
							...
							<td width="432"><html:text property="localidadeID" size="3"
								...
								href="javascript:abrirPopup('exibirPesquisarLocalidadeAction.do', 250, 495);">
									...
									<logic:equal name="corLocalidade" value="exception">
										<html:text property="localidadeNome" size="40" readonly="true"
									...
									<logic:empty name="PesquisarAtualizarSetorComercialActionForm"
										...
										<html:text property="localidadeNome" value="" size="40"
											readonly="true"
											style="background-color:#EFEFEF; border:0; color: #ff0000" />
									</logic:empty>
						...
						<tr>
							<td><strong>C&oacute;digo do Setor Comercial: <font
									color="#FF0000">*</font> </strong>
							</td>

							<td><html:text maxlength="3" property="setorComercialCD"
									size="3" tabindex="2"
									onkeyup="somente_numero_zero_a_nove(this);" />&nbsp; <a
								href="javascript:validarLocalidade();"> <img width="23"
									height="21" border="0"
						...
						<tr>
							<td><strong>Nome do Setor Comercial: <font
									color="#FF0000">*</font> </strong>
							</td>
						...
						<tr>
							<td><strong>Munic&iacute;pio: <font color="#FF0000">*</font>
							</strong>
							</td>
							...
							<td align="right">
								<div align="left">
									...
									<a
										...
										<img src="<bean:message key="caminho.imagens"/>pesquisa.gif"
										border="0" width="23" height="21" title="Pesquisar Município">
									</a>

									<logic:present name="corMunicipio">
										<logic:equal name="corMunicipio" value="exception">
											<html:text property="municipioNome" size="40" readonly="true"
												style="background-color:#EFEFEF; border:0; color: #ff0000" />
										</logic:equal>
										...
										<a href="javascript:limparMunicipio();"> <img
											src="<bean:message key="caminho.imagens"/>limparcampo.gif"
											border="0" title="Apagar Município" /> </a>
									</logic:present>
									...
									<logic:notPresent name="corMunicipio">
										<logic:empty name="PesquisarAtualizarSetorComercialActionForm"
											...
											<html:text property="municipioNome" size="40" value=""
												readonly="true"
												style="background-color:#EFEFEF; border:0; color: #ff0000" />
										</logic:empty>
						...
						<tr>
							<td><strong>Setor Alternativo? <font color="FF0000">*</font>
							</strong></td>
						...
						<tr>
							<td><strong>Setor Criado para Atualização
						...
						<tr>
							...
							<td><html:text maxlength="3" tabindex="1"
								...
								href="javascript:abrirPopup('exibirPesquisarTabelaAuxiliarAbreviadaAction.do?tela=fonteCaptacao',275,480);">
									...
									src="<bean:message key="caminho.imagens"/>limparcampo.gif"
									border="0" title="Apagar Fonte de Captação" /> </a>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2"><input type="button" name="Button"
								class="bottonRightCol" value="Desfazer" tabindex="6"
								...
								name="Button" class="bottonRightCol" value="Cancelar"
								tabindex="6"
