		...
		if (objeto == null || codigoObjeto == null) {
			...
			if (codigoObjeto.length < 1 || isNaN(codigoObjeto)) {
				...
				abrirPopup(url + "?" + "tipo=" + tipo + "&" + objeto + "="
						+ codigoObjeto + "&caminhoRetornoTelaPesquisaBairro="
						+ "/exibirInserirQuadra.do", altura, largura);
			}
		}
	}

	function abrirPopupQuadra(url, tipo, objeto, codigoObjeto, altura, largura,
			msg) {

		var form = document.forms[0];
		if (form.localidadeID.value.length < 1
				|| isNaN(form.localidadeID.value)) {
			alert('Informe Localidade.');
		} else if (form.setorComercialCD.value.length < 1
				|| isNaN(form.setorComercialCD.value)) {
			alert('Informe Setor Comercial.');
		} else {
			abrirPopup(url + "&codigoSetorComercial="
					+ form.setorComercialCD.value + "&idLocalidade="
					+ form.localidadeID.value, altura, largura);
		}
...
<html:javascript staticJavascript="true"
	formName="InserirQuadraActionForm" />
	...
	<!--
		function validarForm(formulario) {
			...
			if (validateInserirQuadraActionForm(formulario)) {
				...
				var objSetorComercialCD = returnObject(formulario,
						"setorComercialCD");
				var objSetorComercialID = returnObject(formulario,
						"setorComercialID");
				...
				} else if (objLocalidadeID.value.length > 0
						&& !testarCampoValorZero(objLocalidadeID, "Localidade")) {
					objLocalidadeID.focus();
				}
				if (objSetorComercialCD.value.length < 1) {
					alert("Informe Setor Comercial.");
					objSetorComercialCD.focus();
				} else if (objSetorComercialCD.value.length > 0
						&& !testarCampoValorZero(objSetorComercialCD,
								"Setor Comercial")) {
					objSetorComercialCD.focus();
				}
				if (objQuadraNM.value.length < 1) {
					...
					objQuadraNM.focus();
				} else if (objQuadraNM.value.length > 0
						&& !testarCampoValorZero(objQuadraNM, "Quadra")) {
					objQuadraNM.focus();
				}
		...
		function caracteresespeciais() {
			this.aa = new Array("localidadeID",
					"Localidade possui caracteres especiais.", new Function(
							"varName", " return this[varName];"));
			this.ab = new Array("setorComercialCD",
					"Setor Comercial possui caracteres especiais.",
					new Function("varName", " return this[varName];"));
			this.ac = new Array("quadraNM",
					"Quadra possui caracteres especiais.", new Function(
							"varName", " return this[varName];"));
			this.ad = new Array("rotaID", "Rota possui caracteres especiais.",
					new Function("varName", " return this[varName];"));
			this.ae = new Array("distritoOperacionalID",
					"Distrito Operacional possui caracteres especiais.",
					new Function("varName", " return this[varName];"));
			this.af = new Array("setorCensitarioID",
					"Setor Censitário possui caracteres especiais.",
					new Function("varName", " return this[varName];"));
		}

		function required() {
			this.aa = new Array("localidadeID", "Informe Localidade.",
					new Function("varName", " return this[varName];"));
			this.ab = new Array("setorComercialCD", "Informe Setor Comercial.",
					new Function("varName", " return this[varName];"));
			this.ac = new Array("quadraNM", "Informe Quadra.", new Function(
					"varName", " return this[varName];"));
			this.ad = new Array("rotaID", "Informe Rota.", new Function(
					"varName", " return this[varName];"));
		...
		function IntegerValidations() {
			this.aa = new Array("localidadeID",
					"Localidade deve somente conter números positivos.",
					new Function("varName", " return this[varName];"));
			this.ab = new Array("setorComercialCD",
					"Setor Comercial deve somente conter números positivos.",
					new Function("varName", " return this[varName];"));
			this.ac = new Array("quadraNM",
					"Quadra deve somente conter números positivos.",
					new Function("varName", " return this[varName];"));
			this.ad = new Array(
					"distritoOperacionalID",
					"Distrito Operacional deve somente conter números positivos.",
					new Function("varName", " return this[varName];"));
			this.ae = new Array("setorCensitarioID",
	...
	<!--
		...
		function removerQuadraFace(numeroQuadraFace) {
			...
			if (confirm("Confirma remoção?")) {
				...
				form.action = "/gsan/exibirInserirQuadraAction.do?numeroQuadraFace="
						+ numeroQuadraFace;
				submeterFormPadrao(form);
			}
		}
...
<logic:equal name="permissaoAdicionarQuadraFace" value="2">
	...
	<body leftmargin="5" topmargin="5"
		onload="atualizarDadosIndicador(document.forms[0]); setarFoco('${requestScope.nomeCampo}');">
		<!-- FIM- CASO A EMPRESA NÃO TRABALHE COM FACE DE QUADRA -->
</logic:equal>
					...
					<table width="100%" border="0">
						<tr>
							...
							<logic:present scope="application" name="urlHelp">
								<td align="right"><a
									href="javascript:abrirPopupHelp('${applicationScope.urlHelp}cadastroLocalizacaoQuadraInserir', 500, 700);"><span
									...
									<tr bgcolor="#cbe5fe">
										<td width="100%" align="center">
											...
											<table width="100%" border="0">
												...
												<tr>
													<td width="21%"><strong>Localidade:<font
															color="#FF0000">*</font> </strong>
													</td>
													<td><html:text property="localidadeID" size="5"
														...
														href="javascript:abrirPopup('exibirPesquisarLocalidadeAction.do', 250, 495);">
															...
															<logic:equal name="corLocalidade" value="exception">
																<html:text property="localidadeNome" size="45"
																	readonly="true"
												...
												<tr>
													...
													<td><html:text property="setorComercialCD" size="5"
														...
														href="javascript:chamarPopup('exibirPesquisarSetorComercialAction.do', 'setorComercialOrigem', 'idLocalidade', document.forms[0].localidadeID.value, 275, 480, 'Informe a Localidade');">
															...
															<logic:notEqual name="corSetorComercial"
																value="exception">
																<html:text property="setorComercialNome" size="45"
																	readonly="true"
																	style="background-color:#EFEFEF; border:0; color: #000000" />
															...
															<logic:empty name="InserirQuadraActionForm"
																...
																<html:text property="setorComercialNome" value=""
												...
												<tr>
													...
													<td><html:text property="quadraNM" size="5"
															tabindex="3"
												...
												<tr>
													...
													<td><html:hidden property="rotaID" /> <html:text
															property="codigoRota" size="5" maxlength="4"
															tabindex="18"
															...
															onkeyup="limpar(12);somente_numero_zero_a_nove(this);" />
														<a
								...
								<table width="100%" align="center" bgcolor="#90c7fc" border="0">
									...
									<tr bgcolor="#cbe5fe">
										<td width="100%" align="center">
											...
											<table width="100%" border="0">
												<tr>
													<td width="21%"><strong>Incrementar Lote:</strong>
													</td>
												...
												<logic:equal name="permissaoAdicionarQuadraFace" value="2">
													...
													<tr>
														...
														<td><html:radio property="indicadorRedeAguaAux"
																...
																Sem Rede de Água <html:radio
																	property="indicadorRedeAguaAux" value="2" tabindex="6"
																	onclick="verificarMarcacao(2, 'Agua');habilitacaoDistritoOperacional(document.forms[0].indicadorRedeAguaAux);" />
																Com Rede de Água <html:radio
																	property="indicadorRedeAguaAux" value="3" tabindex="7"
																	onclick="verificarMarcacao(3, 'Agua');habilitacaoDistritoOperacional(document.forms[0].indicadorRedeAguaAux);" />
																Rede de Água Parcial</strong></td>
													</tr>
													<tr>
														<td><strong>Rede de Esgoto:</strong>
														</td>
														<td><html:radio property="indicadorRedeEsgotoAux"
																...
																Rede de Esgoto Parcial</strong></td>
													</tr>
													...
													<tr>
														...
														<td><html:text property="distritoOperacionalID"
																...
																onkeyup="limpar(10);somente_numero_zero_a_nove(this);" />
															<a
															href="javascript:abrirPopup('exibirPesquisarDistritoOperacionalAction.do?limparForm=sim',275,480);">
																...
																src="<bean:message key="caminho.imagens"/>limparcampo.gif"
																border="0" title="Apagar Distrito Operacional" /> </a></td>
													</tr>
													<tr>
														<!--<table>
															<tr>-->
																<td width="25%"><strong>Quadra Criada para Atualização
																		Cadastral? <font color="FF0000">*</font>
																</strong>
																</td>
																<td width="75%"><html:radio
									...
									<tr bgcolor="#cbe5fe">
										<td width="100%" align="center">
											...
											<table width="100%" border="0">
												...
												<tr>
													<td width="21%"><strong>Setor Censitário:</strong>
													</td>
													<td><html:text property="setorCensitarioID" size="5"
														...
														href="javascript:abrirPopup('exibirPesquisarTabelaAuxiliarAction.do?tela=ibgeSetorCensitario',275,480);">
															...
															src="<bean:message key="caminho.imagens"/>limparcampo.gif"
															border="0" title="Apagar Setor Censitário" /> </a>
													</td>
												</tr>
									...
									<table width="100%" border="0">
										<tr>
											<td height="17" colspan="3"><strong>Face(s) da
													quadra:<font color="#FF0000">*</font> </strong>
											</td>
											<td align="right"><input type="button"
												class="bottonRightCol" value="Adicionar" tabindex="11"
												style="width: 80px"
												onclick="javascript:abrirPopup('exibirAdicionarQuadraFaceAction.do?acao=inserir&telaRetorno=exibirInserirQuadraAction', 295, 450);">
											</td>
										</tr>
											...
											+ quadraFace.getNumeroQuadraFace()
													.intValue()%>')">
																					...
																					<td width="10%" align="center"><a
																						href="javascript:abrirPopup('exibirAdicionarQuadraFaceAction.do?acao=atualizar&telaRetorno=exibirInserirQuadraAction&numeroQuadraFace=<%=""
											+ quadraFace.getNumeroQuadraFace()
													.intValue()%>',400, 630);">
																							<bean:write name="quadraFace"
																								property="numeroQuadraFace" /> </a>
																					</td>
					...
					<table width="100%" border="0">
						<tr>
							...
							<td align="right"><gsan:controleAcessoBotao
									name="botaoConcluir" value="Inserir" tabindex="19"
									onclick="javascript:validarForm(document.forms[0]);"
									url="inserirQuadraAction.do" />
							</td>
						</tr>
					</table>
...
<logic:equal name="permissaoAdicionarQuadraFace" value="2">
	...
	<script language="JavaScript">		habilitacaoDistritoOperacional(document.forms[0].indicadorRedeAguaAux);
