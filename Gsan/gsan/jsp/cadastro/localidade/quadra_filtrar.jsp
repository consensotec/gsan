...
<html:javascript staticJavascript="false"
	formName="FiltrarQuadraActionForm" />
...
<body leftmargin="5" topmargin="5"
	onload="setarFoco('${requestScope.nomeCampo}');verificarChecado('${sessionScope.indicadorAtualizar}');setaFocusPrimeiroCampo();">

	<html:form action="/filtrarQuadraAction" name="FiltrarQuadraActionForm"
		type="gsan.gui.cadastro.localidade.FiltrarQuadraActionForm"
		method="post" onsubmit="return validateFiltrarQuadraActionForm(this);">
					...
					<table width="100%" border="0">
						...
						<tr>
							<td width="25%" colspan=2>
								<table width="100%">
									<tr>
										<td>Para filtrar uma quadra no sistema, informe os dados
											abaixo:</td>
										<td width="74" align="right"><input type="checkbox"
											name="indicadorAtualizar" value="1" /><strong>Atualizar</strong>

										</td>
										<logic:present scope="application" name="urlHelp">
											<td align="right"><a
												href="javascript:abrirPopupHelp('${applicationScope.urlHelp}cadastroLocalizacaoQuadraFiltrar', 500, 700);"><span
						...
						<tr>
							...
							<td><html:text property="localidadeID" size="5"
								...
								<a
								href="javascript:abrirPopup('exibirPesquisarLocalidadeAction.do?indicadorUsoTodos=1', 250, 495);">
									...
									<logic:empty name="FiltrarQuadraActionForm"
										property="localidadeID">
										<html:text property="localidadeNome" size="45" value=""
											readonly="true"
											style="background-color:#EFEFEF; border:0; color: #ff0000" />
									</logic:empty>
									<logic:notEmpty name="FiltrarQuadraActionForm"
										property="localidadeID">
										<html:text property="localidadeNome" size="45" readonly="true"
											style="background-color:#EFEFEF; border:0; color: #000000" />
									</logic:notEmpty>
						...
						<tr>
							<td><strong>Setor Comercial:</strong>
							</td>
							<td><html:text property="setorComercialCD" size="5"
								...
								<a
								href="javascript:chamarPopup('exibirPesquisarSetorComercialAction.do', 'setorComercialOrigem','idLocalidade', document.forms[0].localidadeID.value, 275, 480, 'Informe Localidade.');">
									<img width="23" height="21" border="0"
									src="<bean:message key="caminho.imagens"/>pesquisa.gif"
									title="Pesquisar Setor Comercial" />
							</a> <logic:present name="corSetorComercial">
						...
						<tr>
							<td><strong>Quadra:</strong>
							</td>
							<td><html:text property="quadraNM" size="5" maxlength="4"
									tabindex="3" onkeypress="return isCampoNumerico(event);" /></td>
									
									
						</tr>
						<tr>
							<td height="24"><strong>Rota:</strong>
							</td>
							<td><html:hidden property="idRota" /> <html:text
									maxlength="4" size="4" property="codigoRota" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000"
									onkeypress="return isCampoNumerico(event);" /> <a
								href="javascript:pesquisarRota();"> <img border="0"
									src="<bean:message key="caminho.imagens"/>pesquisa.gif"
									border="0" title="Pesquisar Rota" />
							</a> <a href="javascript:limparRota()"> <img
									src="<bean:message key="caminho.imagens"/>limparcampo.gif"
									border="0" title="Apagar" />
							</a></td>
						</tr>
						<tr>
							<td height="30"><strong>Quadra Criada para
									Atualização Cadastral?</strong>
							</td>
							<td><html:radio property="indicadorAtualizacaoCadastral" value="1"
									tabindex="4" /><strong>Sim <html:radio
										property="indicadorAtualizacaoCadastral" value="2" tabindex="5" />Não <html:radio
										property="indicadorAtualizacaoCadastral" value="3" tabindex="6" />Todos</strong></td>
						</tr>
						<tr>
							<td height="30"><strong>Indicador de uso:</strong>
							</td>
							<td><html:radio property="indicadorUso" value="1"
									tabindex="4" /><strong>Ativo <html:radio
										property="indicadorUso" value="2" tabindex="5" />Inativo <html:radio
										property="indicadorUso" value="3" tabindex="6" />Todos</strong></td>
						</tr>
						<tr>
							<td><input name="Button" type="button"
								class="bottonRightCol" value="Limpar" align="left"
								onclick="window.location.href='<html:rewrite page="/exibirFiltrarQuadraAction.do?desfazer=S"/>'">
							</td>
							<td align="right"><gsan:controleAcessoBotao name="Button"
									value="Filtrar"
									onclick="javascript:validarForm(document.forms[0]);"
									url="filtrarQuadraAction.do" /> <!-- 							  
