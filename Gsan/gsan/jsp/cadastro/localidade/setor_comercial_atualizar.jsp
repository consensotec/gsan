...
<%@ page import="gsan.operacional.FonteCaptacao"%>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function caracteresespeciais() {
		this.ac = new Array("setorComercialNome",
				"Nome do Setor Comercial possui caracteres especiais.",
				new Function("varName", " return this[varName];"));
		this.ab = new Array("municipioID",
				"Município possui caracteres especiais.", new Function(
						"varName", " return this[varName];"));
	}

	function IntegerValidations() {
		this.ab = new Array("municipioID",
				"Município deve somente conter números positivos.",
				new Function("varName", " return this[varName];"));
	}

	function validarForm(formulario) {

		var objSetorComercialNome = returnObject(formulario,
				"setorComercialNome");
	...
	function remover(id) {
		...
		if (where_to == true) {
			form.action = 'exibirAtualizarSetorComercialAction.do?acao=R&idRemover='
					+ id;
			submeterFormPadrao(form);
		}
	}
...
<body leftmargin="5" topmargin="5"
	...
	<html:form action="/atualizarSetorComercialAction" method="post">
		...
		<html:hidden name="PesquisarAtualizarSetorComercialActionForm"
			property="setorComercialID" />
			...
			<tr>
				...
				<td width="625" valign="top" class="centercoltext">
					...
					<table width="100%" border="0">
						<tr>
							<td colspan="2">Para alterar o setor comercial, informe os
								dados abaixo:</td>
							<logic:present scope="application" name="urlHelp">
								<td align="right"><a
									href="javascript:abrirPopupHelp('${applicationScope.urlHelp}cadastroLocalizacaoSetorComercialAtualizar', 500, 700);"><span
					...
					<table width="100%" border="0">
						...
						<tr>
							...
							<td width="70%"><bean:write
									name="PesquisarAtualizarSetorComercialActionForm"
									property="localidadeID" /> - <bean:write
									name="PesquisarAtualizarSetorComercialActionForm"
						...
						<tr>
							<td height="20"><strong>C&oacute;digo do Setor
									Comercial:</strong>
							</td>
							<td><bean:write
									name="PesquisarAtualizarSetorComercialActionForm"
						...
						<tr>
							<td height="20"><strong>Nome do Setor Comercial: <font
									color="#FF0000">*</font> </strong>
							</td>

							<td align="right">
								<div align="left">
									<html:text maxlength="30" property="setorComercialNome"
										size="45" tabindex="1" />
						...
						<tr>
							<td height="20"><strong>Munic&iacute;pio:<font
									color="#FF0000">*</font> </strong>
							</td>
							...
							<td align="right">
								<div align="left">
									...
									<html:text property="municipioID" size="5" maxlength="4"
										tabindex="2"
										onkeypress="validaEnterComMensagem(event, 'exibirAtualizarSetorComercialAction.do?objetoConsulta=2', 'municipioID', 'Município');" />

									<a
										href="javascript:abrirPopup('exibirPesquisarMunicipioAction.do', 250, 495);">
						...
						<tr>
							...
							<td><html:radio property="indicadorSetorAlternativo"
									...
									property="indicadorSetorAlternativo" value="2" /><strong>Não</strong>
							</td>
						</tr>
						<tr>
							<td><strong>Setor Criado para
									Atualização Cadastral? <font color="#FF0000">*</font></strong></td>
							<td><html:radio property="indicadorAtualizacaoCadastral"
									value="1" /><strong>Sim</strong> <html:radio
									property="indicadorAtualizacaoCadastral" value="2" /><strong>Não</strong>
							</td>
						</tr>

						<tr>
							<td colspan="2">Para adicionar a(s) fonte(s) de captação,
						...
						<tr>
							...
							<td><html:text maxlength="3" tabindex="1"
								...
								<a
								href="javascript:abrirPopup('exibirPesquisarTabelaAuxiliarAbreviadaAction.do?tela=fonteCaptacao',275,480);">
									<img width="23" height="21" border="0"
									src="<bean:message key="caminho.imagens"/>pesquisa.gif"
									title="Pesquisar Fonte de Captação" /> </a> <logic:present
									name="fonteCaptacaoEncontrada" scope="request">
									<html:text property="descricaoFonteCaptacao" size="40"
										maxlength="40" readonly="true"
										style="background-color:#EFEFEF; border:0; color: #000000" />
								</logic:present> <logic:notPresent name="fonteCaptacaoEncontrada"
									scope="request">
									<html:text property="descricaoFonteCaptacao" size="40"
										maxlength="40" readonly="true"
										style="background-color:#EFEFEF; border:0; color: red" />
								</logic:notPresent> <a href="javascript:limparFonteCaptacao();"> <img
									src="<bean:message key="caminho.imagens"/>limparcampo.gif"
									border="0" title="Apagar" /> </a>
							</td>
						</tr>
						...
						<tr>
							...
							<td width="450" align="right"><input type="button"
								class="bottonRightCol" style="" value="Adicionar"
											...
											<div style="width: 100%; height: 100%; overflow: auto;">
												<table width="100%" align="left" bgcolor="#99CCFF">
													...
													<logic:notEmpty name="colecaoFonteCaptacao" scope="session">
														...
														<logic:iterate name="colecaoFonteCaptacao" id="fonte"
															type="FonteCaptacao">
															<%
																cont = cont + 1;
																				if (cont % 2 == 0) {
															...
															<tr bgcolor="#FFFFFF">
																...
																<td width="6%">
																	<div align="center">
																		<a
																			href="javascript:remover('<bean:write name="fonte" property="id"/>');">
																			<img
																			src="<bean:message key="caminho.imagens"/>Error.gif"
																			border="0" width="14" height="14" title="Remover">
																		</a>
																	</div>
																</td>
								...
								<table width="100%">
									<tr>
										<td><logic:present name="voltar">
											...
											<input name="Submit23" class="bottonRightCol"
