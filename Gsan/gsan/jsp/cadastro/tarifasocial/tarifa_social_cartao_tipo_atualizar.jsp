...
<%@ page import="gsan.cadastro.tarifasocial.TarifaSocialCartaoTipo, gsan.util.ConstantesSistema"%>
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td align="right">
					<div align="left"><html:text maxlength="2"
						property="numeroMaximoMeses" size="2" tabindex="5" onkeypress="return isCampoNumerico(event);" /></div>
					</td>
				</tr>
				<tr>
