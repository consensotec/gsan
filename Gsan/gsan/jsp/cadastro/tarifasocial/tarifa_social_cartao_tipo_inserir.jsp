...
<body leftmargin="5" topmargin="5" onload="javascript:setarFoco('${requestScope.nomeCampo}');">
    <html:form
        ...
        type="gsan.gui.cadastro.tarifasocial.TarifaSocialCartaoTipoActionForm"
        method="post"
    ...
    <tr>
        ...
        <!--Início Tabela Reference a Páginação da Tela de Processo-->
            ...
            <tr>
                ...
                <td><html:text maxlength="20" property="descricao" size="20" tabindex="1" onblur="validaTexto(this);" /></td>
            </tr>
            <tr>
                <td><strong>Descri&ccedil;&atilde;o Abreviada:<font color="#FF0000">*</font></strong></td>
                <td align="right">
			        <div align="left">
				       <html:text maxlength="2" property="descricaoAbreviada" size="2" tabindex="2" onblur="validaTexto(this);" />
					</div>
				</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="right">
			        <div align="left">
                        <html:text maxlength="2" property="numeroMaximoMeses" size="2" tabindex="5" onkeypress="return isCampoNumerico(event);" />
                    </div>
	            </td>
            </tr>
            <tr>
