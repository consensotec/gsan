...
<%@page import="gsan.cadastro.tarifasocial.TarifaSocialCartaoTipo"%>
...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="TarifaSocialCartaoActionForm" />
...
function fechamento() {
    opener.window.location.href='/gsan/inserirTarifaSocialWizardAction.do?action=exibirInserirTarifaSocialDadosMultiplasEconomiasAction&reload=ok';
    self.close();
}
...
<logic:present name="operacaoConcluida">
	<body leftmargin="0" topmargin="0"
		onLoad="fechamento(); setarFoco('${requestScope.nomeCampo}');">
</logic:present>
...
<logic:notPresent name="operacaoConcluida">
	...
	<html:form action="/inserirTarifaSocialDadosCartaoMultiplasEconomias"
		method="post">
				...
				<table width="100%" border="0">
					<tr>
						...
						<table width="100%" border="0" dwcopytype="CopyTableRow">
							...
							<input type="hidden" name="clienteImovelEconomiaID"
								value="${requestScope.clienteImovelEconomiaID}" />

							<tr>
								<td height="25"><strong>Tipo:</strong></td>
								<td colspan="2"><html:select property="tipoCartao"
									value="${requestScope.tarifaSocialDadoEconomia.tarifaSocialCartaoTipo.id}"
									onchange="armazenarIndex(this);" style="width:150px;">
									<html:option
							...
							<tr>
								...
								<td colspan="2"><html:text property="dataValidade" size="11"
									...
									href="javascript:abrirCalendario('TarifaSocialCartaoActionForm', 'dataValidade')">
								<img border="0"
									src="<bean:message key='caminho.imagens'/>calendario.gif"
									width="20" border="0" align="middle" alt="Exibir Calendário" />
								</a> &nbsp;&nbsp;<span style="font-size: 10px">(dd/mm/aaaa)</span>
								</td>
							</tr>
							<tr>
						...
						<table width="100%" border="0" dwcopytype="CopyTableRow">
							...
							<tr>
								...
								<td><html:text property="valorRendaFamiliar" size="8"
									...
									onkeyup="formataValorMonetario(this, 8);" /></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td height="25"><strong>Tipo:</strong></td>
