...
<%@ page import="gsan.util.Pagina" %>
<%@ page import="gsan.cadastro.cliente.ClienteImovel" %>
<%@ page import="gsan.cadastro.tarifasocial.TarifaSocialDadoEconomia" %>
  ...
  <tr>
    ...
    <td valign="top" class="centercoltext">
	  ...
	  <tr>
						...
						<table width="100%" bgcolor="#99CCFF">
                            ...
                            <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
								<td colspan="2" ><div align="left">
									<a href="javascript:abrirPopup('exibirInserirTarifaSocialDadosCartaoUmaEconomia.do?clienteImovel=${sessionScope.clienteImovel.id}', 530, 470);">${sessionScope.clienteImovel.cliente.nome}</a></div>
								</td>
								<td align="left"> 
									<bean:write name="clienteImovel" property="imovel.complementoEndereco" scope="session"/>
								</td>
								<td align="right">
								
								<logic:present name="clienteImovel" property="cliente.cpf">
									<bean:write name="clienteImovel" property="cliente.cpfFormatado" scope="session"/>
								</logic:present>
                            ...
                            <tr bordercolor="#FFFFFF" bgcolor="#0066FF">
								...
								<td bgcolor="#99CCFF"> <div align="center"><strong>&Oacute;rg&atilde;o
									Expedidor</strong></div>
								</td>
                            ...
                            <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
								<td align="right">
									<logic:present name="clienteImovel" property="cliente.rg">
										<bean:write name="clienteImovel" property="cliente.rg" scope="session"/>
									</logic:present>
								...
								<td align="left">
									...
									<logic:present name="clienteImovel" property="cliente.dataEmissaoRg">
										<bean:write name="clienteImovel" property="cliente.dataEmissaoRg" formatKey="date.format" scope="session"/>
									</logic:present>
								...
								<logic:present name="clienteImovel" property="cliente.orgaoExpedidorRg">
									<bean:write name="clienteImovel" property="cliente.orgaoExpedidorRg.descricaoAbreviada" scope="session"/>
								</logic:present>
								...
								<td><div align="left"></div>
									...
									<logic:present name="clienteImovel" property="cliente.unidadeFederacao">
										<bean:write name="clienteImovel" property="cliente.unidadeFederacao.sigla" scope="session"/>
									</logic:present>
		...
		<logic:present name="colecaoDadosTarifaSocial" scope="session">
			<logic:iterate id="tarifaSocialDadoEconomia" name="colecaoDadosTarifaSocial" 
			type="TarifaSocialDadoEconomia">
							...
							<logic:notPresent name="tarifaSocialDadoEconomia" property="id">
							  ...
							  <td align="left">
								...
								<logic:notEmpty name="tarifaSocialDadoEconomia" property="tarifaSocialCartaoTipo">
									<font color="#333333">${tarifaSocialDadoEconomia.tarifaSocialCartaoTipo.descricao}</font>
								</logic:notEmpty>
							  ...
							  <td align="right">
								...
								<logic:notEmpty name="tarifaSocialDadoEconomia" property="rendaTipo">
                                       <font color="#333333">${tarifaSocialDadoEconomia.rendaTipo.descricao}</font>
								</logic:notEmpty>
		...
		<logic:notPresent name="colecaoDadosTarifaSocial" scope="session">
			<logic:notEmpty name="colecaoTarifaSocialDadoEconomia">
			<logic:iterate id="tarifaSocialDadoEconomia" name="colecaoTarifaSocialDadoEconomia">
						...
						<table width="100%" bgcolor="#99CCFF">
                            ...
                            <tr bordercolor="#FFFFFF" bgcolor="#FFFFFF">
							  ...
							  <td align="left">
								...
								<logic:notEmpty name="tarifaSocialDadoEconomia" property="tarifaSocialCartaoTipo">
									<div align="center"><font color="#333333">${tarifaSocialDadoEconomia.tarifaSocialCartaoTipo.descricao}</font></div>
								</logic:notEmpty>
								<logic:empty name="tarifaSocialDadoEconomia" property="tarifaSocialCartaoTipo">
	  								&nbsp;
								</logic:empty>
							  ...
							  <td>
								...
								<logic:notEmpty name="tarifaSocialDadoEconomia" property="rendaTipo">
                                       <div align="left"><font color="#333333">${tarifaSocialDadoEconomia.rendaTipo.descricao}</font></div>
								</logic:notEmpty>
								<logic:empty name="tarifaSocialDadoEconomia" property="rendaTipo">
                              		&nbsp;
								</logic:empty>
