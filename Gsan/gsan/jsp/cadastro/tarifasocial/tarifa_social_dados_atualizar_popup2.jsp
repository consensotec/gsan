...
<%@page import="gsan.cadastro.cliente.ClienteImovel" isELIgnored="false"%>
<%@page import="gsan.cadastro.cliente.ClienteImovelEconomia" %>
...
<html:form action="/atualizarDadosTarifaSocialClienteAction"
	...
	type="gsan.gui.cadastro.tarifasocial.AtualizarDadosTarifaSocialClienteActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" bgcolor="#99ccff" width="100%">
				...
				<logic:present name="colecaoClienteImovel" scope="session">
          		...
          		CPF - <%=gsan.util.Util.formatarCPFApresentacao((cpf + ""))%>
	          		...
	          		RG - <%=gsan.util.Util.formatarRGApresentacao((rg + ""),
							(orgaoExpedidorRg + ""), (unidadeFederacao + ""))%>
								...
								CNPJ - <%=gsan.util.Util.formatarCPFApresentacao((cnpj + ""))%>
									</logic:present>
								</logic:notPresent>
							</logic:notPresent></td>
						</tr>
