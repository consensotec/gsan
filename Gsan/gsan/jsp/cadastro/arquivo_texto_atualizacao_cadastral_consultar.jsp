...
<html:form action="/consultarArquivoTextoAtualizacaoCadastralAction"
	...
	type="gsan.gui.cadastro.ConsultarArquivoTextoAtualizacaoCadastralActionForm"
	method="post"
				...
				<tr>
					...
					<td>
						<html:text tabindex="8" maxlength="3" property="idLocalidade" size="5"
							onkeypress="form.target=''; validaEnterComMensagem(event, 'exibirConsultarArquivoTextoAtualizacaoCadastralAction.do?objetoConsulta=1', 'idLocalidade', 'Localidade'); return isCampoNumerico(event);"
							 />
