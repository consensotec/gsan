...
<html:form action="/filtrarCargoFuncionarioAction"
	...
	type="gsan.gui.cadastro.FiltrarCargoFuncionarioActionForm"
	method="post"
	...
	<!--Início Tabela Reference a Páginação da Tela de Processo-->
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<td class="parabg">Filtrar Cargo do Funcionário</td>
				...
				<tr>
						...
						<td colspan="2">Para filtrar o(s) cargo(s) do(s) funcionários(s), informe o dado abaixo:</td>
