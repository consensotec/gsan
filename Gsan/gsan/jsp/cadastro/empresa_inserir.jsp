...
<%@ page import="gsan.cadastro.empresa.EmpresaCobrancaFaixa"%>
...
<script language="JavaScript">
	...
	function limparForm() {
		...
		form.indicadorAtualizaCadastro[1].checked = "2" ;
...
<body leftmargin="5" topmargin="5"
	...
	<html:form action="/inserirEmpresaAction.do"
		...
		type="gsan.gui.cadastro.InserirEmpresaActionForm" method="post"
		...
		<table width="770" border="0" cellspacing="5" cellpadding="0">
			...
			<tr>
				<td width="155" valign="top" class="leftcoltext">
					<div align="center">
						<p align="left">&nbsp;</p>
						<p align="left">&nbsp;</p>
						<p align="left">&nbsp;</p>
				...
				<td width="615" valign="top" class="centercoltext">
					...
					<table width="100%" border="0">
						...
						<tr>
							<td>
								<strong>Indicador Atualiza Cadastro:<font color="FF0000">*</font></strong>
							</td>
							<td>
								<html:radio property="indicadorAtualizaCadastro" value="1" tabindex="6" /><strong>Sim</strong>
								<html:radio property="indicadorAtualizaCadastro" value="2" tabindex="7" /><strong>Não</strong>
							</td>
							<td>&nbsp;</td>
						</tr>
