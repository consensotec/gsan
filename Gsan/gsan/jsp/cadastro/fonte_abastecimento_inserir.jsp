...
<html:form action="/inserirFonteAbastecimentoAction.do"
	...
	type="gsan.gui.cadastro.InserirFonteAbastecimentoActionForm"
	method="post"
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<html:radio property="indicadorCalcularVolumeFixo" tabindex="3" value="2" /><strong>Não</strong>
					</td>
					<td>&nbsp;</td>
				</tr>
				
				<tr>
					<td><strong>Permite Poço?<font color="FF0000">*</font></strong></td>
					<td><html:radio property="indicadorPermitePoco" tabindex="2" value="1" /><strong>Sim</strong>
					<html:radio property="indicadorPermitePoco" tabindex="3" value="2" /><strong>Não</strong>
					</td>
					<td>&nbsp;</td>
				</tr>
