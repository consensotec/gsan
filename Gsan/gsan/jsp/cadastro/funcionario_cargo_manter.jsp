			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<logic:notPresent name="acao" scope="session">
						<td class="parabg">Manter Cargo do Funcionário</td>
					</logic:notPresent>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="7" height="23"><font style="font-size: 10px;"
						color="#000000" face="Verdana, Arial, Helvetica, sans-serif"> <strong>Cargo(s) do(s) funcionário(s) cadastrado(s):</strong> </font></td>
				</tr>
				...
				<tr>
					...
					<div align="right"><a
						...
						<img border="0"
							...
							title="Imprimir Cargo do Funcionário" /> </a></div>
					</td>	
				</tr>
			</table>
