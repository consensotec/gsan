...
<html:form action="/filtrarImovelOutrosCriteriosWizardAction"
	...
	type="gsan.gui.cadastro.imovel.ImovelOutrosCriteriosActionForm"
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Existe nível para instalação de esgoto:<font color="#ff0000">*</font></strong></td>
					<td>
						<html:radio property="indicadorNivelEsgoto" value="1"><strong>Sim</strong></html:radio>
						<html:radio property="indicadorNivelEsgoto" value="2"><strong>Não</strong></html:radio>
						<html:radio property="indicadorNivelEsgoto" value="3"><strong>Todos</strong></html:radio>
					</td>
				</tr>
