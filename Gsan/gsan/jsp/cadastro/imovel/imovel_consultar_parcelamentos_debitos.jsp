...
function limparForm(){
   	var form = document.forms[0];
    form.idImovelParcelamentosDebitos.value = "";
    consultarImovelAjax();
...
function consultarImovelAjax(){
	...
	if(form.idImovelParcelamentosDebitos != null && form.idImovelParcelamentosDebitos.value != ""){
		$.ajax({
				   type: "POST",
				   url: "consultarImovelAjaxAction.do?idImovel="+form.idImovelParcelamentosDebitos.value,
				   data: "",
...
<body leftmargin="5" topmargin="5" onload="javascript:habilitaMatricula();setarFoco('idImovelParcelamentosDebitos');consultarImovelAjax();">
				...
				<table width="100%" align="center" bgcolor="#90c7fc" border="0">
					...
					<logic:present name="colecaoParcelamento">
						...
						<%if (cor.equalsIgnoreCase("#cbe5fe")) {
							...
							<td align="right"><bean:write name="parcelamento" property="valorJurosParcelamento"  format="0.00"/></td>
							<td align="right"><bean:write name="parcelamento" property="valorDesconto"  format="0.00"/></td>
							<td align="right"><bean:write name="parcelamento" property="valorEntradaComDesconto"  format="0.00"/></td>
