...
<%@ page import="gsan.cadastro.imovel.ImovelAtualizacaoCadastral"%>
...
<script LANGUAGE="JavaScript">
   ...
   function limparLocalidade(){
	...
	function validarForm(form){
		...
		if(existeColecaoImovel != "" || form.localidade.value != ""){
			 if(validateGerarArquivoTextoAtualizacaoCadastralDispositivoMovelActionForm(form) && validarInscricao(form)){
				 if (form.quadraInicial.value.length > 0 && form.quadraFinal.value == ""){
			...
			alert ('Informe Localidade ou Imóveis');
		}
	}
</script>
...
<html:form action="/filtrarImovelAtualizacaoCadastralDispositivoMovelAction"
	...
	type="gsan.gui.cadastro.imovel.GerarArquivoTextoAtualizacaoCadastralDispositivoMovelActionForm"
	method="post">
	...
	<td width="625" valign="top" class="centercoltext">
	  ...
	  <tr>
		<td width="100"><strong>Localidade:</strong></td>
		  <td>
			<html:text tabindex="7" maxlength="3" property="localidade" size="5"
				onkeypress="validaEnterComMensagem(event, 'exibirFiltrarImovelAtualizacaoCadastralDispositivoMovelAction.do?objetoConsulta=1', 'localidade', 'Localidade'); return isCampoNumerico(event);"
			...
			<a href="javascript:limparBorracha(1);">
				<img src="<bean:message key="caminho.imagens"/>limparcampo.gif"
					border="0" title="Apagar Localidade" />
			</a>
		  </td>
	  </tr>
	   ...
	   <tr>
		...
		<td>
			...
			onkeypress="validaEnterDependenciaComMensagem(event, 'exibirFiltrarImovelAtualizacaoCadastralDispositivoMovelAction.do?objetoConsulta=2', document.forms[0].setorComercialCD, document.forms[0].localidade.value, 'Localidade', 'Setor Comercial');return isCampoNumerico(event);"
			/>
	  ...
	  <tr>
		...
		<td width="432"><html:text tabindex="10" maxlength="4"
			...
			onkeypress="validaEnterDependenciaComMensagem(event, 'exibirFiltrarImovelAtualizacaoCadastralDispositivoMovelAction.do?objetoConsulta=3', document.forms[0].quadraInicial, document.forms[0].setorComercialCD.value, 'Setor Comercial.', 'Quadra Inicial'); return isCampoNumerico(event);"
			onkeyup="javascript:limparQuadra();habilitaDesabilita();"
			onchange="javascript:duplicarQuadra();"/> 
	  ...
	  <tr>
		...
		<td><html:text maxlength="4" property="quadraFinal" size="5"
			onkeypress="validaEnterDependenciaComMensagem(event, 'exibirFiltrarImovelAtualizacaoCadastralDispositivoMovelAction.do?objetoConsulta=4', document.forms[0].quadraFinal, document.forms[0].quadraInicial.value, 'Quadra Inicial.', 'Quadra Final'); return isCampoNumerico(event);"
	  ...
	  <tr>
		...
		<html:text maxlength="4" size="5" property="codigoRota"  		
			onkeypress="validaEnterDependenciaComMensagem(event, 'exibirFiltrarImovelAtualizacaoCadastralDispositivoMovelAction.do?objetoConsulta=5',document.forms[0].codigoRota, document.forms[0].setorComercialCD.value, 'Setor Comercial.', 'Código Rota');return isCampoNumerico(event);"
			...
			<table width="100%" border="0">
	      	<tr>
	      		...
	      		<td align="left"><html:text
					...
					onkeypress="validaEnterComMensagem(event, 'exibirFiltrarImovelAtualizacaoCadastralDispositivoMovelAction.do?objetoConsulta=6','idImovel','Im&oacute;vel'); return isCampoNumerico(event);" 
					onkeyup="javascript:habilitaDesabilitaLocalidadeImovel();limparLocalidade();"/>
				<a
					...
					<logic:iterate name="colecaoImovel" id="imovel"
						...
						<%}%>
							<td align="center" width="20%" valign="middle">
								<a href="javascript:removerImovel(<%="" + imovel.getId().intValue()%>)">
