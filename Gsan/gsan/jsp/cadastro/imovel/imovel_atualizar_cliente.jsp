								...
								<logic:notEmpty name="imovelClientesNovos">
									<logic:iterate name="imovelClientesNovos"
										...
										<tr bgcolor="#FFFFFF">
											...
											<td width="10%">
											<div align="center">
												<logic:equal name="podeAlterarCliente" value="true">
													<input type="checkbox"
														name="idRemocaoClienteImovel"
														value="<%=""+GcomAction.obterTimestampIdObjeto(imovelClienteNovo) + "-" + imovelClienteNovo.getCliente().getId()%>" />
												</logic:equal>											
											</div>
											</td>
											<td width="10%">
											...
											<div align="left"id='cliente_<bean:write name="imovelClienteNovo" property="cliente.id" />'>											
												...
												<logic:equal name="podeAlterarCliente" value="false">
													<bean:write name="imovelClienteNovo" property="cliente.nome" />
												</logic:equal>
											</div>
											</td>
