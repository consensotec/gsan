...
function validarSuspenderImovelProgramaEspecialActionForm(form){
	...
	if ((form.inscricaoImovel.value == undefined ) || (form.inscricaoImovel.value == '')){	
         msg = msg + 'Informe Imóvel. \n';
         alert(msg);
         return false;
	} else
 
	if ((form.observacao.value == undefined) || (form.observacao.value == '')){
          msg = msg + 'Informe Observação. \n';
          alert(msg);
          return false;
	} else {
	     return true;
...
<html:form action="/suspenderImovelProgramaEspecialAction.do" name="InserirImovelProgramaEspecialActionForm"
	type="gsan.gui.cadastro.imovel.InserirImovelProgramaEspecialActionForm" method="post">
				...
				<tr>
					...
					<table width="100%">
						...
						<tr>
						    ...
						    <td width="75%">
							    <html:textarea property="observacao" cols="40" rows="4" onkeyup="limitTextArea(document.forms[0].observacao, 200, document.getElementById('utilizado'), document.getElementById('limite'));"/><br>
