...
var bCancel = false; 
	...
	if(bCancel){
       ...
       return testarCampoValorZero(document.FiltrarSubcategoriaActionForm.codigoSubcategoria, 'Código da Subcategoria') 
    ...
    function caracteresespeciais () { 
     	...
     	this.ac = new Array("descricaoSubcategoria", "Descrição da Subcategoria possui caracteres especiais.", new Function ("varName", " return this[varName];"));
    } 
    ...
    function required () { 
     	this.aa = new Array("codigoSubcategoria", "Informe Código da Subcategoria.", new Function ("varName", " return this[varName];"));
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table bordercolor="#000000" border="0" width="100%" cellspacing="0">
				...
				<tr>
					<td><strong>Fator Fiscalização:<font color="#FF0000">*</font></strong></td>
					<td align="right">
