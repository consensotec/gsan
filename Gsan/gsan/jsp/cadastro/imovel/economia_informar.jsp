...
<%@ page import="gsan.cadastro.cliente.ClienteTipo" isELIgnored="false"%>
<%@ page import="gsan.cadastro.cliente.ClienteRelacaoTipo"%>
...
<html:form action="/informarEconomiaAction.do" name="EconomiaActionForm"
	type="gsan.gui.cadastro.imovel.EconomiaActionForm" method="post">
