...
<html:form action="/atualizarImovelProgramaEspecialAction.do" name="AtualizarImovelProgramaEspecialActionForm"
	type="gsan.gui.cadastro.imovel.AtualizarImovelProgramaEspecialActionForm" method="post">
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<td>
				...
				<tr>
					<td width="230"><strong>N&uacute;mero de Inscri&ccedil;&atilde;o Social (NIS):<font color="#FF0000">*</font></strong></td>
