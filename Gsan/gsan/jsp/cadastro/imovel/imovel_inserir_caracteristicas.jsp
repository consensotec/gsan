...
<%@ page import="gsan.cadastro.imovel.FonteAbastecimento"%>

<%@ page import="gsan.atendimentopublico.ligacaoesgoto.LigacaoEsgotoSituacao"%>
...
<!-- Begin
    ...
    function validateInserirImovelActionForm(form) {
      ...
      return true;
       ...
       return testarCampoDecimalValorZero(document.InserirImovelActionForm.areaConstruida, 'Área Construída')
              && testarCampoDecimalValorZero(document.InserirImovelActionForm.reservatorioInferior, 'Volume Reservatório Inferior')
              && testarCampoDecimalValorZero(document.InserirImovelActionForm.reservatorioSuperior, 'Volume Reservatório Superior')
              && testarCampoDecimalValorZero(document.InserirImovelActionForm.piscina, 'Volume Piscina Imóvel')
...
///     this.an = new Array("poco", "Informe Poço.", new Function ("varName", " return this[varName];"));
    ...
    function caracteresespeciais () {
     ////this.aa = new Array("areaConstruida", "Área Construída deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
  //   this.ab = new Array("reservatorioInferior", "Volume Reservatório Inferior deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
  ////  this.ac = new Array("reservatorioSuperior", "Volume Reservatório Superior deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
   //  this.ad = new Array("piscina", "Volume Piscina Imóvel deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
    }
    ...
    function FloatValidations () {
     this.ai = new Array("areaConstruida", "Área Construída deve somente conter números decimais positivos.", new Function ("varName", " return this[varName];"));
