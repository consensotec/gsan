...
<%@ page
	import="gsan.cadastro.cliente.ClienteRelacaoTipo,gsan.cadastro.cliente.ClienteImovelEconomia"%>
...
<html:form action="/atualizarEconomiaPopupAction"
	...
	type="gsan.gui.cadastro.imovel.EconomiaPopupActionForm" method="post"
