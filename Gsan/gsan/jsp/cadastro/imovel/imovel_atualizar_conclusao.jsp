...
function abrirMapa(){
	var form = document.forms[0];
	var latParam = form.cordenadasUtmX.value;
	var lonParam = form.cordenadasUtmY.value;
	var paramsMapa = '' + '${paramsMapa}';
	abrirPopup('exibirMapaKMLAction.do?paramsMapa='+paramsMapa+'&atualizar=true' +'&latImov='+latParam +'&lonImov='+lonParam ,'700','750');
}

function redirecionarCoordenadasMapa(coordenadaImovelX,coordenadaImovelY){
	var form = document.forms[0];
	form.cordenadasUtmX.value = coordenadaImovelX;
	form.cordenadasUtmY.value = coordenadaImovelY;
}
</script>
</head>
