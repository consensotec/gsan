...
<html:html>
<head>
<%@page import="gsan.arrecadacao.Devolucao"%>
<%@page import="gsan.arrecadacao.DevolucaoHistorico"%>
...
function limparForm(){
   	var form = document.forms[0];
    form.idImovelDevolucoesImovel.value = "";
    consultarImovelAjax();
...
function consultarImovelAjax(){
	...
	if(form.idImovelDevolucoesImovel != null && form.idImovelDevolucoesImovel.value != ""){
		$.ajax({
				   type: "POST",
				   url: "consultarImovelAjaxAction.do?idImovel="+form.idImovelDevolucoesImovel.value,
				   data: "",
...
<body leftmargin="5" topmargin="5" onload="javascript:habilitaMatricula();setarFoco('idImovelDevolucoesImovel');consultarImovelAjax();">
