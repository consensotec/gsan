		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="2">
						<html:text property="idLogradouroFiltro" 
							size="9"
							maxlength="9" 
							tabindex="9"
						...
						<a href="javascript:abrirPopup('exibirPesquisarLogradouroAction.do?codigoMunicipio='+document.forms[0].idMunicipioFiltro.value+'&codigoBairro='+document.forms[0].idBairroFiltro.value+'&indicadorUsoTodos=1&primeriaVez=1', 400, 800);">
							<img src="<bean:message key='caminho.imagens'/>pesquisa.gif" 
								width="23"
								height="21" 
								border="0" 
								style="cursor:hand;" title="Pesquisar Logradouro"></a> <logic:present
