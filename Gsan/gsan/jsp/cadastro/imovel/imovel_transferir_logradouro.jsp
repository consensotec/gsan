<%@page import="gsan.cadastro.imovel.bean.ImovelClienteParaTransferirHelper"%>
...
<html:html>
	...
	<body leftmargin="5" topmargin="5"
		...
		<html:form action="/exibirTransferirImovelLogradouroAction.do"
			...
			type="gsan.gui.cadastro.imovel.TransferirImovelLogradouroActionForm"
			method="post"
				...
				<tr>
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td class="parabg">Transferir Imovéis/Clientes Para Outros Logradouros</td>
							<td width="11"><img border="0"
					...
					<table>
						...
						<table border="0" align="left">
							...
							<tr>
								<td width="800">Preencher os Campos Para Efetuar a Transferência dos Imovéis/Clientes do Logradouro</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							</tr>
						...
						<table border="0" width="100%">
							<tr>
								...
								<table align="center" bgcolor="#99ccff" border="0" width="100%">
									<tr>
										<td align="left"><strong>Origem dos Imóveis/Clientes Transferidos</strong></td>
									</tr>
								</table>
								<table align="left" border="0" width="100%">
									...
									<tr>
										...
										<table border="0" width="90%">
											...
											<tr>
												<td align="left" width="400">Selecionar Imovéis/Clientes para Transferência</td>
										...
										<table border="0" width="100%">
											<tr>
												...
												<table align="center" bgcolor="#99ccff" border="0" width="100%">
													...
													<tr>
														<td align="left"><strong>Destino dos Imóveis/Clientes Transferidos</strong></td>
													</tr>
												</table>
												</td>
											</tr>
