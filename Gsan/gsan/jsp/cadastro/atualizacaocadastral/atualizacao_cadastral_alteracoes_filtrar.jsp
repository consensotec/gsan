...
<script LANGUAGE="JavaScript">
	...
	function validarForm(form){
		if(validateFiltrarAlteracaoAtualizacaoCadastralActionForm(form)){
			...
			botaoAvancarTelaEspera('/gsan/filtrarAlteracaoAtualizacaoCadastralAction.do');
		}
	}
...
<html:form action="/filtrarAlteracaoAtualizacaoCadastralAction"
	...
	type="gsan.gui.cadastro.atualizacaocadastral.FiltrarAlteracaoAtualizacaoCadastralActionForm"
	...
	<td width="625" valign="top" class="centercoltext">
     ...
     <tr>
		...
		<td colspan="2"><html:text maxlength="9" property="idArquivo"
			tabindex="1" size="9"
			onkeypress="validaEnterComMensagem(event, 'exibirFiltrarAlteracaoAtualizacaoCadastralAction.do', 'idArquivo', 'Arquivo'); return isCampoNumerico(event);" />
		<a href="javascript:chamarPopup('exibirPesquisarArquivoTextoAtualizacaoCadastralAction.do?limpaForm=S', 500, 300,document.forms[0].idArquivo);">
		...
		<a href="javascript:limparArquivo();"> 
