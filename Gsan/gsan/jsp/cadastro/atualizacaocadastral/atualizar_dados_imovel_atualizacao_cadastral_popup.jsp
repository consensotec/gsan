...
<%@ page import="gsan.cadastro.atualizacaocadastral.bean.DadosTabelaAtualizacaoCadastralHelper"%>
...
<html:form action="/atualizarDadosImovelAtualizacaoCadastralAction"
	...
	type="gsan.gui.cadastro.ExibirAtualizarDadosImovelAtualizacaoCadastralPopupActionForm" method="post"
	onsubmit="">
