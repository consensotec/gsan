...
/*    	else if (document.getElementById("bairroCarregado") == null){
    		...
    		form.action = "inserirLogradouroAction.do?confirmarLogradouroMesmoNome=NAO";
    		submeterFormPadrao(form);
    	}
    }
}
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><html:text maxlength="4" property="codigoBairro" size="4"
						...
						onkeypress="javascript:return validaEnterDependencia(event, 'exibirInserirLogradouroAction.do', this,document.forms[0].idMunicipio.value,'Município');" />
