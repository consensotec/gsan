...
<%@ page import="gsan.cadastro.endereco.LogradouroCep" %>
...
function abrirPesquisaLogradouro(abrirPesquisaLogradouro) {
    ...
    function validaNumero(number){
        //Deixa número no formato 00000 se começar com números
        var aux = number.value;
        var digito1 = aux.substring(0, 1);
	    ...
	    <td width="640" valign="top" class="centercoltext">
    		...
    		<table width="100%" border="0">
				...
				<tr>
					...
					<logic:equal name="mascaraNumEndereco" value="1">
						<td><html:text maxlength="5" property="numero" size="5" tabindex="5" onblur="validaNumero(numero)"/></td>
					</logic:equal>
					<logic:equal name="mascaraNumEndereco" value="2">
