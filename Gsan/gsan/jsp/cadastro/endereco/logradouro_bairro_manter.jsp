...
<%@ page import="gsan.cadastro.endereco.bean.ManterLogradouroBairroHelper"%>
...
function atualizar(objeto){
	if (CheckboxNaoVazioAtt(objeto)){
		if (confirm ("Confirma atualização?")) {
			document.forms[0].action = "/gsan/atualizarLogradouroGrauImportanciaAction.do?logbairro=sim"
			document.forms[0].submit();
		 }
	}
}
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
				...
				<tr>
					...
					<td class="parabg">
						<logic:present name="indicadorImportanciaLogradouro" >
							Manter Importância Bairro Logradouro
						</logic:present>
					...
					<table width="100%" bgcolor="#99CCFF">
						...
						<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
							...
							<logic:present name="logradouros">
								<%int cont = 1;%>
								<logic:iterate name="logradouros" id="logradouro" type="ManterLogradouroBairroHelper">
									<pg:item>
										<%cont = cont + 1;
			if (cont % 2 == 0) {%>
										<tr bgcolor="#FFFFFF">
			...
			%>
										<tr bgcolor="#cbe5fe">
											<%}%>
											<logic:equal name="logradouro" property="logradouro.logradouro.indicadorUso"
												...
												<logic:notPresent name="indicadorImportanciaLogradouro" >
													<td width="25%"><font color="#CC0000"> 
														<a href="exibirAtualizarLogradouroBairroAction.do?manter=1&idRegistroAtualizacao=<bean:write name="logradouro" property="logradouro.id" />">
														<bean:write name="logradouro" property="logradouro.descricaoFormatada" />
													</a></font></td>
												</logic:notPresent>
												...
												<td width="19%"><font color="#CC0000"> <bean:write
													name="logradouro" property="logradouro.logradouro.municipio.nome" /> </font></td>

											</logic:equal>

											<logic:notEqual name="logradouro" property="logradouro.logradouro.indicadorUso"
												value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>">
												...
												<logic:present name="indicadorImportanciaLogradouro" >
													<td width="25%"><bean:write name="logradouro" property="logradouro.logradouro.descricaoFormatada" />
													</td>
												</logic:present>
												<logic:notPresent name="indicadorImportanciaLogradouro">
													<td width="25%"><a href="exibirAtualizarLogradouroAction.do?manter=1&idRegistroAtualizacao=<bean:write name="logradouro" property="logradouro.id" />">
														<bean:write name="logradouro" property="logradouro.logradouro.descricaoFormatada" />
													</a></td>
												</logic:notPresent>
												...
												<td width="19%"><bean:write name="logradouro"
													property="logradouro.logradouro.municipio.nome" /></td>
					...
					<!--
							...
							<logic:notPresent name="indicadorImportanciaLogradouro">	
								...
								onclick="window.location.href='<html:rewrite page="/exibirInformarImportanciaLogradouroBairroAction.do"/>'"
								align="left" style="width: 80px;">
							</logic:notPresent>
							<logic:present name="indicadorImportanciaLogradouro" >
								<input name="button"
								type="button" class="bottonRightCol" value="Voltar Filtro"
								onclick="window.location.href='<html:rewrite page="/exibirInformarImportanciaLogradouroBairroAction.do?menu=sim&implog=sim"/>'"
								align="left" style="width: 80px;">
							</logic:present>
							</td>
