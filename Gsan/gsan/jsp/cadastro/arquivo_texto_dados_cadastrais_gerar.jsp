...
<html:javascript staticJavascript="false"  formName="GerarArquivoTextoDadosCadastraisActionForm"/>
...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if(validarCampos() ){
			if(validateGerarArquivoTextoDadosCadastraisActionForm(form)){
	...
	function chamarPopup(url, tipo, objeto, codigoObjeto, altura, largura, msg,campo){
  	...
  	function limpar(){
  		...
  		form.action='exibirGerarArquivoTextoDadosCadastraisAction.do?menu=sim';
...
<div id="formDiv">
<html:form action="/gerarArquivoTextoDadosCadastraisAction.do"
	name="GerarArquivoTextoDadosCadastraisActionForm"
	type="gsan.gui.cadastro.GerarArquivoTextoDadosCadastraisActionForm"
	method="post">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Arquivo Texto com Dados Cadastrais </td>
					<td width="11"><img border="0"
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(1);validaEnterComMensagem(event, 'exibirGerarArquivoTextoDadosCadastraisAction.do?objetoConsulta=1','localidadeInicial','Localidade Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(2);validaEnterComMensagem(event, 'exibirGerarArquivoTextoDadosCadastraisAction.do?objetoConsulta=2','setorComercialInicial','Setor Comercial Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							size="3"
							onkeypress="validaEnterComMensagem(event, 'exibirGerarArquivoTextoDadosCadastraisAction.do?objetoConsulta=3','localidadeFinal','Localidade Final');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" property="setorComercialFinal"
							size="3"
							onkeypress="validaEnterDependencia(event, 'exibirGerarArquivoTextoDadosCadastraisAction.do?objetoConsulta=4', document.forms[0].setorComercialFinal, document.forms[0].localidadeFinal.value, 'Localidade Final');"
							tabindex="8"/>
