			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td>
						...
						<html:radio property="unidadeEsgoto" value="<%=""+ConstantesSistema.TODOS%>" />
						<strong>Todas</strong> 
					</td>
				</tr>											
				...
				<tr>
					...
					<td>
						...
						<strong>N&atilde;o</strong>
						<html:radio property="unidadeAbreRegistro" value="<%=""+ConstantesSistema.TODOS%>" />
						<strong>Todas</strong> 
					</td>
				</tr>											
				...
				<tr>
					...
					<td>
						...
						<strong>N&atilde;o</strong>
						<html:radio property="unidadeAceita" value="<%=""+ConstantesSistema.TODOS%>" />
						<strong>Todas</strong> 
					</td>
				</tr>											
