...
<%@page import="gsan.cadastro.geografico.Municipio"%>
	...
	function limparUnidadeSuperior() {
	 ...
	 function validaRadioButton(nomeCampo,mensagem){
  	...
  	function validaTodosRadioButton(){
		...
		if(validaRadioButton(form.indicadorUnidadeCentralAtendimento,"Unidade Central Atendimento") != ""){
			mensagem = mensagem + validaRadioButton(form.indicadorUnidadeCentralAtendimento,"Unidade Central Atendimento")+"\n";
		}
...
<html:form action="/atualizarUnidadeOrganizacionalAction.do"
	...
	type="gsan.gui.cadastro.unidade.AtualizarUnidadeOrganizacionalActionForm"
	method="post"
						...
						<tr bgcolor="#cbe5fe">
							...
							<table border="0" width="100%">
								...
								<tr>
										...
										<td><html:radio property="indicadorUnidadeCentralAtendimento"
											value="<%=""+ConstantesSistema.SIM%>" /> <strong>Sim</strong>
										<html:radio property="indicadorUnidadeCentralAtendimento"
											value="<%=""+ConstantesSistema.NAO%>" /> <strong>N&atilde;o</strong>
										</td>
								</tr>
					...
					<td><logic:present scope="session" name="manter">
					    ...
					    <logic:notPresent scope="session" name="manter">
						  ...
						  <logic:notPresent scope="session" name="filtrar_manter">
							<input name="Submit222" class="bottonRightCol" value="Voltar"
								type="button"
								onclick="window.location.href='/gsan/exibirFiltrarUnidadeOrganizacionalAction.do';">
						  </logic:notPresent>
					   </logic:notPresent> 
