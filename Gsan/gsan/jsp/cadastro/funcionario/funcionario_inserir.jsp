...
<script language="JavaScript">
	...
	function validarForm(form){
		...
		testarCampoValorZero(document.InserirFuncionarioActionForm.matricula, 'Matrícula') && 
	...
	function nome() {
		this.aa = new Array("nome","Nome possui caracteres especiais ou números.", new Function("varName", " return this[varName];"));
	}

	function IntegerValidations() {
		this.aa = new Array("idUnidade","Unidade deve somente conter números positivos.", new Function(	"varName", " return this[varName];"));
		this.ab = new Array("matricula","Matrícula deve somente conter números positivos.", new Function(	"varName", " return this[varName];"));
	}

	function cpf() {
		this.aa = new Array("numeroCpf","Dígito verificador do CPF não confere.", new Function("varName", " return this[varName];"));
	}
	...
	function validarIdadeFuncionario() {
		...
		if (form.dataNascimento.value.length > 0) {
			...
			if (parseInt(idadeFuncionario) < parseInt(idadeMinimaFuncionario)) {
				...
				alert("O funcionário terá que possuir, no mínimo, "
...
<html:form action="/inserirFuncionarioAction.do" 
	...
	type="gsan.gui.cadastro.funcionario.InserirFuncionarioActionForm"
