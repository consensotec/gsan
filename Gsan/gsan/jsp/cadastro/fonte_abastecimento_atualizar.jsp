		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<html:radio property="indicadorCalcularVolumeFixo" tabindex="3" value="2" ><strong>Não</strong></html:radio>
					</td>
					<td>&nbsp;</td>
				</tr>
				...
				<tr>
					...
					<html:radio property="indicadorPermitePoco" tabindex="3" value="2" ><strong>Não</strong></html:radio>
					</td>
					<td>&nbsp;</td>
				</tr>
