...
function validarForm(){
	...
	if (validateEmitirBoletosActionForm(form)){
...
<html:form action="/emitirBoletosAction.do"
	...
	type="gsan.gui.cadastro.EmitirBoletosActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr> 
              	...
              	<tr> 
	                <td width="25%"><strong>Entidade Beneficente:<font	color="#FF0000">*</font></strong></td>
	                <td align="left" colspan="2"><div align="left"> <strong> 
	                    <html:select property="entidadeBeneficente" >
							<logic:present name="colecaoEntidadeBeneficente">
								<html:option value="">&nbsp;</html:option>
								<html:options collection="colecaoEntidadeBeneficente" labelProperty="cliente.nome" property="id" />
							</logic:present>
						</html:select>
	                    </strong></div>
	                </td>
