...
<html:javascript staticJavascript="false" formName="InserirProjetoForm" />
...
function validarForm(){
	...
	if (validateInserirProjetoForm(form)){
...
<html:form action="/inserirProjetoAction.do"
	name="InserirProjetoForm"
	type="gsan.gui.cadastro.projeto.InserirProjetoForm"
	method="post">
		...
		<table width="770" border="0" cellspacing="5" cellpadding="0">
			...
			<!--Início Tabela Reference a Páginação da Tela de Processo-->
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<td class="parabg">Inserir Projeto</td>
			...
			<!--Fim Tabela Reference a Páginação da Tela de Processo-->
				...
				<table width="100%" border="0">
					<tr>
						<td colspan="2">Para inserir um Projeto, informe os
						dados abaixo:</td>
					</tr>
					...
					<td colspan="3"><strong> <html:text property="idOrgaoFinanciador" size="10"
						maxlength="10"
						tabindex="3"
						onkeypress="javascript:return validaEnter(event, 'exibirInserirProjetoAction.do?pesquisarCliente=sim', 'idOrgaoFinanciador');" />
					</strong> <a
					...
					<a
						href="javascript:abrirCalendario('InserirProjetoForm', 'dataInicio');">
					<img border="0"
					...
					<td><strong> <html:text maxlength="10"
						...
						onkeyup="mascaraData(this, event);" />
					<a
						href="javascript:abrirCalendario('InserirProjetoForm', 'dataFim');">
					<img border="0"
						src="<bean:message key="caminho.imagens"/>calendario.gif"
						width="20" border="0" align="absmiddle" alt="Exibir Calendário" /></a>
					</strong>
					...
					<tr>
						...
						<td width="75%">
							<html:textarea property="observacao" cols="40" rows="4" onkeyup="limitTextArea(document.forms[0].observacao, 299, document.getElementById('utilizado'), document.getElementById('limite'));"/><br>
					...
					<tr>
						<td colspan="2"><input name="Button" type="button"
							...
							onclick="window.location.href='<html:rewrite page="/exibirInserirProjetoAction.do?menu=sim"/>'"> 
							<input name="Button"
