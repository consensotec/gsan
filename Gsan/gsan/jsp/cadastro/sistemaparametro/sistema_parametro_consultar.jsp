...
<body leftmargin="5" topmargin="5"
	...
	<html:form action="/exibirConsultarParametrosSistemaAction"
		type="gsan.gui.cadastro.sistemaparametro.ConsultarParametrosSistemaActionForm"
		method="post">
											...
											<td>
												<table border="0" width="100%">
													...
													<tr>
														...
														inserir conta antecipada:</strong>
														</td>
														<td><html:text property="numeroMaximoMesesInserirContaAntecipada"
																maxlength="2" size="2" readonly="true"
																style="background-color:#EFEFEF; border:0; color: #000000" />
														</td>
													</tr>
													...
													<tr>
														<td width="40%" align="left"><strong>Número máximo de dias entre data ligação e leitura para tratar como nova ligação:</strong>
														</td>
														<td><html:text
																property="numeroMaximoDiasNovaLigacao" maxlength="3"
