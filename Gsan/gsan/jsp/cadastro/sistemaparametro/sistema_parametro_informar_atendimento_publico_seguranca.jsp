...
<script>
	...
	function IntegerValidations () {
		...
		this.aj = new Array("diasVencimentoCertidaoNegativa", "Número dias de Vencimento para gerar Certidão Negativa deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		...
		this.al = new Array("qtdDiasGuardarOcorrenciasParalisacao", "Quantidade de dias para guardar ocorrências de paralisação deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		
		
	}

	function caracteresespeciais () {
	this.aa = new Array("descricaoRegulamento", "Descrição Regulamento possui caracteres especiais.", new Function ("varName", " return this[varName];"));
	...
	function required () {
		...
		this.ai = new Array("diasVencimentoCertidaoNegativa", "Informe Número dias de Vencimento para gerar Certidão Negativa.", new Function ("varName", " return this[varName];"));
		this.aj = new Array("qtdDiasGuardarOcorrenciasParalisacao", "Informe Quantidade de dias para guardar ocorrências de paralisação.", new Function ("varName", " return this[varName];"));
					...
					<table width="100%" border="0">
						...
						<tr>
							<td colspan="2" align="center"><strong>Parâmetros
									para Atendimento ao Público:</strong>
							</td>
						</tr>
						...
						<tr>
							<td width="40%"><strong>Indicador de Controle de
									Autorização para a Tramitação do RA:</strong>
							</td>
							<td><strong> <html:radio
						...
						<tr>
							<td width="40%"><strong>Indicador de Calculo da
									Data Prevista do RA em Dias Úteis:</strong>
							</td>
							<td><strong> <html:radio
						...
						<tr>
							<td><strong> Situação de Água na Exclusão de Imóvel: </strong></td>
						...
						<tr>
							<td><strong> Situação de Esgoto na Exclusão de Imóvel: </strong></td>
						...
						<tr>
							<td width="40%" align="left"><strong>Prazo para
									Revisão de Conta(nº dias após vencimento):<font color="#FF0000"></font>
							</strong></td>
						...
						<tr>
							<td width="40%"><strong>Indicador de D&eacute;bito
									a Cobrar v&aacute;lido Certidão Negativa:</strong></td>
							<td><strong> <html:radio
						...
						<tr>
							<td width="40%"><strong>Indicador de Documento
									obrigatório para 2ª via da Conta:</strong>
							</td>
							<td><strong> <html:radio
						...
						<tr>
							<td width="40%" align="left"><strong>Número de dias
									para validade ordem de fiscalização:</strong></td>
						...
						<tr>
							<td width="40%" align="left"><strong>Número máximo
									de dias para uma ordem de serviço ser fiscalizada:</strong></td>
						...
						<tr>
							<td width="40%" align="left"><strong>E-mail do
									Responsável:<font color="#FF0000">*</font>
							</strong></td>
						...
						<tr>
							<td width="40%"><strong>Indicador de controle de
									dias de expiração de senha por Grupo:</strong>
							</td>
							<td><strong> <html:radio
						...
						<tr>
							<td><strong>Regulamento de Serviços:</strong>
							</td>
						</tr>
						
						<tr>
							<td><strong>Descrição regulamento:</strong>
							</td>
						...
						<tr>
							<td><strong>Estrutura Tarifária:</strong>
							</td>
						</tr>


						<tr>
							<td><strong>Descrição decreto:</strong>
							</td>
						...
						<tr>
							<td><strong>Descrição lei:</strong>
							</td>
						...
						<tr>
							<td><strong>Descrição Norma CO:</strong>
							</td>
						...
						<tr>
							<td><strong>Descrição Norma CM:</strong>
							</td>
						...
						<tr>
							<td width="40%" align="left"><strong>Quantidade de dias para guardar ocorrências de paralisação:<font color="#FF0000">*</font></strong></td>
							<td><html:text maxlength="2"
