...
<html:javascript staticJavascript="false"
	formName="AtualizarFeriadoActionForm" />
<script language="JavaScript"
...
<script language="JavaScript">
	 ...
	 function bloquearMunicipio(){
		var form = document.AtualizarFeriadoActionForm;
   ...
   function validarForm() {
      var form = document.forms[0];
	  if(validateAtualizarFeriadoActionForm(form)){	     
...
<body leftmargin="5" topmargin="5"
	onload="setarFoco('${requestScope.nomeCampo}');bloquearMunicipio();">

<html:form action="/atualizarFeriadoAction"
	name="AtualizarFeriadoActionForm"
	type="gsan.gui.cadastro.sistemaparametro.AtualizarFeriadoActionForm"
	method="post"
	onsubmit="return validateAtualizarFeriadoActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Feriado</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para atualizar o feriado, informe os dados abaixo:</td>
				</tr>

				<tr>
					<td width="30%" class="style3"><strong>Tipo do Feriado:</strong></td>
					<td width="70%" colspan="2">
						<html:radio	property="indicadorTipoFeriado" value="1" tabindex="1"	disabled="true" 
						style="background-color:#EFEFEF; border:0; color: #000000;"/><strong>Nacional
						<html:radio  property="indicadorTipoFeriado" value="2" tabindex="2" disabled="true" 
						style="background-color:#EFEFEF; border:0; color: #000000;" />Municipal</strong>
									
					</td>
				</tr>
				
				<tr>
					<td width="30%" class="style3"><strong>Código do Feriado:</strong></td>
					<td width="70%" colspan="2" ><html:text property="codigoFeriado" size="4" maxlength="4" tabindex="3" 
				...
				<tr>
					...
					<td width="70%" colspan="2">
						...
						<html:text property="idMunicipio" size="4" maxlength="4" tabindex="4" 
							onkeypress="validaEnterComMensagem(event,'exibirAtualizarFeriadoAction.do?pesquisa=S','idMunicipio','Município');" />
						...
						<logic:notPresent name="municipioEncontrado">
							<logic:empty name="AtualizarFeriadoActionForm" property="idMunicipio">
								<html:text property="descricaoMunicipio" size="40" maxlength="40" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #ff0000" />
							</logic:empty>
							<logic:notEmpty name="AtualizarFeriadoActionForm" property="idMunicipio">
								<html:text property="descricaoMunicipio" size="40" maxlength="40" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000" />
							</logic:notEmpty>
						</logic:notPresent> 
			   ...
			   <tr> 
					...
					<td width="70%" colspan="2">
						<html:text property="dataFeriado" size="10" maxlength="10" tabindex="5" onkeyup="mascaraData(this,event)"/>
						<a href="javascript:abrirCalendario('AtualizarFeriadoActionForm', 'dataFeriado')">
				...
				<tr>
				   ...
				   <td width="70%" colspan="2"><strong><b><span class="style2"> 
				  		<html:text property="descricaoFeriado" size="20" maxlength="20" tabindex="6"/> </span></b></strong></td>
				</tr>
				<tr>
				</tr>
				<tr>
			...
			<table width="100%">
				<tr>
					<td width="40%" align="left">
						...
						onclick="window.location.href='/gsan/exibirAtualizarFeriadoAction.do?desfazer=S&reloadPage=1&tipoFeriado=<bean:write 
						name="AtualizarFeriadoActionForm" property="indicadorTipoFeriado" />&idFeriado=<bean:write 
						name="AtualizarFeriadoActionForm" property="codigoFeriado" />';">
					...
					<td align="right">
						...
						value="Atualizar" onclick="validarForm();" tabindex="7" />
					</td>
				</tr>
			</table>
			</td>
