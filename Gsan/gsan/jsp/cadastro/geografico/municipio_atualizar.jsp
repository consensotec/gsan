...
<html:form action="/atualizarMunicipioAction.do"
	...
	type="gsan.gui.cadastro.geografico.AtualizarMunicipioActionForm"
	method="post"
		...
		<tr>
			...
			<table width="100%" border="0">
			   ...
			   <tr> 
				...
				<tr>
					<td width="40%" class="style3"><strong>Contrato de Adesão de Serviços:</strong></td>
					<td width="60%" colspan="2"><html:select
						property="contratoAdesao" tabindex="4" style="width:200px;">
						<html:option value="-1"> &nbsp; </html:option>
						<html:options collection="colecaoContratoAdesao" property="id"
