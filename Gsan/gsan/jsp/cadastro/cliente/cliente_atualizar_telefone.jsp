...
<%@ page import="gsan.cadastro.cliente.FoneTipo" %>
...
function IntegerValidations () {
	...
	this.ab = new Array("ddd", "DDD deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	this.ac = new Array("telefone", "Número do Telefone deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	this.ad = new Array("ramal", "Ramal deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
}

function caracteresespeciais () {
	this.aa = new Array("idMunicipio", "Município possui caracteres especiais.", new Function ("varName", " return this[varName];"));
...
function verificarTamanhoTelefone() {
	...
	if (!(form.telefone.value.length >= 7 && form.telefone.value.length <= 9)) {
		alert('Número do Telefone deve conter entre 7 e 9 dígitos.');
		return false;
	} else {
		return true;
	}
