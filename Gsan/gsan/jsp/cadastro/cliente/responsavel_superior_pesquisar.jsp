...
var bCancel = false;
    ...
    function validatePesquisarActionForm(form) {
      ...
      return true;
       ...
       return testarCampoValorZero(document.PesquisarActionForm.cnpj, 'CNPJ') 
       && validateCaracterEspecial(form) && validateLong(form) && validateCnpj(form) 
       && validatePesquisar(form);
   }

    function validatePesquisar(form) {
		if (form.cnpj.value=='' && form.nome.value=='' && form.idEsferaPoder.value==-1) {
			alert('É obrigatório informar pelo menos um dos campos.');
			return false;
		} 
		return true;
    }
		...
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td width="86%"><html:text maxlength="14" property="cnpj" size="14" onkeypress="return isCampoNumerico(event);" />
					<br>
				...
				<tr>
					...
					<td align="right">
					<html:submit value="Pesquisar" styleClass="bottonRightCol"/></td>
				</tr>
			</table>
			<p>&nbsp;</p>
			</td>
