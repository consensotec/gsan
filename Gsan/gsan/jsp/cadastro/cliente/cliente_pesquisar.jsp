...
function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	...
	if (tipoConsulta == 'municipio') {
		...
		form.descricaoMunicipioClienTabelaAuxiliarIndicadorActionFormte.value = descricaoRegistro;
		...
		<tr>
    		...
    		<table width="100%" border="0">
				...
				<tr>
					...
					<td>
						<html:text maxlength="11" property="cpf" size="11" tabindex="3" onkeypress="return isCampoNumerico(event);"/>
					</td>
				</tr>
				<tr>
					<td height="28"><strong>RG:</strong></td>
					<td>
						<html:text maxlength="13" property="rg" size="14" tabindex="4" onkeypress="return isCampoNumerico(event);" />
					</td>
				</tr>
				<tr>
					<td height="28"><strong>CNPJ:</strong></td>
					<td>
						<html:text maxlength="14" property="cnpj" size="14" tabindex="5" onkeypress="return isCampoNumerico(event);" />
					</td>
				</tr>
				<tr>
					<td height="28"><strong>CEP:</strong></td>
					<td>
						<html:text maxlength="8" property="cepClienteEndereco" size="9" tabindex="6" onkeypress="return isCampoNumerico(event);" />
					</td>
				</tr>
				<tr>
					...
					<td>
						<html:text maxlength="4" property="idMunicipioCliente" size="4" tabindex="7"
							onkeypress="javascript:validaEnterComMensagem(event, 'exibirPesquisarClienteAction.do?objetoConsulta=1', 'idMunicipioCliente', 'Município'); return isCampoNumerico(event);" />
				...
				<tr>
					...
					<td>
						<html:text maxlength="4" property="codigoBairroCliente" tabindex="8" size="4"
							onkeypress="javascript:validaEnterComMensagem(event, 'exibirPesquisarClienteAction.do?objetoConsulta=1', 'codigoBairroCliente', 'Bairro');" onkeypress="return isCampoNumerico(event);" />
				...
				<tr>
					...
					<td width="18%">
						<html:text property="idLogradouroCliente" size="9" maxlength="9" tabindex="9"
							onkeypress="validaEnterComMensagem(event, 'exibirPesquisarClienteAction.do?objetoConsulta=1', 'idLogradouroCliente', 'Logragouro'); return isCampoNumerico(event);" />
						...
						<logic:present name="idLogradouroNaoEncontrado">
							<logic:equal name="idLogradouroNaoEncontrado" value="exception">
								<html:text property="nomeLogradouroCliente" size="35" maxlength="30" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #ff0000" />
							</logic:equal>
						...
						<logic:notPresent name="idLogradouroNaoEncontrado">
							<logic:empty name="PesquisarActionForm" property="idLogradouroCliente">
								<html:text property="nomeLogradouroCliente" value="" size="35" maxlength="30" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #ff0000" />
							</logic:empty>
