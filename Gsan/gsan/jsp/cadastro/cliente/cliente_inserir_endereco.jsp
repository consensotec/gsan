...
function remover(objeto){
	if (confirm ("Confirma remoção?")) {
		redirecionarSubmit('removerInserirClienteColecaoEnderecoAction.do');
	}
}
</script>
</head>
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Clique em adicionar para informar o(s) endere&ccedil;o(s) abaixo:</td>
					<logic:present scope="application" name="urlHelp">
						<td align="right"><a href="javascript:abrirPopupHelp('${applicationScope.urlHelp}cadastroClienteInserirAbaEndereco', 500, 700);"><span style="font-weight: bold"><font color="#3165CE">Ajuda</font></span></a></td>									
					</logic:present>
    		...
    		<table width="100%" border="0">
				<tr>
					...
					<td width="432" align="right">
						...
						onclick="javascript:abrirPopup('exibirInserirEnderecoAction.do?tipoPesquisaEndereco=cliente&operacao=1&mostrarPerimetro=sim', 570, 700);" />
						</logic:equal>
						<logic:equal name="POPUP" value="true" scope="session">
						<html:button
						styleClass="bottonRightCol" property="adicionar" value="Adicionar"
						onclick="javascript:abrirPopupModalDeNome('exibirInserirEnderecoAction.do?tipoPesquisaEndereco=cliente&operacao=1&mostrarPerimetro=sim', 570, 700, 'PopUpEndereco', 'no');" />
						</logic:equal>
					</td>
				</tr>
				<tr>
						...
						<tr>
							...
							<table width="100%" bgcolor="#99CCFF">
								...
								<logic:present name="colecaoEnderecos">
									...
									<logic:iterate name="colecaoEnderecos" id="endereco" scope="session">
										...
										<%}%>
											...
											<td width="81%">
												<a href="javascript:passarParametros('exibirInserirEnderecoAction.do?exibirEndereco=OK&tipoPesquisaEndereco=cliente&mostrarPerimetro=sim&operacao=1&objetoSelecionado=<%= "" + GcomAction.obterTimestampIdObjeto(endereco) %>')"><bean:write name="endereco" property="enderecoFormatado"/></a>
											</td>
										</tr>
									</logic:iterate>
								</logic:present>
...
<script>
document.getElementById('botaoConcluir').onclick = function() { botaoAvancarTelaEspera('/gsan/inserirClienteWizardAction.do?concluir=true&action=inserirClienteEnderecoAction'); }
