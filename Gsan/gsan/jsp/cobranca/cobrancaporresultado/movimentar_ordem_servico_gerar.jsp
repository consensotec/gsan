  ...
  <tr>
    ...
    <td width="625" valign="top" class="centercoltext">
      ...
      <table border="0" width="100%">
        <tr>
          <td colspan="2">Para gerar OS para comandos de contas em cobrança por empresa, informe os dados abaixo:</td>
        </tr>
		...
		<tr>
			<td width="25%"><strong>Tipo de Serviço:<font color="#ff0000">*</font></strong></td>
		...
		<tr>
			<td width="25%"><strong>Situação da Ligação da Água:</strong></td>
