...
<SCRIPT LANGUAGE="JavaScript">
	...
	function limparEmpresa() {
		...
		form.periodoCicloInicial.value = '';
		form.periodoCicloFinal.value = '';
		
		form.action = 'exibirConsultarComandosContasCobrancaEmpresaAction.do?limpar=sim';
	...
	function selecionarComandos(){
		...
		if(form.idEmpresa.value !=null && form.idEmpresa.value !="" && form.idEmpresa.value !=" "){
			if(form.periodoCicloInicial.value !='' && form.periodoCicloInicial.value.length < 10){
				perIni = false;
				alert('Informe um período inicial válido');				
			}
			if(form.periodoCicloFinal.value !='' && form.periodoCicloFinal.value.length < 10){
				perFin = false;
				alert('Informe um período final válido');				
			}
			if(perIni && perFin){
				form.action = 'exibirConsultarComandosContasCobrancaEmpresaAction.do?selecionarComandos=sim';
	    		form.submit();
			}
		}
		else{
	...
	function movimentarOS() {
		form = document.forms[0];
	  	...
	  	if (selecionouComando()) {
	  		form.action = 'exibirMovimentarOrdemServicoAction.do?comando=' + comandoSelecionado();
	    	form.submit();
	  	}
	}
	...
	function encerrarComando() {
	  	...
	  	if (selecionouComando()) {
	  		form.action = 'consultarComandosContasCobrancaEmpresaAction.do?acao=encerrarComando';
	    	form.submit();
	  	}
	}
	...
	function selecionouComando(){
		...
		if(retorno == false){
			alert('Selecione um Comando de Conta em Cobrança.');
		}
...
<html:form action="/consultarComandosContasCobrancaEmpresaAction"
	name="ConsultarComandosContasCobrancaEmpresaActionForm"
	type="gsan.gui.cobranca.cobrancaporresultado.ConsultarComandosContasCobrancaEmpresaActionForm"
	method="post">
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><html:text maxlength="9" property="idEmpresa" size="9"
						tabindex="14" 
						onkeypress="validaEnterComMensagem(event, 'exibirConsultarComandosContasCobrancaEmpresaAction.do', 'idEmpresa', 'Empresa');
						limparEmpresaTecla();
				...
				<tr>
					...
					<td><strong> <html:text maxlength="10"
						property="periodoCicloInicial" size="10" tabindex="10"
						onkeyup="replicarCampo(document.forms[0].periodoCicloFinal, this);return mascaraDataNova(this, event);"
						onchange="limparComandos();" />
					<a
						href="javascript:abrirCalendarioReplicando('ConsultarComandosContasCobrancaEmpresaActionForm', 'periodoCicloInicial', 'periodoCicloFinal');">
					<img border="0"
						src="<bean:message key="caminho.imagens"/>calendario.gif"
						width="20" border="0" align="absmiddle" alt="Exibir Calendário" /></a>
					</strong> <html:text maxlength="10" property="periodoCicloFinal"
						tabindex="11" size="10" onkeyup="mascaraData(this, event);"
						onchange="limparComandos();" /> <a
						href="javascript:abrirCalendario('GerarArquivoTextoContasCobrancaEmpresaActionForm', 'periodoCicloFinal')">
					<img border="0"
						src="<bean:message key="caminho.imagens"/>calendario.gif"
						width="20" border="0" align="absmiddle" alt="Exibir Calendário" /></a>
					(dd/mm/aaaa)</td>
					...
					<tr>
						...
						<table width="100%" bgcolor="#99CCFF" border="0">
							<tr bordercolor="#000000">
								<td width="10%" bgcolor="#90c7fc" align="center" rowspan="2"><strong>Selecionar</strong></td>
					...
					<tr>
						...
						<table width="100%" bgcolor="#99CCFF">
							<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
								...
								<pg:param name="q" />
								<logic:present
									name="colecaoConsultarComandosContasCobrancaEmpresaHelper">
									<%int cont = 0;%>
									<logic:iterate
										name="colecaoConsultarComandosContasCobrancaEmpresaHelper"
										id="consultarComandosContasCobrancaEmpresaHelper"
										type="ConsultarComandosContasCobrancaEmpresaHelper"
										scope="session">
										<pg:item>
											<%cont = cont + 1;
									if (cont % 2 == 0) {%>
											...
											<tr bgcolor="#FFFFFF">
												...
												<div align="center"><html:radio property="idRegistro"
													value="${consultarComandosContasCobrancaEmpresaHelper.idComandoEmpresaCobrancaConta}" />
												</div>
												</td>

												<td align="center" width="10%"><a
													href="javascript:abrirPopup('exibirConsultarComandosContasCobrancaEmpresaPopupAction.do?pesquisa=nao&idComandoEmpresaCobrancaConta=<%= consultarComandosContasCobrancaEmpresaHelper
													.getIdComandoEmpresaCobrancaConta()%>', 475, 600);">
												<%=consultarComandosContasCobrancaEmpresaHelper
															.getIdComandoEmpresaCobrancaConta()%> </a></td>

												<td align="center" width="9%">
												<logic:present
													name="consultarComandosContasCobrancaEmpresaHelper"
													property="dataInicioCiclo">
													<logic:empty name="consultarComandosContasCobrancaEmpresaHelper"
														property="dataExecucao">
														<font color="red"><%=Util
																.formatarData(consultarComandosContasCobrancaEmpresaHelper
																		.getDataInicioCiclo())%></font>
													</logic:empty>
													<logic:notEmpty name="consultarComandosContasCobrancaEmpresaHelper"
														property="dataExecucao">
														<%=Util
																.formatarData(consultarComandosContasCobrancaEmpresaHelper
																		.getDataInicioCiclo())%>
													...
													name="<%=Util.formatarData(consultarComandosContasCobrancaEmpresaHelper.getDataInicioCiclo())%>">&nbsp;</logic:notPresent>
												</td>
												
												<td align="center" width="8%"><logic:present
													name="consultarComandosContasCobrancaEmpresaHelper"
													property="dataFinalCiclo">
													<logic:empty name="consultarComandosContasCobrancaEmpresaHelper"
														property="dataEncerramento">
														<font color="red">
															<%=Util
																.formatarData(consultarComandosContasCobrancaEmpresaHelper
																		.getDataFinalCiclo())%></font>
													</logic:empty>
													<logic:notEmpty name="consultarComandosContasCobrancaEmpresaHelper"
														property="dataEncerramento">
														<%=Util
													...
													name="<%=Util.formatarData(consultarComandosContasCobrancaEmpresaHelper.getDataFinalCiclo())%>">&nbsp;</logic:notPresent>
												</td>
												
												<td align="center" width="13%"><logic:present
													name="consultarComandosContasCobrancaEmpresaHelper"
													property="dataExecucao">
													<%=Util
																.formatarData(consultarComandosContasCobrancaEmpresaHelper
													...
													name="<%=Util.formatarData(consultarComandosContasCobrancaEmpresaHelper.getDataExecucao())%>">&nbsp;</logic:notPresent>
												</td>
												...
												<td align="center" width="13%"><logic:present
													...
													name="<%=Util.formatarData(consultarComandosContasCobrancaEmpresaHelper.getDataEncerramento())%>">&nbsp;</logic:notPresent>
												</td>
				...
				<table width="100%" border="0">
				<logic:present name="colecaoConsultarComandosContasCobrancaEmpresaHelper">
					<tr>
						<td colspan="2">
					...
					<tr>
						<td>
							<input name="Button" type="button" class="bottonRightCol"
								...
								onclick="window.location.href='<html:rewrite page="/exibirConsultarComandosContasCobrancaEmpresaAction.do?menu=sim"/>'">
							<input name="Button" type="button" class="bottonRightCol"
								value="Cancelar" align="left"
								onclick="javascript:window.location.href='/gsan/telaPrincipal.do'">
						</td>
						<td align="right">
							<logic:present name="permissaoEspecialEncerrarComando" scope="session">
								<input type="button" name="encerrar"
									class="bottonRightCol" value="Encerrar Comando"
									onClick="javascript:encerrarComando();" />
							</logic:present>
							
							<logic:notPresent name="permissaoEspecialEncerrarComando" scope="session">
								<input type="button" name="encerrar" disabled="disabled"
									class="bottonRightCol" value="Encerrar Comando"
									onClick="" />
							</logic:notPresent>
