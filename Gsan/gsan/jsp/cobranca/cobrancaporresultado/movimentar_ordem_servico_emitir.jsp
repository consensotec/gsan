...
<%@page import="gsan.gui.cobranca.cobrancaporresultado.OrdemServicoGeradaEmpresaCobrancaHelper" %>
		       ...
		       <div id="tipoVisitaCobranca" style="display:none;">
        		...
        		<table border="0">
					...
					<logic:present name="IcDebito" scope="session">
					 <td width="30%" align="left"><strong>Intervalo de Valor de Débito:<font color="#ff0000"></font></strong>
			          </td>
			          <td width="45%" align="center">&nbsp;&nbsp;<strong>
			          		<html:text property="valorMinimoDebito" size="14"
								maxlength="14" tabindex="12"
								onkeyup="formataValorMonetario(this, 14); replicarCampo(document.forms[0].valorMaximoDebito, document.forms[0].valorMinimoDebito);"
								onchange="javascript:limparTotalizacao();" 
								style="text-align:right;" /> a 
							<html:text property="valorMaximoDebito"
