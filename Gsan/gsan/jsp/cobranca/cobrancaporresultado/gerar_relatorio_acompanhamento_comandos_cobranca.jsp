...
<div id="formDiv">  
<html:form action="/gerarRelatorioAcompanhamentoComandosCobrancaAction"
	name="GerarRelatorioAcompanhamentoComandosCobrancaActionForm"
	type="gsan.gui.cobranca.cobrancaporresultado.GerarRelatorioAcompanhamentoComandosCobrancaActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Relatório de Acompanhamento dos Comandos de Cobrança</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="6">Para gerar o relatório de acompanhamento dos comandos de cobrança, informe os dados abaixo:</td>
					<td align="right"></td>
				</tr>
                ...
                <td><strong>Período de Execução do Comando:<font color="#FF0000">*</font></strong></td>
		               <td width="70%"><strong> 
							<html:text  property="dataPeriodoExInicial" 
										...
										/> 
								<a href="javascript:abrirCalendarioReplicando('GerarRelatorioAcompanhamentoComandosCobrancaActionForm', 'dataPeriodoExInicial', 'dataPeriodoExFinal');"  style="text-decoration:none;">
									<img border="0"
							...
							<html:text property="dataPeriodoExFinal" 
								...
								<a href="javascript:abrirCalendario('GerarRelatorioAcompanhamentoComandosCobrancaActionForm', 'dataPeriodoExFinal')" style="text-decoration:none;">
									<img border="0"
										 src="<bean:message key="caminho.imagens"/>calendario.gif"
										 width="20" 
										 border="0" 
				...
				<tr>
					<td colspan="2" ><input name="Button" type="button" class="bottonRightCol"
						...
						onclick="window.location.href='<html:rewrite page="/exibirGerarRelatorioAcompanhamentoComandosCobrancaAction.do?menu=sim"/>'">
					...
					<td align="right"><%--<INPUT type="button" class="bottonRightCol" value="Inserir" tabindex="13" style="width: 70px;" onclick="validarForm(document.forms[0]);">--%>
		  			...
		  			<gsan:controleAcessoBotao name="Botao" value="Gerar"
						onclick="validaForm();"
						url="gerarRelatorioAcompanhamentoComandosCobrancaAction.do" tabindex="13" /></td>
				</tr>
