...
<%@ page import="gsan.cadastro.imovel.ImovelPerfil" %>
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="3"><html:text property="periodoCicloInicialPopup" size="12"
				...
				<tr>
					...
					<td colspan="3"><html:text property="periodoCicloFinalPopup" size="12"
						maxlength="10" readonly="true"
						style="background-color:#EFEFEF; border:0; font-color: #000000" />
					</td>
				</tr>
				...
				<logic:present name="colecaoSituacaoAgua" scope="session">
					...
					<tr>
						...
						<td colspan="3">
							<html:text property="localidadeComponent"
							size="5" maxlength="4" readonly="true"
							style="background-color:#EFEFEF; border:0; font-color: #000000" />
							<html:text property="nomeLocalidadeComponent" size="40" readonly="true"
							style="background-color:#EFEFEF; border:0; font-color: #000000" />
						</td>						
					</tr>
					<tr>
						<td width="35%"><strong>Setores Comerciais</strong></td>
						<td>
							<logic:present name="colecaoSetoresComponent" scope="request">
								<select multiple="multiple" disabled="disabled" style="background-color:#EFEFEF">
									<logic:iterate
											name="colecaoSetoresComponent"
											id="setComponent"
											type="SetorComercial"
											scope="request">
										<option style="color: #000">
											<c:out value="${setComponent.codigo}" />
										</option>	
									</logic:iterate>									
								</select>										
							</logic:present>
							<logic:notPresent name="colecaoSetoresComponent" scope="request">
								<input type="text" size="3" maxlength="4" readonly="readonly" 
								style="background-color:#EFEFEF; border:0; font-color: #000000"  />	
							</logic:notPresent>
						</td>
					</tr>				
				...
				<logic:present name="IcDebito" scope="session">
					<td width="35%"><strong>Valor Total de Debito:</strong></td>
					<td colspan="3"><html:text property="intervaloValorDebitoInicial"
						size="12" maxlength="10" readonly="true"
						style="background-color:#EFEFEF; border:0; font-color: #000000; text-align:right" />
					a <html:text property="intervaloValorDebitoFinal" size="12"
						maxlength="10" readonly="true"
						style="background-color:#EFEFEF; border:0; font-color: #000000; text-align:right" />
					</td>
				</logic:present>
