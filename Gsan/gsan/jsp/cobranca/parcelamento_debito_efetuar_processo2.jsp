...
<%@ page import="gsan.cobranca.bean.ContaValoresHelper"
	isELIgnored="false"%>
<%@ page import="gsan.cobranca.bean.GuiaPagamentoValoresHelper"
	isELIgnored="false"%>
				...
				<tr>
					<td colspan="4">
						<table width="100%" bgcolor="#99CCFF">
							...
							<logic:equal name="habilitaPagamentoAVista" value="1">
								<td align="right" bgcolor="#FFFFFF">
									<bean:write name="EfetuarParcelamentoDebitosActionForm" property="valorDebitoTotalAtualizado"/>
								</td>
								<td align="right" bgcolor="#FFFFFF">
									<bean:write name="EfetuarParcelamentoDebitosActionForm" property="valorTotalImpostos"/>
								</td>
								<td align="right" bgcolor="#FFFFFF">
									<bean:write name="EfetuarParcelamentoDebitosActionForm" property="valorDescontoPagamentoAVista"/>
								</td>
								<td align="right" bgcolor="#FFFFFF">
									<bean:write name="EfetuarParcelamentoDebitosActionForm" property="valorPagamentoAVista"/>
								</td>
							</logic:equal>
					...
					<table width="100%" bgcolor="#99CCFF">
						<logic:empty name="colecaoContaValores" scope="session">
							<tr bgcolor="#90c7fc">
								...
								<td align="center"><strong>Multa</strong></td>
								<td align="center"><strong>Juros</strong></td>
								<td align="center"><strong>Atu. Monetária</strong></td>
							</tr>
						</logic:empty>
							...
							<logic:iterate name="colecaoContaValores" type="ContaValoresHelper" id="contaValores">
								...
								<%}%>
									...
									<td width="25%" align="right">
										<bean:write name="contaValores" property="conta.valorTotal"	formatKey="money.format" />
									</td>
									<td width="10%" align="right">
										<bean:write name="contaValores"	property="valorMulta" formatKey="money.format" />
									</td>
									<td width="10%" align="right">
										<bean:write name="contaValores"	property="valorJurosMora" formatKey="money.format" />
									</td>
									<td width="15%" align="right">
										<bean:write name="contaValores"	property="valorAtualizacaoMonetaria" formatKey="money.format" />
									</td>
								</tr>
