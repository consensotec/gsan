 ...
 var bCancel = false;
    ...
    function validateCriterioCobrancaActionForm(form) {
      ...
      return validateRequired(form) && validateCaracterEspecial(form) && testarCampoValorZero(form.numeroAnoContaAntiga, 'Número de Anos para Determinar Conta Antiga') && validateLong(form) 
		...
		validarCampoNumericoComMensagem(form.numeroDiasAposVencimento,'Número de Dias Após o Vencimento'); 
   }
...
function validaEmissao(form){
	...
	var x = 0;
	   ...
	   if(x==0){
			...
			alert('Emissão da Ação para Imóvel com Situação de Cobrança igual a SIM, selecione pelo menos uma ou mais Situações de cobrança.');
			return false;
	  } 
	}
	   return true;
			...
			<table width="100%" border="0">
				...
				<tr> 
                    <td><strong>Data de In&iacute;cio de Vig&ecirc;ncia do Crit&eacute;rio:<font color="#FF0000">*</font></strong></td>
				     <td width="40%"><html:text maxlength="10" property="dataInicioVigencia" size="10" onkeyup="javascript:mascaraData(this,event);" tabindex="2"/>
              ...
              <tr> 
                ...
                <td width="40%"><html:text property="numeroAnoContaAntiga" size="2" maxlength="2" tabindex="3"/> 
                </td>
               ...
               <tr> 
                 ...
                 <tr>
              	...
              	<tr>
              		<td><strong>Número de Dias Após o Vencimento: </strong></td>
              ...
              <tr> 
                ...
                <table width="100%">
                 ...
                 <tr> 
 				 ...
 				 <tr>
					<td width="65%"><strong>Situa&ccedil;&atilde;o de cobran&ccedil;a:</strong></td>                 
                 	<td colspan="2">
                 	<logic:present name="desabilita">
                 		<html:select property="idsCobrancaSituacao" multiple="multiple" disabled="true"
                 		  name="CriterioCobrancaActionForm" size="8"  >
                 	...
                 	<logic:notPresent name="desabilita">
                 		<html:select property="idsCobrancaSituacao" multiple="multiple"  size="8"  >
                 ...
                 <tr> 
                  <td width="65%"><strong>Indicador de Imóvel com Situação de Cobrança:<font color="#FF0000">*</font></strong></td>
 				...
 				<tr>
					<td width="65%"><strong>Situa&ccedil;&atilde;o de Liga&ccedil;&atilde;o de &Aacute;gua:</strong>
					</td>
					<td colspan=2>
                 	<logic:present name="desabilita">
               ...
               <tr>
					<td width="65%"><strong>Situa&ccedil;&atilde;o de Liga&ccedil;&atilde;o de Esgoto:</strong>
					</td>
					<td colspan=2>
                 	<logic:present name="desabilita">                 	
               ...
               <tr> 
                ...
                <td align="right"> <input type="button" name="Submit24" class="bottonRightCol" value="Adicionar" onClick="abrirPopupComSubmit(document.forms[0],'','');" tabindex="22"> 
                </td>
               </tr>
			   ...
			   <tr>
				...
				<tr>
					<td>&nbsp;</td>
					<td>Campos Obrigatórios <font color="#FF0000">*</font></td>
				</tr>
			</table>
			<table width="100%" border="0">
				<tr>
					...
					<td valign="top">
					  <div align="right">
					    <gsan:controleAcessoBotao name="botaoInserir" value="Inserir"  onclick="validarForm(document.forms[0]);"  url="inserirCriterioCobrancaAction.do" tabindex="23"/>
