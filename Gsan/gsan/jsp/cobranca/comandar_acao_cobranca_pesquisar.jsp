...
<html:form action="/pesquisarComandoAcaoCobrancaAction.do" name="PesquisarComandoAcaoCobrancaActionForm" type="gsan.gui.micromedicao.PesquisarComandoAcaoCobrancaActionForm"
	method="post">
