...
<%@ page import="gsan.cobranca.NegativadorMovimentoReg"%>
...
<html:form action="/excluirNegativacaoOnLineAction.do"
	...
	type="gsan.gui.cobranca.ExcluirNegativacaoOnLineActionForm"
	method="post">
					...
					<logic:iterate name="colecaoHelper" scope="session" id="helper" >
		                  ...
		                  <td>
			                  ...
			                  <bean:define  name="negativadorMovimentoReg" property="valorDebito" id="valor" />
			                     <strong><b><span class="style1">
			                  		...
			                  		value="<%=  gsan.util.Util.formataBigDecimal((java.math.BigDecimal)valor,2,true)%>" ></span></b></strong>        
			                  </logic:present>
						  </td>
		                </tr>
		                ...
		                <tr>
		                  ...
		                  <table width="100%" border="1">
							...
							<logic:iterate name="helper"  property="itensConta" id="itensConta" >
								...
								if (((gsan.cobranca.NegativadorMovimentoRegItem)itensConta).getValorDebito() != null) {
									valorCorrente = ((gsan.cobranca.NegativadorMovimentoRegItem)itensConta).getValorDebito().doubleValue();
								}
			                    ...
			                    <tr bordercolor="#90c7fc">
			                      <td><div align="center"><strong>
				                    ...
				                    <logic:present name="itensConta" property="contaGeral.contaHistorico.anoMesReferenciaConta" >
				                      <%=Util.formatarMesAnoReferencia(((gsan.cobranca.NegativadorMovimentoRegItem)itensConta).getContaGeral().getContaHistorico().getAnoMesReferenciaConta())%>
				                    </logic:present>
				                    </logic:present>
				                    </logic:present>
			                      	<logic:present name="itensConta" property="contaGeral" >
				                    ...
				                    <logic:present name="itensConta" property="contaGeral.conta.referencia" >
				                      <%=Util.formatarMesAnoReferencia(((gsan.cobranca.NegativadorMovimentoRegItem)itensConta).getContaGeral().getConta().getReferencia())%>
				                    </logic:present>
				                    </logic:present>
				                    </logic:present>
								  </strong></div></td>
			                      ...
			                      <td><div align="center">
			                      	<%=gsan.util.Util.formataBigDecimal(new java.math.BigDecimal(valorCorrente),2,true) %> &nbsp;
				                  </div></td>
			                      <td><div align="center">
		                    ...
		                    <tr bordercolor="#90c7fc">
		                      ...
		                      <td><div align="center"><%=gsan.util.Util.formataBigDecimal(new java.math.BigDecimal(valor),2,true) %></div></td>
		                      <td>&nbsp;</td>
		                      <td>&nbsp;</td>
		                    </tr>
		                  </table>                  
		                ...
		                <tr>
		                  ...
		                  <table width="100%" border="1">
							...
							quantidade = quantidade +1 ;
							double valorCorrente = 0;
							if (((gsan.cobranca.NegativadorMovimentoRegItem)itensGuiaPagamento).getValorDebito() != null) {
								valorCorrente = ((gsan.cobranca.NegativadorMovimentoRegItem)itensGuiaPagamento).getValorDebito().doubleValue();
							}
							valor = valor + valorCorrente;
							%>
		                      ...
		                      <tr bordercolor="#90c7fc">
		                        ...
		                        <td><div align="center">99/99/9999&nbsp;</div></td>
		                        <td><div align="center"><%=gsan.util.Util.formataBigDecimal(new java.math.BigDecimal(valorCorrente),2,true) %></div></td>
