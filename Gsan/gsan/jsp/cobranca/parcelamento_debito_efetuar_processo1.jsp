...
<%@ page import="gsan.atendimentopublico.ligacaoagua.LigacaoAguaSituacao" %>
...
function required () { 
	...
	this.am = new Array("nomeClienteParcelamento", "Pressione [Enter] após informar o número do Cliente Responsável.", new Function ("varName", " return this[varName];"));
...
function verificaExistenciaMatricula(){
	...
	if( form.matriculaImovel.value == "" ){
		...
		if(!form.indicadorParcelamentoCarne[0].checked && !form.indicadorParcelamentoCarne[1].checked ){
			form.indicadorParcelamentoCarne[1].checked = true;
		}

		if(!form.indicadorCarneImovelCliente[0].checked && !form.indicadorCarneImovelCliente[1].checked ){
			form.indicadorCarneImovelCliente[0].checked = true;
		}	
...
function habilitarCarneParaCliente() {
	var form = document.forms[0];

	if (form.indicadorParcelamentoCarne[0].checked) {
		form.indicadorCarneImovelCliente[1].disabled = false;
	} else {
		form.indicadorCarneImovelCliente[0].checked = true;
		form.indicadorCarneImovelCliente[1].disabled = true;
	}
}
...
<body leftmargin="5" topmargin="5" onload="habilitaMatricula();verificaExistenciaMatricula();javascript:setarFoco('${requestScope.nomeCampo}');habilitarCarneParaCliente();">

<div id="formDiv">
<html:form action="/efetuarParcelamentoDebitosWizardAction"
	name="EfetuarParcelamentoDebitosActionForm"
	type="gsan.gui.cobranca.EfetuarParcelamentoDebitosActionForm"
	method="post">
		...
		<td width="625" valign="top" class="centercoltext">
            ...
            <table width="100%" border="0">
				...
				<tr> 
					...
					<td><br>
						<html:text property="dataParcelamento" size="10" maxlength="10" tabindex="2" onkeyup="mascaraData(document.forms[0].dataParcelamento,this)" onkeypress="return isCampoNumerico(event);"/>
				...
				<tr> 
					...
					<logic:notPresent name="bloqueiaIntervaloParcelamento" scope="session">
						<html:text property="inicioIntervaloParcelamento" onkeyup="mascaraAnoMes(document.forms[0].inicioIntervaloParcelamento,this);" onkeypress="return isCampoNumerico(event);" maxlength="7" size="7"/>
						...
						<logic:empty name="EfetuarParcelamentoDebitosActionForm" property="inicioIntervaloParcelamento">
						  <html:text property="fimIntervaloParcelamento" onkeyup="mascaraAnoMes(document.forms[0].fimIntervaloParcelamento,this)" onkeypress="return isCampoNumerico(event);"  maxlength="7" size="7" readonly="true"/>
						</logic:empty>
						<logic:notEmpty name="EfetuarParcelamentoDebitosActionForm" property="inicioIntervaloParcelamento">
						  <html:text property="fimIntervaloParcelamento" onkeyup="mascaraAnoMes(document.forms[0].fimIntervaloParcelamento,this)" onkeypress="return isCampoNumerico(event);"  maxlength="7" size="7"/>
						</logic:notEmpty>
					</logic:notPresent>
					...
					<logic:present name="bloqueiaIntervaloParcelamento" scope="session">
						...
						<logic:equal name="bloqueiaIntervaloParcelamento" scope="session" value="sim">
							<html:text property="inicioIntervaloParcelamento" onkeyup="mascaraAnoMes(document.forms[0].inicioIntervaloParcelamento,this)" onkeypress="return isCampoNumerico(event);"  maxlength="7" size="7" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000" />
							a 
							 <html:text property="fimIntervaloParcelamento" onkeyup="mascaraAnoMes(document.forms[0].fimIntervaloParcelamento,this)" onkeypress="return isCampoNumerico(event);"  maxlength="7" size="7" readonly="true"  style="background-color:#EFEFEF; border:0; color: #ff0000" />
						</logic:equal>	
				...
				<logic:equal name="temPermissaoParcelarGerandoCarne" value="true">
					<tr> 
						<td><strong>Parcelar em Carnê?<font color="#FF0000">*</font></strong></td>
						<td>
							<strong>
								<html:radio property="indicadorParcelamentoCarne" value="1" onchange="javascript:habilitarCarneParaCliente();" />Sim
								<html:radio property="indicadorParcelamentoCarne" value="2" onchange="javascript:habilitarCarneParaCliente();" />N&atilde;o
							</strong>
						</td>
					</tr>
					<tr> 
						<td><strong>Gerar Cobrança Para:<font color="#FF0000">*</font></strong></td>
						<td>
							<strong>
								<html:radio property="indicadorCarneImovelCliente" value="1"/>Imóvel
								<html:radio property="indicadorCarneImovelCliente" value="2" disabled="true"/>Cliente
							</strong>
						</td>
					</tr>
				</logic:equal>
				<logic:notEqual name="temPermissaoParcelarGerandoCarne" value="true">
					<html:hidden property="indicadorParcelamentoCarne" value="2"/>
					<html:hidden property="indicadorCarneImovelCliente" value="1"/>
				</logic:notEqual>
				<tr> 
					<td>&nbsp;</td>
