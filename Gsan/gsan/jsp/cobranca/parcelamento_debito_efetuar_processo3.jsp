...
<%@ page import="gsan.cobranca.bean.OpcoesParcelamentoHelper" isELIgnored="false"%>
<%@ page import="gsan.cobranca.bean.NegociacaoOpcoesParcelamentoHelper" isELIgnored="false"%>
            ...
            <table width="100%" border="0">
				...
				<tr>
					<td colspan="2">
						<table width="100%" bgcolor="#99CCFF">
							<tr bgcolor="#90c7fc">  
								<td align="center">
									<strong>Nos Acrésc. Impontualidade</strong>
								</td>
								<td align="center">
							...
							<tr bgcolor="#cbe5fe"> 
								<td align="right" bgcolor="#FFFFFF">
									...
									<logic:notEqual name="EfetuarParcelamentoDebitosActionForm" property="descontoAcrescimosImpontualidade" value="0,00">
										<a href="javascript:abrirPopup('exibirValorDescontoAcrescimosImpontualidadeConsultarPopupAction.do?multa=<bean:write name="EfetuarParcelamentoDebitosActionForm" property="descontoMulta" />&juros=<bean:write name="EfetuarParcelamentoDebitosActionForm" property="descontoJuros" />&atualizacao=<bean:write name="EfetuarParcelamentoDebitosActionForm" property="descontoAtualizacaoMonetaria" />', 300, 650);">	
											<bean:write name="EfetuarParcelamentoDebitosActionForm"	property="descontoAcrescimosImpontualidade"/>
										</a>
									</logic:notEqual>
									<logic:equal name="EfetuarParcelamentoDebitosActionForm" property="descontoAcrescimosImpontualidade" value="0,00">	
										0,00
									</logic:equal>
								...
								<td align="right" bgcolor="#FFFFFF">
									<bean:write name="EfetuarParcelamentoDebitosActionForm" 
											property="descontoSobreDebitoTotal"/>
								</td>
								<td align="right" bgcolor="#FFFFFF">
									<bean:write name="EfetuarParcelamentoDebitosActionForm" 
											property="descontoDebitoTipo"/>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr> 
					...
					<td>
						...
						<logic:equal name="habilitaValorEntrada" value="1">
						...
						<logic:notEqual name="habilitaValorEntrada" value="1">
							<html:text property="valorEntradaInformado" maxlength="20" size="20" readonly="True"
							onkeyup="formataValorMonetario(this,20)" style="text-align: right;"/>&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="button" name="" value="Calcular" class="bottonRightCol" onClick="enviar();" disabled="disabled"/>
						</logic:notEqual>
						...
						<table width="100%" bgcolor="#99CCFF">
							...
							<% } %>
								...
								<logic:equal name="opcoesParcelamento" property="indicadorExisteParcelamentoEmAndamento" scope="session" value="1">
									...
									<logic:equal name="opcoesParcelamento" property="indicadorNaoPermiteParc" scope="session" value="1">
									<tr>
										<td colspan="2">
											<font color="#FF0000">As normas da RD não permitem parcelar o débito do imóvel.</font>
										</td>
									</tr>
								</logic:equal>
