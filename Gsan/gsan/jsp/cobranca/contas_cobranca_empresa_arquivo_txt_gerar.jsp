...
<%@page
	import="gsan.cobranca.GerarArquivoTextoContasCobrancaEmpresaHelper"%>
...
<html:form action="/gerarArquivoTextoContasCobrancaEmpresaAction"
	...
	type="gsan.gui.cobranca.GerarArquivoTextoContasCobrancaEmpresaActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Arquivo Texto de Contas em Cobrança por Empresa</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para gerar o arquivo texto das contas em cobrança por
