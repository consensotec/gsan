...
<%@ page import="gsan.cobranca.CobrancaAcaoAtividadeComando"%>
<%@ page import="gsan.cobranca.CobrancaCriterio"%>
...
<html:form
	...
	type="gsan.gui.cobranca.ManterComandoAcaoCobrancaEventualCriterioComandoActionForm"
	method="post"
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" dwcopytype="CopyTableRow">
				...
				<tr>
					<td colspan="5">
					<table width="595" bgcolor="#99CCFF">
						<tr bgcolor="#99CCFF">
						...
						<tr bgcolor="#99CCFF">
							<td width="1%" rowspan="2" bgcolor="#90c7fc">
							...
							<td width="6%" rowspan="2" bgcolor="#90c7fc">
							<div align="center"><strong>Nº Anos Det. Conta Antiga</strong></div>
							</td>
						...
						<tr bordercolor="#000000">
							...
							<div align="center"><strong>Sit. Esp. Cob.</strong></div>
							</td>
							<td width="10%" bgcolor="#90c7fc">
							<div align="center"><strong>Sit. Cob.</strong></div>
							</td>
							<td width="10%" bgcolor="#90c7fc">
							<div align="center"><strong>Consid. Conta Rev.</strong></div>
							</td>
							<td width="10%" bgcolor="#90c7fc">
							<div align="center"><strong>Imov. Deb. Conta M&ecirc;s</strong></div>
							</td>
							<td width="10%" bgcolor="#90c7fc">
							<div align="center"><strong>Inqu. Deb. Conta M&ecirc;s</strong></div>
							</td>
							<td width="10%" bgcolor="#90c7fc">
							<div align="center"><strong>Imov. com Deb. Conta Ant.</strong></div>
							</td>
						</tr>
