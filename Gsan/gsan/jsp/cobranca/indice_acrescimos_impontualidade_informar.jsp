...
<html:form action="/informarIndiceAcrescimosImpontualidadeAction"
	...
	type="gsan.gui.cobranca.IndiceAcrescimosImpontualidadeForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td width="25%"><html:text maxlength="6" property="percentualMulta"
						onkeyup="formataValorMonetario(this, 6)" size="6" tabindex="2" />
					</td>
				</tr>
				<tr>
					...
					<td width="25%"><html:text maxlength="6"
						...
						onkeyup="formataValorMonetario(this, 6)" size="6" tabindex="3" />
					</td>
				</tr>
				<tr>
