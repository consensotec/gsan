...
<%@ page import="gsan.cobranca.parcelamento.ParcelamentoQuantidadePrestacaoHelper" %>
<%@ page import="gsan.cobranca.parcelamento.ParcelamentoFaixaValor" %>
...
<html:form action="/inserirPrestacoesParcelamentoPerfilAction"
	...
	type="gsan.gui.cobranca.parcelamento.InserirPrestacoesParcelamentoPerfilActionForm"
	method="post"
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td width="25%"><strong>Entrada com Guia de Pagamento apenas para quem possui Permissão Especial:</strong></td>
					<logic:equal name="readOnly" value="true">
						<td colspan="2">
							<html:radio property="indicadorGuiaPagamentoPermissaoEspecial" value="1" disabled="true" />SIM
							<html:radio property="indicadorGuiaPagamentoPermissaoEspecial" value="2" disabled="true"/>NÃO
						</td>
					</logic:equal>
					<logic:notEqual name="readOnly" value="true">
						<td colspan="2">
							<html:radio property="indicadorGuiaPagamentoPermissaoEspecial" value="1" disabled="false"/>SIM
							<html:radio property="indicadorGuiaPagamentoPermissaoEspecial" value="2" disabled="false"/>NÃO
						</td>
					</logic:notEqual>
				</tr>
					...
					<td colspan="6">
						...
						<tr bgcolor="#cbe5fe">
							...
							<tr>
								...
								<td width="25%"><strong>Vlr da entrada pode ser Inferior à soma das prestações Parc Anteriores que foram cobradas e ainda não estão quitadas?</strong></td>
								<logic:equal name="readOnly" value="true">
									<td colspan="2">
										<html:radio property="indicadorEntradaMenorPrestacaoParcelamento" value="1" disabled="true" />SIM
										<html:radio property="indicadorEntradaMenorPrestacaoParcelamento" value="2" disabled="true"/>NÃO
									</td>
								</logic:equal>
								<logic:notEqual name="readOnly" value="true">
									<td colspan="2">
										<html:radio property="indicadorEntradaMenorPrestacaoParcelamento" value="1" disabled="false"/>SIM
										<html:radio property="indicadorEntradaMenorPrestacaoParcelamento" value="2" disabled="false"/>NÃO
									</td>
								</logic:notEqual>
							</tr>
							...
							<tr>
								<td colspan="6">
									<table width="100%" border="0">
										<tr>
											<td width="195px;"><strong>Situação da Ligação de Água</strong></td>
					...
					<div style="width: 100%; height: 180; overflow: auto;">
						<table width="100%" border="0" bgcolor="#90c7fc">
							<tr bgcolor="#90c7fc" height="18">
								...
								<td width="10%" align="center"><strong>Entrada com Guia de Pag. apenas Permissão Esp.</strong></td>
