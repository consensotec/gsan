...
function validacaoDatasAnoMes(){

		  var form = document.forms[0];

		  if (form.periodoContabil.value != ""){
			  form.dataParcelamentoInicial.disabled = true;
			  form.dataParcelamentoFinal.disabled = true;
			  form.anoMesReferenciaContabil.disabled= true;
		  }
		  else if (form.anoMesReferenciaContabil.value != ""){
				form.dataParcelamentoInicial.disabled = true;
				form.dataParcelamentoFinal.disabled = true;
				form.periodoContabil.disabled = true;

		  } else if (form.dataParcelamentoInicial.value != "" || form.dataParcelamentoFinal.value != ""){
				form.anoMesReferenciaContabil.disabled= true;
				form.periodoContabil.disabled = true;
	      } else {
	    	  form.dataParcelamentoInicial.disabled = false;
				form.dataParcelamentoFinal.disabled = false;
				form.anoMesReferenciaContabil.disabled= false;
				form.periodoContabil.disabled = false;
		      }
	}
...
<div id="formDiv">
	<html:form action="/gerarRelatorioRelacaoParcelamentoAction.do"
		...
		type="gsan.gui.cobranca.parcelamento.GerarRelatorioRelacaoParcelamentoActionForm"
		method="post">
		...
		<table width="770" border="0" cellspacing="5" cellpadding="0">
		  <tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Ano Contábil:</strong></td>
					<td><html:text property="periodoContabil" style="width: 65px;" size="6"
						maxlength="4" onkeyup="validacaoDatasAnoMes();"
									onkeypress="return isCampoNumerico(event);"/>(aaaa)
					</td>
				</tr>
				
				<tr>
					<td><strong>Mês/Ano Contábil:</strong></td>
					<td><html:text property="anoMesReferenciaContabil" style="width: 65px;" size="7"
						maxlength="7" onkeyup="mascaraAnoMes(this, event);validacaoDatasAnoMes();"
				...
				<tr>
					...
					<td><strong> <html:text property="dataParcelamentoInicial"
						...
						onkeyup="mascaraData(this,event);replicaDataParcelamento();validacaoDatasAnoMes();" />
					<a
					...
					a </strong> <html:text property="dataParcelamentoFinal" size="10"
						maxlength="10" onkeyup="mascaraData(this,event);validacaoDatasAnoMes();" onkeypress="return isCampoNumerico(event);" /> <a
