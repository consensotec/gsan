...
<script language="JavaScript">
 ...
 function validaCaracterEspeciaisInteger(form) {                                                                   
   ...
   var PERCENTUAL_MAXIMO_ABATIMENTO = document.getElementById("PERCENTUAL_MAXIMO_ABATIMENTO").value;
	...
	function adicionarParcelamentoPerfilDebitos(form){
		  
		document.forms[0].target='';	
	    form.action = "exibirAtualizarPerfilParcelamentoAction.do?adicionarParcelamentoPerfilDebitos=S&reload=S";
	    submeterFormPadrao(form);
    }
...
<body leftmargin="5" topmargin="5"
	onload="setarFoco('${requestScope.nomeCampo}');validaPercentualDescontoAcrescimo();validaPercentualDescontoImpontualidade();">
<html:form action="/atualizarPerfilParcelamentoAction"
	name="AtualizarParcelamentoPerfilActionForm"
	type="gsan.gui.cobranca.parcelamento.AtualizarParcelamentoPerfilActionForm"
	method="post"
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="25%"><strong>Número da RD:</strong></td>
            ...
            <table width="100%" border="0">
              	<tr> 
                	<td colspan="2">
                		<strong>Percentual de Desconto sobre os Acréscimos por Impontualidade:</strong><font color="#FF0000">*</font>
                	</td>
           ...
           <tr>
				...
				<tr>
              		...
              		<td>
              			...
              			<a href="javascript:abrirCalendario('AtualizarParcelamentoPerfilActionForm', 'limiteVencimentoContaPagamentoAVista')">		
              	...
              	<tr>
              		...
              		<td>
						...
						onkeyup="mascaraData(this, event);" onkeypress="return isCampoNumerico(event);"/>
						<a href="javascript:abrirCalendario('AtualizarParcelamentoPerfilActionForm', 'limiteVencimentoContaPagamentoParcelado')">			
							<img border="0" src="<bean:message key='caminho.imagens'/>calendario.gif" width="16" height="15" border="0" alt="Exibir Calendário" title="Data Limite vencimento da Conta"/>
						</a>
              		</td>
              	</tr>
				...
				<tr>
					...
					<td><logic:equal name="readOnly" value="true">
						<html:text property="percentualDescontoAVista" size="6"
							maxlength="6" tabindex="5"
							onkeyup="formataValorMonetario(this, 6)"
							style="text-align:right;" readonly="true" />
					</logic:equal> <logic:notEqual name="readOnly" value="true">
				...
				<tr >
						<td height="18" colspan="2">
						<div id="layerHideREPARCELAMENTOSCONSECUTIVOS" style="display:block">
							<table width="100%" border="0" bgcolor="#99CCFF">
								<tr bgcolor="#99CCFF">
									<td align="center"><span class="style2"> <a
										href="javascript:extendeTabela('REPARCELAMENTOSCONSECUTIVOS',true);" /> <b><strong> Reparcelamentos Consecutivos</strong></b> </a><font color="#FF0000">*</font> </span></td>
								</tr>
							</table>
						</div>
						<div id="layerShowREPARCELAMENTOSCONSECUTIVOS" style="display:none">

							<table width="100%" border="0" bgcolor="#99CCFF">
															<tr>
									<td align="center" ><span class="style2"> 
										<a href="javascript:extendeTabela('REPARCELAMENTOSCONSECUTIVOS',false);" /> <b><strong> Reparcelamentos Consecutivos </strong></b> </a> </span>
									</td>
				             	</tr>
				            </table>		
							<table  >
							...
							<table >
				             	...
				             	<tr>
									...
									<td colspan="3">
										...
										<html:text property="idTipoDebito" 
											...
											maxlength="4"
											tabindex="2"
											onkeyup="validaEnter(event, 'exibirAtualizarPerfilParcelamentoAction.do?objetoConsulta=1', 'idTipoDebito');document.getElementById('descricaoTipoDebito').value = '';"
								...
								<tr>
								 <td align="right" >
									  ...
									  onclick="adicionarParcelamentoPerfilDebitos(document.forms[0])" />
								    </td>
								</tr>
		             			</table>
				             	<table>
											            ...
											            <div align="center">
											            	<font color="#333333"> 
											            		<img width="14"
											             			 ...
											             			 border="0"
											             			 src="<bean:message key="caminho.imagens"/>Error.gif"
												             		 onclick="javascript:document.forms[0].target='';if(confirm('Confirma remoção?')){redirecionarSubmit('removerParcelamentoTipoDebitoAction.do?idDebitoTipo=<bean:write name="tipoDebitoHelper" property="debitoTipo.id"/>');}" />
											            </font></div>
											       </td>	
