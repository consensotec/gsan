    ...
    <table border="0" width="100%">
      ...
      <tr >
        ...
        <td width="19%"><div align="left"><strong>
       	 <html:text property="numeroContrato" disabled="true" size="15" maxlength="15" />
        </strong></div></td>
        <td width="14%" height="10"><strong>Data do 
            Contrato:<span class="style2"><strong><font color="#FF0000">*</font></strong></span></strong></td>
          <td colspan="5"> 
                  <html:text onkeyup="mascaraData(this, event);" onkeypress="return isCampoNumerico(event);"
					property="dataContrato" size="10" maxlength="10" /> 
				<a href="javascript:abrirCalendario('AtualizarContratoParcelamentoPorClienteActionForm', 'dataContrato')">
				<img border="0"
      ...
      <tr>
        ...
        <td width="21%"><strong>
          ...
          <html:text property="numeroContratoAnt" disabled="" size="15" maxlength="15" 
          	onkeyup="habilitaTipoRelacao(); " 
          	onkeypress="return validaEnter(event, 'exibirAtualizarContratoParcelamentoClienteAction.do?consulta=contratoAnt', 'numeroContratoAnt');" />
        ...
        <td width="25%"><strong>
        	<logic:present name="contratoAtualizar" property="contratoAnterior">
				<html:select property="relacaoAnterior" > 
					<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
					<html:options collection="collTipoRelacao" 
						labelProperty="descricao" 
						property="id" />
				</html:select>
			</logic:present>
        	<logic:notPresent name="contratoAtualizar" property="contratoAnterior">
        		<html:select property="relacaoAnterior" disabled="true" > 
					<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
					<html:options collection="collTipoRelacao" 
						labelProperty="descricao" 
						property="id" />
          ...
          <td class="style3"><strong>Usu&aacute;rio  Respons&aacute;vel:<span class="style2"><strong><font color="#FF0000">*</font></strong></span></strong></td>
            ...
            <td colspan="6"><span class="style2"><strong>
				<html:text property="loginUsuario" 
					...
					onkeypress="javascript:pesquisaEnterSemUpperCase(event, 'exibirAtualizarContratoParcelamentoClienteAction.do?consulta=usuario', 'loginUsuario');"/>
        ...
        <tr>
          ...
          <td colspan="5">
				<html:select property="relacaoCliente" > 
					<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
					<html:options collection="collRelacaoCliente" 
						labelProperty="descricao" 
						property="id" />
				</html:select>
          </td>
       ...
       <table border="0">
        ...
        <tr>
          ...
          <td colspan="5">
          	<html:text onkeypress="return isCampoNumerico(event);" onkeyup="mascaraAnoMes(this, event);" property="anoMesDebitoInicio" size="7"  maxlength="7" />
            <strong> a</strong>
            <html:text onkeypress="return isCampoNumerico(event);" onkeyup="mascaraAnoMes(this, event);" property="anoMesDebitoFinal" size="7"  maxlength="7" />
            (mm/aaaa) </td>
        </tr>
        <tr>
          ...
          <td colspan="5">
              	<html:text onkeyup="mascaraData(this, event);" onkeypress="return isCampoNumerico(event);"
					...
					href="javascript:abrirCalendario('AtualizarContratoParcelamentoPorClienteActionForm', 'dataVencimentoInicio')">
				<img border="0"
					src="<bean:message key='caminho.imagens'/>calendario.gif"
					width="20" border="0" align="middle" alt="Exibir Calendário" /></a>
                ...
                <html:text onkeyup="mascaraData(this, event);" onkeypress="return isCampoNumerico(event);"
					...
					href="javascript:abrirCalendario('AtualizarContratoParcelamentoPorClienteActionForm', 'dataVencimentoFinal')">
				<img border="0"
					src="<bean:message key='caminho.imagens'/>calendario.gif"
					width="20" border="0" align="middle" alt="Exibir Calendário" /></a>
