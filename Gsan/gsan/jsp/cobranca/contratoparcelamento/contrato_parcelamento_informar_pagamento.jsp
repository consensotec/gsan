...
<%@page import="gsan.cobranca.contratoparcelamento.InformarPagamentoContratoParcelamentoPorClienteHelper"%>
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function informarPagamento(){
		...
		} else if (verificaData(form.dataPagamento)){
...
<html:form action="/informarPagamentoContratoParcelamentoPorClienteAction"
	...
	type="gsan.gui.cobranca.contratoparcelamento.InformarPagamentoContratoParcelamentoPorClienteActionForm"
	method="post">
