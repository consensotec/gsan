...
<%@ page import="gsan.cobranca.contratoparcelamento.PrestacaoContratoParcelamentoHelper"%>
...
<html:form action="/emitirExtratoContratoParcelamentoPorClienteAction"
	...
	type="gsan.gui.cobranca.contratoparcelamento.EmitirExtratoContratoParcelamentoPorClienteActionForm"
	method="post">
