...
<html:form action="/inserirCobrancaSituacaoAction.do"
	...
	type="gsan.gui.cobranca.InserirCobrancaSituacaoActionForm"
	method="post"
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Indicador Cancela Negativação do Imóvel  :<font color="FF0000">*</font></strong></td>
					<td><html:radio property="indicadorCancelarImovelNegativacao" value="1" /><strong>Sim</strong>
					<html:radio property="indicadorCancelarImovelNegativacao"  value="2" /><strong>Não</strong>
					</td>
					<td>&nbsp;</td>
				</tr>
				
				<tr>
					<td><strong>Indicador de Bloquear Alteração de Vencimento da Conta :<font color="FF0000">*</font></strong></td>
					<td><html:radio property="indicadorAlterarVencimentoConta" value="1"/><strong>Sim</strong>
						<html:radio property="indicadorAlterarVencimentoConta" value="2"/><strong>Não</strong>
					</td>
					<td>&nbsp;</td>				
				</tr>
				
				<tr>
					<td><strong>Indicador de Bloqueio de Certidão Negativa de Débitos  :<font color="FF0000">*</font></strong></td>
					<td><html:radio property="indicadorBloqueioCertidaoDebNegativado" value="1" /><strong>Sim</strong>
					<html:radio property="indicadorBloqueioCertidaoDebNegativado"  value="2" /><strong>Não</strong>
					</td>
					<td>&nbsp;</td>
				</tr>	
