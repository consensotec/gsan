...
<%@ page import="java.util.Collection, java.util.Iterator, gsan.cobranca.InformarCicloMetaGrupoHelper" %>
...
<html:form
  ...
  type="gsan.gui.cobranca.AnalisarMetasCicloActionForm"
				...
				<tr>
					<td colspan="7">
					  		...
					  		<logic:iterate name="helpersUnidades" id="itemUnegHash">
						  		<bean:define name="itemUnegHash" property="value" id="itemUneg" type="gsan.cobranca.InformarCicloMetaGrupoHelper"/>
									...
									<td colspan=4>
									    <table width="100%" bgcolor="#90c7fc">
									  		...
									  		<logic:iterate name="helpersLocalidade" id="itemLocHash">
										  		<bean:define name="itemLocHash" property="value" id="itemLoc" type="gsan.cobranca.InformarCicloMetaGrupoHelper"/>
												<tr bgcolor="#ffffff">
							           				<td width="<%=widthDescricaoItem%>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
