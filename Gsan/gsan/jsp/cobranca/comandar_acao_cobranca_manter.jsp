...
<%@ page
	import="gsan.util.Util,gsan.cobranca.CobrancaGrupoCronogramaMes,gsan.cobranca.CobrancaAcaoAtividadeComando"%>
<head>
<html:html>
...
<html:form action="/exibirManterComandoAcaoCobrancaAction.do"
	...
	type="gsan.gui.cobranca.ManterComandoAcaoCobrancaActionForm"
	method="post"
