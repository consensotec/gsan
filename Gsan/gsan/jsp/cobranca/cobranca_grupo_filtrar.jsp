...
<html:javascript staticJavascript="false"
	formName="FiltrarCobrancaGrupoActionForm" dynamicJavascript="true" />
<script language="JavaScript"
...
<script language="JavaScript">
	...
	function validarForm(formulario){	
		if(validateFiltrarCobrancaGrupoActionForm(formulario)){    		
...
<html:form action="/filtrarCobrancaGrupoAction"
	name="FiltrarCobrancaGrupoActionForm"
	type="gsan.gui.cobranca.FiltrarCobrancaGrupoActionForm"
	method="post"
	onsubmit="return validateFiltrarCobrancaGrupoActionForm(this);">
		...
		<tr>
			...
			<td width="615" valign="top" class="centercoltext">
				...
				<tr>
						...
						<td colspan="2">Para filtrar o(s) grupo(s) de cobrança(s), informe o(s) dado(s) abaixo:</td>
				...
				<tr>
					...
					<td><html:text property="id" size="2" maxlength="2" onkeypress="return isCampoNumerico(event);"/><font
				...
				<tr>
					<td><input name="Button" 
						...
						value="Limpar" 
						align="left"
						onclick="window.location.href='/gsan/exibirFiltrarCobrancaGrupoAction.do?menu=sim'"
						tabindex="8">
