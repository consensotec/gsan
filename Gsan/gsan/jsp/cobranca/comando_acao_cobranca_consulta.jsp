...
<%@ page
	import="gsan.cobranca.CobrancaAcaoAtividadeComando, gsan.cobranca.CobrancaAtividade, gsan.atendimentopublico.ordemservico.OrdemServico, gsan.cobranca.bean.CobrancaAcaoOrdemServicoNaoAceitasHelper"%>
<head>
<html:html>
...
<html:form action="/comandosAcaoCobrancaFiltrarAction" method="post"
	...
	type="gsan.gui.cobranca.ComandosAcaoCobrancaFiltrarActionForm">
