...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="GerarCartasCampanhaSolidariedadeCriancaNegociacaoAVistaActionForm" />
<script>
...
function validarForm(){
	var form = document.forms[0];		
		form.action = 'gerarCartasCampanhaSolidariedadeCriancaNegociacaoAVistaAction.do';
...
<html:form action="/gerarCartasCampanhaSolidariedadeCriancaNegociacaoAVistaAction.do"
	name="GerarCartasCampanhaSolidariedadeCriancaNegociacaoAVistaActionForm"
	type="gsan.gui.cobranca.GerarCartasCampanhaSolidariedadeCriancaNegociacaoAVistaActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img
						...
						border="0" /></td>
					<td class="parabg">Cartas da Campanha de Solidariedade da Criança </td>
			...
			<table width="100%" border="0">
				...
				<tr> 
              	...
              	<tr>
					<td width="25%"><strong>Ação:<font	color="#FF0000">*</font></strong></td>
					<td width="15%">
						<html:radio property="acao" value="1"/> <strong>Gerar </strong>
					</td>
					<td >
						<html:radio property="acao" value="2"/> <strong>Emitir </strong>
					</td>
				</tr>
