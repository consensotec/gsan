...
<%@page import="gsan.cobranca.bean.AcoesCobrancaImovelHelper"%>
<%@page import="gsan.cobranca.bean.AcoesCobrancaTipoDebitoHelper"%>
...
<body leftmargin="5" topmargin="5">
	...
	<html:form action="/consultarAcoesCobrancaImovelAction"
	    ...
	    type="gsan.gui.cobranca.ExibirConsultarAcoesCobrancaImovelActionForm"
		method="post">
