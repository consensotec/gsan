...
function validarRelacaoImoveis(){
	...
	function caracteresespeciais () {
    	...
    	this.ab = new Array("localidadeOrigemID", "Localidade Inicial possui caracteres especiais.", new Function ("varName", " return this[varName];"));
     	...
     	this.aw = new Array("descricaoSolicitacao", "Descrição Solicitacao não permite caracteres especiais.", new Function ("varName", " return this[varName];"));
     	this.ax = new Array("idImovel", "Matrícula do Imóvel não permite caracteres especiais.", new Function ("varname", "return this[varName];"));
     	this.ay = new Array("quantidadeMaximaDocumentos", "Quantidade Máxima de Documentos não permite caracteres especiais.", new Function ("varname", "return this[varName];"));
     	this.ak = new Array("valorLimiteObrigatoria", "Valor Limite para Emissão Obrigatória não permite caracteres especiais.", new Function ("varname", "return this[varName];"));
     	this.az = new Array("codigoClienteSuperior", "Código do Cliente Superior não permite caracteres especiais.", new Function ("varname", "return this[varName];"));
     	this.ba = new Array("consumoMedioInicial", "Consumo Médio do Imóvel inicial não permite caracteres especiais.", new Function ("varname", "return this[varName];"));
     	this.bb = new Array("consumoMedioFinal", "Consumo Médio do Imóvel final não permite caracteres especiais.", new Function ("varname", "return this[varName];"));
     	this.bc = new Array("logradouroId", "Logradouro não permite caracteres especiais.", new Function ("varname", "return this[varName];"));
    ...
    function IntegerValidations () {
    	...
    	this.ai = new Array("localidadeOrigemID", "Localidade Inicial deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     	...
     	this.al = new Array("setorComercialOrigemCD", "Setor Comercial Inicial deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     	this.am = new Array("setorComercialDestinoCD", "Setor Comercial Final deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     	this.an = new Array("idCliente", "Cliente deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     	this.ao = new Array("idImovel", "Matrícula do Imóvel deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     	this.ap = new Array("rotaFinal", "Rota Final deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     	this.aq = new Array("rotaInicial", "Rota Inicial deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
    ...
    function FloatValidations () {
	 	this.ar = new Array("valorLimiteObrigatoria", "Valor Limite para Emissão Obrigatória deve somente conter números decimais positivos.",new Function ("varName", " return this[varName];"));
	}

    function required () {
    	this.as = new Array("titulo", "Informe Título.", new Function ("varName", " return this[varName];"));
     	this.at = new Array("descricaoSolicitacao", "Informe Descrição Solicitação.", new Function ("varName", " return this[varName];"));     	
     	this.au = new Array("cobrancaAcao", "Informe Ação de Cobrança.", new Function ("varName", " return this[varName];"));
     	this.av = new Array("cobrancaAtividade", "Informe Atividade de Cobrança.", new Function ("varName", " return this[varName];"));    	
    }    
...
function limparDestino(tipo){
	...
	switch(tipo){
		...
		case 3: //Imovel			
			...
			verificarPreenchimentoImovel();
			break;
		case 4: //Código do Cliente Superior			
...
function habilitarPesquisarSetorComercialInicial(){
	...
	var form = document.forms[0];
		...
		if (form.setorComercialOrigemCD.disabled == false) {
			abrirPopupDependencia('exibirPesquisarSetorComercialAction.do?idLocalidade='+form.localidadeOrigemID.value+'&tipo=setorComercialOrigem&indicadorUsoTodos=1',form.localidadeOrigemID.value,'Localidade da inscrição de origem', 400, 800);
		}
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		...
		<tr>
			...
			<table width="100%" border="0"  cellpadding="0" cellspacing="3">
				...
				<tr>
					<td width="16%"><strong>Código do Cliente Superior:</strong></td>
					<td colspan="2">
