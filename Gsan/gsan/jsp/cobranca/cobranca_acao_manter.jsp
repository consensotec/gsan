		...
		<tr>
			...
			<logic:iterate name="colecaoCobrancaAcao" id="cobrancaAcao" type="CobrancaAcao">
          	<pg:item>
				...
				<td width="240"><html:link href="/gsan/exibirAtualizarAcaoCobrancaAction.do" paramId="idRegistroAtualizar" paramProperty="id" paramName="cobrancaAcao" title="<%="" + cobrancaAcao.getDescricaoCobrancaAcao() %>">
				<bean:write name="cobrancaAcao" property="descricaoCobrancaAcao"/></html:link></td>
	...
	<td>
        ...
        <tr>
        	<td>
				...
				<input name="button" type="button" class="bottonRightCol" value="Voltar Filtro" onclick="window.location.href='<html:rewrite page="/exibirFiltrarAcaoCobrancaAction.do"/>'" align="left" style="width: 80px;"> 
			</td>
