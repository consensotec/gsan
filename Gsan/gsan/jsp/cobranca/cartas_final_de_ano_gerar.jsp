...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="GerarCartasFinalDeAnoActionForm" />
<script>
...
function validarForm(){
	var form = document.forms[0];		
		form.action = 'gerarCartasFinalDeAnoAction.do';
...
<html:form action="/gerarCartasFinalDeAnoAction.do"
	name="GerarCartasFinalDeAnoActionForm"
	type="gsan.gui.cobranca.GerarCartasFinalDeAnoActionForm"
	method="post">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img
						...
						border="0" /></td>
					<td class="parabg">Cartas Final de Ano </td>
