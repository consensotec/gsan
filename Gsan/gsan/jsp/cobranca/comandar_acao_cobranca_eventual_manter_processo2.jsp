...
function validarRelacaoImoveis(){
	...
	function caracteresespeciais () {
	     this.aa = new Array("titulo", "Título possui caracteres especiais.", new Function ("varName", " return this[varName];"));
	     this.ab = new Array("localidadeOrigemID", "Localidade Inicial deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	     this.ac = new Array("localidadeDestinoID", "Localidade Final deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	     this.ad = new Array("setorComercialOrigemCD", "Setor Comercial Inicial deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	     this.ae = new Array("setorComercialDestinoCD", "Setor Comercial Final deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	     this.af = new Array("idCliente", "Cliente deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	     this.ag = new Array("prazoExecucao", "Prazo de Execução deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	     this.av = new Array("descricaoSolicitacao", "Descrição Solicitacao possui caracteres especiais.", new Function ("varName", " return this[varName];"));
	     this.aq = new Array("valorLimiteObrigatoria", "Valor Limite para Emissão Obrigatória deve somente conter números decimais positivos.",new Function ("varName", " return this[varName];"));
	     this.ba = new Array("numeroQuadraInicial", "Quadra Inicial deve somente conter números decimais positivos.",new Function ("varName", " return this[varName];"));
	     this.bb = new Array("numeroQuadraFinal", "Quadra Final deve somente conter números decimais positivos.",new Function ("varName", " return this[varName];"));
	     this.bc = new Array("codigoClienteSuperior", "Cliente Superior deve somente conter números decimais positivos.",new Function ("varName", " return this[varName];"));
	     this.bd = new Array("quantidadeDiasVencimento", "Quantidade de Dias de Vencimento deve somente conter números decimais positivos.",new Function ("varName", " return this[varName];"));
	    }

    function IntegerValidations () {
     this.ag = new Array("prazoExecucao", "Cliente deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     this.ah = new Array("quantidadeMaximaDocumentos", "Quantidade máxima de documentos deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     this.ai = new Array("localidadeOrigemID", "Localidade Inicial deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     this.aj = new Array("localidadeDestinoID", "Localidade Final deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     this.ak = new Array("setorComercialOrigemCD", "Setor Comercial Inicial deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     this.al = new Array("setorComercialDestinoCD", "Setor Comercial Final deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     this.am = new Array("idCliente", "Cliente deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     this.an = new Array("idImovel", "Matrícula do Imóvel deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
     this.ao = new Array("rotaFinal", "Rota Final deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
  	 this.ap = new Array("rotaInicial", "Rota Inicial deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
    }
    ...
    function required () {
     this.ar = new Array("titulo", "Informe Título.", new Function ("varName", " return this[varName];"));
     this.as = new Array("descricaoSolicitacao", "Informe Descrição Solicitação.", new Function ("varName", " return this[varName];"));     	
     this.at = new Array("cobrancaAcao", "Informe Ação de Cobrança.", new Function ("varName", " return this[varName];"));
     this.au = new Array("cobrancaAtividade", "Informa Atividade de Cobrança.", new Function ("varName", " return this[varName];"));
    } 
...
function validarPeriodoVencimentoConta(){
		...
		if($("input[@name='periodoVencimentoContaFinal']").val() == '' && 
			...
			alert('Informe Período de Referência das Contas Final');
			return false;
		}
		...
		if($("input[@name='periodoVencimentoContaFinal']").val() != '' && 
			...
			alert('Informe Período de Referência das Contas Inicial');
			return false;
		}
	...
	function validarPeriodoFiscalizacaoImovel(){
		if($("input[@name='periodoFinalFiscalizacao']").val() == '' && 
			...
			alert('Informe Período de Fiscalização do Imóvel Final');
			return false;
		}
		...
		if($("input[@name='periodoFinalFiscalizacao']").val() != '' && 
			...
			alert('Informe Período de Fiscalização do Imóvel Inicial');
			return false;
		}
	...
	function validarPeriodoConta(){
		...
		if($("input[@name='periodoFinalConta']").val() == '' && 
			...
			alert('Informe Período de Vencimento das Contas Final');
			return false;
		}
		...
		if($("input[@name='periodoFinalConta']").val() != '' && 
			...
			alert('Informe Período de Vencimento das Contas Inicial');
			return false;
		}
...
function validarLimite(){
	...
	if (tamanho > 9){
		alert('Valor Limite para Emissão Obrigatória deve possuir até 5 casas decimais.');
...
function validateTituloEDescricaoSolicitacao(form) {
	if (form.titulo.value=='' && form.descricaoSolicitacao.value=='') {
		alert('É obrigatório informar o Título e a Descrição da Solicitação.');
		return false;
	} 
	return true;
}
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" dwcopytype="CopyTableRow">
				...
				<tr>
					<td width="16%"><strong>Matrícula do Imóvel:</strong></td>
					<logic:empty name="ManterComandoAcaoCobrancaDetalhesActionForm" property="dataRealizacao">
						...
						<a href="javascript:habilitarPesquisaImovel(document.forms[0]);" >
								<img width="23" height="21"	src="<bean:message key='caminho.imagens'/>pesquisa.gif" border="0" title="Pesquisar Imóvel"/></a>	
				...
				<tr>
					<td width="16%"><strong>Unidade Negócio:<strong></strong></strong></td>
					<td colspan="3">
					 <div align="left"><strong> 
						 <logic:empty name="ManterComandoAcaoCobrancaDetalhesActionForm" property="dataRealizacao"> 
				...
				<tr>
					...
					<logic:empty name="ManterComandoAcaoCobrancaDetalhesActionForm" property="dataRealizacao"> 
					 ...
					 <img title="Pesquisar Setor Comercial" alt="Pesquisar Setor Comercial"
						...
						'setorComercialOrigem', 'idLocalidade', document.forms[0].localidadeOrigemID.value, 275, 480, 
						'Informe a Localidade da inscrição de origem',document.forms[0].setorComercialOrigemCD);"><html:hidden property="setorComercialOrigemID" /></a>
				...
				<tr>
					...
					<logic:empty name="ManterComandoAcaoCobrancaDetalhesActionForm" property="dataRealizacao"> 
					 ...
					 <a href="javascript:chamarPopup('exibirPesquisarSetorComercialAction.do', 'setorComercialDestino', 'idLocalidade', document.forms[0].localidadeDestinoID.value, 275, 480, 'Informe a Localidade da inscrição de destino',document.forms[0].setorComercialDestinoCD);">
				...
				<tr>
					...
					<logic:empty name="ManterComandoAcaoCobrancaDetalhesActionForm" property="dataRealizacao"> 
					  ...
					  <img border="0" title="Exibir Calendário"
				...
				<tr>
						<td width="16%"><strong>Consumo Médio do Imóvel:</strong></td>
				...
				<logic:present scope="session" name="colecaoFiscalizacaoSituacao">					
					...
					<tr>
						<td width="16%"><strong>Período de Fiscalização do Imóvel:</strong></td>
				...
				<tr>
					...
					<td align="left" width="4%">
						<span style="font-weight: bold">
							<u>
								<a id="nomeArquivo" style="cursor: pointer;" onmouseover="this.T_BGCOLOR='whitesmoke';this.T_LEFT=false;return escape( '<c:out value="Para alterar a lista de imóveis, selecionar um novo arquivo. Ao selecionar um novo arquivo, a lista atual de imóveis será removida."/>' ); "><c:out value="${ManterComandoAcaoCobrancaDetalhesActionForm.nomeArquivoRelacaoImoveis}"/></a>
							</u>
						</span>
				    </td>
				</tr>
				...
				<tr>
					<td width="16%"><strong>Relação de Imóveis:</strong></td>
					<td colspan="3">
