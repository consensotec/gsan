...
<script language="JavaScript">
	function limpaProcesso(){
	 	var form = document.AtualizarAtividadeCobrancaActionForm;
...
<html:form action="/atualizarAtividadeCobrancaAction.do"
	name="AtualizarAtividadeCobrancaActionForm"
	type="gsan.gui.cobranca.AtualizarAtividadeCobrancaActionForm"
	method="post" onsubmit="return validateAtualizarAtividadeCobrancaActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Atividade de Cobrança</td>
					<td width="11"><img border="0"
			...
			<table border="0" width="100%">	
				...
				<tr>
					...
					<div align="left"><html:text property="idProcessoAssociado" size="3"
						...
						onkeypress="validaEnter(event, 'exibirAtualizarAtividadeCobrancaAction.do', 'idProcessoAssociado');" />
					<a href="javascript:popupIndisponivel();"> <img
						src="imagens/pesquisa.gif" style="" height="21" width="23"
						border="0" title="Pesquisar Processo" alt="Pesquisar Processo"></a> <logic:present name="processoInexistente"
						scope="request">
						<html:text property="descricaoProcessoAssociado" size="40" maxlength="40"
							readonly="true"
							style="background-color:#EFEFEF; border:0; color: #ff0000;" />
					</logic:present> <logic:notPresent name="processoInexistente"
						scope="request">
						<html:text property="descricaoProcessoAssociado" size="40" maxlength="40"
							readonly="true"
							style="background-color:#EFEFEF; border:0; color: #000000;" />
					</logic:notPresent> <a href="javascript:limpaProcesso();"><img src="imagens/limparcampo.gif" border="0" height="21"
						width="23" title="Apagar"></a></div>
					</td>
				</tr>
				<tr>
					<td colspan="2"><hr></td>
				...
				<tr>
					...
					<input name="Submit763" class="bottonRightCol" value="Voltar"
						type="button" tabindex="15"
						onclick="window.location.href='/gsan/exibirManterAtividadeCobrancaAction.do?menu=sim';">
					<input name="Submit22"
						class="bottonRightCol" value="Desfazer" type="button" tabindex="14"
						onclick="window.location.href='/gsan/exibirAtualizarAtividadeCobrancaAction.do?idRegistroAtualizar=${sessionScope.idAtividadeCobranca}';">
					...
					<td align="right"><input name="botao" class="bottonRightCol"
						value="Atualizar" onclick="validaForm();" type="button" tabindex="13"></td>
				</tr>
			</table>
			<p>&nbsp;</p>
