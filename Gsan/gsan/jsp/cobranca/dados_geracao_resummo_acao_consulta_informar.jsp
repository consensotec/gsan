...
<%@ page import="gsan.gerencial.bean.InformarDadosGeracaoResumoAcaoConsultaHelper" %>
...
<html:javascript staticJavascript="false"  formName="InformarDadosGeracaoResumoAcaoConsultaActionForm"
...
<!--
    ...
    function validateInformarDadosGeracaoResumoAcaoConsultaActionForm(form) {                                                                   
        if (bCancel) 
      return true; 
        else 
    ...
    function caracteresespeciais () { 
     this.aa = new Array("mesAnoFaturamento", "Mês/Ano do Faturamento possui caracteres especiais.", new Function ("varName", " return this[varName];"));
    ...
    function required () { 
     this.aa = new Array("mesAnoFaturamento", "Informe Mês/Ano do Faturamento.", new Function ("varName", " return this[varName];"));
     this.ab = new Array("tipoImpressao", "Informe Tipo de Impressão.", new Function ("varName", " return this[varName];"));
    } 
...
function validarForm(form){
	if (validateInformarDadosGeracaoResumoAcaoConsultaActionForm(form)){
...
<html:form action="/informarDadosGeracaoResumoAcaoConsultaAction" method="post">
	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="eloPolo" size="4" maxlength="3" tabindex="5" onkeypress="validaEnterComMensagem(event, 'exibirInformarDadosGeracaoResumoAcaoConsultaAction.do?pesquisarEloPolo=OK', 'eloPolo', 'Elo Pólo');"/>
			...
			<logic:notPresent name="corEloPolo">
				...
				<logic:empty name="InformarDadosGeracaoResumoAcaoConsultaActionForm" property="eloPolo">
					<html:text property="descricaoEloPolo" value="" size="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000"/>
				</logic:empty>
				<logic:notEmpty name="InformarDadosGeracaoResumoAcaoConsultaActionForm" property="eloPolo">
					<html:text property="descricaoEloPolo" size="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
				</logic:notEmpty>
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="localidade" size="4" maxlength="3" tabindex="6" onkeypress="validaEnterComMensagem(event, 'exibirInformarDadosGeracaoResumoAcaoConsultaAction.do?pesquisarLocalidade=OK', 'localidade', 'Localidade');"/>
			...
			<logic:notPresent name="corLocalidade">
				...
				<logic:empty name="InformarDadosGeracaoResumoAcaoConsultaActionForm" property="localidade">
					<html:text property="descricaoLocalidade" value="" size="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000"/>
				</logic:empty>
				<logic:notEmpty name="InformarDadosGeracaoResumoAcaoConsultaActionForm" property="localidade">
					<html:text property="descricaoLocalidade" size="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
				</logic:notEmpty>
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="setorComercial" size="4" maxlength="3" tabindex="7" onkeypress="validaEnterDependenciaComMensagem(event, 'exibirInformarDadosGeracaoResumoAcaoConsultaAction.do?pesquisarSetorComercial=OK', this, document.forms[0].localidade.value, 'Localidade', 'Setor Comercial');"/>
			...
			<logic:notPresent name="corSetorComercial">
				...
				<logic:empty name="InformarDadosGeracaoResumoAcaoConsultaActionForm" property="setorComercial">
				...
				<logic:notEmpty name="InformarDadosGeracaoResumoAcaoConsultaActionForm" property="setorComercial">
					<html:text property="descricaoSetorComercial" size="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
				</logic:notEmpty>
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="quadra" size="4" maxlength="4" tabindex="8" onkeypress="validaEnterDependenciaComMensagem(event, 'exibirInformarDadosGeracaoResumoAcaoConsultaAction.do?pesquisarQuadra=OK', this, document.forms[0].setorComercial.value, 'Setor Comercial', 'Quadra');"/>
      ...
      <tr>
      	<td HEIGHT="30"><strong>Tipo de Impressão:<font color="#FF0000">*</font></strong></td>
        <td>
			<html:select property="tipoImpressao" style="width: 200px" tabindex="16">
				
				<html:option value="">&nbsp;</html:option>
				
				<html:option value="<%= "" + InformarDadosGeracaoResumoAcaoConsultaHelper.ID_IMPRESSAO_TRADICIONAL %>">
				<%= "" + InformarDadosGeracaoResumoAcaoConsultaHelper.DESC_IMPRESSAO_TRADICIONAL %></html:option>
				
				<html:option value="<%= "" + InformarDadosGeracaoResumoAcaoConsultaHelper.ID_IMPRESSAO_SIMULTANEA %>">
				<%= "" + InformarDadosGeracaoResumoAcaoConsultaHelper.DESC_IMPRESSAO_SIMULTANEA %></html:option>
				
				<html:option value="<%= "" + InformarDadosGeracaoResumoAcaoConsultaHelper.ID_AMBOS %>">
				<%= "" + InformarDadosGeracaoResumoAcaoConsultaHelper.DESC_AMBOS %></html:option>
      ...
      <tr>
      	<td align="left"><INPUT type="button" onclick="window.location.href='exibirInformarDadosGeracaoResumoAcaoConsultaAction.do?limparForm=OK'" style="width: 70px;" name="botaoLimpar" class="bottonRightCol" value="Limpar" tabindex="15"></td>
