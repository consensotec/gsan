...
<%@page
	import="gsan.cobranca.ExtensaoComandoContasCobrancaEmpresaHelper"%>
...
<html:form action="/gerarExtensaoComandoContasCobrancaEmpresaAction"
	...
	type="gsan.gui.cobranca.GerarExtensaoComandoContasCobrancaEmpresaActionForm"
	method="post">
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><html:text maxlength="9" property="idEmpresa" size="9"
						tabindex="14"
						onkeypress="validaEnterComMensagem(event, 'exibirGerarExtensaoComandoContasCobrancaEmpresaAction.do?pesquisarEmpresa=sim', 'idEmpresa', 'Empresa'); return isCampoNumerico(event); " />
					<a href="javascript:pesquisarEmpresa();"><img
						...
						border="0" src="imagens/limparcampo.gif" height="21" width="23" title="Limpar Empresa"> </a>
					</td>
				</tr>
				<tr>
					...
					<img border="0"
						...
						tabindex="11" size="10"
						onkeyup="mascaraData(this, event);limparPeriodo();" 
					...
					<tr>
						...
						<table width="100%" bgcolor="#99CCFF" border="0">
							<tr bordercolor="#000000">
								...
								<td width="12%" bgcolor="#90c7fc" align="center" rowspan="2"><strong>Quantidade de Dias
								 de Vencimento</strong></td>
									...
									.formatarAnoMesParaMesAno(extensaoComandoContasCobrancaEmpresaHelper
											...
											.toString())%></td>				
													...
													<td align="center" width="12%">
														${extensaoComandoContasCobrancaEmpresaHelper.qtdDiasVencimento}
													</td>
												</tr>
											...
											<tr bgcolor="#FFFFFF">
												...
												<td align="center" width="12%">&nbsp;
														<input type="text" id="anoMes"	
														name="c<bean:write name="gerarExtensaoComandoContasCobrancaEmpresaHelper" property="gerarArquivoTextoContasCobrancaEmpresaHelper.idComandoEmpresaCobrancaConta" />"
														onkeypress="return isCampoNumerico(event);"
														size="3" maxlength="3" value = "<% if(gerarExtensaoComandoContasCobrancaEmpresaHelper.getQtdDiasVencimento() != null) out.print(gerarExtensaoComandoContasCobrancaEmpresaHelper.getQtdDiasVencimento()); %>" /> 
												</td>	
