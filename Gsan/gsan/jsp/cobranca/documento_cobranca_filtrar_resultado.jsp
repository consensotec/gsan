...
<%@page import="gsan.cobranca.bean.CobrancaDocumentoHelper"%>
								...
								<%	}	%>
										...
										<td width="95" align="left">
											<logic:equal name="cobrancaDocumentoHelper"
												...
												value="<%= "" + gsan.cobranca.DocumentoEmissaoForma.CRONOGRAMA.intValue() %>">
											...
											<logic:equal name="cobrancaDocumentoHelper"
												property="cobrancaDocumento.documentoEmissaoForma.id"
												value="<%= "" + gsan.cobranca.DocumentoEmissaoForma.EVENTUAL.intValue() %>">
											...
											<logic:equal name="cobrancaDocumentoHelper"
												property="cobrancaDocumento.documentoEmissaoForma.id"
												value="<%= "" + gsan.cobranca.DocumentoEmissaoForma.INDIVIDUAL.intValue() %>">
