          ...
          <td height="364"> 
            ...
            <tr>
              ...
              <tr>
                ...
                <td colspan="2"><html:text property="operacao" size="7" maxlength="7" readonly="true" style="background-color:#EFEFEF; border:0"/>  
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="2"><html:text property="sequencialRemessa" size="8" maxlength="8" readonly="true" style="background-color:#EFEFEF; border:0"/>
               </td>
              </tr>
              <tr>
                <td><strong>Entidade:</strong></td>
                <td colspan="2"><html:text property="entidade" size="5" maxlength="5" readonly="true" style="background-color:#EFEFEF; border:0"/>
               </td>
              </tr>
              <tr>
              ...
              <tr>
                <td><strong>Data Movimento Arquivo:</strong></td>
                <td colspan="2"><html:text property="dataMovimentoArquivo" size="8" maxlength="8" readonly="true" style="background-color:#EFEFEF; border:0"/>                
                  (AAAAMMDD) </td>
              </tr>
              <tr> 
                <td width="37%"><strong>Unidade de Neg&oacute;cio:</strong></td>
                <td colspan="2"><html:text property="unidadeNegocio" size="5" maxlength="5" readonly="true" style="background-color:#EFEFEF; border:0"/>
                </td>
              </tr>
              <tr> 
                <td><strong>N&uacute;mero da Vers&atilde;o:</strong></td>
                <td colspan="2"><html:text property="numeroVersao" size="2" maxlength="2" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
