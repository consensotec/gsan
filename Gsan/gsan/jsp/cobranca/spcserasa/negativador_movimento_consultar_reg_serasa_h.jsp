        ...
        <tr> 
          <td height="364"> 
            <table width="100%" border="0" dwcopytype="CopyTableRow">
              ...
              <tr>
                <td width="37%"><strong>Negativador:</strong></td>
              ...
              <tr>
                ...
                <td colspan="2"> <html:text property="tipoRegistroCodigo" size="2" maxlength="2" readonly="true" style="background-color:#EFEFEF; border:0"/>
                 <html:text property="tipoRegistroDescricao" size="20" maxlength="20" readonly="true" style="background-color:#EFEFEF; border:0"/>         </td>
              </tr>
              <tr>
                <td><strong>CNPJ da institui&ccedil;&atilde;o informante:</strong></td>
                <td colspan="2"><html:text property="cnpj" size="14" maxlength="14" readonly="true" style="background-color:#EFEFEF; border:0"/>
               </td>
              </tr>
              <tr>
                <td><strong>Data Movimento:</strong></td>
                <td colspan="2"><html:text property="dataMovimento" size="8" maxlength="8" readonly="true" style="background-color:#EFEFEF; border:0"/>
                  (AAAAMMDD) </td>
              </tr>
              <tr>
                <td><strong>DDD do Telefone de Contato:</strong></td>
                <td colspan="2"><html:text property="dddTelefoneContato" size="4" maxlength="4" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>Telefone de Contato:</strong></td>
                <td colspan="2"><html:text property="telefoneContato" size="8" maxlength="8" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>Ramal do Telefone de Contato:</strong></td>
                <td colspan="2"><html:text property="ramalTelefoneContato" size="4" maxlength="4" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>Nome do Contato:</strong></td>
                <td colspan="2"><html:text property="nomeContato" size="50" maxlength="50" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>Identifica&ccedil;&atilde;o do Arquivo:</strong></td>
                <td colspan="2"><html:text property="identificacaoArquivo" size="15" maxlength="15" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>Sequencial de Remessa:</strong></td>
                <td colspan="2"><html:text property="sequencialRemessa" size="6" maxlength="6" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>C&oacute;digo de Envio:</strong></td>
                <td colspan="2"><html:text property="codigoEnvio" size="1" maxlength="1" readonly="true" style="background-color:#EFEFEF; border:0"/>
                <html:text property="descricaoCodigoEnvio" size="8" maxlength="8" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>Diferencial de Remessa:</strong></td>
                <td colspan="2"><html:text property="diferencialRemessa" size="4" maxlength="4" readonly="true" style="background-color:#EFEFEF; border:0"/>
                </td>
              </tr>
              <tr>
                <td><strong>C&oacute;digo de Retorno:</strong></td>
                <td colspan="2"><html:text property="codigoRetorno" size="60" maxlength="60" readonly="true" style="background-color:#EFEFEF; border:0"/>
                </td>
              </tr>
              <tr> 
                <td><strong>Sequencial do Registro:</strong></td>
                <td colspan="2"><html:text property="sequencialRegistro" size="7" maxlength="7" readonly="true" style="background-color:#EFEFEF; border:0"/>
                </td>
              </tr>
              <tr>
                <td colspan="3"><hr></td>
              ...
              <tr>
                ...
                <td colspan="2"><html:text property="indicadorAceitacao" size="15" maxlength="15" readonly="true" style="background-color:#EFEFEF; border:0"/>
               </td>
              </tr>
             <tr> 
