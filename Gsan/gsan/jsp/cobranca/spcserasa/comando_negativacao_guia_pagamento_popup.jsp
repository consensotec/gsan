...
<%@page import="gsan.cobranca.NegativacaoCriterioSubcategoria"%>
<%@page import="gsan.cobranca.NegativacaoCriterioImovelPerfil"%>
<%@page import="gsan.cobranca.NegativacaoCriterioClienteTipo"%>
...
<html:form  
	...
	type="gsan.gui.cobranca.spcserasa.ConsultarNegativacaoComandoGuiaPagamentoActionForm">
