...
<html:form action="/filtrarComandoNegativacaoPorCriterioAction"   
	name="FiltrarComandoNegativacaoPorCriterioActionForm"
  	type="gsan.gui.cobranca.spcserasa.FiltrarComandoNegativacaoPorCriterioActionForm"
  	method="post">
...
<p>&nbsp;</p>
            <table align="center" width="100%" border="0" >
              <tr>
                <td colspan="2">Para filtrar o(s) comando(s), informe os dados abaixo:</td>
                <td width="15%"><html:checkbox property="checkAtualizar" value="1"/><strong>Atualizar</strong></td>
              </tr>
              <tr> 
                 <td width="30%"><strong>T&iacute;tulo do Comando:</strong></td>
                 <td colspan="3"><p>
