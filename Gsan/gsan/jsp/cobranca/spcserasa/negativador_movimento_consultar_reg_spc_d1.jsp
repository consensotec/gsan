...
<html:form action="/exibirConsultarDadosRegistroSPCAction"
	...
	type="gsan.gui.cobranca.spcserasa.ConsultarDadosRegistroActionForm"
	method="post">
          ...
          <td height="364"> 
            <table width="100%" border="0" dwcopytype="CopyTableRow">
              ...
              <tr>
                ...
                <html:text property="tipoRegistroDescricao" size="60" maxlength="60" readonly="true" style="background-color:#EFEFEF; border:0"/>                    
                </td>
              </tr>
              <tr>
                <td><strong>Pra&ccedil;a de Concess&atilde;o:</strong></td>
                <td colspan="2"><html:text property="pracaConcessao" size="8" maxlength="8" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>Nome/Raz&atilde;o:</strong></td>
                <td colspan="2"><html:text property="nomeRazao" size="45" maxlength="45" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
               ...
               <html:text property="tipoDocumentoDescricao" size="4" maxlength="4" readonly="true" style="background-color:#EFEFEF; border:0"/> </td>
              </tr>
              <tr>
                <td><strong>CPF/CNPJ:</strong></td>
                <td colspan="2"><html:text property="cpfCnpj" size="15" maxlength="15" readonly="true" style="background-color:#EFEFEF; border:0"/> </td>
              </tr>
              <tr>
                <td><strong>RG:</strong></td>
                <td colspan="2"><html:text property="rg" size="20" maxlength="20" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>Data de Nascimento:</strong></td>
                <td colspan="2"><html:text property="dataNascimento" size="8" maxlength="8" readonly="true" style="background-color:#EFEFEF; border:0"/> 
                  (DDMMAAAA) </td>
              </tr>
              <tr>
                <td><strong>Filia&ccedil;&atilde;o:</strong></td>
                <td colspan="2"><html:text property="filiacao" size="45" maxlength="45" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>Endere&ccedil;o:</strong></td>
                <td colspan="2"><html:text property="endereco" size="50" maxlength="50" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>N&uacute;mero:</strong></td>
                <td colspan="2"><html:text property="numero" size="5" maxlength="5" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr> 
                <td width="37%"><strong>Complemento:</strong></td>
                <td colspan="2"><html:text property="complemento" size="30" maxlength="30" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>Bairro:</strong></td>
                <td colspan="2"><html:text property="bairro" size="25" maxlength="25" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>CEP:</strong></td>
                <td colspan="2"><html:text property="cep" size="8" maxlength="8" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>Cidade:</strong></td>
                <td colspan="2"><html:text property="cidade" size="30" maxlength="30" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>UF:</strong></td>
                <td colspan="2"><html:text property="uf" size="2" maxlength="2" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>Fone-DDD:</strong></td>
                <td colspan="2"><html:text property="foneDDD" size="2" maxlength="2" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr> 
                <td><strong>Fone-N&uacute;mero:</strong></td>
                <td colspan="2"><html:text property="foneNumero" size="8" maxlength="8" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td><strong>C&oacute;digo de Retorno:</strong></td>
                <td colspan="2"><html:text property="codigoRetorno" size="10" maxlength="10" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr> 
                <td><strong>Sequencial do Registro:</strong></td>
                <td colspan="2"><html:text property="sequencialRegistro" size="15" maxlength="15" readonly="true" style="background-color:#EFEFEF; border:0"/></td>
              </tr>
              <tr>
                <td colspan="3"><hr></td>
              </tr>
