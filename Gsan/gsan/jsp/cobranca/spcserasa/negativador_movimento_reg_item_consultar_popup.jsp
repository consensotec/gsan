...
<html:form action="/exibirConsultarNegativadorMovimentoRegItemPopupAction"
	...
	type="gsan.gui.cobranca.spcserasa.ConsultarNegativadorMovimentoRegItemPopupActionForm"
	method="post">
										...
										<td width="8%">
	                      				...
	                      				<td width="10%">
	                      					<div align="center">                						 
	                      						...
	                      						<logic:present name="negativadorMovimentoRegItem" property="contaGeral" >
													...
													<logic:present name="negativadorMovimentoRegItem" property="contaGeral.conta" >											 
												 		...
												 		<logic:present name="negativadorMovimentoRegItem" property="contaGeral.conta.valorAgua" >
															 ...
															 <%
															 valorAgua = ((gsan.cobranca.NegativadorMovimentoRegItem)negativadorMovimentoRegItem).getContaGeral().getConta().getValorAgua().doubleValue();
															 %>	
												 		...
												 		<logic:present name="negativadorMovimentoRegItem" property="contaGeral.conta.valorEsgoto" >
															 ...
															 <%
															  valorEsgoto = ((gsan.cobranca.NegativadorMovimentoRegItem)negativadorMovimentoRegItem).getContaGeral().getConta().getValorEsgoto().doubleValue();
															 %>
														...
														<logic:present name="negativadorMovimentoRegItem" property="contaGeral.conta.debitos" >											 
															...
															<%
															 valorDebitos = ((gsan.cobranca.NegativadorMovimentoRegItem)negativadorMovimentoRegItem).getContaGeral().getConta().getDebitos().doubleValue();
															%>	
														...
														<logic:present name="negativadorMovimentoRegItem" property="contaGeral.conta.valorCreditos" >
															...
															<%
															 valorCreditos = ((gsan.cobranca.NegativadorMovimentoRegItem)negativadorMovimentoRegItem).getContaGeral().getConta().getValorCreditos().doubleValue();
															%>	
												...
												<logic:present name="negativadorMovimentoRegItem" property="contaGeral" >
													...
													<logic:present name="negativadorMovimentoRegItem" property="contaGeral.contaHistorico" >											 
														...
														<logic:present name="negativadorMovimentoRegItem" property="contaGeral.contaHistorico.valorAgua" >
															...
															<%
															valorAgua = ((gsan.cobranca.NegativadorMovimentoRegItem)negativadorMovimentoRegItem).getContaGeral().getContaHistorico().getValorAgua().doubleValue();
															%>	
														...
														<logic:present name="negativadorMovimentoRegItem" property="contaGeral.contaHistorico.valorEsgoto" >
															 ...
															 <%
															 valorEsgoto = ((gsan.cobranca.NegativadorMovimentoRegItem)negativadorMovimentoRegItem).getContaGeral().getContaHistorico().getValorEsgoto().doubleValue();
															 %>
														...
														<logic:present name="negativadorMovimentoRegItem" property="contaGeral.contaHistorico.debitos" >											 
															 ...
															 <%
															 valorDebitos = ((gsan.cobranca.NegativadorMovimentoRegItem)negativadorMovimentoRegItem).getContaGeral().getContaHistorico().getValorDebitos().doubleValue();
															 %>	
														...
														<logic:present name="negativadorMovimentoRegItem" property="contaGeral.contaHistorico.valorCreditos" >
															 ...
															 <%
															 valorCreditos = ((gsan.cobranca.NegativadorMovimentoRegItem)negativadorMovimentoRegItem).getContaGeral().getContaHistorico().getValorCreditos().doubleValue();
															 %>	
												...
												%>
												<%=gsan.util.Util.formataBigDecimal(new java.math.BigDecimal(valorCorrente),2,false) %>
