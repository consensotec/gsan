...
<p>&nbsp;</p>
            <table width="100%" border="0" >
			  ...
			  <tr>
                <td width="132"><strong>Código doTipo do Registro:</strong></td>
              ...
              <tr> 
               <tr> 
                ...
                <td colspan="2"><div align="right">
                  <input type="submit" name="Submit" class="bottonRightCol" onClick="javascript:window.location.href='../../Cobrança/negativador_registro_tipo_manter.html'" value="Filtrar">
                </div></td>
              </tr>
            </table>
