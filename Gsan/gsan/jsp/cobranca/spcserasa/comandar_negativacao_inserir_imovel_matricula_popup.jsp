	      		 ...
	      		 <tr>
					...
					<logic:notPresent name="atualizar" scope="request">
					    <html:text
							...
							onkeypress="validaEnterComMensagem(event, 'exibirAdicionarMatriculaImovelNegativacaoAction.do','idImovelDebitos','Im&oacute;vel');return isCampoNumerico(event);" 
									  ...
									  <div style="width: 100%; height: 100%; overflow: auto;">
										...
										<logic:notEmpty name="imovelClientes">
											<logic:iterate name="imovelClientes" id="imovelCliente"
												...
												<logic:present name="indicadorValidaCpfCnpf" scope="request">
											  		<%if (imovelCliente.getCliente().getIndicadorValidaCpfCnpj().compareTo(Integer.valueOf(ConstantesSistema.NAO))==0) {%>  	
											   		<td width="10%" align="center">
														<html:radio property="clienteSelecionado"
														value="${imovelCliente.id}" disabled="true" />
													 </td>
												...
												<logic:notPresent name="indicadorValidaCpfCnpf" scope="request">
													<td width="10%" align="center">
															<html:radio property="clienteSelecionado"
															value="${imovelCliente.id}" />
													 </td>
