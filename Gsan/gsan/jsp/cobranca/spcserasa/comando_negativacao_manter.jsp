								...
								<logic:iterate name="collectionComandoNegativacao" id="comandoNegativacaoHelper">
									<pg:item>
										...
										<tr bgcolor="#cbe5fe">
											...
											<td align="center">
											<logic:equal name="comandoNegativacaoHelper" property="indicadorComandoSimulado" value="<%=gsan.util.ConstantesSistema.SIM.toString() %>">
											SIM
											</logic:equal>
											
											
											<logic:equal name="comandoNegativacaoHelper" property="indicadorComandoSimulado"  value="<%=gsan.util.ConstantesSistema.NAO.toString() %>">
											NÃO
											</logic:equal>
