...
<!--
	...
	function email() {
		this.aa = new Array("emailCliente", "E-Mail inválido.", new Function(
				"varName", " return this[varName];"));
	}

	function IntegerValidations() {
		this.aa = new Array("idArrecadador",
				"O campo Código do Arrecadador deve conter apenas números.",
				new Function("varName", " return this[varName];"));
		this.ac = new Array("idCliente",
				"O campo Cliente deve conter apenas números.", new Function(
						"varName", " return this[varName];"));
	}
...
<body leftmargin="5" topmargin="5"
	...
	<html:form action="/filtrarContratoArrecadadorAction"
		...
		type="gsan.gui.arrecadacao.FiltrarContratoArrecadadorActionForm"
		...
		<table width="770" border="0" cellspacing="5" cellpadding="0">
			<tr>
				...
				<td width="625" valign="top" class="centercoltext">
					...
					<table width="100%" border="0">
						<tr>
							<td width="139" height="22"><strong>Código do
						...
						<tr>
							<td width="25%"><strong>Número Contrato:</strong>
							</td>
						...
						<tr>
							<td width="32%"><strong>Conta Depósito Arrecadação:
							</strong>
							</td>
							...
							<td width="68%"><html:text maxlength="4"
								...
								<a href="javascript:pesquisaTipoConta('arrecadacao');"> <img
									...
									border="0" title="Pesquisar Conta Depósito Arrecadação" /> </a> <a
								href="javascript:limparContaBancaria(document.forms[0],'arrecadacao');">
									<img src="<bean:message key="caminho.imagens"/>limparcampo.gif"
									border="0" title="Limpar Conta Depósito Arrecadação" /> </a></td>
						</tr>

						<tr>
							<td width="32%"><strong>Conta Depósito Tarifa: </strong>
							</td>
							...
							<td width="68%"><html:text maxlength="4"
								...
								<a href="javascript:pesquisaTipoConta('tarifa');"> <img
									width="23" height="21"
									src="<bean:message key='caminho.imagens'/>pesquisa.gif"
									border="0" title="Pesquisar Conta Depósito Tarifa" /> </a> <a
								href="javascript:limparContaBancaria(document.forms[0],'tarifa');">
									<img src="<bean:message key="caminho.imagens"/>limparcampo.gif"
									border="0" title="Limpar Conta Depósito Tarifa" /> </a></td>
						</tr>
