...
<%@page import="gsan.arrecadacao.ArrecadadorContratoTarifa"%>
...
<html:javascript staticJavascript="false"
	formName="InserirContratoArrecadadorActionForm" />
...
<script language="JavaScript">
	...
	function validarForm(form){		
		if(validateInserirContratoArrecadadorActionForm(form)){
			if(validaData(form)){
				if(validaIndicadorClienteResponsavel(form)){								
	...
	function validaIndicadorClienteResponsavel(){

		var form = document.forms[0];
		var msg = '';
		
		if(!form.indicadorCobParClienteResponsavel[0].checked && !form.indicadorCobParClienteResponsavel[1].checked){
			msg = msg + 'Informe Indicador de Convênio para Cobrança de Parcelamento de Cliente Responsável  .';
		}
		if( msg != '' ){
			alert(msg);
			return false;
	...
	function limparForm(form){
		...
		form.indicadorCobranca[1].checked = true;
		form.indicadorCobParClienteResponsavel[0].checked = true;
		form.indicadorCobParClienteResponsavel[1].checked = true;
	...
	function verificarChecado(valor){
		...
		if(valor == "1"){
		 	form.indicadorCobParClienteResponsavel.checked = true;
		 }else{
		 	form.indicadorCobParClienteResponsavel.checked = false;
		}
	}
	...
	function adicionarObjeto(){
		...
		if( objFormaArrecadacao.value != '-1' ) {
			...
			if((objValorTarifa.value != "" || objValorTarifaPercentual.value != "")  && objNmDiasFloat.value != "" ) {
				form.action = 'exibirInserirContratoArrecadadorAction.do?acao=adicionar';
				form.submit();
			} else if (objValorTarifa.value == "" && objNmDiasFloat.value != "" && objValorTarifaPercentual.value == "") {
					alert("Informe Valor da Tarifa ou Percentual da Tarifa."); 
			} else if (objValorTarifa.value != "" && objValorTarifaPercentual.value != "" && objNmDiasFloat.value == "") {
	...
	if(!form.indicadorCobParClienteResponsavel[0].checked && !form.indicadorCobParClienteResponsavel[1].checked && !form.indicadorCobParClienteResponsavel[2].checked){
		msg = msg + 'Informe indicadorCobParClienteResponsavel.';
	}
...
<body leftmargin="5" topmargin="5"
	...
	<html:form action="/inserirContratoArrecadadorAction.do"
		...
		type="gsan.gui.arrecadacao.InserirContratoArrecadadorActionForm"
		method="post"
		onsubmit="return validateInserirContratoArrecadadorActionForm(this);">
			...
			<tr>
				...
				<td valign="top" class="centercoltext">
					...
					<table width="100%" border="0">
						<tr>
							<td colspan="2">Para adicionar o contrato de arrecadador,
								informe os dados abaixo:</td>
						</tr>

						<tr>
							<td width="32%" class="style3"><strong>Arrecadador:<font
									color="#FF0000">*</font> </strong></td>
							<td width="68%" colspan="2"><html:select
									property="idClienteCombo" tabindex="1" style="width:200px;">
						...
						<tr>
							<td width="25%"><strong>Número Contrato:<font
									color="#FF0000">*</font> </strong></td>
						...
						<tr>
							<td width="32%"><strong>Conta Depósito Arrecadação:<font
									color="#FF0000">*</font> </strong></td>
							...
							<td width="68%"><html:text maxlength="4"
								...
								<a href="javascript:pesquisaTipoConta('arrecadacao');"> <img
									...
									border="0" title="Pesquisar Conta Bancária" /> </a> <a
								href="javascript:limparContaBancaria(document.forms[0],'arrecadacao');">
									<img src="<bean:message key="caminho.imagens"/>limparcampo.gif"
									border="0" title="Limpar Conta Bancária" /> </a>
							</td>
						</tr>

						<tr>
							<td width="32%"><strong>Conta Depósito Tarifa:<font
									color="#FF0000">*</font> </strong></td>
						...
						<tr>
							<td><strong>Cliente: <font
									color="#FF0000">*</font></strong>
							</td>
							<td colspan="3"><strong> <html:text
										property="idCliente" size="10" maxlength="10"
										onkeypress="javascript:validaEnter(event, 'exibirInserirContratoArrecadadorAction.do?objetoConsulta=1', 'idCliente');return isCampoNumerico(event);" />
							</strong> <a
								...
								alt="Pesquisar Cliente"> <img width="23" height="21"
									...
									<logic:empty name="InserirContratoArrecadadorActionForm"
										property="idCliente">
								...
								</logic:notPresent> <a href="javascript:limparCliente('cliente');"> <img
									border="0"
						...
						<tr>
							<td width="32%" class="style3"><strong>Código do
									Convênio:<font color="#FF0000">*</font> </strong></td>
						...
						<tr>
							<td width="32%"><strong>Indicador de Cobrança de
									ISS:</strong></td>
							<td width="68%"><strong> <span class="style1"><strong>
											<html:radio property="indicadorCobranca" value="1"
												tabindex="5" /> <strong>Cobrar ISS <html:radio
													property="indicadorCobranca" value="2" tabindex="6" />Não
												Cobrar ISS </strong> </strong> </span> </strong></td>
						</tr>
					...
					<td><strong> <html:text property="dtInicioContrato" size="10"
						...
						onclick="javascript:abrirCalendario('InserirContratoArrecadadorActionForm', 'dtInicioContrato')" />
					dd/mm/aaaa </td>
				  </tr>
				  ...
				  <tr>
					...
					<td><strong> <html:text property="dtFimContrato" size="10"
						...
						src="<bean:message key="caminho.imagens"/>calendario.gif"
						width="20" border="0" align="absmiddle" alt="Exibir Calendário"
						onclick="javascript:abrirCalendario('InserirContratoArrecadadorActionForm', 'dtFimContrato')" />
					dd/mm/aaaa</td>
				</tr>
						<tr>
							<td width="32%" class="style3"><strong>Tamanho
									Máximo para Identificação do Imóvel:<font color="#FF0000">*</font>
							</strong></td>
							<td width="68%" colspan="2"><html:text
									property="tamanhoMaximoIdentificacaoImovel" size="2"
									maxlength="2" tabindex="9"
									onchange="validarCampoNumericoComMensagemLimpandoCampo(document.forms[0].tamanhoMaximoIdentificacaoImovel, 'Tamanho Máximo Identificação Imóvel');"
						...
						<tr>
							...
							<td width="68%" colspan="2"><strong><b><span
										class="style2"> <html:text property="emailCliente"
												size="50" maxlength="40" tabindex="6"
												style="text-transform: none;" /> </span> </b> </strong>
							</td>
						</tr>
						<tr>
						<tr>
							<td width="32%"><strong>Indicador de Convênio para
									Cobrança de Parcelamento de Cliente Responsável :<font
									color="#FF0000">*</font> </strong></td>
							<td width="68%"><strong> <span class="style1"><strong>
											<html:radio property="indicadorCobParClienteResponsavel"
												value="1" tabindex="5" /> <strong>Sim <html:radio
													property="indicadorCobParClienteResponsavel" value="2"
													tabindex="6" />Não </strong> </strong> </span> </strong></td>
						</tr>



						<tr>
							<td width="32%" class="style3"><strong>Forma:<font
									color="#FF0000">*</font> </strong></td>
							<td width="78%" colspan="2"><html:select
									property="formaDeArrecadacao" tabindex="1"
									onclick="javascript:desabilitaCampo();" style="width:400px;">
									<html:option value="-1"> &nbsp; </html:option>
									<logic:present name="colecaoFormaArrecadacao" scope="session">
										<html:options collection="colecaoFormaArrecadacao"
						...
						<tr>
							<td><strong>Valor da Tarifa:<font color="#FF0000">*</font>
							</strong></td>
							<td width="68%" colspan="2"><span class="style2"> <html:text
										property="valorTarifa" size="15" maxlength="17" tabindex="10"
										onblur="javascript:desabilitaCampo();numeroPositivo();"
										onchange="validarCampoNumericoComMensagemLimpandoCampo(document.forms[0].valorTarifa, 'Valor Tarifa');bloqueiaValorTarifa();"
										onkeypress="formataValorMonetario( this, 17 );return isCampoNumerico(event);"
										onkeyup="formataValorMonetario( this, 17 );bloqueiaValorTarifa();"
										style="text-align: right;" /> </span>
							</td>
						</tr>
						<tr>
							<td><strong>Percentual da Tarifa:<font
									color="#FF0000">*</font> </strong></td>
							<td width="68%" colspan="2"><span class="style2"> <html:text
										property="valorTarifaPercentual" size="15" maxlength="6"
										tabindex="11"
										onblur="javascript:desabilitaCampo();numeroPositivo();"
										onchange="validarCampoNumericoComMensagemLimpandoCampo(document.forms[0].valorTarifaPercentual, 'Tarifa Percentual');bloqueiaValorTarifa();"
						...
						<tr>
							<td><strong>Quantidade de dias FLOAT:<font
									color="#FF0000">*</font> </strong></td>
							<td width="68%" colspan="2"><strong><b><span
										class="style2"> <html:text property="numeroDiaFloat"
												size="4"
												onchange="validarCampoNumericoComMensagemLimpandoCampo(document.forms[0].numeroDiaFloat, 'Número dias FLOAT');"
												onblur="javascript:desabilitaCampo();numeroPositivo();"
												maxlength="4" tabindex="12" style="text-align: right;"
						...
						<tr>
							...
							<td colspan="3" align="right"><input type="button"
								class="bottonRightCol" value="Adicionar" tabindex="25"
								style="width: 80px; align: right;"
								onclick="javascript:adicionarObjeto();"
								name="botaoAdicionarArrecadacaoContratoTarifa">
							</td>
						</tr>
						<tr>
							<td colspan="3">
										...
										<td>
											<table width="100%" bgcolor="#99CCFF">
												<tr bgcolor="#99CCFF">
													...
													<td width="20%">
														<div align="left">
															<strong>Perc. da Tarifa</strong>
														</div>
													</td>
													<td width="15%">
														<div align="left">
															<strong>N. de dias FLOAT</strong>
														</div>
													</td>
												</tr>
											</table>
									...
									<tr>
										<td>
											<%
												String cor = "#FFFFFF";
											%> <logic:present
												name="colecaoArrecadadorContratoTarifaSelecionados"
												scope="session">
																...
																<table width="100%" align="center" bgcolor="#99CCFF">
																	...
																	<logic:iterate
																		...
																		<td align="center" width="10%"><img
																			...
																			onclick="remover('${count}')" title="Remover"
																			style="cursor: hand;">
																		<td width="35%">
																			<div align="left">
																				<logic:present name="arrecadadorContratoTarifa"
																					property="arrecadacaoForma">
																					<bean:write name="arrecadadorContratoTarifa"
																						property="arrecadacaoForma.descricao" />
																				</logic:present>

																				<logic:notPresent name="arrecadadorContratoTarifa"
																					property="arrecadacaoForma">&nbsp;</logic:notPresent>
																			</div>
																		</td>
																		...
																		<td width="20%">
																			<div align="left">
																				<logic:present name="arrecadadorContratoTarifa"
																					...
																					<%=Util
										.formatarMoedaReal(arrecadadorContratoTarifa
												.getValorTarifa())%>
																				</logic:present>
																				<logic:notPresent name="arrecadadorContratoTarifa"
																					property="valorTarifa">&nbsp;</logic:notPresent>
																			</div>
																		</td>
																		...
																		<td width="20%">
																			<div align="left">
																				<logic:present name="arrecadadorContratoTarifa"
																					property="valorTarifaPercentual">
																					<%=Util
										.formatarMoedaReal(arrecadadorContratoTarifa
												.getValorTarifaPercentual())%>
																				</logic:present>
																				<logic:notPresent name="arrecadadorContratoTarifa"
																					property="valorTarifaPercentual">&nbsp;</logic:notPresent>
																			</div>
																		</td>
																		...
																		<td width="15%">
																			<div align="left">
																				<logic:present name="arrecadadorContratoTarifa"
																					property="numeroDiaFloat">
																					<bean:write name="arrecadadorContratoTarifa"
																						property="numeroDiaFloat" />
																				</logic:present>

																				<logic:notPresent name="arrecadadorContratoTarifa"
																					property="numeroDiaFloat">&nbsp;</logic:notPresent>
																			</div>
																		</td>
						...
						<tr>
							<td width="33%" align="left"><input name="Button" type="button"
								class="bottonRightCol" value="Limpar" align="left"
								onclick="window.location.href='/gsan/exibirInserirContratoArrecadadorAction.do?menu=sim'"
								tabindex="8"> <input type="button"
							...
							<td align="right"><input type="button" name="Button"
								...
								onClick="validarForm(document.forms[0]);" tabindex="11" /></td>
						</tr>
