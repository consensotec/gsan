...
<html:javascript staticJavascript="false"
	formName="AtualizarPagamentoSituacaoActionForm" />

<SCRIPT LANGUAGE="JavaScript">
<!--

function validarForm(formulario){
if(validateAtualizarPagamentoSituacaoActionForm(formulario)){
...
<html:form action="/atualizarPagamentoSituacaoAction.do" method="post">

	<INPUT TYPE="hidden" name="removerPagamentoSituacao">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Situação de Pagamento</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para Atualizar uma Situação de Pagamento, informe os
					dados abaixo:</td>
				<tr>
					<td><strong>C&oacute;digo:</strong></td>
					<td><html:hidden property="id" /> 
					<bean:write	name="AtualizarPagamentoSituacaoActionForm" property="id" />
					</td>
				</tr>
