...
<html:form action="/gerarMovimentoDebitoAutomaticoBancoAction"
	...
	type="gsan.gui.arrecadacao.GerarMovimentoDebitoAutomaticoBancoActionForm"
	method="post">
								...
								<html:select property="idGrupoFaturamento" 
									...
									<logic:present name="colecaoFaturamentoGrupo">
										...
										<logic:iterate name="colecaoFaturamentoGrupo" id="faturamentoGrupo" >
											...
											<option <%= (idGF.toString().equalsIgnoreCase(((gsan.faturamento.FaturamentoGrupo)faturamentoGrupo).getId() + ";" + ((gsan.faturamento.FaturamentoGrupo)faturamentoGrupo).getAnoMesReferencia()))?" selected ": "" %> value="<bean:write name="faturamentoGrupo" property="id" />;<bean:write name="faturamentoGrupo" property="anoMesReferencia" />" >
