...
<html:form action="/pesquisarGuiaDevolucaoAction"
	...
	type="gsan.gui.arrecadacao.PesquisarGuiaDevolucaoActionForm"
	method="post">
	...
	<table width="740" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0"
				...
				<td class="parabg">Pesquisa de Guias de Devolução do Cliente</td>
				<td width="11"><img border="0"
			...
			<table width="100%" border="0" bgcolor="#90c7fc">
				...
				<table width="100%" border="0" bgcolor="#90c7fc">
					<tr>
						<td bgcolor="#79bbfd" colspan="7" align="center" height="20"><strong>Guias de Devolução do Cliente</strong></td>
					</tr>
