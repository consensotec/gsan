...
<%@ page import="java.math.BigDecimal,gsan.cadastro.localidade.Localidade,gsan.util.Util" %>
<%@ page import="gsan.arrecadacao.bean.FiltrarDadosDiariosArrecadacaoHelper" %>
...
<html:form action="/exibirConsultarDadosDiariosEloAction.do"
			...
			<table width="100%" border="0">
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF" dwcopytype="CopyTableRow">
						...
						boolean ehTODOS = elo.getId().intValue() == -1;
						...
						if (cor.equalsIgnoreCase("#cbe5fe")) {
							  ...
							  <td height="17">
			                  	<font color="#000000" style="font-size:10px;<%=negrito%>" face="Verdana, Arial, Helvetica, sans-serif"> 
			                  	 <a href="javascript:abrirPopup('exibirConsultarDadosDiariosLocalidadeAction.do?referencia=<%=referencia%>&idGerencia=<%=idGerencia%>&idEloPopup=<%=elo.getId()%>&idUnidadeNegocio=<%=idUnidadeNegocio%>&valorTotalGerencia=<%=valorTotalGerencia%>&valorTotalUnidadeNegocio=<%=valorTotalUnidadeNegocio%>&valorTotalElo=<%=itemHelper.getValorArrecadacaoLiquida()%>', 475, 800);">
								        <%=elo.getDescricao() %>
							        </a>
			                  	</font></td>
			                  <td><div align="right">
			                  ...
			                  <td><div align="right">
				                  <font color="#000000" style="font-size:10px;<%=negrito%>" face="Verdana, Arial, Helvetica, sans-serif"> 
				                  <a href="javascript:abrirPopup('exibirConsultarDadosDiariosValoresDiariosAction.do?referencia=<%=referencia%>&idGerencia=<%=idGerencia %>&idEloPopup=<%=elo.getId() %>', 475, 800);">
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioDadosDiariosEloAction.do" />
</html:form>
<body>
</html:html>
