...
<%@page import="gsan.arrecadacao.GuiaDevolucao"%>
...
function validarForm(form){
	if(CheckboxNaoVazio(document.ManterGuiaDevolucaoActionForm.idRegistrosRemocao) && confirm('Confirma remoção?')){
		form.action = "manterGuiaDevolucaoAction.do"
	  	form.submit();
	}
}
...
<html:form action="/manterGuiaDevolucaoAction"
	...
	type="gsan.gui.arrecadacao.ManterGuiaDevolucaoActionForm" method="post"
	>
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Cancelar Guia de Devolução do Imóvel</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<div align="left"><html:text property="idImovel" readonly="true"
						style="background-color:#EFEFEF; border:0;" size="30"
						maxlength="10" /></div>
					</td>
				</tr>
				<tr>
					<td width="180"><strong>Inscrição do Imóvel:</strong></td>
					<td colspan="3" align="left">
				...
				<tr>
					<td width="180"><strong>Cliente Usuário:</strong></td>

					<td colspan="3" align="left"><html:text property="nomeCliente"
						readonly="true" style="background-color:#EFEFEF; border:0;"
						size="50" maxlength="50" /></td>
				</tr>
				<tr>
					<td width="180"><strong>Situação Água:</strong></td>

					<td align="right">
					<div align="left"><html:text property="situacaoLigacaoAgua"
						readonly="true" style="background-color:#EFEFEF; border:0;"
						size="30" maxlength="30" /></div>
					</td>
				</tr>
				<tr>
					<td width="180"><strong>Situação Esgoto:</strong></td>
					<td align="right">
			...
			%>
												<tr bgcolor="#cbe5fe">
													...
													<%--<td width="17%" align="center">
														...
														title="<%="" + guiaDevolucao.getId()%>">${guiaDevolucao.id}</html:link>
													</td>--%>
													<td width="17%" align="left">${guiaDevolucao.id}&nbsp;</td>
													<td width="25%" align="left">
													
													<logic:present name="guiaDevolucao" property="creditoTipo">
														<logic:present name="guiaDevolucao" property="creditoTipo.descricao">
															${guiaDevolucao.creditoTipo.descricao}
														</logic:present>
													</logic:present>
														&nbsp;
													</td>
													<td width="20%" align="left">
														<logic:present name="guiaDevolucao" property="documentoTipo">
															<logic:present name="guiaDevolucao" property="documentoTipo.descricaoDocumentoTipo">
																${guiaDevolucao.documentoTipo.descricaoDocumentoTipo}
															</logic:present>
														</logic:present>
													&nbsp;</td>
