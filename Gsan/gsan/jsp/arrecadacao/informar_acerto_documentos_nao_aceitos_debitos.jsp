...
<%@ page import="gsan.cobranca.DocumentoTipo" %>
														 ...
														 <td width="20%" align="center">
													 		<div align="center">
														 		<input 
														 			...
														 			type="checkbox" 
														 			alt="<%="" + Util.formatarMoedaReal(((ContaValoresHelper)contavaloreshelper).getValorTotalConta().subtract(((ContaValoresHelper)contavaloreshelper).getConta().getValorImposto())).trim()%>
