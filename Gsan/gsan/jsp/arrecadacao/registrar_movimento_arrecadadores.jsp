...
<!--
	...
	function IntegerValidations () {
	   this.aa = new Array("codigoAgente", "Arrecadador deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	}
	...
	function validarForm(){
	   ...
	   if(form.codigoAgente.value != '' && form.codigoConvenio.value != '' && form.idTipoMovimento.value != '' && form.uploadPicture.value != '') {
		  ...
		  if(form.codigoConvenio.value == ''){
		       mensagem = mensagem + 'Informe Codigo Convênio.';
		  }
	...
	<tr>
		...
		<table width="100%" border="0">
			...
			<logic:present name="um" scope="session">
				<tr>
					<td><strong>Código Convênio:<font color="#FF0000">*</font></strong></td>
