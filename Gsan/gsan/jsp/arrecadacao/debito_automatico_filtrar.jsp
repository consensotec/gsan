...
<script language="JavaScript">
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
		var form = document.FiltrarDebitoAutomaticoActionForm;
    ...
    function chamarPopup(url, tipo, objeto, codigoObjeto, altura, largura, msg){
		...
		if (objeto == null || codigoObjeto == null){
            abrirPopup(url + "?" + "tela=" + tipo + "&caminhoRetornoTelaPesquisa=exibirFiltrarDebitoAutomaticoAction", altura, largura); 
		}
		else{
			if (codigoObjeto.length < 1 || isNaN(codigoObjeto)){
			    ...
			    abrirPopup(url + "?" + "tela=" + tipo + "&" + objeto + "=" + codigoObjeto + "&caminhoRetornoTelaPesquisa=exibirFiltrarDebitoAutomaticoAction", altura, largura);
			}
		}
	}
...
<html:form action="/filtrarDebitoAutomaticoAction"
	...
	type="gsan.gui.arrecadacao.FiltrarDebitoAutomaticoActionForm"
	method="post"
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><html:text property="matricula" size="9" maxlength="9" tabindex="1" onkeypress="return isCampoNumerico(event);"/></td>
					<td>&nbsp;</td>
				</tr>
				...
				<tr>
					...
					<a	
					href="javascript:chamarPopup('exibirPesquisarTabelaAuxiliarAbreviadaAction.do', 'banco', null, null, 400, 800, null);">
					...
					<logic:notPresent name="corBanco">
						...
						border="0" title="Apagar" tabindex="4" /> </a></td>
				</tr>
				...
				<tr>
					...
					<img width="23" height="21" border="0" name="imgPesquisarAgencia"
						src="<bean:message key="caminho.imagens"/>pesquisa.gif"
						title="Pesquisar Agência" tabindex="6" /></a> <logic:present
						name="corAgencia">
						...
						src="<bean:message key="caminho.imagens"/>limparcampo.gif"
						border="0" title="Apagar" name="imgLimparAgencia" tabindex="7"/> </a></td>
				</tr>
				...
				<tr>
					<td colspan="3"><input name="limpar" type="button" class="bottonRightCol"
						...
						onclick="window.location.href='/gsan/exibirFiltrarDebitoAutomaticoAction.do?menu=sim'" tabindex="10">
					<input name="Button" type="button" class="bottonRightCol"
						value="Cancelar" align="left"
						onclick="window.location.href='/gsan/telaPrincipal.do'" tabindex="9"></td>
					<td align="right" colspan="2"><input type="button" name="filtrar"
						class="bottonRightCol" value="Filtrar"
						onClick="javascript:validarForm(document.forms[0])" tabindex="8"/></td>
				</tr>
			</table>
