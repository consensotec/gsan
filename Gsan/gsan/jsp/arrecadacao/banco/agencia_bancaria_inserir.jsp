...
<html:javascript staticJavascript="false"
	formName="InserirAgenciaBancariaActionForm" />
...
function validarForm(formulario){
	...
	if (validateInserirAgenciaBancariaActionForm(formulario)){
		...
		/* else if(!enderecoInformado.disabled){
			...
			if (!testarCampoValorZero(objRamal, "Ramal")){
				...
				formulario.action = "/gsan/inserirAgenciaBancariaAction.do";
...
<html:form action="/exibirInserirAgenciaBancariaAction" method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Agência Bancária</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para adicionar uma Agência Bancária, informe os
					dados abaixo:</td>
					<!-- Banco -->
				<tr>
				...
				<tr>
					<td><strong>Código da Agência Bancária:<font color="#FF0000">*</font></strong></td>
					<td colspan="2"><html:text property="codigo" size="4" maxlength="4"
						tabindex="2" /></td>
				</tr>
				...
				<tr>
					<td><input name="Button" type="button" class="bottonRightCol"
						...
						onclick="window.location.href='<html:rewrite page="/exibirInserirAgenciaBancariaAction.do?menu=sim"/>'">
		  ...
		  --%> <gsan:controleAcessoBotao name="Botao" value="Inserir"
						...
						url="inserirAgenciaBancariaAction.do" tabindex="13" /></td>
				</tr>
