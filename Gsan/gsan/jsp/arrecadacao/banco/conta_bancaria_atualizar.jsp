...
<html:form action="/atualizarContaBancariaAction"
	...
	type="gsan.gui.arrecadacao.banco.AtualizarContaBancariaActionForm"
	method="post"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Conta Bancária</td>
			...
			<table width="100%" border="0">
				<tr>
					<td height="10" colspan="3">Para atualizar a conta bancária,
				...
				<logic:notEmpty name="colecaoAgencia">
					<tr>
						<td><strong>Agência:<font color="#FF0000">*</font></strong></td>
