				...
				<tbody>
					...
					<tr>
						...
						value="${requestScope.dataAtual}" /><html:text
							value="<%= Util.formatarData(((gsan.arrecadacao.aviso.AvisoBancario)avisoBancario).getDataLancamento()) %>"
					...
					<tr>
						...
						<td colspan="3" class="style1"><logic:present name="avisoBancario"
							...
							<input type="text" size="10" maxlength="10"
								...
								name="dataRealizacao"
								value="<%= Util.formatarData(((gsan.arrecadacao.aviso.AvisoBancario)avisoBancario).getDataRealizada())%>">
					...
					<tr>
						...
						<td colspan="3" class="style1"><input type="text " size="14"
							...
							value="<%= Util.formatarMoedaReal(((gsan.arrecadacao.aviso.AvisoBancario) avisoBancario).getValorArrecadacaoInformado()) %>">
						</td>
					</tr>
					<tr>
						...
						<td colspan="3" class="style1"><input type="text " size="14"
							...
							value="<%= Util.formatarMoedaReal(((gsan.arrecadacao.aviso.AvisoBancario) avisoBancario).getValorDevolucaoInformado()) %>">
						</td>
					</tr>
					<tr>
								...
								<logic:iterate name="avisoDeducoes" id="avisoDeducoes"
									...
									<%cont = cont + 1;
										...
										<div align="center"><span class="style1"> <input
											...
											value="<%= Util.formatarMoedaReal(((gsan.arrecadacao.aviso.AvisoDeducoes) avisoDeducoes).getValorDeducao()) %>"
						...
						<table bgcolor="#99ccff" width="100%">
							...
							<tbody>
								...
								<logic:iterate name="avisoAcerto" id="avisoAcerto" indexId="i">
									...
									.formatarData(((gsan.arrecadacao.aviso.AvisoAcerto) avisoAcerto)
											.getDataAcerto())%></div>
										</td>
										<td>
										<div align="center"><span class="style1"> <input
											name="posicaoAvisoAcerto_<bean:write name="i"/>" onkeyup="formataValorMonetario(this, 14)" style="text-align:right;"
											value="<%= Util.formatarMoedaReal(((gsan.arrecadacao.aviso.AvisoAcerto) avisoAcerto).getValorAcerto()) %>"
											size="14" maxlength="14" type="text"> </span></div>
										</td>
									</tr>
								</logic:iterate>
