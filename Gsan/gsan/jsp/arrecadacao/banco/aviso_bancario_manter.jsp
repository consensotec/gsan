...
<html:form action="/ExibirAtualizarAvisoBancarioAction" method="post">
	...
	%>
							...
							.formatarData(((gsan.arrecadacao.aviso.bean.AvisoBancarioHelper) avisoBancario)
									.getAvisoBancario()
					...
					DÉBITO
							...
							.formatarData(((gsan.arrecadacao.aviso.bean.AvisoBancarioHelper) avisoBancario)
									...
									<div align="right"><logic:present name="avisoBancario"
										...
										<%=Util
							.formatarMoedaReal(((gsan.arrecadacao.aviso.bean.AvisoBancarioHelper) avisoBancario)
									.getAvisoBancario()
									.getValorRealizado())%>
									</logic:present></div>
									</td>
