...
<%@ page import="gsan.arrecadacao.ArrecadacaoForma"%>
...
<script><!--
	...
	function validaRequiredAvisoBancario () {
		...
		if(!form.tipoInclusao[0].checked && !form.tipoInclusao[1].checked && !form.tipoInclusao[2].checked){
...
function selecionarFormaArrecadacao(form){
	
	tipoInclusao = obterValorRadioMarcadoPorNome("tipoInclusao");
	
<!--	if (tipoInclusao == "ficha"){-->
<!--		-->
<!--		form.idFormaArrecadacao.value = document.getElementById("FICHA").value;-->
<!--		form.idFormaArrecadacao.disabled = true;-->
<!--	}-->
<!--	else{-->
		
		form.idFormaArrecadacao.disabled = false;
<!--	}-->
}
    ...
    <td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" dwcopytype="CopyTableRow">
        ...
        <tr>
          ...
          <td colspan="3">
            <strong>
              <html:text property="idAvisoBancario" size="9" maxlength="9" onkeyup="validaEnter(event, 'inserirPagamentosWizardAction.do?action=exibirInserirPagamentosAvisoBancarioAction', 'idAvisoBancario');limparAvisoBancarioTecla();" /> 
        ...
        <tr>
          ...
          <td>
            <html:radio property="tipoInclusao" value="manual" onchange="selecionarFormaArrecadacao(document.forms[0]);"><strong>Manual</strong></html:radio>
            <html:radio property="tipoInclusao" value="caneta" onchange="selecionarFormaArrecadacao(document.forms[0]);"><strong>Código de Barras</strong></html:radio>
            <html:radio property="tipoInclusao" value="ficha" onchange="selecionarFormaArrecadacao(document.forms[0]);"><strong>Ficha de Compensação</strong></html:radio>
          </td>
        </tr>
        <tr>
          <td>
