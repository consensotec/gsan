			...
			<table width="100%" border="0" style="fonteReduzida">
				...
				if (cont % 2 == 0) {%>
										...
										<tr bgcolor="#cbe5fe">
											...
											<logic:notEmpty
												...
												<logic:notEmpty name="pagamento" property="contaGeral.contaHistorico">
													<logic:notEmpty name="pagamento"
														...
														<a
															href="javascript:abrirPopup('exibirConsultarContaAction.do?tipoConsulta=contaHistorico&contaID=<%="" + pagamento.getContaGeral().getId() %>' , 600, 800);">${pagamento.contaGeral.contaHistorico.formatarAnoMesParaMesAno}</a>
													</logic:notEmpty>
												</logic:notEmpty>
											</logic:notEmpty> 
											...
											<logic:notEmpty name="pagamento" property="contaGeral.contaHistorico">
											<bean:write name="pagamento"
												property="contaGeral.contaHistorico.valorTotal" formatKey="money.format" />&nbsp;
											</logic:notEmpty>
											</logic:notEmpty>
											</td>
											...
											<td width="15%" align="center">
												...
												<logic:present name="pagamentoHistorico" property="guiaPagamentoGeral">
													...
													<logic:present name="pagamentoHistorico" property="guiaPagamentoGeral.guiaPagamentoHistorico">
														...
														${pagamentoHistorico.guiaPagamentoGeral.guiaPagamentoHistorico.debitoTipo.descricao}</a>&nbsp;
