...
<!--
   ...
   function InteiroZeroPositivoValidations () { 
       this.aa = new Array("codigoBarraDigitadoCampo1Parte1", "Campo 1 do Código de Barras digitado deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
       this.ab = new Array("codigoBarraDigitadoCampo1Parte2", "Campo 2 do Código de Barras digitado deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
       
       this.ac = new Array("codigoBarraDigitadoCampo2Parte1", "Campo 3 do Código de Barras digitado deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
       this.ad = new Array("codigoBarraDigitadoCampo2Parte2", "Campo 4 do Código de Barras digitado deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
       
       this.ae = new Array("codigoBarraDigitadoCampo3Parte1", "Campo 5 do Código de Barras digitado deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
       this.af = new Array("codigoBarraDigitadoCampo3Parte2", "Campo 6 do Código de Barras digitado deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
       
       this.ag = new Array("codigoBarraDigitadoDigitoVerificador", "Campo 7 do Código de Barras digitado deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
    }
    
    function IntegerValidations () {
	   this.aa = new Array("codigoBarraDigitadoCampo4", "Campo 8 do Código de Barras digitado deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	} 
