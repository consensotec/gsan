...
<fmt:bundle basename="gsan.properties.application" />
<%@page isELIgnored="false"%>
<%@ page import="gsan.arrecadacao.pagamento.bean.InserirPagamentoViaCanetaHelper"%>
	...
	function adicionarCodigoDeBarra(){
	 	...
	 	if(tamanhoTotal == 48){
	 		...
	 		if (validarCampo4(form.codigoBarraDigitadoCampo4.value)){
		 		if(validatePagamentosFaturasEspeciaisActionForm(form)){
		 	    	form.action = "/gsan/inserirPagamentosFaturasEspeciaisWizardAction.do?destino=2&action=exibirInserirPagamentosFaturasEspeciaisTipoInclusaoCanetaAction";
		 	    	form.submit();
		 	  	}
    ...
    <td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" dwcopytype="CopyTableRow">
        ...
        <tr>
          ...
          <td>
			<html:text property="descricaoFormaArrecadacao" size="52" maxlength="60" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
          </td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <td colspan="3"> 
            <strong> 
              <html:text property="codigoBarraDigitadoCampo1" disabled="true" tabindex="1" size="11" maxlength="11" onkeyup="javascript:autotab(this, document.PagamentosFaturasEspeciaisActionForm.codigoBarraDigitadoDigitoVerificadorCampo1);"/>
              <html:text property="codigoBarraDigitadoDigitoVerificadorCampo1" disabled="true" size="1" maxlength="1" onkeyup="autotab(this, document.PagamentosFaturasEspeciaisActionForm.codigoBarraDigitadoCampo2)"/>
              <html:text property="codigoBarraDigitadoCampo2"  size="11"  disabled="true" maxlength="11" onkeyup="autotab(this, document.PagamentosFaturasEspeciaisActionForm.codigoBarraDigitadoDigitoVerificadorCampo2)"/>
              <html:text property="codigoBarraDigitadoDigitoVerificadorCampo2"  disabled="true" size="1" maxlength="1" onkeyup="autotab(this, document.PagamentosFaturasEspeciaisActionForm.codigoBarraDigitadoCampo3)"/>

              <html:text property="codigoBarraDigitadoCampo3" disabled="true" size="11" maxlength="11" onkeyup="autotab(this, document.PagamentosFaturasEspeciaisActionForm.codigoBarraDigitadoDigitoVerificadorCampo3)"/>
              <html:text property="codigoBarraDigitadoDigitoVerificadorCampo3" disabled="true" size="1" maxlength="1" onkeyup="autotab(this, document.PagamentosFaturasEspeciaisActionForm.codigoBarraDigitadoCampo4)"/>
              <html:text property="codigoBarraDigitadoCampo4" disabled="true" size="11" maxlength="11" onkeyup="autotab(this, document.PagamentosFaturasEspeciaisActionForm.codigoBarraDigitadoDigitoVerificadorCampo4)"/>
