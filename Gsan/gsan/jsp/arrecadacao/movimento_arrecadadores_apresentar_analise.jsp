...
<%@ page import="gsan.arrecadacao.aviso.bean.AvisoBancarioHelper" isELIgnored="false" %>
			...
			<tr> 
                <td> 
                    ...
                    <tr bgcolor="#99CCFF"> 
                        ...
                        <td width="11%"><div align="center"><strong>Vl. Devol.</strong></div></td>
				...
				<td> 
					...
					<logic:iterate name="colecaoAvisosBancariosPorMovimentoArrecadador" id="avisoBancarioHelper" type="AvisoBancarioHelper">
							...
							<%}%> 
								...
								<td width="11%">
									<div align="right">
									<logic:present name="avisoBancarioHelper" property="valorDevolucaoCalculado">
										<bean:write name="avisoBancarioHelper" property="valorDevolucaoCalculado" formatKey="money.format"/>
									</logic:present>
									<logic:notPresent name="avisoBancarioHelper" property="valorDevolucaoCalculado">
										&nbsp;
									</logic:notPresent>
									</div>
								</td>
							...
							<tr bgcolor="#cbe5fe">
								...
								<td width="11%">
									<div align="right">
									<logic:present name="valorTotalAviso">
										<strong><bean:write name="valorTotalAviso" formatKey="money.format"/></strong>
									</logic:present>
									<logic:notPresent name="valorTotalAviso">
										&nbsp;
									</logic:notPresent>
									</div>
								</td>
								<td width="11%">
									<div align="right">
									<logic:present name="valorTotalArrecadacaoCalculado">
										<strong><bean:write name="valorTotalArrecadacaoCalculado" formatKey="money.format"/></strong>
									</logic:present>
									<logic:notPresent name="valorTotalArrecadacaoCalculado">
										&nbsp;
									</logic:notPresent>	
									</div>
								</td>
								<td width="11%">
									<div align="right">
									<logic:present name="valorTotalDevolucao">
										<strong><bean:write name="valorTotalDevolucao" formatKey="money.format"/></strong>
									</logic:present>
									<logic:notPresent name="valorTotalDevolucao">
										&nbsp;
									</logic:notPresent>
									</div>
								</td>
