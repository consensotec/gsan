...
<%@ page import="gsan.arrecadacao.ArrecadadorContrato"%>
...
function validaIndicadorClienteResponsavel(){
	...
	if(!form.indicadorCobParClienteResponsavel[0].checked && !form.indicadorCobParClienteResponsavel[1].checked){
		msg = msg + 'Indicador de Convênio para Cobrança de Parcelamento de Cliente Responsável  .';
	}
	if( msg != '' ){
		alert(msg);
		return false;
...
function validarMotivoCancelamento(form){
	...
	function IntegerValidations () {
		...
		this.ab = new Array("idCliente", "O campo Cliente deve conter apenas números.", new Function ("varName", " return this[varName];"));
		this.ac = new Array("numeroDiaFloat", "O campo Quantidade de dias FLOAT deve conter apenas números.", new Function ("varName", " return this[varName];"));
	}
	
	function caracteresespeciais() {
		
		this.ad = new Array("numeroDiaFloat", "Quantidade de dias FLOAT deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	}
...
<html:form action="/atualizarContratoArrecadadorAction.do"
	...
	type="gsan.gui.arrecadacao.AtualizarContratoArrecadadorActionForm"
	method="post"
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="25%"><strong>Número Contrato:<font color="#FF0000">*</font></strong></td>
					<td><html:text property="numeroContrato"size="9"  maxlength="10"  tabindex="2"/></td>
				</tr>
				...
				<tr>
					...
					<a href="javascript:pesquisaTipoConta('arrecadacao');"> <img
						...
						title="Pesquisar Depósito Arrecadação" /></a> <a
						href="javascript:limparContaBancaria(document.forms[0],'arrecadacao');">
					<img src="<bean:message key="caminho.imagens"/>limparcampo.gif"
						border="0" title="Limpar Depósito Arrecadação" /></a></td>
				</tr>
				...
				<tr>
					...
					<a href="javascript:pesquisaTipoConta('tarifa');"> <img width="23"
						height="21"
						src="<bean:message key='caminho.imagens'/>pesquisa.gif" border="0"
						title="Pesquisar Depósito Tarifa" /></a> <a
						href="javascript:limparContaBancaria(document.forms[0],'tarifa');">
					<img src="<bean:message key="caminho.imagens"/>limparcampo.gif"
						border="0" title="Limpar Depósito Tarifa" /></a></td>
				</tr>
				...
				<tr>
					...
					<td width="68%"><strong> <span class="style1"><strong> <html:radio
						property="indicadorCobranca" value="1" tabindex="6" /> <strong>Cobrar ISS
					<html:radio property="indicadorCobranca" value="2" tabindex="7" />Não Cobrar ISS
			...
			<tr>
					...
					<td><strong> <html:text property="dtInicioContrato" size="10"
						...
						onclick="javascript:abrirCalendario('AtualizarContratoArrecadadorActionForm', 'dtInicioContrato')" />
					dd/mm/aaaa </td>
				  </tr>
				  ...
				  <tr>
					...
					<td><strong> <html:text property="dtFimContrato" size="10"
						...
						src="<bean:message key="caminho.imagens"/>calendario.gif"
						width="20" border="0" align="absmiddle" alt="Exibir Calendário"
						onclick="javascript:abrirCalendario('AtualizarContratoArrecadadorActionForm', 'dtFimContrato')" />
					dd/mm/aaaa</td>
				</tr>

					<tr>
					<td><strong> Data de Encerramento do Contrato:</strong></td>
					<td><html:text property="dataContratoEncerramento" size="10" maxlength="10"
				...
				<tr>
					<td width="32%" class="style3"><strong>Tamanho Máximo para
					Identificação do Imóvel:<font color="#FF0000">*</font></strong></td>
				...
				<tr>
					<td width="32%"><strong>Indicador de Convênio para Cobrança de Parcelamento de Cliente Responsável :<font color="#FF0000">*</font></strong></td>
					<td width="68%"><strong> <span class="style1"><strong> <html:radio
						property="indicadorCobParClienteResponsavel" value="1" tabindex="6" /> <strong>Sim
						<html:radio property="indicadorCobParClienteResponsavel" value="2" tabindex="7" />Não </strong></strong></span></strong></td>
				</tr>
						...
						<tr>
							...
							<table width="100%" bgcolor="#99CCFF">
								<tr bgcolor="#99CCFF">
									...
									<td width="15%">
										<div align="left"><strong>Número de dias FLOAT</strong></div>
									</td>
								</tr>
							</table>
							</td>
