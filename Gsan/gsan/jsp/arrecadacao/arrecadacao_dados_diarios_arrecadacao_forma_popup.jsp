...
<%@ page import="java.math.BigDecimal,gsan.util.Util" %>
<%@ page import="gsan.arrecadacao.bean.FiltrarDadosDiariosArrecadacaoHelper, gsan.arrecadacao.ArrecadacaoForma" %>
...
<html:form action="/exibirConsultarDadosDiariosArrecadacaoFormaAction.do"
	...
	type="gsan.gui.arrecadacao.FiltrarDadosDiariosArrecadacaoActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Consultar Dados Diários da Arrecadação - Forma de Arrecadação</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					...
					<table width="100%" border="0">
						<%
						BigDecimal valorTotalArrecadador = (BigDecimal)session.getAttribute("valorTotalArrecadador");
						...
						<tr bgcolor="#cbe5fe">
							<td colspan="2" align="left" width="73%">
								<strong>Agente: ${sessionScope.nomeAgente}</strong>
							</td>						
							...
							<td colspan="1" align="right" width="17%">
								<strong>
									<a href="javascript:abrirPopup('exibirConsultarDadosDiariosValoresDiariosAction.do?referencia=<%= referencia%>&idArrecadadorPopup=${sessionScope.idArrecadadorPopup}', 575, 800);">
					...
					<table width="100%" bgcolor="#99CCFF" dwcopytype="CopyTableRow">
						...
						if (cor.equalsIgnoreCase("#cbe5fe")) {
							...
							<td>
							      <div align="right">
							      <font color="#000000" style="font-size:9px;<%=negrito%>" face="Verdana, Arial, Helvetica, sans-serif"> 
							      	<a href="javascript:abrirPopup('exibirConsultarDadosDiariosValoresDiariosAction.do?referencia=<%=referencia %>&idArrecadadorPopup=${sessionScope.idArrecadadorPopup}&idArrecadacaoForma=<%=arrecadacaoForma.getId()%>', 475, 800);">
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioDadosDiariosArrecadacaoFormaAction.do" />
</html:form>
<body>
</html:html>
