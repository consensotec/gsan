...
<%@ page import="gsan.arrecadacao.GuiaDevolucao" isELIgnored="false"%>
<html:html>
...
<link rel="stylesheet"
	...
	type="text/css">
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="ManterDevolucaoActionForm" />
...
function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
    ...
    if (tipoConsulta == 'cliente') {
        ...
        form.action = 'exibirAtualizarDevolucaoAction.do';
        form.submit();
     }
	...
	if (tipoConsulta == 'tipoDebito') { 	
 	...
 	if (tipoConsulta == 'guiaDevolucao') {
 	  ...
 	  form.guiaDevolucaoClone.value = codigoRegistro;
...
function recuperarDadosCincoParametros(codigoRegistro, descricaoRegistro1, descricaoRegistro2, descricaoRegistro3, tipoConsulta) { 
	var form = document.ManterDevolucaoActionForm;
...
function limparForm(tipo){
    ...
    if(tipo == 'guiaDevolucao')
    {
		if (form.guiaDevolucao.disabled == false) {
			...
			var ObjGuiaDevolucaoClone = returnObject(form,"guiaDevolucao");
...
function validarForm(form){
	...
	if(validateManterDevolucaoActionForm(form)){
		if(form.codigoCliente.value.length > 0 && form.localidade.value.length < 1){
		    ...
		    alert("Mês/Ano de Referência da Devolução posterior ao Mês/Ano corrente " + MES_ANO_C + ".");
		    return false;
		}
		...
		{
			form.codigoClienteClone.value = form.codigoCliente.value;
			form.codigoImovelClone.value = form.codigoImovel.value;
			form.localidadeClone.value = form.localidade.value;
			form.tipoDebitoClone.value = form.tipoDebito.value;
			form.referenciaDevolucaoClone.value = form.referenciaDevolucao.value;
			form.guiaDevolucaoClone.value = form.guiaDevolucao.value;
			redirecionarSubmit('/gsan/atualizarDevolucaoAction.do');
		}
	}
}
//-->
...
<html:form action="/exibirAtualizarDevolucaoAction" method="post"
	type="gsan.gui.arrecadacao.ManterDevolucaoActionForm"
	onsubmit="return validateManterDevolucaoActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Devolução</td>
					<td width="11"><img border="0"
			...
			<!-- Início do Corpo - Fernanda Paiva  09/03/2006  -->

			<table width="100%" border="0">
				<tr> 
                	<td height="10">
						<strong>Aviso Banc&aacute;rio:<font color="#FF0000">*</font></strong>
					</td>
                	<td width="403">
					<html:text property="codigoAgenteArrecadador" size="3"
							maxlength="3" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #000000" />
							<html:text property="dataLancamentoAviso" size="10"
							maxlength="10" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #000000" />
							 <html:text property="numeroSequencialAviso" size="3"
							maxlength="3" readonly="true"
							style="background-color:#EFEFEF; border:0; color: #000000" />
							<html:hidden property="avisoBancario" />
					</td>
              	</tr>
              	<tr>
					<td colspan="4">Para atualizar a devolução, informe os dados abaixo:</td>
				</tr>
			</table>
			...
			<table width="100%" border="0">
				<tr>
              	...
              	<tr> 
					<td height="10">
						<strong>Guia de Devolu&ccedil;&atilde;o:</strong>
					</td>
                	<td width="403"> 
                		<html:text tabindex="1" property="guiaDevolucao" maxlength="9" size="9" onkeyup="validaEnterGuiaDevolucao(event, 'exibirAtualizarDevolucaoAction.do', 'guiaDevolucao');" />
						...
						<logic:notPresent name="corGuia">
							<logic:empty name="ManterDevolucaoActionForm"	property="guiaDevolucao">
							...
							<logic:notEmpty name="ManterDevolucaoActionForm" property="guiaDevolucao">
								<html:text property="guiaDevolucaoDescricao" size="37"	readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" />
							</logic:notEmpty>
						</logic:notPresent>
              	...
              	<tr>
                   	...
                   	<html:text maxlength="3" tabindex="2"
							...
							onkeyup="validaEnterLocalidade(event, 'exibirAtualizarDevolucaoAction.do', 'localidade');" />
						...
						<logic:notPresent name="corLocalidade">
							<logic:empty name="ManterDevolucaoActionForm"	property="localidade">
								<html:text property="localidadeDescricao" size="45" value="" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000" />
							</logic:empty>
							<logic:notEmpty name="ManterDevolucaoActionForm" property="localidade">
								<html:text property="localidadeDescricao" size="45"	readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000" />
							</logic:notEmpty>
						</logic:notPresent>
                ...
                <tr>
					...
					<td width="403">
						<html:text property="codigoImovel" maxlength="9"
							size="9" tabindex="3"
							onkeyup="validaEnterImovel(event, 'exibirAtualizarDevolucaoAction.do', 'codigoImovel');" />
						...
						<logic:notPresent name="corImovel">
							<logic:empty name="ManterDevolucaoActionForm"	property="codigoImovel">
								<html:text property="inscricaoImovel" size="25" value="" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000" />
							</logic:empty>
							<logic:notEmpty name="ManterDevolucaoActionForm" property="codigoImovel">
								<html:text property="inscricaoImovel" size="25"	readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000" />
							</logic:notEmpty>
						</logic:notPresent>
				...
				<tr>
					...
					<td width="80%">
						<html:text property="codigoCliente" maxlength="9"
						size="9" tabindex="4"
						onkeyup="return validaEnterCliente(event, 'exibirAtualizarDevolucaoAction.do', 'codigoCliente'); " />
						...
						<logic:notPresent name="corCliente">
							<logic:empty name="ManterDevolucaoActionForm"	property="codigoCliente">
								<html:text property="nomeCliente" size="40" value="" readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000" />
							</logic:empty>
							<logic:notEmpty name="ManterDevolucaoActionForm" property="codigoCliente">
								<html:text property="nomeCliente" size="40"	readonly="true"
									style="background-color:#EFEFEF; border:0; color: #000000" />
							</logic:notEmpty>
						</logic:notPresent>
				...
				<tr>
					<td height="10">
						<strong>Referência da Devolução:</strong>
					</td>
					<td width="403">
						<INPUT TYPE="hidden" ID="DATA_ATUAL" value="${requestScope.dataAtual}"/>
						<html:text property="referenciaDevolucao" maxlength="7" size="7" tabindex="5" onkeyup="mascaraAnoMes(this, event); return validaEnterReferenciaDevolucao(event, 'exibirAtualizarDevolucaoAction.do', 'referenciaDevolucao'); " /> mm/aaaa
					</td>
				</tr>
				<tr>
				  <td><strong>Tipo de Débito:</strong></td>
				  <td width="82%" height="24">
				    <html:text maxlength="9" tabindex="6" property="tipoDebito" size="9" onkeypress="validaEnterComMensagem(event, 'exibirAtualizarDevolucaoAction.do','tipoDebito','Tipo do Débito');"/> 
					...
					<logic:notPresent name="corTipoDebito">
						<logic:empty name="ManterDevolucaoActionForm"	property="tipoDebito">
							<html:text property="descricaoTipoDebito" size="40" value="" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000" />
						</logic:empty>
						<logic:notEmpty name="ManterDevolucaoActionForm" property="tipoDebito">
							<html:text property="descricaoTipoDebito" size="40"	readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000" />
						</logic:notEmpty>
					</logic:notPresent>
				...
				<tr>
              	...
              	<tr>
					...
					<td width="403">
						<html:hidden property="valorGuiaDevolucao" />
						<html:text tabindex="7" property="valorDevolucao" maxlength="13" size="13" onkeyup="formataValorMonetario(this, 11)" style="text-align: right;"/> 
					</td>
				</tr>
				<tr>
					<td  height="10"><strong>Data da Devolu&ccedil;&atilde;o:<font color="#FF0000">*</font></strong></td>
					<td width="403">
						<html:text tabindex="8" property="dataDevolucao" maxlength="10" size="10" onkeyup="mascaraData(this, event);" />
						<a href="javascript:abrirCalendario('ManterDevolucaoActionForm', 'dataDevolucao')">
						<img border="0"
				...
				<tr>
					<td colspan="3">
						<logic:present scope="session" name="manter">
							<input tabindex="9" name="button" type="button" class="bottonRightCol" value="Voltar" onclick="window.location.href='/gsan/exibirManterDevolucaoAction.do'" align="left" style="width: 80px;">	
						</logic:present>
						<logic:notPresent scope="session" name="manter">
							<logic:present scope="session" name="filtrar_manter">
								<input tabindex="9" name="Submit222" type="button" class="bottonRightCol" value="Voltar Filtro" onclick="window.location.href='/gsan/exibirFiltrarDevolucaoAction.do?tela=manterDevolucao'" align="left" style="width: 80px;">
							</logic:present>
							<logic:notPresent scope="session" name="filtrar_manter">
								<input tabindex="9" name="Submit222" type="button" class="bottonRightCol" value="Voltar Filtro" onclick="window.location.href='/gsan/exibirFiltrarDevolucaoAction.do?tela=manterDevolucao&botaoAtualizar=botaoAtualizar'" align="left" style="width: 80px;">
							</logic:notPresent>
						</logic:notPresent>
					
						<input name="Submit22" tabindex="10"
							class="bottonRightCol" value="Desfazer" type="button"
							onclick="window.location.href='/gsan/exibirAtualizarDevolucaoAction.do?idRegistroAtualizacao=<%= session.getAttribute("codigoDevolucao")%>';">	
	                ...
	                <td align="right">
	                	...
	                	<html:hidden property="guiaDevolucaoClone" />
						...
						<gsan:controleAcessoBotao name="Button" value="Atualizar" onclick="javascript:validarForm(document.forms[0]);" url="atualizarDevolucaoAction.do" tabindex="12"/>
	            	    <%-- <input tabindex="12" type="button" name="Button" class="bottonRightCol"	value="Atualizar" onClick="javascript:validarForm(document.forms[0]);" /> --%>
	            	    
	            	  </td>
				</tr>
	
				<!-- Fim do Corpo - Fernanda Paiva 09/03/2006  -->
				</table>
			<p>&nbsp;</p>
			</td>
		</tr>
	...
	<logic:notEqual name="ManterDevolucaoActionForm"
