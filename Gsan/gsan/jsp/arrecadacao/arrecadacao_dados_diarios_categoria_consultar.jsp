...
<%@ page import="java.math.BigDecimal,gsan.util.Util, gsan.cadastro.imovel.Categoria" %>
...
<html:form action="/consultarDadosDiariosArrecadacaoWizardAction" 
	...
	<jsp:include
		page="/jsp/util/wizard/navegacao_abas_wizard_filtro.jsp?numeroPagina=4" />
		    	       ...
		    	       <%} %>
	        	        ...
	        	        <tr bordercolor="#FFFFFF" bgcolor="#90c7fc""> 
		                	...
		                	<font color="#000000" style="font-size:9px"
									face="Verdana, Arial, Helvetica, sans-serif"><strong>Categoria</strong></font></div></td>
						...
						for (FiltrarDadosDiariosArrecadacaoHelper helper : mapDadosDiariosAnoMes.get(itemAnoMes)){
							...
							boolean ehTODOS = categoria.getId().intValue() == -1;
							String negrito = ehTODOS ? "font-weight: bold;" : "";							
							
            		    	BigDecimal valorItemCategoria = helper.getValorArrecadacaoLiquida(); 
			              ...
			              <font color="#000000" style="font-size:9px;<%=negrito%>"
									face="Verdana, Arial, Helvetica, sans-serif">
							<a href="javascript:abrirPopup('exibirConsultarDadosDiariosValoresDiariosAction.do?referencia=<%=itemAnoMes%>&idCategoria=<%=categoria.getId()%>', 475, 800);">
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioDadosDiariosArrecadacaoCategoriaAction.do" />
