...
<%@ page import="java.math.BigDecimal,gsan.util.Util, gsan.arrecadacao.bean.FiltrarDadosDiariosArrecadacaoHelper" %>
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Consultar Dados Diários da Arrecadação - Unidade Negócio</td>
					<td width="11"><img border="0"
					...
					<table width="100%" bgcolor="#99CCFF" dwcopytype="CopyTableRow">
	        	        ...
	        	        <tr bordercolor="#FFFFFF" bgcolor="#90c7fc""> 
		                	...
		                	<div class="style9"><font color="#000000" style="font-size:10px"
		                		...
		                		<strong>Unidade de Negócio</strong></font></div></td>
