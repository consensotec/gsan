...
<html:form action="/filtrarTabelaAuxiliarAction?tela=${requestScope.tela}" method="post">
		...
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td width="50%" align="right"><input type="checkbox" name="atualizar" 
						value="1" checked/><strong>Atualizar</strong></td>
				</tr>
				<tr>
					<td><strong>C&oacute;digo:</strong></td>
					<td><html:text property="id" size="2" maxlength="3"/>
					<font size="1">&nbsp;(somente
					números)</font> <br>
				...
				<tr>
					...
					<td width="60%"><input type"text" name="descricao"
				...
				<tr>
					...
					<td align="right" colspan="2"><input name="Button2" type="button"
