...
<%@ page import="gsan.gui.util.tabelaauxiliar.DadosTelaTabelaAuxiliar" isELIgnored="false" %>
...
<body leftmargin="5" topmargin="5" onload="window.focus();resizePageSemLink(495, 330); setarFoco('${requestScope.nomeCampo}');">
<html:form
  action="/pesquisarTabelaAuxiliarAction"
  method="post"
