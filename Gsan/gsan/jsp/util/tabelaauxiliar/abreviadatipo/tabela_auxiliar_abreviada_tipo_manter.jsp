...
<html:form
  action="/removerTabelaAuxiliarAbreviadaTipoAction?tela=${sessionScope.tela}"
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								<tr bordercolor="#FFFFFF" bgcolor="#79BBFD">
									...
									<td width="26%">
									<div align="center"><strong><bean:write name="descricaoAbreviada" scope="session"/></strong></div>
									</td>
									<td width="33%" align="center"><strong>Sistema de Abastecimento</strong>
									</td>
								</tr>
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<pg:param name="q" />
									<%int cont = 0;%>
									<logic:iterate name="tabelasAuxiliaresAbreviadasTipo" id="tabelasAuxiliaresAbreviadasTipo" scope="session"> 
										<pg:item>
											<%cont = cont + 1;
			if (cont % 2 == 0) {%>
											<tr bgcolor="#cbe5fe">
											...
											<tr bgcolor="#FFFFFF">
												...
												<div align="center"><input type="checkbox"
													...
													value="<bean:write name="tabelasAuxiliaresAbreviadasTipo" property="id" />"></div>
												</td>
												<td width="12%">
												<div align="center"><bean:write name="tabelasAuxiliaresAbreviadasTipo" property="id"/></div>
												</td>

												
												<td width="16%" align="center"><html:link
													href="/gsan/exibirAtualizarTabelaAuxiliarAbreviadaTipoAction.do?tela=${sessionScope.tela}&manter=sim"
													paramId="idRegistroAtualizacao" paramProperty="id"
													paramName="tabelasAuxiliaresAbreviadasTipo">
													<bean:write name="tabelasAuxiliaresAbreviadasTipo" property="descricao"/>
												</html:link></td>
												<td width="26%">
												<div align="center"> <bean:write name="tabelasAuxiliaresAbreviadasTipo" property="descricaoAbreviada"/></div>
												</td>
												<td width="33%" align="center">
												<logic:notEmpty 
														name="tabelasAuxiliaresAbreviadasTipo"
														property="sistemaAbastecimento">
													<bean:write
														name="tabelasAuxiliaresAbreviadasTipo"
														property="sistemaAbastecimento.descricao" />																																						
												</logic:notEmpty>												
												<logic:empty 
														name="tabelasAuxiliaresAbreviadasTipo"												
														property="sistemaAbastecimento">
							...
							<table width="100%" border="0">
								...
								<tr>
									<td><font color="#FF0000"> <html:submit styleClass="bottonRightCol" value="Excluir" property="Button"/></font> <input name="button" type="button"
										...
										onclick="window.location.href='/gsan/exibirFiltrarTabelaAuxiliarAbreviadaTipoAction.do?tela=${sessionScope.tela}'"
