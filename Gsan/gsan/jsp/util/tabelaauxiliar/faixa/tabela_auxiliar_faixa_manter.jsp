...
<%--Incluir esse javascript para validar quando os checkboxes estão vazios--%>
...
<html:form
  action="/removerTabelaAuxiliarFaixaAction"
...
<table width="770" border="0" cellspacing="5" cellpadding="0">
  <tr>
    ...
    <td width="625" valign="top" bgcolor="#003399" class="centercoltext">
      ...
      <table width="100%" border="1" cellpadding="1" cellspacing="0" bordercolor="#000000">
        ...
        <tr bordercolor="#000000">
          ...
          <td width="482" bgcolor="#90c7fc"><strong>Faixa Inicial:</strong></td>
          <td width="482" bgcolor="#90c7fc"><strong>Faixa Final:</strong></td>
        </tr>
	...
	index="center" maxPageItems="10">
      ...
      <logic:iterate name="tabelasAuxiliaresFaixas" id="tabelasAuxiliaresFaixas">
	<pg:item>
        <tr bordercolor="#90c7fc">
          <td>
	    <div align="center">
	      <strong>
                <input type="checkbox" name="idRegistrosRemocao" value="<bean:write name="tabelasAuxiliaresFaixas" property="id"/>"/>
              </strong>
            </div>
          </td>
          <td>
	    <div align="center">
              <strong>
                <bean:write name="tabelasAuxiliaresFaixas" property="id"/>
              </strong>
            </div>
          </td>
          <td>
            <strong>
	      <html:link page="/exibirAtualizarTabelaAuxiliarFaixaAction.do"
			 paramName="tabelasAuxiliaresFaixas"
			 paramProperty="id"
     			 paramId="idRegistroAtualizacao">
		<bean:write name="tabelasAuxiliaresFaixas" property="faixaInicial"/>
	      </html:link>
            </strong>
          </td>
          <td>
            <strong>
		<bean:write name="tabelasAuxiliaresFaixas" property="faixaFinal"/>
            </strong>
          </td>
        </tr>
	</pg:item>
