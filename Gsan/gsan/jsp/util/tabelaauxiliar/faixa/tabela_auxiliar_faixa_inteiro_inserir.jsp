...
<html:form action="/inserirTabelaAuxiliarFaixaInteiroAction?tela=${requestScope.tela}" method="post"
	name="TabelaAuxiliarFaixaInteiroActionForm"
	type="gsan.gui.util.tabelaauxiliar.faixa.TabelaAuxiliarFaixaInteiroActionForm"
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="30%" height="0"><strong>Menor Faixa :<font
						color="#FF0000">*</font></strong></td>
					<td colspan="2"><input type="text" name="menorFaixa"
						size="<bean:write name="tamMaxCampoMenorFaixa" scope="request"/>"
						maxlength="<bean:write name="tamMaxCampoMenorFaixa" scope="request" />"
						></td>
				</tr>
				<tr>
					<td width="30%" height="0"><strong>Maior Faixa :<font
						color="#FF0000">*</font></strong></td>
					<td colspan="2"><input type="text" name="maiorFaixa"
						size="<bean:write name="tamMaxCampoMaiorFaixa" scope="request"/>"
						maxlength="<bean:write name="tamMaxCampoMaiorFaixa" scope="request" />"
						></td>
				</tr>
				<tr>
				<tr>
