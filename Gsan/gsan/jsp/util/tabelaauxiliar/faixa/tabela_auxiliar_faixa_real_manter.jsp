...
<html:form
  action="/removerTabelaAuxiliarFaixaRealAction?tela=${requestScope.tela}"
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								<tr bordercolor="#FFFFFF" bgcolor="#79BBFD">
									...
									<td width="29%">
									<div align="center"><strong>Volume Menor Faixa</strong></div>
									</td>
									<td width="30%">
									<div align="center"><strong>Volume Maior Faixa</strong></div>
									</td>
									<td width="30%">
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<pg:param name="q" />
									<%int cont = 0;%>
									<logic:iterate name="tabelasAuxiliaresFaixaReais" id="tabelasAuxiliaresFaixaReais" scope="session"> 
										<pg:item>
											<%cont = cont + 1;
			if (cont % 2 == 0) {%>
											<tr bgcolor="#FFFFFF">
											...
											<tr bgcolor="#cbe5fe">
												...
												<div align="center"><input type="checkbox"
													...
													value="<bean:write name="tabelasAuxiliaresFaixaReais" property="id" />"></div>
												</td>
												<td width="12%">
												<div align="center"><html:link
													href="/gsan/exibirAtualizarTabelaAuxiliarFaixaRealAction.do?tela=${requestScope.tela}&manter=sim"
													paramId="idRegistroAtualizacao" paramProperty="id"
													paramName="tabelasAuxiliaresFaixaReais"><bean:write name="tabelasAuxiliaresFaixaReais" property="id"/></div>
												</html:link>
												</td>

												
												<td width="16%" align="center">
													<bean:write name="tabelasAuxiliaresFaixaReais" property="volumeMenorFaixa" formatKey="money.format"/>
												</td>
												<td width="29%">
												<div align="center"> <bean:write name="tabelasAuxiliaresFaixaReais" property="volumeMaiorFaixa" formatKey="money.format"/></div>
												</td>

												<td width="30%" align="center"><logic:equal
													name="tabelasAuxiliaresFaixaReais" property="indicadorUso"
													value="1">
											SIM
											</logic:equal> <logic:equal name="tabelasAuxiliaresFaixaReais"
							...
							<table width="100%" border="0">
								...
								<tr>
									<td><font color="#FF0000"> <html:submit styleClass="bottonRightCol" value="Excluir" property="Button"/></font> <input name="button" type="button"
										...
										onclick="window.location.href='<html:rewrite page="/exibirFiltrarTabelaAuxiliarFaixaRealAction.do?tela=${requestScope.tela}&limpar=S"/>'"
