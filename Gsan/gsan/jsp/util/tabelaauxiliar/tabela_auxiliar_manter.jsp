...
<script language="JavaScript">
	...
	function Confirmacao() {
    	...
    	if (CheckboxNaoVazio(document.ManutencaoRegistroActionForm.idRegistrosRemocao) && 
    		confirm('Deseja realmente remover o(s) registo(s) de <%=((String) session.getAttribute("titulo")).toLowerCase()%> ')) {
      		return true;
      	}else{
      		return false;
      	}
...
<html:form
  action="/removerTabelaAuxiliarAction?tela=${sessionScope.tela}"
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<pg:param name="q" />
									<%int cont = 0;%>
									<logic:iterate name="tabelasAuxiliares" id="tabelasAuxiliares" scope="session"> 
										<pg:item>
											<%cont = cont + 1;
			if (cont % 2 == 0) {%>
											<tr bgcolor="#cbe5fe">
											...
											<tr bgcolor="#FFFFFF">
												...
												<div align="center"><input type="checkbox"
													...
													value="<bean:write name="tabelasAuxiliares" property="id" />"></div>
												</td>
												<td width="12%">
												<div align="center"><bean:write name="tabelasAuxiliares" property="id"/></div>
												</td>
												
												<td width="16%" align="center"><html:link
													href="/gsan/exibirAtualizarTabelaAuxiliarAction.do?tela=${sessionScope.tela}&manter=sim"
							...
							<table width="100%" border="0">
								...
								<tr>
									<td><font color="#FF0000"> <html:submit styleClass="bottonRightCol" value="Remover" property="Button"/></font> <input name="button" type="button"
