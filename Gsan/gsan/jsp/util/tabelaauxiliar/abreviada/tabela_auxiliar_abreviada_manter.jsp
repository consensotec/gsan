...
<html:form
  action="/removerTabelaAuxiliarAbreviadaAction?tela=${sessionScope.tela}"
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								<tr bordercolor="#FFFFFF" bgcolor="#79BBFD">
									...
									<td width="29%">
									<div align="center"><strong><bean:write name="descricao" scope="session"/></strong></div>
									</td>
									<td width="30%">
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<pg:param name="q" />
									<%int cont = 0;%>
									<logic:iterate name="tabelasAuxiliaresAbreviadas" id="tabelasAuxiliaresAbreviadas" scope="session"> 
										<pg:item>
											<%cont = cont + 1;
			if (cont % 2 == 0) {%>
											<tr bgcolor="#cbe5fe">
											...
											<tr bgcolor="#FFFFFF">
												...
												<div align="center"><input type="checkbox"
													...
													value="<bean:write name="tabelasAuxiliaresAbreviadas" property="id" />"></div>
												</td>
												<td width="12%">
												<div align="center"><bean:write name="tabelasAuxiliaresAbreviadas" property="id"/></div>
												</td>

												
												<td width="16%" align="center"><html:link
													href="/gsan/exibirAtualizarTabelaAuxiliarAbreviadaAction.do?tela=${sessionScope.tela}&manter=sim"
													paramId="idRegistroAtualizacao" paramProperty="id"
													paramName="tabelasAuxiliaresAbreviadas">
													<bean:write name="tabelasAuxiliaresAbreviadas" property="descricao"/>
												</html:link></td>
												<td width="29%">
												<div align="center"> <bean:write name="tabelasAuxiliaresAbreviadas" property="descricaoAbreviada"/></div>
												</td>
							...
							<table width="100%" border="0">
								...
								<tr>
									<td><font color="#FF0000"> <html:submit styleClass="bottonRightCol" value="Excluir" property="Button"/></font> <input name="button" type="button"
										...
										onclick="window.location.href='/gsan/exibirFiltrarTabelaAuxiliarAbreviadaAction.do?tela=${requestScope.tela}'"
