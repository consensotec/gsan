...
<%@ page isELIgnored="false"
	import="java.util.Collection,gsan.util.ConstantesSistema"%>
<html:html>
<head>
					...
					<logic:iterate name="colecaoTabelaAuxiliarAbreviada"
						...
						<pg:item>
							...
							<%}%>
								...
								<c:if test="${sessionScope.dados.nomeParametroFuncionalidade == 'banco'}" var="testeTipoPesquisa">
								<td align="center">
								...
								<td align="center">									
										<bean:write name="tabelaAuxiliarAbreviada" property="descricao" />
								</td>
								</c:if>
