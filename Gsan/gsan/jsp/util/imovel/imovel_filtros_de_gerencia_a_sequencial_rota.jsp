...
<%@page import="gsan.util.ConstantesInterfaceGSAN"%><script>
...
<tr>
	...
	<td>
		...
		<a href="javascript:chamarPesquisaLocalidadeInicial();"><img width="23" height="21" border="0" 
				src='<gsan:i18n key="caminho.imagens"/>pesquisa.gif' title='<gsan:i18n key="<%=ConstantesInterfaceGSAN.HINT_GSAN_PESQUISAR%>"/>'/></a> 
...
<tr>
	...
	<td>
		...
		<a href="javascript:chamarPesquisaSetorComercialInicial();"><img width="23" height="21" border="0" style="cursor:hand;"
				src="<gsan:i18n key="caminho.imagens"/>pesquisa.gif"
				title='<gsan:i18n key="<%=ConstantesInterfaceGSAN.HINT_GSAN_PESQUISAR%>"/>'/></a>
		...
		<a href="javascript:limparSetorComercialInicial();limparSetorComercialFinal();bloquearCampos();"><img src="<gsan:i18n key="caminho.imagens"/>limparcampo.gif"
				border="0" title='<gsan:i18n key="<%=ConstantesInterfaceGSAN.HINT_GSAN_APAGAR%>"/>' />
		</a>
	</td>
</tr>
...
<tr>
	...
	<td>
		...
		<a href="javascript:chamarPesquisaLocalidadeFinal();"><img border="0" src="imagens/pesquisa.gif" height="21" width="23" title='<gsan:i18n key="<%=ConstantesInterfaceGSAN.HINT_GSAN_PESQUISAR%>"/>'></a>
...
<tr>
	...
	<td>
		...
		<a href="javascript:chamarPesquisaSetorComercialFinal();"><img width="23" height="21" border="0" 
				src="<gsan:i18n key="caminho.imagens"/>pesquisa.gif"
					title="<gsan:i18n key="<%=ConstantesInterfaceGSAN.HINT_GSAN_PESQUISAR%>"/>" /></a>
