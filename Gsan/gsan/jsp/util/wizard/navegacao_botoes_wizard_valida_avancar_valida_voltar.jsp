...
<%@ page import="gsan.gui.*" isELIgnored="false"%>
	...
	<tr>
		<logic:greaterThan name="numeroPagina" value="1">
        	<td width="50%" align="right">
				<a href="javascript:botaoAvancar('/gsan/<bean:write name="statusWizard" 
			...
			<td width="10%">
				<input name="voltar" type="button" class="buttonAbaRodape" value="Voltar" style="width: 80px"
					onClick="javascript:botaoAvancar('/gsan/<bean:write name="statusWizard" property="caminhoActionPrincipalWizard"/>.do?destino=<bean:write name="numeroPaginaAnterior"/>&action=<bean:write name="itemWizard" property="caminhoActionFinal"/>');"/>
			</td>
		</logic:greaterThan>
