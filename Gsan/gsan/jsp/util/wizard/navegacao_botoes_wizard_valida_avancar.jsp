...
<%@ page import="gsan.gui.*,java.util.*" isELIgnored="false"%>
	...
	<tr>
		<td colspan="8" align="left" width="80%">
			<logic:notEmpty name="statusWizard" property="caminhoActionVoltarFiltro">
				<input name="Voltar Filtro" id="botaoVoltar" type="button" class="bottonRightCol" value="Voltar" style="width: 80px"
			...
			<logic:present name="statusWizard" property="caminhoActionDesfazerInserir">
				<input name="desfazer" id="botaoDesfazer" type="button" class="bottonRightCol" value="Desfazer" style="width: 80px"
			...
			<input name="cancelar" id="botaoCancelar" type="button" class="bottonRightCol" value="Cancelar" style="width: 80px"
				onClick="javascript:window.location.href='/gsan/telaPrincipal.do'" />
		</td>
		<td align="right" width="*">
			<logic:equal name="statusWizard" property="botaoConcluirDesabilitado" value="sim">
				<logic:present name="statusWizard" property="nomeBotaoConcluir">
				<input name="concluir" id="botaoConcluir" type="button" class="bottonRightCol" style="width: 80px" value="<bean:write name="statusWizard" property="nomeBotaoConcluir"/>"
					disabled="disabled" />
				</logic:present>
				<logic:notPresent name="statusWizard" property="nomeBotaoConcluir">
				<input name="concluir" id="botaoConcluir" type="button" class="bottonRightCol" style="width: 80px" value="Concluir"
					disabled="disabled" />
				</logic:notPresent>
			</logic:equal>
			<logic:notEqual name="statusWizard" property="botaoConcluirDesabilitado" value="sim">
				<logic:present name="statusWizard" property="nomeBotaoConcluir">
				<input name="concluir" id="botaoConcluir" type="button" class="bottonRightCol" style="width: 80px" value="<bean:write name="statusWizard" property="nomeBotaoConcluir"/>"
