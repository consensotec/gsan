	...
	<tr>
		...
		<logic:iterate name="statusWizard"
			...
			<td valign="top"><logic:notEqual name="itemWizard"
				...
				<a
					href="javascript:redirecionarSubmit('/gsan/<bean:write name="statusWizard" property="caminhoActionPrincipalWizard"/>.do?destino=<%=contador%>&action=<bean:write name="itemWizard" property="value.caminhoActionInicial"/>');">
