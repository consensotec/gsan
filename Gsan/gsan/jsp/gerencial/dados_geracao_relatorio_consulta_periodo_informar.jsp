...
<%@ page import="gsan.cadastro.localidade.GerenciaRegional" %>
...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="InformarDadosGeracaoRelatorioConsultaPeriodoActionForm"/>

<script language="JavaScript">

function validarForm(form){
	if (validateInformarDadosGeracaoRelatorioConsultaPeriodoActionForm(form)){

		if(validarPeriodoInicial(form) && validarPeriodoFinal(form)){
...
function validateInformarDadosGeracaoRelatorioConsultaPeriodoActionForm(form){
	var retorno = true;
	if(form.mesAnoInicialFaturamento.value == "" || form.mesAnoFinalFaturamento.value == ""){
		alert("Informe período de faturamento.");
		retorno = false;
	}else if(form.opcaoTotalizacao.value == ""){
...
function validarPeriodoInicial(form){
	var retorno = true;

	retorno = verificaAnoMes(form.mesAnoInicialFaturamento);

	return retorno;
}

function validarPeriodoFinal(form){
	var retorno = true;

	retorno = verificaAnoMes(form.mesAnoFinalFaturamento);
...
function receberRota(codigoRota,descricao, codigo,destino) {
	  ...
	  form.action = 'exibirInformarDadosGeracaoRelatorioConsultaPeriodoAction.do?menu=sim&analiseFaturamento=ok&tipoResumo=ANALISE&id=464';
	  form.submit();
}
...
function replicaMesAno(){
	...
	form.mesAnoFinalFaturamento.value = form.mesAnoInicialFaturamento.value;
}
...
<html:form action="/informarDadosGeracaoRelatorioConsultaPeriodoAction" method="post">
...
<table width="770" border="0" cellspacing="5" cellpadding="0">
  <tr>
	...
	<td width="625" valign="top" class="centercoltext">
	  ...
	  <tr>
      	<td HEIGHT="30"><strong>Período de Referência:<font color="#FF0000">*</font></strong></td>
        <td>
			<html:text property="mesAnoInicialFaturamento" size="8" maxlength="7" tabindex="1" onkeyup="mascaraAnoMes(this, event);somente_numero(this);replicaMesAno();" onchange="replicaMesAno();" onkeypress="replicaMesAno();"/>&nbsp;&nbsp;A&nbsp;&nbsp;
			<html:text property="mesAnoFinalFaturamento"   size="8" maxlength="7" tabindex="1" onkeyup="mascaraAnoMes(this, event);somente_numero(this);"/>&nbsp;&nbsp;(MM/AAAA)
		</td>
      </tr>
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="localidade" size="4" maxlength="3" tabindex="6" onkeypress="validaEnterComMensagem(event, 'exibirInformarDadosGeracaoRelatorioConsultaPeriodoAction.do?pesquisarLocalidade=OK', 'localidade', 'Localidade');"/>
			...
			<logic:notPresent name="corLocalidade">
				...
				<logic:empty name="InformarDadosGeracaoRelatorioConsultaPeriodoActionForm" property="localidade">
					<html:text property="descricaoLocalidade" value="" size="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000"/>
				</logic:empty>
				<logic:notEmpty name="InformarDadosGeracaoRelatorioConsultaPeriodoActionForm" property="localidade">
					<html:text property="descricaoLocalidade" size="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
				</logic:notEmpty>
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="municipio" size="4" maxlength="4" tabindex="6" onkeypress="validaEnterComMensagem(event, 'exibirInformarDadosGeracaoRelatorioConsultaPeriodoAction.do?pesquisarMunicipio=OK', 'municipio', 'Município');"/>
			...
			<logic:notPresent name="corMunicipio">
				...
				<logic:empty name="InformarDadosGeracaoRelatorioConsultaPeriodoActionForm" property="municipio">
					<html:text property="descricaoMunicipio" value="" size="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000"/>
				</logic:empty>
				<logic:notEmpty name="InformarDadosGeracaoRelatorioConsultaPeriodoActionForm" property="municipio">
					<html:text property="descricaoMunicipio" size="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
				</logic:notEmpty>
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="setorComercial" size="4" maxlength="3" tabindex="7" onkeypress="validaEnterDependenciaComMensagem(event, 'exibirInformarDadosGeracaoRelatorioConsultaPeriodoAction.do?pesquisarSetorComercial=OK', this, document.forms[0].localidade.value, 'Localidade', 'Setor Comercial');"/>
			...
			<logic:notPresent name="corSetorComercial">
				...
				<logic:empty name="InformarDadosGeracaoRelatorioConsultaPeriodoActionForm" property="setorComercial">
				...
				<logic:notEmpty name="InformarDadosGeracaoRelatorioConsultaPeriodoActionForm" property="setorComercial">
					<html:text property="descricaoSetorComercial" size="45" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000"/>
				</logic:notEmpty>
      ...
      <tr>
        ...
        <td width="432">
        	...
        	<html:text property="quadra" size="4" maxlength="4" tabindex="8" onkeypress="validaEnterDependenciaComMensagem(event, 'exibirInformarDadosGeracaoRelatorioConsultaPeriodoAction.do?pesquisarQuadra=OK', this, document.forms[0].setorComercial.value, 'Setor Comercial', 'Quadra');"/>
      ...
      <tr>
      	<td align="left"><INPUT type="button" onclick="window.location.href='exibirInformarDadosGeracaoRelatorioConsultaPeriodoAction.do?limparForm=OK'" style="width: 70px;" name="botaoLimpar" class="bottonRightCol" value="Limpar" tabindex="15"></td>
...
<!--<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=informarDadosGeracaoRelatorioConsultaPeriodoAction.do&left=555&top=570"/>--> 
