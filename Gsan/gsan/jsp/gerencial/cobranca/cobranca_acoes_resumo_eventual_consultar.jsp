...
<%@ page import="gsan.cobranca.CobrancaAcao" %>
<%@ page import="gsan.cobranca.CobrancaDebitoSituacao" %>
<%@ page import="gsan.cobranca.CobrancaAcaoSituacao" %>
...
<%@ page import="gsan.gerencial.bean.CobrancaAcaoDebitoHelper,gsan.gerencial.bean.CobrancaAcaoSituacaoHelper"%>
<%@ page import="gsan.gerencial.bean.CobrancaAcaoHelper, gsan.cobranca.CobrancaAcao, gsan.cobranca.CobrancaAcaoSituacao"%>
...
<html:form action="/consultarResumoAcaoCobrancaEventualWizardAction" 
	...
	type="gsan.gui.gerencial.cobranca.ResumoAcaoCobrancaActionForm"
	method="post">
					...
					<tr>
					  <td>
					    <table width="100%" bgcolor="#90c7fc">
						  ...
						  <tr>
						    <td rowspan="2" bgcolor="#cbe5fe" width="32%">
							  ...
							  %>							  
							  &nbsp;&nbsp;
							  <a href="javascript:abrirPopup('exibirConsultarResumoAcaoCobrancaSituacaoAcaoDetalhesPopupAction.do?tipoDetalhe=eF&idCobrancaAcao=<bean:write name="resumoAcaoCobranca" property="id"/>&idCobrancaAcaoSituacao=<bean:write name="cobrancaAcaoSituacao" property="id"/>
								  							&cobrancaAcaoSituacao=<bean:write name="cobrancaAcaoSituacao" property="descricao"/>
							 ...
							 %>
							  &nbsp;&nbsp;
							  <a href="javascript:abrirPopup('exibirConsultarResumoAcaoCobrancaSituacaoAcaoDetalhesPopupAction.do?tipoDetalhe=eE&idCobrancaAcao=<bean:write name="resumoAcaoCobranca" property="id"/>&idCobrancaAcaoSituacao=<bean:write name="cobrancaAcaoSituacao" property="id"/>
								  							&cobrancaAcaoSituacao=<bean:write name="cobrancaAcaoSituacao" property="descricao"/>
						...
						<tr>
				          <td align="right">
						  <div align="right">						  
						  <a href="gerarRelatorioResumoAcoesCobrancaEventuaisAction.do?id=<bean:write name="resumoAcaoCobranca" property="id"/>">
							<img border="0"
								src="<bean:message key="caminho.imagens"/>print.gif"
								title="Imprimir Pagamentos" /> 
						  </a>
						  </div>
						  </td>
					    </tr>
