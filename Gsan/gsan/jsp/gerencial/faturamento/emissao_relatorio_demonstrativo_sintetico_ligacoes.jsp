...
<html:form action="/gerarRelatorioDemonstrativoSinteticoLigacoesAction.do"
	...
	type="gsan.gui.relatorio.gerencial.faturamento.ExibirEmissaoRelatorioDemonstrativoSinteticoLigacoesActionForm"
	method="post">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Relat&oacute;rio Demonstrativo Sintético das Ligações</td>
					<td width="11"><img border="0"
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="municipio" 
							size="3"
							onkeypress="validaEnterComMensagem(event, 'exibirEmissaoRelatorioDemonstrativoSinteticoLigacoesAction.do?objetoConsulta=3','municipio','Município');
							            return isCampoNumerico(event);"/>
