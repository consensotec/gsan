...
<%@ page import="gsan.micromedicao.ResumoAnormalidadeLeitura"%>
...
function abrirPopupDetalhe(tipo){
	abrirPopup('exibirResumoAnaliseFaturamentoPeriodoDetalheAction.do?tipo='+tipo,470,532);
}
</script>-->
...
<div id="formDiv"><html:form action="/resultadoResumoAnaliseFaturamentoPeriodoAction"
		name="ResumoAnaliseFaturamentoActionForm"
		type="gsan.gui.gerencial.faturamento.ResumoAnaliseFaturamentoActionForm"
		method="post">
		...
		<table width="770" border="0" cellspacing="5" cellpadding="0">
			<tr>
				...
				<!-- include com a tabela Dados da Geração da Consulta --> <%@ include
					file="/jsp/gerencial/tabela_dados_geracao_consulta_periodo.jsp"%> 
				                    	...
				                    	<table width="100%" border="0">
					                        ...
					                        <tr>
					                            <td height="10" colspan="2"><strong>D&eacute;bitos Cobrados: </strong></td>
				                          		<td>
				                          			<strong>
					                          			<input name="valorDebitos" type="text" readonly="readonly" style="background-color:#EFEFEF;  border:0; text-align:right; color: #000000; " value="<bean:write name="ResumoAnaliseFaturamentoActionForm" property="valorDebitos" />" size="15">
					                          		</strong>
				                            	</td>
					                        </tr>
					                        <tr>
					                        	<td height="10" colspan="2"><strong>Cr&eacute;ditos Realizados: </strong></td>
				                          		<td>
				                          			<strong>
				                          				<input name="valorCreditos" type="text" readonly="readonly" style="background-color:#EFEFEF; border:0; text-align:right; color: #000000; " value="<bean:write name="ResumoAnaliseFaturamentoActionForm" property="valorCreditos" />" size="15">
					                          		</strong>
			                          			</td> 
					                        </tr>
					                        <tr>
						                        ...
						                        <td>
							                        <strong>
							                            <input name="valorImpostos" type="text"  disabled style="background-color:#EFEFEF; border:0; text-align:right; color: #000000;" value="<bean:write name="ResumoAnaliseFaturamentoActionForm" property="valorImpostos"  />" size="15" maxlength="15">
						                           </strong>
				                          		</td>
					                        </tr>
					                        <tr>
						                        ...
						                        <td>
							                        <strong>
							                            <input name="valorTotal" type="text"  disabled style="background-color:#EFEFEF; border:0; text-align:right; color: #000000;" value="<bean:write name="ResumoAnaliseFaturamentoActionForm" property="valorTotal"  />" size="15" maxlength="15">
						                           </strong>
				                          		</td>
					                        </tr>                   
					                    </table>
	            ...
	            <p>
	              <table>
	                 <tr>
	                 	<td>
	                 		<input name="button" type="button" class="bottonRightCol" value="Voltar" onclick="window.location.href='<html:rewrite page="/exibirInformarDadosGeracaoRelatorioConsultaPeriodoAction.do"/>'" align="left" style="width: 80px;">
	                 	</td>
		...
		<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio_tela_espera.jsp?relatorio=gerarRelatorioAnaliseFaturamentoPeriodoAction.do"/>
