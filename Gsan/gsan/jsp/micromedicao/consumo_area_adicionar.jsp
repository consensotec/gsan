...
<html:javascript staticJavascript="false"
	formName="AdicionarConsumoAreaActionForm" />
...
<script language="JavaScript">
	...
	if(testarCampoValorZero(document.AdicionarConsumoAreaActionForm.numeroArea, 'Número da Área')
	&& testarCampoValorZero(document.AdicionarConsumoAreaActionForm.numeroConsumo, 'Número do Consumo')) {

			if(validateAdicionarConsumoAreaActionForm(form)){
			form.action = 'adicionarConsumoAreaAction.do?adicionar=sim';
        	form.submit()
			}
		}
	}
	...
	&& testarCampoValorZero(document.AdicionarConsumoAreaActionForm.numeroConsumo, 'Número do Consumo')) {
			...
			if(validateAdicionarConsumoAreaActionForm(form)){
			form.action = 'adicionarConsumoAreaAction.do?atualizar=sim';
        	form.submit()
			}
		}
	}
	...
	function chamarReload(){
		...
		chamarSubmitComUrlSemUpperCase('/gsan/exibirInformarConsumoAreaAction.do');
	}
...
<html:form action="/adicionarConsumoAreaAction"
	name="AdicionarConsumoAreaActionForm"
	type="gsan.gui.faturamento.AdicionarConsumoAreaActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Adicionar consumo e área</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="2"><html:text property="categoria" size="15"
						maxlength="15" style="background-color:#EFEFEF; border:0;"
						readonly="true" />
				</tr>
				<tr>
					<td><strong>Subcategoria:<font color="#FF0000">*</font></strong></td>
					<td colspan="2"><html:text property="subCategoria" size="45"
						maxlength="40" style="background-color:#EFEFEF; border:0;"
						readonly="true" />
				</tr>

				<tr>
					<td><strong>Número da Área Máxima:<font color="#FF0000">*</font></strong></td>
					<td colspan="2"><html:text property="numeroArea" size="8"
