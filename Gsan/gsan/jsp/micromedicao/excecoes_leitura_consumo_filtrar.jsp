...
function limparPesquisaSetorComercialSemFocus() {
 ...
 function limparForm(){
	...
	form.idGerenciaFiltro.value = "-1";
	form.idUnidadeFiltro.value = "-1";
 }
...
<html:form name="LeituraConsumoActionForm"
	type="gsan.gui.micromedicao.LeituraConsumoActionForm"
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><html:select property="idGerenciaFiltro"  tabindex="5" onchange="reloadForm();">
						<html:option value="-1">&nbsp;</html:option>
				...
				<tr>
					...
					<td><html:select property="idUnidadeFiltro" tabindex="6">
						<html:option value="-1">&nbsp;</html:option>
					...
					<td><html:select property="idUnidadeFiltro" tabindex="6" disabled="true">
						<html:option value="-1">&nbsp;</html:option>
						<html:options collection="colecaoUnidadeNegocio"
							labelProperty="nome" property="id" />
					</html:select></td>
