...
<html:javascript staticJavascript="false"
	formName="FiltrarLocalArmazenagemHidrometroActionForm" dynamicJavascript="true" />
<script language="JavaScript"
...
<script language="JavaScript">
	...
	function validarForm(formulario){	
			if(validateFiltrarLocalArmazenagemHidrometroActionForm(formulario)){    		
	...
	function limparForm() {
		var form = document.AtualizarLocalArmazenagemHidrometroActionForm;
		form.codigo.value = "";
...
<html:form action="/filtrarLocalArmazenagemHidrometroAction"
	name="FiltrarLocalArmazenagemHidrometroActionForm"
	type="gsan.gui.micromedicao.FiltrarLocalArmazenagemHidrometroActionForm"
	method="post"
	onsubmit="return validateFiltrarLocalArmazenagemHidrometroActionForm(this);">
	...
	<!--Início Tabela Reference a Páginação da Tela de Processo-->
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<td class="parabg">Filtrar Local de Armazenagem do Hidrômetro</td>
				...
				<tr>
						...
						<td colspan="2">Para filtrar o(s) local(is) de armazenagem do(s) hidrômetro(s), informe o dado abaixo:</td>
				...
				<tr>
					...
					<td colspan="2"><span class="style2"> <html:text
						property="descricao" size="45" maxlength="45" /> </span></td>
			   		<td width="15%">&nbsp;</td>
			   </tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr>
					...
					<td><html:radio property="indicadorOficina" tabindex="5" value="1" /><strong>Sim</strong>
					<html:radio property="indicadorOficina" tabindex="7" value="2" /><strong>Não</strong>
					<html:radio property="indicadorOficina" tabindex="8" value="" /><strong>Todos</strong>
					</td>
				</tr>				
				...
				<tr>
					<td><input name="Button" type="button" class="bottonRightCol"
						...
						onclick="window.location.href='/gsan/exibirFiltrarLocalArmazenagemHidrometroAction.do?menu=sim'"
						tabindex="8"></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
