	                         ...
	                         <% if (indexQuadra++ % 2 == 0) { %>
			                  ...
			                  <% } %>
		                        <td bordercolor="#90c7fc"><div align="center">
		                        	<html:checkbox title="${quadra.numeroQuadra}" property="idQuadraAdicionar" value="${quadra.id}" disabled="<%=((gsan.cadastro.localidade.Quadra) quadra).getRoteiroEmpresa() != null ? true : false %>">
		                        	</html:checkbox>
		                        </td>
