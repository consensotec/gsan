...
<html:html>
	...
	<body leftmargin="0" topmargin="0">
		<html:form action="/desfazerVinculoPopupAction.do"
				   ...
				   type="gsan.gui.micromedicao.DesfazerVinculoPopupActionForm"
				   method="post">
											...
											<logic:iterate name="colecaoImoveisVinculados" id="clienteimovel">
												...
												<td width="20%">
													<div align="center" style="<%=styleColor %>">
														<bean:define name="clienteimovel" property="imovel" id="imovel" />
														<%=((gsan.cadastro.imovel.Imovel) imovel).getInscricaoFormatada()%>
													</div>
												</td>
												<td width="21%">
												...
												<td width="45%">
													<div align="left" style="<%=styleColor %>">
														<bean:define name="clienteimovel" property="imovel" id="imovel" />
														<%=((gsan.cadastro.imovel.Imovel) imovel).getEnderecoFormatado()%>
													</div>
												</td>
											</logic:iterate>
										</table>
