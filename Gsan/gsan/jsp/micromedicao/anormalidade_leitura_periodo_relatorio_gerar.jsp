...
<%@page import="gsan.util.ConstantesInterfaceGSAN"%><html:html>
...
<html:form action="/gerarRelatorioAnormalidadeLeituraPeriodoAction.do"
	...
	type="gsan.gui.micromedicao.GerarRelatorioAnormalidadeLeituraPeriodoActionForm"
	method="post">
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="200">
						<strong>Anormalidade de Leitura Faturada:<font color="#FF0000">*</font></strong>
					</td>
					<td colspan="3"><html:select property="anormalidadeLeituraFaturada" multiple="true">
						<logic:notEmpty name="colecaoAnormalidadesLeitura">
							<html:option value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
							<html:options collection="colecaoAnormalidadesLeitura" labelProperty="descricao" property="id" />
						</logic:notEmpty>
				...
				<tr>
					<td><strong>Ordenação:<font color="#FF0000">*</font></strong></td>
					<td>
						<html:radio property="ordenacao" value="1"><strong>Rota</strong></html:radio>
						<html:radio property="ordenacao" value="2"><strong>Inscrição</strong></html:radio>
					</td>
				</tr>
