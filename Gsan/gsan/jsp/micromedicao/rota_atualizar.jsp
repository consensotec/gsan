...
<script language="JavaScript">
	...
	function pesquisarLeiturista(){
	  ...
	  if ( form.empresaLeituristica.value == '-1' ){
	    ...
	    abrirPopup('pesquisarLeituristaAction.do?empresa=' + form.empresaLeituristica.value, 200, 400 );
	  }
	}	
   ...
   function validarIndicadorTrasmissaoOffline(){
		...
		if(selecionado == ''){
			alert('Informe se a Transmissao é Off-line.');
			indicadorTransmissaoOffline.focus();
		}	
	}
   ...
   function validarIndicadorGerarFiscalizacao(){
	...
	function verificarindicadorAjusteConsumo(){
	
		var form = document.forms[0];
		if(!form.indicadorAjusteConsumo[0].checked && !form.indicadorAjusteConsumo[1].checked){
			alert("Informe o Indicador de Ajuste de Consumo.");
			form.indicadorAjusteConsumo.focus();
		}
	...
	function validarLimiteImoveisRota(){
		...
		if(form.numeroLimiteImoveis.value != "" && (form.leituraTipo.value != '3' && form.leituraTipo.value != '6' && form.leituraTipo.value != '10')){
	...
	function verificarindicadorSequencialLeitura(){
		
		var form = document.forms[0];
		if(!form.indicadorSequencialLeitura[0].checked && !form.indicadorSequencialLeitura[1].checked){
			alert("Informe o Indicador de Sequencial de leitura.");
			form.indicadorSequencialLeitura.focus();
		}
...
<html:form action="/atualizarRotaAction" name="InserirRotaActionForm"
	type="gsan.gui.micromedicao.InserirRotaActionForm" method="post"
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<logic:present scope="application" name="urlHelp">
									<td align="right"><a href="javascript:abrirPopupHelp('${applicationScope.urlHelp}cadastroRotaAtualizar', 500, 700);"><span style="font-weight: bold"><font color="#3165CE">Ajuda</font></span></a></td>									
					</logic:present>
...
<table width="100%" border="0">
				...
				<tr>
					...
					<td height="24"><html:text maxlength="3"
						...
						onkeypress="javascript:limparDescSetorComercial(document.InserirRotaActionForm);
						            validaEnterDependenciaComMensagem(event, 'exibirAtualizarRotaAction.do?reloadPage=1', this, document.forms[0].idLocalidade.value, 'Localidade','Setor Comercial');
						            return isCampoNumerico(event);" />
				...
				<tr>
					<td><strong>Empresa de Cobrança:<font color="#FF0000">*</font></strong></td>
...
-->
				...
				<tr>
					<td><strong>Indicador Armazenar Coordenadas:<font color="#FF0000">*</font></strong></td>
					<td><strong> <span class="style1"> <html:radio
						property="indicadorArmazenarCoordenadas" value="<%=ConstantesSistema.SIM.toString()%>"
						tabindex="13" /> Sim <html:radio
						property="indicadorArmazenarCoordenadas" value="<%=ConstantesSistema.NAO.toString()%>"/>
					Não </span></strong></td>
				</tr>
				...
				<tr>
					...
					<td colspan="2"><html:text maxlength="6" property="idLeiturista"
						tabindex="17" size="6"
						onkeypress="javascript:validaEnterComMensagem(event, 'exibirAtualizarRotaAction.do?reloadPage=1', 'idLeiturista', 'Leiturista');
						           return isCampoNumerico(event);" />
				...
				<tr>
					...
					<td><strong> <span class="style1"><strong> <html:radio
						property="indicadorUso" value="1" tabindex="17" /> <strong>Ativo
				...
				<%-- início da tabela de Critérios de Cobrança da Rota --%>
              	...
              	<tr>
					<td >
						<strong> Critérios de Cobrança da Rota<font color="#FF0000">*</font></strong>
                    </td>
