...
<%@ page import="gsan.atendimentopublico.ordemservico.ServicoTipo"%>
<%@ page import="gsan.micromedicao.ContratoEmpresaServico"%>
<%@ page import="gsan.micromedicao.ContratoEmpresaAditivo"%>
<%@ page import="gsan.micromedicao.ItemServicoContrato"%>
<%@ page import="gsan.micromedicao.InformarItensContratoServicoHelper"%>
...
function desabilitarCampos(){
	...
	}else if(getChecked(form.idNumeroContrato)){
		form.idContrato.disabled = true;
		form.dtInicioContrato.disabled = true;
		form.dtFimContrato.disabled = true;
...
function abrirPopupAditivo() {
	...
	if(form.idEmpresa.value != '-1' && form.idContrato.value != '' && (getChecked(form.idNumeroContrato))){
...
function removerTipoServico(id){
	...
	var form = document.forms[0];	
	if (confirm('Confirma Remoção?')) {
		form.action = 'exibirInformarItensContratoServicoAction.do?acao=removerTipoServico&id='+id;
		form.submit();
	}
}
...
function adicionarTipoServico(){
	...
	var idTipoServico = form.idServicoTipo.value;
	
	if(idTipoServico == ''){
		alert('Informe Tipo de Servico');
	}
	else{
		form.action = 'exibirInformarItensContratoServicoAction.do?acao=adicionarTipoServico';
		form.submit();
	}
...
<html:form action="/informarItensContratoServicoAction.do"
	...
	type="gsan.gui.micromedicao.ExibirInformarItensContratoServicoActionForm"
	method="post">
                ...
                <tr>
					<td width="" align="right" colspan="2">
						<input type="button" 
							   ...
							   onclick="javascript:adicionarTipoServico();">
					</td>
										...
										<table width="100%" cellpadding="0" cellspacing="0" border="0">
											<tr>
												...
												<table width="100%" bgcolor="#99CCFF" border="0">
													<logic:iterate name="colecaoTiposServico" 
												   				   id="servicoTipo"
												   				   type="ServicoTipo">
														...
														<td align="center" width="10%">
															<img src="<bean:message key='caminho.imagens'/>Error.gif" 
																 style="cursor: hand;"
																 onclick="removerTipoServico('${servicoTipo.id}')"
																 title="Remover" >
														</td>
											...
											<tr>
												...
												<table width="100%" bgcolor="#99CCFF" border="0">
													<logic:iterate name="colecaoItemServicoContratoSelecionados" 
														...
														<td width="25%" align="center" onmouseover="this.T_BGCOLOR='whitesmoke';this.T_LEFT=true;return escape( '${itemServicoContrato.hint}' ); ">
