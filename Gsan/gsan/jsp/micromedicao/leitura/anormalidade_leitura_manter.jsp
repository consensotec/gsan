...
<html:form action="/removerAnormalidadeLeituraAction"
							...
							<div align="right">
								<a href="javascript:toggleBox('demodiv',1);">
									<img border="0" src="<bean:message key="caminho.imagens"/>print.gif"
										title="Imprimir Anormalidade Leitura" /> 
								</a>
							</div>
							</td>
						</tr>
	...
	</table><jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioAnormalidadesLeituraAction.do"/>
