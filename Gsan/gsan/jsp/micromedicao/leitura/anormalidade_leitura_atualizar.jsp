...
<!--
	...
	function validarForm(form){
		...
		if(validateAtualizarAnormalidadeLeituraActionForm(form)){
			...
			if(validaFatores(form)){				
  				submeterFormPadrao(form);
			}			
		}
	}

	function validaFatores(form) {

		if(form.numeroFatorSemLeitura.value>=10 || form.numeroFatorComLeitura.value>=10
    	    || (' ' <= form.numeroFatorSemLeitura.value && form.numeroFatorSemLeitura.value <= '/')
    	    || (':' <= form.numeroFatorSemLeitura.value && form.numeroFatorSemLeitura.value <= '~')  	
    	    || (' ' <= form.numeroFatorComLeitura.value && form.numeroFatorComLeitura.value <= '/') 
    	    || (':' <= form.numeroFatorComLeitura.value && form.numeroFatorComLeitura.value <= '~') ){
			alert("Valor de Fator dever ser um número real menor 10(dez).")
			return false;
		}
		else {
			return true;
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					e anormalidades informadas:</strong></td>
					<td>						
				...
				<tr>
					<td><strong>Imprimir conta via mobile:<font color="#FF0000">*</font></strong></td>
					<td>						
				...
				<tr>
					<td><strong>Foto obrigatória:<font color="#FF0000">*</font></strong></td>
					<td>						
			...
			<table>	
				...
				<tr>
					...
					<td colspan="2" align="left">
						<html:text property="numeroVezesSuspendeLeitura" size="5" maxlength="2" onkeypress="javascript: return isCampoNumerico(event);" />
					</td>
				</tr>
				<tr>
					<td>
					...
					<td colspan="2" align="left">
						<html:text property="numeroMesesLeituraSuspensa" size="5" maxlength="2" onkeypress="javascript: return isCampoNumerico(event);" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2"><font color="#FF0000"> <logic:present
						name="inserir" scope="session">
						<input type="button" name="ButtonReset" class="bottonRightCol"
							value="Voltar"
							onClick="javascript:window.location.href='/gsan/exibirFiltrarAnormalidadeLeituraAction.do?menu=sim'">
					</logic:present>
					<logic:notPresent name="inserir" scope="session">
						<logic:notPresent name="manter" scope="session">
							<input type="button" name="ButtonReset" class="bottonRightCol"
								value="Voltar" onClick="javascript:window.location.href='/gsan/exibirFiltrarAnormalidadeLeituraAction.do'">
						</logic:notPresent>
						<logic:present name="manter" scope="session">
							<input type="button" name="ButtonReset" class="bottonRightCol"
								value="Voltar" onClick="javascript:window.location.href='/gsan/exibirManterAnormalidadeLeituraAction.do'">
						</logic:present>
					</logic:notPresent>
					<input type="button" name="ButtonReset"
						class="bottonRightCol" value="Desfazer"
						onClick="javascript:window.location.href='/gsan/exibirAtualizarAnormalidadeLeituraAction.do?desfazer=S'" > <input type="button"
