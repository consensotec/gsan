...
<html:form action="/inserirAnormalidadeLeituraAction"
	...
	type="gsan.gui.micromedicao.leitura.InserirAnormalidadeLeituraActionForm"
	method="post"
		...
		<tr>
			...
			<table>
				...
				<tr>
					...
					<td colspan="2"><span class="style2"> <html:text
						property="numeroFatorSemLeitura" size="3" maxlength="3" onkeyup="formataValorMonetario(this,3);"/> </span></td>
				</tr>
				<tr>
					<td><strong>Fator que deverá atualizar o consumo de imóveis com anormalidade (Com leitura):<font color="#FF0000">*</font></strong></td>
					<td colspan="2"><span class="style2"> <html:text
						property="numeroFatorComLeitura" size="3" maxlength="3" onkeyup="formataValorMonetario(this,3);"/> </span></td>
				</tr>
				<tr>
