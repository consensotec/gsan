...
<html:form action="/monitorarLeituraMobileAction"
	...
	type="gsan.gui.micromedicao.MonitorarLeituraMobileActionForm"
	method="post"
									...
									<tr bgcolor="#FFFFFF">
										...
										<c:choose>
										 <c:when test='${movimento.leituraAnormalidade != null && movimento.leituraAnormalidade.id != null }'>
											<a href="javascript:abrirPopup('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${movimento.imovel.id}&anoMes=${movimento.anoMesMovimento}&metp=${movimento.medicaoTipo.id}', 450, 550);">
