...
<html:form action="/exibirConsultarArquivoTextoLeituraDivisaoPopupAction"
	...
	type="gsan.gui.micromedicao.ConsultarArquivoTextoLeituraDivisaoPopupActionForm"
	method="post">
								...
								<logic:present name="colecaoArquivoTextoRoteiroEmpresaDivisao">
									...
									<logic:iterate name="colecaoArquivoTextoRoteiroEmpresaDivisao"
										...
										<tr bgcolor="#FFFFFF" class="styleFontePequena">
											...
											<td width="25%">
											<div align="center" onmouseover="this.T_BGCOLOR='whitesmoke';this.T_FONTCOLOR='green';this.T_LEFT=true;return escape( 'TELEFONE: ${arquivoTextoRoteiroEmpresaDivisao.leiturista.numeroFone} <br> IMEI: ${arquivoTextoRoteiroEmpresaDivisao.numeroImei}' ); "><c:choose>
												<c:when
