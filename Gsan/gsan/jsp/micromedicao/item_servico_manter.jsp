...
<%@ page import="gsan.micromedicao.ItemServico"%>
...
<html:form action="/removerItemServicoAction"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Itens de Contrato</td>
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="7" height="23"><font style="font-size: 10px;"
						color="#000000" face="Verdana, Arial, Helvetica, sans-serif"> <strong>Item(s) de Contrato
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" bgcolor="#90c7fc">
								...
								<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
									...
									<%int cont = 0;%>
									<logic:iterate name="colecaoItemServico" id="itemServico"
										type="ItemServico">
									...
									<pg:item>
										...
										<%}%>
											...
											<div align="center"><input type="checkbox"
												...
												value="<bean:write name="itemServico" property="id"/>"></div>
											</td>
											
											<td width="20%">
											<div align="center">${itemServico.codigoItem}</div>
											</td>

											<td width="70%" align="left">
											<html:link
												href="/gsan/exibirAtualizarItemServicoAction.do?menu=sim"
												paramId="idRegistroAtualizacao" paramProperty="id"
												paramName="itemServico"
												title="<%="" + itemServico.getDescricao()%>">
												<bean:write name="itemServico" property="descricao"/>
											</html:link>
											</td>
								...
								<tr>
									<td>
										...
										<input name="button" 
											...
											value="Voltar Filtro"
											onclick="window.location.href='<html:rewrite page="/exibirFiltrarItemServicoAction.do?limpar=S"/>'"
											align="left" 
											style="width: 80px;">
									</td>
									<td valign="top">
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioItemServicoManterAction.do" />
