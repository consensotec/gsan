...
<html:javascript staticJavascript="false"
	formName="AtualizarRetornoControleHidrometroActionForm" />

<SCRIPT LANGUAGE="JavaScript">
<!--

function validarForm(formulario){
if(validateAtualizarRetornoControleHidrometroActionForm(formulario)){
...
<html:form action="/atualizarRetornoControleHidrometroAction.do" method="post">

	<INPUT TYPE="hidden" name="removerRetornoControleHidrometro">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Retorno de Controle de Hidrometro</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para Atualizar um retorno de controle de hidr&ocirc;metro, informe os
					dados abaixo:</td>
				</tr>			
				...
				<tr>
					...
					<td><html:hidden property="id" /> <bean:write
						name="AtualizarRetornoControleHidrometroActionForm" property="id" /></td>
				</tr>				
