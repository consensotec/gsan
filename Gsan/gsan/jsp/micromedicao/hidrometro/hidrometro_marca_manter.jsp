...
<%@page import="gsan.micromedicao.hidrometro.HidrometroMarca"%>
...
<html:form action="/removerHidrometroMarcaAction" 
	...
	onsubmit="return CheckboxNaoVazio(document.ManutencaoHidrometroMarcaActionForm.idRegistrosRemocao) && confirm('Confirma remoção?')">
		...
		<td width="625" valign="top" class="centercoltext">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Marca do Hidrômetro</td>
					<td width="11"><img border="0"
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="4" height="23">
						...
						<strong>Marca(s) do Hidrômetro(s) cadastrado(s):</strong>
						</font>
					</td>
				</tr>
	  		</table>
					...
					<td>
						<table width="100%" bgcolor="#99CCFF">
							...
							<tr bgcolor="#99CCFF">
								...
								<td width="15%" align="center">
									<strong>Validade da revisão</strong>
								</td>
								<td width="15%" align="center">
