					...
					<table width="100%" bgcolor="#90c7fc">
						...
						<c:forEach items="${requestScope.hidrometrosInstalacaoHistorico}"
                            ...
                            <%}%>
								...
								<td>
									<div align="center">
										<c:if test="${hidrometroInstalacaoHistorico.hidrometro.indicadorFinalidade eq 2}">
											LIGACAO DE ESGOTO
										</c:if>
										<c:if test="${hidrometroInstalacaoHistorico.hidrometro.indicadorFinalidade eq 1}">
											${hidrometroInstalacaoHistorico.medicaoTipo.descricao}
										</c:if>&nbsp;
									</div>
								</td>
								<td>
