...
<html:form action="/atualizarHidrometroMarcaAction.do"	name="AtualizarHidrometroMarcaActionForm"
	type="gsan.gui.micromedicao.hidrometro.AtualizarHidrometroMarcaActionForm"	method="post"
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
				<td width="30%" class="style3"><strong>Tipo Hidômetro:</strong></td>
					<td width="70%" colspan="2">
						<html:radio	property="indicadorTipoHidrometro" value="1" tabindex="1"	
						style="background-color:#EFEFEF; border:0; color: #000000;"/><strong>Micromedidor
						<html:radio  property="indicadorTipoHidrometro" value="2" tabindex="2" 
						style="background-color:#EFEFEF; border:0; color: #000000;" />Macromedidor</strong>
