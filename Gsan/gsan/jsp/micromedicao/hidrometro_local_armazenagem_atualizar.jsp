...
<html:javascript staticJavascript="false"
	formName="AtualizarLocalArmazenagemHidrometroActionForm" />
...
function validarForm(formulario){
	...
	if(validateAtualizarLocalArmazenagemHidrometroActionForm(formulario)){
...
<html:form action="/atualizarLocalArmazenagemHidrometroAction.do" method="post">

	<INPUT TYPE="hidden" name="removerLocalArmazenagemHidrometro">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Local de Armazenagem do Hidrômetro</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para atualizar o local de armazenagem do hidrômetro informe os
					dados abaixo:</td>
				<tr>
					<td><strong>C&oacute;digo:</strong></td>
					<td><html:hidden property="id" /> 
					<bean:write	name="AtualizarLocalArmazenagemHidrometroActionForm" property="id" />
					</td>
				</tr>
