...
<html:form action="/exibirManterVinculosImoveisRateioConsumoAction.do"
	...
	type="gsan.gui.micromedicao.ManterVinculosImoveisRateioConsumoActionForm"
	method="post">
			...
			<table width="590" bgcolor="#99CCFF">
				...
				cor = "#cbe5fe";%>
							<tr bgcolor="#cbe5fe">
								...
								<td>
								<div align="center" class="style9"><bean:define
									name="clienteimovel" property="imovel" id="imovel" /><%=((gsan.cadastro.imovel.Imovel) imovel)
							.getInscricaoFormatada()%></div>
								...
								<div align="left" class="style9"><bean:define
									name="clienteimovel" property="imovel" id="imovel" /><%=(((gsan.cadastro.imovel.Imovel) imovel)
							.getEnderecoFormatado() != null)?((gsan.cadastro.imovel.Imovel) imovel)
