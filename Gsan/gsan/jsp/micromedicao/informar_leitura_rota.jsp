...
<html:form action="/informarLeituraRotaAction"
	...
	type="gsan.gui.micromedicao.InformarLeituraRotaActionForm"
	method="post">
						...
						<table width="100%" bgcolor="#99CCFF">
							...
							if (cont % 2 == 0) {%>
									...
									<tr bgcolor="#FFFFFF">
										...
										<!--  Informa que o Hidrômetro foi retirado -----  indicador = 1 = SIM -->
										<c:choose >
					...
					<table align="center">				
						<tr class="centercoltext">
							<td align="center">
								...
								<strong>Posição: ${InformarLeituraRotaActionForm.indice}/${InformarLeituraRotaActionForm.total}</strong>
							</td>
						</tr>
					</table>					
					<table>				
							...
							<td align="right" width="10%">
								<c:choose>
									<c:when test='${InformarLeituraRotaActionForm.indice != InformarLeituraRotaActionForm.total}'>
										<gsan:controleAcessoBotao name="Button" url="informarLeituraRotaAction.do" value="Avançar" tabindex="7" onclick="javascript:validarForm(1);"/>
									</c:when>
								</c:choose>
							</td>
							<td align="left" width="10%">
