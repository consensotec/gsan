...
<html:javascript staticJavascript="false"  formName="EmissaoRelatorioOrcamentoSinpActionForm"/>
...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if(validateEmissaoRelatorioOrcamentoSinpActionForm(form) && 
	...
	function habilitaDesabilitaFormulario(limpaSessao){
		...
		if(opcaoTotalizacao >= 1 && opcaoTotalizacao <= 5 || opcaoTotalizacao == 26){
	...
	function limparSemOpcaoTotalizacao(){
  		...
  		form.action='emissaoRelatorioOrcamentoSinpAction.do?menu=sim';
	    form.submit();
	...
	*/
	...
	function limparLocalidade() {
  	...
  	function reloadForm(){
  		...
  		form.action='emissaoRelatorioOrcamentoSinpAction.do';
	    form.submit();
  	}
...
<html:form action="/gerarRelatorioOrcamentoSinpAction.do"
	name="EmissaoRelatorioOrcamentoSinpActionForm"
	type="gsan.gui.relatorio.gerencial.faturamento.EmissaoRelatorioOrcamentoSinpActionForm"
	method="post">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Relat&oacute;rio para o Or&ccedil;amento e SINP</td>
					<td width="11"><img border="0"
				...
				<tr>
					...
					<td>
						...
						<html:select property="opcaoTotalizacao" 
		                    ...
		                    <html:option value="5">ESTADO POR CENTRO CUSTO/LOCALIDADE</html:option>
		                    <html:option value="26">ESTADO POR MUNICÍPIO</html:option>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="localidade" 
							size="4"
							onkeypress="validaEnterComMensagem(event, 'emissaoRelatorioOrcamentoSinpAction.do?objetoConsulta=2','localidade','Localidade'); return isCampoNumerico(event);"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="4" 
							...
							property="municipio" 
							size="4"
							onkeypress="validaEnterComMensagem(event, 'emissaoRelatorioOrcamentoSinpAction.do?objetoConsulta=3','municipio','Município'); return isCampoNumerico(event);"/>
...
<%@ include file="/jsp/util/rodape.jsp"%>	
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioOrcamentoSinpAction.do" />
