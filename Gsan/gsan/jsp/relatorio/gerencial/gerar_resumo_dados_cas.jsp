...
<html:form action="/gerarResumoDadosCasAction.do"
	...
	type="gsan.gui.relatorio.gerencial.faturamento.ExibirGerarResumoDadosCasActionForm"
	method="post">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Demonstrativo do Faturamento/Arrecadacao</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				...
				<tr>
					<td colspan="2">Para gerar o Demonstrativo, informe os dados abaixo:</td>
				</tr>
