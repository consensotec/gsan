...
<html:javascript staticJavascript="false"  formName="EmissaoRelatorioQuadroMetasAcumuladoActionForm"/>
...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if(validateEmissaoRelatorioQuadroMetasAcumuladoActionForm(form) && 
	...
	function limparSemOpcaoTotalizacao(){
  		...
  		form.action='exibirGerarQuadroMetasAcumuladoAction.do?menu=sim';
	    form.submit();
	...
	*/
	...
	function limparLocalidade() {
  	...
  	function reloadForm(){
  		...
  		form.action='exibirGerarQuadroMetasAcumuladoAction.do';
	    form.submit();
  	}
...
<html:form action="/gerarRelatorioQuadroMetasAcumuladoAction.do"
	name="EmissaoRelatorioQuadroMetasAcumuladoActionForm"
	type="gsan.gui.relatorio.gerencial.faturamento.EmissaoRelatorioQuadroMetasAcumuladoActionForm"
	method="post">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Relat&oacute;rio para o Quadro de Metas Acumulado</td>
					<td width="11"><img border="0"
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							property="localidade" 
							size="3"
							onkeypress="validaEnterComMensagem(event, 'exibirGerarQuadroMetasAcumuladoAction.do?objetoConsulta=2','localidade','Localidade');"/>
...
<%@ include file="/jsp/util/rodape.jsp"%>	
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioQuadroMetasAcumuladoAction.do" />
