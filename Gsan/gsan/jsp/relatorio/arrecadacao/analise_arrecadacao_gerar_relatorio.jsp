...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="GerarRelatorioAnaliseArrecadacaoActionForm" />
<script>
...
<html:form 
	action="/gerarRelatorioAnaliseArrecadacaoAction.do"
	name="GerarRelatorioAnaliseArrecadacaoActionForm"
	type="gsan.gui.relatorio.arrecadacao.GerarRelatorioAnaliseArrecadacaoActionForm"
	method="post">
	...
	<table width="770" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img
						...
						border="0" /></td>
					<td class="parabg">Relátorio de Análise da Arrecadação</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="3">Para gerar o relat&oacute;rio de análise da arrecadação, informe os dados abaixo:</td>
				</tr>
				<tr>
	...
	<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioAnaliseArrecadacaoAction.do"/> 
