...
function validarForm(){
	...
	if (validateGerarRelatorioResumoArrecadacaoActionForm(form) && form.mesAno.value != "" && validaMesAno(form)){
		var opcao = '';
...
<html:form action="/gerarRelatorioResumoArrecadacaoAction.do"
	...
	type="gsan.gui.relatorio.arrecadacao.GerarRelatorioResumoArrecadacaoActionForm"
	method="post">
