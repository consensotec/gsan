...
<%@ page import="gsan.cadastro.atualizacaocadastral.bean.DadosResumoMovimentoAtualizacaoCadastralHelper" isELIgnored="false"%>
...
<body leftmargin="5" topmargin="5" onload="setarFoco('${requestScope.nomeCampo}');">
	...
	<div id="formDiv">
		<html:form action="/gerarResumoMovimentacaoAtualizacaoCadastralAction"
			...
			type="gsan.gui.relatorio.cadastro.GerarResumoMovimentacaoAtualizacaoCadastralActionForm"
