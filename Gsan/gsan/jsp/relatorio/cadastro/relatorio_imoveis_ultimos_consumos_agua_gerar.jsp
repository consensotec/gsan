...
<html:javascript staticJavascript="false"  formName="GerarRelatorioImoveisUltimosConsumosAguaActionForm"/>
...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if(validateGerarRelatorioImoveisUltimosConsumosAguaActionForm(form) &&
			campoObrigatorio() && 
			validarCampos() ){
	...
	function chamarPopup(url, tipo, objeto, codigoObjeto, altura, largura, msg,campo){
  	...
  	function limpar(){
		...
		form.sequencialRotaFinal.value = "";
  		...
  		form.action='exibirGerarRelatorioImoveisUltimosConsumosAguaAction.do?menu=sim';
	    form.submit();
  	}
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
		...
		if (tipoConsulta == 'localidadeOrigem') {
	  		...
	  		form.action='exibirGerarRelatorioImoveisUltimosConsumosAguaAction.do';
	    form.submit();
	...
	var form = document.GerarRelatorioImoveisUltimosConsumosAguaActionForm;	
...
<html:form action="/gerarRelatorioImoveisUltimosConsumosAguaAction.do"
	name="GerarRelatorioImoveisUltimosConsumosAguaActionForm"
	type="gsan.gui.relatorio.cadastro.GerarRelatorioImoveisUltimosConsumosAguaActionForm"
	method="post">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Relat&oacute;rio  de Im&oacute;veis com os &Uacute;ltimos Consumos de &Aacute;gua </td>
					<td width="11"><img border="0"
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(1);validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisUltimosConsumosAguaAction.do?objetoConsulta=1','localidadeInicial','Localidade Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(2);validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisUltimosConsumosAguaAction.do?objetoConsulta=2','setorComercialInicial','Setor Comercial Inicial');"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisUltimosConsumosAguaAction.do?objetoConsulta=3','localidadeFinal','Localidade Final');"
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" property="setorComercialFinal"
							...
							onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisUltimosConsumosAguaAction.do?objetoConsulta=4','setorComercialFinal','Setor Comercial Final');"
							onkeyup="javascript:desabilitaIntervaloDiferenteSetor();"
							tabindex="8"/>
              	...
              	<tr> 
                	...
                	<td colspan="6">
						...
						<html:select property="perfilImovel" 
							...
							<logic:present name="colecaoImovelPerfil" scope="request">
...
<%@ include file="/jsp/util/rodape.jsp"%>	
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioImoveisUltimosConsumosAguaAction.do" />
