...
<div id="formDiv"><html:form action="/gerarRelatorioImoveisTipoConsumoAction.do"
	...
	type="gsan.gui.relatorio.cadastro.GerarRelatorioImoveisTipoConsumoActionForm"
	method="post">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Relat&oacute;rio  de Im&oacute;veis por Tipo de Consumo/Período </td>
					<td width="11"><img border="0"
