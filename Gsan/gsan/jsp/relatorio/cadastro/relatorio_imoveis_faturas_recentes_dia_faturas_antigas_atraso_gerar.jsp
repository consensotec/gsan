...
<html:form action="/gerarRelatorioImoveisFaturasRecentesDiaFaturasAntigasAtrasoAction.do"
	...
	type="gsan.gui.relatorio.cadastro.GerarRelatorioImoveisFaturasRecentesDiaFaturasAntigasAtrasoActionForm"
	method="post">
...
<%@ include file="/jsp/util/rodape.jsp"%>
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio_tela_espera.jsp?relatorio=gerarRelatorioImoveisFaturasRecentesDiaFaturasAntigasAtrasoAction.do" />
