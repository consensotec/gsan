...
<html:javascript staticJavascript="false"  formName="GerarRelatorioImoveisAtivosNaoMedidosActionForm"/>
...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if(validateGerarRelatorioImoveisAtivosNaoMedidosActionForm(form) && 
			campoObrigatorio() && 
			validarCampos() ){
	...
	function chamarPopup(url, tipo, objeto, codigoObjeto, altura, largura, msg,campo){
  	...
  	function reloadForm(){
  		...
  		form.action='exibirGerarRelatorioImoveisAtivosNaoMedidosAction.do';
	    form.submit();
  	}
  	...
  	function limpar(){
		...
		form.sequencialRotaFinal.value = "";
  		...
  		form.action='exibirGerarRelatorioImoveisAtivosNaoMedidosAction.do?menu=sim';
	    form.submit();
  	}
	...
	var form = document.GerarRelatorioImoveisAtivosNaoMedidosActionForm;	
...
<html:form action="/gerarRelatorioImoveisAtivosNaoMedidosAction.do"
	name="GerarRelatorioImoveisAtivosNaoMedidosActionForm"
	type="gsan.gui.relatorio.cadastro.GerarRelatorioImoveisAtivosNaoMedidosActionForm"
	method="post">
	      ...
	      <div align="center">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Gerar Relat&oacute;rio  de Im&oacute;veis Ativos e N&atilde;o Medidos</td>
					<td width="11"><img border="0"
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(1);validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisAtivosNaoMedidosAction.do?objetoConsulta=1','localidadeInicial','Localidade Inicial');return isCampoNumerico(event);"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="javascript:limparOrigem(2);validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisAtivosNaoMedidosAction.do?objetoConsulta=2','setorComercialInicial','Setor Comercial Inicial');return isCampoNumerico(event);"/>
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" 
							...
							onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisAtivosNaoMedidosAction.do?objetoConsulta=3','localidadeFinal','Localidade Final');return isCampoNumerico(event);"
				...
				<tr>
					...
					<td>
						...
						<html:text maxlength="3" property="setorComercialFinal"
							...
							onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioImoveisAtivosNaoMedidosAction.do?objetoConsulta=4','setorComercialFinal','Setor Comercial Final');return isCampoNumerico(event);"
