...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="GerarRelatorioSaldoContasAReceberContabilActionForm" />
<script>

function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {

    var form = document.GerarRelatorioSaldoContasAReceberContabilActionForm;
...
function validarForm(){
	...
	var form = document.GerarRelatorioSaldoContasAReceberContabilActionForm; 
	    ...
	    if (validateGerarRelatorioSaldoContasAReceberContabilActionForm(form) && validaMesAno(form)){
			 ...
			 for(i=0; i < form.opcaoTotalizacao.length; i++) {
      		...
      		if (opcao == 'localidade') {
	      		...
	      		if (form.codigoMunicipio.value == '') {
      				alert('Preencha o código do município');
      				return false;
      			}
      		}else if (opcao == '') {
...
<html:form action="/gerarRelatorioSaldoContasAReceberContabilAction.do"
	name="GerarRelatorioSaldoContasAReceberContabilActionForm"
	type="gsan.gui.relatorio.financeiro.GerarRelatorioSaldoContasAReceberContabilActionForm"
	method="post">
	...
	<table width="770" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img
						...
						border="0" /></td>
					<td class="parabg">Relatório do Saldo do Contas a Receber Contábil</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="3">Para gerar o relatório do saldo do contas a receber contábil, informe os dados abaixo:</td>
				</tr>
				<tr>
					<td width="26%">
						<strong>Mês/Ano de Referência Contábil:<font color="#FF0000">*</font></strong>
					</td>
					<td colspan="2">
				...
				<tr>
					...
					<td align="left">
						<html:text property="codigoLocalidade" size="4" maxlength="3"
							onkeypress="validaEnter(event, 'exibirGerarRelatorioSaldoContasAReceberContabilAction.do?pesquisarLocalidade=OK', 'codigoLocalidade');" />
				...
				<tr>
					...
					<td align="left">
						<html:text property="codigoMunicipio" size="4" maxlength="4" 
							onkeypress="validaEnter(event, 'exibirGerarRelatorioSaldoContasAReceberContabilAction.do?pesquisarMunicipio=OK', 'codigoMunicipio');" />
	...
	<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioSaldoContasAReceberContabilAction.do"/> 
