...
<html:form action="/gerarRelatorioEvolucaoContasAReceberContabilAction.do"
	...
	type="gsan.gui.relatorio.financeiro.GerarRelatorioEvolucaoContasAReceberContabilActionForm"
	method="post">
	...
	<table width="770" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img
						...
						border="0" /></td>
					<td class="parabg">Relatório da Evolução do Contas a Receber Contábil</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="3">Para gerar o relatório da evolução do contas a receber contábil, informe os dados abaixo:</td>
				</tr>
				<tr>
					<td width="26%">
