...
<html:form action="/gerarRelatorioContasBaixadasContabilmenteAction.do"
	...
	type="gsan.gui.relatorio.financeiro.GerarRelatorioContasBaixadasContabilmenteActionForm"
	method="post">
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td align="left" width="15%">
						...
						onclick = "tipoFormato[0].checked=true; tipoFormato[1].disabled=true; tipoFormato[0].disabled=false;"/> <strong>Analítico </strong>
					</td>
					<td align="left">
