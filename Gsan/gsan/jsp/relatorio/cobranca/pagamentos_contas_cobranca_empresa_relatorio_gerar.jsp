...
<html:form action="/gerarRelatorioPagamentosContasCobrancaEmpresaAction"
	...
	type="gsan.gui.cobranca.GerarRelatorioPagamentosContasCobrancaEmpresaActionForm"
	method="post">
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="2"><strong> <html:text maxlength="7" property="periodoComandoInicial"
						...
						onchange="validarCampoDataComMensagemLimpandoCampo(document.forms[0].periodoComandoInicial, 'Período Referência Inicial');" />
					<strong> a</strong> <html:text maxlength="7"
						property="periodoComandoFinal" size="7" tabindex="9"
						onkeypress="return isCampoNumerico(event);"
						onkeyup="mascaraAnoMes(this, event);"
						onchange="validarCampoDataComMensagemLimpandoCampo(document.forms[0].periodoComandoFinal, 'Período Referência Final');" /> </strong> (mm/aaaa)</td>
				</tr>
