...
<SCRIPT LANGUAGE="JavaScript">
	...
	function limparEmpresa() {
		...
		form.action = 'exibirConsultarComandosAcompanhamentoCobrancaResultadoAction.do?limpar=sim';
	...
	function selecionarComandos(){
		...
		if(form.idEmpresa.value != ''){
			if(form.nomeEmpresa.value != 'EMPRESA INEXISTENTE' && form.nomeEmpresa.value != ''){
				form.action = 'exibirConsultarComandosAcompanhamentoCobrancaResultadoAction.do?selecionarComandos=sim';
			    form.submit();
			}
		}
		else{
...
<html:form action="/consultarComandosAcompanhamentoCobrancaResultadoAction.do" 
			name="ConsultarComandosAcompanhamentoCobrancaResultadoActionForm"
			type="gsan.gui.relatorio.cobranca.ConsultarComandosAcompanhamentoCobrancaResultadoActionForm"
			method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Relatório de OS das Contas em Cobrança por Resultado</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para gerar o relatório de OS das contas em cobrança por resultado, informe os dados abaixo:</td>
				</tr>
				<tr>
					<td width="30%"><strong>Empresa:<font color="#FF0000">*</font></strong></td>
					<td><html:text maxlength="9" property="idEmpresa" size="9"
						tabindex="14" 
						onkeypress="validaEnterComMensagem(event, 'exibirConsultarComandosAcompanhamentoCobrancaResultadoAction.do', 'idEmpresa', 'Empresa');limparEmpresaTecla();"
				...
				<tr>
					...
					<td><strong> <html:text maxlength="10"
						...
						onkeyup="mascaraData(this, event);  replicarCampo(document.forms[0].periodoCicloFinal, document.forms[0].periodoCicloInicial);limparPeriodoFinal();"
						onchange="limparComandos();" />
					<a
						href="javascript:abrirCalendario('ConsultarComandosCobrancaResultadoActionForm', 'periodoCicloFinal');">			     
					<img border="0"
					...
					<tr>
						...
						<table width="100%" bgcolor="#99CCFF" border="0">
							<tr bordercolor="#000000">
								<td width="10%" bgcolor="#90c7fc" align="center" rowspan="2"><strong><a
									href="javascript:facilitador(this);">Marca / Desmarca</a></strong></td>
									...
									if (cont % 2 == 0) {%>
											...
											<tr bgcolor="#FFFFFF">
												...
												<%=consultarComandosContasCobrancaEmpresaHelper
															.getIdComandoEmpresaCobrancaConta()%> </td>
					...
					<tr>
						<td>
							<input name="Button" type="button" class="bottonRightCol"
								...
								onclick="window.location.href='<html:rewrite page="/exibirConsultarComandosAcompanhamentoCobrancaResultadoAction.do?menu=sim"/>'">
							<input name="Button" type="button" class="bottonRightCol"
						...
						<td align="right">
							<input name="Button3222" type="button"
								class="bottonRightCol" value="Avançar" onClick="javascript:validaForm();" />
						</td>
