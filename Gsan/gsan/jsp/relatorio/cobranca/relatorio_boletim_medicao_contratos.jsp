...
<%@ page import="gsan.relatorio.cobranca.BoletimMedicaoContratoHelper" %>
<%@ page import="gsan.relatorio.cobranca.BoletimMedicaoContratoDadosHelper" %>
...
<div id="formDiv"><html:form action="/exibirSolicitarGeracaoEmissaoBoletimMedicaoContratosAction.do"
	...
	type="gsan.gui.relatorio.cobranca.GerarEmitirBoletimMedicaoContratosForm"
	method="post"> 
