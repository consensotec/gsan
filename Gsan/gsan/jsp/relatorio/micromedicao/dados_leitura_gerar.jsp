...
<script language="JavaScript">
	...
	function validarForm(form){
		if(validateGerarDadosLeituraActionForm(form)){		
			...
			} else 	if ((form.idGrupoFaturamento.value == null || form.idGrupoFaturamento.value == '-1') && 
...
<body leftmargin="5" topmargin="5"
	onload="javascript:setarFoco('${requestScope.nomeCampo}');bloquearGrupo();setarValorDefault();">
<div id="formDiv">
<html:form action="/gerarRelatorioDadosLeituraAction"
	name="GerarDadosLeituraActionForm"
	type="gsan.gui.micromedicao.GerarDadosLeituraActionForm" method="post">
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td colspan="3">
						...
						<a href="javascript:pesquisarLocalidadeFinal();"><img width="23" height="21"
								 src="<bean:message key="caminho.imagens"/>pesquisa.gif" border="0" title="Pesquisar Localidade Final"/></a>
				...
				<tr>
					...
					<img border="0"
						src="<bean:message key="caminho.imagens"/>pesquisa.gif" border="0" title="Pesquisar Rota" /></a>
	...
	<jsp:include
		page="/jsp/relatorio/escolher_tipo_relatorio_tela_espera.jsp?relatorio=gerarRelatorioDadosLeituraAction.do" />
