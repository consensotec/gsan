...
<head>
	...
	<html:javascript staticJavascript="false" formName="GerarRelatorioResumoSolicitacoesRAPorUnidadeActionForm" staticJavascript="false" dynamicJavascript="true" />
	...
	<script language="JavaScript">
		...
		function validacaoForm() {
			...
			var usuario = trim(form.loginUsuario.value);
	
			if ((unidade == null || unidade == '') && (unidadeSuperior == null || unidadeSuperior == '')) {
		...
		function recuperarDadosPopup(codigoRegistro, nomeRegistro, tipoConsulta) {
			...
			if (tipoConsulta == 'unidadeOrganizacional') {
				...
				form.nomeUsuario.value = nomeRegistro;
			}
		}
...
<body leftmargin="5" topmargin="5" onload="window.focus();javascript:setarFoco('${requestScope.nomeCampo}');">

	<html:form action="/gerarRelatorioResumoSolicitacoesRAPorUnidadeAction"
		method="post" name="GerarRelatorioResumoSolicitacoesRAPorUnidadeActionForm"
		type="gsan.gui.atendimentopublico.registroatendimento.GerarRelatorioResumoSolicitacoesRAPorUnidadeActionForm">
			...
			<tr>
				...
				<td width="600" valign="top" class="centercoltext">
					...
					<table width="100%" border="0">
						...
						<tr>
							<td>
								<strong>Situação dos Registros de Atendimento<font color="#FF0000">*</font></strong>
							</td>
						...
						<tr>
							...
							<td colspan="6">
								<span class="style2">
									<strong>
										<html:text property="dataAtendimentoInicial" size="11" maxlength="10" onkeyup="mascaraData(this, event);replicaDataAtendimento();" />
										<a href="javascript:abrirCalendarioReplicando('GerarRelatorioResumoSolicitacoesRAPorUnidadeActionForm', 'dataAtendimentoInicial','dataAtendimentoFinal');">
											<img border="0" src="<bean:message key='caminho.imagens'/>calendario.gif" width="16" height="15" border="0" alt="Exibir Calendário" /></a>
										&nbsp;a&nbsp;
										<html:text property="dataAtendimentoFinal" size="11" maxlength="10" onkeyup="mascaraData(this, event)" />
										<a href="javascript:abrirCalendario('GerarRelatorioResumoSolicitacoesRAPorUnidadeActionForm', 'dataAtendimentoFinal');">
											<img border="0" src="<bean:message key='caminho.imagens'/>calendario.gif" width="16" height="15" border="0" alt="Exibir Calendário" /></a>
						...
						<tr>
							...
							<td>
								<html:text property="idUnidade" maxlength="4" size="4" onkeypress="limparUnidadeSuperior(); validaEnterComMensagem(event, 'exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?objetoConsulta=1','idUnidade','Unidade Organizacional');" />
						...
						<tr>
							...
							<td>
								<html:text property="idUnidadeSuperior" maxlength="4" size="4" onkeypress="limparUnidade(); validaEnterComMensagem(event, 'exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?objetoConsulta=2','idUnidadeSuperior','Unidade Superior');" />
						...
						<tr>
							...
							<td>
								<html:text property="loginUsuario" maxlength="11" size="9" style="text-transform: none;" onkeypress="validaEnterStringSemUpperCase(event, 'exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?objetoConsulta=5','loginUsuario');"/>
								<a href="javascript:chamarPopup('exibirUsuarioPesquisar.do?mostrarLogin=s', 'usuario', null, null, 275, 480, '',document.forms[0].loginUsuario);">
									<img width="23" height="21" border="0" style="cursor:hand;" src="<bean:message key="caminho.imagens"/>pesquisa.gif" title="Pesquisar usuário"/></a>
								<logic:present name="usuarioEncontrado" scope="session">
									<html:text property="nomeUsuario" size="33" maxlength="30" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" />
								</logic:present> 
								<logic:notPresent name="usuarioEncontrado" scope="session">
									<html:text property="nomeUsuario" size="33" maxlength="30" readonly="true" style="background-color:#EFEFEF; border:0; color: red" />
								</logic:notPresent>
						...
						<tr>
							...
							<td>
								<html:text property="idMunicipio" maxlength="4" size="4" onkeypress="validaEnterComMensagem(event, 'exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?objetoConsulta=3','idMunicipio','Municipio');" />
						...
						<tr>
							...
							<td>
								<html:text property="idBairro" maxlength="4" size="4" onkeypress="return validaEnterDependencia(event, 'exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?objetoConsulta=4', this, document.forms[0].idMunicipio.value, 'Município');" />
						...
						<tr>
							<td height="24">
								<input type="button" class="bottonRightCol" value="Limpar" onclick="window.location.href='/gsan/exibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do?menu=sim';" />
							</td>
							<td align="right">
								<input type="button" name="Button" class="bottonRightCol" value="Filtrar" onClick="javascript:validarForm()" />
							</td>
						</tr>
					</table>
					<p>&nbsp;</p>
		...
		<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioResumoSolicitacoesRAPorUnidadeAction.do" />
