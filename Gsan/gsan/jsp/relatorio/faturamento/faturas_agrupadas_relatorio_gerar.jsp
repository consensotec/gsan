...
<!-- Begin
	...
	function validarForm(form){
		if(validateGerarRelatorioFaturasAgrupadasActionForm(form)) {
			botaoAvancarTelaEspera('/gsan/gerarRelatorioFaturasAgrupadasAction.do');
		}
	}
...
<html:form action="/gerarRelatorioFaturasAgrupadasAction"
	...
	type="gsan.gui.relatorio.faturamento.GerarRelatorioFaturasAgrupadasActionForm" method="post"
