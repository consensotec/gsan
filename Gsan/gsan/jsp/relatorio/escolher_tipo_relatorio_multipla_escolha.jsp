...
function mandarForm() {
	...
	<% if (parametro1 != null && !parametro1.trim().equals("") ) {	%>
...
function mandarFormCaminho(path) {
	...
	form.action = path + '?tipoRelatorio=' + tipo + '&escolhacombo='+ document.form.escolhaRelatorio[document.form.escolhaRelatorio.selectedIndex].value;
	form.submit();
		...
		<%if (left != null && top != null){ %>
			...
			<tr>
				...
				<td colspan="2" align="center"><input type="button"
					...
					class="buttonMenuRelatorio" value="Fechar" name="botaoFechar" onclick="toggleBox('demodiv',0);" /></td>
			</tr>
			</table>
			...
			<tr>
				...
				<td colspan="2" align="center">
					...
					<input type="button"
						...
						value="Fechar" 
						name="botaoFechar" 
						onclick="toggleBox('demodiv',0);" /></td>
			</tr>
			</table>
