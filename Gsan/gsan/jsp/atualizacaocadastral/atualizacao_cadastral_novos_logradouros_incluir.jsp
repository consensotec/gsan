...
<%@ page import="gsan.atualizacaocadastral.bean.AtualizacaoCadastralLogradouroHelper"%>
<%@ page import="gsan.atualizacaocadastral.LogradouroAtlzCadDM"%>
...
<html:html>
	...
	<div id="formDiv">
		<html:form action="/inserirNovosLogradourosAtualizacaoCadastralAction.do"
					...
					type="gsan.gui.atualizacaocadastral.InserirNovosLogradourosAtualizacaoCadastralActionForm" 
					method="post">
