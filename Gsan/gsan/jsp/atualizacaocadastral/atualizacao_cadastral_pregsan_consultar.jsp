...
<%@page import="gsan.atualizacaocadastral.bean.DadosImovelPreGsanHelper"  isELIgnored="false"%>
...
<html:form action="/atualizarImovelPreGsanAction" 
	...
	type="gsan.gui.atualizacaocadastral.ConsultarImoveisPreGsanActionForm"
	method="post"
