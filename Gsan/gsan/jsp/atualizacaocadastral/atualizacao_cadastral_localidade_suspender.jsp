...
<%@ page import="gsan.atualizacaocadastral.AreaAtualizacaoCadastralDM" isELIgnored="false"%>
...
<div id="formDiv">
	<html:form action="/suspenderLocalidadeAtualizacaoCadastralAction"
		...
		type="gsan.gui.atualizacaocadastral.SuspenderLocalidadeAtualizacaoCadastralActionForm"
		method="post"
