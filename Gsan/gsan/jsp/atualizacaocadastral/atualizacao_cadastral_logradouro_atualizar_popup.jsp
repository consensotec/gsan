...
<html:html>
		...
		<script LANGUAGE="JavaScript">
			...
			function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
			    ...
			    if (tipoConsulta == 'cep') {
			      ...
			      //Código responsável pela atualizacao automática da colecao
			      /*form.action = "exibirAtualizarLogradouroAtualizacaoCadastralPopUpAction.do";
				  submeterFormPadrao(form);*/
	...
	<logic:notPresent name="fechar">
		...
		<html:form action="/exibirAtualizarLogradouroAtualizacaoCadastralPopUpAction" 
					...
					type="gsan.gui.atualizacaocadastral.AtualizarLogradouroAtualizacaoCadastralPopUpActionForm"
					method="post">
					...
					<td width="615" valign="top" class="centercoltext">
						...
						<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td class="parabg">Atualizar Novo Logradouro - Atualização Cadastral</td>
								<td width="11">
						...
						<table width="100%" border="0">
							...
							<tr>
								...
								<td>
									...
									onkeypress="javascript:return validaEnterDependencia(event, 'exibirAtualizarLogradouroAtualizacaoCadastralPopUpAction.do', this,document.forms[0].idMunicipio.value,'Município');return isCampoNumerico(event);" />
