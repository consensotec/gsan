...
<%@ page import="gsan.atualizacaocadastral.ClienteAtualizacaoCadastralDM"  isELIgnored="false"%>
<%@ page import="gsan.atualizacaocadastral.ClienteFoneAtualizacaoCadastralDM"  isELIgnored="false"%>
<%@ page import="gsan.atualizacaocadastral.HidrometroInstalacaoHistoricoAtualizacaoCadastralDM"  isELIgnored="false"%>
<%@ page import="gsan.atualizacaocadastral.ImovelSubcategoriaAtualizacaoCadastralDM"  isELIgnored="false"%>
...
<html:form action="/exibirConsultarDadosImovelAmbienteVirtualPopupAction" 
	...
	type="gsan.gui.atualizacaocadastral.ConsultarDadosImovelAmbienteVirtualPopupActionForm"
	method="post">
													...
													<%int cont = 1;%>
														<tr>
															<td colspan="2" height="7">
																<div id="gallery">
																    	<table width="100%" border="0" >
																	    	<logic:iterate name="colecaoFoto" id="foto" type="gsan.atualizacaocadastral.ImovelFotoAtualizacaoCadastralDM">
																		    		<%
																						  cont = cont + 1;
																						  if (cont % 2 == 0) {
																					  %>
