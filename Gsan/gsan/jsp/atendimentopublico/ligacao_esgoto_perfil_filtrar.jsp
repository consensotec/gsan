...
<html:form action="/filtrarPerfilLigacaoEsgotoAction"
	...
	type="gsan.gui.atendimentopublico.FiltrarPerfilLigacaoEsgotoActionForm" method="post"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Perfil da Ligação Esgoto</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td colspan="2">Para filtrar o(s) perfil(is) da ligação de esgoto, informe o dado
					abaixo:</td>
