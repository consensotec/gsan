...
<script language="JavaScript">
	...
	function validarForm(tipo){
		...
		if(validateGerarCertidaoNegativaClienteActionForm(form) && 
			...
			if ( tipo != null && tipo == "reduzido") {
				 form.action = 'gerarCertidaoNegativaClienteAction.do?tipo=reduzido';
				 form.submit();
			} else {	
				form.action = 'gerarCertidaoNegativaClienteAction.do';
				 form.submit();
			}
		}
	}
...
<html:form action="/gerarCertidaoNegativaClienteAction.do"
	...
	type="gsan.gui.atendimentopublico.GerarCertidaoNegativaClienteActionForm"
	method="post">
			...
			<table width="100%" border="0">
				...
				<tr>
					<td height="24"><input type="button" class="bottonRightCol"
						value="Limpar" 
						onclick="window.location.href='/gsan/exibirGerarCertidaoNegativaClienteAction.do?menu=sim';"></td>

					<td align="right"><input type="button" name="Button"
						class="bottonRightCol" value="Gerar Certidão"
						onClick="javascript:validarForm('normal')" /></td>
					
					<td align="right"><input type="button" name="Button"
						class="bottonRightCol" value="Gerar Certidão Reduzida"
						onClick="javascript:validarForm('reduzido')" /></td>
