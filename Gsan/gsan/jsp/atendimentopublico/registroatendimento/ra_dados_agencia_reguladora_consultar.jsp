...
<%@ page import="gsan.atendimentopublico.registroatendimento.RaDadosAgenciaReguladoraFone"%>
<%@ page import="gsan.atendimentopublico.registroatendimento.RegistroAtendimento"%>
...
<html:form action="/informarRaDadosAgenciaReguladoraAction.do" name="ConsultarRaDadosAgenciaReguladoraActionForm"
	type="gsan.gui.atendimentopublico.registroatendimento.ConsultarRaDadosAgenciaReguladoraActionForm">
