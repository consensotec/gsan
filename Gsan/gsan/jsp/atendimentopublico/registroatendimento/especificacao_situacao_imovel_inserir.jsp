...
<html:form action="/inserirEspecificacaoSituacaoImovelAction.do"
	...
	type="gsan.gui.atendimentopublico.registroatendimento.InserirEspecificacaoSituacaoImovelActionForm"
	method="post">
                						...
                						<div align="center">
                    						...
                    						<table width="85%" align="center" bgcolor="#99CCFF">
					                      	...
					                      	<c:set var="count" value="0"/>
  			                      		  	...
  			                      		  	<logic:iterate id="especificacaoImovSitCriterio" name="InserirEspecificacaoSituacaoImovelActionForm" property="especificacaoImovelSituacaoCriterio" type="gsan.atendimentopublico.registroatendimento.EspecificacaoImovSitCriterio" scope="session">
