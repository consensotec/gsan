...
<%@ page import="gsan.atendimentopublico.registroatendimento.LocalidadeEspecificacaoUnidade"%>
...
<div id="formDiv"><html:form action="/inserirAssociacaoLocalidadeComEspecificacaoUnidadeAction.do"
	...
	type="gsan.gui.atendimentopublico.registroatendimento.ExibirInserirAssociacaoLocalidadeComEspecificacaoUnidadeActionForm"
	method="post">
