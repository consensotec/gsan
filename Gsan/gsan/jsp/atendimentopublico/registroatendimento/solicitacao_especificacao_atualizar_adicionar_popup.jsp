...
function removerArquivo(identificacao){	
	...
	function validaTodosRadioButton(){
		...
		if(validaRadioButton(form.indicadorPoco,"Refere-se a Poço?") != ""){
			mensagem = mensagem + validaRadioButton(form.indicadorPoco,"Refere-se a Ligação de Poço?")+"\n";
		}

		if(validaRadioButton(form.indicadorLigacaoEsgoto,"Refere-se a Ligação de Esgoto?") != ""){
			mensagem = mensagem + validaRadioButton(form.indicadorLigacaoEsgoto,"Refere-se a Ligação de Esgoto?")+"\n";
		}
	...
	<table width="615" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Refere-se a Poço?:<font color="#FF0000"></font><font
						color="#FF0000">*</font></strong></td>
				...
				<tr>
					<td><strong>Refere-se a Ligação de Esgoto?:<font color="#FF0000"></font><font
						color="#FF0000">*</font></strong></td>
