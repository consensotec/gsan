...
function abrirPopupComSubmit(form,altura, largura){
 ...
 form.action = 'recuperarDadosInserirTipoSolicitacaoEspecificacaoAction.do?retornarTela=exibirAtualizarTipoSolicitacaoEspecificacaoAction.do&limpaSessao=1&trocou=sim';
...
<html:form action="/atualizarTipoSolicitacaoEspecificacaoAction"
	...
	type="gsan.gui.atendimentopublico.registroatendimento.AtualizarTipoSolicitacaoEspecificacaoActionForm"
	method="post">
								...
								<logic:iterate name="colecaoSolicitacaoTipoEspecificacao"
									...
									<div align="left"><a
										href="javascript:document.forms[0].target='';
												abrirPopup('exibirAtualizarAdicionarSolicitacaoEspecificacaoAction.do?atualizar=sim&posicao=${count}&trocou=sim&first=sim&btatualizar=sim',710,440);">
