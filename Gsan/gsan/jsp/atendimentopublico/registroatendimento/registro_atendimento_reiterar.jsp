...
<%@ page import="gsan.atendimentopublico.registroatendimento.RAReiteracaoFone"%>
<%@ page import="gsan.cadastro.cliente.ClienteEndereco" %>
...
<html:form action="/reiterarRegistroAtendimentoAction.do"
	...
	type="gsan.gui.atendimentopublico.registroatendimento.ReiterarRegistroAtendimentoActionForm"
	method="post"
