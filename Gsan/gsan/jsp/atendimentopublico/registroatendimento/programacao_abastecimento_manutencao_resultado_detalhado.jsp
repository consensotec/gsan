...
<%@ page import="gsan.operacional.abastecimento.AbastecimentoProgramacao"%>
<%@ page import="gsan.operacional.abastecimento.ManutencaoProgramacao"%>
...
<html:form
	...
	type="gsan.gui.atendimentopublico.registroatendimento.ResultadoDetalhadoProgramacaoAbastecimentoManutencaoActionForm"
	method="post"
