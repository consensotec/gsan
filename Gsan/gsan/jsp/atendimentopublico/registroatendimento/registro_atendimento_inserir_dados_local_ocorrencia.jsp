...
<%@ page import="gsan.atendimentopublico.registroatendimento.LocalOcorrencia" %>
	  ...
	  <tr>
		...
		<td colspan="3">
			...
			style="text-align: right;width:190px"
						onblur="javaScript:formataCoordenada(this,24,12);"
						onkeyup="javaScript:formataCoordenada(this,24,12);"
						onkeypress="return isNumericoComPontuacao(event)" />			
		</td>
	  </tr>
	  <tr>
		...
		<td colspan="3">
			...
			<html:text maxlength="25" property="nnCoordenadaLeste"
							style="text-align: right;width:190px"
						onblur="javaScript:formataCoordenada(this,24,12);"
							onkeyup="javaScript:formataCoordenada(this,24,12);"
						onkeypress="return isNumericoComPontuacao(event)"  />
