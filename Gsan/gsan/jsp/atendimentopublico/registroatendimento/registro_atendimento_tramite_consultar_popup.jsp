...
<html:form action="/exibirConsultarRegistroAtendimentoTramiteAction.do"
	...
	type="gsan.gui.atendimentopublico.registroatendimento.ConsultarRegistroAtendimentoTramiteActionForm"
	method="post">
		          						...
		          						<div align="left"> 
		              						<table width="100%" align="center" bgcolor="#99CCFF">
			                					...
			                					<c:set var="count" value="0"/>
	  			                      		  	<logic:iterate id="tramite" name="ConsultarRegistroAtendimentoTramiteActionForm" property="colecaoTramites" type="gsan.atendimentopublico.registroatendimento.Tramite" scope="session">
