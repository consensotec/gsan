...
<%@page import="gsan.atendimentopublico.registroatendimento.RaDadosAgenciaReguladora"%>
...
<html:form  action="/informarRaDadosAgenciaReguladoraAction.do" 
		name="ManutencaoRegistroActionForm" type="gsan.gui.ManutencaoRegistroActionForm">
