...
<html:form action="/exibirConsultarRegistroAtendimentoOSAction.do"
	...
	type="gsan.gui.atendimentopublico.registroatendimento.ConsultarRegistroAtendimentoOSActionForm"
	method="post">
		          						...
		          						<div align="left"> 
		              						<table width="100%" align="center" bgcolor="#99CCFF">
			                					...
			                					<c:set var="count" value="0"/>
	  			                      		  	<logic:iterate id="os" name="ConsultarRegistroAtendimentoOSActionForm" property="colecaoOS" type="gsan.atendimentopublico.ordemservico.OrdemServico" scope="session">
