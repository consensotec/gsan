...
<html:javascript staticJavascript="false" formName="InserirOcorrenciaOperacionalActionForm" />
<script language="JavaScript"
...
function validateInserirOcorrenciaOperacionalActionForm(form) {
    if (bCancel)
  return true;
    else

  return testarCampoValorZero(document.InserirOcorrenciaOperacionalActionForm.codigoMunicipio, 'Município') &&
	testarCampoValorZero(document.InserirOcorrenciaOperacionalActionForm.localidade, 'Localidade') && 
	testarCampoValorZero(document.InserirOcorrenciaOperacionalActionForm.bairro, 'Bairro') &&
	testarCampoValorZero(document.InserirOcorrenciaOperacionalActionForm.ocorrenciaTipo, 'Tipo de Ocorrência') && 
	testarCampoValorZero(document.InserirOcorrenciaOperacionalActionForm.motivoOcorrencia, 'Motivo da Ocorrência') &&
	...
	function validarForm(){
		var form = document.forms[0];
			if(validateInserirOcorrenciaOperacionalActionForm(form)){
	...
	function carregarMotivoOcorrencia(){
		var form = document.forms[0];
		form.action = 'exibirInserirOcorrenciaOperacionalAction.do';
		form.submit();
		}
	...
	function limparMunicipio() {
		var form = document.InserirOcorrenciaOperacionalActionForm;
...
<body leftmargin="5" topmargin="5"
	...
	<html:form action="/inserirOcorrenciaOperacionalAction.do" method="post"
		name="InserirOcorrenciaOperacionalActionForm"
		type="gsan.gui.atendimentopublico.registroatendimento.InserirOcorrenciaOperacionalActionForm"
		onsubmit="return validateInserirOcorrenciaOperacionalActionForm(this);">
				...
				<td width="625" valign="top" class="centercoltext">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td class="parabg">Inserir Ocorrência Operacional</td>
					...
					<table width="100%" border="0">
						...
						<tr>
							<td colspan="3">Para inserir uma ocorrência, informe os
								dados abaixo:</td>
						</tr>
						...
						<tr>
							...
							<td colspan="2"><html:text maxlength="5" property="codigoMunicipio" tabindex="1" 
									...
									onkeypress="javascript:validaEnterComMensagem(event, 'exibirInserirOcorrenciaOperacionalAction.do', 'codigoMunicipio', 'Município');" />
						...
						<tr>
							...
							<td colspan="2"><html:select property="ocorrenciaTipo" onchange="javascript:carregarMotivoOcorrencia();" tabindex="4" >
									<option value="-1"></option>
						...
						<tr>
							<td><strong>Motivo da Ocorrência:<font
									color="#ff0000">*</font> </strong></td>
							<td colspan="2"><html:select property="motivoOcorrencia" tabindex="5" >
									<option value="-1"></option>
									<html:options name="request"
						...
						<tr>
							<td height="10" width="30"><strong>Descrição da Ocorrência:<font
									color="#ff0000">*</font> </strong>
							</td>
							<td colspan="2"><strong> <html:textarea rows="5" cols="40" tabindex="6" 
										property="descricao" 
									...
									<span id="utilizadoDescricao">0</span>/<span id="limiteDescricao">200</span> </strong>
							</td>
						</tr>
						...
						<tr>
							...
							<td><html:text property="dataOcorrencia" size="10"
									...
									onblur="somente_numero(this);mascaraDataValidaDiaMesAno(this, event)"
									onkeypress="return isCampoNumerico(event);"
									readonly="false" 
									value=""/> <a
								href="javascript:abrirCalendario('InserirOcorrenciaOperacionalActionForm', 'dataOcorrencia')">
						...
						<tr>
							<td><strong>Horário da Ocorrência:<font
									color="#ff0000">*</font> </strong></td>
							<td colspan="2"><html:text property="horaOcorrencia" size="5"
							maxlength="5" tabindex="8" onkeyup="mascaraHora(this, event);" 
							/>
						...
						<tr>
							...
							<td colspan="2"><strong> <html:textarea rows="5" cols="40" tabindex="9" 
										property="areasAfetadas" 
									...
									<span id="utilizadoArea">0</span>/<span id="limiteArea">200</span> </strong>
							</td>
						</tr>
						...
						<tr>
							...
							<td><html:text property="dataPrevisao" size="10"
								...
								href="javascript:abrirCalendario('InserirOcorrenciaOperacionalActionForm', 'dataPrevisao')">
									<img border="0" src="<bean:message key="caminho.imagens"/>calendario.gif" width="20" border="0" align="absmiddle" alt="Exibir Calendário" /></a><font size="2">dd/mm/aaaa</font>
							</td>
							...
							<html:radio property="codigoPeriodoPrevisao" value="3" onmousedown="selecionarRadio(this, event);" onclick="evitarEvento(event);"/> Noite</strong>
							</td>
						</tr>
						...
						<tr>
							...
							<td><html:text property="dataReprogramacao" size="10"
									...
									onkeyup="javascript:somente_numero(this);mascaraDataValidaDiaMesAno(this, event);"
									onblur="somente_numero(this);mascaraDataValidaDiaMesAno(this, event)" /> <a
								href="javascript:abrirCalendario('InserirOcorrenciaOperacionalActionForm', 'dataReprogramacao')">
									<img border="0" src="<bean:message key="caminho.imagens"/>calendario.gif" width="20" border="0" align="absmiddle" alt="Exibir Calendário" /></a><font size="2">dd/mm/aaaa</font>
							</td>
							<td><strong> 
							...
							<html:radio property="codigoPeriodoReprogramacao" value="3" onmousedown="selecionarRadio(this, event);" onclick="evitarEvento(event);"/> Noite</strong>
							</td>
						</tr>
						...
						<tr>
							...
							<td><html:text property="dataConclusao" size="10"
									...
									onkeyup="javascript:somente_numero(this);mascaraDataValidaDiaMesAno(this, event);" 
									onblur="somente_numero(this);mascaraDataValidaDiaMesAno(this, event)"/> <a
								href="javascript:abrirCalendario('InserirOcorrenciaOperacionalActionForm', 'dataConclusao')">
									<img border="0" src="<bean:message key="caminho.imagens"/>calendario.gif"width="20" border="0" align="absmiddle" alt="Exibir Calendário" /></a><font size="2">dd/mm/aaaa</font>
							</td>
							<td><strong> 
							...
							<html:radio property="codigoPeriodoConclusao" value="3" onmousedown="selecionarRadio(this, event);" onclick="evitarEvento(event);"/> Noite</strong>
							</td>
						</tr>
						...
						<tr>
							...
							<td colspan="2"><strong> <html:textarea rows="5" cols="40" tabindex="13" 
										property="observacao" 
									...
									<span id="utilizadoObservacao">0</span>/<span id="limiteObservacao">200</span> </strong></td>
						</tr>
						...
						<tr>
							<td colspan="2"><input name="Button" type="button"
								...
								onclick="window.location.href='<html:rewrite page="/exibirInserirOcorrenciaOperacionalAction.do?menu=sim"/>'">
