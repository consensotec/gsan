...
<script language="JavaScript">
	...
	function validaTodosRadioButton() {
		...
		if (validaRadioButton(form.indicadorFaltaAgua, "Falta D'água") != "") {
			mensagem = mensagem
					+ validaRadioButton(form.indicadorFaltaAgua,
							" Falta D'água") + "\n";
		}
		if (validaRadioButton(form.indicadorTarifaSocial, "Tarifa Social") != "") {
			mensagem = mensagem
					+ validaRadioButton(form.indicadorTarifaSocial,
							"Tarifa Social") + "\n";
		}
		if (mensagem != "") {
			alert(mensagem);
		...
		window
				.open(
						...
						'top='
								...
								+ ',left='
								+ left
								+ ',location=no,screenY=0,screenX=0,menubar=no,status=no,toolbar=no,scrollbars=yes,resizable=no,width='
...
<body leftmargin="5" topmargin="5"
	...
	<html:form action="/inserirTipoSolicitacaoEspecificacaoAction"
		...
		type="gsan.gui.atendimentopublico.registroatendimento.InserirTipoSolicitacaoEspecificacaoActionForm"
		method="post">
				...
				<td width="600" valign="top" bgcolor="#003399" class="centercoltext">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td class="parabg">Inserir Tipo de Solicitação com
								Especificações</td>
					...
					<table width="100%" border="0">
						<tr>
							<td colspan="2">
								<p>Para adicionar um tipo de solicitação, informe os dados
									abaixo:</p></td>
							<logic:present scope="application" name="urlHelp">
								<td align="right"><a
									href="javascript:abrirPopupHelp('${applicationScope.urlHelp}atendimentoRegistroTipoSolicitacaoEspecificacoesInserir', 500, 700);"><span
						...
						<tr>
							<td width="40%"><strong>Descrição do Tipo de
									Solicitação:<font color="#FF0000">*</font><strong>
							</td>
						...
						<tr>
							<td><strong>Grupo de Solicitação do Tipo:<font
									color="#FF0000">*</font>
							</strong>
							</td>
							<td><html:select property="idgrupoTipoSolicitacao"
									tabindex="2">
						...
						<tr>
							<td width="40%"><strong>Falta D'água:<font
									color="#FF0000">*</font>
							</strong>
							</td>
						...
						<tr>
							<td width="40%"><strong>Tarifa Social:<font
									color="#FF0000">*</font>
							</strong>
							</td>
						...
						<tr>
							<td width="40%"><strong>Uso Sistema:<font
									color="#FF0000">*</font>
							</strong>
							</td>
							<td><logic:present
									name="temPermissaoAlterarIndicadorUsoSistemaTipoSolicitacao">
									<html:radio property="indicadorUsoSistema" value="1"
										tabindex="5" />
									<strong>Sim</strong>&nbsp; 
							<html:radio property="indicadorUsoSistema" value="2" tabindex="6" />
									...
									<html:radio property="indicadorUsoSistema" value="1"
										disabled="true" />
									<strong>Sim</strong>&nbsp; 
							<html:radio property="indicadorUsoSistema" value="2"
										disabled="true" />
									<strong>N&atilde;o</strong>
						...
						<tr>
							...
							<td align="right"><input type="button" name="Submit24"
								...
								onClick="javascript:abrirPopupComSubmit(document.forms[0], 600, 800);"
								tabindex="7">
							</td>
						</tr>
							...
							<td colspan="2">
								<table width="100%" cellpadding="0" cellspacing="0">
									<tr bordercolor="#000000">
										...
										<td bgcolor="#90c7fc" width="80%"><strong>Descrição
												da Especificação</strong>
										</td>
									</tr>
													...
													<table width="100%" bgcolor="#99CCFF">
														...
														<logic:iterate name="colecaoSolicitacaoTipoEspecificacao"
															...
															<tr bgcolor="#FFFFFF">
																...
																<td width="80%"><a
																	href="javascript:document.forms[0].target='';abrirPopup('exibirAdicionarSolicitacaoEspecificacaoAction.do?editar=<bean:write name="solicitacaoTipoEspecificacao" property="idHelper"/>&ultimaAlteracao=<bean:write name="solicitacaoTipoEspecificacao" property="ultimaAlteracao.time"/>',710,440);">
					...
					<table width="100%" border="0">
						<tr>
							...
							<td valign="top">
								<div align="right">
									<input name="botaoInserir" type="button" class="bottonRightCol"
