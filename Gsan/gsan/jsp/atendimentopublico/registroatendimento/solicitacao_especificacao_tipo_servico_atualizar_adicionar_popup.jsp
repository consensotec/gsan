...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false"  formName="AtualizarAdicionarSolicitacaoEspecificacaoActionForm" />
...
function validarForm(form){
 ...
 if(validateCriterioCobrancaActionForm(form)){
    form.action="atualizarAdicionarSolicitacaoEspecificacaoTipoServicoAction.do";    
...
function desfazer(){
 ...
 form.action ="exibirAtualizarAdicionarSolicitacaoEspecificacaoTipoServicoAction.do?limpaSessao=1";
 submeterFormPadrao(form);
}

function voltar(){
 form = document.forms[0];
 form.action ="exibirAtualizarAdicionarSolicitacaoEspecificacaoAction.do";
 submeterFormPadrao(form);
}
...
<html:form action="/atualizarAdicionarSolicitacaoEspecificacaoTipoServicoAction"
	name="AtualizarAdicionarSolicitacaoEspecificacaoActionForm"
	type="gsan.gui.atendimentopublico.registroatendimento.AtualizarAdicionarSolicitacaoEspecificacaoActionForm"
	method="post">
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><html:text maxlength="4" property="idTipoServico" size="4"
						tabindex="20"
						onkeypress="javascript:validaEnterComMensagem(event, 'exibirAtualizarAdicionarSolicitacaoEspecificacaoTipoServicoAction.do?objetoConsulta=1', 'idTipoServico', 'Tipo do Serviço');"
						onkeyup="javascript:document.forms[0].descricaoTipoServico.value = '';"/>
					<a
						href="javascript:redirecionarSubmit('recuperarDadosPesquisarAdicionarSolicitacaoEspecificacaoTipoServicoAction.do?caminhoRetornoTelaPesquisaServicoTipo=exibirAtualizarAdicionarSolicitacaoEspecificacaoTipoServicoAction&limpar=1');">
					<img width="23" height="21" border="0"
						...
						name="idTipoServicoNaoEncontrado">
						<logic:empty name="AtualizarAdicionarSolicitacaoEspecificacaoActionForm"
							property="idTipoServico">
							<html:text property="descricaoTipoServico" value="" size="40"
								maxlength="30" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #ff0000" />
						</logic:empty>
						<logic:notEmpty name="AtualizarAdicionarSolicitacaoEspecificacaoActionForm"
							property="idTipoServico">
							<html:text property="descricaoTipoServico" size="40"
								maxlength="30" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000" />
