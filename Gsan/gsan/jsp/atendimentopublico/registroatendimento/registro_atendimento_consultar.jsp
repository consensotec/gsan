...
<%@ page import="gsan.atendimentopublico.registroatendimento.RegistroAtendimentoConta"%>
<%@ page import="gsan.atendimentopublico.registroatendimento.RegistroAtendimentoPagamentoDuplicidade"%>
<%@ page import="java.math.BigDecimal,gsan.util.Util" %>
<%@ page import="java.text.SimpleDateFormat"%>
<%@ page import="gsan.atendimentopublico.bean.DadosRAReiteracaoHelper"%>
...
<html:form action="/exibirConsultarRegistroAtendimentoAction.do"
	...
	type="gsan.gui.atendimentopublico.registroatendimento.ConsultarRegistroAtendimentoActionForm"
	method="post">
																...
																<logic:iterate name="colecaoRAContas"
																	...
																	<c:choose>
																		...
																		<td align="center" width="40%">
																			...
																			<logic:present name="contaGeral" property="conta">
																				<bean:write name="contaGeral"
																					property="conta.dataVencimentoConta" format="dd/MM/yyyy" />
																			</logic:present>
																			
																			<logic:notPresent name="contaGeral" property="conta">
																				<bean:write name="contaGeral"
																					property="contaHistorico.dataVencimentoConta" format="dd/MM/yyyy" />
																			</logic:notPresent>	
																		</td>
																		<td align="center" width="30%">
																			<logic:present name="contaGeral" property="conta">
																				<bean:define name="contaGeral" property="conta.valorTotalContaBigDecimal" id="valorTotalContaBigDecimal"/>
																				<%= Util.formatarMoedaReal((BigDecimal)valorTotalContaBigDecimal) %>
																			</logic:present>
																			
																			<logic:notPresent name="contaGeral" property="conta">
																				<bean:define name="contaGeral" property="contaHistorico.valorTotalContaBigDecimal" id="valorTotalContaBigDecimal"/>
																				<%= Util.formatarMoedaReal((BigDecimal)valorTotalContaBigDecimal) %>
																			</logic:notPresent>									
																		</td>
																	</tr>
		                               	...
		                               	<tr>
		                                 	...
		                                 	<td>
												<html:text property="numeroCoordenadaNorte" readonly="true"
													style="background-color:#EFEFEF; border:0; text-align: right;width:190px" size="12"
													maxlength="25" />
		                                 	</td>
		                               	</tr>
