...
<%@ page import="gsan.atendimentopublico.bean.OcorrenciaOperacionalHelper"%>
...
<html:form action="/inserirRegistroAtendimentoSimplificadoAction"
	...
	type="gsan.gui.atendimentopublico.registroatendimento.InserirRegistroAtendimentoSimplificadoActionForm"
	method="post">
