...
<script language="JavaScript">
	...
	function validarForm() {
		...
		if (validateEncerrarRegistroAtendimentoActionForm(form)) {
			if ((raReferenciaEnabled && 
				...
				alert('Informe o Número de RA de Referência.');
			}
		}
	}
	...
	/* Limpar Número RA de Referência */
...
<html:form action="/encerrarRegistroAtendimentoAction.do"
	...
	type="gsan.gui.atendimentopublico.registroatendimento.EncerrarRegistroAtendimentoActionForm"
	method="post">
                								...
                								<span class="style2">
                									<strong>
														<html:text property="numeroRAReferencia" size="9" maxlength="9"
							   									   onkeypress="javascript:validaEnterComMensagem(event, 'exibirEncerrarRegistroAtendimentoAction.do?validaNumeroRAReferencia=true', 'numeroRAReferencia','Número do RA de Referência');"/>
				...
				<tr bgcolor="#cbe5fe">
           			<td align="center">
	    				...
	    				<tr bgcolor="#99CCFF">
                     		<td align="center">
                   				<span class="style2">
                    					<b>Dados da Geração do Débito</b>
                   				</span>
                     		</td>
                    	</tr>
                    	...
                    	<tr bgcolor="#cbe5fe">
							<td>
								<table border="0" width="100%">
								<tr>
									<td height="10"><strong>Tipo de Débito:</strong></td>
