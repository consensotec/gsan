...
<script language="JavaScript">
	...
	function validaForm() {
		...
		if(validaCombo()){
    		...
    		form.action='exibirInserirEspecificacaoSituacaoCriterioImovelAction.do?tipoOperacao=I';
	    	form.submit();
...
<logic:present name="fechaPopup" scope="request">
	<body leftmargin="0" topmargin="0" onload="chamarReload('exibirAtualizarEspecificacaoSituacaoImovelAction.do?tipoOperacao=I');window.close()">
</logic:present>


<html:form action="/exibirInserirEspecificacaoSituacaoCriterioImovelAction.do"
	name="AtualizarEspecificacaoSituacaoImovelActionForm"
	type="gsan.gui.atendimentopublico.registroatendimento.AtualizarEspecificacaoSituacaoImovelActionForm"
	method="post">
