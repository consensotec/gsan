...
<%@ page import="gsan.gui.GcomAction"%>
<%@ page import="gsan.atendimentopublico.registroatendimento.RegistroAtendimentoAnexo"%>
...
<html:javascript staticJavascript="false"  formName="AtualizarRegistroAtendimentoActionForm" dynamicJavascript="false" />
...
function adicionarArquivo(){
	...
	form.target = "";
	form.action = "exibirAtualizarRegistroAtendimentoAnexosAction.do?adicionar=OK";
...
function removerArquivo(identificacao){
	...
	var form = document.forms[0];
	form.target = "";
	form.action = "exibirAtualizarRegistroAtendimentoAnexosAction.do?remover=" + identificacao;
...
function visualizarArquivo(identificacao){
	...
	var form = document.forms[0];
	form.target = "_new";
	form.action = "exibirAtualizarRegistroAtendimentoAnexosAction.do?visualizar=" + identificacao;
...
function atualizarObservacao(identificacao){
	...
	abrirPopup('exibirAtualizarRegistroAtendimentoObservacaoArquivoAnexoAction.do?telaRetorno=exibirAtualizarRegistroAtendimentoAnexosAction&idRegistroAtendimentoAnexo=' + identificacao, 350, 620);
...
<body leftmargin="5" topmargin="5" onload="setarFoco('${requestScope.nomeCampo}'); limitTextArea(document.forms[0].observacaoAnexo, 200, document.getElementById('utilizado'), document.getElementById('limite'));">

<div id="formDiv">

<form ACTION="" name="AtualizarRegistroAtendimentoActionForm" method="post" enctype="multipart/form-data">
...
<table width="770" border="0" cellspacing="5" cellpadding="0">
  <tr>
	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <tr>
		<td height="10"></td>
		<td><font color="#FF0000">*</font>&nbsp; Serão aceitos, apenas os arquivos nos formatos: JPG, DOC, DOCX, XLS, XLSX ou PDF</td>
	  </tr>
												...
												<td width="80%">
													...
													<% if (cont % 2 == 0) {%>
														...
														<logic:present name="registroAtendimentoAnexo" property="descricaoDocumento">
															...
															<TEXTAREA ROWS="2" COLS="55" style="cursor:hand; border:0px solid; background-color: #cbe5fe; font-color: #000000" readonly><bean:write name="registroAtendimentoAnexo" property="descricaoDocumento" /></TEXTAREA></a>
													...
													<%} else {%>
														...
														<logic:present name="registroAtendimentoAnexo" property="descricaoDocumento">
															...
															<a href="javascript:atualizarObservacao('<%="" + GcomAction.obterTimestampIdObjeto(registroAtendimentoAnexo) %>')">
															<TEXTAREA ROWS="2" COLS="55" style="cursor:hand; border:0px solid; background-color: #ffffff; font-color: #000000" readonly><bean:write name="registroAtendimentoAnexo" property="descricaoDocumento" /></TEXTAREA></a>
														...
														<logic:notPresent name="registroAtendimentoAnexo" property="descricaoDocumento">
															...
															<a href="javascript:atualizarObservacao('<%="" + GcomAction.obterTimestampIdObjeto(registroAtendimentoAnexo) %>')">
															<TEXTAREA ROWS="2" COLS="55" style="border:0px solid; background-color: #ffffff" readonly></TEXTAREA></a>
      ...
      <tr>
        <td colspan="2">
			<div align="right">
				<jsp:include page="/jsp/util/wizard/navegacao_botoes_wizard_valida_avancar_ra_aba_anexo.jsp?numeroPagina=4"/>
			</div>
		</td>
      </tr>
      </table>
