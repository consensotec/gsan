...
<html:form action="/exibirConsultarRegistroAtendimentoSolicitanteAction" 
	...
	type="gsan.gui.atendimentopublico.registroatendimento.ConsultarRegistroAtendimentoSolicitanteActionForm"
	method="post">
			                					...
			                					<c:set var="count" value="0"/>
	                      		  				<c:set var="checked" value="false"/>
	  			                      		  	...
	  			                      		  	<logic:iterate id="solicitante" 
	  			                      		  		...
	  			                      		  		type="gsan.atendimentopublico.registroatendimento.RegistroAtendimentoSolicitante" 
	  			                      		  		scope="session">
