...
<html:form action="/gerarRelatorioContratoPrestacaoServicoAction"
	...
	type="gsan.gui.atendimentopublico.GerarContratoPrestacaoServicoActionForm"
										...
										<logic:notEmpty name="imovelClientes">
											<logic:iterate name="imovelClientes" id="imovelCliente"
												...
												<tr bgcolor="#FFFFFF">
													...
													name="idCliente"
													value="<bean:write name="imovelCliente" property="cliente.id" />|<bean:write name="imovelCliente" property="clienteRelacaoTipo.id"/>"></div>
													</td>
