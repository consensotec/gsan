...
<html:form action="/inserirPerfilLigacaoEsgotoAction.do"
	...
	type="gsan.gui.atendimentopublico.InserirPerfilLigacaoEsgotoActionForm" method="post"
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Perfil da Ligação de Esgoto</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td colspan="2">Para adicionar um perfil de ligação de esgoto, informe os dados abaixo:</td>
				</tr>
				<tr>
