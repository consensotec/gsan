...
<html:form action="/gerarCertidaoNegativaAction.do"
	...
	type="gsan.gui.atendimentopublico.GerarCertidaoNegativaActionForm"
	method="post">
				...
				<tr>
					...
					<td>
						<html:text
							...
							onkeypress="validaEnterComMensagem(event, 'exibirGerarCertidaoNegativaAction.do?objetoConsulta=1','idImovel','Matrícula do Imóvel');return isCampoNumerico(event);"/>
						<a
