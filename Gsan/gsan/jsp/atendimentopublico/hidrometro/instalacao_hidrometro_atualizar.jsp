...
<html:form action="/atualizarInstalacaoHidrometroAction.do"
	...
	type="gsan.gui.atendimentopublico.hidrometro.AtualizarInstalacaoHidrometroActionForm"
	method="post"
								...
								<tr bgcolor="#cbe5fe">
									...
									<table border="0" width="100%">
										...
										<tr>
											...
											<label> <html:radio property="medicaoTipo" value="3"
												onclick="javascript:reload();" /> <strong>LIGAÇÃO DE ESGOTO</strong></label>
											</p>
											</td>
										</tr>
