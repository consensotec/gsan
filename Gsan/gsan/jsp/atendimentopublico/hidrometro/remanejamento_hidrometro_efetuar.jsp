...
<html:javascript staticJavascript="false" formName="EfetuarRemanejamentoHidrometroActionForm" />
...
<body leftmargin="5" topmargin="5" onload="javascript:verificaForm();setarFoco('${requestScope.nomeCampo}');">
	<html:form action="/exibirEfetuarRemanejamentoHidrometroAction.do"
		name="EfetuarRemanejamentoHidrometroActionForm" method="post"
		type="gsan.gui.atendimentopublico.hidrometro.EfetuarRemanejamentoHidrometroActionForm">
		...
		<logic:notPresent name="semMenu">
			...
			<table width="770" border="0" cellspacing="5" cellpadding="0">
				...
				<table width="100%" border="0">
					<tr>
						<td height="31">
							<table width="100%" border="0" align="center">
								<tr>
									<td height="10" colspan="2">Para efetuar o remanejamento do hidrômetro, informe os dados abaixo:.</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										...
										<a href="javascript:chamarPopup('exibirPesquisarOrdemServicoAction.do', 'ordemServico', null, null, 600, 500, '',document.forms[0].idOrdemServico);">
											<img width="23" height="21" border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif" title="Pesquisar OS" /></a>
										<logic:present name="OrdemServicoInexistente">
											<html:text property="nomeOrdemServico" readonly="true" style="background-color:#EFEFEF; border:0; color: #ff0000" size="45" maxlength="45" />
										</logic:present>
										<logic:notPresent name="OrdemServicoInexistente">
											<html:text property="nomeOrdemServico" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" size="45" maxlength="45" />
										</logic:notPresent>
											<a href="javascript:limparForm();"> <img border="0" title="Apagar" src="<bean:message key='caminho.imagens'/>limparcampo.gif" /></a>
									</td>
								</tr>
								<tr bgcolor="#cbe5fe">
											...
											<tr bgcolor="#cbe5fe">
												<td>
													<table border="0" width="100%">
														<tr>
															<td width="38%" height="10"><strong>Matr&iacute;cula do Im&oacute;vel:</strong></td>
															<td>
														...
														<tr>
															...
															<td>
																<html:text property="clienteUsuario" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" size="40" maxlength="40" />
															</td>
														</tr>
														<tr>
															<td><strong>CPF ou CNPJ:</strong></td>
															<td>
																<html:text property="cpfCnpjCliente" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" size="40" maxlength="40" />
															</td>
														</tr>
														<tr>
															<td><strong>Situa&ccedil;&atilde;o da Liga&ccedil;&atilde;o de &Aacute;gua:</strong></td>
															<td>
																<html:text property="situacaoLigacaoAgua" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" size="40" maxlength="40" />
															</td>
														</tr>
														<tr>
															<td><strong>Situa&ccedil;&atilde;o da Liga&ccedil;&atilde;o de Esgoto:</strong></td>
															<td><html:text property="situacaoLigacaoEsgoto" readonly="true" style="background-color:#EFEFEF; border:0; color: #000000" size="40" maxlength="40" /></td>
														</tr>
													</table>
												</td>
											</tr>
								...
								<tr bgcolor="#cbe5fe">
									<td align="center" colspan="2">
										<table width="100%" border="0" bgcolor="#99CCFF">
											<tr bgcolor="#99CCFF">
												<td height="18" colspan="2">
													<div align="center">Dados do Remanejamento do Hidr&ograve;metro</div>
												</td>
											</tr>
											<tr bgcolor="#cbe5fe">
												<td>
													<table border="0" width="100%">
														<tr>
															<td width="38%"><strong>N&uacute;mero do Hidr&ocirc;metro:</strong></td>
															<td>
																<strong><html:text property="hidrometro" readonly="true" style="background-color:#EFEFEF; border:0;" size="15" maxlength="15" /></strong>
															</td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td>
																<html:radio property="tipoMedicao" disabled="true" value="1" /><strong>LIGAÇÃO DE ÁGUA</strong>
																<html:radio property="tipoMedicao" disabled="true" value="2" /><strong>POÇO</strong>
																<html:radio property="tipoMedicao" disabled="true" value="3" /><strong>LIGAÇÃO DE ESGOTO</strong>
															</td>
														</tr>
														<tr>
															<td>
																<strong>Local de Instalação:<font color="#FF0000">*</font></strong>
															</td>
															<td>
														...
														<tr>
															...
															<td>
																<html:radio property="tipoCavalete" value="1" /><strong>COM</strong>
																<html:radio property="tipoCavalete" value="2" /><strong>SEM</strong>
															</td>
														</tr>
													</table>
												</td>
					...
					<logic:notEmpty name="EfetuarRemanejamentoHidrometroActionForm" property="idTipoDebito">
						<tr>
							<td height="31">
								<table width="100%" border="0" align="center">
									<tr bgcolor="#cbe5fe">
														...
														<table border="0" width="100%">
															...
															<logic:notEqual name="EfetuarRemanejamentoHidrometroActionForm" property="alteracaoValor" value="OK">
																<tr>
																	...
																	<td colspan="2">
																		<strong> <!--Campo Seleção Diametro de Ligação -->
																			<html:text property="valorDebito" readonly="true" style="background-color:#EFEFEF; border:0; text-align: right;" size="15" maxlength="15" />
																		</strong>
																	</td>
																</tr>
															</logic:notEqual>
															<logic:equal name="EfetuarRemanejamentoHidrometroActionForm" property="alteracaoValor" value="OK">
																<tr>
																	...
																	<td colspan="2">
																		<strong> <!--Campo Seleção Diametro de Ligação -->
																			<html:text property="valorDebito" style="text-align: right;" size="15" maxlength="15" />
																		</strong>
																	</td>
																</tr>
															</logic:equal>
																		...
																		<strong> <!-- Campo Material Ligação -->
																			<html:select property="motivoNaoCobranca" style="width: 230px;" onchange="habilitarQtdParcelaButton();">
																				...
																				<logic:present name="colecaoNaoCobranca">
																					<html:options collection="colecaoNaoCobranca" labelProperty="descricao" property="id" />
																				</logic:present>
																			</html:select>
																		</strong>
																	</td>
							...
							<table width="100%">
								...
								<tr>
									<td width="40%" align="left">
										...
										<input type="button" name="ButtonReset" class="bottonRightCol" value="Desfazer" onClick="limparForm();">
									...
									<td align="right">
										<input name="Button" type="button" class="bottonRightCol" value="Efetuar" onClick="javascript:validarForm(document.forms[0]);">
									</td>
								</tr>
							</table>
						</td>
