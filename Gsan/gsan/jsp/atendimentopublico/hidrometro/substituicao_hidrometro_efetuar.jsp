...
<script language="JavaScript">
	...
	function limparForm() {
		...
		form.tipoMedicao[2].checked = false;	
...
<html:form action="/efetuarSubstituicaoHidrometroAction.do"
	...
	type="gsan.gui.atendimentopublico.hidrometro.EfetuarSubstituicaoHidrometroActionForm"
	method="post">
												...
												<tr bgcolor="#cbe5fe">
													...
													<table border="0" width="100%">
														...
														<tr>
															...
															<td><strong>
															 <html:radio property="tipoMedicao" value="1" disabled="true" /> <strong>LIGAÇÃO DE ÁGUA
															 <html:radio property="tipoMedicao" value="2" disabled="true" /> <strong>POÇO
															 <html:radio property="tipoMedicao" value="3" disabled="true" /> <strong>LIGAÇÃO DE ESGOTO</strong> </strong>															
															</td>
														</tr>
														<tr>
