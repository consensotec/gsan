...
<html:form action="/efetuarCorteLigacaoAguaAction.do"
	...
	type="gsan.gui.atendimentopublico.EfetuarCorteLigacaoAguaActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Efetuar Corte de Ligação de Água</td>
					<td width="11"><img border="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center">
						<tr>
							...
							água, informe os dados abaixo:.</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><span class="style2"> <!-- Campo Ordem de Serviço --> <html:text
								...
								onkeypress="javascript:validaEnterComMensagem(event, 'exibirEfetuarCorteLigacaoAguaAction.do', 'idOrdemServico','Ordem de Serviço');"
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								...
								<tr bgcolor="#cbe5fe">
									...
									<table border="0" width="100%">
										...
										<tr>
											<td class="style3">
												<strong>Número do Selo do Corte:<span class="style2"></span></strong>
											</td>
											<td colspan="2">
											<strong> 
									...
									<tr bgcolor="#cbe5fe">
										...
										<table border="0" width="100%">
											...
											<logic:notPresent name="permissaoMotivoNaoCobranca">
												...
												<tr>
													<td class="style3">
														<strong>Percentual de Cobrança: <font olor="#FF0000">*</font></strong>
													</td>
													<td colspan="2">
