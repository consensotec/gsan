		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><html:radio property="indicadorFaturarConsumoReal" value="1" tabindex="5"/> <strong>Sim 
					<html:radio property="indicadorFaturarConsumoReal" value="2" tabindex="6"/> Não</strong>
					</td>
				</tr>
				
				<tr>
					<td><strong>Indicador de só Faturar com Leitura Real: <font	color="#FF0000">*</font></strong></td>
					<td><html:radio property="indicadorFaturarLeituraReal" value="1" tabindex="5"  /> <strong>Sim 
					<html:radio property="indicadorFaturarLeituraReal" value="2" tabindex="6"/> Não</strong>
					</td>
				</tr>
