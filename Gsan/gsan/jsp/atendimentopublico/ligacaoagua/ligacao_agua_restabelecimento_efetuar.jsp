...
<script language="JavaScript">
	...
	function validarForm(form){
		...
		urlRedirect = "/gsan/efetuarRestabelecimentoLigacaoAguaAction.do";
   		...
   		if(testarCampoValorZero(document.EfetuarRestabelecimentoLigacaoAguaActionForm.idOrdemServico, 'Ordem de Serviço')&& 
   			testarCampoValorZero(document.EfetuarRestabelecimentoLigacaoAguaActionForm.matriculaImovel, 'Matrícula do imóvel')&&
  	 		testarCampoValorZero(document.EfetuarRestabelecimentoLigacaoAguaActionForm.inscricaoImovel, 'Inscrição do Imóvel')&&
   			testarCampoValorZero(document.EfetuarRestabelecimentoLigacaoAguaActionForm.clienteUsuario, 'Usuário')&&
   			testarCampoValorZero(document.EfetuarRestabelecimentoLigacaoAguaActionForm.cpfCnpjCliente, 'cpfCnpjCliente')&&
   			testarCampoValorZero(document.EfetuarRestabelecimentoLigacaoAguaActionForm.situacaoLigacaoAgua, 'Situação da Ligacao Agua')&& 
   			testarCampoValorZero(document.EfetuarRestabelecimentoLigacaoAguaActionForm.situacaoLigacaoEsgoto, 'Situação da Ligacao Esgoto')) {
...
<html:form action="/exibirEfetuarRestabelecimentoLigacaoAguaAction.do"
	...
	type="gsan.gui.atendimentopublico.EfetuarRestabelecimentoLigacaoAguaActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Efetuar Restabelecimento de Ligação de Água</td>
					<td width="11"><img border="0"
					...
					<table width="100%" border="0" align="center">
						...
						<tr>
							...
							<td><html:text property="idOrdemServico" size="8" maxlength="9"
								onkeypress="javascript:limparOrdemServicoTecla();validaEnterComMensagem(event, 'exibirEfetuarRestabelecimentoLigacaoAguaAction.do', 'idOrdemServico','Ordem de Serviço');"
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								<tr bgcolor="#99CCFF">
									...
									Restabelecimento de Água</span></div>
									</td>
								</tr>
								<tr bgcolor="#cbe5fe">
									<td>
									...
									<tr bgcolor="#cbe5fe">
										...
										<table border="0" width="100%">
											...
											<logic:present name="permissaoMotivoNaoCobranca">
												<tr>
													<td class="style3"><strong>Motivo da Não Cobrança:<font color="#FF0000">*</font></strong></td>
