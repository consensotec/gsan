...
<script language="JavaScript">
    ...
    function caracteresespeciais () { 
     this.aa = new Array("idOrdemServico", "Ordem de Serviço possui caracteres especiais.", new Function ("varName", " return this[varName];"));
    } 

    function required () { 
     this.aa = new Array("idOrdemServico", "Informe Ordem de Serviço.", new Function ("varName", " return this[varName];"));
    } 

    function IntegerValidations () { 
     this.aa = new Array("idOrdemServico", "Ordem de Serviço deve ser numérico(a).", new Function ("varName", " return this[varName];"));
    } 

    function IntegerValidations () { 
     this.aa = new Array("idOrdemServico", "Ordem de Serviço deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
    }
...
function redirecionaSubmit(caminhoAction) {
 ...
 function validarForm(form){
  ...
  if((document.EfetuarCorteAdministrativoLigacaoAguaActionForm.tipoCorte, 'Tipo do Corte') && 
   testarCampoValorZero(document.EfetuarCorteAdministrativoLigacaoAguaActionForm.idOrdemServico, 'Ordem de Serviço')&& 
   testarCampoValorZero(document.EfetuarCorteAdministrativoLigacaoAguaActionForm.matriculaImovel, 'Matrícula do imóvel')&&
   testarCampoValorZero(document.EfetuarCorteAdministrativoLigacaoAguaActionForm.inscricaoImovel, 'Inscrição do Imóvel')&&
   testarCampoValorZero(document.EfetuarCorteAdministrativoLigacaoAguaActionForm.clienteUsuario, 'Usuário')&&
   testarCampoValorZero(document.EfetuarCorteAdministrativoLigacaoAguaActionForm.cpfCnpjCliente, 'cpfCnpjCliente')&&
   testarCampoValorZero(document.EfetuarCorteAdministrativoLigacaoAguaActionForm.situacaoLigacaoAgua, 'Situação da Ligacao Agua')&& 
   testarCampoValorZero(document.EfetuarCorteAdministrativoLigacaoAguaActionForm.dataCorte, 'Data do Corte Administrativo')&& 
   testarCampoValorZero(document.EfetuarCorteAdministrativoLigacaoAguaActionForm.situacaoLigacaoEsgoto, 'Situação da Ligacao Esgoto')) {
...
<html:form
	...
	type="gsan.gui.atendimentopublico.ligacaoagua.EfetuarCorteAdministrativoLigacaoAguaActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Efetuar Corte Administrativo da Ligação de Água</td>
					<td width="11"><img border="0"
				...
				<tr>
					...
					<table width="100%" border="0" align="center">
						<tr>
							...
							da ligação de água, informe os dados abaixo:</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><span class="style2"> <html:text property="idOrdemServico"
								size="8" maxlength="9"
								onkeypress="javascript:limparOrdemServicoTecla();validaEnterComMensagem(event, 'exibirEfetuarCorteAdministrativoLigacaoAguaAction.do', 'idOrdemServico','Ordem de Serviço');" />
						...
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								<tr bgcolor="#99CCFF">
									...
									Administrativo da Ligação de Água</span></div>
									</td>
								</tr>
								<tr bgcolor="#cbe5fe">
									<td>
