...
<html:form action="/filtrarLigacaoAguaSituacaoAction"
	...
	type="gsan.gui.atendimentopublico.FiltrarLigacaoAguaSituacaoActionForm"
	method="post"
			...
			<table width="100%" border="0">
		       ...
		       <tr>
				...
				<tr>
					...
					<html:radio property="indicadorPermissaoCorteEsgoto" tabindex="3" value="<%=ConstantesSistema.INDICADOR_USO_DESATIVO.toString()%>" /><strong>Não</strong>
