...
<html:form action="/efetuarLigacaoAguaAction.do"
	...
	type="gsan.gui.atendimentopublico.EfetuarLigacaoAguaActionForm"
	method="post">
										...
										<logic:equal name="efetuarLigacaoAguaSemRA" value="true">
											<tr>
												...
												<td colspan="2"><html:text property="idImovel" size="10"
													...
													onkeypress="validaEnterComMensagem(event, 'exibirEfetuarLigacaoAguaAction.do', 'idImovel', 'Matrícula do Imóvel');"
