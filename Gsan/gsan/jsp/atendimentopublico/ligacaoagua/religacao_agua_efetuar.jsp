...
<script language="JavaScript">
   ...
   if(testarCampoValorZero(document.EfetuarReligacaoAguaActionForm.idOrdemServico, 'Ordem de Serviço')&& 
   testarCampoValorZero(document.EfetuarReligacaoAguaActionForm.matriculaImovel, 'Matrícula do imóvel')&&
   testarCampoValorZero(document.EfetuarReligacaoAguaActionForm.inscricaoImovel, 'Inscrição do Imóvel')&&
   testarCampoValorZero(document.EfetuarReligacaoAguaActionForm.clienteUsuario, 'Usuário')&&
   testarCampoValorZero(document.EfetuarReligacaoAguaActionForm.cpfCnpjCliente, 'cpfCnpjCliente')&&
   testarCampoValorZero(document.EfetuarReligacaoAguaActionForm.situacaoLigacaoAgua, 'Situação da Ligacao Agua')&& 
   testarCampoValorZero(document.EfetuarReligacaoAguaActionForm.situacaoLigacaoEsgoto, 'Situação da Ligacao Esgoto')) {
...
<html:form action="/exibirEfetuarReligacaoAguaAction.do"
	...
	type="gsan.gui.atendimentopublico.EfetuarReligacaoAguaActionForm"
	method="post">
						...
						<tr>
							...
							<table width="100%" border="0" align="center" cellpadding="0"
								...
								<tr>
									...
									<td class="parabg">Efetuar Religação de Ligação de Água</td>
									<td width="11"><img border="0"
							...
							<table width="100%" border="0">
								<tr>
									...
									<table width="100%" border="0" align="center">
										<tr>
											<td height="10" colspan="2">Para efetuar a religação de água, 
										...
										<tr>
											...
											<td><html:text property="idOrdemServico" size="8"
												maxlength="9"
												onkeypress="javascript:limparOrdemServicoTecla();validaEnterComMensagem(event, 'exibirEfetuarReligacaoAguaAction.do', 'idOrdemServico','Ordem de Serviço');" />
										...
										<tr bgcolor="#cbe5fe">
											...
											<table width="100%" border="0" bgcolor="#99CCFF">
												<tr bgcolor="#99CCFF">
													...
													<td height="18" colspan="2">
													<div align="center">Dados da Religação de Água</div>
													</td>
												</tr>
												<tr bgcolor="#cbe5fe">
													<td>
													<table border="0" width="100%">
														...
														<tr>
															...
															<td width="39%" height="10"><strong>Data da Religação:<span
											...
											<tr bgcolor="#cbe5fe">
												...
												<table width="100%" border="0" bgcolor="#99CCFF">
													...
													<tr bgcolor="#cbe5fe">
														...
														<table border="0" width="100%">
															<tr>
																<td width="39%" height="10"><strong>Tipo de Débito:<span
															...
															<logic:notEqual name="EfetuarReligacaoAguaActionForm" property="alteracaoValor" value="OK">
																<tr>
																	<td>Valor do Débito:<font color="#FF0000">*</font></td>
																	<td colspan="2"> 
															...
															<logic:present name="permissaoMotivoNaoCobranca">
																<tr>
																	<td class="style3">Motivo da Não Cobrança:<font color="#FF0000">*</font></td>
																...
																<tr>
																	<td class="style3">Percentual de Cobrança:<font color="#FF0000">*</font></td>
																	<td colspan="2">
