...
<body leftmargin="5" topmargin="5" onload="setarFoco('descricao');">
	<html:form action="/inserirLigacaoAguaSituacaoAction.do"
		...
		type="gsan.gui.atendimentopublico.ligacaoagua.InserirLigacaoAguaSituacaoActionForm"
		method="post"
...
<table>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Indicador de só Faturar com Consumo Real: <font color="#FF0000">*</font></strong></td>
					<td><strong> <html:radio property="indicadorFaturarConsumoReal"
						value="<%=""+ConstantesSistema.SIM%>" onclick="verificarRadioButton()"/> <strong>Sim <html:radio
						property="indicadorFaturarConsumoReal"
						value="<%=""+ConstantesSistema.NAO%>"  onclick="verificarRadioButton()"/> Não</strong> </strong></td>
				</tr>
				<tr>
					<td><strong>Indicador de só Faturar com Leitura Real: <font color="#FF0000">*</font></strong></td>
					<td><strong> <html:radio property="indicadorFaturarLeituraReal"
						value="<%=""+ConstantesSistema.SIM%>" /> <strong>Sim <html:radio
						property="indicadorFaturarLeituraReal"
						value="<%=""+ConstantesSistema.NAO%>" /> Não</strong> </strong></td>
				</tr>
