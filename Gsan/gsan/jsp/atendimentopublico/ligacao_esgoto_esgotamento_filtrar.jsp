...
<html:form action="/filtrarLigacaoEsgotoEsgotamentoAction"
	...
	type="gsan.gui.atendimentopublico.FiltrarLigacaoEsgotoEsgotamentoActionForm"
	method="post"
	...
	<!--Início Tabela Reference a Páginação da Tela de Processo-->
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<td class="parabg">Filtrar Ligação de Esgoto Esgotamento</td>
				...
				<tr>
						...
						<td colspan="2">Para filtrar a(s) ligação(oes) de esgoto esgotamento, informe o dado abaixo:</td>
				...
				<tr>
					<td><strong>Quantidade de Meses para Situação Esoecial de Faturamento:</strong></td>
					<td colspan="2"><span class="style2"> <html:text
