...
<script>
   function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	...
	function refresh(){
		var form = document.forms[0];
		form.action = 'exibirInformarAssociacaoSituacaoCobrancaAction.do';
		form.submit();
	}
</script>
...
<html:form action="/informarAssociacaoSituacaoCobrancaAction.do"
	...
	type="gsan.gui.atendimentopublico.InformarTramiteAssociacaoSituacaoCobrancaActionForm"
	method="post">
       ...
       <table width="100%" border="0">
			...
			<logic:notPresent name="colecaoTipoEspecificacao" scope="session">
				<tr>
					...
					<td><html:select property="idTipoEspecificacao" tabindex="3" onchange="javascript:refresh();" >
