...
<html:javascript staticJavascript="false"
	formName="FiltrarAtividadeActionForm" dynamicJavascript="true" />
<script language="JavaScript"
...
<script language="JavaScript">
	...
	function validarForm(formulario){
		if(validateFiltrarAtividadeActionForm(formulario)){
...
<html:form action="/filtrarAtividadeAction"
	name="FiltrarAtividadeActionForm"
	type="gsan.gui.atendimentopublico.FiltrarAtividadeActionForm"
	method="post"
	onsubmit="return validateFiltrarAtividadeActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Atividade</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para filtrar uma atividade, informe os dados
					abaixo:</td>
		       ...
		       <tr>
				...
				<tr>
					<td><strong>Atividade &Uacute;nica?</strong></td>
					<td><html:radio property="indicadorAtividadeUnica" tabindex="2" value="<%=ConstantesSistema.SIM.toString()%>" /><strong>Sim</strong>
					<html:radio property="indicadorAtividadeUnica" tabindex="3" value="<%=ConstantesSistema.NAO.toString()%>" /><strong>N&atilde;o</strong>
					<html:radio property="indicadorAtividadeUnica" tabindex="4" value="" /><strong>Todos</strong></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td><input name="Button" type="button" class="bottonRightCol"
						...
						onclick="window.location.href='/gsan/exibirFiltrarAtividadeAction.do?menu=sim'"
						tabindex="8"></td>
