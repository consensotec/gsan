...
<html:javascript staticJavascript="false"
	formName="FiltrarLigacaoEsgotoSituacaoActionForm" dynamicJavascript="true" />
<script language="JavaScript"
...
<script language="JavaScript">
	...
	function validarForm(formulario){
		if(validateFiltrarLigacaoEsgotoSituacaoActionForm(formulario)){
...
<html:form action="/filtrarLigacaoEsgotoSituacaoAction"
	name="FiltrarLigacaoEsgotoSituacaoActionForm"
	type="gsan.gui.atendimentopublico.FiltrarLigacaoEsgotoSituacaoActionForm"
	method="post"
	onsubmit="return validateFiltrarLigacaoEsgotoSituacaoActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Filtrar Situa&ccedil;&atilde;o de Liga&ccedil;&atilde;o de Esgoto</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para filtrar uma situa&ccedil;&atilde;o de liga&ccedil;&atilde;o de Esgoto, informe os dados
					abaixo:</td>
				...
				<tr>
					...
					<td><html:text property="codigo" size="2" maxlength="2" /><font
		       ...
		       <tr>
				...
				<tr>
					...
					<td><html:radio property="indicadorFaturamento" tabindex="2" value="<%=ConstantesSistema.SIM.toString()%>" /><strong>Sim</strong>
					<html:radio property="indicadorFaturamento" tabindex="3" value="<%=ConstantesSistema.NAO.toString()%>" /><strong>N&atilde;o</strong>
					<html:radio property="indicadorFaturamento" tabindex="4" value="<%=ConstantesSistema.TODOS.toString()%>" /><strong>Todos</strong></td>
					<td>&nbsp;</td>
				</tr>
				<tr>
				...
				<tr>
					<td><input name="Button" type="button" class="bottonRightCol"
						...
						onclick="window.location.href='/gsan/exibirFiltrarLigacaoEsgotoSituacaoAction.do?menu=sim'"
						tabindex="8"></td>
