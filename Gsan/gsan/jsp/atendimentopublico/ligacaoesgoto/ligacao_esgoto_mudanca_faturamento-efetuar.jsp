...
<script language="JavaScript">
	...
	function limparForm() {
		...
		form.motivoCorteSupressao.value = "-1";		
...
<html:form
	...
	type="gsan.gui.atendimentopublico.ligacaoesgoto.EfetuarMudancaSituacaoFaturamentoLigacaoEsgotoActionForm"
	method="post">
									...
									<table width="100%" border="0" align="center">
										...
										<tr>
											...
											<td><span class="style2"> <!-- Campo Ordem de Serviço --> <html:hidden
												...
												href="javascript:chamarPopup('exibirPesquisarOrdemServicoAction.do', 'ordemServico', null, null, 600, 500, '',document.forms[0].idOrdemServico);"><img width="23" height="21" border="0"
													...
													<table border="0" width="100%">
														<tr>
															...
															<td width="58%"><html:text property="matriculaImovel"
																...
																readonly="true"
																style="background-color:#EFEFEF; border:0;" size="27"
																maxlength="20" /></td>
														</tr>
														<tr>
											...
											<table width="100%" border="0" bgcolor="#99CCFF">
												...
												<tr bgcolor="#cbe5fe">
													...
													<table border="0" width="100%">
														...
														<tr>
															<logic:present name="desativacaoRamalEsgoto" scope="session">			
																<td><strong> Motivo do Corte/Supressão:<font color="#FF0000">*</font>
																</strong></td>
																	<td><html:select property="motivoCorteSupressao">
																		<html:option value="-1">&nbsp;</html:option>
																		<logic:present name="colecaoMotivo" scope="session">
									...
									<table width="100%">
										...
										<tr>
											<td width="40%" align="left"><logic:present
												...
												onclick="javascript:window.location.href='/gsan/exibirEfetuarMudancaSituacaoFaturamentoLigacaoEsgotoAction.do?menu=sim'">
												<!-- onClick="limparForm();"> -->
												<input type="button"
