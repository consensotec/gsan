...
<script language="JavaScript" src="<bean:message key="caminho.js"/>validacao/regras_validator.js"></script><html:javascript staticJavascript="false" 
	formName="AtualizarVolumeMinimoLigacaoEsgotoActionForm" />

<script language="JavaScript">
	function validaForm() {
		var form = document.forms[0];
		if (validateAtualizarVolumeMinimoLigacaoEsgotoActionForm(form)){
	...
	function validarValorMinimo () {
		...
		if (modConsumoMinimo > 0) {
			//Calcula o proximo menor valor mutiplo da quantidade de economias([FS0004]).
			var novoConsumoMinimo = parseInt(parseInt(form.consumoMinimoFixado.value) / parseInt(form.qtdeEconomia.value));
			novoConsumoMinimo = parseInt(form.qtdeEconomia.value) * (novoConsumoMinimo + 1);
			var msg = 'Valor do volume mínimo deverá ser alterado para '+novoConsumoMinimo+' valor múltiplo de quantidade de economias '+form.qtdeEconomia.value+'.';
...
<html:form
	action="/atualizarVolumeMinimoLigacaoEsgotoAction.do"
	name="AtualizarVolumeMinimoLigacaoEsgotoActionForm"
	type="gsan.gui.atendimentopublico.ligacaoesgoto.AtualizarVolumeMinimoLigacaoEsgotoActionForm"
	method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Atualizar Volume Mínimo da Ligação de Esgoto</td>
					<td width="11"><img border="0"
			...
			<table width="100%" border="0">
				<tr>
					...
					<table width="100%" border="0" align="center">
						<tr>
							<td height="10" colspan="2">Para atualização do volume mínimo da ligação de esgoto, informe os dados abaixo:</td>
						</tr>
						<tr>
						...
						<td height="10"><strong>Ordem de Servi&ccedil;o:<span
							...
							<html:text property="idOrdemServico" size="9" maxlength="9"
   									   onkeypress="javascript:validaEnterComMensagem(event, 'exibirAtualizarVolumeMinimoLigacaoEsgotoAction.do?validaOS=true', 'idOrdemServico','Ordem de Serviço');"
   									   onkeyup="limparOS();"/>
					...
					<table width="100%" border="0" align="center">
						<tr bgcolor="#cbe5fe">
							...
							<table width="100%" border="0" bgcolor="#99CCFF">
								...
								<tr bgcolor="#99CCFF">
									<td height="18" colspan="2">
									<div align="center"><span class="style2"><strong>  Dados do Volume Mínimo da Ligação de Esgoto </strong></span></div>
									</td>
								</tr>
								<tr bgcolor="#cbe5fe">
									<td>
									<table border="0" width="100%">
										<tr>
											<td width="39%" height="10"><strong>Volume Mínimo:</strong></td>
