...
<html:javascript staticJavascript="false"
	formName="AtualizarAtividadeActionForm" />

<SCRIPT LANGUAGE="JavaScript">
<!--

function validarForm(formulario){
if(validateAtualizarAtividadeActionForm(formulario)){
...
<html:form action="/atualizarAtividadeAction.do" method="post">

	<INPUT TYPE="hidden" name="removerAtividade">
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para Atualizar uma Atividade, informe os
					dados abaixo:</td>
				<tr>
					<td><strong>C&oacute;digo:</strong></td>
					<td><html:hidden property="id" /> <bean:write
						name="AtualizarAtividadeActionForm" property="id" /></td>
				</tr>
				...
				<tr>
					...
					<td><strong> <html:radio property="indicadorAtividadeUnica"
						...
						property="indicadorAtividadeUnica" value="2" /> N&atilde;o</strong>
					</strong></td>
				</tr>
