...
<%@ page import="gsan.cadastro.imovel.ImovelSubcategoria"%>
...
function validarForm(form, idImovelTipo1,idImovelTipo2){

	if(idImovelTipo1 != "" && idImovelTipo1 != 0){
		form.action = "emitirOrdemFiscalizacaoAction.do?idImovelTipo1="+idImovelTipo1;
	}else{
		
		form.action = "emitirOrdemFiscalizacaoAction.do?idImovelTipo2="+idImovelTipo2;
	}
	form.submit();
...
<html:form 
	...
	type="gsan.gui.atendimentopublico.ordemservico.EmitirOrdemFiscalizacaoForm" 
	method="post">
						...
						<tr bgcolor="#cbe5fe">
                  			...
                  			<div id="layerShowLocal">
	                   		<table width="100%" border="0" bgcolor="#99CCFF">
								...
								<tr>
									<td>
										<div class="style9"><strong>Valor dos Serviços:</strong></div>
										</td>
						...
						<table width="100%">
							<tr>
								<td align="left" colspan="">
						   		...
						   		<td align="right">
									<div align="right">
									<logic:present name="idImovelTipo1">
										<input type="button" 
										name="Button" 
										class="bottonRightCol"
										value="Emitir"
										onclick="javascript:validarForm(document.forms[0],${idImovelTipo1},0);"/>
									</logic:present>
									<logic:notPresent name="idImovelTipo1">
										<input type="button" 
											name="Button" 
											class="bottonRightCol"
											value="Emitir"
											onclick="javascript:validarForm(document.forms[0],0,${idImovelTipo2});"/>
									</logic:notPresent>
									</div>
