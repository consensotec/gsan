...
<html:form action="/exibirDetalharMaterialUtilizadoPopupAction" 
	...
	type="gsan.gui.atendimentopublico.ordemservico.DetalharMaterialUtilizadoPopupActionForm"
	method="post">
								...
								<td>
									<table width="100%" bgcolor="#99CCFF">
										...
										<tr>
											...
											<logic:iterate id="helper" name="DetalharMaterialUtilizadoPopupActionForm" property="colecaoOSAtividade" type="gsan.atendimentopublico.ordemservico.bean.ObterDadosAtividadeOSHelper" scope="session">
