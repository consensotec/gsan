...
function validarForm(form){
		...
		if(validateInserirMaterialActionForm(form)){
...
<html:form action="/inserirMaterialAction" method="post"
	name="InserirMaterialActionForm"
	type="gsan.gui.atendimentopublico.ordemservico.InserirMaterialActionForm"
	onsubmit="return validateInserirMaterialActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Material</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td colspan="2">Para inserir um material, informe os dados gerais
					abaixo:</td>
				</tr>
				
				<tr>
					<td width="162"><strong>Código do Material:</strong></td>
					<td><strong> <html:text property="codigoMaterial" size="7" maxlength="7" /> </strong></td>
				</tr>
				...
				<tr>
					...
					<td><strong> <html:text property="descricao" size="40"
						maxlength="40" /> </strong></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2"><input name="Button" type="button"
						...
						onclick="window.location.href='/gsan/exibirInserirMaterialAction.do?menu=sim'"> <input
