...
<%@ page import="gsan.atendimentopublico.registroatendimento.AtendimentoMotivoEncAcaoCobranca"%>
...
<html:form action="/informarMotivoEncerramentoAtendimentoAction"
	...
	type="gsan.gui.atendimentopublico.ordemservico.InformarMotivoEncerramentoAtendimentoActionForm"
	method="post">
