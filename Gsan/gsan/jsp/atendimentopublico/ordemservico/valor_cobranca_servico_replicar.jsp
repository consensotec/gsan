...
<%@page	import="gsan.atendimentopublico.ordemservico.ServicoCobrancaValor"%>
...
<html:form action="/replicarValorCobrancaServicoAction.do"
	...
	type="gsan.gui.atendimentopublico.ordemservico.ReplicarValorCobrancaServicoActionForm"
											...
											<pg:item>
												...
												<tr bgcolor="#cbe5fe">
													...
													<td width="12%" align="center">
														<%=gsan.util.Util.formatarData(servicoCobrancaValor.getDataVigenciaInicial())%>
													</td>
														
													<td width="12%" align="center">
														<%=gsan.util.Util.formatarData(servicoCobrancaValor.getDataVigenciaFinal())%>
													</td>											
	
													<td width="18%" align="right">
														<%=gsan.util.Util.formatarMoedaReal(servicoCobrancaValor.getValor())%>
													</td>
