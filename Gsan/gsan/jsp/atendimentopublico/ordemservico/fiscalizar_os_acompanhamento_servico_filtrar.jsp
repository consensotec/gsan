...
<%@ page import="gsan.atendimentopublico.ordemservico.OSProgramacaoAcompanhamentoServico"%>
<%@ page import="gsan.atendimentopublico.ordemservico.bean.PesquisarFiscalizarOSEncerradaAcompanhamentoHelper"%>
...
<html:form action="/filtrarOSEncerradaAcompanhamentoServicoAction"
	...
	type="gsan.gui.atendimentopublico.ordemservico.FiltrarFiscalizarOSAcompanhamentoServicoActionForm"
	method="post">
