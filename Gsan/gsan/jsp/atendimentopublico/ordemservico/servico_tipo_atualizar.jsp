...
<html:form action="/atualizarTipoServicoAction.do"
	...
	type="gsan.gui.atendimentopublico.ordemservico.AtualizarTipoServicoActionForm"
	method="post"
			...
			<table width="100%" height="311" border="0">
				...
				<tr>
					...
					<td align="left"><label> <html:radio
						...
						value="<%=gsan.util.ConstantesSistema.ATUALIZACAO_AUTOMATICA + ""%>" />
					<strong>Automática</strong></label></td>
					<td align="left"><label> <html:radio
						property="atualizacaoComercial"
						value="<%=gsan.util.ConstantesSistema.ATUALIZACAO_NENHUMA + ""%>" />
					<strong>Não Atualiza</strong></label></td>
					<td align="left"><label> <html:radio
						property="atualizacaoComercial"
						value="<%=gsan.util.ConstantesSistema.ATUALIZACAO_POSTERIOR + ""%>" />
