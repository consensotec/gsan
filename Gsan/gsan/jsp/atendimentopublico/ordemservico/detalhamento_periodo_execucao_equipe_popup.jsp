...
<html:form action="/exibirDetalharPeriodoExecucaoEquipePopupAction" 
	...
	type="gsan.gui.atendimentopublico.ordemservico.DetalharPeriodoExecucaoEquipePopupActionForm"
	method="post">
								...
								<td>
									<table width="100%" bgcolor="#99CCFF">
										...
										<tr>
											...
											<logic:iterate id="helper" name="DetalharPeriodoExecucaoEquipePopupActionForm" property="colecaoOSAtividade" type="gsan.atendimentopublico.ordemservico.bean.ObterDadosAtividadeOSHelper" scope="session">
