...
<%@ page import="gsan.atendimentopublico.ordemservico.bean.OSPavimentoRetornoHelper"%>
...
<html:form action="/exibirManterOrdemRepavimentacaoProcessoAceiteAction" method="post"
	...
	type="gsan.gui.atendimentopublico.ordemservico.FiltrarOrdemRepavimentacaoProcessoAceiteActionForm" method="post">
