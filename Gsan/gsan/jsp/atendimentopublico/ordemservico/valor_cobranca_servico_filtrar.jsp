...
<script language="JavaScript">
	...
	function validaQuantidadeEconomias(){
		var form = document.forms[0];
		
		if((form.quantidadeEconomiasInicial.value == '' && form.quantidadeEconomiasFinal.value != '') 
				|| (form.quantidadeEconomiasInicial.value != '' && form.quantidadeEconomiasFinal.value == '')){
			
			if(form.quantidadeEconomiasInicial.value == ''){
				alert('Informe Quantidade de Economia Inicial.');
			}else if(form.quantidadeEconomiasFinal.value == ''){
				alert('Informe Quantidade de Economia Final.');
			}
	...
	function limparForm() {
		...
		form.indicativoTipoSevicoEconomias[0].checked = false;
		form.indicativoTipoSevicoEconomias[1].checked = false;
		form.capacidadeHidrometro.selectedIndex = '-1';
	...
	function reload(){
   		var form = document.forms[0];
   		form.action = "/gsan/exibirFiltrarValorCobrancaServicoAction.do";	
   		form.submit();
   	}
	function validarExibicaoValorServico(){
		...
		if(form.indicadorGeracaoDebito[0].checked){
			form.valorServicoInicial.disabled = false;
	   		form.valorServicoFinal.disabled = false
		}else if(form.indicadorGeracaoDebito[1].checked){
			form.valorServicoInicial.value = "";
	   		form.valorServicoFinal.value = "";   		
	   		form.valorServicoInicial.disabled = true;
	   		form.valorServicoFinal.disabled = true
		}else if(form.indicadorGeracaoDebito[2].checked){
			form.valorServicoInicial.value = "";
	   		form.valorServicoFinal.value = "";  
			form.valorServicoInicial.disabled = true;
	   		form.valorServicoFinal.disabled = true
...
<body leftmargin="5" topmargin="5"
	onload="habilitarCapacidadeHidrometro();validarExibicaoValorServico();">

<html:form action="/filtrarValorCobrancaServicoAction.do"
	name="FiltrarValorCobrancaServicoActionForm"
	type="gsan.gui.atendimentopublico.ordemservico.FiltrarValorCobrancaServicoActionForm"
			...
			<table width="100%" border="0">
				<tr>
					...
					<table width="100%" border="0" align="center">
						...
						<tr>
							<td height="10"><strong> Tipo do Serviço:<font color="#FF0000"></font></strong></td>
							<td colspan="2" width="330"><span class="style2"> <html:text
								property="tipoServico" size="5" maxlength="4"
								onkeypress="javascript:validaEnterComMensagem(event, 'exibirFiltrarValorCobrancaServicoAction.do', 'tipoServico','Tipo do Serviço');return isCampoNumerico(event);" />
							<a
						...
						<tr>
							...
							<td align="left" colspan="2">
								<label> 
									<html:radio	property="indicadorGeracaoDebito" value="1" onchange="javascript:validarExibicaoValorServico(this);"/><strong>Sim</strong>
								</label>
								<label>
									<html:radio property="indicadorGeracaoDebito" value="2" onchange="javascript:validarExibicaoValorServico(this);"/> <strong>Não</strong>
								</label>
								<label>
									<html:radio property="indicadorGeracaoDebito" value="3" onchange="javascript:validarExibicaoValorServico(this);"/> <strong>Todos</strong>
								</label>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td align="left" colspan="2">
								...
								<label>
									<html:radio property="indicativoTipoSevicoEconomias" value="3" onchange="javascript:desabilitaEconomia();"/> <strong>Todos</strong>
								</label>
							</td>
						</tr>
						...
						<tr> 
				        	...
				        	<td valign="middle">
					            ...
					            <img border="0" src="<bean:message key='caminho.imagens'/>calendario.gif" 
					            	 onclick="javascript:abrirCalendario('FiltrarValorCobrancaServicoActionForm', 'dataVigenciaInicial');" 
					            	 width="20" border="0" 
					            ...
					            <html:text maxlength="10" 
					            		   ...
					            		   onkeyup="javascript:mascaraData(this,event);"/>
					            <img border="0" src="<bean:message key='caminho.imagens'/>calendario.gif" 
					            	 onclick="javascript:abrirCalendario('FiltrarValorCobrancaServicoActionForm', 'dataVigenciaFinal')"
					            	 width="20" border="0" 
