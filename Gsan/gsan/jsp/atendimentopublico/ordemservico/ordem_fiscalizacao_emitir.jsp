						   		...
						   		<td align="right">
									...
									<logic:equal name="EmitirOrdemFiscalizacaoForm" property="indicadorPermitirEmitir" value="sim">
										<logic:present name="idImovelTipo1">
											...
											onclick="javascript:abrirPopupComValidacao('exibirEmitirOrdemFiscalizacaoPopupAction.do?idImovelTipo1=${idImovelTipo1}&tipo=', 765, 790,document.forms[0]);"/>	
										</logic:present>	
										...
										<input type="button" 
											...
											class="bottonRightCol"
											value="Emitir" 												
											onclick="javascript:abrirPopupComValidacao('exibirEmitirOrdemFiscalizacaoPopupAction.do?idImovelTipo2=${idImovelTipo2}tipo=', 765, 790,document.forms[0]);"/>
										</logic:notPresent>
									</logic:equal>
