...
<body leftmargin="0" topmargin="0" onload="window.focus();resizePageSemLink(600, 331);">	

<html:form action="/programarOrdemServicoRoteiroCriteriosAction.do"
	name="ElaborarOrdemServicoRoteiroCriteriosActionForm"
	type="gsan.gui.atendimentopublico.ordemservico.ElaborarOrdemServicoRoteiroCriteriosActionForm"
	method="post">
			        ...
			        <tr> 
			          	<td height="24" colspan="3">
			          		...
			          		<table width="100%" align="center" bgcolor="#99CCFF">
			              		...
			              		<tr bgcolor="#cbe5fe">
			                		<td height="15" bordercolor="#90c7fc" >
