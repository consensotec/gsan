...
<%@page import="gsan.atendimentopublico.ordemservico.ServicoPerfilTipo"%>
		...
		<td width="625" valign="top" class="centercoltext">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Perfil de Serviço</td>
					<td width="11"><img border="0"
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td colspan="4" height="23">
						...
						<strong>Perfis de Seviços Cadastrados:</strong>
						</font>
					</td>
						...
						<table width="100%" bgcolor="#99CCFF">
							...
							<tr bgcolor="#99CCFF">
								...
								<td width="15%" align="center">
									<strong>Perfil de Serviço</strong>
								</td>
...
<jsp:include page="/jsp/relatorio/escolher_tipo_relatorio.jsp?relatorio=gerarRelatorioTipoPerfilServicoManterAction.do"/>
