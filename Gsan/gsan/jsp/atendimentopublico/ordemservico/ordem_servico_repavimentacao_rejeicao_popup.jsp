...
<%@ page import="gsan.gui.atendimentopublico.ordemservico.AtualizarOrdemProcessoRepavimentacaoPopUpActionForm"%>
...
<html:form action="/rejeitarOrdemProcessoRepavimentacaoPopupAction.do"
	...
	type="gsan.gui.atendimentopublico.ordemservico.AtualizarOrdemProcessoRepavimentacaoPopUpActionForm"
	method="post">
