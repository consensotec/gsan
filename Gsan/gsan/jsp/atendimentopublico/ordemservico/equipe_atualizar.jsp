...
<%@page import="gsan.atendimentopublico.ordemservico.EquipeComponentes"%>
...
<html:form action="/atualizarEquipeAction.do"
	...
	type="gsan.gui.atendimentopublico.ordemservico.AtualizarEquipeActionForm"
	method="post">
			...
			<table width="100%" border="0">
				<tr>
					...
					<table width="100%" border="0" align="center">
                        ...
                        <tr>
							<td><strong>Usuário Responsavel Pela Execução do Serviço:</strong></td>
						...
						<tr>
							...
							<logic:iterate id="equipeEquipamentosEspeciais"
								...
								type="gsan.atendimentopublico.ordemservico.EquipeEquipamentosEspeciais"
								scope="session">
								<c:set var="count" value="${count+1}" />
								<c:choose>
									<c:when test="${count%2 == '1'}">
