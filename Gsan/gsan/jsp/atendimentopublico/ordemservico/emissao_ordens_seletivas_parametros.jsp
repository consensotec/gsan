...
function recuperarDadosQuatroParametros(idRegistro, descricaoRegistro, codigoRegistro, tipoConsulta) {
	...
	function apagaSetorEnter(tecla){
		if (document.all) {
...
<body leftmargin="5" topmargin="5" onload="controleQuadra();//setarFoco('${requestScope.nomeCampo}');">


<html:form action="/filtrarImovelEmissaoOrdensSeletivasWizardAction"
	type="gsan.gui.atendimentopublico.ordemservico.ImovelEmissaoOrdensSeletivasActionForm"
								...
								<td width="100%" align="center">
									...
									<tr>
										...
										<td>
											...
											onkeypress="apagaSetorEnter(event); duplicarLocalidade(); controleSetorComercial(); validaEnter(event, 'filtrarImovelEmissaoOrdensSeletivasWizardAction.do?action=exibirFiltrarImovelEmissaoOrdensSeletivasParametros&objetoConsulta=1&inscricaoTipo=origem', 'localidadeInicial');return isCampoNumerico(event);"
