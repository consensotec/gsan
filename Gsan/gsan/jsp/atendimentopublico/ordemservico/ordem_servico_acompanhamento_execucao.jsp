...
<html:form action="/filtrarOrdemServicoAction" method="post"
	...
	type="gsan.gui.atendimentopublico.ordemservico.GerarRelatorioAcompanhamentoExecucaoOSActionForm" >
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<img width="23" height="21" border="0"
						src="<bean:message key="caminho.imagens"/>pesquisa.gif"
						title="Pesquisar Equipe de Progamação" /></a> <logic:present
				...
				<tr>
					...
					<img width="23" height="21" border="0"
						src="<bean:message key="caminho.imagens"/>pesquisa.gif"
						title="Pesquisar Equipe de Execução" /></a> <logic:present
