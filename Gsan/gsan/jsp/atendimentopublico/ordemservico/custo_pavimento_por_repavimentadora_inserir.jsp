...
<%@ page import="gsan.cadastro.unidade.UnidadeRepavimentadoraCustoPavimentoRua"%>
<%@ page import="gsan.cadastro.unidade.UnidadeRepavimentadoraCustoPavimentoCalcada"%>
...
<div id="formDiv"><html:form action="/inserirCustoPavimentoPorRepavimentadoraAction.do"
	...
	type="gsan.gui.atendimentopublico.ordemservico.ExibirInserirCustoPavimentoPorRepavimentadoraActionForm"
	method="post">
													...
													<td> <%cor2 = "#cbe5fe";%>
														<table width="100%" bgcolor="#99CCFF" border="0">
															<logic:iterate name="colecaoUnidadeRepavimentadoraCustoPavimentoRua" 
																...
																<td width="30%">
																	<div align="center">
																		<%=gsan.util.Util.formatarData(unidadeRepavimentadoraCustoPavimentoRua.getDataVigenciaInicial())%>
																	</div>
																</td>
													...
													<td> <%cor3 = "#cbe5fe";%>
														<table width="100%" bgcolor="#99CCFF" border="0">
															<logic:iterate name="colecaoUnidadeRepavimentadoraCustoPavimentoCalcada" 
																...
																<td width="30%">
																	<div align="center">
																		<%=gsan.util.Util.formatarData(unidadeRepavimentadoraCustoPavimentoCalcada.getDataVigenciaInicial())%>
																	</div>
																</td>
