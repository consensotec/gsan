...
<%@ page import="gsan.gui.atendimentopublico.ordemservico.CadastrarMensagemAcompanhamentoServicoPopupAction"%>
...
<html:html>
	...
	<body leftmargin="5" topmargin="5">
		<html:form action="/cadastrarMensagemAcompanhamentoServicoAction.do"
				   ...
				   type="gsan.gui.atendimentopublico.ordemservico.CadastrarMensagemAcompanhamentoServicoPopupActionForm"
				   method="post"
				   styleId="form">
