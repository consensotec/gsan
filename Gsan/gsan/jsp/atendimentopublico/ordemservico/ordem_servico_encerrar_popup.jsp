...
<%@ page import="gsan.atendimentopublico.registroatendimento.AtendimentoMotivoEncerramento"%>
<%@ page import="gsan.atendimentopublico.ordemservico.OsReferidaRetornoTipo"%>	
...
<html:form  action="/encerrarOrdemServicoPopupAction"
			...
			type="gsan.gui.atendimentopublico.ordemservico.EncerrarOrdemServicoActionForm"
