...
<%@page import="gsan.atendimentopublico.ordemservico.Material"%>
...
function remover(objeto){
	...
	if (CheckboxNaoVazio(objeto)){
		if (confirm ("Confirma remoção?")) {
			document.forms[0].action = "/gsan/removerMaterialAction.do"
		...
		<td width="625" valign="top" class="centercoltext">
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Manter Material </td>
					<td width="11"><img border="0"
				...
				<tr>
					<td>
						...
						<pg:pager isOffset="true" index="half-full" maxIndexPages="10"
							...
							<pg:param name="pg"/>
							<pg:param name="q"/>
							<logic:present name="colecaoMaterial">
								<%int cont = 0;%>
								<logic:iterate name="colecaoMaterial" id="material" type="Material">
									<pg:item>
										<%cont = cont + 1;
										if (cont % 2 == 0) {%>
										<tr bgcolor="#cbe5fe">
										...
										<%}%>
											...
											<td width="15%" align="center">
												<a href="/gsan/exibirAtualizarMaterialAction.do?idMaterial=<%=""+ material.getId()%>"><bean:write name="material" property="id"/></a>
											</td>
											<td width="35%" align="left">
												<bean:write name="material" property="descricao" />
											</td>
											<td width="20%" align="center">
												<bean:write name="material" property="descricaoAbreviada"/>
											</td>
											<td width="15%" align="center">
							...
							<tr>
							  ...
							  onclick="remover(idRegistrosRemocao);" url="removerClienteAction.do"/>-->
									<input type="button" class="bottonRightCol" tabindex="1"
										value="Remover" name="removerMaterial" onclick="remover(document.ManutencaoRegistroActionForm.idRegistrosRemocao);"/>
									<input name="button" type="button" class="bottonRightCol" tabindex="2" value="Voltar Filtro"
										onclick="window.location.href='<html:rewrite page="/exibirFiltrarMaterialAction.do"/>'">
								</td>
