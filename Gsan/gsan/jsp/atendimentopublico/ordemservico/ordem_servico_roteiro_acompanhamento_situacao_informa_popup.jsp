...
<html:form action="/exibirAcompanharRoteiroProgramacaoOrdemServicoAction.do"
	...
	type="gsan.gui.atendimentopublico.ordemservico.AcompanharRoteiroProgramacaoOrdemServicoActionForm"
	method="post">
	...
	<input type="hidden" name="validarMotivo" value="<%=request.getParameter("veioAcompanhamentoRoteiro")%>"/>
