...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if (validateInserirMotivoCorteActionForm(form)){
				submeterFormPadrao(form);
			}	
	}
	
	function limparForm() {
		var form = document.InserirMotivoCorteActionForm;
...
<html:form action="/inserirMotivoCorteAction.do"
	name="InserirMotivoCorteActionForm"
	type="gsan.gui.atendimentopublico.InserirMotivoCorteActionForm"
	method="post"
	onsubmit="return validateInserirMotivoCorteActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Motivo de Corte</td>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td colspan="2">Para inserir o motivo de corte, informe a descrição
					abaixo:</td>
				</tr>
				<tr>
					...
					<td colspan="2"><html:text property="descricao" maxlength="25"
						size="25"
						onkeyup="limitTextArea(document.forms[0].descricao, 25, document.getElementById('utilizado'), document.getElementById('limite'));" /><br>
					</td>
				</tr>
