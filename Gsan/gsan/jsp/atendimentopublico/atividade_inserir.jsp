...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if (validateInserirAtividadeActionForm(form)){
         if(form.indicadorAtividadeUnica[0].checked == false && form.indicadorAtividadeUnica[1].checked == false){
	         alert('Informe o Indicador de Atividade Única.'); 
		 } else {
	...
	form.tipoAviso[0].checked == false && form.tipoAviso[1].checked == false
...
<html:form action="/inserirAtividadeAction.do"
	name="InserirAtividadeActionForm"
	type="gsan.gui.atendimentopublico.InserirAtividadeActionForm"
	method="post"
	onsubmit="return validateInserirAtividadeActionForm(this);">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Inserir Atividade</td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para inserir a atividade, informe a
					descrição abaixo:</td>
				</tr>
				<tr>
				...
				<tr>
					<td><strong>Atividade única? <font
						color="#FF0000">*</font></strong></td>
					<td><strong> <html:radio property="indicadorAtividadeUnica"
						value="<%=""+ConstantesSistema.SIM%>" /> <strong>Sim <html:radio
						property="indicadorAtividadeUnica" value="<%=""+ConstantesSistema.NAO%>"/> N&atilde;o</strong>
					</strong></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr>
					<td colspan="2"><input name="Button" type="button"
						...
						onclick="window.location.href='<html:rewrite page="/exibirInserirAtividadeAction.do?menu=sim"/>'"> <input name="Button"
