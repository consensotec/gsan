...
<html:form action="/inserirLigacaoEsgotoEsgotamentoAction.do"
	...
	type="gsan.gui.atendimentopublico.InserirLigacaoEsgotoEsgotamentoActionForm"
	method="post"
		...
		<tr>
			...
			<table width="100%" border="0">
				<tr>
					...
					<td colspan="2">Para adicionar uma ligação de esgoto esgotamento, informe o dado abaixo:</td>
				</tr>
				...
				<tr>
					<td HEIGHT="30"><strong>Quantidade de Meses para Situação Especial de Faturamento:</strong></td>
