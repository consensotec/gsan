					...
					<td align="left">
						<label> 
							...
							<strong>Não</strong>
								...
								<!--  Indicador da inclusão de débitos -->
				<tr>
					<td><strong><span class="style2">Indicador incluir débitos:<font color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%">
						<label> 
							<html:radio	property="indicadorIncluirDebito" value="1" /><strong>Sim</strong>
						</label>
					</td>
					<td align="left">
						<label> 
							<html:radio property="indicadorIncluirDebito" value="2" /><strong>Não</strong>
						</label>
					</td>
				</tr>
				
				<!--  Indicador para cobrança de multa -->
				<tr>
					<td><strong><span class="style2">Indicador cobrar juros:<font color="#FF0000">*</font></span></strong></td>
					<td align="left" width="20%">
						<label> 
							<html:radio	property="indicadorCobrarJuros" value="1" /><strong>Sim</strong>
						</label>
					</td>
					<td align="left">
						<label> 
							<html:radio property="indicadorCobrarJuros" value="2" /><strong>Não</strong>
						</label>
					</td>
				</tr>	
