								...
								<div style="width: 100%; height: 300; overflow: auto;">
									...
									<%	}	%>
											...
											<td width="15%" align="center">
												<a href="javascript:abrirPopup('gerarRelatorio2ViaContaAction.do?cobrarTaxaEmissaoConta=N&idConta='+<%="" + contaValoresHelper.getConta().getId()%>+
													'&indicadorCliente='+<%="" + contaValoresHelper.getIndicadorMensagem()%>+
													'&idClienteImovel='+<%="" + contaValoresHelper.getIdClienteImovel()%>+'&idClienteConta='+<%= contaValoresHelper.getIdClienteConta()%>, 400, 800);">
