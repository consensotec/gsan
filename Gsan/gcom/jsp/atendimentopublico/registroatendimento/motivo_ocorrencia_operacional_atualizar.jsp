...
<html:form action="/atualizarMotivoOcorrenciaOperacionalAction.do"
	...
	type="gcom.gui.atendimentopublico.registroatendimento.AtualizarMotivoOcorrenciaOperacionalActionForm">
			...
			<td width="625" valign="top" class="centercoltext">
				...
				<table width="100%" border="0" align="center" cellpadding="0"
					...
					<tr>
						...
						<td class="parabg">Atualizar Motivo Ocorrência Operacional</td>
						<td width="11"><img border="0"
				...
				<table width="100%" border="0">
					<tr>
						<td colspan="2">Para atualizar o motivo ocorrência operacional, informe os dados abaixo:
					</td>
					</tr>
					<html:hidden property="idMotivoOcorrenciaOperacional" value="${idMotivoOcorrenciaOperacional}"/>
					<tr>
						<td width="25%"><strong>Descrição:<font color="red">*</font></strong></td>
						<td>
					...
					<tr>
						<td width="25%"><strong>Tipo da Ocorrência:<font color="red">*</font></strong></td>
						<td>
