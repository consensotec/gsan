...
function validaTodosRadioButton(){
		...
		if(validaRadioButton(form.indicadorPoco,"Refere-se a Poço?") != ""){
			mensagem = mensagem + validaRadioButton(form.indicadorPoco,"Refere-se a Poço?")+"\n";
		}
	...
	<table width="615" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td><strong>Refere a Poço?:<font color="#FF0000"></font><font
						color="#FF0000">*</font></strong></td>
					<td><logic:present name="consultaDados">
				...
				<tr>
					<td><strong>Refere a Ligação de Esgoto?:<font color="#FF0000"></font><font
						color="#FF0000">*</font></strong></td>
					<td><logic:present name="consultaDados">
