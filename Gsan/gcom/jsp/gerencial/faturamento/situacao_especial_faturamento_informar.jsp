	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table border="0" width="100%">
				...
				<tr>
					<td><strong>Mês/Ano de Faturamento:</strong><font color="#FF0000">*</td>
					<td colspan="2"><html:text maxlength="7" size ="7" property="mesAnoReferenciaFaturamento" 
					onkeydown="formataDataReferencia(this,event)" onkeypress="javascript:return isCampoNumerico(event);"/>	
