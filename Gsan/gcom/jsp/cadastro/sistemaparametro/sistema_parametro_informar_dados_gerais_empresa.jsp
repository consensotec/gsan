...
<script>
	...
	function IntegerValidations () {
		...
		this.ai = new Array("numeroTelefoneAtendimentoEsgoto", "Telefone de Atendimento Serviço de esgoto deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.aj = new Array("tamanhoMaximoAnexoRA", "Tamanho Máximo de Anexo para Registro de Atendimento deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		}
	...
	function caracteresespeciais () {
		...
		this.ai = new Array("numeroTelefoneAtendimentoEsgoto", "Telefone de Atendimento Serviço de esgoto possui caracteres especiais.", new Function ("varName", " return this[varName];"));
	}
	...
	function required () {
		...
		this.am = new Array("tamanhoMaximoAnexoRA", "Informe Tamanho Máximo de Anexo para Registro de Atendimento.", new Function ("varName", " return this[varName];"));		
		this.an = new Array("resolucaoImagem", "Informe Resolução da Imagem.", new Function ("varName", " return this[varName];"));				
	}
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="25%" align="left">
						<strong>Número do Telefone de Atendimento Serviço Esgoto:</strong>
					</td>
					<td>
						<html:text maxlength="12" 
							property="numeroTelefoneAtendimentoEsgoto" 
							size="15" />
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="3">
						...
						<a href="javascript:abrirPopup('exibirPesquisarClienteAction.do', 475, 800);" title="Pesquisar Cliente">
				...
				<tr>
					<td width="25%" align="left">
						<strong>Mensagem de Vencimento da Guia de Pagamento Referente a Entrada de Parcelamento:</strong>
					</td>
					<td>
						<html:text maxlength="100" property="msgVencimentoGuiaEntradaParc" size="50"/>
					</td>
				</tr>
				...
				<tr>
					<td width="40%">
						<strong>Bloquear alterar o nome do cliente com CPF ou CNPJ validado:<font color="#FF0000">*</font></strong>
					</td>
					<td><strong>
						<html:radio property="indicadorAlterarNomeClienteCpfCnpjValidado" value="1" /> Sim
						<html:radio property="indicadorAlterarNomeClienteCpfCnpjValidado" value="2" /> N&atilde;o
						</strong>	
					</td>
				</tr>
				...
				<tr>
					<td width="25%" align="left">
						<strong>Domínio do E_mail corporativo:</strong>
					</td>
					<td>
				...
				<tr>
					<td width="40%">
						<strong>Indicador de Validar CPF/CNPJ: <font color="#FF0000">*</font></strong>
					</td>
					<td><strong> 
						<html:radio property="indicadorValidaCpfCnpj" value="1" />Sim
						<html:radio property="indicadorValidaCpfCnpj" value="2" />N&atilde;o 
 						</strong>
					</td>
				</tr>
				...
				<tr>
					<td width="40%">
						<strong>Indicador de Imprimir Nome Cliente Atual na Segunda Via de Conta: <font color="#FF0000">*</font></strong>
					</td>
					<td><strong> 
						<html:radio property="indicadorNomeClienteAtualConta" value="1" />Sim
						<html:radio property="indicadorNomeClienteAtualConta" value="2" />N&atilde;o 
 						</strong>
					</td>
				</tr>
