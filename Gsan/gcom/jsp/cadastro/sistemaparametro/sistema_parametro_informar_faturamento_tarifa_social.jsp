	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
			   ...
			   <tr>
					<td width="40%" align="left"><strong>Número máximo de meses para inserir conta antecipada:</strong></td>
				...
				<tr>
					<td width="40%" align="left">
						<strong>Número máximo de dias entre data ligação e leitura para tratar como nova ligação:</strong>
					</td>
