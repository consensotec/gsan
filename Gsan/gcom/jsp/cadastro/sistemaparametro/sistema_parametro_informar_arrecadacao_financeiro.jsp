...
<script>
	...
	function caracteresespeciais () { 
		...
		this.ab = new Array("numeroLayOut", "Número do Layout da FEBRABAN deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		...
		this.ae = new Array("numeroModuloDigitoVerificador", "Número do módulo verificador deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.af = new Array("numeroMesesPesquisaImoveisRamaisSuprimidos", "Número meses para pesquisa de imóveis com ramais suprimidos deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.ag = new Array("numeroAnoQuitacao", "Número de anos para geração da declaração de quitação de débitos deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.ah = new Array("numeroMesesAnterioresParaDeclaracaoQuitacao", "Quantidade de meses anteriores geração declaração de quitação de débitos deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.ai = new Array("valorMaximoBaixado", "Valor Máximo a ser Baixado deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.aj = new Array("diferencaMaximaBaixado", "Diferença Máxima para Baixa deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.al = new Array("percentualEntradaMinima", "Percentual de Entrada Mínima para Financiamento deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.am = new Array("percentualMaximoAbatimento", "Percentual Máximo para Abatimento de um Serviço deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.an = new Array("percentualTaxaFinanciamento", "Percentual de Taxa de Juros para Financiamento deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
		this.ap = new Array("percentualCalculoIndice", "Percentual da Média do Índice para Cálculo do Parcelamento deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	  }
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="40%" align="left">
						<strong>Número do Layout da FEBRABAN:</strong>
					</td>
					<td>
						<html:text maxlength="4" 
				...
				<tr>
						<td width="40%">
							<strong>Indicador Contrato Bancário da<br />Carteira 17:</strong>
						</td>
						<td>
							<strong> 
