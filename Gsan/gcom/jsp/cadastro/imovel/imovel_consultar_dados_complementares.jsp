...
<script language="JavaScript">
	...
	function habilitaMatricula() {
		...
		if (form.idImovelDadosComplementares.value != null
				...
				&& form.matriculaImovelDadosComplementares.value != "IMÓVEL INEXISTENTE") {
				...
				<td class="centercoltext" valign="top">
					...
					<table border="0" width="100%">
											...
											<table width="100%" align="center" bgcolor="#99CCFF" border="0">
												<tr>
													...
													<td align="center" width="96%">
														<strong>
															Dados do Imóvel<logic:present name="imovelExcluido" scope="request"> <font color="#ff0000">&nbsp;(Excluído)</font> </logic:present>
														</strong>
													</td>
												</tr>
											</table>
						...
						<tr>
						  ...
						  <!-- Inicio da tabela de Hitorico Clientes do Imovel -->
            <tr>
             <td colspan="6" >	
	             ...
	             <tr>
	             	...
	             	<table width="100%" align="center" bgcolor="#90c7fc" border="0">
	             		<tr bordercolor="#79bbfd">
							<td colspan="6" bgcolor="#79bbfd" align="center"><strong>Histórico de Clientes do Imóvel</strong></td>
						</tr>
						<tr bordercolor="#000000">
							...
							<td width="13%" bgcolor="#90c7fc" align="center">
							 <div align="center"><strong>Data Início Relação</strong></div>
							</td>
							<td width="13%" bgcolor="#90c7fc" align="center">
							 <div align="center"><strong>Data Fim Relação</strong></div>
							</td>
							<td width="15%" bgcolor="#90c7fc" align="center">
				...
				<tr>
					<td width="100%" colspan="6" >
						<logic:notEmpty name="colecaoHistoricoClientesImovel">
						<div style="width: 100%; height: 102; overflow: auto;">
							<table width="100%" align="left" bgcolor="#99CCFF" border="0">
								<%int contCliente = 0;%>
								<logic:notEmpty name="colecaoHistoricoClientesImovel" scope="session">
									<logic:iterate name="colecaoHistoricoClientesImovel" id="clienteImovel"
													type="ClienteImovel">
										...
										<tr bgcolor="#FFFFFF">
											...
											<td width="30%" align="left" >
												<div align="left">
													<logic:present	name="clienteImovel" property="cliente">
													<a	href="javascript:abrirPopup('exibirConsultarClienteAction.do?desabilitarPesquisaCliente=SIM&codigoCliente='+<bean:write name="clienteImovel" property="cliente.id" />, 500, 800);">
											...
											<td width="13%" align="center">
												<logic:present name="clienteImovel" property="dataInicioRelacao">
													<%=""+ Util.formatarData(clienteImovel.getDataInicioRelacao()) %>
												</logic:present> 
											...
											<td width="13%" align="center">
												<logic:present name="clienteImovel" property="dataFimRelacao">
													<%=""+ Util.formatarData(clienteImovel.getDataFimRelacao()) %>
												</logic:present> 
												<logic:notPresent name="clienteImovel" property="dataFimRelacao">
												&nbsp;
										  		</logic:notPresent>
											...
											<td width="15%" align="right">
												...
												<logic:notEmpty name="clienteImovel"
											...
											<td width="14%" align="right">
												<logic:notEmpty
													...
													<bean:define name="clienteImovel" property="cliente"
														id="cliente" />
					...
					<!-- Fim da tabela de Hitorico Clientes do Imovel -->	
								...
								<table width="100%" align="center" bgcolor="#90c7fc" border="0">
									...
									<tr bordercolor="#000000">
										...
										<td width="20%" bgcolor="#90c7fc">
											<div align="left" class="style9">
												<font color="#000000" style="font-size: 9px" face="Verdana, Arial, Helvetica, sans-serif">
													<strong>Escritório Cobrança</strong>
												</font>
											</div>
										</td>
										<td width="20%" bgcolor="#90c7fc">
											<div align="left" class="style9">
												<font color="#000000" style="font-size: 9px" face="Verdana, Arial, Helvetica, sans-serif">
													<strong>Advog. Resp. Cobrança</strong>
												</font>
											</div>
										</td>
									</tr>
										...
										<logic:present name="colecaoDadosImovelCobrancaSituacao">
											<logic:iterate name="colecaoDadosImovelCobrancaSituacao" id="imovelCobrancaSituacaoHelper">
												...
												%>
													...
													<td width="10%">
														<div align="left" class="style9">
															<font color="#000000" style="font-size: 9px" face="Verdana, Arial, Helvetica, sans-serif"> <!-- #dialog é o id do DIV definido como mostrado a seguir  -->
																				...
																				<logic:notEmpty name="imovelCobrancaSituacaoHelper" property="contasEnviadasCobrancaHelper">
																					...
																					<div id="boxes">
																						<div id="dialog" class="window">
																							...
																							<table width="100%" align="center" bgcolor="#90c7fc" border="0">
																								<tr bordercolor="#79bbfd">
																									<td colspan="7" bgcolor="#79bbfd" align="center"><b>Contas Enviadas Para Cobrança</b></td>
																								</tr>
																								<tr bordercolor="#000000">
																									<td bgcolor="#90c7fc"><b>Mês/Ano</b></td>
																									<td bgcolor="#90c7fc"><b>Vl.Conta</b></td>
																				...
																				<logic:notEmpty name="imovelCobrancaSituacaoHelper" property="contasPagasCobrancaHelper">
																					...
																					<div id="boxes">
																						<div id="dialog1" class="window">
																							...
																							<table width="100%" align="center" bgcolor="#90c7fc" border="0">
																								<tr bordercolor="#79bbfd">
																									<td colspan="7" bgcolor="#79bbfd" align="center"><b>Contas Pagas Em Cobrança</b></td>
																								</tr>
																								<tr bordercolor="#000000">
																									<td bgcolor="#90c7fc"><b>Mês/Ano</b></td>
																									<td bgcolor="#90c7fc"><b>Vl.Pago</b></td>
								...
								<table width="100%" align="center" bgcolor="#90c7fc" border="0">
									...
									<tr bordercolor="#000000">
										...
										<td width="60%" colspan="3" bgcolor="#90c7fc">
											<div align="left" class="style9">
												<font color="#000000" style="font-size: 9px" face="Verdana, Arial, Helvetica, sans-serif">
													<strong>Inclusões Aceitas</strong>
												</font>
											</div>
										</td>
									</tr>
								...
								<table width="100%" align="center" bgcolor="#90c7fc" border="0">
									<tr bordercolor="#79bbfd">
										<td colspan="3" align="center" bgcolor="#79bbfd">
											<strong>Anormalidades de Localidade Pólo:</strong>
										</td>
									</tr>
									<tr bordercolor="#000000">
										<td width="65%" bgcolor="#90c7fc" align="center">
								...
								<table width="100%" align="left" bgcolor="#90c7fc" border="0">
									<tr bordercolor="#79bbfd">
										<td colspan="6" bgcolor="#79bbfd" align="center">
											<strong>Histórico de Altera&ccedil;&atilde;o do Imóvel</strong>
										</td>
										<td align="center" bgcolor="#79bbfd">
											<input type="button" name="button" class="bottonRightCol" value="Pesquisar Histórico" onClick="javascript:pesquisarHistoricoImovel()">
										</td>
									</tr>
								</table>
								<table>
