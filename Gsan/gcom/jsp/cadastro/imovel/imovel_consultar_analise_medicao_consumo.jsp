				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF">
						...
						<logic:present name="indicadorPercentualAlternativoEsgoto" scope="session">
							<tr bgcolor="#99CCFF" class="styleFontePeqNegrito">
								<td align="center" colspan="3" width="50%">Limite de Consumo Alternativo</td>
								<td align="center" colspan="3" align="center" width="50%">Percentual de Consumo Alternativo</td>
							</tr>
							
							<tr bgcolor="#FFFFFF" class="styleFontePequena">
								<td colspan="3" align="center">${sessionScope.consultarImovelActionForm.limiteConsumoAlternativo}&nbsp;</td>
								<td colspan="3" align="center">${sessionScope.consultarImovelActionForm.percentualAlternativoEsgoto}&nbsp;</td>
							</tr>
						</logic:present>
				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF">
						<tr>
							...
							Hidr&ocirc;metro do Poço ou da Ligação de Esgoto</strong></td>
												...
												<tr bgcolor="#FFFFFF" class="styleFontePequena">
													...
													<td width="12%" align="center"><font color="#000000" style="font-size:9px"
														...
														<a title="${medicaoHistorico.leituraAnormalidadeInformada.descricao}" 
													     href="javascript:abrirPopup('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${sessionScope.consultarImovelActionForm.idImovelAnaliseMedicaoConsumo}&anoMes=${medicaoHistorico.mesAno}&metp=<%=LigacaoTipo.LIGACAO_AGUA%>&idFotoTipoLeituraConsumoAnormalidade=<%=ConstantesSistema.FOTO_TIPO_LEITURA_ANORMALIDADE%>&idAnormalidade=${medicaoHistorico.leituraAnormalidadeInformada.id}', 450, 550);">
							...
							%>
												<tr bgcolor="#FFFFFF" class="styleFontePequena">
													...
													<a title="${imovelMicromedicao.consumoHistorico.consumoAnormalidade.descricao}"
													     href="javascript:abrirPopup('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${sessionScope.consultarImovelActionForm.idImovelAnaliseMedicaoConsumo}&anoMes=${imovelMicromedicao.consumoHistorico.referenciaFaturamento}&metp=<%=LigacaoTipo.LIGACAO_AGUA%>&idFotoTipoLeituraConsumoAnormalidade=<%=ConstantesSistema.FOTO_TIPO_CONSUMO_ANORMALIDADE%>&idAnormalidade=${imovelMicromedicao.consumoHistorico.consumoAnormalidade.id}', 450, 550);">
							...
							%>
												<tr bgcolor="#FFFFFF" class="styleFontePequena">
													...
													<td width="12%" align="center"><font color="#000000" style="font-size:9px"
														face="Verdana, Arial, Helvetica, sans-serif">
													    <a title="${medicaoHistorico.leituraAnormalidadeInformada.descricao}" 
													     href="javascript:abrirPopup('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${sessionScope.consultarImovelActionForm.idImovelAnaliseMedicaoConsumo}&anoMes=${medicaoHistorico.mesAno}&metp=<%=LigacaoTipo.LIGACAO_ESGOTO%>&idFotoTipoLeituraConsumoAnormalidade=<%=ConstantesSistema.FOTO_TIPO_LEITURA_ANORMALIDADE%>&idAnormalidade=${medicaoHistorico.leituraAnormalidadeInformada.id}', 450, 550);">
 															 ${medicaoHistorico.leituraAnormalidadeInformada.id}
 														</a>
													</font></td>
													<td width="12%" align="center"><font color="#000000" style="font-size:9px"
							...
							%>
												<tr bgcolor="#FFFFFF" class="styleFontePequena">
													...
													<td width="13%" align="center"><font color="#000000"
														...
														face="Verdana, Arial, Helvetica, sans-serif">
														<a title="${imovelMicromedicao.consumoHistorico.consumoAnormalidade.descricao}"
													     href="javascript:abrirPopup('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${sessionScope.consultarImovelActionForm.idImovelAnaliseMedicaoConsumo}&anoMes=${imovelMicromedicao.consumoHistorico.referenciaFaturamento}&metp=<%=LigacaoTipo.LIGACAO_ESGOTO%>&idFotoTipoLeituraConsumoAnormalidade=<%=ConstantesSistema.FOTO_TIPO_CONSUMO_ANORMALIDADE%>&idAnormalidade=${imovelMicromedicao.consumoHistorico.consumoAnormalidade.id}', 450, 550);">
 															${imovelMicromedicao.consumoHistorico.consumoAnormalidade.descricaoAbreviada}
														</a>
													&nbsp;</font></td>
