	...
	<html:hidden property="verificaIndicadorTarifaCategoria"/>
		...
		<td valign="top" class="centercoltext">
			...
			<table bordercolor="#000000" width="100%" cellspacing="0">
										...
										<tr> 
											...
											<td>
												<input type="text" name="vezesMediaEstouro" value="<bean:write name="CategoriaActionForm" property="vezesMediaEstouro"/>" 
													size="4" maxlength="4" onKeyup="formataValorDecimalUmaCasa(this, 3);" style="text-align: right;"/>
											</td>
										</tr>
									</table>
								</td>
										...
										<tr> 
											...
											<td>
												<input name="porcentagemMediaBaixoConsumo" value="<bean:write name="CategoriaActionForm" property="porcentagemMediaBaixoConsumo"/>" 
													type="text" size="6" maxlength="6" onKeyup="formataValorDecimalUmaCasa(this, 5);" style="text-align: right;">&nbsp;%
											</td>
										</tr>
									</table>
								</td>
				...
				<logic:notEqual name="indicadorTarifaCategoria" value="1">
				
					<html:hidden property="limiteConsumo" />
					<html:hidden property="fatorLimiteConsumo" />					
