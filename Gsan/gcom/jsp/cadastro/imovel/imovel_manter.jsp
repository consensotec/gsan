		...
		<tr>
			...
			<table width="100%" cellpadding="0" cellspacing="0">	
				...
				<tr>
					...
					<tr>
						<td align="left">																
							<logic:present name="situacaoExclusaoConfirmada" scope="session">
								<table width="100%" border="0">
										<tr width="100%">
											<td ><p><strong>Observação da Exclusão:</strong></p></td>
										</tr>								
										<tr width="100%" align="left">											
											<td width="100%"><html:textarea style="width:100%;" property="mensagemObservacaoExclusao" cols="30" rows="4"
													onkeyup="limitTextArea(document.forms[0].mensagemObservacaoExclusao, 200, document.getElementById('utilizado'), document.getElementById('limite'));" />
											</td>
										</tr>
								</table>		
							</logic:present>															
