...
function visualizarImovelPerfilEnquadramento(){
 	var form = document.forms[0];
 	
	abrirPopup('exibirConsultarEnquadramentoImovelPerfilAction.do?idImovel=' + form.idImovelDadosCadastrais.value , 255, 750);		
}	
...
function abrirMapa(){
	var form = document.forms[0];
	var idImovel = form.idImovelDadosCadastrais.value;
	abrirPopup('exibirMapaKMLAction.do?idImovel='+idImovel, 590, 640);
}

function onloadControleBotaoMapa(){
	var form = document.forms[0];
	if(form.idImovelDadosCadastrais.value=="" 
		|| (form.coordenadaXDadosCadastrais.value=="" && form.coordenadaYDadosCadastrais.value=="")){
		form.botaoMapa.disabled = true;
	}
}

function abrirFotosAtualizacaoCadastral() {
	var form = document.forms[0];
	var idImovel = form.idImovelDadosCadastrais.value;
	if(!idImovel) return;
	abrirPopup('exibirConsultarFotosAtualizacaoCadastralPopupAction.do?idImovel='+idImovel,'700','750');
}

</script>
</head>

<body leftmargin="5" topmargin="5" onload="javascript:habilitaMatricula();setarFoco('idImovelDadosCadastrais');consultarImovelAjax();onloadControleBotaoMapa();">
		...
		<tr>
			...
			%>
						...
						<tr>
							...
							<logic:present name="imovelPerfilEnquadramento" scope="session">
								<div class="style9">
									<a href="javascript:visualizarImovelPerfilEnquadramento();"
									onmouseover="this.T_BGCOLOR='whitesmoke';this.T_FONTCOLOR='blue';this.T_LEFT=true;return escape( 'EXIBIR O HISTORICO DO PERFIL' ); ">									
										<html:text
											property="imovelPerfilDadosCadastrais" readonly="true"
											style="background-color:#EFEFEF; border:0; color: #000000; text-decoration: underline; cursor:pointer;"											 																					
											size="20" maxlength="20" />
									</a>
								</div>							
							</logic:present>
							<logic:notPresent name="imovelPerfilEnquadramento" scope="session">
								<div class="style9">																	
									<html:text property="imovelPerfilDadosCadastrais" readonly="true"
										style="background-color:#EFEFEF; border:0; color: #000000"
										size="20" maxlength="20" />								
								</div>							
							</logic:notPresent>								
						...
						<tr>
							...
							<td align="left"><strong>Tipo de &aacute;rea da quadra:</strong></td>
							<td align="left"><html:text
								property="tipoAreaQuadraDadosCadastrais" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000"
								size="20" maxlength="20" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td height="10" align="left">
								<div class="style9"><strong>Data Cadastramento:</strong></div>
							</td>
							<td align="left">
								<div class="style9">
									<html:text
										property="dataAtualizacaoCadastral" readonly="true"
										style="background-color:#EFEFEF; border:0; color: #000000"
										size="20" maxlength="20" />
								</div>
							</td>
