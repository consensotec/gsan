...
function consultarImovelAjax(){
	...
	if(form.idImovelPagamentos != null && form.idImovelPagamentos.value != ""){
		$.ajax({
				   type: "POST",
				   url: "consultarImovelAjaxAction.do?idImovel="+form.idImovelPagamentos.value,
				   data: "",
...
<body leftmargin="5" topmargin="5" onload="javascript:habilitaMatricula();setarFoco('idImovelPagamentos');consultarImovelAjax();">
			...
			<table width="100%" border="0" style="fonteReduzida">
				...
				%>
													...
													${pagamento.debitoTipo.descricao}													
														...
														<td width="11%" align="right"><logic:present
															name="pagamento" property="guiaPagamento">
