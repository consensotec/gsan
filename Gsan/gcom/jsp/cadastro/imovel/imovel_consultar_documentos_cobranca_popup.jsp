      ...
      <tr>
      	<td colspan="5">
			...
			<tr> 
		        ...
		        <td height="10"><strong>Vl. Acr&eacute;scimo:</strong></td>
		        <td>
					<html:text property="valorAcrescimos" size="10" readonly="true" style="background-color:#EFEFEF; border:0; text-align: right;"/>
		        </td>
			</tr>
			<tr> 
