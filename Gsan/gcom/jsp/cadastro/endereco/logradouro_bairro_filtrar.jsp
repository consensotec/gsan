...
function performanceJSP(){
	 ...
	 */
	var camposExclusao = [form.ultimoacesso, form.tipoPesquisa[0], form.tipoPesquisaPopular[0], form.indicadorUso[0]];
...
<html:form action="/filtrarLogradouroBairroAction.do" method="post"
					...
					<td width="11"><img border="0"
						...
						<td class="parabg">
							<logic:present name="indicadorImportanciaLogradouro" >
								Filtrar Importância Logradouro Bairro
							</logic:present>
							<logic:notPresent name="indicadorImportanciaLogradouro" >
								Filtrar Logradouro Bairro
							</logic:notPresent>
						</td>
					<td width="11"><img border="0"
				...
				<tr>
					...
					<td>
						<html:text  maxlength="4" 
									...
									onkeypress="javascript:validaEnter(event, 'exibirInformarImportanciaLogradouroBairroAction.do', 'idMunicipioFiltro');return isCampoNumerico(event);" />
				...
				<TR>
					...
					<TD>
						<html:text property="idBairro" 
								   ...
								   onkeypress="validaEnterDependencia(event, 'exibirInformarImportanciaLogradouroBairroAction.do', document.forms[0].idBairro, document.forms[0].idMunicipioFiltro.value, 'Município');return isCampoNumerico(event);" />
				...
				<tr>
					...
					<td>
						<html:text  maxlength="8" 
									...
									onkeypress="javascript:validaEnter(event, 'exibirInformarImportanciaLogradouroBairroAction.do', 'cep');return isCampoNumerico(event);" />
					...
					<td><strong> <font color="#ff0000"> 
						<logic:present name="indicadorImportanciaLogradouro" >
							<input name="Submit22"
								...
								onclick="window.location.href='/gsan/exibirManterLogradouroBairroAction.do?menu=sim&implog=sim';">
						</logic:present>
						<logic:notPresent name="indicadorImportanciaLogradouro" >
							<input name="Submit22"
								class="bottonRightCol" value="Limpar" type="button" tabindex="11"
								onclick="window.location.href='/gsan/exibirManterLogradouroBairroAction.do?menu=sim';">
						</logic:notPresent>
					</font></strong></td>
					<td align="right"></td>
					<td align="right">
					<gsan:controleAcessoBotao name="Button" value="Filtrar"
							  onclick="javascript:validarForm(document.forms[0]);" url="filtrarLogradouroBairroAction.do"/>
					<!--
