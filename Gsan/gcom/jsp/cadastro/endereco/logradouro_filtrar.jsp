	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td>
						<html:text  maxlength="8" 
							...
							<a href="javascript:abrirPopup('exibirPesquisarCepAction.do?idMunicipioDefinido='+document.forms[0].idMunicipioFiltro.value+'&indicadorUsoTodos=1');"> <img
								width="23" 
								height="21" 
								border="0"
								src="<bean:message key="caminho.imagens"/>pesquisa.gif"
								title="Pesquisar CEP" /></a> 
				...
				<tr>
				<logic:present name="indicadorImportanciaLogradouro" >
						<td colspan="2" align="left"><input name="Submit22" 
						...
						<td colspan="2" ><input name="Submit22"
								class="bottonRightCol" value="Limpar" type="button" tabindex="11"
