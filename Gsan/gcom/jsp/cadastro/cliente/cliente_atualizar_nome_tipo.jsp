		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td align="right">
					<div align="left"><html:radio property="indicadorNegativacaoPeriodo"
						value="<%=ConstantesSistema.SIM.toString()%>" />
					<strong>Sim</strong> <html:radio property="indicadorNegativacaoPeriodo"
						value="<%=ConstantesSistema.NAO.toString()%>" />
					<strong>Não</strong></div>
					</td>
				</tr>
				...
				<tr>
					<td><strong>Por SMS: <font color="#FF0000">*</font></strong></strong></td>
					<td>
