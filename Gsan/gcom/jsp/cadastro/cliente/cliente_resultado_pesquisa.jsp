						...
						<%}%>
							...
							<td>
								<logic:present name="consultaCliente">
									<logic:present name="pesquisarClienteAssociado">
										<a href="javascript:enviarDados('<bean:write name="cliente" property="id"/>', '<bean:write name="cliente" property="nome"/>', 'clienteAssociado');">
														<bean:write name="cliente" property="nome" /> 
													</a>
									</logic:present>
									<logic:notPresent name="pesquisarClienteAssociado">
