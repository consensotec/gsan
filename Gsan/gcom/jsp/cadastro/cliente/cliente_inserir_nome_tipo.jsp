...
function validacaoCaracteresEspeciais(evento) {
	...
	var tecla = null;
		...
		if(evento.target.name != 'nome' && evento.target.name != 'nomeAbreviado'){
...
<body leftmargin="5" topmargin="5"
	onload="setarFoco('${requestScope.nomeCampo}');validarDiaVencimentoTecla();validarPermiteNegativacao();">
			...
			<table width="100%" border="0">
				...
				<logic:present name="indicadorNomeFantasia" scope="session">
					...
					<tr>
						...
						<td width="82%">
						<html:text maxlength="100" property="nome" size="50" tabindex="1" />
				...
				<logic:notPresent name="indicadorNomeFantasia" scope="session">
						<tr>
							...
							<td width="82%"><html:text maxlength="100" property="nome"
				...
				<tr>
					<td><strong>Negativação por Período?:</strong></td>
					<td>
				...
				<tr><td><strong>Enviar Mensagem: </strong></td></tr>
				<tr>
					<td><strong>Por SMS: <font color="#FF0000">*</font></strong></td>
					<td>
					<html:radio property="indicadorEnviarSms" 
				...
				<tr>
					<td><strong>Por Email: <font color="#FF0000">*</font></strong></td>
					<td>
						<html:radio property="indicadorEnviarEmail" 
							value="<%=ConstantesSistema.SIM.toString()%>" tabindex="11" />
							<strong>Sim</strong>
						<html:radio property="indicadorEnviarEmail" 
							value="<%=ConstantesSistema.NAO.toString()%>" tabindex="11" />
							<strong>Não</strong>
					</td>				
				</tr>
