...
function required () {
	var permissao = document.getElementById("permissaoCnpj");
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0" dwcopytype="CopyTableRow">
				<tr>
					...
					<logic:present scope="application" name="urlHelp">
						<td align="right"><a href="javascript:abrirPopupHelp('${applicationScope.urlHelp}cadastroClienteAtualizarAbaPessoa', 500, 700);"><span style="font-weight: bold"><font color="#3165CE">Ajuda</font></span></a></td>									
					</logic:present>
    		...
    		<table width="100%" border="0">
				<logic:equal name="temPermissaoParaAlterarClienteSemCpf" value="${false}" scope="request">
					<tr>
						<td width="13%"><strong>CNPJ:<font color="#FF0000">*</font></strong></td>
						<td width="87%"><html:text property="cnpj" size="14" maxlength="14" tabindex="1" onkeypress="return isCampoNumerico(event);" /> <font size="1">&nbsp;</font></td>
					</tr>
				</logic:equal>
				<logic:notEqual name="temPermissaoParaAlterarClienteSemCpf" value="${false}" scope="request">
					<tr>
						<td width="13%"><strong>CNPJ:<font color="#FF0000"></font></strong></td>
						<td width="87%"><html:text property="cnpj" size="14" maxlength="14" tabindex="1" onkeypress="return isCampoNumerico(event);" /> <font size="1">&nbsp;</font></td>
					</tr>
				...
				<tr>
					...
					<td><html:select property="idRamoAtividade" tabindex="2">
						<html:option
							value="<%=""+ConstantesSistema.NUMERO_NAO_INFORMADO%>">&nbsp;</html:option>
						<html:options collection="ramoAtividades"
				...
				<tr>
					<logic:present name="indicadorPessoaFisica" scope="session">
						<td width="40%">
				...
				<tr>
					<td colspan="2"><strong>Cliente Respons&aacute;vel Superior</strong></td>
				</tr>
				<tr>
					<td><strong>C&oacute;digo :</strong></td>
					<td><html:text maxlength="9" property="codigoClienteResponsavel"
						tabindex="3" size="9"
						onkeypress="javascript:return validaEnter(event, '/gsan/atualizarClienteWizardAction.do?destino=2&action=exibirAtualizarClientePessoaAction', 'codigoClienteResponsavel');" />
					<a
						href="javascript:abrirPopup('exibirPesquisarResponsavelSuperiorAction.do', 400, 800);">
					<img src="<bean:message key="caminho.imagens"/>pesquisa.gif"
						border="0" width="23" height="21" title="Pesquisar Cliente"></a> <logic:present
						name="codigoClienteNaoEncontrado">
						<logic:equal name="codigoClienteNaoEncontrado" value="exception">
							<html:text property="nomeClienteResponsavel" size="50"
								maxlength="50" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #ff0000" />
						</logic:equal>
						<logic:notEqual name="codigoClienteNaoEncontrado"
							value="exception">
							<html:text property="nomeClienteResponsavel" size="50"
								maxlength="50" readonly="true"
						...
						name="codigoClienteNaoEncontrado">
						<logic:empty name="ClienteActionForm"
							property="codigoClienteResponsavel">
							<html:text property="nomeClienteResponsavel" value="" size="50"
								maxlength="50" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #ff0000" />
						</logic:empty>
						<logic:notEmpty name="ClienteActionForm"
							property="codigoClienteResponsavel">
							<html:text property="nomeClienteResponsavel" size="50"
								maxlength="50" readonly="true"
								style="background-color:#EFEFEF; border:0; color: #000000" />
