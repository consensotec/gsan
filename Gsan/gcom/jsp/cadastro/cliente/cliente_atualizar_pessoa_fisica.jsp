...
<html:form action="/atualizarClienteWizardAction" method="post">
	...
	<input type="hidden" id="permissaoCpf" value="${requestScope.temPermissaoParaAlterarClienteSemCpf}" />
    		...
    		<table width="100%" border="0">
				<logic:equal name="temPermissaoParaAlterarClienteSemCpf" value="${false}" scope="request">
					<tr>
						...
						<td width="82%"><html:text property="cpf" size="11" maxlength="11" tabindex="1" onkeypress="return isCampoNumerico(event);" /></td>
					</tr>
				</logic:equal>
					...
					<td>
						...
						<a href="javascript:abrirCalendario('ClienteActionForm', 'dataEmissao')">
							<img border="0" src="<bean:message key="caminho.imagens"/>calendario.gif"
								width="20" border="0" align="absmiddle" title="Exibir Calendário" alt="Exibir Calendário" /></a>
						<font size="2">dd/mm/aaaa</font>
					</td>
				</tr>
				<tr>
					<td height="24"><strong>&Oacute;rg&atilde;o Expeditor:</strong></td>
					<td>
				...
				<tr>
					<td height="24"><strong>Sexo:<strong><font color="#FF0000">*</font></strong></td>
					<td>
