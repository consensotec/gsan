			...
			%>
									<tr bgcolor="#cbe5fe">
										...
										<td width="30%" align="left">
											...
											<logic:present name="tipoPesquisaFuncionario">
												<logic:empty name="caminhoRetornoTelaPesquisaFuncionario">
													<a href="javascript:enviarDados('<bean:write name="funcionario" property="id"/>', '<bean:write name="funcionario" property="nome"/>', '${tipoPesquisaFuncionario}');">
														<bean:write name="funcionario" property="nome" />
													</a>
												</logic:empty>
												<logic:notEmpty name="caminhoRetornoTelaPesquisaFuncionario">
													<a href="javascript:enviarDadosParametros('<bean:write name="caminhoRetornoTelaPesquisaFuncionario"/>','<bean:write name="funcionario" property="id"/>', '<bean:write name="funcionario" property="nome"/>', '${tipoPesquisaFuncionario}');">
														<bean:write name="funcionario" property="nome" />
													</a>
												</logic:notEmpty>
											</logic:present>
											
											<logic:notPresent name="tipoPesquisaFuncionario">
