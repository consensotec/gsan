      ...
      <table width="100%" border="0">
       ...
       <table width="100%" border="0">
        <tr>
			...
			<td colspan="3"><html:text maxlength="9" property="id"
        ...
        <tr>
			...
			<td colspan="3"><html:text maxlength="40" property="nome"
        ...
        <tr> 
          ...
          <td colspan="3"><html:text maxlength="9" property="idUnidadeEmpresa" onkeyup="javascript:limparDescricaoEmpresa(document.PesquisarFuncionarioActionForm);"
