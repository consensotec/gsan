...
<%@ include file="/jsp/util/cabecalho.jsp"%>
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		...
		<table>
			...
			<tr><td><strong>Imóveis que tiveram os dados de cliente atualizado:</strong></td><td>${arquivo.qtdeImoveisComClienteAtualizados} (${arquivo.indiceAtualizacaoClientes}%)</td></tr>
		</table>
		<p>&nbsp;</p>
