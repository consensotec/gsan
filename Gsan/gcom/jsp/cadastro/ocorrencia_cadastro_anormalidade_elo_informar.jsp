		...
		<table width="100%" border="0">
			...
			<tr>
				...
				cor = "#FFFFFF";%>
								...
								<a href="#" onclick="abrirPopup('exibirFotoOcorrenciaCadastroAction.do?id=<bean:write name="cad1" property="id"/>',  '600', '800');">
				...
				cor2 = "#FFFFFF";%>
								...
								<a href="#" onclick="abrirPopup('exibirFotoAnormalidadeEloAction.do?id=<bean:write name="elo1" property="id"/>', 600, 800)">
								<input name="imageField" type="image"
									src="imagens/imgfolder.gif" width="18" height="18" border="0"></a>
								</logic:notEmpty>
								</td>
