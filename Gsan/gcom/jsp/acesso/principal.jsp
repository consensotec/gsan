...
<head>
    ...
    <script language="JavaScript" src="<bean:message key="caminho.js"/>util.js" ></script>
      ...
      <script language="JavaScript">
          ...
          <%    }else if(getServletContext().getAttribute("nomeEmpresa").equals("CAEMA")){    %>
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto01.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto02.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto03.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto04.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto05.jpg");
                  
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto06.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto07.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto08.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto09.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto10.jpg");
                  
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto11.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto12.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto13.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto14.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto15.jpg");
                  
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto16.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto17.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto18.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto19.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto20.jpg");
                  
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto21.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto22.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto23.jpg");

                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto24.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto25.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto26.jpg");

                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto27.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto28.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto29.jpg");

                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto32.jpg");

                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto33.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto34.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto35.jpg");

                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto36.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto37.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto38.jpg");

                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto39.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto40.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto41.jpg");

                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto42.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto43.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto44.jpg");

                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto45.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto46.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto47.jpg");

                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto48.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto49.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto50.jpg");

                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto51.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto52.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto53.jpg");
                  image_list[image_index++] = new imageItem("<bean:message key="caminho.imagens"/>caema_foto54.jpg");
        <%    }else{    %>
...
<%    }else if(getServletContext().getAttribute("nomeEmpresa").equals("CAEMA")){    %>
         <body leftmargin="5" topmargin="5" onLoad="rotateImage('imagemCaema')">
<%    }else{    %>
                      ...
                      <table width="95%">
                          <tr>
                              <td width="50%">
                                   ...
                                   <strong>
                                       <span style="font-size: 11px; font-family: verdana">Gerência Comercial: Arminda</span>
                                   </strong>
                                  <br>
                                  <span style="font-size: 11px; font-family: verdana">
                                  ...
                                  <br>
                                  <strong>
                                      <span style="font-size: 11px; font-family: verdana">Divisão de Cadastro: Jerocilio</span>
                                  </strong>
                                  <br>
                                  <span style="font-size: 11px; font-family: verdana">
                                  ...
                                  <br>
                                  <strong>
                                  <span style="font-size: 11px; font-family: verdana">Divisão de Atendimento ao Público: Silvia Ramalho</span>
                                  </strong>
                                  <br>
                                  <span style="font-size: 11px; font-family: verdana">
                                  &nbsp;&nbsp;Contato (95) 2121.2223<br>
                                  </span>
                              ...
                              <td width="50%" valign="top">
                                  ...
                                  <br>
                                  <strong>
                                  <span style="font-size: 11px; font-family: verdana">Gerência de Serviços: Raimundo da Silva</span>
                                  </strong>
                                  <br>
                                  <span style="font-size: 11px; font-family: verdana">
                   ...
                   if (getServletContext().getAttribute("nomeEmpresa").equals("CAEMA")){    %>
                    ...
                    <table width="95%">
                        <tr>
                             <td>
                                  <p>&nbsp;</p>
                                  <p><div align="center"><img name="imagemCaema" width="450" height="294" /></div>
                                  <p>&nbsp;</p>
                                  <logic:notEmpty name="mensagemGrupo" scope="session">		
								  <p>&nbsp;</p>
                                  <p>&nbsp;</p>
