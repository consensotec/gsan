...
<html:form action="/gerarRelatorioResumoDevedoresDuvidososAction.do"
	...
	type="gcom.gui.relatorio.financeiro.GerarRelatorioResumoDevedoresDuvidososActionForm"
	method="post">
	...
	<table width="770" border="0" cellpadding="0" cellspacing="5">
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="11"><img
						...
						border="0" /></td>
					<td class="parabg">Relátorio Resumo de Devedores Duvidosos</td>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="26%"><strong>Mês/Ano de Referência Contabil:<font
