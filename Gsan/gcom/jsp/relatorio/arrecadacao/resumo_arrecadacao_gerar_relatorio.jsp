...
function validarForm(){
	...
	if (validateGerarRelatorioResumoArrecadacaoActionForm(form) && form.mesAno.value != "" && validaMesAno(form) && !camposRequeridos()){
		var opcao = '';
		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					onkeyup="mascaraAnoMes(this, event);"   onkeypress="return isCampoNumerico(event);mascaraAnoMes(this, event);"/>
				...
				<tr>
					<td height="24" >
			          	<input type="button" 
			          		...
			          		value="Limpar"
			          		onclick="window.location.href='/gsan/exibirGerarRelatorioResumoArrecadacaoAction.do?menu=sim';" 
			          		/>
					</td>
