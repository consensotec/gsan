...
<script language="JavaScript">
	...
	function validarForm(){
		...
		if(validateGerarComparativoFatArrecExpurgoActionForm(form) && validaMesAno(form) && camposRequeridos()){
			toggleBox('demodiv',1);
		}
				...
				<tr>
					<td height="24" >
			          	<input type="button" 
			          		...
			          		value="Limpar"
			          		onclick="window.location.href='/gsan/exibirGerarComparativoFatArrecExpurgoAction.do?menu=sim';" 
			          		/>
					</td>
