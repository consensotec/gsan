...
<%@ taglib uri="/WEB-INF/c.tld" prefix="c"%>
  ...
  <script>
         ...
         function verificaRadioButtons(indicadorResponsavel, indicadorDebitoAutomaticoAnterior){
         	...
         	if(indicadorDebitoAutomaticoAnterior != null && indicadorDebitoAutomaticoAnterior != ''){
				if(indicadorDebitoAutomaticoAnterior == '1'){
					form.indicadorDebitoAutomaticoAnterior[0].checked = true;
				}else if(indicadorDebitoAutomaticoAnterior == '2'){
					form.indicadorDebitoAutomaticoAnterior[1].checked = true;
				}
			}else{
				form.indicadorResponsavel[1].checked = true;
			}
         ...
         function habilitaDebitoAutomaticoAnterior(){
      		var form = document.forms[0];
      	
      		if(form.numeroContratoAnt.value != null && form.numeroContratoAnt.value != ""){
      			form.indicadorDebitoAutomaticoAnterior[0].disabled = false;
      		}else{
      			form.indicadorDebitoAutomaticoAnterior[0].disabled = true;
      			form.indicadorDebitoAutomaticoAnterior[1].checked = true;
   			}
      	}
    ...
    <table border="0" width="100%">
      ...
      <tr>
        ...
        <td width="21%"><strong>
          ...
          <html:text 
	          	...
	          	maxlength="15" 
	          	onkeyup="javascript: habilitaTipoRelacao();habilitaDebitoAutomaticoAnterior();" 
      ...
      <tr>
          <td class="style3" width="30"><strong>Utilizar o c&oacute;digo do d&eacute;bito autom&aacute;tico do contrato anterior:</strong></td>
          <td colspan="5"><strong>
            <label>
              <html:radio property="indicadorDebitoAutomaticoAnterior" value="1" />
              Sim</label>
            <label>
              <html:radio property="indicadorDebitoAutomaticoAnterior" value="2" />
              N&atilde;o</label>
          </strong></td>
        </tr>
        <tr>
