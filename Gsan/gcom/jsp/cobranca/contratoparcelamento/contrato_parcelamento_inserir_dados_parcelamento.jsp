...
<script type="text/javascript">
	...
	function escolheuRD(dataVigenciaInicio, dataVigenciaFinal, dataContrato, numeroRD){
	 ...
	 function atualizarDataVencimento() {
	 	var form = document.forms[0];
	 	form.action = "exibirInserirContratoParcelamentoClienteAction.do?method=atualizarDataVencimento";
    	form.submit(); 
	 }
...
<table>
	...
	<tr>
		<td colspan="2"><strong>Dia do Vencimento das Parcelas:</strong><strong><span
			class="style2"><strong><font color="#FF0000">*</font></strong></span></strong></td>
		<td colspan="2"><strong> 
	...
	<tr>
		...
		<input name="dataVencimentoPrimParcela" type="text" 
			 ...
			 size="10" maxlength="10"	value="${contratoCadastrar.dataVencimentoPrimParcelaFormatada}"				
	...
	<tr>
		...
		<td colspan="2"><strong> 
		<html:text property="valorParceladoFinal" 
					size="20"
					readonly="true" 
