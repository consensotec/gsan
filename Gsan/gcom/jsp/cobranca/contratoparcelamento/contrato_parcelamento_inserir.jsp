  ...
  <script language="JavaScript">
		  ...
		  function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
		    ...
		    if(tipoConsulta == 'usuario'){
		    	...
		    	habilitaTipoRelacao();
		    	habilitaDebitoAutomaticoAnterior();
