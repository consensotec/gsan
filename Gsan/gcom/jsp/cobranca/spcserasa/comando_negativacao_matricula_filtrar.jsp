...
function limparForm(tipo){
    var form = document.forms[0];
 	if(tipo == 'usuario')
    {
		var ObjIdUsuarioResponsavel = returnObject(form,"idUsuarioResponsavel");
		var ObjNomeUsuarioResponsavel = returnObject(form,"nomeUsuarioResponsavel");
		ObjIdUsuarioResponsavel.value = "";
		ObjNomeUsuarioResponsavel.value = "";
		form.ObjNomeUsuarioResponsavel.value = "";
	}
}
-->
</script>
                ...
                <tr> 
	                ...
	                <td colspan="3">
						<html:text property="idUsuarioResponsavel" maxlength="9" size="9" 
							onkeyup="return validaEnterUsuarioResponsavel(event, 'exibirFiltrarComandoNegativacaoTipoMatriculaAction.do', 'idUsuarioResponsavel'); " />
                  ...
                  <td colspan="3">
                  	<table width="100%">
                  		<tr>
                  			...
                  			<td align="right" width="3%"><input name="Button3222" type="button" class="bottonRightCol" value="Filtrar" onClick="return enviar();" /></td>
                  		</tr>
                  	</table>                  	
                  </td>
                </tr>
