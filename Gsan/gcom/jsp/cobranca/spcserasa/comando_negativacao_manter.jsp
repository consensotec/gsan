...
<html:form action="/removerPerfilParcelamentoAction" method="post"
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
        ...
        <tr>
          ...
          <td class="parabg">Manter Comando de Negativação</td>
	  ...
	  <tr bordercolor="#cbe5fe"> 
        ...
        <tr bordercolor="#cbe5fe"> 
          <td colspan="6" bgcolor="#cbe5fe"><strong>Comando(s) de Negativação Selecionado(s):</strong></td>
        </tr>
        ...
        <tr bordercolor="#cbe5fe"> 
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr bordercolor="#000000">
		          ...
		          <td width="40%" bgcolor="#90c7fc"><div align="center"><strong>Título</strong></div></td>
		          <td width="13%" bgcolor="#90c7fc"><div align="center"><strong>Negativador</strong></div>          </td>
		          <td width="10%" bgcolor="#90c7fc"><div align="center"><strong>Simulação</strong></div>          </td>
		          <td width="17%" bgcolor="#90c7fc"><div align="center"><strong>Data e Hora de Geração do Comando</strong></div>          </td>
				  <td width="20%" bgcolor="#90c7fc"><div align="center"><strong>Usuário Responsável</strong></div>          </td>
		        </tr>
			<tr>
				<td colspan="6">
