...
function desabilitaIntervaloDiferente(){
	...
	var form = document.forms[0];	
	    if(form.codigoLocalidadeInicial.value != form.codigoLocalidadeFinal.value){	        
	        form.codigoSetorComercialInicial.disabled = true;		
		 	...
		 	form.codigoSetorComercialInicial.value = "";		
		 	form.codigoSetorComercialFinal.value = "";
		 	form.corSetorComercialInicial.value = "";		
		 	form.corSetorComercialFinal.value = "";
		  }else{
		    form.codigoSetorComercialInicial.disabled = false;		
			form.codigoSetorComercialFinal.disabled = false;
		 }		
	...
	function limparOrigem(tipo){
		...
		case 1:
			form.corLocalidadeInicial.value = "";
			form.codigoLocalidadeFinal.value = "";
			form.corLocalidadeFinal.value = "";
			form.codigoSetorComercialInicial.value = "";
		    form.codigoSetorComercialFinal.value = "";
              ...
              <table width="100%" border="0" dwcopytype="CopyTableRow">
               ...
               <tr>
                ...
                <tr>
                  ...
                  <td colspan="2"><strong><b><span class="style4">
                    <html:text property="codigoLocalidadeInicial" maxlength="3" size="4"
                    	...
                    	onkeypress="javascript:validaEnterLocalidadeInicial(event, 'exibirFiltrarComandoNegativacaoTipoCriterioAction.do', 'codigoLocalidadeInicial'); return isCampoNumerico(event);replicarLocalidade();" 
                    	onkeyup="replicarCampo(document.forms[0].codigoLocalidadeFinal,this);verificaLocalidadeInicial();desabilitarGrupoCobranca(); verificarSetorComercial();desabilitaIntervaloDiferente();limparOrigem(1);"/>
                ...
                <tr>
                  ...
                  <td colspan="2"><strong><b><span class="style4">
				  	<html:text property="codigoSetorComercialInicial" maxlength="3" size="4" 
				  	onkeypress="javascript:validaEnterSetorComercialInicial(event, 'exibirFiltrarComandoNegativacaoTipoCriterioAction.do', 'codigoSetorComercialInicial'); return isCampoNumerico(event);" 
                  ...
                  <td align="right">
	                  <table width="100%">
	                  	<tr>
	                  		...
	                  		<td align="right" width="5%"><img src="<bean:message key='caminho.imagens'/>voltar.gif" width="15" height="24"/></td>
	                  		<td align="right" width="2%"><input name="Button32222" type="button" class="bottonRightCol" value="Voltar" onClick="javascript:window.location.href='/gsan/exibirFiltrarComandoNegativacaoAction.do'"/></td>
	                  		<td align="right" width="5%"><input name="Button322" type="button" class="bottonRightCol" value="Filtrar" onClick="return filtrar();"/></td>
	                  	</tr>
	                  </table>	                  
                  </td>
                 </tr>
