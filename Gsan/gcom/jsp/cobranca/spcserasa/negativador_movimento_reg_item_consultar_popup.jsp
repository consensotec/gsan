            ...
            <table width="100%" border="0" dwcopytype="CopyTableRow">
              ...
              <tr>
                ...
                <td colspan="3"><span class="style1">                  
                  <html:text property="matriculaImovel" size="9" maxlength="9" disabled="true" style="background-color:#EFEFEF; border:0" />
                </span></td>
              </tr>
              <tr>
                <td><strong>Inscri&ccedil;&atilde;o:</strong></td>
                <td colspan="3"><html:text property="inscricao" disabled="true" style="background-color:#EFEFEF; border:0" size="20" maxlength="20"/>
              </tr>
              <tr>
                <td><strong>Situa&ccedil;&atilde;o da Liga&ccedil;&atilde;o de &Aacute;gua:</strong></td>
	                <td width="19%">                
	                	<html:text property="situacaoLigacaoAgua" disabled="true" style="background-color:#EFEFEF; border:0" size="20" maxlength="20"/>
	                </td>
                <td width="26%"><strong>Situa&ccedil;&atilde;o da Liga&ccedil;&atilde;o de Esgoto:</strong></td>
	                <td>                	
	                	<html:text property="situacaoLigacaoEsgoto" disabled="true" style="background-color:#EFEFEF; border:0" size="20" maxlength="20"/>
	                </td>
              </tr>
