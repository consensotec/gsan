	                ...
	                <td height="17" colspan="3">
	                	<table width="100%">
	                		<tr>
				                ...
				                <td align="right" width="5%"><input name="botaoAvancar" type="button" class="bottonRightCol" value="Avançar" onClick="javascript:validaForm();"/></td>
				                <td align="right" width="2%"><img src="<bean:message key='caminho.imagens'/>avancar.gif" width="15" height="24"/></td> 
