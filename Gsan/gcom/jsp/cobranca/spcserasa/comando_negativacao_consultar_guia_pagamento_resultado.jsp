...
function submeterForm(id){
 	window.open("/gsan/exibirConsultarComandoNegativacaoTipoGuiaPagamentoPopupAction.do?idSelecionado=" + id,"mywindow","menubar=0,scrollbars=1,resizable=1,width=785,height=520")
}	
			...
			<!--Início Tabela Reference a Páginação da Tela de Processo-->
              ...
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  ...
                  <td class="parabg">Consulta Comandos de Negativação - Por Guia de Pagamento de Cliente</td>
              ...
              <table width="100%" border="0">
                <tr> 
                  <td colspan="2"><strong>Comandos de Negativação Por Guia de Pagamento de Cliente:</strong></td>
                ...
                e Hora de Execu&ccedil;&atilde;o do Comando</strong></div></td>
                    ...
                    Respons&aacute;vel</strong></div></td>
                        ...
                        <!-- Colocar aqui o inicio da tag de paginação  --> 
                     	<logic:present name="collNegativacaoGuiaPagamento">
                     	<%int cont = 1;%>
					 	<logic:iterate name="collNegativacaoGuiaPagamento" id="negativacaoCriterio">
							<pg:item>
							<%cont = cont + 1;
							if (cont % 2 == 0) {%>
	                      		<tr bgcolor="#cbe5fe"> 
