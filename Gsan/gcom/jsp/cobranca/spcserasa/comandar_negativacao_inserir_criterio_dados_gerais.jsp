  ...
  <tr>
	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <tr>
        ...
        <td colspan="2">
        	<logic:present name="CpfCnpjValidado">
        	...
        	<logic:notPresent name="CpfCnpjValidado">
...
<script>
$(function() {
	document.getElementsByName('avancar').onclick = function() {
		botaoAvancarTelaEspera('/gsan/inserirComandoNegativacaPorCriterioWizardAction.do?concluir=true&action=inserirComandoNegativacaoDadosGeraisAction');
	}

	document.getElementsByName('desfazer')[0].onclick = function() {
		document.forms[0].action = 'exibirInserirComandoNegativacaoPorCriterioAction.do?desfazer=true';
