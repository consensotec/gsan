	...
	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
     ...
     <table>	
	    <tr bordercolor="#cbe5fe"> 
	         <td colspan="6" bgcolor="#cbe5fe">Contratos do negativador:</td>
	       </tr>
     </table>
	  ...
	  <table width="100%" cellpadding="0" cellspacing="0">
	 	...
	 	<tr>
	 		<td>
			 	<table width="100%" cellpadding="0" cellspacing="0">
				    <tr bordercolor="#cbe5fe"> 
			          <td bgcolor="#79BBFD" width="7%"><div align="center"><strong><a	href="javascript:facilitador(this);" id="0">Todos</a></strong></div></td>
			          
			          <td width="15%" bgcolor="#79BBFD"><div align="center"><strong>N&ordm; Contrato</strong></div></td>
			          <td width="23%" bgcolor="#79BBFD"><div align="center"><strong>Negativador</strong></div>          </td>
			           <td width="18%" bgcolor="#79BBFD"><div align="center"><strong>Data Início</strong></div>          </td>
			          <td width="37%" bgcolor="#79BBFD"><div align="center"><strong>Data Fim</strong></div>          </td>
			        </tr>
		      	</table>
      		</td>
      	</tr>
