...
<html:javascript staticJavascript="false" formName="AtualizarComandoNegativacaoPorGuiaPagamentoActionForm" dynamicJavascript="false" />
...
<div id="formDiv">
<html:form action="/atualizarComandoNegativacaoPorGuiaPagamentoWizardAction" method="post">
		...
		<td>
			<html:text property="idCliente" styleId="idCliente" size="8" maxlength="8" tabindex="2"
				onkeypress="validaEnterComMensagem(event,
					'atualizarComandoNegativacaoPorGuiaPagamentoWizardAction.do?action=exibirAtualizarComandoNegativacaoPorGuiaPagamentoDadosClienteAction',
			...
			<logic:empty name="AtualizarComandoNegativacaoPorCriterioActionForm" property="idCliente">
				<html:text property="descricaoCliente" styleId="descricaoCliente" size="38" readonly="true"
					style="background-color:#EFEFEF; border:0; color: #ff0000" />
			</logic:empty>

			<logic:notEmpty name="AtualizarComandoNegativacaoPorCriterioActionForm" property="idCliente">
				<html:text property="descricaoCliente" styleId="descricaoCliente" size="38" readonly="true"
					style="background-color:#EFEFEF; border:0; color: #000000" />
			</logic:notEmpty>
