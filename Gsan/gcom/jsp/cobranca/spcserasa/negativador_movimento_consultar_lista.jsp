	                ...
	                <td colspan="4"> 
	                	<table bordercolor="#000000" width="100%" cellspacing="0">
			                <tr>
				                <td width="615">
					                <table width="100%" border="0">
						                <tr bordercolor="#90c7fc"><td colspan="10" bgcolor="#90c7fc"><strong>Movimentos Encontrados </strong></td></tr>
							                <tr bordercolor="#000000">
								                ...
								                <td width="18%" bgcolor="#90c7fc"><div align="center"><strong>Data/Hora de Processamento </strong></div></td>
								                <td width="16%" bgcolor="#90c7fc"><div align="center"><strong>Qtde.Registros </strong></div></td>
								                <td width="17%" bgcolor="#90c7fc"><div align="center"><strong>Valor do D&eacute;bito </strong></div></td>
							                </tr>                        
													...
													<logic:iterate name="collectionNegativadorMovimento" id="negativadorMovimento">
														<pg:item>
															...
															<tr bgcolor="#cbe5fe">
																...
																<td width="40">
																	<div align="center">											
																	 	<a href="javascript:consultarNegativadorMovimentoDados(<bean:write name="negativadorMovimento" 
																	 		property="id"/>);">	<bean:write name="negativadorMovimento" property="numeroSequencialEnvio" />												
																		</a>
																	</div>	
																</td>
																<td width="40">
																	<div align="center">
																		<bean:write name="negativadorMovimento" property="dataEnvio" format="dd/MM/yyyy" />
																	</div>	
																</td>
																<td width="40">
																	<div align="center">
																...
																<td width="40">
																	<div align="center">
																		<bean:write name="negativadorMovimento" property="valorTotalEnvio" formatKey="money.format"/>
																	</div>	
																</td>											
															</tr>
														</pg:item>										
							 ...
							 <tr> 
						         <td colspan="4"><div align="left"><strong><font color="#FF0000">
							         <input type="submit" name="Submit223" class="bottonRightCol" value="Voltar Filtro" 
							         	onClick="javascript:window.location.href='<html:rewrite page="/exibirFiltrarNegativadorMovimentoAction.do?desfazer='S'"/>'">
							         <input type="button"
