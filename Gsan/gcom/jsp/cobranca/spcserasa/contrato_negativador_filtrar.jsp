            ...
            <table width="100%" border="0" >
              ...
              <tr>
					<td><div align="left"><strong><font color="#FF0000">
						<input name="Button" type="button" class="bottonRightCol" value="Limpar" align="left" onclick="window.location.href='<html:rewrite page="/exibirFiltrarContratoNegativadorAction.do?menu=sim"/>'" >
                   	</td>
