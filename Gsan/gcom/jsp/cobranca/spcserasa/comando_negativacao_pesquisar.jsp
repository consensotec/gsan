...
<SCRIPT LANGUAGE="JavaScript">
	...
	function recuperarDadosPopup(codigoRegistro, descricaoRegistro, tipoConsulta) {
	    ...
	    if(tipoConsulta == 'comandoNegativacao'){
	    	form.negativadorId.value = codigoRegistro;
...
<html:form action="/pesquisarComandoNegativacaoAction"
	...
	<table width="770" border="0" cellspacing="5" cellpadding="0">
		...
		<html:hidden property="negativadorId"/>
		<tr>
	...
	<table width="600" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="25%"><strong>Comando Simulado:<font color="#FF0000">*</font></strong></td>
					<td width="75%">
				...
				<tr> 
	           		<td width="25%" class="style3"><strong>Período de Geração do Comando:</strong></td>
					<td width="75%">
				...
				<tr> 
	           		<td width="25%" class="style3"><strong>Período de Execução do Comando:</strong></td>
					<td width="75%">
				...
				<tr> 
					...
					<td width="25%"> <strong>Usuário Responsável:</strong> </td>
                     <td width="75%">
					<logic:equal name="PesquisarComandoNegativacaoActionForm" 
				 property="popup" 
				 value="<%=ConstantesSistema.NAO.toString()%>">
				 		<html:text property="usuarioResponsavelId" 
								   ...
								   maxlength="11" 
								   tabindex="10" 
  								   onkeypress="javascript:validaEnterComMensagem(event, 'exibirPesquisarComandoNegativacaoAction.do?validaUsuarioResponsavel=true', 'usuarioResponsavelId','Usuário Responsável');return isCampoNumerico(event);"/>
						<a href="javascript:abrirPopup('exibirUsuarioPesquisar.do', 400, 750);" >
