...
<script language="JavaScript">
	...
	function verificarMovimentoRegistroChecado(valor){
		...
		if( valor==1){	
			form.movimentoCorrigido[0].disabled = false;
         	...
         	form.movimentoCorrigido[2].disabled = false;
     	}else{
     	 	form.movimentoCorrigido[0].disabled = true;
         	form.movimentoCorrigido[1].disabled = true;
         	form.movimentoCorrigido[2].disabled = true;
         	form.movimentoCorrigido[2].checked = true; 
     	}
	}
	...
	function habilitarPesquisaEloPolo(form) {
		chamarPopup('exibirPesquisarEloAction.do', 'elo', null, null, 275, 480, '',form.idEloPolo.value);
	}
		...
		<tr>
			...
			<td valign="top" class="centercoltext">
            	...
            	<table width="100%" border="0" >
              		<tr><td colspan="4">Para consultar movimento de negativador, informe os dados abaixo:</td></tr>	              	
	              	<tr>
	              		<td width="274"><strong>Negativador:<font color="#FF0000"></font></strong></td>	                	
              		...
              		<tr> 
	                	...
	                	<td colspan="3">
	                  		<html:radio property="tipoMovimento" value="1"/><strong>Inclus&atilde;o</strong>
	                   		<html:radio property="tipoMovimento" value="2"/><strong>Exclus&atilde;o</strong>
					   		<html:radio property="tipoMovimento" value="3"/><strong>Todos</strong>
						</td>
              		</tr>             
             		<tr>
						<td width="25%"><strong>Matrícula do Imóvel:</strong></td>						
						<td width="75%">
							<html:text maxlength="9" name="FiltrarNegativadorMovimentoActionForm" property="idImovel" 
								size="9" onkeypress="javascript: return validaEnter(event, 'exibirFiltrarNegativadorMovimentoAction.do', 'idImovel'); "
							...
							<logic:present name="imovelEncontrado" scope="session">
								<html:text property="nomeImovel" size="30" maxlength="30" readonly="true" style="background-color:#EFEFEF; border:0;"/>
							</logic:present>
							<logic:notPresent name="imovelEncontrado" scope="session">
								<html:text property="nomeImovel" size="30" maxlength="30" readonly="true" style="background-color:#EFEFEF; border:0; color:#FF0000"/>
							</logic:notPresent>								
                	...
                	<tr> 
	              	...
	              	<logic:present name="collMotivoRejeicao"> 
               		...
               		<tr> 
		                <td><strong>Movimentos com Registros:</strong></td>
		                <td colspan="3">
		                	<html:radio property="movimentoCorrigido" value="1" disabled="true" /> 
		                  	<strong>Corrigidos</strong>
		                    <html:radio property="movimentoCorrigido" value="2" disabled="true" /> 
		                  	<strong>N&atilde;o Corrigidos</strong>
		                    <html:radio property="movimentoCorrigido" value="3" disabled="true" /> 
							<strong>Todos</strong>
						</td>
              		</tr>
