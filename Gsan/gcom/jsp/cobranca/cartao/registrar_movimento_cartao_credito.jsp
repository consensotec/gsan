	...
	function validarForm(){
	   ...
	   if(form.idArrecadador.value.length > 0 && form.uploadPicture.value.length > 0) {
		  ...
		  if (validateRegistrarMovimentoCartaoCreditoActionForm(form)){
	  	 	if(confirm('Confirma registrar movimento de cartão de crédito/débito?')){
	    	   submitForm(form);
		  	}
		  }
	   }
...
<form action="/gsan/registrarMovimentoCartaoCreditoRedeAction.do"
	...
	<tr>
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<td class="parabg">Registrar Movimento Cartão de Crédito/Débito</td>
		...
		<table width="100%" border="0">
			<tr>
				<td colspan="2">Para registrar movimento de cartão de crédito/débito, informe os dados abaixo:</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" maxlength="3" name="idArrecadador" size="4"
						...
						value="${requestScope.parametroidArrecadador}">
					...
					<logic:present name="idArrecadadorNaoEncontrado">
						...
						<logic:equal name="idArrecadadorNaoEncontrado" value="exception">
							<input type="text" name="nomeArrecadador" size="40" maxlength="30" readonly="true"
								value="${requestScope.parametroNomeArrecadador}" style="background-color:#EFEFEF;
					...
					<logic:notPresent name="idArrecadadorNaoEncontrado">
						<input type="text" name="nomeArrecadador" size="40" maxlength="30" readonly="true"
							value="" style="background-color:#EFEFEF; border:0; color: #ff0000">
					</logic:notPresent> 
					
					<a href="javascript:limparPesquisaArrecadador(document.forms[0]);">
			...
			<tr>
				...
				<td><input type="file" style="textbox" name="uploadPicture"	size="50"/></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
		...
		<table width="100%">
			...
			<tr>
				...
				<td align="right">
					<gsan:controleAcessoBotao name="Button" value="Registrar" onclick="javascript:validarForm();"
						url="registrarMovimentoCartaoCreditoAction.do" />
