...
<script>
	function validarFormSubmit(){
    	...
    	if (validarCombinacao() && validarAnoMesReferencia()){
    		
    		if (form.matriculaImovel.value != ''){
    			form.action = '/gsan/exibirMotivoNaoGeracaoDocumentoTipoComandoCronogramaAction.do?filtroPorImovel=true';
    			form.submit();
    		}else{
				if(validarParametros()){
	    			if (form.indicadorTipoRelatorio[0].checked){
		    			form.action = '/gsan/gerarRelatorioMotivoNaoGeracaoDocumentoCronogramaAction.do?filtroPorComandoSintetico=true';
	    			}else{
	    				form.action = '/gsan/gerarRelatorioMotivoNaoGeracaoDocumentoCronogramaAction.do?filtroPorComandoAnalitico=true';
	    			}
	    			form.submit();
				}
    		}
	...
	function validarCombinacao(){
		...
		if (form.indicadorTipoPesquisa[1].checked && (form.matriculaImovel.value == null || form.matriculaImovel.value == '')){
			...
			retorno = false;
		}else if (form.anoMesReferencia.value == null || form.anoMesReferencia.value == '' || form.anoMesReferencia.value.length < 7){
			alert('Informe Referência da Cobrança');
			retorno = false;
		}else if (form.idCobrancaGrupo == null || form.idCobrancaGrupo.selectedIndex == 0){
			alert('Informe Grupo de Cobrança');
			retorno = false;
		}else if (form.idCobrancaAcao == null || form.idCobrancaAcao.selectedIndex == 0){
			alert('Informe Ação de Cobrança');
			retorno = false;
		}else if (form.idCobrancaAtividade == null || form.idCobrancaAtividade.selectedIndex == 0){
			alert('Informe Atividade de Cobrança');
			retorno = false;
		}else if (form.indicadorTipoPesquisa[1].checked && !testarCampoValorInteiroComZero2(form.matriculaImovel, "Matricula Imóvel")){
			retorno = false;
		}
	...
	function validarAnoMesReferencia(){
		...
		if (form.anoMesReferencia.value != ""){
			if (!validaAnoMesSemAlert(form.anoMesReferencia)){
...
function validarOpcoesGeograficas(){
	document.forms[0].action = "exibirMotivoNaoGeracaoDocumentoTipoComandoCronogramaAction.do?pesquisarComando=OK";
...
function setarUnidadeNegocio(){
	document.forms[0].action = "exibirMotivoNaoGeracaoDocumentoTipoComandoCronogramaAction.do";
	document.forms[0].submit();
}

function limparForm(){
	document.forms[0].action = "exibirMotivoNaoGeracaoDocumentoTipoComandoCronogramaAction.do?limparForm=sim";
	document.forms[0].submit();
}
				...
				<table width="100%" border="0">
					...
					<tr>
						<td colspan="2">
							<table width="100%">
								<tr>
									<td width="30%">
										<strong>Refer&ecirc;ncia da Cobran&ccedil;a:<font color="#FF0000">*</font></strong>
									</td>
									<td><strong>
											<html:text maxlength="7"
												property="anoMesReferencia" size="7"
												onkeyup="javascript:somente_numero(this);mascaraAnoMes(this, event);" />
										</strong>(mm/aaaa)
									</td>
								</tr>
								<tr>
									<td>
										<strong>Grupo de Cobran&ccedil;a:<font color="#FF0000">*</font></strong>
									</td>
									<td>
								...
								<tr>
									<td>
										<strong>A&ccedil;&atilde;o de Cobran&ccedil;a:<font color="#FF0000">*</font></strong>
									</td>
									<td>
								...
								<tr>
									<td>
										<strong>Atividade de Cobran&ccedil;a:<font color="#FF0000">*</font></strong>
									</td>
									<td>
										<html:select property="idCobrancaAtividade"
											style="width: 230px;">
											<logic:present name="colecaoCobrancaAtividade">
												<html:option value="" />
												<html:options collection="colecaoCobrancaAtividade"
		 	        ...
		 	        <tr>
		                ...
		                <td colspan="2"><strong>
			                <html:text maxlength="3"
			                  			 ...
			                  			 onkeypress="javascript:validaEnterComMensagem(event, 'exibirMotivoNaoGeracaoDocumentoTipoComandoCronogramaAction.do?pesquisarLocalidade=OK', 'idLocalidade','Localidade');return isCampoNumerico(event);" />
	                ...
	                <td colspan="2"><strong>
		                <html:text maxlength="3"
		                  			 ...
		                  			 onkeyup="somente_numero_zero_a_nove(this);"
	 	                  			 onkeypress="javascript:validaEnterDependencia(event, 'exibirMotivoNaoGeracaoDocumentoTipoComandoCronogramaAction.do?pesquisarSetorComercial=OK', this, document.forms[0].idLocalidade.value, 'Localidade');return isCampoNumerico(event);" />
	               ...
	               <tr>
		                ...
		                <td colspan="2"><strong>
			                <html:text maxlength="3" size="3" tabindex="1" property="idQuadra" onkeyup="somente_numero_zero_a_nove(this);"
			                  		onkeypress="javascript:validaEnterDependencia(event, 'exibirMotivoNaoGeracaoDocumentoTipoComandoCronogramaAction.do?pesquisarQuadra=OK',this,document.forms[0].idSetorComercial.value, 'Setor Comercial');return isCampoNumerico(event);" />
