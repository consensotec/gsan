...
<script language="JavaScript">
	...
	function IntegerValidations () {
		...
		this.ae = new Array("numeroDiasValidade", "Numero Dias Validade deve somente conter números positivos.", new Function ("varName", " return this[varName];"));
	}
...
<body leftmargin="5" topmargin="5" onload="setarFoco('${requestScope.nomeCampo}');habilitaNumeroDiasAcaoPredecessora();verificarChecado('${sessionScope.indicadorAtualizar}');"">
	...
	<html:form action="/filtrarAcaoCobrancaAction"
		...
		type="gcom.gui.cobranca.AcaoCobrancaFiltrarActionForm" method="post">
				...
				<td width="600" valign="top" bgcolor="#003399" class="centercoltext">
					...
					<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td class="parabg">Filtrar Ação de Cobrança</td>
							<td width="11">
					...
					<table width="100%" border="0">
						<tr>
							<td>
								<p>Para filtrar a ação de cobrança, informe os dados abaixo:</p>
							</td>
							<td align="right">
					...
					<table width="100%" border="0">
						<tr>
							<td>
								<strong>Descrição da Ação de Cobrança:</strong>
							</td>
							<td>
						...
						<tr>
							<td>
								<strong>Núm. Dias de Validade da Ação:</strong>
							</td>
							<td>
						...
						<tr>
							<td>
								<strong>Ação Predecessora:</strong>
							</td>
							<td>
						...
						<tr>
							<td>
								<strong>Núm. Dias entre a Ação e Predec.:</strong>
							</td>
							<td>
						...
						<tr>
							<td>
								<strong>Sit. da Lig. de Água dos Imóveis:</strong>
							</td>
							<td>
						...
						<tr>
							<td>
								<strong>Sit. da Lig. de Esgoto dos Imóveis:</strong>
							</td>
							<td>
						...
						<tr>
							<td>
								<strong>Critério de Cobrança:</strong>
							</td>
							<td>
								<html:text maxlength="4" property="idCobrancaCriterio" size="4" tabindex="8" onkeypress="javascript:validaEnterComMensagem(event, 'exibirFiltrarAcaoCobrancaAction.do', 'idCobrancaCriterio', 'Critério de Cobrança');document.forms[0].descricaoCobrancaCriterio.value = '';" />
								<a href="javascript:abrirPopup('exibirPesquisarCriterioCobrancaAction.do',400,600);">
									<img width="23" height="21" border="0" src="<bean:message key="caminho.imagens"/>pesquisa.gif" title="Pesquisar Critério de Cobrança" />
								</a>
						...
						<tr>
							...
							<td>
								<html:text maxlength="4" property="idServicoTipo" size="4" tabindex="9" onkeypress="javascript:validaEnterComMensagem(event, 'exibirFiltrarAcaoCobrancaAction.do', 'idServicoTipo', 'Tipo de Serviço');document.forms[0].descricaoServicoTipo.value = '';" />
						...
						<tr>
							<td colspan="2">
								<table width="100%" border="0">
									<tr>
										<td width="35%">
											<strong>Compõe o Cronograma:</strong>
										</td>
										<td width="15%">
									...
									<tr>
										<td>
											<strong>Ação Obrigatória:</strong>
										</td>
										<td>
									...
									<tr>
										<td>
											<strong>Considera Débitos a Cobrar:</strong>
										</td>
										<td>
									...
									<tr>
										<td width="45%">
											<strong>Considera Créditos a Realizar:</strong>
										</td>
										<td>
									...
									<tr>
										<td width="45%">
											<strong>Considera Notas Promissória:</strong>
										</td>
										<td>
									...
									<tr>
										<td>
											<strong>Considera Acrésc. por Impont.:</strong>
										</td>
										<td>
									...
									<tr>
										<td>
											<strong>Pode Exec. para Imóv. sem Déb.:</strong>
										</td>
										<td>
									...
									<tr>
										<td>
											<strong>Seleção ordenando por valor decrescente:</strong>
										</td>
										<td>
									...
									<tr>
										<td width="45%">
											<strong>Efetuar Ação para CPF/CNPJ Válido:</strong>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<html:radio property="indicadorMensagemSMS" value="2" tabindex="49" /><strong>Não</strong>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<html:radio property="indicadorMensagemEmail" value="2" tabindex="51" /><strong>Não</strong>
										</td>
									</tr>
									<tr>
										<td>
