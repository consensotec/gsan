		...
		<tr>
			...
			<table width="100%">
				...
				<tr>
					...
					<td align="right">
						...
						<!--  <input type="button" name="concluir" class="bottonRightCol" value="Concluir" onclick="javascript:concluirTransacao();">-->
					</td>
				</tr>
			...
			<logic:present name="dados" scope="request">
				...
				<table width="100%">
					...
					<logic:present name="imagemConsultarParcelamento" scope="session">
						<tr>
							<td width="30%"><strong>Valor da Transação:</strong></td>
							<td><html:text property="valorTransacao" size="20"
									readonly="true" tabindex="1" /></td>
						</tr>

						<tr>
							<td width="30%"><strong>Comprovante de pagamento:</strong>
							</td>
							<td align="left"><img width="300px" height="300px"
								src="<c:out value='${imagemConsultarParcelamento}'/>" /></td>
						</tr>
					</logic:present>
					...
					<tr>
						...
						<td align="right">
							<!-- <input type="button" name="Button" class="bottonRightCol" value="Salvar" onclick="validarForm();" tabindex="13" />-->
						</td>
					</tr>
				</table>
