...
function voltar(){
    var form = document.forms[0];
  	form.action = 'exibirConsultarDebitoAction.do?voltar=sim&menu=sim';
    form.submit();		
}


function tipoFormatoRelatorio(){
    var form = document.forms[0];
	var actionMontada;
     
	if(form.opcaoRelatorio.value==1){
		actionMontada = "gerarRelatorioDebitosClienteConsultarAction.do?relatorioEndereco=sim&pesquisaCliente=sim"+"&tipoRelatorio="+form.formatoRelatorio.value
	}else if (form.opcaoRelatorio.value==2){
		actionMontada = "gerarRelatorioDebitosResumidoClienteConsultarAction.do"+"?tipoRelatorio="+form.formatoRelatorio.value
	}else{
		actionMontada = "gerarRelatorioDebitosResumidoResponsavelConsultarAction.do?tipoRelatorio="+form.formatoRelatorio.value
	}
	
	form.action = actionMontada;
    form.submit();
}
			...
			%>
                ...
                <tr>
                	<td align="left" width="66%">
						<strong>Selecione o tipo de relatório:</strong>
				...
				<tr>
					<td align="left" width="66%"><select name="opcaoRelatorio">
						<strong>Selecione o tipo de relatório:</strong>
							<!--<option value="gerarRelatorioDebitosClienteConsultarAction.do?pesquisaCliente=sim&relatorioEndereco=sim">
							Relatório de Débitos com Endereço
							</option>-->
							<option value="1">
							...
							<logic:present name="ConsultarDebitoClienteActionForm" property="codigoClienteSuperior">
								<option value="3">
						...
						<td align="left">
							<span class="style2">
						   		<strong> 
		                  			<label>
						  				<html:radio property="formatoRelatorio" value="1"/> PDF </label>
		                  			<label> 
										<html:radio property="formatoRelatorio" value="6"/> CSV </label>				  
		                  		</strong>
		                  </span>
						</td>
				</tr>
				 <tr>
					...
					<td align="left">
						...
						class="bottonRightCol" value="Gerar Relatório" type="button"
						onClick="javascript:tipoFormatoRelatorio();">
					</td>
				</tr>				
