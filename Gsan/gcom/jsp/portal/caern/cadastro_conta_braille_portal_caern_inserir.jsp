		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$('[name=dataExpedicao]').datepicker({
					showOn : 'both',
					buttonImage : '/gsan/imagens/portal/caern/icons/data.gif',
					maxDate : '+0d',
			...
			function verificarDadosCliente(){
				...
				form.action = "/gsan/exibirInserirCadastroContaBraillePortalCaernAction.do?ok=sim";
				form.submit();
		...
		<div id="container">
	        ...
	        <div id="content">
				...
				<div id="fatura-email" class="serv-int">
	            	...
	            	<html:form action="/inserirCadastroContaBraillePortalCaernAction.do?lojaVirtual=S"
						name="InserirCadastroContaBraillePortalCaernActionForm"
						...
						<html:hidden property="nomeCliente" value="${ExibirServicosPortalCaernActionForm.nomeUsuario}" />
						<html:hidden property="cpfCnpjCliente" value="${ExibirServicosPortalCaernActionForm.cpfCnpjSolicitante}" />
						
						<html:hidden property="confirmarNomeCliente" value="${ExibirServicosPortalCaernActionForm.nomeUsuario}" />
						<html:hidden property="confirmarCpfCnpjCliente" value="${ExibirServicosPortalCaernActionForm.cpfCnpjSolicitante}" />
								...
								<tr>
									<td style="text-align: left">
										...
										<span class="cmp-text-2">
											...
											onkeyup="mascaraTelefone(this);"	alt="phone" /> 
										</span>
									</td>
								</tr>
								<tr>
