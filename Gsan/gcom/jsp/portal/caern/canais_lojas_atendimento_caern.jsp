...
<%@ page import="gcom.gui.portal.caern.LojaAtendimentoCaernHelper"%>
				...
				<div class="serv-int" style="width:880px;">
		        	...
		        	<div id="solicitacao-serv">
			        	...
			        	<html:form action="/exibirLojasAtendimentoPresencialPortalCaernAction.do"
								...
								type="gcom.gui.portal.caern.ExibirLojasAtendimentoPresencialPortalCaernActionForm" method="post" >
