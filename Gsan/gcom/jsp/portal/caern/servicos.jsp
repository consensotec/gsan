	        ...
	        <!-- Content - Start -->
	         ...
	         <%@ include file="/jsp/portal/caern/cabecalhoImovel.jsp"%>
	            ...
	            <ul id="lista-informacoes">
					...
					<li id="serv-11">
						<a href="exibirInserirCadastroContaBraillePortalCaernAction.do"> <span>Solicitar
								conta em braille</span> </a>
						<div class="info-serv" style="text-align: justify;">
							<p>Em atendimento a Lei Estadual nº 14.262 de 05 de janeiro
								de 2011, que assegura aos portadores de deficiência visual o
								direito de receber os boletos de pagamento de suas contas de
								água, energia elétrica e telefonia, confeccionados em braille,
								estamos disponibilizando esta funcionalidade para emissão deste
								serviço, o qual será solicitado sem custo adicional.</p>
							<p>Para acessar clique em solicitar conta em braille ou dirija-se
							 a uma loja de atendimento ou entre em contato com o call 
							 center, através do número 0800 084 0195.</p>
							<span id="bottom"></span> <img
								src="imagens/portal/caern/general/seta-info-servicos.gif" alt="Seta" />
						</div>
					</li>
				</ul>
	        </div>
