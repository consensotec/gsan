...
<html:html>
	<head>
		...
		<title>Caer | Informa&ccedil;&otilde;es</title>
	...
	<body>
		<div id="container"> 
		   <html:form action="/exibirInformacoesPortalCaerAction.do" method="post" 
				name="ExibirInformacoesPortalCaerActionForm" type="gcom.gui.portal.caer.ExibirInformacoesPortalCaerActionForm" >
		        ...
		        <!-- Content - Start -->
		         <div id="content">
		            ...
		            <ul id="lista-informacoes">
		          		...
		          		<li>
		            		<a href="exibirConsultarEstruturaTarifariaPortalCaerAction.do">
		          		...
		          		<li>
		            		<a href="exibirInformacoesPortalCaerAction.do?method=parcelamentoDebito">
		                ...
		                <li>
		            		<a href="exibirConsultarPagamentoFaturaPortalCaerAction.do">
								<span>Onde pagar sua fatura</span>
							</a>
						</li>
						
						<li>
		            		<a href="exibirConsultarTabelaServicosPortalCaerAction.do">
								<span>Tabela servi&ccedil;os</span>
							</a>
							<div class="info-serv" style="text-align:justify;display:block;">
		                        <p> &nbsp;
								</p>
		                        <p> &nbsp; Consulte o valor dos servi&ccedil;os prestados pela CAER.
								</p>
								<p> &nbsp;
								</p>
		                        <span id="bottom">&nbsp;</span>
		                ...
		                <li>
		            		<a href="exibirInformacoesPortalCaerAction.do?method=validarCertidaoNegativaDebito">
		            	...
		            	<!-- 
		            	<li>
		            		<a href="exibirConsultarRegulamentoServicosPortalCaerAction.do">
							...
							<div class="info-serv" style="text-align:justify;display:block;">
								...
								Companhia de Saneamento Ambiental do Maranh&atilde;o, caer.
		                		</p>
		                        <span id="bottom">&nbsp;</span>
		                        <img src="imagens/portal/caer/general/seta-info-servicos.gif" alt="Seta" />
		                    </div>
		            	...
		            	<!--
		            	<li>
		            		<a href="exibirInformacoesPortalCaerAction.do?method=vivaAgua">
		            	...
		            	<!--
	                  	<li>
		            		<a href="exibirInformacoesPortalCaerAction.do?method=ligacaoAguaEsgoto">
							...
							<div class="info-serv" 
		                        ...
		                        de esgoto da CAER deve o interessado formalizar o pedido de liga&ccedil;&atilde;o predial de &aacute;gua
		                         e/ou liga&ccedil;&atilde;o de esgoto, junto &aacute; Loja de Atendimento da CAER do Munic&iacute;pio munido, 
		                ...
		                <!--
            			<li>
		            		<a href="exibirInformacoesPortalCaerAction.do?method=debitoAutomatico">
							...
							<div class="info-serv" 
		                        ...
		                        CAER oferece aos seus Clientes.
								</p>
		                ...
		                <!-- 
		                <li>
		            		<a href="exibirInformacoesPortalCaerAction.do?method=orientacoesCliente">
