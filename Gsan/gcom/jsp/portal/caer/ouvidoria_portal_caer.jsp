	        ...
	        <!-- Content - Start -->
		        <div id="content">
		        	<div id="negociadebitos" class="serv-int" style="width:880px;">	
							...
							<br />
							<br />
							<p>A CAER disponibiliza mais um canal de comunicação para clientes e funcionários. A ouvidoria tem por objetivo estreitar a relação da diretoria com o público interno e externo. 
							...
							<ul class="lista">
								<li><em>Endereço:</em> Rua Melvin Jones, nº 219 - São Pedro</li>
