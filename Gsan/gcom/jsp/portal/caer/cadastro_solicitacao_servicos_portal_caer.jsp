	...
	<head>
		...
		<script type="text/javascript">
			...
			function carregarEspecificacao(){
				redirecionarSubmit('exibirInserirSolicitacaoServicosPortalCaerAction.do');
			}
		...
		<div id="container">
			...
			<div id="content">
				...
				<div id="solicitacao-serv" class="serv-int">
	            	...
	            	<html:form action="/inserirSolicitacaoServicosPortalCaerAction.do"
						name="InserirSolicitacaoServicosPortalCaerActionForm"
						type="gcom.gui.portal.caer.InserirSolicitacaoServicosPortalCaerActionForm" method="post"
