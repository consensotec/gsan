	...
	<body>
		<div id="container">
	        ...
	        <div id="content">
	        	<div id="text-top" style="text-align:justify;">
					A Loja Virtual da Companhia de &Aacute;guas e Esgotos de Roraima &eacute; o ambiente onde se encontram dispon&iacute;veis os servi&ccedil;os da empresa. Esta &eacute; a forma mais r&aacute;pida de atendimento, tudo para facilitar a sua vida.					
	            </div>
	            <div id="info-index" class="box">
	            	<a href="exibirInformacoesPortalCaerAction.do" title="Informações | Tire suas dúvidas e entenda sua conta">
	                    <span id="text-box" style="text-align:justify;">
	                    	Este acesso permitir&aacute; esclarecimentos sobre diversos servi&ccedil;os que a CAER oferece aos seus clientes. Para conhecer estes serviços ou tirar suas dúvidas clique no link informa&ccedil;&otilde;es.
	                    </span>
	                </a>
	            </div>
	            <div id="servicos-index" class="box">
				    ...
				    <html:form styleId="form-matricula" action="/exibirServicosPortalCaerAction.do?method=servicos" method="post" 
	    ...
	    <logic:present name="solicitarCpfCnpj" scope="request">
		    <div id="solicitarCpfCnpj" style="display:none; cursor: default;">
		    	...
		    	<html:form styleId="form-matricula" style="padding: 8px 0 0 0px; width: 100%;" action="/exibirServicosPortalCaerAction.do?method=servicos&vcpf=true" method="post" 
					name="ExibirServicosPortalCaerActionForm" type="gcom.gui.portal.caer.ExibirServicosPortalCaerActionForm" >
                    <fieldset>
                        ...
                        <logic:present name="cpfCnpjInvalido" scope="request">
							<span style="display: block; background: url('/gsan/imagens/portal/caer/forms/cpf_cnpj_invalido.png') no-repeat scroll 0pt 0pt transparent; width: 100px; margin-right: -12px;" id="cpfCnpjError"></span>
                        ...
                        <logic:present name="cpfCnpjNaoCadastrado" scope="request">
							<span style="display: block; background: url('/gsan/imagens/portal/caer/forms/cpf_cnpj_nao_cadastrado.png') no-repeat scroll 0pt 0pt transparent; width: 180px; margin-right: -12px;" id="cpfCnpjError"></span>
							<script>
