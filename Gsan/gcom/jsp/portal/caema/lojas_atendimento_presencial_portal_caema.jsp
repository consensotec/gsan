...
<%@ page import="gcom.gui.portal.caema.LojaAtendimentoCaemaHelper"%>
				...
				<div class="serv-int" style="width:880px;">
		        	...
		        	<div id="solicitacao-serv">
			        	...
			        	<html:form action="/exibirLojasAtendimentoPresencialPortalCaemaAction.do"
								...
								type="gcom.gui.portal.caema.ExibirLojasAtendimentoPresencialPortalCaemaActionForm" method="post" >
