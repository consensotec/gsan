...
<%@ page import="gcom.gui.portal.saae.LojaAtendimentoSaaeHelper"%>
	...
	<head>
		...
		<style type="text/css">
			...
			#lista-informacoes li {
				background: url("/gsan/imagens/portal/saae/general/arrow-link.gif") no-repeat;
				float: left;
				height: 39px;
				margin-bottom: 5px;
				position: relative;
			...
			#lista-informacoes li.localSelecionado {
				background: url("/gsan/imagens/portal/saae/general/arrow-link-hover.gif") no-repeat;
			}
		...
		<div id="container">
	        ...
	        <div id="content">
				...
				<div class="serv-int" style="width:880px;">
					...
					<p>&nbsp;</p>
					<p class="paragrafo">
						Para melhor atender você, os atendimentos são realizados presencialmente no próprio departamento
					</p>
					<p>&nbsp;</p>
					...
					<ul style="width:100%;margin-top:25px;">
						<li style="width:100%;float:left;">
							<div class="box">
								...
								<br /><br />
								Rua Barão de Cotegipe, Centro da cidade (em frente à praça do Jacaré),  das 8h às 17h.<br/>
							</div>
						</li>
					</ul>
	        		...
	        		<ul id="lista-informacoes">
		        		<li class="link">
		            		<a href="exibirLojasAtendimentoPresencialPortalSaaeAction.do?local=regiaoMetropolitana" class="regiaoMetropolitana">
								<span>Boa Vista</span>
							</a>
		                </li>
		        		<li class="link">
		            		<a href="exibirLojasAtendimentoPresencialPortalSaaeAction.do?local=interior" class="interior">
		        	...
		        	<div id="solicitacao-serv">
			        	...
			        	<html:form action="/exibirLojasAtendimentoPresencialPortalSaaeAction.do"
								name="ExibirLojasAtendimentoPresencialPortalSaaeActionForm"
								type="gcom.gui.portal.saae.ExibirLojasAtendimentoPresencialPortalSaaeActionForm" method="post" >
			        	...
			        	<div id="details">
		        			<div id="lojas" style="width: 370px; float: left; margin-left: 2px; margin-top: 16px; min-height:370px;">
		        				<ul id="lista-informacoes">
		        					<logic:present name="colecaoLojas">
			        					<logic:iterate name="colecaoLojas" id="loja" scope="request" type="LojaAtendimentoSaaeHelper">
				        					<li class="lista-loja">
		        			...
		        			<div class="detshow" style="background: url(/gsan/imagens/portal/saae/general/info-servico-top.gif) no-repeat 0 0 #f5f6f6; width: 470px; float: left; margin-left: 2px; margin-top: 16px; min-height:370px;">
		        				<div id="content-detalhe"></div> 
	        				</div>
        					<span class="detshow" style="background: url(/gsan/imagens/portal/saae/general/info-servico-bottom.gif) no-repeat scroll 0 0 transparent; float: left; height: 10px; width: 470px; margin-left:375px; ">&nbsp;</span>
		        		</div>
		        	</div>
	        	</div>
	       </div>
