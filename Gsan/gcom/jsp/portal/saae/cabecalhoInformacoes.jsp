	...
	<body>
		<logic:present scope="request" name="voltarInformacoes">
			<div id="voltar-informacoes" class="serv-int btn-voltar-informacoes" >
				<a href="exibirInformacoesPortalSaaeAction.do" title="Voltar Para o Menu de Informações">
		   			<img src="/gsan/imagens/portal/saae/general/btn-voltar-informacoes.gif" alt="Voltar Para o Menu de Informações" />
				</a>
			</div>
		</logic:present>
