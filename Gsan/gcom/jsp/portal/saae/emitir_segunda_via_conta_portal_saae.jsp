	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#btnPesquisar').click(function(){
				$('form')
						.attr('action', 'exibirServicosPortalSaaeAction.do?method=declaracaoAnual')
						.submit();
			});
		});
	</script>	
	...
	<div id="container">
		...
		<div id="content">
			...
			<div id="seg-via-conta" class="serv-int">
				<html:form 	action="/emitirSegundaViaContaPortalSaaeAction.do?method=emitirSegundaVia" method="post" style="width:100%;">
					<html:hidden property="matricula" value="${ExibirServicosPortalSaaeActionForm.matricula}" />
					<html:hidden property="nomeUsuario" value="${ExibirServicosPortalSaaeActionForm.nomeUsuario}" />
					...
					<ul id="desc-debito">
						<li>
							...
							${EmitirSegundaViaContaPortalSaaeActionForm.valorDebito} <span style="width:2px;float:none;padding:0;">|</span>
						</li>
						<li>
							<em>Data:</em> ${EmitirSegundaViaContaPortalSaaeActionForm.data} <span style="width:2px;float:none;padding:0;">|</span>
						</li>
						<li>
							<em>Valor do Débito a Cobrar: R$</em>
							${EmitirSegundaViaContaPortalSaaeActionForm.valorDebitoCobrado}
						</li>
					</ul>
								...
								<tr class="tr-<%=(i%2) + 1%>">
									...
									<td>
										<a href="javascript:abrirPopup('gerarRelatorio2ViaContaAction.do?cobrarTaxaEmissaoConta=N&idConta='+<%="" + contaValoresHelper.getConta().getId()%>, 400, 800);" 
											...
											<img src="imagens/portal/saae/icons/print.gif" alt="Imprimir Fatura" />
										</a>
									</td>	
										...
										<div>
											...
											<ul class="box-banco">
												<li><a href="javascript:abrirPopup('enviarDadosBancosAction.do?banco=BancoBrasil&idConta=<%="" + contaValoresHelper.getConta().getId()%>', 800, 600);" 
														...
														<img src="imagens/portal/saae/general/banco-brasil.gif" alt="Banco do Brasil" />
													</a>
												</li>
												<!-- <li><a href="javascript:window.open('http://www.bancoreal.com.br','mywindow','width=700,height=700,toolbar=yes,
														...
														<img src="imagens/portal/saae/general/banco-santander.gif" alt="Banco Santander" />
													</a>
												</li> -->
												<li><a href="javascript:
														...
														resizable=yes');window.close();" 
														title="Bradesco">
														<img src="imagens/portal/saae/general/banco-bradesco.gif" alt="Bradesco" />
												</a>
												</li>
												<li><a href="javascript:window.open('http://www.caixa.gov.br','mywindow','width=700,height=700,toolbar=yes,
														...
														<img src="imagens/portal/saae/general/banco-caixa.gif" alt="Caixa Econômica Federal" />
													</a>
												</li>
												<li class="close"><img
													src="imagens/portal/saae/icons/close.gif" alt="" />
												</li>
											</ul>
										</div>
									</td>
