	...
	<table width="580" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>					
					...
					<td align="right"><a
						...
						style="font-weight: bold"><font color="#3165CE">Ajuda</font></span></a>
					</td>
				</tr>
			</table>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="19%"><strong>Tipo de Usu&aacute;rio:</strong></td>
				...
				<tr>
					...
					<td colspan="3"><logic:present name="bloquearUnidadeOrganizacional"
						scope="session">
				...
				<tr>
					...
					<logic:present name="caminhoRetornoTelaPesquisaUsuario">
						<input type="button" name="Button" class="bottonRightCol"
							value="Voltar" onclick="redirecionarSubmit('${caminhoRetornoTelaPesquisaUsuario}.do')">
					</logic:present> 
