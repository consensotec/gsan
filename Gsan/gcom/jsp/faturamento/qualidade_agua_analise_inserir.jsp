...
<script>
	...
	function IntegerValidations () {
		...
		this.ba = new Array("quantidadeDurezaTotalExigidas", "Quantidade Dureza Exigidas deve somente conter números positivos.", new Function ("varName", "return this[varName];"));
		this.bb = new Array("quantidadeDurezaTotalAnalisada", "Quantidade Dureza Analisadas deve somente conter números positivos.", new Function ("varName", "return this[varName];"));
		this.bc = new Array("quantidadeDurezaTotalConforme","Quantidade Dureza Conforme deve somente conter números positivos.",new Function ("varName", "return this[varName];"));
		this.bd = new Array("quantidadePhExigidas","Quantidade Ph Exigidas deve somente conter números positivos.",new Function ("varName", "return this[varName];"));
		this.be = new Array("quantidadePhAnalisada","Quantidade Ph Analisadas deve somente conter números positivos.",new Function ("varName", "return this[varName];"));
		this.bf = new Array("quantidadePhConforme","Quantidade Ph Analisadas deve somente conter números positivos.",new Function ("varName", "return this[varName];"));		
	}	
	...
	function caracteresespeciais () {
		...
		this.ba = new Array("quantidadeDurezaTotalExigidas", "Quantidade Dureza Exigidas possui caracteres especiais.", new Function ("varName", "return this[varName];"));
		this.bb = new Array("quantidadeDurezaTotalAnalisada", "Quantidade Dureza Analisadas possui caracteres especiais.", new Function ("varName", "return this[varName];"));
		this.bc = new Array("quantidadeDurezaTotalConforme","Quantidade Dureza Conforme possui caracteres especiais.",new Function ("varName", "return this[varName];"));
		this.bd = new Array("quantidadePhExigidas","Quantidade Ph Exigidas possui caracteres especiais.",new Function ("varName", "return this[varName];"));
		this.be = new Array("quantidadePhAnalisada","Quantidade Ph Analisadas possui caracteres especiais.",new Function ("varName", "return this[varName];"));
		this.bf = new Array("quantidadePhConforme","Quantidade Ph Analisadas possui caracteres especiais.",new Function ("varName", "return this[varName];"));
				...
				<logic:present name="inserirTodosAtivado" scope="request">
					<tr>
						...
						<table width="100%" align="center" bgcolor="#99CCFF">
							...
							<tr bgcolor="#cbe5fe">
								<td width="25%"><strong>Quantidade Coliformes Termotolerantes / E.Coli :</strong></td>
								<td width="25%" align="center"><html:text
							...
							<tr bgcolor="#cbe5fe">
								...
								<td width="25%" align="center"> 
									<html:text property="quantidadePhExigidas" size="4" 
											   maxlength="4" readonly="true" tabindex="1"
											   style="background-color:#EFEFEF; border:0;"
											   onkeypress="return isCampoNumerico(event);"/>
								</td>
								<td width="25%" align="center"> 
									<html:text property="quantidadePhAnalisada" size="4" 
											   maxlength="4" readonly="true" tabindex="1"
											   style="background-color:#EFEFEF; border:0;"
											   onkeypress="return isCampoNumerico(event);"/>
								</td>
								<td width="25%" align="center"> 
									<html:text property="quantidadePhConforme" size="4" 
											   maxlength="4" readonly="true" tabindex="1"
											   style="background-color:#EFEFEF; border:0;"
											   onkeypress="return isCampoNumerico(event);"/>
								</td>								
							...
							<tr bgcolor="#cbe5fe">
								<td width="25%"><strong>Dureza Total: </strong></td>
								<td width="25%" align="center"> 
									<html:text property="quantidadeDurezaTotalExigidas" size="4" 
											   maxlength="4" readonly="true" tabindex="1"
											   style="background-color:#EFEFEF; border:0;"
											   onkeypress="return isCampoNumerico(event);"/>
								</td>
								<td width="25%" align="center"> 
									<html:text property="quantidadeDurezaTotalAnalisada" size="4" 
									           maxlength="4" readonly="true" tabindex="1"
											   style="background-color:#EFEFEF; border:0;"
											   onkeypress="return isCampoNumerico(event);"/>
								</td>
								<td width="25%" align="center"> 
									<html:text property="quantidadeDurezaTotalConforme" size="4" 
									           maxlength="4" readonly="true" tabindex="1"
											   style="background-color:#EFEFEF; border:0;"
											   onkeypress="return isCampoNumerico(event);"/>
								</td>								
					...
					<tr>
						...
						<table width="100%" align="center" bgcolor="#99CCFF">
							...
							<tr bgcolor="#cbe5fe">
								<td width="25%"><strong>Ph: </strong></td>
								<td width="25%" align="center"> 
									<html:text property="quantidadePhExigidas" size="5" 
											   maxlength="5" tabindex="1"											   
											   onkeypress="return isCampoNumerico(event);"/>
								</td>
								<td width="25%" align="center"> 
									<html:text property="quantidadePhAnalisada" size="5" 
											   maxlength="5" tabindex="1"											   
											   onkeypress="return isCampoNumerico(event);"/>
								</td>
								<td width="25%" align="center"> 
									<html:text property="quantidadePhConforme" size="5" 
											   maxlength="5" tabindex="1"											   
											   onkeypress="return isCampoNumerico(event);"/>
								</td>								
							</tr>
							...
							<tr bgcolor="#cbe5fe">
								<td width="25%"><strong>Dureza Total: </strong></td>
								<td width="25%" align="center"> 
									<html:text property="quantidadeDurezaTotalExigidas" size="5" 
											   maxlength="5" tabindex="1"											   
											   onkeypress="return isCampoNumerico(event);"/>
								</td>
								<td width="25%" align="center"> 
									<html:text property="quantidadeDurezaTotalAnalisada" size="5" 
									           maxlength="5" tabindex="1"											   
											   onkeypress="return isCampoNumerico(event);"/>
								</td>
								<td width="25%" align="center"> 
									<html:text property="quantidadeDurezaTotalConforme" size="5" 
									           maxlength="5" tabindex="1"											   
											   onkeypress="return isCampoNumerico(event);"/>
								</td>								
							</tr>
