										...
										<select name="leiturista_${subrota.codigoRota}" style="width: 310px;">
											...
											<logic:iterate name="colecaoLeiturista" id="leiturista">
												<c:if test="${leiturista.id == subrota.idLeiturista}">
													<c:if test="${leiturista.cliente != null}">
														<option value="${leiturista.id}" selected>${leiturista.cliente.nome}</option>
													</c:if>
													<c:if test="${leiturista.funcionario != null}">
														<option value="${leiturista.id}" selected>${leiturista.funcionario.nome}</option>
													</c:if>													
												</c:if>
												<c:if test="${leiturista.id != subrota.idLeiturista}">
													<c:if test="${leiturista.cliente != null}">
													...
													<c:if test="${leiturista.funcionario != null}">
														<option value="${leiturista.id}">${leiturista.funcionario.nome}</option>
													</c:if>
												</c:if>
											</logic:iterate>
										</select>
