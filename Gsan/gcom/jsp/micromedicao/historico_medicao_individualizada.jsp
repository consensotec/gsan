...
function voltar(){
	var form = document.forms[0];
	form.action = "/gsan/exibirManterHistoricoMedicaoIndividualizadaAction.do"
	form.submit();
}
</script>
</head>
		...
		<tr>
			...
			<td valign="top" class="centercoltext"><!--Início Tabela Reference a Páginação da Tela de Processo-->
							...
							<table width="590" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
									<td height="0">
										...
										<div style="overflow: auto; width: 590px; height: 200px">
										<table width="590">	
											<%String cor = "#cbe5fe";%>
											<%String styleColor = "";%>
											<%int contador = 0;	%>
				...
				<table border="0">
					<tr>
						<td align="left">
							<input name="Submit222"	class="bottonRightCol" value="Voltar" type="button"	onclick="javascript:voltar();">
