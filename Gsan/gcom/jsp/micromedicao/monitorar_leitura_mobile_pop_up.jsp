					...
					<tr bgcolor="#cbe5fe">
						...
						<table>	
							<tr bordercolor="#000000" bgcolor="#90c7fc">
								...
								<td width="10%" bgcolor="#90c7fc">
								<div align="center"><strong>Anorm. Leit.</strong></div>
								</td>
								<td width="10%" bgcolor="#90c7fc">
								<div align="center"><strong>Anorm. Cons.</strong></div>
								</td>
								<td width="10%" bgcolor="#90c7fc">
								...
								<%cont = cont + 1; if (cont % 2 == 0) {%>
									...
									<tr bgcolor="#FFFFFF">
										...
										<td align="center">
											<a href="javascript:abrirPopupNovo('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${helper.idImovel}&anoMes=<bean:write name="anoMes" scope="session" />&metp=${helper.idTipoMedicao}&idFotoTipoLeituraConsumoAnormalidade=<%=ConstantesSistema.FOTO_TIPO_LEITURA_ANORMALIDADE%>&idAnormalidade=${helper.idAnormalidade} ', 550, 450);">
 															${helper.idAnormalidade} 
  											</a> 
										</td>	
										
										<td align="center">
											<a href="javascript:abrirPopupNovo('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${helper.idImovel}&anoMes=<bean:write name="anoMes" scope="session" />&metp=${helper.idTipoMedicao}&idFotoTipoLeituraConsumoAnormalidade=<%=ConstantesSistema.FOTO_TIPO_CONSUMO_ANORMALIDADE%>&idAnormalidade=${helper.idConsumoAnormalidade} ', 550, 450);">
 															${helper.descricaoAbreviadaAnormalidadeConsumo} 
  											</a> 
										</td>	
