		...
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<td><html:text property="id" size="2" maxlength="2" onkeypress="javascript:return isCampoNumerico(event);" /></td>
					<td>&nbsp;</td>
				</tr>
		       <tr>
				...
				<tr>
					...
					<td colspan="2"><span class="style2"> <html:text
						property="numeroOrdem" size="5" maxlength="5"  onkeyup="javascript:return isCampoNumerico(event);" /> </span></td>
					<td>&nbsp;</td>
				</tr>
