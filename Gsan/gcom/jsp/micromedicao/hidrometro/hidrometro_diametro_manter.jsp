		...
		<tr>
				...
				<tr>
					...
					<table width="100%" bgcolor="#99CCFF" border="0">
						<tr bordercolor="#000000">
							<td width="8%" bgcolor="#90c7fc" align="center"><strong><a
							...
							<td width="40%" bgcolor="#90c7fc" align="center"><strong>Descri&ccedil;&atilde;o</strong></td>
							<td width="22%" bgcolor="#90c7fc" align="center"><strong>Descri&ccedil;&atilde;o Abreviada</strong></td>
							<td width="25%" bgcolor="#90c7fc" align="center"><strong>Valor a ser Cobrado por Depreciação</strong></td>							
						</tr>
					</table>
					</td>
				</tr>
			...
			if (cont % 2 == 0) {%>
										...
										<tr bgcolor="#FFFFFF">
											...
											<td width="10%" align="center">${hidrometroDiametro.id}</td>
											<td width="40%" align="center"><html:link
										...
										<td width="25%" align="center">${hidrometroDiametro.valorCobradoPorDepreciacao}</td>
										</tr>
									</pg:item>
								</logic:iterate>
							</logic:present>
