							...
							<tr>
								<td align="center" width="*"><strong><a
				         		...
				         		<logic:equal name="indicadorMacromedidor" value="1">
					           		<td align="center" width="11%"><strong>Tombamento</strong></td>
				           		</logic:equal>
						...
						<logic:notEmpty name="colecaoHidrometro" scope="session">
							...
							<tr>
								<td align="center"><strong><a
									href="javascript:facilitador(this);">Todos</a></strong></td>
								<logic:equal name="indicadorMacromedidor" value="1">
					           		<td align="center"><strong>Tombamento</strong></td>
				           		</logic:equal>
				         		<logic:equal name="indicadorMacromedidor" value="2">
					...
					%>
						...
						%>
							<tr bgcolor="#FFFFFF">
								...
								<logic:equal name="indicadorMacromedidor" value="1">
									<bean:write name="hidrometro" property="tombamento" />
								</logic:equal>
								<logic:equal name="indicadorMacromedidor" value="2">
					...
					<table width="100%">
						<tr>
							<td><gsan:controleAcessoBotao name="Button" value="Movimentar"
								...
								value="Voltar Filtro"
								onclick="window.location.href='/gsan/exibirFiltrarHidrometroActionMovimentarHidrometro.do?tela=movimentarHidrometro'">
							</td>
						</tr>
					</table>
					</td>
