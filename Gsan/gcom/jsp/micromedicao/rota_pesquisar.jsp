			...
			<table width="100%" border="0">
				...
				<tr>
					...
					<logic:empty name="PesquisarRotaActionForm" property="bloquearCampos">
						<html:text maxlength="3" tabindex="1" property="idLocalidade"
								   size="3"
								   onkeypress="javascript:validaEnterComMensagem(event, 'exibirPesquisarInformarRotaLeituraAction.do?pesquisarLocalidade=sim', 'idLocalidade','Localidade'); 
					...
					<logic:notEmpty name="PesquisarRotaActionForm" property="bloquearCampos">
						<html:text maxlength="3" tabindex="1" property="idLocalidade"
						size="3" readonly="true" onkeypress="return isCampoNumerico(event);" /> 
						<img width="23" height="21" border="0"
						src="<bean:message key="caminho.imagens"/>pesquisa.gif"
				...
				<tr>
					...
					<html:text maxlength="3"
						...
						onkeypress="javascript:validaEnterDependenciaComMensagem(event, 'exibirPesquisarInformarRotaLeituraAction.do?pesquisarSetor=sim', this, document.forms[0].idLocalidade.value, 'Localidade','Setor Comercial'); 
									return isCampoNumerico(event);" />
					...
					<img src="<bean:message key="caminho.imagens"/>limparcampo.gif"
						...
						<logic:notEmpty name="PesquisarRotaActionForm" property="bloquearCampos">
							<html:text maxlength="3" property="codigoSetorComercial" tabindex="2" size="3" readonly="true" onkeypress="return isCampoNumerico(event);" /> 
							<img width="23" height="21" border="0"
						src="<bean:message key="caminho.imagens"/>pesquisa.gif"
				...
				<tr>
					...
					<td><html:text property="codigoRota" size="4" maxlength="4" tabindex="3" onkeypress="return isCampoNumerico(event);"/></td>
				</tr>
				<tr>
