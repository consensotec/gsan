					...
					%>
									...
									<table width="100%" bgcolor="#99CCFF">
										...
										<tr bordercolor="#99CCFF" class="styleFontePequena"
											...
											<table width="100%" align="center" bgcolor="#cbe5fe"
												...
												<tr>
													<td class="styleFontePeqNegrito"><strong>Usu&aacute;rio inclus&atilde;o:</strong></td>
													<td colspan="5"><html:text property="loginUsuarioInformouLeitura"
														readonly="true"
														style="background-color:#EFEFEF; border:0;font-size:xx-small"
														size="12" /> <html:text property="nomeUsuarioInformouLeitura"
														readonly="true"
														style="background-color:#EFEFEF; border:0;font-size:xx-small"
														size="50" /></td>													
												</tr>												
												<tr>
													<td class="styleFontePeqNegrito"><strong>Usu&aacute;rio Altera&ccedil;&atilde;o:</strong></td>
							...
							%>
													...
													.formatarData(((gcom.cadastro.imovel.bean.ImovelMicromedicao) imovelMicromedicaoIterator)
															...
															<a title="${imovelMicromedicaoIterator.consumoHistorico.consumoAnormalidade.descricao}"
														     href="javascript:abrirPopup('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${idImovel}&anoMes=${imovelMicromedicaoIterator.medicaoHistorico.mesAno}&metp=${imovelMicromedicaoIterator.consumoHistorico.ligacaoTipo.id}&idFotoTipoLeituraConsumoAnormalidade=<%=ConstantesSistema.FOTO_TIPO_CONSUMO_ANORMALIDADE%>&idAnormalidade=${imovelMicromedicaoIterator.consumoHistorico.consumoAnormalidade.id}', 450, 550);">
	 															${imovelMicromedicaoIterator.consumoHistorico.consumoAnormalidade.descricaoAbreviada}
															</a>
															...
															<a title="${imovelMicromedicaoIterator.consumoHistorico.consumoAnormalidade.descricao}"
														     href="javascript:abrirPopup('exibirConsultarFotoMicroMedicaoPopupAction.do?id=${idImovel}&anoMes=${imovelMicromedicaoIterator.medicaoHistorico.mesAno}&metp=${imovelMicromedicaoIterator.consumoHistorico.ligacaoTipo.id}&idFotoTipoLeituraConsumoAnormalidade=<%=ConstantesSistema.FOTO_TIPO_LEITURA_ANORMALIDADE%>&idAnormalidade=${imovelMicromedicaoIterator.medicaoHistorico.leituraAnormalidadeFaturamento.id}', 450, 550);">
