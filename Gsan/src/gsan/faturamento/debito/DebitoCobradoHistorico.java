...
public class DebitoCobradoHistorico implements Serializable {
    ...
    /** minimal constructor */
    public DebitoCobradoHistorico(Date debitoCobrado,  FinanciamentoTipo financiamentoTipo, Quadra quadra, Localidade localidade, ContaHistorico contaHistorico, gsan.faturamento.debito.DebitoTipo debitoTipo, LancamentoItemContabil lancamentoItemContabil, ParcelamentoGrupo parcelamentoGrupo) {
        this.debitoCobrado = debitoCobrado;
        //this.debitoCobradoHistorico = debitoCobradoHistorico;
        this.financiamentoTipo = financiamentoTipo;
        this.quadra = quadra;
