...
public class DebitoACobrarCategoria extends ObjetoTransacao {
    ...
    /** identifier field */
    private gsan.faturamento.debito.DebitoACobrarCategoriaPK comp_id;
    ...
    /** nullable persistent field */
    private gsan.faturamento.debito.DebitoACobrar debitoACobrar;
    ...
    /** full constructor */
    public DebitoACobrarCategoria(gsan.faturamento.debito.DebitoACobrarCategoriaPK comp_id, Integer quantidadeEconomia, Date ultimaAlteracao, BigDecimal valorCategoria, gsan.faturamento.debito.DebitoACobrar debitoACobrar, Categoria categoria) {
    ...
    /** minimal constructor */
    public DebitoACobrarCategoria(gsan.faturamento.debito.DebitoACobrarCategoriaPK comp_id) {
        this.comp_id = comp_id;
    }

    public gsan.faturamento.debito.DebitoACobrarCategoriaPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.faturamento.debito.DebitoACobrarCategoriaPK comp_id) {
        this.comp_id = comp_id;
    }
    ...
    public gsan.faturamento.debito.DebitoACobrar getDebitoACobrar() {
        return this.debitoACobrar;
    }

    public void setDebitoACobrar(gsan.faturamento.debito.DebitoACobrar debitoACobrar) {
        this.debitoACobrar = debitoACobrar;
    }
