...
public class DebitoCobradoCategoria extends ObjetoTransacao{
    ...
    /** identifier field */
    private gsan.faturamento.debito.DebitoCobradoCategoriaPK comp_id;
    ...
    /** nullable persistent field */
    private gsan.faturamento.debito.DebitoCobrado debitoCobrado;

    /** nullable persistent field */
    private Categoria categoria;

    /** full constructor */
    public DebitoCobradoCategoria(gsan.faturamento.debito.DebitoCobradoCategoriaPK comp_id, Integer quantidadeEconomia, Date ultimaAlteracao, BigDecimal valorCategoria, gsan.faturamento.debito.DebitoCobrado debitoCobrado, Categoria categoria) {
    ...
    /** minimal constructor */
    public DebitoCobradoCategoria(gsan.faturamento.debito.DebitoCobradoCategoriaPK comp_id) {
        this.comp_id = comp_id;
    }

    public gsan.faturamento.debito.DebitoCobradoCategoriaPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.faturamento.debito.DebitoCobradoCategoriaPK comp_id) {
        this.comp_id = comp_id;
    }
    ...
    public gsan.faturamento.debito.DebitoCobrado getDebitoCobrado() {
        return this.debitoCobrado;
    }

    public void setDebitoCobrado(gsan.faturamento.debito.DebitoCobrado debitoCobrado) {
        this.debitoCobrado = debitoCobrado;
    }
