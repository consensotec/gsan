...
public class FaturaItemHistorico implements Serializable {
    ...
    /** full constructor */
    public FaturaItemHistorico(Integer itemSequencia, BigDecimal valorConta, Date ultimaAlteracao, Integer numeroConsumo,  gsan.faturamento.conta.Fatura fatura, gsan.faturamento.conta.ContaGeral contaGeral, Imovel imovel) {
    ...
    /** minimal constructor */
    public FaturaItemHistorico(Integer itemSequencia, gsan.faturamento.conta.Fatura fatura, gsan.faturamento.conta.ContaGeral contaGeral) {
        this.itemSequencia = itemSequencia;
        this.fatura = fatura;
        this.contaGeral = contaGeral;
    }
