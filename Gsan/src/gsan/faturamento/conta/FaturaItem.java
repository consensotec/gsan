...
public class FaturaItem implements Serializable {
    ...
    /** full constructor */
    public FaturaItem(Integer itemSequencia, BigDecimal valorConta, Date ultimaAlteracao, Integer numeroConsumo,  gsan.faturamento.conta.Fatura fatura, gsan.faturamento.conta.ContaGeral contaGeral, Imovel imovel) {
    ...
    /** minimal constructor */
    public FaturaItem(Integer itemSequencia, gsan.faturamento.conta.Fatura fatura, gsan.faturamento.conta.ContaGeral contaGeral) {
        this.itemSequencia = itemSequencia;
        this.fatura = fatura;
        this.contaGeral = contaGeral;
        this.indicadorUsoAtivo = 1;
