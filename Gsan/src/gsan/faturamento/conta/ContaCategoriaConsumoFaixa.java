...
public class ContaCategoriaConsumoFaixa implements Serializable {
    ...
    /** persistent field */
    private gsan.faturamento.conta.ContaCategoria contaCategoria;
    ...
    /** minimal constructor */
    public ContaCategoriaConsumoFaixa(Categoria categoria, gsan.faturamento.conta.ContaCategoria contaCategoria) {
        this.categoria = categoria;
        this.contaCategoria = contaCategoria;
    }
    ...
    public gsan.faturamento.conta.ContaCategoria getContaCategoria() {
        return this.contaCategoria;
    }

    public void setContaCategoria(gsan.faturamento.conta.ContaCategoria contaCategoria) {
        this.contaCategoria = contaCategoria;
    }
