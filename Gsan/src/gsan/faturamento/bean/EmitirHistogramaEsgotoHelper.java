 ...
 * @date 05/11/2007
 */
public class EmitirHistogramaEsgotoHelper {
	...
	private Collection<EmitirHistogramaEsgotoDetalheHelper> colecaoEmitirHistogramaEsgotoDetalhe = null;
	
	
	public Collection<EmitirHistogramaEsgotoDetalheHelper> getColecaoEmitirHistogramaEsgotoDetalhe() {
		return colecaoEmitirHistogramaEsgotoDetalhe;
	}

	public void setColecaoEmitirHistogramaEsgotoDetalhe(
			Collection<EmitirHistogramaEsgotoDetalheHelper> colecaoEmitirHistogramaEsgotoDetalhe) {
		this.colecaoEmitirHistogramaEsgotoDetalhe = colecaoEmitirHistogramaEsgotoDetalhe;
	}

	public EmitirHistogramaEsgotoHelper() { }
