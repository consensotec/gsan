...
public class FaturamentoAtividadeCronograma extends ObjetoTransacao {
    ...
    /** persistent field */
    private gsan.faturamento.FaturamentoAtividade faturamentoAtividade;

    /** persistent field */
    private gsan.faturamento.FaturamentoGrupoCronogramaMensal faturamentoGrupoCronogramaMensal;
    ...
    /** full constructor */
    public FaturamentoAtividadeCronograma(Date dataPrevista, Date dataRealizacao, Date comando, Date ultimaAlteracao, gsan.faturamento.FaturamentoAtividade faturamentoAtividade, gsan.faturamento.FaturamentoGrupoCronogramaMensal faturamentoGrupoCronogramaMensal, Usuario usuario) {
    ...
    /** minimal constructor */
    public FaturamentoAtividadeCronograma(gsan.faturamento.FaturamentoAtividade faturamentoAtividade, gsan.faturamento.FaturamentoGrupoCronogramaMensal faturamentoGrupoCronogramaMensal) {
        this.faturamentoAtividade = faturamentoAtividade;
        this.faturamentoGrupoCronogramaMensal = faturamentoGrupoCronogramaMensal;
    }
     ...
     */
    public FaturamentoAtividadeCronograma(Integer id, Date dataPrevista, Date dataRealizacao, Date comando, Date ultimaAlteracao, gsan.faturamento.FaturamentoAtividade faturamentoAtividade, gsan.faturamento.FaturamentoGrupoCronogramaMensal faturamentoGrupoCronogramaMensal) {
    	this.id = id;
    	this.dataPrevista = dataPrevista;
        this.dataRealizacao = dataRealizacao;
        this.comando = comando;
    ...
    public gsan.faturamento.FaturamentoAtividade getFaturamentoAtividade() {
        return this.faturamentoAtividade;
    }

    public void setFaturamentoAtividade(gsan.faturamento.FaturamentoAtividade faturamentoAtividade) {
        this.faturamentoAtividade = faturamentoAtividade;
    }

    public gsan.faturamento.FaturamentoGrupoCronogramaMensal getFaturamentoGrupoCronogramaMensal() {
        return this.faturamentoGrupoCronogramaMensal;
    }

    public void setFaturamentoGrupoCronogramaMensal(gsan.faturamento.FaturamentoGrupoCronogramaMensal faturamentoGrupoCronogramaMensal) {
        this.faturamentoGrupoCronogramaMensal = faturamentoGrupoCronogramaMensal;
    }
