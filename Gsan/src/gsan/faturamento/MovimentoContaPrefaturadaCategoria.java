...
public class MovimentoContaPrefaturadaCategoria implements Serializable {
    ...
    /** identifier field */
    private gsan.faturamento.MovimentoContaPrefaturadaCategoriaPK comp_id;
    ...
    /** full constructor */
    public MovimentoContaPrefaturadaCategoria(gsan.faturamento.MovimentoContaPrefaturadaCategoriaPK comp_id, BigDecimal valorFaturadoAgua, Integer consumoFaturadoAgua, BigDecimal valorTarifaMinimaAgua, Integer consumoMinimoAgua, BigDecimal valorFaturadoEsgoto, Integer consumoFaturadoEsgoto, BigDecimal valorTarifaMinimaEsgoto, Integer consumoMinimoEsgoto, Date ultimaAlteracao, gsan.faturamento.MovimentoContaPrefaturada movimentoContaPrefaturada, Set movimentoContaCategoriaConsumoFaixas) {
    ...
    /** minimal constructor */
    public MovimentoContaPrefaturadaCategoria(gsan.faturamento.MovimentoContaPrefaturadaCategoriaPK comp_id, Date ultimaAlteracao, Set movimentoContaCategoriaConsumoFaixas) {
        this.comp_id = comp_id;
        this.ultimaAlteracao = ultimaAlteracao;
    }

    public gsan.faturamento.MovimentoContaPrefaturadaCategoriaPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.faturamento.MovimentoContaPrefaturadaCategoriaPK comp_id) {
        this.comp_id = comp_id;
    }
