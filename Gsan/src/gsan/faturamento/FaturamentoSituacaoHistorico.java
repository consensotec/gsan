...
public class FaturamentoSituacaoHistorico extends ObjetoTransacao{
    ...
    /** nullable persistent field */
    private gsan.faturamento.FaturamentoSituacaoComando faturamentoSituacaoComandoInforma;
    
    /** nullable persistent field */
    private gsan.faturamento.FaturamentoSituacaoComando faturamentoSituacaoComandoRetirada;
    ...
    public FaturamentoSituacaoHistorico(Integer anoMesFaturamentoSituacaoInicio, Integer anoMesFaturamentoSituacaoFim, 
    		Date ultimaAlteracao, gsan.faturamento.FaturamentoSituacaoMotivo faturamentoSituacaoMotivo, Imovel imovel, 
    		gsan.faturamento.FaturamentoSituacaoTipo faturamentoSituacaoTipo, Integer anoMesFaturamentoRetirada,
    		Usuario usuario) {
    ...
    /** minimal constructor */
    public FaturamentoSituacaoHistorico(Integer anoMesFaturamentoSituacaoInicio, Integer anoMesFaturamentoSituacaoFim, 
    		gsan.faturamento.FaturamentoSituacaoMotivo faturamentoSituacaoMotivo, Imovel imovel, 
    		gsan.faturamento.FaturamentoSituacaoTipo faturamentoSituacaoTipo, Integer anoMesFaturamentoRetirada,
    		Usuario usuario) {
        this.anoMesFaturamentoSituacaoInicio = anoMesFaturamentoSituacaoInicio;
        this.anoMesFaturamentoSituacaoFim = anoMesFaturamentoSituacaoFim;
    ...
    public void setFaturamentoSituacaoMotivo(gsan.faturamento.FaturamentoSituacaoMotivo faturamentoSituacaoMotivo) {
        this.faturamentoSituacaoMotivo = faturamentoSituacaoMotivo;
    }
    ...
    public void setFaturamentoSituacaoTipo(gsan.faturamento.FaturamentoSituacaoTipo faturamentoSituacaoTipo) {
        this.faturamentoSituacaoTipo = faturamentoSituacaoTipo;
    }
