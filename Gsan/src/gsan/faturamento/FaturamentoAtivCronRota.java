...
public class FaturamentoAtivCronRota extends ObjetoTransacao {
    ...
    /** identifier field */
    private gsan.faturamento.FaturamentoAtivCronRotaPK comp_id;
    ...
    /** nullable persistent field */
    private gsan.faturamento.FaturamentoAtividadeCronograma faturamentoAtividadeCronograma;
    ...
    /** full constructor */
    public FaturamentoAtivCronRota(gsan.faturamento.FaturamentoAtivCronRotaPK comp_id, Date dataContaVencimento, Date ultimaAlteracao, Rota rota, gsan.faturamento.FaturamentoAtividadeCronograma faturamentoAtividadeCronograma) {
    ...
    /** minimal constructor */
    public FaturamentoAtivCronRota(gsan.faturamento.FaturamentoAtivCronRotaPK comp_id) {
        this.comp_id = comp_id;
    }

    public gsan.faturamento.FaturamentoAtivCronRotaPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.faturamento.FaturamentoAtivCronRotaPK comp_id) {
        this.comp_id = comp_id;
    }
    ...
    public gsan.faturamento.FaturamentoAtividadeCronograma getFaturamentoAtividadeCronograma() {
        return this.faturamentoAtividadeCronograma;
    }

    public void setFaturamentoAtividadeCronograma(gsan.faturamento.FaturamentoAtividadeCronograma faturamentoAtividadeCronograma) {
        this.faturamentoAtividadeCronograma = faturamentoAtividadeCronograma;
    }
