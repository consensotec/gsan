...
public class FaturamentoGrupo extends ObjetoTransacao {
    ...
    private Short indicadorMensagemQuitacao;
    
    /** full constructor */
    public FaturamentoGrupo(String descricao, String descricaoAbreviada, Short indicadorUso, Integer anoMesReferencia, 
    		Short diaVencimento, Short indicadorMensagemQuitacao, Date ultimaAlteracao) {
        this.descricao = descricao;
        this.descricaoAbreviada = descricaoAbreviada;
        this.indicadorUso = indicadorUso;
        this.anoMesReferencia = anoMesReferencia;
        this.diaVencimento = diaVencimento;
        this.indicadorMensagemQuitacao = indicadorMensagemQuitacao;
	...
	public Short getIndicadorMensagemQuitacao() {
		return indicadorMensagemQuitacao;
	}

	public void setIndicadorMensagemQuitacao(Short indicadorMensagemQuitacao) {
		this.indicadorMensagemQuitacao = indicadorMensagemQuitacao;
	}
