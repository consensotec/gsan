...
public class ConsumoTarifaCategoria implements Serializable {
    ...
    /** persistent field */
    private gsan.faturamento.consumotarifa.ConsumoTarifaVigencia consumoTarifaVigencia;
    ...
    public ConsumoTarifaCategoria(Integer numeroConsumoMinimo, 
    	...
    	gsan.faturamento.consumotarifa.ConsumoTarifaVigencia consumoTarifaVigencia,Categoria categoria) {
    ...
    /** minimal constructor */
    public ConsumoTarifaCategoria(gsan.faturamento.consumotarifa.ConsumoTarifaVigencia consumoTarifaVigencia, Categoria categoria) {
        this.consumoTarifaVigencia = consumoTarifaVigencia;
        this.categoria = categoria;
    }
    ...
    public gsan.faturamento.consumotarifa.ConsumoTarifaVigencia getConsumoTarifaVigencia() {
        return this.consumoTarifaVigencia;
    }

    public void setConsumoTarifaVigencia(gsan.faturamento.consumotarifa.ConsumoTarifaVigencia consumoTarifaVigencia) {
        this.consumoTarifaVigencia = consumoTarifaVigencia;
    }
