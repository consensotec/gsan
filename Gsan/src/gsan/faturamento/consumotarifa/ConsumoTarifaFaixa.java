...
* 02111-1307, USA.
*/  
package gsan.faturamento.consumotarifa;
...
public class ConsumoTarifaFaixa implements Serializable {
    ...
    /** persistent field */
    private gsan.faturamento.consumotarifa.ConsumoTarifaCategoria consumoTarifaCategoria;

    /** full constructor */
    public ConsumoTarifaFaixa(Integer numeroConsumoFaixaInicio, Integer numeroConsumoFaixaFim, BigDecimal valorConsumoTarifa, Date ultimaAlteracao, gsan.faturamento.consumotarifa.ConsumoTarifaCategoria consumoTarifaCategoria) {
    ...
    /** minimal constructor */
    public ConsumoTarifaFaixa(gsan.faturamento.consumotarifa.ConsumoTarifaCategoria consumoTarifaCategoria) {
        this.consumoTarifaCategoria = consumoTarifaCategoria;
    }
    ...
    public gsan.faturamento.consumotarifa.ConsumoTarifaCategoria getConsumoTarifaCategoria() {
        return this.consumoTarifaCategoria;
    }

    public void setConsumoTarifaCategoria(gsan.faturamento.consumotarifa.ConsumoTarifaCategoria consumoTarifaCategoria) {
        this.consumoTarifaCategoria = consumoTarifaCategoria;
    }
