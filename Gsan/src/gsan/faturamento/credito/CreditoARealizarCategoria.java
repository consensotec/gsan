...
public class CreditoARealizarCategoria extends ObjetoTransacao  {
    ...
    /** identifier field */
    private gsan.faturamento.credito.CreditoARealizarCategoriaPK comp_id;
    ...
    /** nullable persistent field */
    private gsan.faturamento.credito.CreditoARealizar creditoARealizar;

    /** nullable persistent field */
    private Categoria categoria;

    /** full constructor */
    public CreditoARealizarCategoria(gsan.faturamento.credito.CreditoARealizarCategoriaPK comp_id, Integer quantidadeEconomia, BigDecimal valorCategoria, Date ultimaAlteracao, gsan.faturamento.credito.CreditoARealizar creditoARealizar, Categoria categoria) {
    ...
    /** minimal constructor */
    public CreditoARealizarCategoria(gsan.faturamento.credito.CreditoARealizarCategoriaPK comp_id) {
        this.comp_id = comp_id;
    }

    public gsan.faturamento.credito.CreditoARealizarCategoriaPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.faturamento.credito.CreditoARealizarCategoriaPK comp_id) {
        this.comp_id = comp_id;
    }
    ...
    public gsan.faturamento.credito.CreditoARealizar getCreditoARealizar() {
        return this.creditoARealizar;
    }

    public void setCreditoARealizar(gsan.faturamento.credito.CreditoARealizar creditoARealizar) {
        this.creditoARealizar = creditoARealizar;
    }
