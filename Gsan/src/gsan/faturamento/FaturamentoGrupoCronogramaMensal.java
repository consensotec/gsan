...
public class FaturamentoGrupoCronogramaMensal extends ObjetoTransacao {
    ...
    /** full constructor */
    public FaturamentoGrupoCronogramaMensal(Integer anoMesReferencia, Date ultimaAlteracao, gsan.faturamento.FaturamentoGrupo faturamentoGrupo, Usuario usuario) {
    ...
    /** minimal constructor */
    public FaturamentoGrupoCronogramaMensal(Integer anoMesReferencia, gsan.faturamento.FaturamentoGrupo faturamentoGrupo) {
        this.anoMesReferencia = anoMesReferencia;
        this.faturamentoGrupo = faturamentoGrupo;
    }
