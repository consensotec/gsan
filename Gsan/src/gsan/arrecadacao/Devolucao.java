...
public class Devolucao extends ObjetoTransacao {
	...
	/** persistent field */
	private gsan.arrecadacao.DevolucaoSituacao devolucaoSituacaoAnterior;

	/** persistent field */
	private gsan.arrecadacao.DevolucaoSituacao devolucaoSituacaoAtual;

	/** persistent field */
	private gsan.arrecadacao.GuiaDevolucao guiaDevolucao;
	...
	/** persistent field */
	private gsan.faturamento.credito.CreditoARealizarGeral creditoARealizarGeral;
	
	/** persistent field */
	private gsan.arrecadacao.ArrecadadorMovimentoItem arrecadadorMovimentoItem;
	...
	public Devolucao(BigDecimal valorDevolucao,
			...
			gsan.arrecadacao.DevolucaoSituacao devolucaoSituacaoAnterior,
			gsan.arrecadacao.DevolucaoSituacao devolucaoSituacaoAtual,
			gsan.arrecadacao.GuiaDevolucao guiaDevolucao,
	...
	public gsan.arrecadacao.DevolucaoSituacao getDevolucaoSituacaoAnterior() {
	...
	public gsan.arrecadacao.DevolucaoSituacao getDevolucaoSituacaoAtual() {
	...
	public gsan.arrecadacao.GuiaDevolucao getGuiaDevolucao() {
		return this.guiaDevolucao;
	}

	public void setGuiaDevolucao(gsan.arrecadacao.GuiaDevolucao guiaDevolucao) {
		this.guiaDevolucao = guiaDevolucao;
	}
	...
	public gsan.arrecadacao.ArrecadadorMovimentoItem getArrecadadorMovimentoItem() {
		return arrecadadorMovimentoItem;
	}

	public void setArrecadadorMovimentoItem(
			gsan.arrecadacao.ArrecadadorMovimentoItem arrecadadorMovimentoItem) {
		this.arrecadadorMovimentoItem = arrecadadorMovimentoItem;
	}

	public gsan.faturamento.credito.CreditoARealizarGeral getCreditoARealizarGeral() {
		return creditoARealizarGeral;
	}

	public void setCreditoARealizarGeral(
			gsan.faturamento.credito.CreditoARealizarGeral creditoARealizarGeral) {
