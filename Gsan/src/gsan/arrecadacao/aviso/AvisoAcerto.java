...
public class AvisoAcerto extends ObjetoTransacao {
    ...
    /** full constructor */
    public AvisoAcerto(Integer indicadorCreditoDebito, Date dataAcerto, BigDecimal valorAcerto, Date ultimaAlteracao, ContaBancaria contaBancaria, gsan.arrecadacao.aviso.AvisoBancario avisoBancario, Integer indicadorArrecadacaoDevolucao) {
    ...
    /** minimal constructor */
    public AvisoAcerto(ContaBancaria contaBancaria, gsan.arrecadacao.aviso.AvisoBancario avisoBancario) {
        this.contaBancaria = contaBancaria;
        this.avisoBancario = avisoBancario;
    }
    ...
    public void setAvisoBancario(gsan.arrecadacao.aviso.AvisoBancario avisoBancario) {
        this.avisoBancario = avisoBancario;
    }
