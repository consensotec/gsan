...
* 02111-1307, USA.
*/  
package gsan.arrecadacao.banco;
...
public class Agencia implements Serializable {
    ...
    /** persistent field */
    private gsan.arrecadacao.banco.Banco banco;
    ...
    /** minimal constructor */
    public Agencia(String nomeAgencia, String numeroTelefone, String numeroRamal, Bairro bairro, gsan.arrecadacao.banco.Banco banco, Logradouro logradouro, EnderecoReferencia enderecoReferencia, Cep cep) {
        this.nomeAgencia = nomeAgencia;
        this.numeroTelefone = numeroTelefone;
        this.numeroRamal = numeroRamal;
        this.bairro = bairro;
    ...
    public gsan.arrecadacao.banco.Banco getBanco() {
        return this.banco;
    }

    public void setBanco(gsan.arrecadacao.banco.Banco banco) {
        this.banco = banco;
    }
