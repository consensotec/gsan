...
public class PagamentoHistorico implements Serializable {
    ...
    /** persistent field */
    private gsan.arrecadacao.pagamento.PagamentoSituacao pagamentoSituacaoAtual;

    /** persistent field */
    private gsan.arrecadacao.pagamento.PagamentoSituacao pagamentoSituacaoAnterior;
	 ...
	 */
	public gsan.arrecadacao.pagamento.PagamentoSituacao getPagamentoSituacaoAnterior() {
	...
	public void setPagamentoSituacaoAnterior(
			gsan.arrecadacao.pagamento.PagamentoSituacao pagamentoSituacaoAnterior) {
		this.pagamentoSituacaoAnterior = pagamentoSituacaoAnterior;
	}
	 ...
	 */
	public gsan.arrecadacao.pagamento.PagamentoSituacao getPagamentoSituacaoAtual() {
	...
	public void setPagamentoSituacaoAtual(
			gsan.arrecadacao.pagamento.PagamentoSituacao pagamentoSituacaoAtual) {
		this.pagamentoSituacaoAtual = pagamentoSituacaoAtual;
	}
	...
	public void setGuiaPagamentoGeral(gsan.faturamento.GuiaPagamentoGeral guiaPagamentoGeral) {
		this.guiaPagamentoGeral = guiaPagamentoGeral;
	}
