...
public class GuiaPagamentoParcelamentoCartao implements Serializable {
	...
	private gsan.arrecadacao.pagamento.GuiaPagamentoParcelamentoCartaoPK comp_id;
	...
	public gsan.arrecadacao.pagamento.GuiaPagamentoParcelamentoCartaoPK getComp_id() {
		return comp_id;
	}

	public void setComp_id(
			gsan.arrecadacao.pagamento.GuiaPagamentoParcelamentoCartaoPK comp_id) {
		this.comp_id = comp_id;
	}
