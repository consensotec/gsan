...
public class GuiaPagamentoCategoria extends ObjetoTransacao {
    ...
    /** identifier field */
    private gsan.arrecadacao.pagamento.GuiaPagamentoCategoriaPK comp_id;
    ...
    /** nullable persistent field */
    private gsan.arrecadacao.pagamento.GuiaPagamento guiaPagamento;
    ...
    /** full constructor */
    public GuiaPagamentoCategoria(gsan.arrecadacao.pagamento.GuiaPagamentoCategoriaPK comp_id, Integer quantidadeEconomia, BigDecimal valorCategoria, gsan.arrecadacao.pagamento.GuiaPagamento guiaPagamento, Categoria categoria, Date ultimaAlteracao) {
    ...
    /** minimal constructor */
    public GuiaPagamentoCategoria(gsan.arrecadacao.pagamento.GuiaPagamentoCategoriaPK comp_id) {
        this.comp_id = comp_id;
    }

    public gsan.arrecadacao.pagamento.GuiaPagamentoCategoriaPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.arrecadacao.pagamento.GuiaPagamentoCategoriaPK comp_id) {
        this.comp_id = comp_id;
    }
    ...
    public gsan.arrecadacao.pagamento.GuiaPagamento getGuiaPagamento() {
        return this.guiaPagamento;
    }

    public void setGuiaPagamento(gsan.arrecadacao.pagamento.GuiaPagamento guiaPagamento) {
        this.guiaPagamento = guiaPagamento;
    }
