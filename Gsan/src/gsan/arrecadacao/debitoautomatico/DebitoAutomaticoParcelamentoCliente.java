...
public class DebitoAutomaticoParcelamentoCliente implements Serializable {
    ...
    /** full constructor */
    public DebitoAutomaticoParcelamentoCliente(String identificacaoClienteBanco, 
    		Date dataOpcao, Date dataInclusao, 
    		Date dataExclusao, Date ultimaAlteracao, Agencia agencia, 
    		ContratoParcelamento contratoParcelamento) {
    ...
    /** default constructor */
    public DebitoAutomaticoParcelamentoCliente() {
    }

    /** minimal constructor */
    public DebitoAutomaticoParcelamentoCliente(Agencia agencia, ContratoParcelamento contratoParcelamento) {
        this.agencia = agencia;
        this.contratoParcelamento = contratoParcelamento;
    }
