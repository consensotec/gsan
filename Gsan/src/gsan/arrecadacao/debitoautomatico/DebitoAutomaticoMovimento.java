...
public class DebitoAutomaticoMovimento implements Serializable {
    ...
    /** persistent field */
    private gsan.arrecadacao.debitoautomatico.DebitoAutomatico debitoAutomatico;

    /** persistent field */
    private FaturamentoGrupo faturamentoGrupo;

    /** persistent field */
    private gsan.arrecadacao.debitoautomatico.DebitoAutomaticoRetornoCodigo debitoAutomaticoRetornoCodigo;
    ...
    public DebitoAutomaticoMovimento(Date dataVencimento, BigDecimal valorDebito, Date processamento, 
    		...
    		gsan.arrecadacao.debitoautomatico.DebitoAutomatico debitoAutomatico, 
    		FaturamentoGrupo faturamentoGrupo, 
    		gsan.arrecadacao.debitoautomatico.DebitoAutomaticoRetornoCodigo debitoAutomaticoRetornoCodigo, 
    ...
    /** minimal constructor */
    public DebitoAutomaticoMovimento(gsan.arrecadacao.debitoautomatico.DebitoAutomatico debitoAutomatico, 
    		FaturamentoGrupo faturamentoGrupo, 
    		gsan.arrecadacao.debitoautomatico.DebitoAutomaticoRetornoCodigo debitoAutomaticoRetornoCodigo,
    		ContaGeral contaGeral) {
    ...
    public gsan.arrecadacao.debitoautomatico.DebitoAutomatico getDebitoAutomatico() {
        return this.debitoAutomatico;
    }

    public void setDebitoAutomatico(gsan.arrecadacao.debitoautomatico.DebitoAutomatico debitoAutomatico) {
        this.debitoAutomatico = debitoAutomatico;
    }
