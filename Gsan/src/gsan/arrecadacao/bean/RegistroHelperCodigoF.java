...
public class RegistroHelperCodigoF implements Serializable {
	...
	private String reservadoUsoEmpresa;
	...
	public String getReservadoUsoEmpresa() {
		return reservadoUsoEmpresa;
	}

	public void setReservadoUsoEmpresa(String reservadoUsoEmpresa) {
		this.reservadoUsoEmpresa = reservadoUsoEmpresa;
	}
