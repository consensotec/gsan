...
public class CobrancaSituacaoHistorico extends ObjetoTransacao{
    ...
    public CobrancaSituacaoHistorico(Integer anoMesCobrancaSituacaoInicio, Integer anoMesCobrancaSituacaoFim, 
    		Date ultimaAlteracao, Imovel imovel, gsan.cobranca.CobrancaSituacaoTipo cobrancaSituacaoTipo, 
    		gsan.cobranca.CobrancaSituacaoMotivo cobrancaSituacaoMotivo, Integer anoMesCobrancaRetirada,
    		Usuario usuario) {
    ...
    public CobrancaSituacaoHistorico(Integer anoMesCobrancaSituacaoInicio, Imovel imovel, 
    		...
    		gsan.cobranca.CobrancaSituacaoMotivo cobrancaSituacaoMotivo,Usuario usuario) {
        this.anoMesCobrancaSituacaoInicio = anoMesCobrancaSituacaoInicio;
        this.imovel = imovel;
        this.cobrancaSituacaoTipo = cobrancaSituacaoTipo;
        this.cobrancaSituacaoMotivo = cobrancaSituacaoMotivo;
    ...
    public void setCobrancaSituacaoTipo(gsan.cobranca.CobrancaSituacaoTipo cobrancaSituacaoTipo) {
        this.cobrancaSituacaoTipo = cobrancaSituacaoTipo;
    }
    ...
    public void setCobrancaSituacaoMotivo(gsan.cobranca.CobrancaSituacaoMotivo cobrancaSituacaoMotivo) {
        this.cobrancaSituacaoMotivo = cobrancaSituacaoMotivo;
    }
