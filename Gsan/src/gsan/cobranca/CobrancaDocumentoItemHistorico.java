...
public class CobrancaDocumentoItemHistorico implements Serializable {
    ...
    /** full constructor */
    public CobrancaDocumentoItemHistorico(BigDecimal valorItemCobrado, Date ultimaAlteracao, DebitoACobrarGeral debitoACobrarGeral, gsan.cobranca.CobrancaDocumento cobrancaDocumento, gsan.cobranca.DocumentoTipo documentoTipo, ContaGeral contaGeral, GuiaPagamentoGeral guiaPagamentoGeral) {
    ...
    /** default constructor */
    public CobrancaDocumentoItemHistorico() {
    }

    /** minimal constructor */
    public CobrancaDocumentoItemHistorico(DebitoACobrarGeral debitoACobrarGeral, gsan.cobranca.CobrancaDocumento cobrancaDocumento, gsan.cobranca.DocumentoTipo documentoTipo, ContaGeral contaGeral, GuiaPagamentoGeral guiaPagamentoGeral) {
        this.debitoACobrarGeral = debitoACobrarGeral;
        this.cobrancaDocumento = cobrancaDocumento;
        this.documentoTipo = documentoTipo;
        this.contaGeral = contaGeral;
    ...
    public void setCobrancaDocumento(gsan.cobranca.CobrancaDocumento cobrancaDocumento) {
        this.cobrancaDocumento = cobrancaDocumento;
    }
