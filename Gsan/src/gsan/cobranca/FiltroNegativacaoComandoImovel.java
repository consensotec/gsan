...
/**
 * Filtro Referente a Tabela NEGATIVACAO_COMANDO_IMOV
 * 
 * @author Rodrigo Cabral
 * @created 26/06/2014
 */

public class FiltroNegativacaoComandoImovel extends Filtro implements Serializable {
	private static final long serialVersionUID = 1L;
	/**
     * Constructor for the FiltroCobrancaAtividade object
     */
    public FiltroNegativacaoComandoImovel() {
    }
     ...
     */
    public FiltroNegativacaoComandoImovel(String campoOrderBy) {
