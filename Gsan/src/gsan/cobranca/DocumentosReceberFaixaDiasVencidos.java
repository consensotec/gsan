...
public class DocumentosReceberFaixaDiasVencidos {
     ...
     *            Descrição do parâmetro
     */
    public DocumentosReceberFaixaDiasVencidos(Integer valorInicialFaixa, 
    		Integer valorFinalFaixa, String descricaoFaixa) {
     ...
     * default constructor
     */
    public DocumentosReceberFaixaDiasVencidos() {
    }
	...
	public String getFaixaCompleta() {
		faixaCompleta = this.getValorInicialFaixa() + " a " + this.getValorFinalFaixa();
