...
public class CobrancaSituacaoTipo extends ObjetoTransacao implements Serializable {
    ...
    private Short indicadorNegativacaoCliente;
    ...
    public static final int SITUACAO_ESPECIAL_COBRANCA_VIVA_AGUA = 1;
	...
	public Short getIndicadorNegativacaoCliente() {
		return indicadorNegativacaoCliente;
	}

	public void setIndicadorNegativacaoCliente(Short indicadorNegativacaoCliente) {
		this.indicadorNegativacaoCliente = indicadorNegativacaoCliente;
	}
