...
public class NegativadorRetornoMotivo extends ObjetoTransacao implements Serializable {
	...
	/** full constructor */
    public NegativadorRetornoMotivo(Integer id, String descricaoRetornocodigo, Short indicadorUso, Short indicadorRegistroAceito, Date ultimaAlteracao, gsan.cobranca.Negativador negativador, Set negativadorMovimentoRegRetMot, Short codigoRetornoMotivo) {
        this.id = id;
    ...
    public NegativadorRetornoMotivo(Integer id, String descricaoRetornocodigo, Short indicadorUso, Short indicadorRegistroAceito, Date ultimaAlteracao, gsan.cobranca.Negativador negativador, Set negativadorMovimentoRegRetMot) {
        this.id = id;
        this.descricaoRetornocodigo = descricaoRetornocodigo;
        this.indicadorUso = indicadorUso;
        this.indicadorRegistroAceito = indicadorRegistroAceito;
    ...
    /** minimal constructor */
    public NegativadorRetornoMotivo(Integer id, Short indicadorUso, Short indicadorRegistroAceito, Date ultimaAlteracao, gsan.cobranca.Negativador negativador, Set negativadorMovimentoRegRetMot) {
        this.id = id;
        this.indicadorUso = indicadorUso;
        this.indicadorRegistroAceito = indicadorRegistroAceito;
        this.ultimaAlteracao = ultimaAlteracao;
