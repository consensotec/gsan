...
public class NegativacaoCriterioClienteTipo implements Serializable {
    ...
    /** identifier field */
    private gsan.cobranca.NegativacaoCriterioClienteTipoPK comp_id;
    ...
    /** full constructor */
    public NegativacaoCriterioClienteTipo(gsan.cobranca.NegativacaoCriterioClienteTipoPK comp_id, Date ultimaAlteracao, gsan.cobranca.NegativacaoCriterio negativacaoCriterio, ClienteTipo clienteTipo) {
    ...
    /** minimal constructor */
    public NegativacaoCriterioClienteTipo(gsan.cobranca.NegativacaoCriterioClienteTipoPK comp_id, Date ultimaAlteracao) {
        this.comp_id = comp_id;
        this.ultimaAlteracao = ultimaAlteracao;
    }

    public gsan.cobranca.NegativacaoCriterioClienteTipoPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.cobranca.NegativacaoCriterioClienteTipoPK comp_id) {
        this.comp_id = comp_id;
    }
