...
public class CicloMetaGrupo implements Serializable {
    ...
    /** persistent field */
    private gsan.cobranca.CicloMeta cicloMeta;
    ...
    /** minimal constructor */
    public CicloMetaGrupo(Date ultimaAlteracao, gsan.cobranca.CicloMeta cicloMeta, Localidade localidade) {
        this.ultimaAlteracao = ultimaAlteracao;
        this.cicloMeta = cicloMeta;
        this.localidade = localidade;
    }
    ...
    public gsan.cobranca.CicloMeta getCicloMeta() {
        return this.cicloMeta;
    }

    public void setCicloMeta(gsan.cobranca.CicloMeta cicloMeta) {
        this.cicloMeta = cicloMeta;
    }
