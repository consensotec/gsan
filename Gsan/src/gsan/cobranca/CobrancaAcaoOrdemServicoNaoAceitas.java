...
public class CobrancaAcaoOrdemServicoNaoAceitas extends ObjetoTransacao {
    ...
    /** identifier field */
    private gsan.cobranca.CobrancaAcaoOrdemServicoNaoAceitasPK comp_id;
	...
	public gsan.cobranca.CobrancaAcaoOrdemServicoNaoAceitasPK getComp_id() {
		return comp_id;
	}

	public void setComp_id(
			gsan.cobranca.CobrancaAcaoOrdemServicoNaoAceitasPK comp_id) {
		this.comp_id = comp_id;
	}
