...
public class NegativacaoCriterioCpfTipo implements Serializable {
    ...
    /** full constructor */
    public NegativacaoCriterioCpfTipo(Integer id, Short numeroOrdemSelecao, short indicadorCoincidente, Date ultimaAlteracao, gsan.cobranca.NegativacaoCriterio negativacaoCriterio, CpfTipo cpfTipo) {
        this.id = id;
