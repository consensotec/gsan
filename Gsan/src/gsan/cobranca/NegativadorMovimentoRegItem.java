...
public class NegativadorMovimentoRegItem implements Serializable {
    ...
    /** persistent field */
    private gsan.cobranca.NegativadorMovimentoReg negativadorMovimentoReg;
    ...
    /** persistent field */
    private gsan.cobranca.CobrancaDebitoSituacao cobrancaDebitoSituacaoAposExclusao;
    ...
    /** full constructor */
    public NegativadorMovimentoRegItem(Integer id, BigDecimal valorDebito, Date dataSituacaoDebito, gsan.cobranca.NegativadorMovimentoReg negativadorMovimentoReg, GuiaPagamentoGeral guiaPagamentoGeral, ContaGeral contaGeral, gsan.cobranca.DocumentoTipo documentoTipo, DebitoACobrarGeral debitoACobrarGeral, gsan.cobranca.CobrancaDebitoSituacao cobrancaDebitoSituacao) {
        this.id = id;
    ...
    /** minimal constructor */
    public NegativadorMovimentoRegItem(Integer id, Date dataSituacaoDebito, gsan.cobranca.NegativadorMovimentoReg negativadorMovimentoReg, GuiaPagamentoGeral guiaPagamentoGeral, ContaGeral contaGeral, gsan.cobranca.DocumentoTipo documentoTipo, DebitoACobrarGeral debitoACobrarGeral, gsan.cobranca.CobrancaDebitoSituacao cobrancaDebitoSituacao) {
        this.id = id;
        this.dataSituacaoDebito = dataSituacaoDebito;
        this.negativadorMovimentoReg = negativadorMovimentoReg;
        this.guiaPagamentoGeral = guiaPagamentoGeral;
    ...
    public gsan.cobranca.NegativadorMovimentoReg getNegativadorMovimentoReg() {
        return this.negativadorMovimentoReg;
    }

    public void setNegativadorMovimentoReg(gsan.cobranca.NegativadorMovimentoReg negativadorMovimentoReg) {
        this.negativadorMovimentoReg = negativadorMovimentoReg;
    }
	...
	public gsan.cobranca.CobrancaDebitoSituacao getCobrancaDebitoSituacaoAposExclusao() {
		return cobrancaDebitoSituacaoAposExclusao;
	}

	public void setCobrancaDebitoSituacaoAposExclusao(
			gsan.cobranca.CobrancaDebitoSituacao cobrancaDebitoSituacaoAposExclusao) {
