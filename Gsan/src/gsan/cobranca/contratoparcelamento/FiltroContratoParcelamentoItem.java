...
public class FiltroContratoParcelamentoItem extends Filtro implements Serializable {
	...
	public final static String CONTA_GERAL_CONTA_HISTORICO_DEBITO_CREDITO_SITUACAO_ATUAL  = "contaGeral.contaHistorico.debitoCreditoSituacaoAtual";
	...
	public final static String DEBITO_A_COBRAR_GERAL_DEBITO_HISTORICO = "debitoACobrarGeral.debitoACobrarHistorico";
	
	public final static String DEBITO_A_COBRAR_GERAL_DEBITO_HISTORICO_IMOVEL = "debitoACobrarGeral.debitoACobrarHistorico.imovel";
	
	public final static String DEBITO_A_COBRAR_GERAL_DEBITO_HISTORICO_DEBITO_TIPO = "debitoACobrarGeral.debitoACobrarHistorico.debitoTipo";
