...
public class NegativadorRegistroTipo extends ObjetoTransacao implements Serializable  {
    ...
    /** full constructor */
    public NegativadorRegistroTipo(Integer id, String descricaoRegistroTipo, String codigoRegistro, Date ultimaAlteracao, gsan.cobranca.Negativador negativador, Set negativadorMovimentoReg) {
        this.id = id;
    ...
    /** minimal constructor */
    public NegativadorRegistroTipo(Integer id, gsan.cobranca.Negativador negativador, Set negativadorMovimentoReg) {
        this.id = id;
        this.negativador = negativador;
        this.negativadorMovimentoReg = negativadorMovimentoReg;
    }
