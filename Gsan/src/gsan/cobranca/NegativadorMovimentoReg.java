...
public class NegativadorMovimentoReg extends ObjetoTransacao implements Serializable {
    ...
    /** persistent field */
    @ControleAlteracao(funcionalidade={ATRIBUTOS_EXCLUIR_NEGATIVACAO_ONLINE})
    private gsan.cobranca.NegativadorExclusaoMotivo negativadorExclusaoMotivo;
    ...
    /** persistent field */
    private gsan.cobranca.NegativadorMovimentoReg negativadorMovimentoRegInclusao;
    ...
    /** persistent field */
    private gsan.cobranca.NegativadorRegistroTipo negativadorRegistroTipo;

    /** persistent field */
    private gsan.cobranca.NegativadorMovimento negativadorMovimento;
	...
	/** full constructor */
    public NegativadorMovimentoReg(Integer id, String conteudoRegistro, Date ultimaAlteracao, Integer codigoExclusaoTipo, Short indicadorAceito, Short indicadorCorrecao, BigDecimal valorDebito, Date dataSituacaoDebito, Integer codigoSetorComercial, Integer numeroQuadra, String numeroCpf, String numeroCnpj, Quadra quadra, Localidade localidade, Imovel imovel, gsan.cobranca.NegativadorExclusaoMotivo negativadorExclusaoMotivo, ImovelPerfil imovelPerfil, gsan.cobranca.CobrancaDebitoSituacao cobrancaDebitoSituacao, gsan.cobranca.NegativadorMovimentoReg negativadorMovimentoRegInclusao, gsan.cobranca.NegativacaoCriterio negativacaoCriterio, Usuario usuario, Cliente cliente, Categoria categoria, gsan.cobranca.NegativadorRegistroTipo negativadorRegistroTipo, gsan.cobranca.NegativadorMovimento negativadorMovimento, Set negativadorMovimentoReg) {
        this.id = id;
    ...
    public gsan.cobranca.NegativadorExclusaoMotivo getNegativadorExclusaoMotivo() {
        return this.negativadorExclusaoMotivo;
    }

    public void setNegativadorExclusaoMotivo(gsan.cobranca.NegativadorExclusaoMotivo negativadorExclusaoMotivo) {
        this.negativadorExclusaoMotivo = negativadorExclusaoMotivo;
    }
    ...
    public gsan.cobranca.NegativadorMovimentoReg getNegativadorMovimentoRegInclusao() {
        return this.negativadorMovimentoRegInclusao;
    }

    public void setNegativadorMovimentoRegInclusao(gsan.cobranca.NegativadorMovimentoReg negativadorMovimentoRegInclusao) {
        this.negativadorMovimentoRegInclusao = negativadorMovimentoRegInclusao;
    }
    ...
    public gsan.cobranca.NegativadorRegistroTipo getNegativadorRegistroTipo() {
        return this.negativadorRegistroTipo;
    }

    public void setNegativadorRegistroTipo(gsan.cobranca.NegativadorRegistroTipo negativadorRegistroTipo) {
        this.negativadorRegistroTipo = negativadorRegistroTipo;
    }

    public gsan.cobranca.NegativadorMovimento getNegativadorMovimento() {
        return this.negativadorMovimento;
    }

    public void setNegativadorMovimento(gsan.cobranca.NegativadorMovimento negativadorMovimento) {
        this.negativadorMovimento = negativadorMovimento;
    }
