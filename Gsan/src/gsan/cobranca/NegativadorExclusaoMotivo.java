...
public class NegativadorExclusaoMotivo extends ObjetoTransacao implements Serializable {
    ...
    /** full constructor */
    public NegativadorExclusaoMotivo(Integer id, short codigoExclusaoMotivo,String descricaoExclusaoMotivo, short indicadorUso, Date ultimaAlteracao, gsan.cobranca.Negativador negativador, Set negativadorMovimentoReg) {
        this.id = id;
