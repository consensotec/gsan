...
public class CobrancaGrupoCronogramaMes extends ObjetoTransacao{
    ...
    /** full constructor */
    public CobrancaGrupoCronogramaMes(int anoMesReferencia, Date ultimaAlteracao, gsan.cobranca.CobrancaGrupo cobrancaGrupo) {
    ...
    /** minimal constructor */
    public CobrancaGrupoCronogramaMes(int anoMesReferencia, gsan.cobranca.CobrancaGrupo cobrancaGrupo) {
        this.anoMesReferencia = anoMesReferencia;
        this.cobrancaGrupo = cobrancaGrupo;
    }
