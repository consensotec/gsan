...
public class NegativacaoImovei implements Serializable {
    ...
    /** full constructor */
    public NegativacaoImovei(Integer id, Date ultimaAlteracao, short indicadorExcluido, Date dataExclusao, Imovel imovel, gsan.cobranca.NegativacaoComando negativacaoComando) {
        this.id = id;
    ...
    /** default constructor */
    public NegativacaoImovei() {
    }

    /** minimal constructor */
    public NegativacaoImovei(Integer id, Date ultimaAlteracao, short indicadorExcluido, Imovel imovel, gsan.cobranca.NegativacaoComando negativacaoComando) {
        this.id = id;
        this.ultimaAlteracao = ultimaAlteracao;
        this.indicadorExcluido = indicadorExcluido;
        this.imovel = imovel;
