...
public class ParcelamentoItem implements Serializable {
    ...
    /** persistent field */
    private gsan.cobranca.parcelamento.Parcelamento parcelamento;
    ...
    /** full constructor */
    //public ParcelamentoItem(Date ultimaAlteracao, CreditoARealizarHistorico creditoARealizarHistorico, DebitoACobrarHistorico debitoACobrarHistorico, gsan.cobranca.parcelamento.Parcelamento parcelamento, DebitoACobrar debitoACobrar, DocumentoTipo documentoTipo, Conta conta, ContaHistorico contaHistorico, GuiaPagamento guiaPagamento, CreditoARealizar creditoARealizar) {
    public ParcelamentoItem(Date ultimaAlteracao,gsan.cobranca.parcelamento.Parcelamento parcelamento, 
    ...
    /** minimal constructor */
    //public ParcelamentoItem(CreditoARealizarHistorico creditoARealizarHistorico, DebitoACobrarHistorico debitoACobrarHistorico, gsan.cobranca.parcelamento.Parcelamento parcelamento, DebitoACobrar debitoACobrar, DocumentoTipo documentoTipo, Conta conta, Quadra quadra, ContaHistorico contaHistorico, GuiaPagamento guiaPagamento, CreditoARealizar creditoARealizar) {
...
*/
    public gsan.cobranca.parcelamento.Parcelamento getParcelamento() {
        return this.parcelamento;
    }

    public void setParcelamento(gsan.cobranca.parcelamento.Parcelamento parcelamento) {
        this.parcelamento = parcelamento;
    }
