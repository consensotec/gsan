...
public class ParcelamentoQuantidadeReparcelamentoHelper implements Serializable {
	...
	/** full constructor */
    public ParcelamentoQuantidadeReparcelamentoHelper(Short quantidadeMaximaReparcelamento, BigDecimal valorMinimoPrestacao, Date ultimaAlteracao, gsan.cobranca.parcelamento.ParcelamentoPerfil parcelamentoPerfil) {
    ...
    /** minimal constructor */
    public ParcelamentoQuantidadeReparcelamentoHelper(gsan.cobranca.parcelamento.ParcelamentoPerfil parcelamentoPerfil) {
        this.parcelamentoPerfil = parcelamentoPerfil;
    }
