...
public class ParcelamentoQuantidadePrestacaoHelper implements Serializable {
    ...
    private Collection collectionParcelamentoQtdLigacaoAgua;
    
    private String ligacoesAgua;
	...
	public Collection getCollectionParcelamentoQtdLigacaoAgua() {
		return collectionParcelamentoQtdLigacaoAgua;
	}

	public void setCollectionParcelamentoQtdLigacaoAgua(
			Collection collectionParcelamentoQtdLigacaoAgua) {
		this.collectionParcelamentoQtdLigacaoAgua = collectionParcelamentoQtdLigacaoAgua;
	}

	public String getLigacoesAgua() {
		return ligacoesAgua;
	}

	public void setLigacoesAgua(String ligacoesAgua) {
