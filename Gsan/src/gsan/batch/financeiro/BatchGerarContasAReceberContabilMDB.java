...
public class BatchGerarContasAReceberContabilMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarContasAReceberContabilMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				this.getControladorFinanceiro().gerarContasAReceberContabil(
