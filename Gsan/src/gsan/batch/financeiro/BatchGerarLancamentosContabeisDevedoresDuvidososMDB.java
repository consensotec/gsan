 ...
 * @date 25/06/2007
 */
public class BatchGerarLancamentosContabeisDevedoresDuvidososMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarLancamentosContabeisDevedoresDuvidososMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .gerarLancamentosContabeisDevedoresDuvidosos(
