 ...
 * @date 28/09/2010
 */
public class BatchApagarResumoDevedoresDuvidososMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchApagarResumoDevedoresDuvidososMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .apagarResumoDevedoresDuvidosos(
