...
public class BatchGerarValorVolumesConsumidosNaoFaturadosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarValorVolumesConsumidosNaoFaturadosMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				this.getControladorFinanceiro().gerarValorVolumesConsumidosNaoFaturados(
