 ...
 *
 */
public class TarefaBatchGerarResumoDevedoresDuvidosos extends TarefaBatch {
	
	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarResumoDevedoresDuvidosos(Usuario usuario,
	...
	@Deprecated
	public TarefaBatchGerarResumoDevedoresDuvidosos() {
		super(null, 0);
	}
    ...
    public Object executar() throws TarefaException {
        ...
        Integer idTipoPerda = (Integer) getParametro("idTipoPerda");
        ...
        while (iterator.hasNext()) {
            ...
            enviarMensagemControladorBatch(
                    ConstantesJNDI.BATCH_GERAR_RESUMO_DEVEDORES_DUVIDOSOS_MDB,
