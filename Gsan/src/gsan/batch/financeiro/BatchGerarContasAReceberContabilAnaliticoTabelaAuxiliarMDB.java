 ...
 * @date 12/04/2013
 */
public class BatchGerarContasAReceberContabilAnaliticoTabelaAuxiliarMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarContasAReceberContabilAnaliticoTabelaAuxiliarMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .gerarContasAReceberContabilAnaliticoTabelaAuxiliar(
