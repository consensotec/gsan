 ...
 * @date 23/05/2007
 */
public class BatchGerarLancamentosContabeisFaturamentoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarLancamentosContabeisFaturamentoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .gerarLancamentosContabeisFaturamento(
