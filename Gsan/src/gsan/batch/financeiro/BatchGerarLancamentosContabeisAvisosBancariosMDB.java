...
public class BatchGerarLancamentosContabeisAvisosBancariosMDB implements MessageDrivenBean,
	MessageListener{

	private static final long serialVersionUID = 1L;

	public BatchGerarLancamentosContabeisAvisosBancariosMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
            	...
            	this.getControladorFinanceiro().gerarLancamentosContabeisAvisosBancarios(
