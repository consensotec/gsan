 ...
 * @date 08/06/2007
 */
public class BatchGerarResumoDevedoresDuvidososMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoDevedoresDuvidososMDB() {
		super();
	}
