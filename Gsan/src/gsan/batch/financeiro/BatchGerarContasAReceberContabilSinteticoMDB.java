 ...
 * @date 12/04/2013
 */
public class BatchGerarContasAReceberContabilSinteticoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarContasAReceberContabilSinteticoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .gerarContasAReceberContabilSintetico(
