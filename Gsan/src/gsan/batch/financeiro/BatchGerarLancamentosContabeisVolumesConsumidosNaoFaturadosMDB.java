 ...
 * @date 28/11/2011
 */
public class BatchGerarLancamentosContabeisVolumesConsumidosNaoFaturadosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarLancamentosContabeisVolumesConsumidosNaoFaturadosMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .gerarLancamentosContabeisVolumesConsumidosNaoFaturados(
