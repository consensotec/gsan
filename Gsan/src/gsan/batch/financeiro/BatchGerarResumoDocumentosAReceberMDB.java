...
public class BatchGerarResumoDocumentosAReceberMDB implements MessageDrivenBean,
	MessageListener{
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoDocumentosAReceberMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				this.getControladorFinanceiro().gerarResumoDocumentosAReceber(
