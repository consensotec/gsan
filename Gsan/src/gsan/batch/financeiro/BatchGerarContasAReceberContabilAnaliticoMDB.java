 ...
 * @date 12/04/2013
 */
public class BatchGerarContasAReceberContabilAnaliticoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarContasAReceberContabilAnaliticoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .gerarContasAReceberContabilAnalitico(
