 ...
 * @date 28/09/2010
 */
public class BatchAtualizarResumoDevedoresDuvidososMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchAtualizarResumoDevedoresDuvidososMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .atualizarResumoDevedoresDuvidosos(
