...
public class FuncionalidadeIniciada implements Serializable {
	...
	/** persistent field */
	private gsan.batch.FuncionalidadeSituacao funcionalidadeSituacao;

	/** persistent field */
	private gsan.batch.ProcessoIniciado processoIniciado;

	/** persistent field */
	private gsan.batch.ProcessoFuncionalidade processoFuncionalidade;
	...
	public FuncionalidadeIniciada(Date dataHoraInicio, Date dataHoraTermino,
			gsan.batch.FuncionalidadeSituacao funcionalidadeSituacao,
			gsan.batch.ProcessoIniciado processoIniciado,
			gsan.batch.ProcessoFuncionalidade processoFuncionalidade,
	...
	public gsan.batch.FuncionalidadeSituacao getFuncionalidadeSituacao() {
	...
	public gsan.batch.ProcessoIniciado getProcessoIniciado() {
		return this.processoIniciado;
	}

	public void setProcessoIniciado(gsan.batch.ProcessoIniciado processoIniciado) {
		this.processoIniciado = processoIniciado;
	}

	public gsan.batch.ProcessoFuncionalidade getProcessoFuncionalidade() {
