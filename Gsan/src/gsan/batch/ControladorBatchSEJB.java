...
import gsan.arrecadacao.bean.DebitoCarteiraMovimentoHelper;
...
import gsan.atendimentopublico.registroatendimento.FiltroRaEncerramentoComando;
...
import gsan.batch.arrecadacao.TarefaBatchAtualizarLigacaoAguaLigadoAnaliseParaLigado;
import gsan.batch.arrecadacao.TarefaBatchBaixaAutomaticaPagamentosNaoClassificados;
import gsan.batch.arrecadacao.TarefaBatchClassificarPagamentosDevolucoes;
import gsan.batch.arrecadacao.TarefaBatchEncerrarArrecadacaoMes;
import gsan.batch.arrecadacao.TarefaBatchGerarArquivoCarteira17;
import gsan.batch.arrecadacao.TarefaBatchGerarDadosDiariosArrecadacao;
import gsan.batch.arrecadacao.TarefaBatchGerarDebitoACobrarContratoDemandaImovelResidencial;
import gsan.batch.arrecadacao.TarefaBatchGerarHistoricoConta;
import gsan.batch.arrecadacao.TarefaBatchGerarHistoricoParaEncerrarArrecadacaoMes;
import gsan.batch.arrecadacao.TarefaBatchGerarResumoArrecadacaoAnaliticoDados;
import gsan.batch.arrecadacao.TarefaBatchGerarResumoArrecadacaoAnaliticoTotais1;
import gsan.batch.arrecadacao.TarefaBatchGerarResumoArrecadacaoAnaliticoTotais2;
import gsan.batch.arrecadacao.TarefaBatchInserirPagamentosFaturasEspeciais;
import gsan.batch.arrecadacao.TarefaBatchRegistrarMovimentoArrecadadores;
import gsan.batch.arrecadacao.TarefaBatchResumoArrecadacaoAtualizaDados;
import gsan.batch.atendimentopublico.TarefaBatchAtualizarAutosInfracaoPrazoRecursoVencido;
import gsan.batch.atendimentopublico.TarefaBatchEmitirOrdemDeFiscalizacao;
import gsan.batch.atendimentopublico.TarefaBatchEncerrarComandoOSSeletivaInspecaoAnormalidade;
import gsan.batch.atendimentopublico.TarefaBatchExecutarComandoEncerramentoRA;
import gsan.batch.atendimentopublico.TarefaBatchGerarArquivoOrdemDeFiscalizacaoMDB;
import gsan.batch.atendimentopublico.TarefaBatchGerarDadosArquivoAcompanhamentoServico;
import gsan.batch.atendimentopublico.TarefaBatchGerarResumoAtendimentoPublicoAtualizaDados;
import gsan.batch.atendimentopublico.TarefaBatchGerarTxtOsInspecaoAnormalidade;
import gsan.batch.atendimentopublico.TarefaBatchProcessarAtualizacaoDasOrdensServicoDoArquivoTexto;
import gsan.batch.atendimentopublico.TarefaBatchProcessarEncerramentoOSFiscalizacaoDecursoPrazo;
import gsan.batch.atendimentopublico.TarefaBatchProgramacaoAutoRoteiroAcompanhamentoOS;
import gsan.batch.atualizacaocadastral.TarefaBatchAtualizarDadosCadastraisImovelRecadastramento;
import gsan.batch.atualizacaocadastral.TarefaBatchGerarRoteiroDispositivoMovel;
import gsan.batch.auxiliarbatch.CobrancaDocumentoControleGeracao;
import gsan.batch.cadastro.TarefaBatchAtualizarCodigoDebitoAutomatico;
import gsan.batch.cadastro.TarefaBatchEmitirBoletimCadastro;
import gsan.batch.cadastro.TarefaBatchEmitirBoletos;
import gsan.batch.cadastro.TarefaBatchEnviarEmailCobrancaFaturamento;
import gsan.batch.cadastro.TarefaBatchExcluirImoveisDaTarifaSocial;
import gsan.batch.cadastro.TarefaBatchGerarArquivoTextoAtualizacaoCadastral;
import gsan.batch.cadastro.TarefaBatchGerarCartaTarifaSocial;
import gsan.batch.cadastro.TarefaBatchGerarResumoCadastroAtualizaDados;
import gsan.batch.cadastro.TarefaBatchGerarResumoLigacoesEconomias;
import gsan.batch.cadastro.TarefaBatchGerarResumoLigacoesEconomiasPorAno;
import gsan.batch.cadastro.TarefaBatchGerarTabelasTemporariasAtualizacaoCadastral;
import gsan.batch.cadastro.TarefaBatchProcessarComandoGerado;
import gsan.batch.cadastro.TarefaBatchRetirarImovelTarifaSocial;
import gsan.batch.cadastro.TarefaBatchRetornoSMSEmLote;
import gsan.batch.cadastro.TarefaBatchSuspenderImovelEmProgramaEspecial;
import gsan.batch.cadastro.TarefaBatchTransmitirSMSEmLoteCobrancaFaturamento;
import gsan.batch.cobranca.TarefaBatchAtualizarComandoAtividadeAcaoCobranca;
import gsan.batch.cobranca.TarefaBatchAtualizarPagamentosContasCobranca;
import gsan.batch.cobranca.TarefaBatchDesfazerParcelamentoPorEntradaNaoPaga;
import gsan.batch.cobranca.TarefaBatchEmitirCartasCampanhaSolidariedadeCriancaParaNegociacaoAVista;
import gsan.batch.cobranca.TarefaBatchEmitirCartasDeFinalDeAno;
import gsan.batch.cobranca.TarefaBatchEmitirDocumentoCobranca;
import gsan.batch.cobranca.TarefaBatchEncerrarOSVisitaCobranca;
import gsan.batch.cobranca.TarefaBatchGerarArquivoTextoContasCobrancaEmpresa;
import gsan.batch.cobranca.TarefaBatchGerarArquivoTextoPagametosContasCobrancaEmpresa;
import gsan.batch.cobranca.TarefaBatchGerarAtividadeAcaoCobranca;
import gsan.batch.cobranca.TarefaBatchGerarBoletimCobrancaPorResultado;
import gsan.batch.cobranca.TarefaBatchGerarCartasCampanhaSolidariedadeCriancaParaNegociacaoAVista;
import gsan.batch.cobranca.TarefaBatchGerarCartasDeFinalDeAno;
import gsan.batch.cobranca.TarefaBatchGerarDividaAtiva;
import gsan.batch.cobranca.TarefaBatchGerarMovimentoContasCobrancaPorEmpresa;
import gsan.batch.cobranca.TarefaBatchGerarPrescreverDebitosDeImoveis;
import gsan.batch.cobranca.TarefaBatchGerarRelatorioPagamentosContasCobrancaEmpresa;
import gsan.batch.cobranca.TarefaBatchGerarResumoAcoesCobrancaCronograma;
import gsan.batch.cobranca.TarefaBatchGerarResumoAcoesCobrancaCronogramaEncerrarOS;
import gsan.batch.cobranca.TarefaBatchGerarResumoAcoesCobrancaEventual;
import gsan.batch.cobranca.TarefaBatchGerarResumoCobrancaAtualizaDados;
import gsan.batch.cobranca.TarefaBatchGerarResumoDividaAtivaAnual;
import gsan.batch.cobranca.TarefaBatchGerarResumoParcelamentoAtualizaDados;
import gsan.batch.cobranca.TarefaBatchIncluirDebitoACobrarEntradaParcelamentoNaoPaga;
import gsan.batch.cobranca.TarefaBatchInserirResumoAcoesCobrancaCronograma;
import gsan.batch.cobranca.TarefaBatchInserirResumoAcoesCobrancaEventual;
import gsan.batch.cobranca.TarefaBatchPrepararDadosSMSEmailAcaoCobranca;
import gsan.batch.cobranca.TarefaBatchPrepararDadosSMSEmailCobrancaConta;
import gsan.batch.cobranca.TarefaBatchProcessarAmortizacaoDividaAtivaArrecadacao;
import gsan.batch.cobranca.TarefaBatchProcessarAmortizacaoDividaAtivaFaturamento;
import gsan.batch.cobranca.TarefaBatchProcessarEncerramentoOSAcaoCobranca;
import gsan.batch.cobranca.TarefaBatchRetirarContasRevisaoExtratoEntradaParcelamento;
import gsan.batch.cobranca.cobrancaporresultado.TarefaBatchEncerrarComandosDeCobrancaPorEmpresa;
import gsan.batch.cobranca.cobrancaporresultado.TarefaBatchIncluirContasEmCobranca;
import gsan.batch.cobranca.cobrancaporresultado.TarefaBatchProcessarArquivoTxtEncerramentoOSCobranca;
import gsan.batch.cobranca.cobrancaporresultado.TarefaBatchRetirarImoveisContasEmpresaCobranca;
import gsan.batch.cobranca.spcserasa.TarefaBatchAcompanharPagamentoDoParcelamento;
import gsan.batch.cobranca.spcserasa.TarefaBatchAtualizarNumeroExecucaoResumoNegativacao;
import gsan.batch.cobranca.spcserasa.TarefaBatchDeterminarConfirmacaoDaNegativacao;
import gsan.batch.cobranca.spcserasa.TarefaBatchExecutarComandoNegativacao;
import gsan.batch.cobranca.spcserasa.TarefaBatchGerarMovimentoExclusaoNegativacao;
import gsan.batch.cobranca.spcserasa.TarefaBatchGerarMovimentoRetornoNegativacao;
import gsan.batch.cobranca.spcserasa.TarefaBatchGerarResumoDiarioNegativacao;
import gsan.batch.cobranca.spcserasa.TarefaBatchGerarResumoNegativacao;
import gsan.batch.faturamento.TarefaBatchAlterarInscricaoImovel;
import gsan.batch.faturamento.TarefaBatchAtualizaQuantidadeParcelaPagaConsecutivaParcelaBonus;
import gsan.batch.faturamento.TarefaBatchAutomatizarCargaPentaho;
import gsan.batch.faturamento.TarefaBatchAutomatizarPerfisDeGrandesConsumidores;
import gsan.batch.faturamento.TarefaBatchCancelarGrupoFaturamento;
import gsan.batch.faturamento.TarefaBatchEmitirContas;
import gsan.batch.faturamento.TarefaBatchEmitirContasOrgaoPublico;
import gsan.batch.faturamento.TarefaBatchEmitirExtratoConsumoImovelCondominio;
import gsan.batch.faturamento.TarefaBatchEncerrarFaturamentoMes;
import gsan.batch.faturamento.TarefaBatchEnvioEmailContaParaCliente;
import gsan.batch.faturamento.TarefaBatchFaturarGrupoFaturamento;
import gsan.batch.faturamento.TarefaBatchGerarArquivoTextoContasProjetosEspeciais;
import gsan.batch.faturamento.TarefaBatchGerarArquivoTextoDeclaracaoQuitacaoAnualDebitos;
import gsan.batch.faturamento.TarefaBatchGerarBonusTarifaSocial;
import gsan.batch.faturamento.TarefaBatchGerarContas;
import gsan.batch.faturamento.TarefaBatchGerarCreditoARealizarContratoDemandaImovelResidencial;
import gsan.batch.faturamento.TarefaBatchGerarCreditoARealizarPagamentoDuplicidadeVivaAgua;
import gsan.batch.faturamento.TarefaBatchGerarCreditoSituacaoEspecialFaturamento;
import gsan.batch.faturamento.TarefaBatchGerarDadosDeclaracaoQuitacaoAnualDebitos;
import gsan.batch.faturamento.TarefaBatchGerarDebitosACobrarAcrescimosImpontualidade;
import gsan.batch.faturamento.TarefaBatchGerarDebitosACobrarDoacao;
import gsan.batch.faturamento.TarefaBatchGerarFaturaClienteResponsavel;
import gsan.batch.faturamento.TarefaBatchGerarFaturaProgramaEspecial;
import gsan.batch.faturamento.TarefaBatchGerarHistoricoParaEncerrarFaturamentoMes;
import gsan.batch.faturamento.TarefaBatchGerarResumoFaturamento;
import gsan.batch.faturamento.TarefaBatchGerarResumoFaturamentoAguaEsgoto;
import gsan.batch.faturamento.TarefaBatchGerarResumoFaturamentoAnaliticoParte1;
import gsan.batch.faturamento.TarefaBatchGerarResumoFaturamentoAnaliticoParte2;
import gsan.batch.faturamento.TarefaBatchGerarResumoFaturamentoAnaliticoTotais;
import gsan.batch.faturamento.TarefaBatchGerarResumoFaturamentoAtualizaDados;
import gsan.batch.faturamento.TarefaBatchGerarResumoFaturamentoPorAno;
import gsan.batch.faturamento.TarefaBatchGerarResumoReFaturamento;
import gsan.batch.faturamento.TarefaBatchGerarResumoReFaturamentoNovo;
import gsan.batch.faturamento.TarefaBatchGerarResumoReFaturamentoOlap;
import gsan.batch.faturamento.TarefaBatchGerarResumoSimulacaoFaturamento;
import gsan.batch.faturamento.TarefaBatchGerarResumoSituacaoEspecialFaturamento;
import gsan.batch.faturamento.TarefaBatchGerarTaxaEntregaContaOutroEndereco;
import gsan.batch.faturamento.TarefaBatchGerarTaxaPercentualTarifaMinimaCortado;
import gsan.batch.faturamento.TarefaBatchGerarTxtImpressaoContasBraille;
import gsan.batch.faturamento.TarefaBatchParalisarFaturamento;
import gsan.batch.faturamento.TarefaBatchPrescreverDebitosImoveisPublicosAutomatico;
import gsan.batch.faturamento.TarefaBatchPrescreverDebitosImoveisPublicosManual;
import gsan.batch.faturamento.TarefaBatchReceitaLiquidaIndiretaDeAguaEEsgotoMDB;
import gsan.batch.faturamento.TarefaBatchReligarImoveisCortadosComConsumoReal;
import gsan.batch.faturamento.TarefaBatchReligarImoveisCortadosComLeituraRealConsumo;
import gsan.batch.faturamento.TarefaBatchRetificarConjuntoContaConsumos;
import gsan.batch.faturamento.TarefaBatchRetificarContasCaern;
import gsan.batch.faturamento.TarefaBatchSuspenderLeituraParaImovelComConsumoRealNaoSuperiorA10;
import gsan.batch.faturamento.TarefaBatchSuspenderLeituraParaImovelComHidrometroRetirado;
import gsan.batch.faturamento.TarefaBatchVerificarFaturamentoImoveisCortados;
import gsan.batch.financeiro.TarefaBatchApagarResumoDevedoresDuvidosos;
import gsan.batch.financeiro.TarefaBatchAtualizarResumoDevedoresDuvidosos;
import gsan.batch.financeiro.TarefaBatchGerarContasAReceberContabil;
import gsan.batch.financeiro.TarefaBatchGerarContasAReceberContabilAnalitico;
import gsan.batch.financeiro.TarefaBatchGerarContasAReceberContabilAnaliticoTabelaAuxiliar;
import gsan.batch.financeiro.TarefaBatchGerarContasAReceberContabilSintetico;
import gsan.batch.financeiro.TarefaBatchGerarLancamentosContabeisArrecadacao;
import gsan.batch.financeiro.TarefaBatchGerarLancamentosContabeisAvisosBancarios;
import gsan.batch.financeiro.TarefaBatchGerarLancamentosContabeisDevedoresDuvidosos;
import gsan.batch.financeiro.TarefaBatchGerarLancamentosContabeisFaturamento;
import gsan.batch.financeiro.TarefaBatchGerarLancamentosContabeisVolumesConsumidosNaoFaturados;
import gsan.batch.financeiro.TarefaBatchGerarResumoDevedoresDuvidosos;
import gsan.batch.financeiro.TarefaBatchGerarResumoDocumentosAReceber;
import gsan.batch.financeiro.TarefaBatchGerarResumoReceita;
import gsan.batch.financeiro.TarefaBatchGerarValorVolumesConsumidosNaoFaturados;
import gsan.batch.financeiro.TarefaBatchRelatorioContasBaixadasContabilmente;
import gsan.batch.gerencial.TarefaBatchExecutarCargaArrecadacaoGerencialAno;
import gsan.batch.gerencial.TarefaBatchGerarFaturamentoBrutoLiquido;
import gsan.batch.gerencial.TarefaBatchGerarResumoPendenciaBD;
import gsan.batch.gerencial.arrecadacao.TarefaBatchExecutarCargaIndicadorLigacaoEconomiaPorAno;
import gsan.batch.gerencial.arrecadacao.TarefaBatchExecutarCargaLigacoesEconomiasPorAno;
import gsan.batch.gerencial.arrecadacao.TarefaBatchExecutarCargaPendenciaSemQuadraVariosAnos;
import gsan.batch.gerencial.arrecadacao.TarefaBatchExecutarCargaResumoParcelamentoPorAno;
import gsan.batch.gerencial.arrecadacao.TarefaBatchExecutarCargaResumoPendenciaPorAno;
import gsan.batch.gerencial.arrecadacao.TarefaBatchGerarResumoArrecadacao;
import gsan.batch.gerencial.arrecadacao.TarefaBatchGerarResumoArrecadacaoPorAno;
import gsan.batch.gerencial.arrecadacao.TarefaBatchGerarUnResumoArrecadacaoBD;
import gsan.batch.gerencial.cadastro.TarefaBatchGerarResumoColetaEsgoto;
import gsan.batch.gerencial.cadastro.TarefaBatchGerarResumoColetaEsgotoPorAno;
import gsan.batch.gerencial.cadastro.TarefaBatchGerarResumoConsumoAgua;
import gsan.batch.gerencial.cadastro.TarefaBatchGerarResumoConsumoAguaPorAno;
import gsan.batch.gerencial.cadastro.TarefaBatchGerarResumoHistogramaAguaEsgoto;
import gsan.batch.gerencial.cadastro.TarefaBatchGerarResumoHistogramaAguaEsgotoSemQuadra;
import gsan.batch.gerencial.cadastro.TarefaBatchGerarResumoIndicadoresComercializacao;
import gsan.batch.gerencial.cadastro.TarefaBatchGerarResumoMetas;
import gsan.batch.gerencial.cadastro.TarefaBatchGerarResumoMetasAcumulado;
import gsan.batch.gerencial.cadastro.TarefaBatchGerarResumoParcelamento;
import gsan.batch.gerencial.cadastro.TarefaBatchGerarResumoParcelamentoPorAno;
import gsan.batch.gerencial.cobranca.TarefaBatchGerarGuiaPagamentoPorClienteResumoPendencia;
import gsan.batch.gerencial.cobranca.TarefaBatchGerarResumoIndicadoresCobranca;
import gsan.batch.gerencial.cobranca.TarefaBatchGerarResumoPendencia;
import gsan.batch.gerencial.cobranca.TarefaBatchGerarResumoPendenciaPorAno;
import gsan.batch.gerencial.cobranca.TarefaBatchGerarResumoSituacaoEspecialCobranca;
import gsan.batch.gerencial.faturamento.TarefaBatchExecutarCargaColetaEsgotoPorAno;
import gsan.batch.gerencial.faturamento.TarefaBatchExecutarCargaConsumoAguaPorAno;
import gsan.batch.gerencial.faturamento.TarefaBatchExecutarCargaIndicadoresDesempenhoFaturamentoPorAno;
import gsan.batch.gerencial.faturamento.TarefaBatchExecutarCargaIndicadoresDesempenhoFaturamentoVariosAnos;
import gsan.batch.gerencial.faturamento.TarefaBatchExecutarCargaIndicadoresDesempenhoMicromedicaoPorAno;
import gsan.batch.gerencial.faturamento.TarefaBatchExecutarCargaIndicadoresDesempenhoMicromedicaoVariosAnos;
import gsan.batch.gerencial.faturamento.TarefaBatchExecutarCargaLeituraAnormalidadePorAno;
import gsan.batch.gerencial.faturamento.TarefaBatchExecutarCargaRegistroAtendimentoPorAno;
import gsan.batch.gerencial.faturamento.TarefaBatchExecutarCargaResumoFaturamentoPorAno;
import gsan.batch.gerencial.faturamento.TarefaBatchGerarResumoIndicadoresFaturamento;
import gsan.batch.gerencial.micromedicao.TarefaBatchGerarResumoAnormalidades;
import gsan.batch.gerencial.micromedicao.TarefaBatchGerarResumoIndicadoresMicromedicao;
import gsan.batch.gerencial.micromedicao.TarefaBatchGerarResumoIndicadoresMicromedicaoPorAno;
import gsan.batch.gerencial.micromedicao.TarefaBatchGerarResumoInstalacoesHidrometros;
import gsan.batch.gerencial.micromedicao.TarefaBatchGerarResumoInstalacoesHidrometrosPorAno;
import gsan.batch.gerencial.micromedicao.TarefaBatchGerarResumoLeituraAnormalidade;
import gsan.batch.micromedicao.TarefaBatchConsistirLeiturasCalcularConsumos;
import gsan.batch.micromedicao.TarefaBatchEfetuarRateioConsumo;
import gsan.batch.micromedicao.TarefaBatchGerarArquivoTextoParaLeiturista;
import gsan.batch.micromedicao.TarefaBatchGerarDadosParaLeitura;
import gsan.batch.micromedicao.TarefaBatchGerarMovimentoHidrometro;
import gsan.batch.micromedicao.TarefaBatchGerarRAOSAnormalidadeConsumo;
import gsan.batch.micromedicao.TarefaBatchGerarResumoMicromedicaoAtualizaDados;
...
import gsan.cadastro.empresa.FiltroEmpresaCobranca;
...
import gsan.cobranca.ComandoEmpresaCobrancaContaExtensao;
...
import gsan.cobranca.FiltroComandoEmpresaCobrancaContaExtensao;
...
import gsan.cobranca.RelatorioPagamentosContasCobrancaEmpresaHelper;
import gsan.cobranca.TarefaBatchGerarArquivoTextoOSContasPagasParceladas;
import gsan.cobranca.TarefaBatchGerarMovimentoExtensaoContasCobrancaPorEmpresa;
...
import gsan.gerencial.atendimentopublico.registroatendimento.TarefaBatchGerarResumoRegistroAtendimento;
import gsan.gerencial.atendimentopublico.registroatendimento.TarefaBatchGerarResumoRegistroAtendimentoPorAno;
import gsan.gerencial.faturamento.ControladorGerencialFaturamentoLocal;
import gsan.gerencial.faturamento.ControladorGerencialFaturamentoLocalHome;
...
import gsan.gerencial.micromedicao.TarefaBatchGerarResumoHidrometro;
import gsan.integracao.ControladorIntegracaoLocal;
import gsan.integracao.ControladorIntegracaoLocalHome;
...
import gsan.micromedicao.MovimentoHidrometroHelper;
...
import gsan.micromedicao.hidrometro.TarefaBatchAtualizarConjuntoHidrometro;
import gsan.relatorio.GerenciadorExecucaoTarefaRelatorio;
...
public class ControladorBatchSEJB implements SessionBean {
			...
			while (iterator.hasNext()) {
				...
				try {
					...
					case Funcionalidade.GERAR_RESUMO_DIARIO_NEGATIVACAO:
						...
						// 2.0 O sistema exclui o resumo diï¿½rio das
						// negativaï¿½ï¿½es
						// da penï¿½ltima execuï¿½ï¿½o
					...
					case Funcionalidade.EXECUTAR_COMANDO_DE_NEGATIVACAO:
						...
						// Caso exista movimento de exclusï¿½o incompleto,
						// cancelar o processo e exibir msg
						// "Hï¿½ movimento de exclusï¿½o incompleto. Reinicie o
						// step
						// 2 do processo 135 e apï¿½s a conclusï¿½o
					...
					case Funcionalidade.GERAR_RESUMO_FATURAMENTO:
						...
						// Adicionamos um setor comercial ficticio que serï¿½
						// utilizado
					...
					case Funcionalidade.EXECUTAR_COMANDO_DE_ENCERRAMENTO_RA:
						...
						if (colRaEncerramentoComando != null && !colRaEncerramentoComando.isEmpty()) {
							...
							// recupera o promeiro comando da seleï¿½ï¿½o para
							// executar
					...
					case Funcionalidade.GERAR_RESUMO_REFATURAMENTO_NOVO:
						...
						// [FS0001 - Verificar existï¿½ncia de resumo de
						// refaturamento para o ano/mï¿½s de referï¿½ncia]
						...
						/*
						 * Adicionamos um setor comercial fictï¿½cio que serï¿½
					...
					case Funcionalidade.PRESCREVER_DEBITOS_IMOVEIS_PUBLICOS:
						...
						// usuï¿½rio atravï¿½s da interface do sistema
					...
					case Funcionalidade.GERAR_TXT_IMPRESSAO_CONTAS_FORMATO_BRAILLE:
						...
						// Caso haja algum grupo de faturamento que nï¿½o tenha
						// sido faturado
					...
					/**
					 * [UC1240] Gerar Boletim de Cobranï¿½a por Resultado
					 * 
					...
					case Funcionalidade.BATCH_RESUMO_ARRECADACAO_ATUALIZA_DADOS:
						...
						TarefaBatchResumoArrecadacaoAtualizaDados gerarResumoArrecadacaoAtualizaDados = new TarefaBatchResumoArrecadacaoAtualizaDados(	processoIniciado.getUsuario(),
																																									funcionalidadeIniciada.getId());

						// Seta o objeto para ser serializado no banco, onde
						// depois sera executado por uma thread
						funcionalidadeIniciada.setTarefaBatch(IoUtil.transformarObjetoParaBytes(gerarResumoArrecadacaoAtualizaDados ));

						getControladorUtil().atualizar(funcionalidadeIniciada);
						break;						
						
					case Funcionalidade.BATCH_RESUMO_COBRANCA_ATUALIZA_DADOS:

						TarefaBatchGerarResumoCobrancaAtualizaDados gerarResumoCobrancaAtualizaDados = new TarefaBatchGerarResumoCobrancaAtualizaDados(	processoIniciado.getUsuario(),
																																									funcionalidadeIniciada.getId());

						// Seta o objeto para ser serializado no banco, onde
						// depois sera executado por uma thread
						funcionalidadeIniciada.setTarefaBatch(IoUtil.transformarObjetoParaBytes(gerarResumoCobrancaAtualizaDados));

						getControladorUtil().atualizar(funcionalidadeIniciada);
						break;	
						
					case Funcionalidade.BATCH_RESUMO_FATURAMENTO_ATUALIZA_DADOS:

						TarefaBatchGerarResumoFaturamentoAtualizaDados gerarResumoFaturamentoAtualizaDados = new TarefaBatchGerarResumoFaturamentoAtualizaDados(	processoIniciado.getUsuario(),
																																									funcionalidadeIniciada.getId());

						// Seta o objeto para ser serializado no banco, onde
						// depois sera executado por uma thread
						funcionalidadeIniciada.setTarefaBatch(IoUtil.transformarObjetoParaBytes(gerarResumoFaturamentoAtualizaDados));

						getControladorUtil().atualizar(funcionalidadeIniciada);
						break;	
						
					case Funcionalidade.BATCH_RESUMO_MICROMEDICAO_ATUALIZA_DADOS:

						TarefaBatchGerarResumoMicromedicaoAtualizaDados gerarResumoMicromedicaoAtualizaDados = new TarefaBatchGerarResumoMicromedicaoAtualizaDados(	processoIniciado.getUsuario(),
																																									funcionalidadeIniciada.getId());

						// Seta o objeto para ser serializado no banco, onde
						// depois sera executado por uma thread
						funcionalidadeIniciada.setTarefaBatch(IoUtil.transformarObjetoParaBytes(gerarResumoMicromedicaoAtualizaDados));

						getControladorUtil().atualizar(funcionalidadeIniciada);
						break;	
						
					case Funcionalidade.BATCH_RESUMO_ATENDIMENTO_PUBLICO_ATUALIZA_DADOS:

						TarefaBatchGerarResumoAtendimentoPublicoAtualizaDados gerarResumoAtendimentoPublicoAtualizaDados = new TarefaBatchGerarResumoAtendimentoPublicoAtualizaDados(	processoIniciado.getUsuario(),
																																														funcionalidadeIniciada.getId());

						// Seta o objeto para ser serializado no banco, onde
						// depois sera executado por uma thread
						funcionalidadeIniciada.setTarefaBatch(IoUtil.transformarObjetoParaBytes(gerarResumoAtendimentoPublicoAtualizaDados));

						getControladorUtil().atualizar(funcionalidadeIniciada);
						break;	
						
					case Funcionalidade.BATCH_RESUMO_PARCELAMENTO_ATUALIZA_DADOS:

						TarefaBatchGerarResumoParcelamentoAtualizaDados gerarResumoParcelamentoAtualizaDados = new TarefaBatchGerarResumoParcelamentoAtualizaDados(	processoIniciado.getUsuario(),
																																														funcionalidadeIniciada.getId());

						// Seta o objeto para ser serializado no banco, onde
						// depois sera executado por uma thread
						funcionalidadeIniciada.setTarefaBatch(IoUtil.transformarObjetoParaBytes(gerarResumoParcelamentoAtualizaDados));

						getControladorUtil().atualizar(funcionalidadeIniciada);
						break;
						
					case Funcionalidade.BATCH_RESUMO_CADASTRO_ATUALIZA_DADOS:

						TarefaBatchGerarResumoCadastroAtualizaDados gerarResumoCadastroAtualizaDados = new TarefaBatchGerarResumoCadastroAtualizaDados(	processoIniciado.getUsuario(),
																																														funcionalidadeIniciada.getId());

						// Seta o objeto para ser serializado no banco, onde
						// depois sera executado por uma thread
						funcionalidadeIniciada.setTarefaBatch(IoUtil.transformarObjetoParaBytes(gerarResumoCadastroAtualizaDados));
			...
			while (iteratorFaturamentoAtividadeCronograma.hasNext()) {
						...
						while (iteratorRota.hasNext()) {
							...
							if (mensagemAlerta == null) {
								mensagemAlerta = rotaNaoTransmitida.getCodigo().toString() + 
										" Setor Comercial: " + rotaNaoTransmitida.getSetorComercial().getCodigo() + 
										" Localidade: " + rotaNaoTransmitida.getSetorComercial().getLocalidade().getId().toString();
							} else {
								mensagemAlerta += "," + rotaNaoTransmitida.getCodigo().toString() + 
										" Setor Comercial: " + rotaNaoTransmitida.getSetorComercial().getCodigo() +
										" Localidade: " + rotaNaoTransmitida.getSetorComercial().getLocalidade().getId().toString();
				...
				while (iterator.hasNext()) {
					...
					case Funcionalidade.CONSISTIR_LEITURAS_E_CALCULAR_CONSUMOS:
						...
						// @Autor: Yara T. Souza
						// @Data:09/01/09
						// Processar Leituras Nï¿½o Registradas
						// --------------------------------------------------------------
					...
					case Funcionalidade.GERAR_CREDITO_A_REALIZAR_CONTRATO_DEMANDA_RESIDENCIAL:
						/**
						 * [UC1236] Gerar Crï¿½dito a Realizar Contrato de
						 * Demanda Imï¿½vel Residencial
						 * 
						 * @author Rafael Pinto
						 * @date 06/10/2011
						 */
					...
					case Funcionalidade.SUSPENDER_LEITURA_PARA_IMOVEL_COM_HIDROMETRO_RETIRADO:
						/**
						 * [UC1216] Suspender Leitura para Imï¿½vel com
						 * Hidrï¿½metro Retirado
						 * 
						 * @author Vivianne Sousa
						 * @date 23/08/2011
						 */
					...
					case Funcionalidade.GERAR_ATIVIDADE_ACAO_COBRANCA:
						...
						if (cobrancaAcaoAtividadeComandoNaBase == null) {
							// inserir comando de cobranï¿½a eventual
							...
							// Data encerramento prevista serï¿½ igual a data
							// corrente mais o nï¿½mero de dias de validade da
							// aï¿½ï¿½o de cobranï¿½a
					...
					case Funcionalidade.BATCH_RELIGAR_IMOVEIS_CORTADOS_LEITURA_REAL_CONSUMO:

						TarefaBatchReligarImoveisCortadosComLeituraRealConsumo tarefaBatchReligarImoveisCortadosComLeituraRealConsumo = 
								new TarefaBatchReligarImoveisCortadosComLeituraRealConsumo(processoIniciado.getUsuario(),funcionalidadeIniciada.getId());

						tarefaBatchReligarImoveisCortadosComLeituraRealConsumo.addParametro("colecaoRotas", colecaoFaturamentoAtivCronRota);

						tarefaBatchReligarImoveisCortadosComLeituraRealConsumo.addParametro("anoMesFaturamento", faturamentoAtividadeCronograma.
								getFaturamentoGrupoCronogramaMensal().getFaturamentoGrupo().getAnoMesReferencia());
						
						funcionalidadeIniciada.setTarefaBatch(IoUtil.transformarObjetoParaBytes(tarefaBatchReligarImoveisCortadosComLeituraRealConsumo));
	...
	public int iniciarUnidadeProcessamentoBatch(int idFuncionalidadeIniciada, int idUnidadeProcessamento,
		...
		// Caso nï¿½o exista, pode ser usada como teste do processo batch
		if (idFuncionalidadeIniciada > 0) {
			...
			try {
				...
				if (funcionalidadesIniciadasComErro > 0) {
					throw new ControladorException("Esta Unidade nï¿½o serï¿½ executada porque o processo estï¿½ concluï¿½do com erro");
				}
				FiltroFuncionalidadeIniciada filtroFuncionalidadeIniciada = new FiltroFuncionalidadeIniciada();
				filtroFuncionalidadeIniciada.adicionarParametro(new ParametroSimples(	FiltroFuncionalidadeIniciada.ID,
				...
				try {
					...
					if (tarefa instanceof TarefaBatch) {
						...
						// Sï¿½ vai processar as unidades que nï¿½o foram
						...
						if (unidadesJaExecutadas != null && !unidadesJaExecutadas.isEmpty()) {
							...
							while (iterator.hasNext()) {
								...
								if ((unidadeIniciadaLista.getCodigoRealUnidadeProcessamento() == codigoRealUnidadeProcessamento)
									...
									// Caso a unidade jï¿½ tenha sido
									// previamente
									// executada, ela serï¿½ registrada como
									// concluï¿½da e com data de
									// inï¿½cio e fim iguais
	...
	private void encerrarUnidadeIniciadaJaExecutada(UnidadeIniciada unidadeIniciada) throws ControladorException {
		...
		throw new ControladorException("Unidade jï¿½ executada");
	...
	public void encerrarUnidadeProcessamentoBatch(Throwable excecao, int idUnidadeIniciada, boolean executouComErro)
		...
		if (idUnidadeIniciada != 0) {
			...
			// executada por causa de uma continuaï¿½ï¿½o no processo
			if ((!executouComErro)
					|| (excecao != null && excecao.getMessage() != null && excecao.getMessage().equals("Unidade jï¿½ executada"))) {
	...
	/**
	 * Inseri uma coleï¿½ï¿½o de objetos genï¿½ricos na base
	 * 
	 * @author Rafael Pinto
	 * @date 20/05/2008
	 * 
	...
	/**
	 * Funcao que executa as rotinas de execucao da integraï¿½ï¿½o da SAM
	 * 
	 * @author Rodrigo Silveira
	 * @date 27/02/2008
	 * 
	...
	/**
	 * Remove uma coleï¿½ï¿½o de objetos genï¿½ricos na base com um flush para
	...
	public void reiniciarFuncionalidadesIniciadas(String[] idsFuncionalidadesIniciadas, Integer idProcessoIniciado)
		...
		while (i < idsFuncionalidadesIniciadas.length) {
			...
			// Limpa a coleï¿½ï¿½o das funcionalidades jï¿½ executadas da
			// continuaï¿½ï¿½o
			try {
				Object tarefa = IoUtil.transformarBytesParaObjeto(funcionalidadeIniciada.getTarefaBatch());
	...
	/**
	 * Remove uma coleï¿½ï¿½o de GuiaPagamentoCategoria
	 * 
	...
	/**
	 * Remove uma coleï¿½ï¿½o de ClienteGuiaPagamento
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de GuiaPagamento
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de DebitoACobrar
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de DebitoACobrarCategoria
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de Pagamento
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de Devoluï¿½ï¿½o
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de ContaCategoria
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de ContaCategoriaConsumoFaixa
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de CreditoRealizado
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de DebitoCobrado
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de DebitoCobradoCategoria
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de CreditoRealizadoCategoria
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de ContaImpostosDeduzidos
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de ClienteConta
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de CreditoARealizar
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
	...
	/**
	 * Remove uma coleï¿½ï¿½o de CreditoARealizarCategoria
	 * 
	 * [UC0276] Encerrar Arrecadaï¿½ï¿½o do Mï¿½s
	 * 
	 * @author Pedro Alexandre
				...
				try {
					...
					case Funcionalidade.GERAR_CARTAS_CAMPANHA_SOLIDARIEDADE_CRIANCA_PARA_NEGOCIACAO_A_VISTA:
						...
						if (acao.equals("1")) {
							...
							// pelo usuï¿½rio atravï¿½s da interface do sistema
					 ...
					 * Cobranï¿½a Mariana Victor 21/06/2011
					 **/
					case Funcionalidade.RECEPCIONAR_ARQUIVO_TXT_ENCERRAMENTO_OS_COBRANCA:
						...
						break;
					/**
					 * [UC1197] Encerrar Comandos de OS Seletiva de Inspeï¿½ï¿½o
					 * de Anormalidade
					 * 
					 * @author Vivianne Sousa
					 * @created 21/07/2011
					...
					/**
					 * [UC1228] Consultar Ordens de Serviï¿½o do Arquivo Texto
	...
	/**
	 * Cria um ProcessoIniciado para os processos batch iniciados atravï¿½s da
	 * interface comum
	 * 
	 * @param usuario
	 *            Usuï¿½rio que iniciou o processo
	 * @return
	 */
	...
	private void inserirLogExcecaoFuncionalidadeIniciada(UnidadeIniciada unidadeIniciada, Throwable excecao) {
		// Verificar se a unidade jï¿½ possui o registro do log da exceï¿½ï¿½o
		// Sï¿½ o primeiro log deverï¿½ ser gravado
	...
	/**
	 * Inserir e Atualizar Movimentaï¿½ï¿½es de Hidrometros
	 * 
	...
	/**
	 * Inicia um processo relacionado com um relatoio que seria processado em
	 * batch dependendo de critï¿½rios de autorizaï¿½ï¿½o
	 * 
	 * @author Rodrigo Silveira
	 * @date 08/06/2009
	 * 
	...
	public void iniciarProcessoRelatorioControleAutorizacao(TarefaRelatorio tarefaRelatorio) throws ControladorException {
		try {
			...
			// O usuï¿½rio nï¿½o pode agendar relatï¿½rios caso exista mais de
			// dois
			// documentos em situaï¿½ï¿½o de 'Aguardando Autorizaï¿½ï¿½o'
	...
	/**
	 * Atualiza um objeto genï¿½rico na base
	 * 
	 * @author Vivianne Sousa
	 * @date 03/02/2009
	 * 
	...
	/**
	 * Insere uma objeto genï¿½rico na base
	 * 
	 * @author Vivianne Sousa
	 * @date 03/02/2009
	 * 
	...
	/**
	 * Insere uma objeto genï¿½rico na base, sem controle transacional
	 * 
	 * @author Bruno Barros
	 * @date 23/09/2010
	 * 
	...
	/**
	 * Retorna o(s) processo(s) que estï¿½ em execuï¿½ï¿½o
	 * 
	 * @author Arthur Carvalho
	 * @date 04/06/2010
	 * 
	...
	/**
	 * Gerar Declaraï¿½ï¿½o de Quitaï¿½ï¿½o Anual de Dï¿½bitos
	 * 
	...
	/**
	 * verificar se a funcionalidade de gerar dados diï¿½rios de arrecadaï¿½ï¿½o
	 * esta executando
	 * 
	 * @author Rodrigo Cabral
	 * @date 07/12/11
	...
	public void verificarExecucaoFuncionalidade(Integer idFuncionalidade) throws ControladorException {
		 ...
		 * mensagem ao usuï¿½rio negando o acesso a consulta.
		 */
