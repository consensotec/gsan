...
public class BatchEncerrarOSVisitaCobrancaMDB
		implements
			MessageDrivenBean,
			MessageListener {
	...
	public BatchEncerrarOSVisitaCobrancaMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				Integer idFuncionalidade = (Integer)((Object[]) objectMessage.getObject())[0];
				Collection<?> colecaoOs = (Collection<?>) ((Object[]) objectMessage.getObject())[1];		
				Usuario usuario = (Usuario) ((Object[]) objectMessage.getObject())[2];
				
				this.getControladorCobranca().encerrarOSVisitaCobranca(
						idFuncionalidade,
						colecaoOs,
						usuario
					);
