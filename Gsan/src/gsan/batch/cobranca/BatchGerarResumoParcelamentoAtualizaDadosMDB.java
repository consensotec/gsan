 ...
 * @date 04/02/2014
 */
public class BatchGerarResumoParcelamentoAtualizaDadosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoParcelamentoAtualizaDadosMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        .getControladorCobrancaLocal()
                        .gerarResumoParcelamentoAtualizaDados(
	 ...
	 */
	private ControladorCobrancaLocal getControladorCobrancaLocal() {
