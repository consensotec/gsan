 ...
 * @date 22/01/2007
 */
public class BatchGerarResumoAcoesCobrancaCronogramaMDB
		implements
			MessageDrivenBean,
			MessageListener {
	...
	public BatchGerarResumoAcoesCobrancaCronogramaMDB() {
		super();
	}
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorCobranca()
						.gerarResumoAcoesCobrancaCronograma((Object[])((Object[]) objectMessage.getObject())[0],
