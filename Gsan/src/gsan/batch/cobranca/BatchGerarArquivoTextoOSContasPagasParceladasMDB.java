...
public class BatchGerarArquivoTextoOSContasPagasParceladasMDB implements
		MessageDrivenBean, MessageListener {

	private static final long serialVersionUID = 1L;

	public BatchGerarArquivoTextoOSContasPagasParceladasMDB() {
		super();
	}
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this
						...
						.gerarArquivoTxtOSContasPagasParceladas(
