 ...
 * @date 29/01/2014
 */
public class BatchGerarResumoCobrancaAtualizaDadosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoCobrancaAtualizaDadosMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .gerarResumoCobrancaAtualizaDados(
