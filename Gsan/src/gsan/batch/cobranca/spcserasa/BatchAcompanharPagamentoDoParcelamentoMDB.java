...
public class BatchAcompanharPagamentoDoParcelamentoMDB
		implements
			MessageDrivenBean,
			MessageListener {
	private static final long serialVersionUID = 1L;

	public BatchAcompanharPagamentoDoParcelamentoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorSpcSerasa().acompanharPagamentoDoParcelamento(
