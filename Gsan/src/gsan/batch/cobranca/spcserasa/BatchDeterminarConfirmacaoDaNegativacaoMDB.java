...
public class BatchDeterminarConfirmacaoDaNegativacaoMDB
		implements
			MessageDrivenBean,
			MessageListener {
	private static final long serialVersionUID = 1L;

	public BatchDeterminarConfirmacaoDaNegativacaoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorSpcSerasa().determinarConfirmacaoDaNegativacao(
