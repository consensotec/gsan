...
public class BatchAtualizarNumeroExecucaoResumoNegativacaoMDB
		implements
			MessageDrivenBean,
			MessageListener {
	private static final long serialVersionUID = 1L;

	public BatchAtualizarNumeroExecucaoResumoNegativacaoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorSpcSerasa().atualizarNumeroExecucaoResumoNegativacao(
