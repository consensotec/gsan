 ...
 * @created 15/06/2007
 */
public class TarefaBatchInserirResumoAcoesCobrancaEventual extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchInserirResumoAcoesCobrancaEventual(Usuario usuario,
	...
	@Deprecated
	public TarefaBatchInserirResumoAcoesCobrancaEventual() {
		super(null, 0);
	}
	...
	public Object executar() throws TarefaException {
		...
		while (iterator.hasNext()) {
			...
			enviarMensagemControladorBatch(
					ConstantesJNDI.BATCH_INSERIR_RESUMO_ACAO_COBRANCA_EVENTUAL_MDB,
	...
	public void agendarTarefaBatch() {
		AgendadorTarefas.agendarTarefa(
				"InserirResumoAcoesCobrancaEventualBatch", this);
	}
