 ...
 * @date 16/05/2008
 */
public class BatchGerarResumoAcoesCobrancaCronogramaEncerrarOSMDB implements
	...
	public BatchGerarResumoAcoesCobrancaCronogramaEncerrarOSMDB() {
		super();
	}
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this
						...
						.gerarResumoAcoesCobrancaCronogramaEncerrarOS(
