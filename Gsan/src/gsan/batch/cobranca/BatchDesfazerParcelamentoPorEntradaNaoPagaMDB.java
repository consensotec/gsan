 ...
 * @date 23/03/2007
 */
public class BatchDesfazerParcelamentoPorEntradaNaoPagaMDB
		implements
			MessageDrivenBean,
			MessageListener {
	...
	public BatchDesfazerParcelamentoPorEntradaNaoPagaMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorCobranca().desfazerParcelamentosPorEntradaNaoPaga((Integer) ((Object[]) objectMessage.getObject())[0]);
