 ...
 * @date 26/08/2008
 */
public class BatchIncluirDebitoACobrarEntradaParcelamentoNaoPagaMDB implements
	MessageDrivenBean,
	MessageListener{

	private static final long serialVersionUID = 1L;

	public BatchIncluirDebitoACobrarEntradaParcelamentoNaoPagaMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				incluirDebitoACobrarEntradaParcelamentoNaoPaga((Integer) ((Object[]) objectMessage.getObject())[0]);
