 ...
 * @date 22/01/2007
 */
public class BatchGerarResumoAcoesCobrancaEventualMDB
		implements
			MessageDrivenBean,
			MessageListener {
	...
	public BatchGerarResumoAcoesCobrancaEventualMDB() {
		super();
	}
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorCobranca()
						.gerarResumoAcoesCobrancaEventual((Object[])((Object[]) objectMessage.getObject())[0],
