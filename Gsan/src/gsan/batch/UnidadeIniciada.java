...
public class UnidadeIniciada implements Serializable {
	...
	/** persistent field */
	private gsan.batch.UnidadeSituacao unidadeSituacao;

	/** persistent field */
	private gsan.batch.FuncionalidadeIniciada funcionalidadeIniciada;

	private Integer codigoRealUnidadeProcessamento;

	/** full constructor */
	public UnidadeIniciada(Date dataHoraInicio, Date dataHoraTermino,
			gsan.batch.UnidadeProcessamento unidadeProcessamento,
			gsan.batch.UnidadeSituacao unidadeSituacao,
			gsan.batch.FuncionalidadeIniciada funcionalidadeIniciada) {
	...
	public gsan.batch.UnidadeSituacao getUnidadeSituacao() {
		return this.unidadeSituacao;
	}

	public void setUnidadeSituacao(gsan.batch.UnidadeSituacao unidadeSituacao) {
		this.unidadeSituacao = unidadeSituacao;
	}

	public gsan.batch.FuncionalidadeIniciada getFuncionalidadeIniciada() {
