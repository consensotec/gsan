...
public class BatchEfetuarRateioConsumoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchEfetuarRateioConsumoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorMicromedicao().efetuarRateioDeConsumo(
