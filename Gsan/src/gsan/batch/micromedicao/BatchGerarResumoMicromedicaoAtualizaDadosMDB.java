 ...
 * @date 03/02/2014
 */
public class BatchGerarResumoMicromedicaoAtualizaDadosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoMicromedicaoAtualizaDadosMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        .getControladorMicromedicaoLocal()
                        .gerarResumoMicromedicaoAtualizaDados(
	 ...
	 */
	private ControladorMicromedicaoLocal getControladorMicromedicaoLocal() {
