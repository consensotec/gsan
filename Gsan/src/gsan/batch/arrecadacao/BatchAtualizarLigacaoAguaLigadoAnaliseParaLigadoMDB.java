...
public class BatchAtualizarLigacaoAguaLigadoAnaliseParaLigadoMDB
		implements
			MessageDrivenBean,
			MessageListener {
	private static final long serialVersionUID = 1L;

	public BatchAtualizarLigacaoAguaLigadoAnaliseParaLigadoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorArrecadacao().atualizarLigacaoAguaLigadoAnaliseParaLigado(
