...
public class TarefaBatchClassificarPagamentosDevolucoes extends TarefaBatch {
	
	private static final long serialVersionUID = 1L;

	public TarefaBatchClassificarPagamentosDevolucoes(Usuario usuario,
	...
	@Deprecated
	public TarefaBatchClassificarPagamentosDevolucoes() {
		super(null, 0);
	}
    ...
    public Object executar() throws TarefaException {
        ...
        while (iterator.hasNext()) {
            ...
            enviarMensagemControladorBatch(
                    ConstantesJNDI.BATCH_CLASSIFICAR_PAGAMENTOS_DEVOLUCOES_MDB,
	...
	public void agendarTarefaBatch() {
		AgendadorTarefas.agendarTarefa("ClassificarPagamentosDevolucoesBatch",
				this);
	}
