...
public class BatchGerarDadosDiariosArrecadacaoMDB
		implements
			MessageDrivenBean,
			MessageListener {
	...
	public BatchGerarDadosDiariosArrecadacaoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorArrecadacao().gerarDadosDiariosArrecadacao(
