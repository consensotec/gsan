 ...
 * @date: 11/11/2009
 */
public class BatchInserirPagamentosFaturasEspeciaisMDB
		implements
			MessageDrivenBean,
			MessageListener {
	private static final long serialVersionUID = 1L;

	public BatchInserirPagamentosFaturasEspeciaisMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				this.getControladorArrecadacao().inserirPagamentosFaturasEspeciais(
