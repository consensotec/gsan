...
/**
 * BatchGerarResumoCobrancaAtualizaDadosMDB
 * 
 * Descrição da classe 
 *
 * @author Fábio Aguiar
 * @date 29/01/2014
 */
public class BatchResumoArrecadacaoAtualizaDadosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchResumoArrecadacaoAtualizaDadosMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .gerarResumoArrecadacaoAtualizaDados(
