...
public class BatchGerarResumoLigacoesEconomiasMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoLigacoesEconomiasMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				this.getControladorGerencialCadastro().gerarResumoLigacoesEconomias(
