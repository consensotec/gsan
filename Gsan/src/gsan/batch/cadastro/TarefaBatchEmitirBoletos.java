...
//		Date dataAtual = (Date) getParametro("dataAtual");
		...
		Integer idEntidadeBeneficente = new Integer((String) getParametro("entidadeBeneficente"));
		
		enviarMensagemControladorBatch(ConstantesJNDI.BATCH_EMITIR_BOLETOS_MDB, new Object[] {this.getIdFuncionalidadeIniciada(),idGrupo,idEntidadeBeneficente});
