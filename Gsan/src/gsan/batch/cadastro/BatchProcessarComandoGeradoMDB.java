 ...
 * @date 23/03/2011
 */
public class BatchProcessarComandoGeradoMDB implements
		MessageListener, MessageDrivenBean {

	private static final long serialVersionUID = 1L;

	public BatchProcessarComandoGeradoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
					...
					this.getControladorCadastro().processarComandoGerado(
									(Integer) ((Object[]) objectMessage.getObject())[0],
									(Integer) ((Object[]) objectMessage.getObject())[1],
									(TarifaSocialComandoCarta) ((Object[]) objectMessage.getObject())[2]
									);
