...
public class BatchRetornoSMSEmLoteMDB implements MessageDrivenBean, MessageListener{

	private static final long serialVersionUID = 1L;

	public BatchRetornoSMSEmLoteMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				this.getControladorCadastro().retornoSMSEmLote((Integer) ((Object[]) objectMessage.getObject())[0]);
