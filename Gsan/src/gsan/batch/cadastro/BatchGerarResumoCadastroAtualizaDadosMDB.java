 ...
 * 
 */
public class BatchGerarResumoCadastroAtualizaDadosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoCadastroAtualizaDadosMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        .getControladorCadastroLocal()
                        .gerarResumoCadastroAtualizaDados(
	 ...
	 */
	private ControladorCadastroLocal getControladorCadastroLocal() {
