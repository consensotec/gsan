...
/**
 * Executa o batch Gerar Taxa Percentual da Tarifa Mínima para Cortado
 * 
 * @author Raphael Rossiter
 * @created 09/07/2010
 */
public class BatchGerarTaxaPercentualTarifaMinimaCortadoMDB implements
			MessageDrivenBean, MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarTaxaPercentualTarifaMinimaCortadoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorFaturamento().gerarTaxaPercentualTarifaMinimaCortado(
