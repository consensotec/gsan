 ...
 * @date 23/08/2011
 */
public class BatchSuspenderLeituraParaImovelComHidrometroRetiradoMDB implements
			MessageDrivenBean, MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchSuspenderLeituraParaImovelComHidrometroRetiradoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorFaturamento().suspenderLeituraParaImovelComHidrometroRetirado(
