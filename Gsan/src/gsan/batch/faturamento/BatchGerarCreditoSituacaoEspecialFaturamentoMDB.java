...
/**
 * Executa o batch Gerar Crédito Situação Especial Faturamento
 * 
 * @author Raphael Rossiter
 * @created 22/01/2009
 */
public class BatchGerarCreditoSituacaoEspecialFaturamentoMDB implements
			MessageDrivenBean, MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarCreditoSituacaoEspecialFaturamentoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorFaturamento().gerarCreditoSituacaoEspecialFaturamento(
