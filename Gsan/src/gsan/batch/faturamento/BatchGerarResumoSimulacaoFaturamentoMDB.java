...
public class BatchGerarResumoSimulacaoFaturamentoMDB
		implements
			MessageDrivenBean,
			MessageListener {
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoSimulacaoFaturamentoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorFaturamento().gerarResumoSimulacaoFaturamento(
