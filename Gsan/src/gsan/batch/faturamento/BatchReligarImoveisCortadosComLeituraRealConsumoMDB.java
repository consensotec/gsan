 ...
 * 
 */
public class BatchReligarImoveisCortadosComLeituraRealConsumoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchReligarImoveisCortadosComLeituraRealConsumoMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        .getControladorFaturamentoLocal()
                        .religarImoveisCortadosLeituraRealConsumo(
	 ...
	 */
	private ControladorFaturamentoLocal getControladorFaturamentoLocal() {
