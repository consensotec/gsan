 ...
 * 
 */
public class BatchGerarResumoFaturamentoAtualizaDadosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoFaturamentoAtualizaDadosMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .gerarResumoFaturamentoAtualizaDados(
