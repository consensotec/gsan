...
/**
 * Tarefa que manda para batch Paralisar Faturamento
 * 
 * @author Raphael Rossiter
 * @created 22/12/2011
 */
public class TarefaBatchParalisarFaturamento extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchParalisarFaturamento(Usuario usuario,
	...
	@Deprecated
	public TarefaBatchParalisarFaturamento() {
		super(null, 0);
	}
	...
	public Object executar() throws TarefaException {
		...
		while (iterator.hasNext()) {
			...
			enviarMensagemControladorBatch(
					ConstantesJNDI.BATCH_PARALISAR_FATURAMENTO_MDB,
					new Object[] { 
	...
	public void agendarTarefaBatch() {
		AgendadorTarefas.agendarTarefa("ParalisarFaturamentoBatch", this);
	}
