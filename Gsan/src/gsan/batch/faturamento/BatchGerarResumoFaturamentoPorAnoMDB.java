...
public class BatchGerarResumoFaturamentoPorAnoMDB
		implements
			MessageDrivenBean,
			MessageListener {
	...
	public BatchGerarResumoFaturamentoPorAnoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialFaturamento().gerarResumoFaturamentoPorAno(
