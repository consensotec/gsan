...
/**
 * 
 * Serviço do batch de resumo do refaturamento olap 
 *
 * @author Bruno Barros
 * @date 24/11/2008
 */

public class BatchGerarResumoReFaturamentoOlapMDB
		implements
			MessageDrivenBean,
			MessageListener {
	...
	public BatchGerarResumoReFaturamentoOlapMDB() {
		super();
	}
