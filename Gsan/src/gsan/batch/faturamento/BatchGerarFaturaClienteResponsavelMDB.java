 ...
 * @date 15/03/2007
 */
public class BatchGerarFaturaClienteResponsavelMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarFaturaClienteResponsavelMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
                this.getControladorFaturamento().gerarFaturaClienteResponsavel((Integer) ((Object[]) objectMessage.getObject())[0]);
