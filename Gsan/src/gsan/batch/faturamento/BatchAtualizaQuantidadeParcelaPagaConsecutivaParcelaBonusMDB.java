 ...
 * @date 08/02/2008
 */
public class BatchAtualizaQuantidadeParcelaPagaConsecutivaParcelaBonusMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchAtualizaQuantidadeParcelaPagaConsecutivaParcelaBonusMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .atualizaQtdeParcelaPagaConsecutivaEParcelaBonus(
