...
/**
 * Executa o batch Verificar Farturamento dos Imóveis Cortados
 * 
 * @author Raphael Rossiter
 * @created 13/07/2010
 */
public class BatchVerificarFaturamentoImoveisCortadosMDB implements
			MessageDrivenBean, MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchVerificarFaturamentoImoveisCortadosMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorFaturamento().verificarFaturamentoImoveisCortados(
