...
public class BatchParalisarFaturamentoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchParalisarFaturamentoMDB() {
		super();
	}
		...
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				while(iterator.hasNext()) {
					...
					this.getControladorFaturamento().paralisarFaturamento(rota, anoMesCorrente, idGrupoFaturamento, 
