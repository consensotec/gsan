...
public class BatchRetificarContasCaernMDB
		implements
			MessageDrivenBean,
			MessageListener {
	private static final long serialVersionUID = 1L;

	public BatchRetificarContasCaernMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorFaturamento().retificarContasIndevidasCaern(
						(Imovel) ((Object[]) objectMessage.getObject())[0],
