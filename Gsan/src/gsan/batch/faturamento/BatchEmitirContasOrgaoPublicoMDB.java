...
public class BatchEmitirContasOrgaoPublicoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchEmitirContasOrgaoPublicoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				this.getControladorFaturamento().emitirContasOrgaoPublico(
					...
					(Short) ((Object[]) objectMessage.getObject())[5]);
