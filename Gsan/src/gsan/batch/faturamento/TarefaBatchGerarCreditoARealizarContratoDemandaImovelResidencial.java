 ...
 * @date 06/10/2011
 */
public class TarefaBatchGerarCreditoARealizarContratoDemandaImovelResidencial extends TarefaBatch {
	
	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarCreditoARealizarContratoDemandaImovelResidencial(Usuario usuario,
	...
	@Deprecated
	public TarefaBatchGerarCreditoARealizarContratoDemandaImovelResidencial() {
		super(null, 0);
	}
	...
	public Object executar() throws TarefaException {
		...
		while (iterator.hasNext()) {
			...
			System.out.println("ROTA GERAR CREDITO CONTRATO DEMANDA RESIDENCIAL "+ idRota);

			enviarMensagemControladorBatch(
					ConstantesJNDI.BATCH_GERAR_CREDITO_A_REALIZAR_CONTRATO_DEMANDA_RESIDENCIAL_MDB,
	...
	public void agendarTarefaBatch() {
		AgendadorTarefas.agendarTarefa("GerarCreditoARealizarContratoDemandaImovelResidencialBatch", this);
	}
