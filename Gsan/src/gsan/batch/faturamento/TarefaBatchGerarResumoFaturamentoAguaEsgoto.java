 ...
 * @date 24/04/2007
 */
public class TarefaBatchGerarResumoFaturamentoAguaEsgoto extends TarefaBatch {
	...
	public TarefaBatchGerarResumoFaturamentoAguaEsgoto(Usuario usuario,
	...
	@Deprecated
	public TarefaBatchGerarResumoFaturamentoAguaEsgoto() {
		super(null, 0);
	}
    ...
    public Object executar() throws TarefaException {
        ...
        while (iterator.hasNext()) {
            ...
            enviarMensagemControladorBatch(
                    ConstantesJNDI.BATCH_GERAR_RESUMO_FATURAMENTO_AGUA_ESGOTO_MDB,
	...
	public void agendarTarefaBatch() {
		AgendadorTarefas.agendarTarefa("GerarResumoFaturamentoAguaEsgotoBatch",
				this);
	}
