...
public class RelatorioGerado implements Serializable {
	...
	/** persistent field */
	private gsan.batch.Relatorio relatorio;
	...
	public RelatorioGerado(Date ultimaAlteracao, int numeroPaginas,
			...
			gsan.batch.Relatorio relatorio) {
	...
	public gsan.batch.Relatorio getRelatorio() {
		return this.relatorio;
	}

	public void setRelatorio(gsan.batch.Relatorio relatorio) {
		this.relatorio = relatorio;
	}
