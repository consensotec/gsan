 ...
 * @date 24/04/2007
 */
public class BatchGerarResumoInstalacoesHidrometrosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoInstalacoesHidrometrosMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this.getControladorGerencialMicromedicao()
                        .gerarResumoInstalacoesHidrometros(
