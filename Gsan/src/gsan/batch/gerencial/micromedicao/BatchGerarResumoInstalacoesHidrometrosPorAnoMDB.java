 ...
 * @date 17/06/2010
 */
public class BatchGerarResumoInstalacoesHidrometrosPorAnoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoInstalacoesHidrometrosPorAnoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this.getControladorGerencialMicromedicao()
                        .gerarResumoInstalacoesHidrometrosPorAno(
