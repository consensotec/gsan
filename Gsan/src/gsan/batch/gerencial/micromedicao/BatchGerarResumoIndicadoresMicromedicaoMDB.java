...
* 02111-1307, USA.
*/  
package gsan.batch.gerencial.micromedicao;
 ...
 * @date 07/03/2008
 */
public class BatchGerarResumoIndicadoresMicromedicaoMDB
		implements
			MessageDrivenBean,
			MessageListener {
	...
	public BatchGerarResumoIndicadoresMicromedicaoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialMicromedicao().gerarResumoIndicadoresMicromedicao((Integer) ((Object[]) objectMessage.getObject())[0]);
	...
	/**
	 * Retorna o valor de controladorGerencialMicromedicao
	 * 
	 * @return O valor de controladorGerencialMicromedicao
	 */
