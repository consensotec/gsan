...
* 02111-1307, USA.
*/  
package gsan.batch.gerencial.cadastro;
...
/**
 * [UC1057] Gerar Histograma Agua Esgoto Sem Quadra
 * @author Ivan Sergio
 * @data: 01/09/2010
 *
 */

public class BatchGerarResumoHistogramaAguaEsgotoSemQuadraMDB implements MessageDrivenBean, MessageListener {
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoHistogramaAguaEsgotoSemQuadraMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialCadastro().gerarResumoHistogramaSemQuadra(
