...
public class BatchGerarResumoParcelamentoPorAnoMDB
		implements
			MessageDrivenBean,
			MessageListener {
	...
	public BatchGerarResumoParcelamentoPorAnoMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				this
						.getControladorGerencialCadastro()
						.gerarResumoParcelamentoPorAno(
