 ...
 * @date 26/12/2011
 */
public class BatchExecutarCargaRegistroAtendimentoPorAnoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaRegistroAtendimentoPorAnoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaRegistroAtendimentoPorAno(
