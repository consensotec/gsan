 ...
 * @date 23/04/2012
 */
public class BatchExecutarCargaLeituraAnormalidadePorAnoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaLeituraAnormalidadePorAnoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaLeituraAnormalidadePorAno(
