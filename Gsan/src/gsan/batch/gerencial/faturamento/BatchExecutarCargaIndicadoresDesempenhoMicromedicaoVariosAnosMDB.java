 ...
 * @date 20/04/2012
 */
public class BatchExecutarCargaIndicadoresDesempenhoMicromedicaoVariosAnosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaIndicadoresDesempenhoMicromedicaoVariosAnosMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaIndicadoresDesempenhoMicromedicaoVariosAnos(
