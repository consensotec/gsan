 ...
 * @date 26/12/2011
 */
public class BatchExecutarCargaResumoFaturamentoPorAnoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaResumoFaturamentoPorAnoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaResumoFaturamentoPorAno(
