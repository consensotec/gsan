 ...
 * @date 20/04/2012
 */
public class BatchExecutarCargaConsumoAguaPorAnoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaConsumoAguaPorAnoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaConsumoAguaPorAno(
