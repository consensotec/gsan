 ...
 * @date 20/04/2012
 */
public class BatchExecutarCargaColetaEsgotoPorAnoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaColetaEsgotoPorAnoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaColetaEsgotoPorAno(
