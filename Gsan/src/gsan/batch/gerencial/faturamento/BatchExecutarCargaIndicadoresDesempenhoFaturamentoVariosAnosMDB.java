 ...
 * @date 20/04/2012
 */
public class BatchExecutarCargaIndicadoresDesempenhoFaturamentoVariosAnosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaIndicadoresDesempenhoFaturamentoVariosAnosMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaIndicadoresDesempenhoFaturamentoVariosAnos(
