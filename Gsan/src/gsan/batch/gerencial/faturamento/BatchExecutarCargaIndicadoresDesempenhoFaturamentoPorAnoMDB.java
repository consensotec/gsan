 ...
 * @date 20/04/2012
 */
public class BatchExecutarCargaIndicadoresDesempenhoFaturamentoPorAnoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaIndicadoresDesempenhoFaturamentoPorAnoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaIndicadoresDesempenhoFaturamentoPorAno(
