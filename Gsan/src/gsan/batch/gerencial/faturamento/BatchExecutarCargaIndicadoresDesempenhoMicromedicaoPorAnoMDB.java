 ...
 * @date 20/04/2012
 */
public class BatchExecutarCargaIndicadoresDesempenhoMicromedicaoPorAnoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaIndicadoresDesempenhoMicromedicaoPorAnoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaIndicadoresDesempenhoMicromedicaoPorAno(
