...
* 02111-1307, USA.
*/  
package gsan.batch.gerencial.cobranca;

import gsan.gerencial.cobranca.ControladorGerencialCobrancaLocal;
import gsan.gerencial.cobranca.ControladorGerencialCobrancaLocalHome;
 ...
 * @date 07/03/2008
 */
public class BatchGerarResumoIndicadoresCobrancaMDB
		implements
			MessageDrivenBean,
			MessageListener {
	...
	public BatchGerarResumoIndicadoresCobrancaMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorGerencialCobranca().gerarResumoIndicadoresCobranca((Integer) ((Object[]) objectMessage.getObject())[0]);
	 ...
	 * 
	 * @return A interface remota do controlador gerencial de cobrança
	 */
