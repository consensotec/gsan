 ...
 * @date 30/09/2010
 */
public class BatchGerarGuiaPagamentoPorClienteResumoPendenciaMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarGuiaPagamentoPorClienteResumoPendenciaMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
                this.getControladorGerencialCobranca().gerarGuiaPagamentoPorClienteResumoPendencia(
