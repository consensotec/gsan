 ...
 * @date 29/01/2007
 */
public class BatchGerarResumoPendenciaMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoPendenciaMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
                this.getControladorGerencialCobranca().gerarResumoPendencia(
