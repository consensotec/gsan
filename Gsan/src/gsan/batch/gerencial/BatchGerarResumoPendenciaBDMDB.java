...
import gsan.gerencial.ControladorGerencialLocal;
import gsan.gerencial.ControladorGerencialLocalHome;
 ...
 * @date 05/06/2012
 */
public class BatchGerarResumoPendenciaBDMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoPendenciaBDMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        .getControladorGerencial()
                        .gerarResumoPendenciaBD(
