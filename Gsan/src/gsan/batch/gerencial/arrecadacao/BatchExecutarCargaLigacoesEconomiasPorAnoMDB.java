 ...
 * @date 24/04/2012
 */
public class BatchExecutarCargaLigacoesEconomiasPorAnoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaLigacoesEconomiasPorAnoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaLigacoesEconomiasPorAno(
