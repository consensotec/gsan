 ...
 * @date 24/04/2012
 */
public class BatchExecutarCargaResumoParcelamentoPorAnoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaResumoParcelamentoPorAnoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaResumoParcelamentoPorAno(
