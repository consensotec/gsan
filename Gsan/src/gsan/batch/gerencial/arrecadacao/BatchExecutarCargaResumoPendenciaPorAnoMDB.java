 ...
 * @date 24/04/2012
 */
public class BatchExecutarCargaResumoPendenciaPorAnoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaResumoPendenciaPorAnoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaResumoPendenciaPorAno(
