...
import gsan.gerencial.arrecadacao.ControladorGerencialArrecadacaoLocal;
import gsan.gerencial.arrecadacao.ControladorGerencialArrecadacaoLocalHome;
 ...
 * @date 24/04/2012
 */
public class BatchExecutarCargaIndicadorLigacaoEconomiaPorAnoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaIndicadorLigacaoEconomiaPorAnoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaIndicadorLigacaoEconomiaPorAno(
