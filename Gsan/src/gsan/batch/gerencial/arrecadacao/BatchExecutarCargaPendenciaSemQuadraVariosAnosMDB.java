 ...
 * @date 24/04/2012
 */
public class BatchExecutarCargaPendenciaSemQuadraVariosAnosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchExecutarCargaPendenciaSemQuadraVariosAnosMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .executarCargaPendenciaSemQuadraVariosAnos(
