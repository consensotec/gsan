...
public class BatchGerarUnResumoArrecadacaoBDMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarUnResumoArrecadacaoBDMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				this.getControladorGerencialArrecadacao().gerarResumoArrecadacao(
