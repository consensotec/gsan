...
public class ProcessoIniciado implements Serializable {
	...
	/** persistent field */
	private gsan.batch.ProcessoIniciado processoIniciadoPrecedente;

	/** persistent field */
	private gsan.batch.ProcessoSituacao processoSituacao;
	...
	public ProcessoIniciado(Date dataHoraAgendamento, Date dataHoraInicio,
			...
			gsan.batch.Processo processo, Usuario usuario,
			gsan.batch.ProcessoIniciado processoIniciado,
			gsan.batch.ProcessoSituacao processoSituacao,
	...
	/** minimal constructor */
	public ProcessoIniciado(gsan.batch.Processo processo, Usuario usuario,
			gsan.batch.ProcessoIniciado processoIniciado,
			gsan.batch.ProcessoSituacao processoSituacao,
			Set funcionalidadesIniciadas) {
		this.processo = processo;
	...
	public gsan.batch.ProcessoIniciado getProcessoIniciadoPrecedente() {
	...
	public gsan.batch.ProcessoSituacao getProcessoSituacao() {
		return this.processoSituacao;
	}

	public void setProcessoSituacao(gsan.batch.ProcessoSituacao processoSituacao) {
		this.processoSituacao = processoSituacao;
	}
