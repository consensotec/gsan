 ...
 * @created 03/12/2007
 */
public class RelatorioResumoReceitaBean implements RelatorioBean {
    ...
    public RelatorioResumoReceitaBean(ResumoReceita resumo){
    	this.anoMesReferencia = resumo.getAnoMesReferencia()+"";
    	//this.arrecadador = resumo.getArrecadador().getCodigoAgente().toString();
