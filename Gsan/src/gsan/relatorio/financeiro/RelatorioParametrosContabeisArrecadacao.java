...
public class RelatorioParametrosContabeisArrecadacao extends TarefaRelatorio {
	
	private static final long serialVersionUID = 1L;
	
	public RelatorioParametrosContabeisArrecadacao(Usuario usuario) {
	...
	public Object executar() throws TarefaException {
        ...
        Collection<RelatorioParametrosContabeisArrecadacaoBean> colecaoBean = 
            fachada.pesquisarDadosRelatorioParametrosContabeisArrecadacao( referenciaContabil );            
        ...
        retorno = this.gerarRelatorio(
                ConstantesRelatorios.RELATORIO_PARAMETROS_CONTABEIS_ARRECADACAO, parametros,
                ds, tipoRelatorio);
	...
	public void agendarTarefaBatch() {
		AgendadorTarefas.agendarTarefa("RelatorioParametrosContabeisArrecadacao", this);
	}
}
