		...
		if (imoveisRelatoriosHelper != null
			...
			while (imovelRelatorioIterator.hasNext()) {
				...
				relatorioBean = new RelatorioCadastroConsumidoresInscricaoBean(
						...
						imovelRelatorioHelper.getDescricaoAbreviadaSituacaoLigacaoAgua(),

						// Situação da Ligação de Esgoto
						imovelRelatorioHelper.getDescricaoAbreviadaSituacaoLigacaoEsgoto(),

						// Tipo Pavimento Calçada
						imovelRelatorioHelper.getDescAbreviadaTipoPavimentoCalcada() == null ? "":imovelRelatorioHelper.getDescAbreviadaTipoPavimentoCalcada().trim(),

						// Tipo Pavimento Rua
						imovelRelatorioHelper.getDescAbreviadaTipoPavimentoRua() == null ? "":imovelRelatorioHelper.getDescAbreviadaTipoPavimentoRua().trim(),

						// Tipo de Despejo
						imovelRelatorioHelper.getTipoDespejo() == null ?  "" :imovelRelatorioHelper.getTipoDespejo(),
