...
public class RelatorioManterImovelBean implements RelatorioBean {
	 ...
	 *            Description of the Parameter
	 */
	public RelatorioManterImovelBean(String idGerenciaRegional,
			...
			String indicadorNivelEsgotamento) {
