 ...
 * @date 03/02/2011
 */
public class RelatorioDadosDiariosLocalidadeBean implements RelatorioBean {
	...
	private String valorLocalidadePolo;
	...
	public RelatorioDadosDiariosLocalidadeBean() {
		super();
	}

	public RelatorioDadosDiariosLocalidadeBean(String processamentoDefinitivo, String mesAno,
			String ultimoProcessamentoAtual, String faturamentoCobradoEmConta, String nomeGerencia,
			String nomeUnidadeNegocio, String nomeLocalidadePolo, String valorGerencia,
			String valorUnidadeNegocio, String valorLocalidadePolo, String localidade,
			String debitos, String descontos, String valorArrecadado, String devolucao,
			String arrecadacaoLiquida, String percentualMes) {
		super();
		...
		this.valorLocalidadePolo = valorLocalidadePolo;
	...
	public String getValorLocalidadePolo() {
		return valorLocalidadePolo;
	}

	public void setValorLocalidadePolo(String valorLocalidadePolo) {
		this.valorLocalidadePolo = valorLocalidadePolo;
	}
