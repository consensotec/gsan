 ...
 * @date 01/02/2011
 */
public class RelatorioDadosDiariosArrecadacaoGerencia extends TarefaRelatorio {
	private static final long serialVersionUID = 1L;
	
	public RelatorioDadosDiariosArrecadacaoGerencia(Usuario usuario) {
		super(usuario, ConstantesRelatorios.RELATORIO_RELATORIO_DADOS_DIARIOS_ARRECADACAO_GERENCIA);
	}
	...
	public Object executar() throws TarefaException {
		...
		Collection<RelatorioDadosDiariosArrecadacaoGerenciaBean> colecaoBean = this
		...
		retorno = this
				.gerarRelatorio(
						ConstantesRelatorios.RELATORIO_RELATORIO_DADOS_DIARIOS_ARRECADACAO_GERENCIA,
	...
	private Collection<RelatorioDadosDiariosArrecadacaoGerenciaBean> inicializarBeanRelatorio(
			Map<Integer, Collection<FiltrarDadosDiariosArrecadacaoHelper>> mapDadosDiariosAnoMes,
			Collection<BigDecimal> colecaoValorTotal, BigDecimal valorTotalPeriodo,
			Map<Integer, FiltrarDadosDiariosArrecadacaoHelper> mapDadosProcessamento){
		
		Collection<RelatorioDadosDiariosArrecadacaoGerenciaBean> colecaoBean = new ArrayList<RelatorioDadosDiariosArrecadacaoGerenciaBean>();
		...
		for (Integer itemAnoMes : mapDadosDiariosAnoMes.keySet()) {
			...
			for (FiltrarDadosDiariosArrecadacaoHelper helper : mapDadosDiariosAnoMes.get(itemAnoMes)){
				RelatorioDadosDiariosArrecadacaoGerenciaBean bean = new RelatorioDadosDiariosArrecadacaoGerenciaBean();
