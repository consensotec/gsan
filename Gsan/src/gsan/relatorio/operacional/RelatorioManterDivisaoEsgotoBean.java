...
* 02111-1307, USA.
*/  
package gsan.relatorio.operacional;
...
public class RelatorioManterDivisaoEsgotoBean implements RelatorioBean {
	...
	public RelatorioManterDivisaoEsgotoBean(String codigo,
			String descricao, String unidadeOrganizacional, String indicadorUso) {
		this.codigo = codigo;
