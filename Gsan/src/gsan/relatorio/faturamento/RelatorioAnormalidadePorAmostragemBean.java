...
public class RelatorioAnormalidadePorAmostragemBean implements RelatorioBean {
	...
	public RelatorioAnormalidadePorAmostragemBean(){
		
	}
	
	public RelatorioAnormalidadePorAmostragemBean(String grupo,
