...
public class RelatorioHistogramaAguaEconomia extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		if(indicadorSimulacao){
			parametros.put("tituloRelatorio", "ANÁLISE DE CONSUMO DE ÁGUA POR ECONOMIA COM TARIFA DE SIMULAÇÃO PARA REFERÊNCIA " 
					+ Util.formatarAnoMesParaMesAno(filtrarEmitirHistogramaAguaEconomiaHelper.getMesAnoFaturamento()));
		}else{
			parametros.put("tituloRelatorio", "ANÁLISE DE CONSUMO DE ÁGUA POR ECONOMIA PARA REFERÊNCIA " 
					+ Util.formatarAnoMesParaMesAno(filtrarEmitirHistogramaAguaEconomiaHelper.getMesAnoFaturamento()));
		}
