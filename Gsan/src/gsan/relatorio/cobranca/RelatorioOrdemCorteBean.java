...
import gsan.cobranca.bean.OrdemCorteHelper;
 ...
 * @date 08/08/2007
 */
public class RelatorioOrdemCorteBean implements RelatorioBean {
    ...
    public RelatorioOrdemCorteBean(OrdemCorteHelper ordemCorteHelper1,
    		OrdemCorteHelper ordemCorteHelper2) {
    	
    	numero1 = ordemCorteHelper1.getNumero();
    	nomeCliente1 = ordemCorteHelper1.getNomeCliente();
    	endereco1 = ordemCorteHelper1.getEndereco();
    	endereco1Linha2 = ordemCorteHelper1.getEnderecoLinha2();
    	endereco1Linha3 = ordemCorteHelper1.getEnderecoLinha3();
    	rotaGrupo1 = ordemCorteHelper1.getRotaGrupo();
    	matricula1 = ordemCorteHelper1.getMatricula();
    	inscricao1 = ordemCorteHelper1.getInscricao();
    	dataEmissao1 = ordemCorteHelper1.getDataEmissao();
    	mesAno1 = ordemCorteHelper1.getMesAno();
    	situacao1 = ordemCorteHelper1.getSituacao();
    	executor1 = ordemCorteHelper1.getExecutor();
    	dataCorte1 = ordemCorteHelper1.getDataCorte();
    	horaCorte1 = ordemCorteHelper1.getHoraCorte();
    	numeroHidrometro1 = ordemCorteHelper1.getNumeroHidrometro();
    	leituraHidrometro1 = ordemCorteHelper1.getLeituraHidrometro();
    	localizacaoHidrometro1 = ordemCorteHelper1.getLocalizacaoHidrometro();
    	dataVencimento1 = ordemCorteHelper1.getDataVencimento();
    	valor1 = ordemCorteHelper1.getValor();
    	representacaoNumericaCodBarraFormatada1 = ordemCorteHelper1.getRepresentacaoNumericaCodBarraFormatada();
    	representacaoNumericaCodBarraSemDigito1 = ordemCorteHelper1.getRepresentacaoNumericaCodBarraSemDigito();
    	categoriaPrincipal1 = ordemCorteHelper1.getCategoriaPrincipal();
    	situacaoLigacaoAgua1 = ordemCorteHelper1.getSituacaoLigacaoAgua();
    	situacaoLigacaoEsgoto1 = ordemCorteHelper1.getSituacaoLigacaoEsgoto();
		
    	numero2 = ordemCorteHelper2.getNumero();
    	nomeCliente2 = ordemCorteHelper2.getNomeCliente();
    	endereco2 = ordemCorteHelper2.getEndereco();
    	endereco2Linha2 = ordemCorteHelper2.getEnderecoLinha2();
    	endereco2Linha3 = ordemCorteHelper2.getEnderecoLinha3();
    	rotaGrupo2 = ordemCorteHelper2.getRotaGrupo();
    	matricula2 = ordemCorteHelper2.getMatricula();
    	inscricao2 = ordemCorteHelper2.getInscricao();
    	dataEmissao2 = ordemCorteHelper2.getDataEmissao();
    	mesAno2 = ordemCorteHelper2.getMesAno();
    	situacao2 = ordemCorteHelper2.getSituacao();
    	executor2 = ordemCorteHelper2.getExecutor();
    	dataCorte2 = ordemCorteHelper2.getDataCorte();
    	horaCorte2 = ordemCorteHelper2.getHoraCorte();
    	numeroHidrometro2 = ordemCorteHelper2.getNumeroHidrometro();
    	leituraHidrometro2 = ordemCorteHelper2.getLeituraHidrometro();
    	localizacaoHidrometro2 = ordemCorteHelper2.getLocalizacaoHidrometro();
    	dataVencimento2 = ordemCorteHelper2.getDataVencimento();
    	valor2 = ordemCorteHelper2.getValor();
    	representacaoNumericaCodBarraFormatada2 = ordemCorteHelper2.getRepresentacaoNumericaCodBarraFormatada();
    	representacaoNumericaCodBarraSemDigito2 = ordemCorteHelper2.getRepresentacaoNumericaCodBarraSemDigito();
    	categoriaPrincipal2 = ordemCorteHelper2.getCategoriaPrincipal();
    	situacaoLigacaoAgua2 = ordemCorteHelper2.getSituacaoLigacaoAgua();
    	situacaoLigacaoEsgoto2 = ordemCorteHelper2.getSituacaoLigacaoEsgoto();
