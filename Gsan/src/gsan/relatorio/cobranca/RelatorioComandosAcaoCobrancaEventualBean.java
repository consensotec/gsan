...
public class RelatorioComandosAcaoCobrancaEventualBean implements RelatorioBean {
	...
	// [RM 11569 UC 0325]
	private String qtdSmsGerados;
	private String qtdSmsEnviados;
	private String qtdEmailGerados;
	private String qtdEmailEnviados;
	...
	public String getQtdSmsGerados() {
		return qtdSmsGerados;
	}

	public void setQtdSmsGerados(String qtdSmsGerados) {
		this.qtdSmsGerados = qtdSmsGerados;
	}

	public String getQtdSmsEnviados() {
		return qtdSmsEnviados;
	}

	public void setQtdSmsEnviados(String qtdSmsEnviados) {
		this.qtdSmsEnviados = qtdSmsEnviados;
	}

	public String getQtdEmailGerados() {
		return qtdEmailGerados;
	}

	public void setQtdEmailGerados(String qtdEmailGerados) {
		this.qtdEmailGerados = qtdEmailGerados;
	}

	public String getQtdEmailEnviados() {
		return qtdEmailEnviados;
	}

	public void setQtdEmailEnviados(String qtdEmailEnviados) {
