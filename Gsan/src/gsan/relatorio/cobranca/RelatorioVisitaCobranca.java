 ...
 * 
 */
public class RelatorioVisitaCobranca extends TarefaRelatorio {

	private static final long serialVersionUID = 1L;
	public RelatorioVisitaCobranca(Usuario usuario) {
		super(usuario, ConstantesRelatorios.RELATORIO_VISITA_COBRANCA);
	}
...
//		 ------------------------------------
		...
		List relatorioBeans = (List) fachada.gerarRelatorioVisitaCobranca(idCobrancaAcaoCronograma,
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_VISITA_COBRANCA,
