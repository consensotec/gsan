 ...
 * 
 */
public class RelatorioBoletimMedicaoRecuperacaoCreditosParceladosSubTotalBean implements RelatorioBean,Comparable<RelatorioBoletimMedicaoRecuperacaoCreditosParceladosSubTotalBean> {	
	...
	public int compareTo(RelatorioBoletimMedicaoRecuperacaoCreditosParceladosSubTotalBean r1){
