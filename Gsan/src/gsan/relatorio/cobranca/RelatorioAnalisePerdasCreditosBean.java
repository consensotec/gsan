...
public class RelatorioAnalisePerdasCreditosBean implements RelatorioBean {
	...
	public void setPrimeiraFaixaVencidosSuperiorSeisMeses(
			String primeiraFaixaVencidosSuperiorSeisMeses) {
		this.primeiraFaixaVencidosSuperiorSeisMeses = primeiraFaixaVencidosSuperiorSeisMeses;
	}
	...
	public void setPrimeiraFaixaVencidosAteSeisMeses(
			String primeiraFaixaVencidosAteSeisMeses) {
		this.primeiraFaixaVencidosAteSeisMeses = primeiraFaixaVencidosAteSeisMeses;
	}
	public String getPrimeiraFaixaTotal() {
		return primeiraFaixaTotal;
	}
	public void setPrimeiraFaixaTotal(String primeiraFaixaTotal) {
		this.primeiraFaixaTotal = primeiraFaixaTotal;
	}
	public String getPrimeiraFaixaVencer() {
		return primeiraFaixaVencer;
	}
	public void setPrimeiraFaixaVencer(String primeiraFaixaVencer) {
		this.primeiraFaixaVencer = primeiraFaixaVencer;
	}
	...
	public void setSegundaFaixaVencidosAteDoseMeses(
			String segundaFaixaVencidosAteDoseMeses) {
		this.segundaFaixaVencidosAteDoseMeses = segundaFaixaVencidosAteDoseMeses;
	}
	...
	public void setSegundaFaixaVencidosSuperiorDoseMeses(
			String segundaFaixaVencidosSuperiorDoseMeses) {
		this.segundaFaixaVencidosSuperiorDoseMeses = segundaFaixaVencidosSuperiorDoseMeses;
	}
	public String getSegundaFaixaVencer() {
		return segundaFaixaVencer;
	}
	public void setSegundaFaixaVencer(String segundaFaixaVencer) {
		this.segundaFaixaVencer = segundaFaixaVencer;
	}
	public String getSegundaFaixaTotal() {
		return segundaFaixaTotal;
	}
	public void setSegundaFaixaTotal(String segundaFaixaTotal) {
		this.segundaFaixaTotal = segundaFaixaTotal;
	}
	...
	public void setTerceiraFaixaVencidosAteDoseMeses(
			String terceiraFaixaVencidosAteDoseMeses) {
		this.terceiraFaixaVencidosAteDoseMeses = terceiraFaixaVencidosAteDoseMeses;
	}
	...
	public void setTerceiraFaixaVencidosSuperiorDoseMeses(
			String terceiraFaixaVencidosSuperiorDoseMeses) {
		this.terceiraFaixaVencidosSuperiorDoseMeses = terceiraFaixaVencidosSuperiorDoseMeses;
	}
	public String getTerceiraFaixaVencer() {
		return terceiraFaixaVencer;
	}
	public void setTerceiraFaixaVencer(String terceiraFaixaVencer) {
		this.terceiraFaixaVencer = terceiraFaixaVencer;
	}
	public String getTerceiraFaixaTotal() {
		return terceiraFaixaTotal;
	}
	public void setTerceiraFaixaTotal(String terceiraFaixaTotal) {
		this.terceiraFaixaTotal = terceiraFaixaTotal;
	}
