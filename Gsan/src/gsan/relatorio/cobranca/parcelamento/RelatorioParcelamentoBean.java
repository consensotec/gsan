...
* 02111-1307, USA.
*/  
package gsan.relatorio.cobranca.parcelamento;
...
public class RelatorioParcelamentoBean implements RelatorioBean {
    ...
    private String valorDescontoTipoDebito;
    
    private String valorDescontoMulta;
    
    private String valorDescontoJuros;
    
    private String valorDescontoAtualizacaoMonetaria;
	...
	private String cpfCnpjClienteSuperior;

	private String telefoneClienteSuperior;
    
	private String rgClienteResponsavel;
    ...
    //------ CAERN -------
    private String mostrarValoresDescontos;
    private String valorDescontoEntrada;
	...
	public String getRgClienteResponsavel() {
		return rgClienteResponsavel;
	}

	public void setRgClienteResponsavel(String rgClienteResponsavel) {
		this.rgClienteResponsavel = rgClienteResponsavel;
	}
	...
	public RelatorioParcelamentoBean(String matriculaImovel,
            ...
            String valorDescontoTipoDebito,
            String valorDescontoMulta,
            String valorDescontoJuros,
            String valorDescontoAtualizacaoMonetaria,
            String mostrarValoresDescontos,
            String valorDescontoEntrada){
        ...
        this.mostrarValoresDescontos = mostrarValoresDescontos;
...
//        this.nomeUsuarioParcelamento = nomeUsuarioParcelamento;
	...
	public RelatorioParcelamentoBean(String matriculaImovel,
            ...
            String bairroImovelResponsavel){
		this.matriculaImovel = matriculaImovel;
		this.nomeCliente = nomeCliente;
		this.endereco = endereco;
		this.cpfCnpj = cpfCnpj;
...
//    		" - RR</style> na <style isBold=\"true\" pdfFontName=\"Helvetica-Bold\">" + this.getEndereco() + "</style>";  		
	...
	public String getValorDescontoTipoDebito() {
		return valorDescontoTipoDebito;
	}

	public void setValorDescontoTipoDebito(String valorDescontoTipoDebito) {
		this.valorDescontoTipoDebito = valorDescontoTipoDebito;
	}

	public String getValorDescontoMulta() {
		return valorDescontoMulta;
	}

	public void setValorDescontoMulta(String valorDescontoMulta) {
		this.valorDescontoMulta = valorDescontoMulta;
	}

	public String getValorDescontoJuros() {
		return valorDescontoJuros;
	}

	public void setValorDescontoJuros(String valorDescontoJuros) {
		this.valorDescontoJuros = valorDescontoJuros;
	}

	public String getValorDescontoAtualizacaoMonetaria() {
		return valorDescontoAtualizacaoMonetaria;
	}

	public void setValorDescontoAtualizacaoMonetaria(String valorDescontoAtualizacaoMonetaria) {
		this.valorDescontoAtualizacaoMonetaria = valorDescontoAtualizacaoMonetaria;
	}

	public String getMostrarValoresDescontos() {
		return mostrarValoresDescontos;
	}

	public void setMostrarValoresDescontos(String mostrarValoresDescontos) {
		this.mostrarValoresDescontos = mostrarValoresDescontos;
	}

	public String getValorDescontoEntrada() {
		return valorDescontoEntrada;
	}

	public void setValorDescontoEntrada(String valorDescontoEntrada) {
		this.valorDescontoEntrada = valorDescontoEntrada;
	}
	...
	public String getCpfCnpjClienteSuperior(){
		return cpfCnpjClienteSuperior;
	}
	
	public void setCpfCnpjClienteSuperior(String cpfCnpjClienteSuperior){
		this.cpfCnpjClienteSuperior = cpfCnpjClienteSuperior;
	}
	
	public String getTelefoneClienteSuperior(){
		return telefoneClienteSuperior;
	}
	
	public void setTelefoneClienteSuperior(String telefoneClienteSuperior){
		this.telefoneClienteSuperior = telefoneClienteSuperior;
	}
}