...
import gsan.cobranca.BoletimMedicaoJustificativaPenalidade;
...
public class RelatorioBoletimMedicaoCobrancaBean implements RelatorioBean {
	...
	private JRBeanCollectionDataSource arrayJRBoletimPenalidades;
	
	private ArrayList<RelatorioBoletimPenalidadeHelper> arrayRelatorioBoletimPenalidades;
	...
	public JRBeanCollectionDataSource getArrayJRBoletimPenalidades() {
		return arrayJRBoletimPenalidades;
	}

	public void setArrayJRBoletimPenalidades(JRBeanCollectionDataSource arrayJRBoletimPenalidades) {
		this.arrayJRBoletimPenalidades = arrayJRBoletimPenalidades;
	}

	public ArrayList<RelatorioBoletimPenalidadeHelper> getArrayRelatorioBoletimPenalidades() {
		return arrayRelatorioBoletimPenalidades;
	}

	public void setArrayRelatorioBoletimPenalidades(ArrayList<RelatorioBoletimPenalidadeHelper> arrayRelatorioBoletimPenalidades) {
		this.arrayRelatorioBoletimPenalidades = arrayRelatorioBoletimPenalidades;
		this.arrayJRBoletimPenalidades = new JRBeanCollectionDataSource(this.arrayRelatorioBoletimPenalidades);
	}	
}
