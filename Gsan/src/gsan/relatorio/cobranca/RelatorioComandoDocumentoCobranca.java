...
import gsan.cobranca.RelatorioComandoDocumentoCobrancaHelper;
...
public class RelatorioComandoDocumentoCobranca extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		if (sistemaParametro.getNomeAbreviadoEmpresa().equalsIgnoreCase(
			...
			informacao = " Considerando o não pagamento do(s) débito(s) do imóvel supracitado até a presente data, em cumprimento às disposições regulamentares vigentes, "
					+ " procedemos o desligamento da ligação de água. Em consequência, avisamos que: \n"
					+ " a) O não pagamento desta fatura até a data do vencimento, poderá ocasionar a inscrição do nome do responsável no SPC/SERASA; \n"
					+ " b) O prazo para religação é de até 5 dias úteis; \n"
					+ " c) O prazo para retirada do nome inscrito no SPC/SERASA é de, no máximo 5 dias úteis após a compensação do pagamento. ";
		}
