 ...
 * @date 27/01/2011
 */
public class RelatorioReligacaoClientesInadiplentesHelper implements Serializable {
	...
	public RelatorioReligacaoClientesInadiplentesHelper(){
		
	}
	
	// relatório - Todas as ocorrências no Período
	public RelatorioReligacaoClientesInadiplentesHelper(String matricula, String endereco, String perfil, 
			String numeroOS, String usuarioAberturaOS, String nomeUsuarioAberturaOS, 
			String dataEncerramento, String usuarioEncerramentoOS, String nomeUsuarioEncerramentoOS, 
			String valorDebito){
	...
	// relatório - Recorrências de re-ligações para o mesmo cliente inadimplente
	public RelatorioReligacaoClientesInadiplentesHelper(
