...
import gsan.relatorio.RelatorioEmitirOrdemServicoSeletivaAnaliticoSubrelatorioBean;
...
public class RelatorioEmitirOrdemServicoSeletivaAnalitico extends
	...
	public Object executar() throws TarefaException {
		...
		*/	
			...
			Iterator iterDadosImovel = colecaoIdsImoveis.iterator();
			while (iterDadosImovel.hasNext()) {
				Integer[] dadosImovel = (Integer[]) iterDadosImovel.next();
			
				Integer idImovel = dadosImovel[0];
