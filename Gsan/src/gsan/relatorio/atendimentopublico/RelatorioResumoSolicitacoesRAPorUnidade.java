...
public class RelatorioResumoSolicitacoesRAPorUnidade extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		String loginUsuario = (String) getParametro("loginUsuario");
		...
		if (loginUsuario != null) {
			...
			Collection<Usuario> pesquisa = fachada.pesquisar(filtroUsuario, Usuario.class.getName());
			if (pesquisa == null || pesquisa.isEmpty()) {
				throw new ActionServletException("atencao.pesquisa_inexistente", null, "Usuário");
			}
			
			usuario = (Usuario) Util.retonarObjetoDeColecao(pesquisa);
			parametroUsuario = usuario.getLogin();
		}
		...
		parametros.put("usuario", parametroUsuario);
		...
		if (loginUsuario != null) filtro.setIdUsusario(usuario.getId());
