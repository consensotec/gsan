 ...
 * @date 13/02/2007
 */
public class RelatorioResumoImovelMicromedicaoBean implements RelatorioBean {
	...
	/**
	 * @param LeituraCampo a ser setado.
	 */
	...
	/**
	 * @param numeroHidrometro a ser setado.
	 */
	...
	public RelatorioResumoImovelMicromedicaoBean(String mesAno, String dataLeituraInformada, String leituraInformada,
			...
			String anormalidadeLeitura, String sitLeituraAtual, String leituraCampo, String numeroHidrometro) {
		this.mesAno = mesAno;
		this.dataLeituraInformada = dataLeituraInformada;
		this.leituraInformada = leituraInformada;
		this.dataLeituraFaturada = dataLeituraFaturada;
