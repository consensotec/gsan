...
public class ValorVolumesConsumidosNaoFaturado implements Serializable {
    ...
    /** full constructor */
    public ValorVolumesConsumidosNaoFaturado(Integer id, int anoMesReferencia, int numeroSequenciaTipoLancamento, int numeroSequenciaItemTipoLancamento, BigDecimal valorItemLancamento, LancamentoItem lancamentoItem, GerenciaRegional gerenciaRegional, Localidade localidade, LancamentoTipo lancamentoTipo, UnidadeNegocio unidadeNegocio, Categoria categoria) {
        this.id = id;
