...
public class ValorConsumidoNaoFaturadoParametro implements Serializable {
    ...
    /** persistent field */
    private gsan.financeiro.ContaContabil contaContabilCredito;

    /** persistent field */
    private gsan.financeiro.ContaContabil contaContabilDebito;

    /** persistent field */
    private LancamentoItemContabil lancamentoItemContabil;

    /** full constructor */
    public ValorConsumidoNaoFaturadoParametro(Integer id, Date ultimaAlteracao, String descricaoHistoricoDebito, String descricaoHistoricoCredito, LancamentoItem lancamentoItem, LancamentoTipo lancamentoTipo, Categoria categoria, gsan.financeiro.ContaContabil contaContabilCredito, gsan.financeiro.ContaContabil contaContabilDebito, LancamentoItemContabil lancamentoItemContabil) {
        this.id = id;
    ...
    public gsan.financeiro.ContaContabil getContaContabilCredito() {
        return this.contaContabilCredito;
    }

    public void setContaContabilCredito(gsan.financeiro.ContaContabil contaContabilCredito) {
        this.contaContabilCredito = contaContabilCredito;
    }

    public gsan.financeiro.ContaContabil getContaContabilDebito() {
        return this.contaContabilDebito;
    }

    public void setContaContabilDebito(gsan.financeiro.ContaContabil contaContabilDebito) {
        this.contaContabilDebito = contaContabilDebito;
    }
