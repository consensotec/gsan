 ...
 * @date 16/11/2011
 */
public class ParametrosPerdasOrgaoPublico implements Serializable {
	...
	private Integer numeroMesesContasVencidas;

	private Date ultimaAlteracao;

	public ParametrosPerdasOrgaoPublico(){
	}
	/**
	 * @return the id
	 */
	...
	/**
	 * @return the anoMesReferenciaContabil
	 */
	 ...
	 *            the anoMesReferenciaContabil to set
	 */
	...
	/**
	 * @param indicadorEsferaMunicipal
	 *            the indicadorEsferaMunicipal to set
	 */
	...
	/**
	 * @param indicadorEsferaFederal
	 *            the indicadorEsferaFederal to set
	 */
	 ...
	 */
	public Integer getNumeroMesesContasVencidas() {
		return numeroMesesContasVencidas;
	}

	/**
	 * @param numeroMesesContasVencidas
	 *            the numeroMesesContasVencidas to set
	 */
	public void setNumeroMesesContasVencidas(Integer numeroMesesContasVencidas) {
