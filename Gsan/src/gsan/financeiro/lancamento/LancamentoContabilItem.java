...
public class LancamentoContabilItem implements Serializable {
    ...
    /** persistent field */
    private gsan.financeiro.lancamento.LancamentoContabil lancamentoContabil;
    ...
    /** full constructor */
    public LancamentoContabilItem(Short indicadorDebitoCredito, BigDecimal valorLancamento, Date ultimaAlteracao, gsan.financeiro.lancamento.LancamentoContabil lancamentoContabil, ContaContabil contaContabil) {
    ...
    /** full constructor */
    public LancamentoContabilItem(Short indicadorDebitoCredito, BigDecimal valorLancamento, String descricaoHistorico, Date ultimaAlteracao, gsan.financeiro.lancamento.LancamentoContabil lancamentoContabil, ContaContabil contaContabil) {
        this.indicadorDebitoCredito = indicadorDebitoCredito;
        this.valorLancamento = valorLancamento;
        this.ultimaAlteracao = ultimaAlteracao;
        this.lancamentoContabil = lancamentoContabil;
    ...
    /** minimal constructor */
    public LancamentoContabilItem(gsan.financeiro.lancamento.LancamentoContabil lancamentoContabil, ContaContabil contaContabil) {
        this.lancamentoContabil = lancamentoContabil;
        this.contaContabil = contaContabil;
    }
    ...
    public gsan.financeiro.lancamento.LancamentoContabil getLancamentoContabil() {
        return this.lancamentoContabil;
    }

    public void setLancamentoContabil(gsan.financeiro.lancamento.LancamentoContabil lancamentoContabil) {
        this.lancamentoContabil = lancamentoContabil;
    }
