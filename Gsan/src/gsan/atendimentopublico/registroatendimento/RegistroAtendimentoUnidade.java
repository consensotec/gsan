...
public class RegistroAtendimentoUnidade extends ObjetoTransacao implements Serializable {
	...
	public static final String DIRETORIA_DA_PRESIDENCIA = "1";
    ...
    /** persistent field */
    private gsan.atendimentopublico.registroatendimento.AtendimentoRelacaoTipo atendimentoRelacaoTipo;

    /** full constructor */
    public RegistroAtendimentoUnidade(Date ultimaAlteracao, Usuario usuario, gsan.atendimentopublico.registroatendimento.RegistroAtendimento registroAtendimento, UnidadeOrganizacional unidadeOrganizacional, gsan.atendimentopublico.registroatendimento.AtendimentoRelacaoTipo atendimentoRelacaoTipo) {
    ...
    public gsan.atendimentopublico.registroatendimento.AtendimentoRelacaoTipo getAtendimentoRelacaoTipo() {
        return this.atendimentoRelacaoTipo;
    }

    public void setAtendimentoRelacaoTipo(gsan.atendimentopublico.registroatendimento.AtendimentoRelacaoTipo atendimentoRelacaoTipo) {
        this.atendimentoRelacaoTipo = atendimentoRelacaoTipo;
    }
