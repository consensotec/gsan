...
public class EspecificacaoImovSitCriterio extends ObjetoTransacao {
    ...
    /** persistent field */
    private gsan.atendimentopublico.registroatendimento.EspecificacaoImovelSituacao especificacaoImovelSituacao;
    ...
    /** minimal constructor */
    public EspecificacaoImovSitCriterio(Date ultimaAlteracao, gsan.atendimentopublico.registroatendimento.EspecificacaoImovelSituacao especificacaoImovelSituacao, LigacaoEsgotoSituacao ligacaoEsgotoSituacao, LigacaoAguaSituacao ligacaoAguaSituacao) {
        this.ultimaAlteracao = ultimaAlteracao;
        this.especificacaoImovelSituacao = especificacaoImovelSituacao;
        this.ligacaoEsgotoSituacao = ligacaoEsgotoSituacao;
        this.ligacaoAguaSituacao = ligacaoAguaSituacao;
    ...
    public gsan.atendimentopublico.registroatendimento.EspecificacaoImovelSituacao getEspecificacaoImovelSituacao() {
        return this.especificacaoImovelSituacao;
    }

    public void setEspecificacaoImovelSituacao(gsan.atendimentopublico.registroatendimento.EspecificacaoImovelSituacao especificacaoImovelSituacao) {
        this.especificacaoImovelSituacao = especificacaoImovelSituacao;
    }
