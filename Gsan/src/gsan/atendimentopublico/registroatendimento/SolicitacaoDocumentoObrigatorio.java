...
public class SolicitacaoDocumentoObrigatorio implements Serializable {
	...
	/** identifier field */
    private gsan.atendimentopublico.registroatendimento.SolicitacaoDocumentoObrigatorioPK comp_id;
    ...
    /** full constructor */
    public SolicitacaoDocumentoObrigatorio(gsan.atendimentopublico.registroatendimento.SolicitacaoDocumentoObrigatorioPK comp_id, Date ultimaAlteracao, gsan.atendimentopublico.registroatendimento.SolicitacaoTipoEspecificacao solicitacaoTipoEspecificacao, MeioSolicitacao meioSolicitacao) {
    ...
    /** minimal constructor */
    public SolicitacaoDocumentoObrigatorio(gsan.atendimentopublico.registroatendimento.SolicitacaoDocumentoObrigatorioPK comp_id, Date ultimaAlteracao) {
        this.comp_id = comp_id;
        this.ultimaAlteracao = ultimaAlteracao;
    }

	public gsan.atendimentopublico.registroatendimento.SolicitacaoDocumentoObrigatorioPK getComp_id() {
		return this.comp_id ;
	}

	public void setComp_id(
			gsan.atendimentopublico.registroatendimento.SolicitacaoDocumentoObrigatorioPK comp_id) {
		this.comp_id = comp_id;
	}
