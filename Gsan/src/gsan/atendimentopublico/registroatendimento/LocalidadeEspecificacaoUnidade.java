...
public class LocalidadeEspecificacaoUnidade implements Serializable {
	...
	/** identifier field */
    private gsan.atendimentopublico.registroatendimento.LocalidadeEspecificacaoUnidadePK comp_id;
    ...
    /** full constructor */
    public LocalidadeEspecificacaoUnidade(gsan.atendimentopublico.registroatendimento.LocalidadeEspecificacaoUnidadePK comp_id, 
    ...
    /** minimal constructor */
    public LocalidadeEspecificacaoUnidade(gsan.atendimentopublico.registroatendimento.LocalidadeEspecificacaoUnidadePK comp_id, Date ultimaAlteracao) {
        this.comp_id = comp_id;
        this.ultimaAlteracao = ultimaAlteracao;
    }

	public gsan.atendimentopublico.registroatendimento.LocalidadeEspecificacaoUnidadePK getComp_id() {
		return comp_id;
	}

	public void setComp_id(
			gsan.atendimentopublico.registroatendimento.LocalidadeEspecificacaoUnidadePK comp_id) {
		this.comp_id = comp_id;
	}
