...
public class RaDadosAgenciaReguladora extends ObjetoTransacao {
    ...
    /** persistent field */
    private gsan.atendimentopublico.registroatendimento.AgenciaReguladoraMotRetorno agenciaReguladoraMotRetorno;

    /** persistent field */
    private gsan.atendimentopublico.registroatendimento.RegistroAtendimento registroAtendimento;

    /** persistent field */
    private gsan.atendimentopublico.registroatendimento.AgenciaReguladoraMotReclamacao agenciaReguladoraMotReclamacao;

    /** full constructor */
    public RaDadosAgenciaReguladora(String agenciaReguladora, short codigoSituacao, short codigoSituacaoArpe, Date dataPrevisaoOriginal, Date dataPrevisaoAtual, Date dataReclamacao, String descricaoReclamacao, Date dataRetorno, String descricaoRetorno, String contato, String emailContato, String orgaoContato, Short dddContato, String foneContato, String ramalContato, String faxContato, Date ultimaAlteracao, gsan.atendimentopublico.registroatendimento.AtendimentoMotivoEncerramento atendimentoMotivoEncerramento, gsan.atendimentopublico.registroatendimento.AgenciaReguladoraMotRetorno agenciaReguladoraMotRetorno, gsan.atendimentopublico.registroatendimento.RegistroAtendimento registroAtendimento, gsan.atendimentopublico.registroatendimento.AgenciaReguladoraMotReclamacao agenciaReguladoraMotReclamacao) {
    ...
    /** minimal constructor */
    public RaDadosAgenciaReguladora(short codigoSituacao, short codigoSituacaoArpe, Date dataPrevisaoOriginal, Date dataPrevisaoAtual, Date dataReclamacao, Date ultimaAlteracao, gsan.atendimentopublico.registroatendimento.AtendimentoMotivoEncerramento atendimentoMotivoEncerramento, gsan.atendimentopublico.registroatendimento.AgenciaReguladoraMotRetorno agenciaReguladoraMotRetorno, gsan.atendimentopublico.registroatendimento.RegistroAtendimento registroAtendimento, gsan.atendimentopublico.registroatendimento.AgenciaReguladoraMotReclamacao agenciaReguladoraMotReclamacao) {
        this.codigoSituacao = codigoSituacao;
        this.codigoSituacaoArpe = codigoSituacaoArpe;
        this.dataPrevisaoOriginal = dataPrevisaoOriginal;
        this.dataPrevisaoAtual = dataPrevisaoAtual;
    ...
    public void setAtendimentoMotivoEncerramento(gsan.atendimentopublico.registroatendimento.AtendimentoMotivoEncerramento atendimentoMotivoEncerramento) {
        this.atendimentoMotivoEncerramento = atendimentoMotivoEncerramento;
    }

    public gsan.atendimentopublico.registroatendimento.AgenciaReguladoraMotRetorno getAgenciaReguladoraMotRetorno() {
        return this.agenciaReguladoraMotRetorno;
    }

    public void setAgenciaReguladoraMotRetorno(gsan.atendimentopublico.registroatendimento.AgenciaReguladoraMotRetorno agenciaReguladoraMotRetorno) {
        this.agenciaReguladoraMotRetorno = agenciaReguladoraMotRetorno;
    }
    ...
    public void setRegistroAtendimento(gsan.atendimentopublico.registroatendimento.RegistroAtendimento registroAtendimento) {
        this.registroAtendimento = registroAtendimento;
    }

    public gsan.atendimentopublico.registroatendimento.AgenciaReguladoraMotReclamacao getAgenciaReguladoraMotReclamacao() {
        return this.agenciaReguladoraMotReclamacao;
    }

    public void setAgenciaReguladoraMotReclamacao(gsan.atendimentopublico.registroatendimento.AgenciaReguladoraMotReclamacao agenciaReguladoraMotReclamacao) {
        this.agenciaReguladoraMotReclamacao = agenciaReguladoraMotReclamacao;
    }
