...
import gsan.util.tabelaauxiliar.TabelaAuxiliar;

import java.util.Date;

public class LigacaoEsgotoEsgotamento extends ObjetoTransacao{
	...
	public Filtro retornaFiltro() {
		FiltroLigacaoEsgotoEsgotamento filtro = new FiltroLigacaoEsgotoEsgotamento();
		filtro.adicionarParametro(new ParametroSimples(FiltroLigacaoEsgotoEsgotamento.ID, this.getId()));		
		return filtro;
	}
