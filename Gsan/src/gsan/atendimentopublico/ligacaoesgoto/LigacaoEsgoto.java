...
* 02111-1307, USA.
*/  
package gsan.atendimentopublico.ligacaoesgoto;
...
public class LigacaoEsgoto extends ObjetoTransacao implements Serializable {
	...
	@ControleAlteracao(value=FiltroLigacaoEsgoto.LIGACAO_ESGOTO_DIAMETRO,
			funcionalidade={ATRIBUTOS_EFETUAR_LIGACAO_ESGOTO, ATRIBUTOS_EFETUAR_LIGACAO_ESGOTO_SEM_RA,ATRIBUTOS_ATUALIZAR_LIGACAO_ESGOTO,
			                Imovel.ATRIBUTOS_IMOVEL_ATUALIZAR})	
	private gsan.atendimentopublico.ligacaoesgoto.LigacaoEsgotoDiametro ligacaoEsgotoDiametro;

	/** persistent field */
	@ControleAlteracao(value=FiltroLigacaoEsgoto.LIGACAO_ESGOTO_MATERIAL,
			funcionalidade={ATRIBUTOS_EFETUAR_LIGACAO_ESGOTO, ATRIBUTOS_EFETUAR_LIGACAO_ESGOTO_SEM_RA,ATRIBUTOS_ATUALIZAR_LIGACAO_ESGOTO,
			                Imovel.ATRIBUTOS_IMOVEL_ATUALIZAR})
	private gsan.atendimentopublico.ligacaoesgoto.LigacaoEsgotoMaterial ligacaoEsgotoMaterial;
	...
	public LigacaoEsgoto(
			...
			gsan.atendimentopublico.ligacaoesgoto.LigacaoEsgotoDiametro ligacaoEsgotoDiametro,
			gsan.atendimentopublico.ligacaoesgoto.LigacaoEsgotoMaterial ligacaoEsgotoMaterial) {
	...
	public gsan.atendimentopublico.ligacaoesgoto.LigacaoEsgotoDiametro getLigacaoEsgotoDiametro() {
	...
	public gsan.atendimentopublico.ligacaoesgoto.LigacaoEsgotoMaterial getLigacaoEsgotoMaterial() {
