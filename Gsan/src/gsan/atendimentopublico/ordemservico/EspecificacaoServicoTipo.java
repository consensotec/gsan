...
public class EspecificacaoServicoTipo implements Serializable {
    ...
    /** identifier field */
    private gsan.atendimentopublico.ordemservico.EspecificacaoServicoTipoPK comp_id;
    ...
    /** full constructor */
    public EspecificacaoServicoTipo(gsan.atendimentopublico.ordemservico.EspecificacaoServicoTipoPK comp_id, Date ultimaAlteracao, Short ordemExecucao, SolicitacaoTipoEspecificacao solicitacaoTipoEspecificacao, gsan.atendimentopublico.ordemservico.ServicoTipo servicoTipo) {
    ...
    /** minimal constructor */
    public EspecificacaoServicoTipo(gsan.atendimentopublico.ordemservico.EspecificacaoServicoTipoPK comp_id, Date ultimaAlteracao) {
        this.comp_id = comp_id;
        this.ultimaAlteracao = ultimaAlteracao;
    }

    public gsan.atendimentopublico.ordemservico.EspecificacaoServicoTipoPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.atendimentopublico.ordemservico.EspecificacaoServicoTipoPK comp_id) {
        this.comp_id = comp_id;
    }
