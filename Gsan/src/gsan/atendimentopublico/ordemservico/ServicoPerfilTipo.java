...
public class ServicoPerfilTipo extends ObjetoTransacao {
    ...
    /** persistent field */
    private gsan.atendimentopublico.ordemservico.EquipamentosEspeciais equipamentosEspeciais;

    /** full constructor */
    public ServicoPerfilTipo(String descricao, String descricaoAbreviada, Short componentesEquipe, short indicadorVeiculoProprio, short indicadorUso, Date ultimaAlteracao, gsan.atendimentopublico.ordemservico.EquipamentosEspeciais equipamentosEspeciais) {
    ...
    /** minimal constructor */
    public ServicoPerfilTipo(short indicadorVeiculoProprio, short indicadorUso, Date ultimaAlteracao, gsan.atendimentopublico.ordemservico.EquipamentosEspeciais equipamentosEspeciais) {
        this.indicadorVeiculoProprio = indicadorVeiculoProprio;
        this.indicadorUso = indicadorUso;
        this.ultimaAlteracao = ultimaAlteracao;
        this.equipamentosEspeciais = equipamentosEspeciais;
    ...
    public gsan.atendimentopublico.ordemservico.EquipamentosEspeciais getEquipamentosEspeciais() {
        return this.equipamentosEspeciais;
    }

    public void setEquipamentosEspeciais(gsan.atendimentopublico.ordemservico.EquipamentosEspeciais equipamentosEspeciais) {
        this.equipamentosEspeciais = equipamentosEspeciais;
    }
