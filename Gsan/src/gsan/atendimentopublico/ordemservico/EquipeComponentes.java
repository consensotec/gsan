...
public class EquipeComponentes extends ObjetoTransacao {
    ...
    /** full constructor */
    public EquipeComponentes(short indicadorResponsavel, String componentes, Date ultimaAlteracao, gsan.atendimentopublico.ordemservico.Equipe equipe, Funcionario funcionario) {
    ...
    /** minimal constructor */
    public EquipeComponentes(short indicadorResponsavel, Date ultimaAlteracao, gsan.atendimentopublico.ordemservico.Equipe equipe, Funcionario funcionario) {
        this.indicadorResponsavel = indicadorResponsavel;
        this.ultimaAlteracao = ultimaAlteracao;
        this.equipe = equipe;
        this.funcionario = funcionario;
