	...
	public OrdemServico recuperaOSPorId(Integer idOS)
		...
		try {
			...
			consulta = "SELECT os.id, " // 0
					...
					+ "ste.indicadorPoco, "//226
					+ "ste.indicadorLigacaoEsgoto, "//227
			...
			if (retornoConsulta != null) {
				...
				if (retornoConsulta[1] != null) {
					...
					solicitacaoTipoEspecificacao.setIndicadorPoco((Short) retornoConsulta[226]);
					solicitacaoTipoEspecificacao.setIndicadorLigacaoEsgoto((Short) retornoConsulta[227]);
					...
					if (retornoConsulta[4] != null) {
						...
						if (retornoConsulta[52] != null) {
							...
							if (retornoConsulta[57] != null) {
								...
								imovHidrometro.setIndicadorFinalidade((Short) retornoConsulta[229]);
						...
						if (retornoConsulta[11] != null) {
							...
							if (retornoConsulta[19] != null) {
								...
								if (retornoConsulta[30] != null) {
									...
									hidrometro.setIndicadorFinalidade((Short) retornoConsulta[228]);
									HidrometroSituacao hidrometroSituacao = new HidrometroSituacao();
				...
				if (retornoConsulta[104] != null){
					...
					if (retornoConsulta[149] != null) {
						...
						if (retornoConsulta[154] != null) {
							...
							imovHidrometro.setIndicadorFinalidade((Short) retornoConsulta[231]);
					...
					if (retornoConsulta[113] != null) {
						...
						if (retornoConsulta[121] != null) {
							...
							if (retornoConsulta[132] != null) {
								...
								hidrometro.setIndicadorFinalidade((Short) retornoConsulta[230]);
...
*/
	...
	public void atualizarParmsOS(Integer numeroOS,
		...
		try {
			...
			atualizarOS = "update gsan.atendimentopublico.ordemservico.OrdemServico "
			...
			atualizarOS = atualizarOS + " ,orse_dsparecerencerramento = :parecer";
			...
			session.createQuery(atualizarOS).setInteger("idOrdemServico",
					...
					.setString("parecer", parecerEncerramento)
...
//					+ "AND svtp.indicadorUso = 1 "
	...
	public void atualizarOrdemServicoRelatorio(Collection colecaoIdsOrdemServico)
		...
		try {
			...
			String atualizarOrdemServico = "update gsan.atendimentopublico.ordemservico.OrdemServico "
...
//			}
	...
	public void atualizarColecaoOS(Collection colecaoIdsOS)
		...
		try {
			...
			String consulta = "update  gsan.atendimentopublico.ordemservico.OrdemServico "
...
//				"from ";
			...
			if (helper.getCategoria() != null || helper.getSubCategoria() != null) {
				hql += "	gsan.cadastro.imovel.ImovelSubcategoria imovelSubcategoria " +
				...
				hql += "	gsan.cadastro.imovel.Imovel imovel ";
			}
...
//				"	and replace(substring(os.dataEmissao, 1, 10), '-', '') >= :dataVencimento " +
	...
	public Collection pesquisarOrdemServicoGerarRelatorioAcompanhamentoHidrometro(
		...
		try {
			String hql = 
				...
				"	motivo.id " +
				"from " +
				"	gsan.atendimentopublico.ordemservico.OrdemServico os " +
	...
	public void alterarOrdemServicoVencida(OrdemServico ordemServico) throws ErroRepositorioException {
		...
		try {
			String sql = 
				"update " +
				"	gsan.atendimentopublico.ordemservico.OrdemServico " +
				"set " +
				"	amen_id = :idMotivoEncerramento, " +
	...
	public Collection pesquisarOrdemServicoConcluida(Integer idOrdemServico) throws ErroRepositorioException {
		...
		try {
			String hql = 
				...
				"from " +
				"	gsan.atendimentopublico.ordemservico.BoletimOsConcluida boletim " +
    ...
    public void atualizarBoletimOSConcluida(
        ...
        try {
            ...
            String sql = 
            	"UPDATE " +
            	"	gsan.atendimentopublico.ordemservico.BoletimOsConcluida " +
            	"SET " +
    ...
    public void excluirDatasFiscalizacaoBoletimOSConcluida(Integer idOrdemServico)
        ...
        try {
            ...
            String sql = 
            	"DELETE FROM gsan.atendimentopublico.ordemservico.DataFiscalizacaoOsSeletiva " +
            	"WHERE orse_id = :idOrdemServico";
	...
	public Collection pesquisarResumoOrdensServicoConcluidas(
		...
		try {
			String hql =
				...
				"from " +
				"	gsan.atendimentopublico.ordemservico.BoletimOsConcluida bo " +
...
//         "having Count(imovel.imov_id) between "+qtdAnormalidades +" and 10";
	...
	public void atualizarIndicadorDebitoOS(Integer indicadorDebito,
		...
		try {
			...
			atualizarOS = "update gsan.atendimentopublico.ordemservico.OrdemServicoFiscSit "
    ...
    public void excluirSituacaoFiscalizacaoPorOS(Integer idOrdemServico)
        ...
        try {
            ...
            String sql = 
            	"DELETE FROM gsan.atendimentopublico.ordemservico.OrdemServicoFiscSit "+
            	"WHERE orse_id = :idOrdemServico";
    ...
    public void excluirCobrancaDocumentoFiscPorOS(Integer idOrdemServico)
        ...
        try {
            ...
            String sql = 
            	"DELETE FROM gsan.cobranca.CobrancaDocumentoFisc "+
            	"WHERE orse_id = :idOrdemServico";
...
//			AtendimentoMotivoEncerramento.CONCLUSAO_SERVICO)
	...
	public void atualizarDataEncerramentoComando(Integer idComando) throws ErroRepositorioException {
		...
		try {
			consulta = "update gsan.atendimentopublico.ordemservico.ComandoOrdemSeletiva "
        ...
        try {
        	...
        	if(colecaoIdsOrdemServico != null && !colecaoIdsOrdemServico.isEmpty()){
				...
				if(idsProgramacao != null && !idsProgramacao.isEmpty()){
		            String sql = 
		            	"DELETE FROM gsan.atendimentopublico.ordemservico.OrdemServicoProgramacao "+
				...
				if(idsProgramacao != null && !idsProgramacao.isEmpty()){
		            String sql = 
		            	"DELETE FROM gsan.atendimentopublico.ordemservico.ProgramacaoRoteiro "+
	...
	public void atualizarListaArquivoTextoOSVisita(
		...
		while(iterator.hasNext()){
		 ...
		 try{
			sql = " update gsan.atendimentopublico.ordemservico.ArquivoTextoVisitaCampo set" +
				  " sitl_id = :idSituacao," +
...
>>>>>>> .merge-right.r3464
	...
	public void atualizarSituacaoArquivoTextoAcompanhamentoServico( long imei, short situacao ) throws ErroRepositorioException{
		...
		try {
			...
			atualizarOS = 
					"update " +
					"	gsan.atendimentopublico.ordemservico.ArquivoTextoAcompanhamentoServico " +
					"set " +
					"   sitl_id = :situacao " +
					"where " +
	...
	public void atualizarSituacaoProgramacaoOrdemServico( int numeroOS, short situacao ) throws ErroRepositorioException{
		...
		try {
			...
			atualizarOS = 
					"update " +
					"	gsan.atendimentopublico.ordemservico.OSProgramacaoAcompanhamentoServico " +
					"set " +
					"   osst_id = :situacao " +
					"where " +
	...
	public void atualizarCodigoSituacaoOS(Integer numeroOS, short situacao) throws ErroRepositorioException {
		...
		try {
			consulta = "update gsan.atendimentopublico.ordemservico.OrdemServico "
	...
	public Collection<Object[]> pesquisarDadosRelatorioOSSituacaoCobrancaAnalitico(FiltrarRelatorioOSSituacaoHelper helper, boolean boletimGerado)
		...
		try{
			...
			String where = montarWherePadraoRelatorioOSSituacao(helper);
			where += montarWhereSituacaoOSCobrancaRelatorioOSSituacao(helper, boletimGerado);
	...
	private String montarWherePadraoRelatorioOSSituacao(FiltrarRelatorioOSSituacaoHelper helper) {
		...
		if (helper.getMotivoEncerramento() != null) {
			sql += " AND os.amen_id IN (:idsMotivoEncerramento) ";
		}
		
		if (helper.getRetornoFiscalizacao() != null){
			sql += " AND os.fzst_id IN (:idsRetornoFiscalizacao) ";
		}
	...
	public FiscalizacaoSituacao pesquisaFiscalizacaoSituacao(Integer idFiscalizacaoSituacao) throws ErroRepositorioException {
		...
		try {
			consulta = "select fzst " 
					+ " from FiscalizacaoSituacao fzst"
					+ " inner join fetch fzst.cobrancaSituacao"
					+ " where fzst.id = :idFiscalizacaoSituacao";
	...
	public void atualizarDataCorteFiscalizarParametroCalculoDebito(Integer idOS) throws ErroRepositorioException {
		...
		try {
			...
			//pesquisa o id da programacao 
			String consulta = "select dbac_id id from faturamento.debito_a_cobrar where orse_id = :idOS ";

			Collection idsDebitoACobrar = session.createSQLQuery(consulta)
					.addScalar("id", Hibernate.INTEGER)
					.setInteger("idOS",	idOS).list();
			...
			if(idsDebitoACobrar != null && !idsDebitoACobrar.isEmpty()){
				...
				String sql = "Update FiscalizarParametroCalculoDebito "
						+ " set fpcd_dtcorte = null "
						+ " where dbac_id in (:idsDebitoACobrar)";

				session.createQuery(sql).setParameterList("idsDebitoACobrar", idsDebitoACobrar).executeUpdate();
			}
