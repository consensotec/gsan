...
/**
 * Action responsável pelo cancelamento da inserção de um grupo de usuários,
 * e por remover da sessão tosdos os objetos inseridos.  
 *
 * @author Pedro Alexandre
 * @date 14/06/2006
 */
public class CancelarInserirGrupoAction extends GcomAction {
