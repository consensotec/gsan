...
import gsan.cadastro.ContaBraileHelper;
		...
		if ( httpServletRequest.getParameter("confirmar") == null || 
			...
			if ( form.getCpfCnpjCliente() != null && !form.getCpfCnpjCliente().equals("")){
				...
				if ( form.isIndicadorCpf() ){
					...
					//É um CPF
					boolean valido = gsan.util.Util.validacaoCPF(form.getCpfCnpjCliente());
					...
					boolean valido = gsan.util.Util.validacaoCNPJ(form.getCpfCnpjCliente());
			...
			if ( form.getCpfSolicitante() != null && !form.getCpfSolicitante().equals("")){
				...
				//É um CPF
				boolean valido = gsan.util.Util.validacaoCPF(form.getCpfSolicitante());
