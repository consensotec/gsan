 ...
 * Silveira Rômulo Aurélio de Melo Souza Filho Rosana Carvalho Barbosa Sávio
 * Luiz de Andrade Cavalcante Tai Mu Shih Thiago Augusto Souza do Nascimento
 * Tiago Moreno Rodrigues Vivianne Barbosa Sousa Este programa é software livre;
 * você pode redistribuí-lo e/ou modificá-lo sob os termos de Licença Pública
 * Geral GNU, conforme publicada pela Free Software Foundation; versão 2 da
 * Licença. Este programa é distribuído na expectativa de ser útil, mas SEM
 ...
 * Geral GNU para obter mais detalhes. Você deve ter recebido uma cópia da
 * Licença Pública Geral GNU junto com este programa; se não, escreva para Free
 ...
 * @date 29/09/2008
 */
public class InserirUnidadeNegocioActionForm extends ValidatorActionForm {
