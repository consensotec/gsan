 ...
 * @date 16/02/2009
 * @alteracao 16/02/2009 - CRC1178 - Adicionado o Indicador de Incremento do
 *            Lote
 * @alteracao 30/09/2009 - Adicionado o Indicador de Bloqueio para Alteração de
 *            Imóveis
 */
public class AtualizarQuadraActionForm extends ActionForm {
	...
	/**
	 * @param indicadorIncrementoLote
	 *            O indicadorIncrementoLote a ser setado.
	 */
