...
public class EmitirBoletosAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        if(form.getEntidadeBeneficente() == null 
        		|| form.getEntidadeBeneficente().equals("")
        		|| form.getEntidadeBeneficente().equals("" + ConstantesSistema.NUMERO_NAO_INFORMADO)){
        	
        	throw new ActionServletException("atencao.campo.informado", null, "Entidade Beneficente");
        }
        
        String idGrupoFaturamento  = form.getGrupoFaturamento();
        parametros.put("idGrupoFaturamento",idGrupoFaturamento);
        
        String idEntidadeBeneficente  = form.getEntidadeBeneficente();
        parametros.put("idEntidadeBeneficente",idEntidadeBeneficente);
