...
public class AtualizarMunicipioAction extends GcomAction{
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		montarPaginaSucesso(httpServletRequest, "Município "+ atualizarMunicipioActionForm.getNomeMunicipio() +" atualizado com sucesso.", "Realizar outra Manutenção de Município",
