...
public class ManterImovelActionForm extends ValidatorForm {
	...
	private String indicadorImovelExcluido;
	/**
	...
	/**
	 * @return the indicadorImovelExcluido
	 */
	public String getIndicadorImovelExcluido() {
		return indicadorImovelExcluido;
	}
	/**
	 * @param indicadorImovelExcluido the indicadorImovelExcluido to set
	 */
	public void setIndicadorImovelExcluido(String indicadorImovelExcluido) {
