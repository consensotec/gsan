...
import gsan.cadastro.endereco.FiltroLogradouroImportanciaBairro;
 ...
 * @date 28/06/2006
 */
public class FiltrarLogradouroBairroAction extends GcomAction {
	/**
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping
				.findForward("retornarFiltroLogradouroBairro");
