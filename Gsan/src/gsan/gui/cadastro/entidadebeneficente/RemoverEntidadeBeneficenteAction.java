package gsan.gui.cadastro.entidadebeneficente;
...
public class RemoverEntidadeBeneficenteAction extends GcomAction{

	/**
	 * Este caso de uso permite remover uma ou mais Entidade(s) Beneficente
	 * 
	 * [UC0916][SB0002] Remover Entidade Beneficente
	 * 
	 * 
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		fachada.remover(idsRegistrosRemocao, EntidadeBeneficente.class.getName(),
				null, null);

		
		// Encaminha para página de sucesso.
		montarPaginaSucesso(httpServletRequest, idsRegistrosRemocao.length
				+ " Entidade(s) Beneficente excluída(s) com sucesso.",
