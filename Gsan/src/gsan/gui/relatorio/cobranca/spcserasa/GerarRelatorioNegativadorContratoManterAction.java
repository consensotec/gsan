...
import gsan.gui.cobranca.spcserasa.FiltrarContratoNegativadorActionForm;
import gsan.relatorio.ExibidorProcessamentoTarefaRelatorio;
import gsan.relatorio.RelatorioVazioException;
import gsan.relatorio.cobranca.spcserasa.RelatorioManterNegativadorContrato;
 ...
 */
public class GerarRelatorioNegativadorContratoManterAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		FiltrarContratoNegativadorActionForm form = (FiltrarContratoNegativadorActionForm) actionForm;

		Fachada fachada = Fachada.getInstancia();

		FiltroNegativadorContrato filtro = (FiltroNegativadorContrato) sessao.getAttribute("filtroNegativadorContrato");

		// Inicio da parte que vai mandar os parametros para o relatório

		NegativadorContrato parametros = new NegativadorContrato();
		...
		// Fim da parte que vai mandar os parametros para o relatório
			...
			RelatorioManterNegativadorContrato relatorioManterNegativadorContrato = new RelatorioManterNegativadorContrato(
					(Usuario)(httpServletRequest.getSession(false)).getAttribute("usuarioLogado"));

			relatorioManterNegativadorContrato.addParametro("filtroNegativadorContrato", filtro);
			relatorioManterNegativadorContrato.addParametro("negativadorContratoParametros",parametros);
			...
			relatorioManterNegativadorContrato.addParametro("tipoFormatoRelatorio", Integer
					.parseInt(tipoRelatorio));
			try {
				retorno = processarExibicaoRelatorio(relatorioManterNegativadorContrato,
