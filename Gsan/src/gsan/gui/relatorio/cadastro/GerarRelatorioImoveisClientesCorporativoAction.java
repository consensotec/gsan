...
import gsan.relatorio.cadastro.RelatorioImoveisClientesCorporativo;
...
public class GerarRelatorioImoveisClientesCorporativoAction extends ExibidorProcessamentoTarefaRelatorio {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		Collection<Imovel> colecaoImoveis = (Collection<Imovel>) httpServletRequest.getSession(false).getAttribute("colecaoImoveisCorporativos");
		
		String tipoRelatorio = TarefaRelatorio.TIPO_PDF + "";
		
		relatorio.addParametro("colecaoImoveisCorporativos", colecaoImoveis);
