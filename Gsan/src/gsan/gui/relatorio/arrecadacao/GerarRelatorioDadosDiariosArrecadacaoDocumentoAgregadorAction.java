...
import gsan.relatorio.arrecadacao.RelatorioDadosDiariosArrecadacaoDocumentoAgregador;
 ...
 * @date 02/02/2011
 */
public class GerarRelatorioDadosDiariosArrecadacaoDocumentoAgregadorAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		RelatorioDadosDiariosArrecadacaoDocumentoAgregador relatorioDadosDiariosArrecadacaoDocumentoAgregador = new RelatorioDadosDiariosArrecadacaoDocumentoAgregador(
				(Usuario)(httpServletRequest.getSession(false)).getAttribute("usuarioLogado"));
		relatorioDadosDiariosArrecadacaoDocumentoAgregador.addParametro(
				"tipoFormatoRelatorio", Integer.parseInt(tipoRelatorio));
		relatorioDadosDiariosArrecadacaoDocumentoAgregador.addParametro("mapDadosDiariosAnoMes", 
				mapDadosDiariosAnoMes);
		relatorioDadosDiariosArrecadacaoDocumentoAgregador.addParametro("mapDadosProcessamento", 
				mapDadosProcessamento);
		relatorioDadosDiariosArrecadacaoDocumentoAgregador.addParametro("colecaoValorTotal", 
				colecaoValorTotal);
		relatorioDadosDiariosArrecadacaoDocumentoAgregador.addParametro("valorTotalPeriodo", 
				valorTotalPeriodo);
		relatorioDadosDiariosArrecadacaoDocumentoAgregador.addParametro("arrecadador",
				arrecadador);
		
		retorno = processarExibicaoRelatorio(
				relatorioDadosDiariosArrecadacaoDocumentoAgregador, tipoRelatorio,
