...
public class GerarRelatorioMultasAutosInfracaoPendentesActionForm extends ActionForm {
	...
	private String periodoAtuacaoInicial;
	private String periodoAtuacaoFinal;
	...
	public String getPeriodoAtuacaoInicial() {
		return periodoAtuacaoInicial;
	}

	public void setPeriodoAtuacaoInicial(String periodoAtuacaoInicial) {
		this.periodoAtuacaoInicial = periodoAtuacaoInicial;
	}

	public String getPeriodoAtuacaoFinal() {
		return periodoAtuacaoFinal;
	}

	public void setPeriodoAtuacaoFinal(String periodoAtuacaoFinal) {
		this.periodoAtuacaoFinal = periodoAtuacaoFinal;
	}
