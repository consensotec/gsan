...
import gsan.relatorio.faturamento.RelatorioFaturasAgrupadas;
...
public class GerarRelatorioFaturasAgrupadasAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		relatorioFaturasAgrupadas.addParametro("tipoFormatoRelatorio", 	Integer.parseInt(tipoRelatorio));
		
		httpServletRequest.setAttribute("telaSucessoRelatorio",true);
		httpServletRequest.setAttribute("labelVoltar", "Gerar outro Relatório de Faturas Agrupadas");
		httpServletRequest.setAttribute("caminhoVoltar", "exibirGerarRelatorioFaturasAgrupadasAction.do?menu=sim");
