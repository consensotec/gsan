 ...
 * 
 * @see gsan.gui.relatorio.atendimentopublico.GerarRelatorioGestaoSolicitacoesRAPorChefiaAction
 * @see gsan.gui.relatorio.atendimentopublico.ExibirGerarRelatorioGestaoSolicitacoesRAPorChefiaAction
 * @see gsan.relatorio.atendimentopublico.RelatorioGestaoSolicitacoesRAPorChefia
 * 
 * @author Victor Cisneiros
 * @date 20/06/2008
 */
public class GerarRelatorioGestaoSolicitacoesRAPorChefiaActionForm extends ValidatorForm {
