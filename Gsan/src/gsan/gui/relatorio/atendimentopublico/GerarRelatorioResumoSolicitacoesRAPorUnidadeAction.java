...
import gsan.relatorio.atendimentopublico.RelatorioResumoSolicitacoesRAPorUnidade;
 ...
 * @see gsan.gui.relatorio.atendimentopublico.ExibirGerarRelatorioResumoSolicitacoesRAPorUnidadeAction
...
public class GerarRelatorioResumoSolicitacoesRAPorUnidadeAction extends ExibidorProcessamentoTarefaRelatorio {
	...
	public ActionForward execute(
		...
		if (form.getLoginUsuario() != null && !form.getLoginUsuario().trim().equals("")) {
			loginUsuario = form.getLoginUsuario();
		}
		...
		relatorio.addParametro("loginUsuario", loginUsuario);
