...
/**
 * [UC00722] Gerar Relatório para Orçamento e SINP
 * 
 * @author Rafael Pinto
 *
 * @date 21/11/2007
 */
public class EmissaoRelatorioOrcamentoSinpAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping.findForward("emitirOrcamentoSinpInformar");
	 ...
	 * @date 23/11/2007
	 */
	private void pesquisarLocalidade(EmissaoRelatorioOrcamentoSinpActionForm form) {
	 ...
	 * @date 25/02/2008
	 */
	private void pesquisarMunicipio(EmissaoRelatorioOrcamentoSinpActionForm form) {
