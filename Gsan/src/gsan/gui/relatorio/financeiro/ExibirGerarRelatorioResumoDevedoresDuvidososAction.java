...
public class ExibirGerarRelatorioResumoDevedoresDuvidososAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		FiltroPerdasTipo filtroPerdas = new FiltroPerdasTipo();
		filtroPerdas.adicionarParametro(new ParametroSimples(FiltroPerdasTipo.INDICADORUSO, ConstantesSistema.SIM));
		
		Collection<PerdasTipo> perdasTipo = fachada.pesquisar(filtroPerdas, PerdasTipo.class.getName());
		
		httpServletRequest.setAttribute("colecaoTipoPerda", perdasTipo);
