...
public class ManutencaoRegistroActionForm extends ActionForm {
    ...
    private String mensagemObservacaoExclusao;
	...
	public String getMensagemObservacaoExclusao() {
		return mensagemObservacaoExclusao;
	}

	public void setMensagemObservacaoExclusao(String mensagemObservacaoExclusao) {
		this.mensagemObservacaoExclusao = mensagemObservacaoExclusao;
	}
