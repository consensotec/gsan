 ...
 */
public class InserirSubCategoriaConsumoTarifaActionForm extends ValidatorActionForm {
	...
	/**
	 * @return Retorna o campo slcSubCategoria.
	 */
	public String getSlcSubCategoria() {
		return slcSubCategoria;
	}
	/**
	 * @param slcSubCategoria O slcSubCategoria a ser setado.
	 */
