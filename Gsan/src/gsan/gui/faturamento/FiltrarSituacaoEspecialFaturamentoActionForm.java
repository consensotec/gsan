...
public class FiltrarSituacaoEspecialFaturamentoActionForm extends ValidatorForm {
	...
	/**
	 * @param indicadorAtualizar the indicadorAtualizar to set
	 */
