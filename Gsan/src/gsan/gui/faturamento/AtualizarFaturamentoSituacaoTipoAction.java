...
public class AtualizarFaturamentoSituacaoTipoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		String indicadorParalisaFatEsgoto = atualizarFaturamentoSituacaoTipoActionForm.getIndicadorParalisaFatEsgoto();
		String indicadorParalisaFatAgua = atualizarFaturamentoSituacaoTipoActionForm.getIndicadorParalisaFatAgua();    
        ...
        faturamentoSituacaoTipo.setIndicadorParalisaFatEsgoto(new Short(indicadorParalisaFatEsgoto));
        
        //Indicador Paralisa Faturamento Água
        faturamentoSituacaoTipo.setIndicadorParalisaFatAgua(new Short(indicadorParalisaFatAgua));
