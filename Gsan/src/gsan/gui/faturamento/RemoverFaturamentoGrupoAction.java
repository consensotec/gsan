...
public class RemoverFaturamentoGrupoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        fachada.remover(ids, FaturamentoGrupo.class.getName(),
				null, null);
        
        if (retorno.getName().equalsIgnoreCase("telaSucesso")) {
            montarPaginaSucesso(httpServletRequest,
            		ids.length + " Grupo(s) de Faturamento removido(s) com sucesso.",
