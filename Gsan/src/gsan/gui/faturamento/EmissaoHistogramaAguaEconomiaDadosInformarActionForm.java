...
public class EmissaoHistogramaAguaEconomiaDadosInformarActionForm extends ValidatorActionForm {
	...
	private String indicadorTarifaSimulacao;
	...
	public String getIndicadorTarifaSimulacao() {
		return indicadorTarifaSimulacao;
	}

	public void setIndicadorTarifaSimulacao(String indicadorTarifaSimulacao) {
		this.indicadorTarifaSimulacao = indicadorTarifaSimulacao;
	}
