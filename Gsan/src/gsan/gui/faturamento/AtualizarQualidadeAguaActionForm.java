...
public class AtualizarQualidadeAguaActionForm extends ValidatorActionForm {
	...
	public QualidadeAgua setDadosQualidadeAgua(QualidadeAgua qualidadeAgua) {
		...
		// Quantidade Dureza Analisada
		qualidadeAgua.setQuantidadeDurezaAnalisada(null);
		...
		// Quantidade Dureza Conforme
		qualidadeAgua.setQuantidadeDurezaConforme(null);
		...
		// Quantidade Dureza Exigida
		qualidadeAgua.setQuantidadeDurezaExigida(null);
		...
		qualidadeAgua.setQuantidadePhAnalisada(null);
		...
		qualidadeAgua.setQuantidadePhConforme(null);
		...
		qualidadeAgua.setQuantidadePhExigida(null);
		if(getQuantidadePhExigidas() != null 
		...
		//Dureza Total
		qualidadeAgua.setIndiceDurezaTotal(null);
		if(getDurezaTotal() != null 
				&& !getDurezaTotal().equals("")){
			qualidadeAgua.setIndiceDurezaTotal(
				new Integer(getDurezaTotal()));
		}
