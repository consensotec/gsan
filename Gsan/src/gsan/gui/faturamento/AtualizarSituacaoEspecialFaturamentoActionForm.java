...
public class AtualizarSituacaoEspecialFaturamentoActionForm extends ActionForm {
	private static final long serialVersionUID = 1L;

	private String idFaturamentoSituacaoComando;
	...
	private String categoria1ID;
	private String categoria2ID;
	private String categoria3ID;
	private String categoria4ID;
	...
	/**
	 * @return the categoria1ID
	 */
	public String getCategoria1ID() {
		return categoria1ID;
	}

	/**
	 * @param categoria1ID the categoria1ID to set
	 */
	public void setCategoria1ID(String categoria1ID) {
		this.categoria1ID = categoria1ID;
	}

	/**
	 * @return the categoria2ID
	 */
	public String getCategoria2ID() {
		return categoria2ID;
	}

	/**
	 * @param categoria2ID the categoria2ID to set
	 */
	public void setCategoria2ID(String categoria2ID) {
		this.categoria2ID = categoria2ID;
	}

	/**
	 * @return the categoria3ID
	 */
	public String getCategoria3ID() {
		return categoria3ID;
	}

	/**
	 * @param categoria3ID the categoria3ID to set
	 */
	public void setCategoria3ID(String categoria3ID) {
		this.categoria3ID = categoria3ID;
	}

	/**
	 * @return the categoria4ID
	 */
	public String getCategoria4ID() {
		return categoria4ID;
	}

	/**
	 * @param categoria4ID the categoria4ID to set
	 */
	public void setCategoria4ID(String categoria4ID) {
		this.categoria4ID = categoria4ID;
	}
	...
	/**
	 * @return the idFaturamentoSituacaoComando
	 */
	public String getIdFaturamentoSituacaoComando() {
		return idFaturamentoSituacaoComando;
	}

	/**
	 * @param idFaturamentoSituacaoComando the idFaturamentoSituacaoComando to set
	 */
	public void setIdFaturamentoSituacaoComando(String idFaturamentoSituacaoComando) {
		this.idFaturamentoSituacaoComando = idFaturamentoSituacaoComando;
	}
}
