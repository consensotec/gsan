...
import gsan.gui.relatorio.faturamento.RelatorioAnaliticoFaturamentoActionForm;
import gsan.relatorio.ExibidorProcessamentoTarefaRelatorio;
import gsan.relatorio.RelatorioVazioException;
import gsan.relatorio.faturamento.RelatorioAnaliticoFaturamento;
...
// 						"colecaoAnaliticoFaturamento", colecaoAnaliticoFaturamento);
 				...
 				relatorioAnaliticoFaturamento.addParametro("idGrupoFaturamento",
 						idFaturamentoGrupo + "");
 				relatorioAnaliticoFaturamento.addParametro("indicadorLocalidadeInformatizada",
 						form.getIndicadorLocalidadeInformatizada() + "");
 				relatorioAnaliticoFaturamento.addParametro("colecaoLocalidades",
 						sessao.getAttribute("colecaoLocalidades"));
 				relatorioAnaliticoFaturamento.addParametro("colecaoSetor",
 						sessao.getAttribute("colecaoSetor"));
 				relatorioAnaliticoFaturamento.addParametro("colecaoQuadras",
 						sessao.getAttribute("colecaoQuadras"));
