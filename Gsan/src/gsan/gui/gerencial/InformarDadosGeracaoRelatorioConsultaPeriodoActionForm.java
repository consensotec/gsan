 ...
 * os dados para geração de relatório/consulta. Alteração realizada para consulta pode ser
 * realizada por um determinado período no ano. 
 *
 * @author Raphael Rossiter, Davi Menezes
 * @date 17/05/2006, 30/09/2011
 * 
 * 
 */
public class InformarDadosGeracaoRelatorioConsultaPeriodoActionForm extends ActionForm {
	private static final long serialVersionUID = 1L;
	private String mesAnoInicialFaturamento;
	private String mesAnoFinalFaturamento;
	...
	public String getMesAnoInicialFaturamento() {
		return mesAnoInicialFaturamento;
	}
	public void setMesAnoInicialFaturamento(String mesAnoInicialFaturamento) {
		this.mesAnoInicialFaturamento = mesAnoInicialFaturamento;
	}
	public String getMesAnoFinalFaturamento() {
		return mesAnoFinalFaturamento;
	}
	public void setMesAnoFinalFaturamento(String mesAnoFinalFaturamento) {
		this.mesAnoFinalFaturamento = mesAnoFinalFaturamento;
	}
