 ...
 * 
 */
public class ExibirConsultarResumoAcaoCobrancaEventualSituacaoPagoPopupAction extends
		GcomAction {
	/**
	 * < <Descrição do método>>
	 * 
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping
				.findForward("consultarResumoAcaoEventualCobrancaSituacaoPagoPopup");
		...
		InformarDadosGeracaoResumoAcaoConsultaEventualHelper informarDadosGeracaoResumoAcaoConsultaEventualHelper = (InformarDadosGeracaoResumoAcaoConsultaEventualHelper) sessao
				.getAttribute("informarDadosGeracaoResumoAcaoConsultaEventualHelper");
