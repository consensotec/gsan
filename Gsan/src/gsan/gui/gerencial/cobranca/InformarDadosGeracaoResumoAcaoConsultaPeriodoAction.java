 ...
 * @date 22/05/2007
 */
public class InformarDadosGeracaoResumoAcaoConsultaPeriodoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		StatusWizard statusWizard = new StatusWizard(
				"consultarResumoAcaoCobrancaPeriodoWizardAction",
				"exibirInformarDadosGeracaoResumoAcaoConsultaPeriodoAction",
				"cancelarConsultarResumoAcaoCobrancaPeriodoAction",
				"exibirInformarDadosGeracaoResumoAcaoConsultaPeriodoAction",
				"informarDadosGeracaoResumoAcaoConsultaPeriodoAction.do");

		statusWizard
				.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(
						1, "ParametrosPrimeiraAbaA.gif",
						"ParametrosPrimeiraAbaD.gif",
						"exibirDadosGeracaoConsultaPeriodoAction", ""));
		//Haverá mudança aqui
		statusWizard
				.inserirNumeroPaginaCaminho(statusWizard.new StatusWizardItem(
						2, "ResumoUltimaAbaA.gif", "ResumoUltimaAbaD.gif",
						"exibirConsultarResumoAcaoCobrancaPeriodoAction", ""));

		// manda o statusWizard para a sessão
		sessao.setAttribute("statusWizard", statusWizard);

		InformarDadosGeracaoResumoAcaoConsultaPeriodoActionForm informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm = (InformarDadosGeracaoResumoAcaoConsultaPeriodoActionForm) actionForm;

		String mesAnoInicialFaturamento = informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm.getMesAnoInicialFaturamento();
		String mesAnoFinalFaturamento = informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm.getMesAnoFinalFaturamento();

		Integer idEloPolo = null;
		if (informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm.getEloPolo() != null
				&& !informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
						.getEloPolo().equals("")) {
		...
		if (informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm.getLocalidade() != null
				&& !informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
		...
		if (informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
		...
		if (informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm.getQuadra() != null
				&& !informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
						.getQuadra().equals("")) {
		...
		String[] cobrancaGrupo = informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
				.getGrupoCobranca();
		String[] gerenciaRegional = informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
		.getGerencialRegional();
		
		String[] unidadeNegocio = informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
		.getUnidadeNegocio();

		String[] imovelPerfil = informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
				.getPerfilImovel();
		String[] ligacaoAguaSituacao = informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
				.getSituacaoLigacaoAgua();
		String[] ligacaoEsgotoSituacao = informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
				.getSituacaoLigacaoEsgoto();
		String[] categoria = informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
				.getCategoria();
		String[] esferaPoder = informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
				.getEsferaPoder();
		String[] empresa = informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm
				.getEmpresa();
		 ...
		 * 3 - AMBOS
		 */
		String tipoImpressao = informarDadosGeracaoResumoAcaoConsultaPeriodoActionForm.getTipoImpressao();

		// [UC0304] Informar Dados para Geração de Relatório ou Consulta
		InformarDadosGeracaoResumoAcaoConsultaPeriodoHelper informarDadosGeracaoResumoAcaoConsultaHelper = fachada
				.informarDadosGeracaoResumoAcaoConsultaPeriodo(mesAnoInicialFaturamento, mesAnoFinalFaturamento,
		...
		if (gerenciaRegional != null) {
			...
			Collection<GerenciaRegional> colecaoGerenciaRegionalPesquisa = fachada.pesquisar(
		...
		if (unidadeNegocio != null) {
			...
			Collection<UnidadeNegocio> colecaoUnidadeNegocioPesquisa = fachada.pesquisar(
		...
		if (cobrancaGrupo != null) {
			...
			Collection<CobrancaGrupo> colecaoCobrancaGrupoPesquisa = fachada.pesquisar(
		...
		if (ligacaoEsgotoSituacao != null) {
			...
			Collection<LigacaoEsgotoSituacao> colecaoLigacaoEsgotoSituacaoPesquisa = fachada
		...
		if (empresa != null) {
			...
			Collection<Empresa> colecaoEmpresaPesquisa = fachada.pesquisar(
