 ...
 * @author Ana Maria
 */
public class CancelarConsultarResumoAcaoCobrancaPeriodoAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
		...
		sessao.removeAttribute("colecaoAgrupamento");
		sessao.removeAttribute("mesAnoInicialReferencia");
		sessao.removeAttribute("mesAnoFinalReferencia");
		sessao.removeAttribute("colecaoResumoAcaoCobranca");
