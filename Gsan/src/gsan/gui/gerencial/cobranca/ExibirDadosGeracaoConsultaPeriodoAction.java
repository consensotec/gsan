 ...
 * 
 */
public class ExibirDadosGeracaoConsultaPeriodoAction extends GcomAction {
	/**
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		InformarDadosGeracaoResumoAcaoConsultaPeriodoActionForm form = (InformarDadosGeracaoResumoAcaoConsultaPeriodoActionForm) actionForm;
		...
		InformarDadosGeracaoResumoAcaoConsultaPeriodoHelper helper = new InformarDadosGeracaoResumoAcaoConsultaPeriodoHelper();
		helper.setAnoMesInicialReferencia(Util.formatarMesAnoComBarraParaAnoMes(form.getMesAnoInicialFaturamento()));
		helper.setAnoMesFinalReferencia(Util.formatarMesAnoComBarraParaAnoMes(form.getMesAnoFinalFaturamento()));
		...
		InformarDadosGeracaoResumoAcaoConsultaPeriodoHelper informarDadosGeracaoResumoAcaoConsultaHelper = 
			(InformarDadosGeracaoResumoAcaoConsultaPeriodoHelper) fachada
			.informarDadosGeracaoResumoAcaoConsultaPeriodo(form.getMesAnoInicialFaturamento(), form.getMesAnoFinalFaturamento(),
		...
		Collection colecaoResumoAcaoCobranca = fachada.consultarResumoCobrancaAcaoPeriodo(informarDadosGeracaoResumoAcaoConsultaHelper);
		
		sessao.setAttribute("colecaoResumoAcaoCobranca", colecaoResumoAcaoCobranca);

		//Collection colecaoAgrupamento = fachada.criarColecaoAgrupamentoResumosCobrancaAcao(informarDadosGeracaoResumoAcaoHelper);
		
		//sessao.setAttribute("colecaoAgrupamento", colecaoAgrupamento);
		sessao.setAttribute("mesAnoInicialReferencia", Util.formatarAnoMesParaMesAno(informarDadosGeracaoResumoAcaoConsultaHelper.getAnoMesInicialReferencia()));
		sessao.setAttribute("mesAnoFinalReferencia", Util.formatarAnoMesParaMesAno(informarDadosGeracaoResumoAcaoConsultaHelper.getAnoMesFinalReferencia()));
	...
	private void adicionarTextoParametrosParaHintStatusWizard(StatusWizard statusWizard, 
			InformarDadosGeracaoResumoAcaoConsultaPeriodoHelper helper){
		StringBuffer texto = new StringBuffer();
		
		texto.append("<B>Parâmetros:</B>");
		texto.append("<BR>Mês/Ano Inicial de Referência: <I>" + Util.formatarAnoMesParaMesAno(helper.getAnoMesInicialReferencia()) + "</I>");
		texto.append("<BR>Mês/Ano Final de Referência: <I>" + Util.formatarAnoMesParaMesAno(helper.getAnoMesFinalReferencia()) + "</I>");
