 ...
 * @date 22/05/2007
 */
public class ExibirInformarDadosGeracaoResumoAcaoConsultaPeriodoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        InformarDadosGeracaoResumoAcaoConsultaPeriodoActionForm informarDadosGeracaoResumoAcaoConsultaActionForm = 
        (InformarDadosGeracaoResumoAcaoConsultaPeriodoActionForm) actionForm;
        ...
        if (pesquisarSetorComercial != null && !pesquisarSetorComercial.equals("") && 
	        ...
	        if (limparForm != null && !limparForm.equals("")){
	        	...
	        	informarDadosGeracaoResumoAcaoConsultaActionForm.setMesAnoInicialFaturamento("");
	        	informarDadosGeracaoResumoAcaoConsultaActionForm.setMesAnoFinalFaturamento("");
