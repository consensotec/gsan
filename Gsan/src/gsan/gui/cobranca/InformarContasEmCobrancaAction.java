...
import gsan.cobranca.CmdEmpresaCobrancaContaLigacaoAguaSituacao;
import gsan.cobranca.CmdEmpresaCobrancaContaLigacaoAguaSituacaoPK;
import gsan.cobranca.CobrancaSituacao;
import gsan.cobranca.ComandoEmpresaCobrancaConta;
import gsan.cobranca.ComandoEmpresaCobrancaContaGerencia;
import gsan.cobranca.ComandoEmpresaCobrancaContaGerenciaPK;
import gsan.cobranca.ComandoEmpresaCobrancaContaImovelPerfil;
import gsan.cobranca.ComandoEmpresaCobrancaContaImovelPerfilPK;
import gsan.cobranca.ComandoEmpresaCobrancaContaSetorComercial;
import gsan.cobranca.ComandoEmpresaCobrancaContaSetorComercialPK;
import gsan.cobranca.ComandoEmpresaCobrancaContaUnidadeNegocio;
import gsan.cobranca.ComandoEmpresaCobrancaContaUnidadeNegocioPK;
...
public class InformarContasEmCobrancaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		// Cria um comando de empresa de cobrança da conta setando os valores informados pelo
		...
		if (valorMinimo != null && !valorMinimo.trim().equals("")) {
			...
			//[FS0018]Verificar valor final do débito menor que valor inicial
		...
		montarPaginaSucesso(httpServletRequest, "Comando de cobrança de conta informado com sucesso. ",
