 ...
 * @since 24/01/2006
 */
public class ManterComandoAcaoCobrancaDetalhesActionForm  extends ActionForm {
	private static final long serialVersionUID = 1L;
	private String descricaoAcaoCobranca;
	
	private String gerenciaRegional;
	
	private String idCobrancaAcaoAtividadeComandoHidden;
	...
	private FormFile relacaoImoveis;
	
	private String nomeArquivoRelacaoImoveis;
	
	private String[] listaIdsImoveisArquivo;
	
	private String periodoFinalContaHidden;
	
	private String periodoFinalFiscalizacaoHidden;
	
	private String periodoVencimentoContaFinalHidden;
	...
	/**
	 * @param localidadeOrigemID The localidadeOrigemID to set.
	 */
	...
	/**
	 * @param inscricaoTipo The inscricaoTipo to set.
	 */
	...
	/**
	 * @param nomeLocalidadeOrigem The nomeLocalidadeOrigem to set.
	 */
	...
	/**
	 * @param localidadeDestinoID The localidadeDestinoID to set.
	 */
	...
	/**
	 * @param nomeLocalidadeDestino The nomeLocalidadeDestino to set.
	 */
	...
	/**
	 * @param setorComercialOrigemCD The setorComercialOrigemCD to set.
	 */
	...
	/**
	 * @param setorComercialOrigemID The setorComercialOrigemID to set.
	 */
	...
	/**
	 * @param nomeSetorComercialOrigem The nomeSetorComercialOrigem to set.
	 */
	...
	/**
	 * @param nomeSetorComercialDestino The nomeSetorComercialDestino to set.
	 */
	...
	/**
	 * @param setorComercialDestinoCD The setorComercialDestinoCD to set.
	 */
	...
	/**
	 * @param setorComercialDestinoID The setorComercialDestinoID to set.
	 */
	...
	/**
	 * @param clienteRelacaoTipo The clienteRelacaoTipo to set.
	 */
	...
	/**
	 * @param periodoFinalConta The periodoFinalConta to set.
	 */
	...
	/**
	 * @param periodoInicialConta The periodoInicialConta to set.
	 */
	...
	/**
	 * @param periodoVencimentoContaFinal The periodoVencimentoContaFinal to set.
	 */
	...
	/**
	 * @param periodoVencimentoContaInicial The periodoVencimentoContaInicial to set.
	 */
	...
	/**
	 * @param cobrancaAcao The cobrancaAcao to set.
	 */
	...
	/**
	 * @param cobrancaAtividade The cobrancaAtividade to set.
	 */
	...
	/**
	 * @param cobrancaGrupo The cobrancaGrupo to set.
	 */
	...
	/**
	 * @param cobrancaAtividadeIndicadorExecucao O cobrancaAtividadeIndicadorExecucao a ser setado.
	 */
	...
	/**
	 * @param descricaoAcaoCobranca O descricaoAcaoCobranca a ser setado.
	 */
	...
	public FormFile getRelacaoImoveis() {
		return relacaoImoveis;
	}
	...
	public void setRelacaoImoveis(FormFile relacaoImoveis) {
		this.relacaoImoveis = relacaoImoveis;
	}
	...
	public String[] getListaIdsImoveisArquivo() {
		return listaIdsImoveisArquivo;
	}

	public void setListaIdsImoveisArquivo(String[] listaIdsImoveisArquivo) {
		this.listaIdsImoveisArquivo = listaIdsImoveisArquivo;
	}


	public String getPeriodoFinalContaHidden() {
		return periodoFinalContaHidden;
	}

	public String getPeriodoFinalFiscalizacaoHidden() {
		return periodoFinalFiscalizacaoHidden;
	}

	public String getPeriodoVencimentoContaFinalHidden() {
		return periodoVencimentoContaFinalHidden;
	}

	public void setPeriodoFinalContaHidden(String periodoFinalContaHidden) {
		this.periodoFinalContaHidden = periodoFinalContaHidden;
	}

	public void setPeriodoFinalFiscalizacaoHidden(
			String periodoFinalFiscalizacaoHidden) {
		this.periodoFinalFiscalizacaoHidden = periodoFinalFiscalizacaoHidden;
	}

	public void setPeriodoVencimentoContaFinalHidden(
			String periodoVencimentoContaFinalHidden) {
		this.periodoVencimentoContaFinalHidden = periodoVencimentoContaFinalHidden;
	}
	

	public String getIdCobrancaAcaoAtividadeComandoHidden() {
		return idCobrancaAcaoAtividadeComandoHidden;
	}

	public void setIdCobrancaAcaoAtividadeComandoHidden(
			String idCobrancaAcaoAtividadeComandoHidden) {
		this.idCobrancaAcaoAtividadeComandoHidden = idCobrancaAcaoAtividadeComandoHidden;
	}
}
