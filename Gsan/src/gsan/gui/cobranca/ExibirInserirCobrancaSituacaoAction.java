...
public class ExibirInserirCobrancaSituacaoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        if (httpServletRequest.getParameter("menu") != null && httpServletRequest.getParameter("menu").equals("sim")) {
        	...
        	inserirCobrancaSituacaoActionForm.setIndicadorAlterarVencimentoConta(ConstantesSistema.NAO);
        }
        
        if(inserirCobrancaSituacaoActionForm.getIndicadorBloqueioCertidaoDebNegativado() == null){
        	inserirCobrancaSituacaoActionForm.setIndicadorBloqueioCertidaoDebNegativado("2");
        }
