...
import gsan.cobranca.parcelamento.FiltroParcelamentoMotivoDesfazer;
...
public class ExibirCancelarContratoParcelamentoClienteAction extends GcomAction {
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (sessao.getAttribute("fecharPopupCancelarContrato") != null
			...
			Integer idContrato = new Integer(httpServletRequest
					.getParameter("idContrato"));
