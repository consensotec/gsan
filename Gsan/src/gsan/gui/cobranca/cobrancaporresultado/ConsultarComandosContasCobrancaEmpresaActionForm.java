...
public class ConsultarComandosContasCobrancaEmpresaActionForm  extends ActionForm {
	...
	private String intervaloValorDebitoInicial;
	
	private String intervaloValorDebitoFinal;
	...
	private String localidadeComponent;
	
	private String nomeLocalidadeComponent;

	private String periodoCicloInicialPopup;

	private String periodoCicloFinalPopup;
	...
	public String getIntervaloValorDebitoInicial() {
		return intervaloValorDebitoInicial;
	}


	public void setIntervaloValorDebitoInicial(String intervaloValorDebitoInicial) {
		this.intervaloValorDebitoInicial = intervaloValorDebitoInicial;
	}


	public String getIntervaloValorDebitoFinal() {
		return intervaloValorDebitoFinal;
	}


	public void setIntervaloValorDebitoFinal(String intervaloValorDebitoFinal) {
		this.intervaloValorDebitoFinal = intervaloValorDebitoFinal;
	}
	...
	public String getLocalidadeComponent() {
		return localidadeComponent;
	}
	

	public void setLocalidadeComponent(String localidadeComponent) {
		this.localidadeComponent = localidadeComponent;
	}


	public String getNomeLocalidadeComponent() {
		return nomeLocalidadeComponent;
	}


	public void setNomeLocalidadeComponent(String nomeLocalidadeComponent) {
		this.nomeLocalidadeComponent = nomeLocalidadeComponent;
	}


	public String getPeriodoCicloInicialPopup() {
		return periodoCicloInicialPopup;
	}


	public void setPeriodoCicloInicialPopup(String periodoCicloInicialPopup) {
		this.periodoCicloInicialPopup = periodoCicloInicialPopup;
	}


	public String getPeriodoCicloFinalPopup() {
		return periodoCicloFinalPopup;
	}


	public void setPeriodoCicloFinalPopup(String periodoCicloFinalPopup) {
		this.periodoCicloFinalPopup = periodoCicloFinalPopup;
	}
