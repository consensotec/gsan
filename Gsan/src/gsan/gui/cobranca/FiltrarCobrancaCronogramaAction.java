...
public class FiltrarCobrancaCronogramaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (idCobrancaGrupo != null && !idCobrancaGrupo.equals("-1") && !idCobrancaGrupo.equals("")) {
	
			filtroCobrancaGrupoCronogramaMes.adicionarParametro(new ParametroSimples(
				FiltroCobrancaGrupoCronogramaMes.ID_COBRANCA_GRUPO, new Integer(idCobrancaGrupo)));
		}
		...
		filtroCobrancaGrupoCronogramaMes.setCampoOrderBy(FiltroCobrancaGrupoCronogramaMes.ANO_MES_REFERENCIA);
		filtroCobrancaGrupoCronogramaMes.setOrdenarDecrescente(true);
		filtroCobrancaGrupoCronogramaMes.adicionarCaminhoParaCarregamentoEntidade(FiltroCobrancaGrupoCronogramaMes.COBRANCA_GRUPO);

		sessao.setAttribute("filtroCobrancaAcaoAtividade", filtroCobrancaGrupoCronogramaMes);
