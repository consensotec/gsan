 ...
 * 
 */
public class GerarRelatorioDividaAtivaParceladaAction extends ExibidorProcessamentoTarefaRelatorio {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		Collection<DadosParcelamentoDividaAtivaHelper> colecaoDadosParcelamentoDividaAtivaHelper = fachada.obterDadosParcelamentosDividaAtiva(periodoInscricaoInicial,
																																			periodoInscricaoFinal, 
																																			periodoAtualizacaoInicial, 
																																			periodoAtualizacaoFinal, 
																																			idImovel, indicadorIntra);
		
		RelatorioDividaAtivaParcelada relatorioDividaAtivaParcelada = new RelatorioDividaAtivaParcelada((Usuario) httpServletRequest.getSession().getAttribute("usuarioLogado"));
		
		relatorioDividaAtivaParcelada.addParametro("colecaoDadosParcelamentoDividaAtivaHelper", colecaoDadosParcelamentoDividaAtivaHelper);
		relatorioDividaAtivaParcelada.addParametro("tipoformatoRelatorio", Integer.parseInt(tipoRelatorio));
		relatorioDividaAtivaParcelada.addParametro("intra", indicadorIntra);
		
		try{
		
			retorno = processarExibicaoRelatorio(relatorioDividaAtivaParcelada, tipoRelatorio, httpServletRequest, httpServletResponse, actionMapping);
