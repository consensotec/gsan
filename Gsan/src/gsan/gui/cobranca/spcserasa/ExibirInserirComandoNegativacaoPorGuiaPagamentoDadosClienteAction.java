 ...
 * @date 17/03/2015
 */
public class ExibirInserirComandoNegativacaoPorGuiaPagamentoDadosClienteAction extends GcomAction {
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm,
			HttpServletRequest request, HttpServletResponse response) {
        ActionForward retorno = actionMapping.findForward("inserirComandoNegativacaoPorGuiaPagamentoDadosCliente");
