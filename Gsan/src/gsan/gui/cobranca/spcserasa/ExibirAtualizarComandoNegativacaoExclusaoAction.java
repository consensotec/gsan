 ...
 * @date 07/07/2010
 */
public class ExibirAtualizarComandoNegativacaoExclusaoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        ActionForward retorno = actionMapping.findForward("atualizarComandoNegativacaoExclusao");
...
//    	 Pesquisando motivo de retorno
        if(sessao.getAttribute("colecaoRetornoMotivo") == null){
        	...
        	filtroNegativadorRetornoMotivo.adicionarParametro(new ParametroSimples(
        			...
        			new Integer(form.getNegativadorId())));
        	filtroNegativadorRetornoMotivo.adicionarParametro(new ParametroSimples(
