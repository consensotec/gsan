...
public class GerarIntegracaoContabilidadeActionForm extends ValidatorActionForm {
    ...
    public String getNumeroUltimoSequencial() {
		return numeroUltimoSequencial;
	}

	public void setNumeroUltimoSequencial(String numeroUltimoSequencial) {
		this.numeroUltimoSequencial = numeroUltimoSequencial;
	}
