 ...
 * @created 16/10/2012
 */
public class ExibirRegerarLancamentosContabeisAction extends GcomAction {
	/**
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping.findForward("exibirRegerarLancamentosContabeis");
		...
		filtroLancamentoOrigem.adicionarParametro(new ParametroNaoNulo(FiltroLancamentoOrigem.PROCESSO_ID));
