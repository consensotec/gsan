...
public class RemoverContaBancariaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		fachada.remover(ids, ContaBancaria.class.getName(),
				null, null);
        ...
        if (retorno.getName().equalsIgnoreCase("telaSucesso")) {
            montarPaginaSucesso(httpServletRequest,
            		ids.length + " Conta  Bancária(s) removido(s) com sucesso.",
                    "Realizar outra Manutenção de Conta Bancária",
