 ...
 * @date 27/06/2012
 */
public class GerarMovimentoDebitoAutomaticoParcClienteActionForm extends
		ValidatorActionForm {
	...
	public String getIdDataParcela() {
		return idDataParcela;
	}

	public void setIdDataParcela(String idDataParcela) {
		this.idDataParcela = idDataParcela;
	}
