 ...
 *
 */
public class QuestionarioSatisfacaoPortalCaemaAction extends GcomAction {
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(operacao == null || !operacao.equals("sucesso")){
			QuestionarioSatisfacaoPortalCaemaActionForm form = (QuestionarioSatisfacaoPortalCaemaActionForm) actionForm;
