...
public class HistoricoMedicaoIndividualizadaHelper {
	...
	private Integer imoveisVinculadosInicial;
	private Integer imoveisVinculadosFinal;
	...
	public Integer getImoveisVinculadosInicial() {
		return imoveisVinculadosInicial;
	}

	public void setImoveisVinculadosInicial(Integer imoveisVinculadosInicial) {
		this.imoveisVinculadosInicial = imoveisVinculadosInicial;
	}

	public Integer getImoveisVinculadosFinal() {
		return imoveisVinculadosFinal;
	}

	public void setImoveisVinculadosFinal(Integer imoveisVinculadosFinal) {
