...
public class SubstituirConsumosAnterioresAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        httpServletRequest.setAttribute("sucesso", "Consumos substituídos com sucesso.");
        
        if(sessao.getAttribute("peloMenu") != null){
        	retorno = actionMapping.findForward("telaSucesso");
        		
        	montarPaginaSucesso(httpServletRequest, "Consumos anteriores substituídos do imóvel " + idImovel + " com sucesso.",
