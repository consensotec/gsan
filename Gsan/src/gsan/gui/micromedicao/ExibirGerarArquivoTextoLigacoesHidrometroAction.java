...
public class ExibirGerarArquivoTextoLigacoesHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping.findForward("exibirGerarArquivoTextoLigacoesHidrometro");
	 ...
	 * @date 07/04/2008
	 */
	private void pesquisarLocalidade(GerarArquivoTextoLigacoesHidrometroActionForm form,
	 ...
	 * @date 07/04/2008
	 */
	private void pesquisarSetorComercial(GerarArquivoTextoLigacoesHidrometroActionForm form,
		String objetoConsulta) {
