 ...
 * solicitacao_especificacao_adicionar_popup.jsp na hora de adicionar solicitações especificações
 * 
 * @author Sávio Luiz
 * @created 28 de Julho de 2006
 */
public class RecuperarDadosPesquisarAdicionarSolicitacaoEspecificacaoTipoServicoAction extends
		GcomAction {
	/**
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		// chama
		// essa funcionalidade
		if (httpServletRequest.getParameter("caminhoRetornoTelaPesquisaServicoTipo") != null) {
			sessao.setAttribute("caminhoRetornoTelaPesquisaServicoTipo", httpServletRequest
