...
/**
 * Descrição da classe Action auxiliar responsável por não perder as informações
 * preenchidas no solicitacao_tipo_atualizar.jsp na hora de adicionar
 * solicitações especificações
 * 
 * @author Rômulo Aurélio
 * @date 09/11/2006
 */
public class RecuperarDadosAtualizarTipoSolicitacaoEspecificacaoAction extends
		GcomAction {
	/**
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		// filtrarTipoSolicitacaoEspecificacaoActionForm =
		// (FiltrarTipoSolicitacaoEspecificacaoActionForm) actionForm;
