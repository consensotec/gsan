 ...
 *
 */
public class RemoverOcorrenciaOperacionalAction extends GcomAction{
	/**
	 * 
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		fachada.remover(idsRegistrosRemocao, OcorrenciaOperacional.class.getName(),
				null, null);

		montarPaginaSucesso(httpServletRequest, idsRegistrosRemocao.length
				+ " Ocorrência(s) operacional(is) excluído(s) com sucesso.",
