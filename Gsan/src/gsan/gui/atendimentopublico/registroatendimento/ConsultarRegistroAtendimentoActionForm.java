...
public class ConsultarRegistroAtendimentoActionForm extends ActionForm{
    ...
    private String numeroRAPesquisado;
    ...
    private String descricaoRAAssociada;
    private String descricaoSituacaoRAAssociada;
    private String idUnidadeAnterior;
	...
	public String getNumeroRAPesquisado() {
		return numeroRAPesquisado;
	}

	public void setNumeroRAPesquisado(String numeroRAPesquisado) {
		this.numeroRAPesquisado = numeroRAPesquisado;
	}
	...
	public String getDescricaoRAAssociada() {
		return descricaoRAAssociada;
	}

	public void setDescricaoRAAssociada(String descricaoRAAssociada) {
		this.descricaoRAAssociada = descricaoRAAssociada;
	}

	public String getDescricaoSituacaoRAAssociada() {
		return descricaoSituacaoRAAssociada;
	}

	public void setDescricaoSituacaoRAAssociada(String descricaoSituacaoRAAssociada) {
		this.descricaoSituacaoRAAssociada = descricaoSituacaoRAAssociada;
	}
	...
	public String getIdUnidadeAnterior() {
		return idUnidadeAnterior;
	}

	public void setIdUnidadeAnterior(String idUnidadeAnterior) {
		this.idUnidadeAnterior = idUnidadeAnterior;
	}
