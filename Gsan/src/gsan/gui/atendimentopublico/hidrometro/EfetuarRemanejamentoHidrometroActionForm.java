 ...
 * @date 28/06/2006
 */
public class EfetuarRemanejamentoHidrometroActionForm extends ValidatorActionForm {
...
//	Dados da Geração do Débito
	 ...
	 */
	public String getTipoCavalete() {
		return tipoCavalete;
	}

	/**
	 * @param tipoCavalete
	 *            O tipoCavalete a ser setado.
	 */
	public void setTipoCavalete(String tipoCavalete) {
		this.tipoCavalete = tipoCavalete;
	}
