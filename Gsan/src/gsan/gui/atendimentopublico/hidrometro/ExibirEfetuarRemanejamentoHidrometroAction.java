...
public class ExibirEfetuarRemanejamentoHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (idOrdemServico != null && !idOrdemServico.trim().equals("")) {
			...
			if (ordemServico != null) {
				...
				efetuarRemanejamentoHidrometroActionForm.setNomeOrdemServico("ORDEM DE SERVIÇO INEXISTENTE");
			}
		}
		return retorno;
	}
	...
	private void pesquisarSelectObrigatorio(HttpServletRequest httpServletRequest) {
		...
		if (colecaoHidrometroLocalInstalacao == null || colecaoHidrometroLocalInstalacao.isEmpty()) {
			throw new ActionServletException("atencao.entidade_sem_dados_para_selecao", null, "Tabela hidrômetro local de instalação ");
		}
		...
		if (colecaoHidrometroProtecao == null || colecaoHidrometroProtecao.isEmpty()) {
			throw new ActionServletException("atencao.entidade_sem_dados_para_selecao", null, "Tabela hidrômetro proteção ");
		}
