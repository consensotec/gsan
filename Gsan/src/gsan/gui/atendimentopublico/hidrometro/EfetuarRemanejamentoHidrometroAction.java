...
public class EfetuarRemanejamentoHidrometroAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (retorno.getName().equalsIgnoreCase("telaSucesso")) {
			montarPaginaSucesso(httpServletRequest, "Remanejamento do Hidrômetro no imóvel " + imovel.getId() + " efetuada com sucesso",
					"Efetuar outro Remanejamento de hidrômetro", "exibirEfetuarRemanejamentoHidrometroAction.do?menu=sim");
		}
