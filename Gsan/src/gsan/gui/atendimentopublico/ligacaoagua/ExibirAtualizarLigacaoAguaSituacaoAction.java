...
public class ExibirAtualizarLigacaoAguaSituacaoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (id != null && !id.trim().equals("") && Integer.parseInt(id) > 0) {
			...
			atualizarLigacaoAguaSituacaoActionForm.setIndicadorFaturarConsumoReal(
				""+ ligacaoAguaSituacao.getIndicadorConsumoReal());
			
			atualizarLigacaoAguaSituacaoActionForm.setIndicadorFaturarLeituraReal(
				""+ ligacaoAguaSituacao.getIndicadorFaturarLeituraReal());
