...
public class ExibirConsultarDadosOrdemServicoPopupAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		Collection<OrdemServicoFoto> fotos = fachada.buscarFotosOs(ordemServico.getId());
		...
		if (new Short(ordemServico.getSituacao()).intValue() == OrdemServico.SITUACAO_ENCERRADO.intValue()) {
			...
			consultarDadosOrdemServicoPopupActionForm.setMotivoEncerramento(ordemServico.getAtendimentoMotivoEncerramento().getDescricao());
			...
			if (ordemServicoUnidadeEncerramento != null) {
				...
				consultarDadosOrdemServicoPopupActionForm.setUnidadeEncerramentoDtUltimaAlteracao(Util.formatarData(ordemServicoUnidadeEncerramento.getUltimaAlteracao())
				+ " " + Util.formatarHoraSemData(ordemServicoUnidadeEncerramento.getUltimaAlteracao()));				
			}
		}
