...
public class RemoverTipoRetornoOrdemServicoReferidaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        fachada.removerTipoRetornoOrdemServicoReferida(ids,usuarioLogado);
        
        // [FS0004] Verificar Sucesso de Transação
        //Monta a página de sucesso
        if (retorno.getName().equalsIgnoreCase("telaSucesso")) {
            montarPaginaSucesso(httpServletRequest,
            		ids.length + " Tipo de Retorno OS Referida removido(s) com sucesso.",
                    "Realizar outra Manutenção de Tipo Retorno OS Referida",
