...
//	        	}
        		...
        		//[FS0004] Caso o comando tenha sido encerrado
	        	...
	        	//[FS0005] Caso o comando tenha arquivo texto para visita de campo criado
	        	int qtdArquivoTextoVisitaCampo = Fachada.getInstancia().pesquisarArqvTxtVisitaCampoPorComandoOrdemSeletiva(comandoOrdemSeletiva.getId());
	    		if(qtdArquivoTextoVisitaCampo > 0){
	    			throw new ActionServletException("atencao.nao_possivel.movimentar.odens_servico", 
	    					null, "");
	    		}
