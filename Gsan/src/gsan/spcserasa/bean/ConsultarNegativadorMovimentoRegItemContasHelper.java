 ...
 * [UC0684] 
 * 
 * Classe responsável pelo helper para montar a coleção de contas do Relatório de Consultar Negativador MovimentoRegItem
 * 
 * @author Rodrigo Cabral
 * @date 22/09/2014
 */
public class ConsultarNegativadorMovimentoRegItemContasHelper {
	...
	private String totalQtdContas;
	
	private String totalValorConta;
	
	private String totalValorNegativadoConta;
	
	
	public String getTotalQtdContas() {
		return totalQtdContas;
	}

	public void setTotalQtdContas(String totalQtdContas) {
		this.totalQtdContas = totalQtdContas;
	}

	public String getTotalValorConta() {
		return totalValorConta;
	}

	public void setTotalValorConta(String totalValorConta) {
		this.totalValorConta = totalValorConta;
	}

	public String getTotalValorNegativadoConta() {
		return totalValorNegativadoConta;
	}

	public void setTotalValorNegativadoConta(String totalValorNegativadoConta) {
		this.totalValorNegativadoConta = totalValorNegativadoConta;
	}
