...
public class AbastecimentoProgramacao extends ObjetoTransacao {
    ...
    /** full constructor */
    public AbastecimentoProgramacao(int anoMesReferencia, Date dataInicio, Date dataFim, Date horaInicio, Date horaFim, Date ultimaAlteracao, gsan.operacional.SistemaAbastecimento sistemaAbastecimento, Municipio municipio, Bairro bairro, gsan.operacional.SetorAbastecimento setorAbastecimento, gsan.operacional.DistritoOperacional distritoOperacional, gsan.operacional.ZonaAbastecimento zonaAbastecimento, BairroArea bairroArea) {
    ...
    /** minimal constructor */
    public AbastecimentoProgramacao(int anoMesReferencia, Date dataInicio, Date dataFim, Date horaInicio, Date horaFim, Date ultimaAlteracao, Municipio municipio, Bairro bairro, gsan.operacional.SetorAbastecimento setorAbastecimento, gsan.operacional.DistritoOperacional distritoOperacional, gsan.operacional.ZonaAbastecimento zonaAbastecimento, BairroArea bairroArea) {
        this.anoMesReferencia = anoMesReferencia;
        this.dataInicio = dataInicio;
        this.dataFim = dataFim;
        this.horaInicio = horaInicio;
