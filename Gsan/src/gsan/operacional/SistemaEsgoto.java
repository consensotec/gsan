...
public class SistemaEsgoto extends ObjetoTransacao {
    ...
    /** persistent field */
    private gsan.operacional.SistemaEsgotoTratamentoTipo sistemaEsgotoTratamentoTipo;

    /** persistent field */
    private gsan.operacional.DivisaoEsgoto divisaoEsgoto;
    ...
    public SistemaEsgoto(
            ...
            gsan.operacional.SistemaEsgotoTratamentoTipo sistemaEsgotoTratamentoTipo,
            gsan.operacional.DivisaoEsgoto divisaoEsgoto) {
    ...
    public gsan.operacional.SistemaEsgotoTratamentoTipo getSistemaEsgotoTratamentoTipo() {
    ...
    public gsan.operacional.DivisaoEsgoto getDivisaoEsgoto() {
        return this.divisaoEsgoto;
    }

    public void setDivisaoEsgoto(gsan.operacional.DivisaoEsgoto divisaoEsgoto) {
        this.divisaoEsgoto = divisaoEsgoto;
    }
