...
public interface ConstantesSistema {
	...
	String CODIGO_GUIA_DEVOLUCAO_INEXISTENTE = new String("Guia de Dvolução Inexistente");
	...
	String UNIDADE_NEGOCIO_SETOR_COMERCIAL = "UNIDADE DE NEGï¿½CIO POR SETOR COMERCIAL";
...
//  Constantes usadas no caso de uso [UC0658] Filtrar Negativador
    ...
    String CODIGO_AGENTE_NAO_CADASTRADO = "CÁDIGO DO AGENTE NÃO CADASTRADO";
    //fim se constantes para caso de uso [UC0656] Inserir Negativador
    ...
    String CODIGO_MOTIVO_INEXISTENTE = "CÁDIGO DO MOTIVO INEXISTENTE";
    ...
    Integer FAIXA_2 = 2;
    Integer FAIXA_3 = 3;
    String MENSAGEM_FAIXA_1 = "Valor Total Atï¿½ R$5.000,00 ";
