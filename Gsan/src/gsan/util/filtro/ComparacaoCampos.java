 ...
 * @author rodrigo
 */
public class ComparacaoCampos extends FiltroParametro {
     ...
     *            Valor do filtro
     */
    public ComparacaoCampos(String nomeAtributo, Object valor) {
        super(nomeAtributo);
        this.valor = valor;
    }
     ...
     *            Conector da query
     */
    public ComparacaoCampos(String nomeAtributo, Object valor, String conector) {
        super(nomeAtributo, conector);
        this.valor = valor;
    }

    /**
     * Construtor da classe ComparacaoCampos
     * 
     * @param nomeAtributo
