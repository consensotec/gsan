...
public class UnResumoArrecadacaoOutro implements Serializable {
    ...
    /** identifier field */
    private gsan.gerencial.arrecadacao.UnResumoArrecadacaoOutroPK comp_id;
    ...
    /** full constructor */
    public UnResumoArrecadacaoOutro(gsan.gerencial.arrecadacao.UnResumoArrecadacaoOutroPK comp_id, BigDecimal volumeDocumentosRecebidos, Date ultimaAlteracao, GLancamentoItemContabil gLancamentoItemContabil, gsan.gerencial.arrecadacao.UnResumoArrecadacaoAguaEsgoto unResumoArrecadacaoAguaEsgoto, GFinanciamentoTipo gFinanciamentoTipo) {
    ...
    /** minimal constructor */
    public UnResumoArrecadacaoOutro(gsan.gerencial.arrecadacao.UnResumoArrecadacaoOutroPK comp_id, BigDecimal volumeDocumentosRecebidos, Date ultimaAlteracao) {
        this.comp_id = comp_id;
        this.volumeDocumentosRecebidos = volumeDocumentosRecebidos;
        this.ultimaAlteracao = ultimaAlteracao;
    }

    public gsan.gerencial.arrecadacao.UnResumoArrecadacaoOutroPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.gerencial.arrecadacao.UnResumoArrecadacaoOutroPK comp_id) {
        this.comp_id = comp_id;
    }
