...
* 02111-1307, USA.
*/  
package gsan.gerencial.arrecadacao;
...
public class UnResumoArrecadacaoCredito implements Serializable {
    ...
    /** identifier field */
    private gsan.gerencial.arrecadacao.UnResumoArrecadacaoCreditoPK comp_id;
    ...
    /** nullable persistent field */
    private gsan.gerencial.arrecadacao.UnResumoArrecadacaoAguaEsgoto unResumoArrecadacaoAguaEsgoto;

    /** full constructor */
    public UnResumoArrecadacaoCredito(gsan.gerencial.arrecadacao.UnResumoArrecadacaoCreditoPK comp_id, BigDecimal volumeDocumentosRecebidos, Date ultimaAlteracao, GLancamentoItemContabil gLancamentoItemContabil, GCreditoOrigem gCreditoOrigem, gsan.gerencial.arrecadacao.UnResumoArrecadacaoAguaEsgoto unResumoArrecadacaoAguaEsgoto) {
    ...
    /** minimal constructor */
    public UnResumoArrecadacaoCredito(gsan.gerencial.arrecadacao.UnResumoArrecadacaoCreditoPK comp_id, BigDecimal volumeDocumentosRecebidos, Date ultimaAlteracao) {
        this.comp_id = comp_id;
        this.volumeDocumentosRecebidos = volumeDocumentosRecebidos;
        this.ultimaAlteracao = ultimaAlteracao;
    }

    public gsan.gerencial.arrecadacao.UnResumoArrecadacaoCreditoPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.gerencial.arrecadacao.UnResumoArrecadacaoCreditoPK comp_id) {
        this.comp_id = comp_id;
    }
	...
	public gsan.gerencial.arrecadacao.UnResumoArrecadacaoAguaEsgoto getUnResumoArrecadacaoAguaEsgoto() {
        return this.unResumoArrecadacaoAguaEsgoto;
    }

    public void setUnResumoArrecadacaoAguaEsgoto(gsan.gerencial.arrecadacao.UnResumoArrecadacaoAguaEsgoto unResumoArrecadacaoAguaEsgoto) {
        this.unResumoArrecadacaoAguaEsgoto = unResumoArrecadacaoAguaEsgoto;
    }
