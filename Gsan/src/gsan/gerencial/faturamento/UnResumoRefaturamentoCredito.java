...
public class UnResumoRefaturamentoCredito implements Serializable {
	...
	/** identifier field */
    private gsan.gerencial.faturamento.UnResumoRefaturamentoCreditoPK comp_id;
    ...
    /** full constructor */
    public UnResumoRefaturamentoCredito(gsan.gerencial.faturamento.UnResumoRefaturamentoCreditoPK comp_id, BigDecimal valorDocumentosRefaturados, short quantidadeDocumentosRefaturados, Date ultimaAlteracao, GLancamentoItemContabil gerLancamentoItemContabil, GCreditoOrigem gerCreditoOrigem, gsan.gerencial.faturamento.UnResumoRefaturamentoAguaEsgoto unResumoRefaturamentoAguaEsgoto) {
    ...
    /** minimal constructor */
    public UnResumoRefaturamentoCredito(gsan.gerencial.faturamento.UnResumoRefaturamentoCreditoPK comp_id, BigDecimal valorDocumentosRefaturados, short quantidadeDocumentosRefaturados, Date ultimaAlteracao) {
        this.comp_id = comp_id;
        this.valorDocumentosRefaturados = valorDocumentosRefaturados;
        this.quantidadeDocumentosRefaturados = quantidadeDocumentosRefaturados;
        this.ultimaAlteracao = ultimaAlteracao;
    ...
    public gsan.gerencial.faturamento.UnResumoRefaturamentoCreditoPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.gerencial.faturamento.UnResumoRefaturamentoCreditoPK comp_id) {
        this.comp_id = comp_id;
    }
