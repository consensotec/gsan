...
import gsan.gerencial.faturamento.bean.ResumoFaturamentoAguaEsgotoHelper;
import gsan.gerencial.faturamento.bean.ResumoFaturamentoCreditosHelper;
import gsan.gerencial.faturamento.bean.ResumoFaturamentoCreditosSetores;
import gsan.gerencial.faturamento.bean.ResumoFaturamentoDebitosACobrarHelper;
import gsan.gerencial.faturamento.bean.ResumoFaturamentoGuiaPagamentoHelper;
...
import gsan.gerencial.faturamento.bean.ResumoFaturamentoImpostosHelper;
import gsan.gerencial.faturamento.bean.ResumoFaturamentoOutrosHelper;
...
import gsan.gerencial.faturamento.bean.ResumoFaturamentoSituacaoEspecialHelper;
import gsan.gerencial.faturamento.bean.ResumoReFaturamentoHelper;
...
//							helperMotivo.setQtParalisada((Integer) dados[4]);
							helperMotivo.setQtParalisada(1);
						}
					...
					for (int i = 0; i < resumoReFaturamentoContas .size(); i++) {
						...
						if (obj instanceof Object[]) {
								...
								ResumoReFaturamentoNovoHelper helper = new ResumoReFaturamentoNovoHelper(
										...
										(Integer) retorno[26], //idMunicipio
										(Integer) retorno[27], //idBairro
										(Integer) retorno[28]);//idTipoArea												
               ...
               if (objGuiaPagamento instanceof Object[]) {
                   ...
                   ResumoFaturamentoGuiaPagamentoNovoHelper helperGuiaPagamento =
                       new ResumoFaturamentoGuiaPagamentoNovoHelper(
                           ...
                           (Integer) retorno[22], //idMunicipio
                           (Integer) retorno[23], //idBairro
                           (Integer) retorno[24]);//idTipoArea     
