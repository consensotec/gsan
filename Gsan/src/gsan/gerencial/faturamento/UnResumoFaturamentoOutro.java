...
public class UnResumoFaturamentoOutro implements Serializable {
    ...
    /** minimal constructor */
    public UnResumoFaturamentoOutro(gsan.gerencial.faturamento.UnResumoFaturamentoOutroPK comp_id, BigDecimal valorDocumentosFaturados, short quantidadeDocumentosFaturados, Date ultimaAlteracao) {        this.comp_id = comp_id;        this.valorDocumentosFaturados = valorDocumentosFaturados;        this.quantidadeDocumentosFaturados = quantidadeDocumentosFaturados;        this.ultimaAlteracao = ultimaAlteracao;    }

    public gsan.gerencial.faturamento.UnResumoFaturamentoOutroPK getComp_id() {        return this.comp_id;    }
    public void setComp_id(gsan.gerencial.faturamento.UnResumoFaturamentoOutroPK comp_id) {        this.comp_id = comp_id;    }    public int getQuantidadeDocumentosFaturados() {        return this.quantidadeDocumentosFaturados;    }
