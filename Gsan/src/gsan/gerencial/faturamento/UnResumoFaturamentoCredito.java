...
public class UnResumoFaturamentoCredito implements Serializable {
    ...
    /** identifier field */
    private gsan.gerencial.faturamento.UnResumoFaturamentoCreditoPK comp_id;
    ...
    /** nullable persistent field */
    private gsan.gerencial.faturamento.UnResumoFaturamento unResumoFaturamento;

    /** full constructor */
    public UnResumoFaturamentoCredito(gsan.gerencial.faturamento.UnResumoFaturamentoCreditoPK comp_id, BigDecimal volumeDocumentosFaturados, Integer quantidadeDocumentosFaturados, Date ultimaAlteracao, GLancamentoItemContabil gLancamentoItemContabil, GCreditoOrigem gCreditoOrigem, gsan.gerencial.faturamento.UnResumoFaturamento unResumoFaturamento) {        this.comp_id = comp_id;        this.volumeDocumentosFaturados = volumeDocumentosFaturados;        this.quantidadeDocumentosFaturados = quantidadeDocumentosFaturados;        this.ultimaAlteracao = ultimaAlteracao;        this.gerLancamentoItemContabil = gLancamentoItemContabil;        this.gerCreditoOrigem = gCreditoOrigem;        this.unResumoFaturamento = unResumoFaturamento;    }
    ...
    /** minimal constructor */
    public UnResumoFaturamentoCredito(gsan.gerencial.faturamento.UnResumoFaturamentoCreditoPK comp_id, BigDecimal volumeDocumentosFaturados, Integer quantidadeDocumentosFaturados, Date ultimaAlteracao) {
        this.comp_id = comp_id;
        this.volumeDocumentosFaturados = volumeDocumentosFaturados;
        this.quantidadeDocumentosFaturados = quantidadeDocumentosFaturados;
        this.ultimaAlteracao = ultimaAlteracao;
    ...
    public gsan.gerencial.faturamento.UnResumoFaturamentoCreditoPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.gerencial.faturamento.UnResumoFaturamentoCreditoPK comp_id) {
        this.comp_id = comp_id;
    }
	...
	public gsan.gerencial.faturamento.UnResumoFaturamento getUnResumoFaturamento() {
        return this.unResumoFaturamento;
    }

    public void setUnResumoFaturamento(gsan.gerencial.faturamento.UnResumoFaturamento unResumoFaturamento) {
        this.unResumoFaturamento = unResumoFaturamento;
    }
