...
public class UnResumoIndicadorDesempenhoMicromedicaoRef2010 implements Serializable {
    ...
    /** full constructor */
    public UnResumoIndicadorDesempenhoMicromedicaoRef2010(int anoMesReferencia, 
    		int codigoSetorComercial, 
    		int quantidadeLigacoesAtivas, 
    		int quantidadeLigacoesComHidrometro, 
    		int quantidadeLigacoesComMedicaoReal, 
    		int quantidadeLigacoesComHidrometroEMedicaoEstimada, 
    		int quantidadeEconomiasAtivas, 
    		int quantidadeEconomiasComHidrometro, 
    		int quantidadeEconomiasComMedicaoReal, 
    		int quantidadeEconomiasComHidrometroEMedicaoEstimada, 
    		int consumoAguaAtivas, 
    		int consumoAguaComHidrometro, 
    		int consumoAguaComMedicaoReal, 
    		int consumoAguaComHidrometroEMedicaoEstimada, 
    		int volumeFaturadoAgua, 
    		int volumeFaturadoAguaMedido, 
    		int volumeFaturadoAguaNaoMedido, 
    		int quantidadeLigacoes, 
    		int quantidadeEconomias, 
    		int volumeEsgoto, 
    		int volumeFaturadoEsgoto, 
    		int volumeFaturadoEsgotoMedido, 
    		int volumeFaturadoEsgotoNaoMedido, 
    		int quantidadeVisitasRealizadas, 
    		int quantidadeLeiturasEfetuadas, 
    		int quantidadeLeiturasComAnormalidadeHidrometro, 
    		int quantidadeHidrometroInstaladoRamal, 
    		int quantidadeHidrometroSubstituidoRamal, 
    		int quantidadeHidrometroRemanejadoRamal, 
    		int quantidadeHidrometroRetiradoRamal, 
    		int quantidadeHidrometrosAtualInstaladosRamal, 
    		int quantidadeHidrometroInstaladoPoco, 
    		int quantidadeHidrometroSubstituidoPoco, 
    		int quantidadeHidrometroRemanejadoPoco, 
    		int quantidadeHidrometroRetiradoPoco, 
    		int quantidadeHidrometrosAtualInstaladosPoco, 
    ...
    /** default constructor */
    public UnResumoIndicadorDesempenhoMicromedicaoRef2010() {
    }
