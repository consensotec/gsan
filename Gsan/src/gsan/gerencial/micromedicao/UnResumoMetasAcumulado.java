...
public class UnResumoMetasAcumulado implements Serializable {
    ...
    /** persistent field */
    private int quantidadeLigacoesConsumoNaoMedido;
    ...
    /** full constructor */
    public UnResumoMetasAcumulado(Integer id, int anoMesReferencia, int codigoSetorComercial, int numeroQuadra, int quantidadeLigacoesCadastradas, int quantidadeLigacoesCortadas, int quantidadeLigacoesSuprimidas, int quantidadeLigacoesAtivas, int quantidadeLigacoesAtivasDebito3m, int quantidadeLigacoesConsumoMedido, int quantidadeLigacoesConsumoNaoMedido, int quantidadeLigacoesConsumoAte5m3, int quantidadeLigacoesConsumoMedia, int quantidadeEconomias, Date ultimaAlteracao, GGerenciaRegional gerGerenciaRegional, GSetorComercial gerSetorComercial, GSubcategoria gerSubcategoria, GLigacaoAguaPerfil gerLigacaoAguaPerfil, GEsferaPoder gerEsferaPoder, GClienteTipo gerClienteTipo, GLigacaoAguaSituacao gerLigacaoAguaSituacao, GUnidadeNegocio gerUnidadeNegocio, GLocalidade gerLocalidadeElo, GLocalidade gerLocalidade, GCategoria gerCategoria, GImovelPerfil gerImovelPerfil, GRota gerRota, GQuadra gerQuadra, GLigacaoEsgotoSituacao gerLigacaoEsgotoSituacao, GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil) {
        this.id = id;
    ...
    public int getQuantidadeLigacoesConsumoNaoMedido() {
        return this.quantidadeLigacoesConsumoNaoMedido;
    }

    public void setQuantidadeLigacoesConsumoNaoMedido(int quantidadeLigacoesConsumoNaoMedido) {
        this.quantidadeLigacoesConsumoNaoMedido = quantidadeLigacoesConsumoNaoMedido;
    }
