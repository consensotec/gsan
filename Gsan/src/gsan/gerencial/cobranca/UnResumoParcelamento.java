...
public class UnResumoParcelamento implements Serializable {
    ...
    /** persistent field */
    private gsan.gerencial.cadastro.imovel.GSubcategoria gerSubcategoria;

    /** persistent field */
    private gsan.gerencial.cadastro.cliente.GClienteTipo gerClienteTipo;

    /** persistent field */
    private gsan.gerencial.atendimentopublico.ligacaoagua.GLigacaoAguaSituacao gerLigacaoAguaSituacao;

    /** persistent field */
    private gsan.gerencial.cadastro.localidade.GQuadra gerQuadra;

    /** persistent field */
    private gsan.gerencial.atendimentopublico.ligacaoesgoto.GLigacaoEsgotoSituacao gerLigacaoEsgotoSituacao;

    /** persistent field */
    private gsan.gerencial.cadastro.localidade.GGerenciaRegional gerGerenciaRegional;

    /** persistent field */
    private gsan.gerencial.cadastro.localidade.GSetorComercial gerSetorComercial;

    /** persistent field */
    private gsan.gerencial.atendimentopublico.ligacaoagua.GLigacaoAguaPerfil gerLigacaoAguaPerfil;

    /** persistent field */
    private gsan.gerencial.cadastro.imovel.GImovelPerfil gerImovelPerfil;

    /** persistent field */
    private gsan.gerencial.cadastro.localidade.GUnidadeNegocio gerUnidadeNegocio;

    /** persistent field */
    private gsan.gerencial.cadastro.localidade.GLocalidade gerLocalidadeElo;

    /** persistent field */
    private gsan.gerencial.cadastro.localidade.GLocalidade gerLocalidade;

    /** persistent field */
    private gsan.gerencial.atendimentopublico.ligacaoesgoto.GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil;

    /** persistent field */
    private gsan.gerencial.cadastro.cliente.GEsferaPoder gerEsferaPoder;

    /** persistent field */
    private gsan.gerencial.cadastro.imovel.GCategoria gerCategoria;

    /** persistent field */
    private gsan.gerencial.micromedicao.GRota gerRota;
    ...
    /** full constructor */
    public UnResumoParcelamento(int anoMesReferencia, int setorComercial, int quadra, int quantidadeContas, 
    		BigDecimal valorContas, BigDecimal valorGuias,  
    		BigDecimal valorCreditos, BigDecimal valorDescricaoAcrescimo,  
    		int quantidadeGuias, BigDecimal valorDescricaoInatividade, 
    		BigDecimal valorAcrescimoImpontualidade, Date ultimaAlteracao, 
    		short quantidadeParcelamentos, BigDecimal valorDescricaoAntiguidade, 
    		GSubcategoria gerSubcategoria, GClienteTipo gerClienteTipo, GLigacaoAguaSituacao gerLigacaoAguaSituacao, 
    		GQuadra gerQuadra, GLigacaoEsgotoSituacao gerLigacaoEsgotoSituacao, GGerenciaRegional gerGerenciaRegional, 
    		GSetorComercial gerSetorComercial, GLigacaoAguaPerfil gerLigacaoAguaPerfil, 
    		GImovelPerfil gerImovelPerfil, GUnidadeNegocio gerUnidadeNegocio, GLocalidade gerLocalidadeElo, 
    		GLocalidade gerLocalidade, GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil, GEsferaPoder gerEsferaPoder, 
    		GCategoria gerCategoria, GRota gerRota, BigDecimal valorJurosParcelamento, BigDecimal valorEntrada,
            BigDecimal valorDebitosCobrarParcelamentos, BigDecimal valorDebitosCobrarTotal, BigDecimal valorDebitosCobrarAcrescimos,
            BigDecimal valorDebitosCobrarReligadosSancoes, Integer quantidadeTotalParcelas,
            Integer quantidadeMediaParcelas, GConsumoTarifa gerConsumoTarifa, Short indicadorHidrometro,
            Integer quantidadeReparcelamentos, Short codigoRota) {
    ...
    /** default constructor */
    public UnResumoParcelamento() {
    }

    /** minimal constructor */
    public UnResumoParcelamento(int anoMesReferencia, int setorComercial, int quadra, int quantidadeContas, 
    		BigDecimal valorContas, BigDecimal valorGuias, BigDecimal valorServicosIndiretos, 
    		BigDecimal valorCreditos, BigDecimal valorDescricaoAcrescimo, int quantidadeGuias, 
    		BigDecimal valorTotalParcelado, BigDecimal valorDescricaoInatividade, BigDecimal valorFinanciado, 
    		BigDecimal valorAcrescimoImpontualidade, Date ultimaAlteracao, short quantidadeParcelamentos, 
    		BigDecimal valorSancoes, BigDecimal valorDescricaoAntiguidade, GSubcategoria gerSubcategoria, 
    		GClienteTipo gerClienteTipo, GLigacaoAguaSituacao gerLigacaoAguaSituacao, GQuadra gerQuadra, 
    		GLigacaoEsgotoSituacao gerLigacaoEsgotoSituacao, GGerenciaRegional gerGerenciaRegional, 
    		GSetorComercial gerSetorComercial, GLigacaoAguaPerfil gerLigacaoAguaPerfil, GImovelPerfil gerImovelPerfil, 
    		GUnidadeNegocio gerUnidadeNegocio, GLocalidade gerLocalidadeElo, GLocalidade gerLocalidadeByLocaId, 
    		GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil, GEsferaPoder gerEsferaPoder, GCategoria gerCategoria, 
    		GRota gerRota) {
        this.anoMesReferencia = anoMesReferencia;
        this.setorComercial = setorComercial;
        this.quadra = quadra;
	...
	public gsan.gerencial.cadastro.imovel.GCategoria getGerCategoria() {
		return gerCategoria;
	}

	public void setGerCategoria(
			gsan.gerencial.cadastro.imovel.GCategoria gerCategoria) {
		this.gerCategoria = gerCategoria;
	}

	public gsan.gerencial.cadastro.cliente.GClienteTipo getGerClienteTipo() {
		return gerClienteTipo;
	}

	public void setGerClienteTipo(
			gsan.gerencial.cadastro.cliente.GClienteTipo gerClienteTipo) {
		this.gerClienteTipo = gerClienteTipo;
	}

	public gsan.gerencial.cadastro.cliente.GEsferaPoder getGerEsferaPoder() {
		return gerEsferaPoder;
	}

	public void setGerEsferaPoder(
			gsan.gerencial.cadastro.cliente.GEsferaPoder gerEsferaPoder) {
		this.gerEsferaPoder = gerEsferaPoder;
	}

	public gsan.gerencial.cadastro.localidade.GGerenciaRegional getGerGerenciaRegional() {
		return gerGerenciaRegional;
	}

	public void setGerGerenciaRegional(
			gsan.gerencial.cadastro.localidade.GGerenciaRegional gerGerenciaRegional) {
		this.gerGerenciaRegional = gerGerenciaRegional;
	}

	public gsan.gerencial.cadastro.imovel.GImovelPerfil getGerImovelPerfil() {
		return gerImovelPerfil;
	}

	public void setGerImovelPerfil(
			gsan.gerencial.cadastro.imovel.GImovelPerfil gerImovelPerfil) {
		this.gerImovelPerfil = gerImovelPerfil;
	}

	public gsan.gerencial.atendimentopublico.ligacaoagua.GLigacaoAguaPerfil getGerLigacaoAguaPerfil() {
		return gerLigacaoAguaPerfil;
	}

	public void setGerLigacaoAguaPerfil(
			gsan.gerencial.atendimentopublico.ligacaoagua.GLigacaoAguaPerfil gerLigacaoAguaPerfil) {
		this.gerLigacaoAguaPerfil = gerLigacaoAguaPerfil;
	}

	public gsan.gerencial.atendimentopublico.ligacaoagua.GLigacaoAguaSituacao getGerLigacaoAguaSituacao() {
		return gerLigacaoAguaSituacao;
	}

	public void setGerLigacaoAguaSituacao(
			gsan.gerencial.atendimentopublico.ligacaoagua.GLigacaoAguaSituacao gerLigacaoAguaSituacao) {
		this.gerLigacaoAguaSituacao = gerLigacaoAguaSituacao;
	}

	public gsan.gerencial.atendimentopublico.ligacaoesgoto.GLigacaoEsgotoPerfil getGerLigacaoEsgotoPerfil() {
		return gerLigacaoEsgotoPerfil;
	}

	public void setGerLigacaoEsgotoPerfil(
			gsan.gerencial.atendimentopublico.ligacaoesgoto.GLigacaoEsgotoPerfil gerLigacaoEsgotoPerfil) {
		this.gerLigacaoEsgotoPerfil = gerLigacaoEsgotoPerfil;
	}

	public gsan.gerencial.atendimentopublico.ligacaoesgoto.GLigacaoEsgotoSituacao getGerLigacaoEsgotoSituacao() {
		return gerLigacaoEsgotoSituacao;
	}

	public void setGerLigacaoEsgotoSituacao(
			gsan.gerencial.atendimentopublico.ligacaoesgoto.GLigacaoEsgotoSituacao gerLigacaoEsgotoSituacao) {
		this.gerLigacaoEsgotoSituacao = gerLigacaoEsgotoSituacao;
	}

	public gsan.gerencial.cadastro.localidade.GLocalidade getGerLocalidade() {
		return gerLocalidade;
	}

	public void setGerLocalidade(
			gsan.gerencial.cadastro.localidade.GLocalidade gerLocalidade) {
		this.gerLocalidade = gerLocalidade;
	}

	public gsan.gerencial.cadastro.localidade.GLocalidade getGerLocalidadeElo() {
		return gerLocalidadeElo;
	}

	public void setGerLocalidadeElo(
			gsan.gerencial.cadastro.localidade.GLocalidade gerLocalidadeElo) {
		this.gerLocalidadeElo = gerLocalidadeElo;
	}

	public gsan.gerencial.cadastro.localidade.GQuadra getGerQuadra() {
		return gerQuadra;
	}

	public void setGerQuadra(gsan.gerencial.cadastro.localidade.GQuadra gerQuadra) {
		this.gerQuadra = gerQuadra;
	}

	public gsan.gerencial.micromedicao.GRota getGerRota() {
		return gerRota;
	}

	public void setGerRota(gsan.gerencial.micromedicao.GRota gerRota) {
		this.gerRota = gerRota;
	}

	public gsan.gerencial.cadastro.localidade.GSetorComercial getGerSetorComercial() {
		return gerSetorComercial;
	}

	public void setGerSetorComercial(
			gsan.gerencial.cadastro.localidade.GSetorComercial gerSetorComercial) {
		this.gerSetorComercial = gerSetorComercial;
	}

	public gsan.gerencial.cadastro.imovel.GSubcategoria getGerSubcategoria() {
		return gerSubcategoria;
	}

	public void setGerSubcategoria(
			gsan.gerencial.cadastro.imovel.GSubcategoria gerSubcategoria) {
		this.gerSubcategoria = gerSubcategoria;
	}

	public gsan.gerencial.cadastro.localidade.GUnidadeNegocio getGerUnidadeNegocio() {
		return gerUnidadeNegocio;
	}

	public void setGerUnidadeNegocio(
			gsan.gerencial.cadastro.localidade.GUnidadeNegocio gerUnidadeNegocio) {
		this.gerUnidadeNegocio = gerUnidadeNegocio;
	}
