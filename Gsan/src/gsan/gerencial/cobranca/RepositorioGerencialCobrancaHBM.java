...
import gsan.cobranca.ResumoCobrancaAcao;
import gsan.cobranca.ResumoCobrancaAcaoEventual;
import gsan.cobranca.ResumoCobrancaSituacaoEspecial;
...
import gsan.gerencial.cobranca.bean.ResumoPendenciaContasGerenciaHelper;
import gsan.gerencial.cobranca.bean.ResumoPendenciaContasGerencialPorAnoHelper;
import gsan.gerencial.cobranca.bean.ResumoPendenciaCreditoARealizarGerenciaHelper;
import gsan.gerencial.cobranca.bean.ResumoPendenciaCreditoARealizarGerencialPorAnoHelper;
import gsan.gerencial.cobranca.bean.ResumoPendenciaDebitosACobrarGerenciaHelper;
import gsan.gerencial.cobranca.bean.ResumoPendenciaDebitosACobrarGerencialPorAnoHelper;
import gsan.gerencial.cobranca.bean.ResumoPendenciaGuiasPagamentoGerenciaHelper;
import gsan.gerencial.cobranca.bean.ResumoPendenciaGuiasPagamentoGerencialPorAnoHelper;
import gsan.gerencial.faturamento.bean.ConsultarResumoSituacaoEspecialHelper;
import gsan.util.ErroRepositorioException;
import gsan.util.GeradorSqlRelatorio;
...
public class RepositorioGerencialCobrancaHBM implements
	...
	public List getResumoSituacaoEspecialCobrancaHelper(int idLocalidade)
		...
		try {
			...
			String hql = " select "
					...
					// " ) " +
					" from "
					+ "	gsan.cobranca.CobrancaSituacaoHistorico cobrancaSituacaoHistorico "
	...
	public void excluirTodosResumoCobrancaSituacaoEspecial(int idLocalidade)
		...
		try {
			...
			session.createQuery(
					"delete gsan.cobranca.ResumoCobrancaSituacaoEspecial where loca_id="+idLocalidade).executeUpdate();
	...
	public Integer verificarExistenciaAnoMesReferenciaResumoPeriodo(
			Integer anoMesInicialReferencia, Integer anoMesFinalReferencia, String resumo)
			throws ErroRepositorioException {
		...
		try {
			...
			// "select count(*) from " + objetoResumo + "as resumo " +
			"select count(*) from " + resumo + " resumo "
					+ " where resumo.anoMesReferencia between " + anoMesInicialReferencia
					+ " and " + anoMesFinalReferencia + " ";
			// Faz a pesquisa
			retorno = (Integer) session.createQuery(sql).setMaxResults(1)
					.list().iterator().next();
	...
	public Collection consultarCobrancaAcaoPeriodo(InformarDadosGeracaoResumoAcaoConsultaPeriodoHelper informarDadosGeracaoResumoAcaoConsultaPeriodoHelper) 
			throws ErroRepositorioException{
		...
		try {
			consulta = " select new gsan.gerencial.bean.CobrancaAcaoHelper (cbac.id, cbac.descricaoCobrancaAcao, "
					...
					+ " where 1 = 1 "
					+ this
							.criarCondicionaisResumosHQLPeriodo(informarDadosGeracaoResumoAcaoConsultaPeriodoHelper)
...
//--------------------------------------------------------------------------------
	...
	public String criarCondicionaisResumosHQLPeriodo(
			InformarDadosGeracaoResumoAcaoConsultaPeriodoHelper informarDadosGeracaoResumoAcaoConsultaHelper) {
		...
		if (informarDadosGeracaoResumoAcaoConsultaHelper != null) {
			...
			// Inicio Parametros simples
			if ((informarDadosGeracaoResumoAcaoConsultaHelper.getAnoMesInicialReferencia() != null
					&& !informarDadosGeracaoResumoAcaoConsultaHelper.getAnoMesInicialReferencia().toString().equals(""))
				&& (informarDadosGeracaoResumoAcaoConsultaHelper.getAnoMesFinalReferencia() != null 
					&& !informarDadosGeracaoResumoAcaoConsultaHelper.getAnoMesFinalReferencia().toString().equals(""))){
				sql = sql
						+ " and re.anoMesReferencia between " + informarDadosGeracaoResumoAcaoConsultaHelper.getAnoMesInicialReferencia()
						+ " and " + informarDadosGeracaoResumoAcaoConsultaHelper.getAnoMesFinalReferencia() + " ";
			}
...
//--------------------------------------------------------------------------------
	...
	public Collection consultarCobrancaAcaoSituacao(
		...
		try {
			consulta = " select new gsan.gerencial.bean.CobrancaAcaoSituacaoHelper(castu.id, castu.descricao, sum(re.quantidadeDocumentos), sum(re.valorDocumentos))"
					+ " from ResumoCobrancaAcao re"
					+ " inner join re.cobrancaAcao cbac"
	...
	public Collection consultarCobrancaAcaoDebito(
		...
		try {
			consulta = " select new gsan.gerencial.bean.CobrancaAcaoDebitoHelper (cdst.id, cdst.descricao, sum(re.quantidadeDocumentos),"
	...
	public Collection consultarCobrancaAcaoSituacaoPerfilImovel(
		...
		try {
			consulta = " select new gsan.gerencial.bean.CobrancaAcaoPerfilHelper(iper.id, iper.descricao,"
	...
	public Collection consultarCobrancaAcaoSituacaoPerfilImovelIndicador(
		...
		try {
			consulta = " select new gsan.gerencial.bean.CobrancaAcaoPerfilIndicadorHelper(iper.id, iper.descricao,"
	...
	public Collection consultarCobrancaAcaoMotivoEncerramento(
		...
		try {
			consulta = " select new gsan.gerencial.bean.ResumoCobrancaAcaoSituacaoAcaoDetalhesHelper(moen.id, moen.descricao,"
					+ " sum(re.quantidadeDocumentos), sum(re.valorDocumentos))"
					+ " from ResumoCobrancaAcao re"
					+ " inner join re.cobrancaAcao cbac"
					+ " inner join re.cobrancaAcaoSituacao castu"
	...
	public Collection consultarCobrancaAcaoRetornoFiscalizacao(
		...
		try {
			consulta = " select new gsan.gerencial.bean.ResumoCobrancaAcaoSituacaoAcaoDetalhesHelper(fisu.id, " 
	...
	public List getContasPendentes(int idQuadra)
		...
		try {
			String hql =
				...
				"    rota.codigo " +//28
				"  from " +  
				"   gsan.faturamento.conta.Conta con " +
				...
				"   SistemaParametro sp " +
				"  where " +
				" ( ( con.referenciaContabil <= (sp.anoMesFaturamento - 1) and con.debitoCreditoSituacaoAtual.id in ( 0,1,2) ) " +
				"		 or ( con.referenciaContabil > (sp.anoMesFaturamento - 1) and con.debitoCreditoSituacaoAtual.id in (3,4,5,8) ) " +
				"		 and ( con.debitoCreditoSituacaoAnterior.id is null " +
				"		 or ( con.referencia <= (sp.anoMesFaturamento - 1)    and con.debitoCreditoSituacaoAnterior.id <> 2 ))) " +
				"    and " +
				"    qua.id = :idQuadra" +
				"   order by " +
	...
	public List getContasPendentesPorRegiao(int idSetor)
		...
		try {
			String hql =
				...
				"  				  anoMesFaturamento " +
				"  				from " +
				"  				  gsan.cadastro.sistemaparametro.SistemaParametro sp) and " +
	...
	public List getGuiasPagamentoGerencia(int idQuadra)
		...
		try {
			String hql =
				...
				"  rota.codigo " +//24
				"from " +
				"  gsan.arrecadacao.pagamento.GuiaPagamento guia " +
				...
				"  								   	  gsan.cadastro.sistemaparametro.SistemaParametro sp) and guia.debitoCreditoSituacaoAtual in ( 0,1,2 ) ) " +
				" or( guia.anoMesReferenciaContabil >= (select sp.anoMesFaturamento from " +
				"  								   	  gsan.cadastro.sistemaparametro.SistemaParametro sp)" +
	...
	public List getDebitosACobrarGerencia(int idQuadra)
		...
		try {
			String hql =
				...
				"  finTipo.id, " +//19
                "  ( dc.valorDebito - (trunc(( dc.valorDebito / dc.numeroPrestacaoDebito ),2) * (dc.numeroPrestacaoCobradas - (CASE WHEN dc.anoMesReferenciaPrestacao is not null and dc.anoMesReferenciaPrestacao > (sp.anoMesFaturamento - 1) THEN 1 ELSE 0 END)))), " + //20
				"  imo.id, " + // 21
				"  imo.consumoTarifa.id, " + // 22
				"  rota.codigo "+//23
				"from " +
				"  gsan.faturamento.debito.DebitoACobrar dc " +
				...
				"  SistemaParametro sp " +
				"where " +
				" ( ( dc.anoMesReferenciaContabil <= (sp.anoMesFaturamento - 1) and dc.debitoCreditoSituacaoAtual.id " +
				" in ( 0,1,2 ) ) " +
				" or ( dc.anoMesReferenciaContabil > (sp.anoMesFaturamento - 1) and dc.debitoCreditoSituacaoAtual.id " +
				" in ( 3,4,5,8 ) " +
				" and dc.debitoCreditoSituacaoAnterior.id  is null ) ) " +
				" and qua.id = :idQuadra" +
				"  order by" +
				"  imo.id, dc.id";
	...
	public List getCreditoARealizarGerencia(int idQuadra)
		...
		try {
			String hql =
				...
				" (( cr.valorCredito - (trunc(( cr.valorCredito / cr.numeroPrestacaoCredito ),2) * cr.numeroPrestacaoRealizada)) + cr.valorResidualMesAnterior) " + // 25
				"from " +
				"  gsan.faturamento.credito.CreditoARealizar cr " +
				...
				"  SistemaParametro sp " +
				"where " +
				" ( ( cr.anoMesReferenciaContabil <= (sp.anoMesFaturamento - 1) and cr.debitoCreditoSituacaoAtual.id " +
				" in ( 0,1,2 ) ) " +
				" or ( cr.anoMesReferenciaContabil > (sp.anoMesFaturamento - 1) and cr.debitoCreditoSituacaoAtual.id " +
				" in ( 3,4,5,8 ) " +
				" and cr.debitoCreditoSituacaoAnterior.id  is null ) ) " +
				" and qua.id = :idQuadra" +
				"  order by" +
				"  imo.id, cr.id ";
	...
	public BigDecimal getPesquisaDebitoACobrar(int idParc)
		...
		try {
			...
			+ " from "
			+ "   gsan.faturamento.debito.DebitoACobrar debitoacobrar, "
			+ "   gsan.faturamento.conta.Conta as conta "
	...
	public Integer pesquisarMaiorAnoMesResumoPendencia()
		...
		try {
			...
			consulta = "SELECT max(resPend.anoMesReferencia) "
					+ " FROM "
					+ " gsan.gerencial.cobranca.UnResumoPendencia resPend ";
	...
	public Integer pesquisarMaiorAnoMesResumoParcelamento()
		...
		try {
			...
			consulta = "SELECT max(resParc.anoMesReferencia) "
					+ " FROM "
					+ " gsan.gerencial.cobranca.UnResumoParcelamento resParc ";
...
//				.setFirstResult(quantidadeInicio).setMaxResults(quantidadeMaxima)
	...
	public List getGuiasPagamentoPorClienteGerencia(int idLocalidade)
		...
		try {
			String hql =
				...
				"  left join imo.ligacaoEsgoto as ligEsgoto " +
				"where " +
				"  ( ( guia.anoMesReferenciaContabil < ( select sp.anoMesFaturamento from gsan.cadastro.sistemaparametro.SistemaParametro sp ) " +
	...
	public Collection consultarCobrancaAcaoTipoCorte(
		...
		try {
			consulta = " select new gsan.gerencial.bean.ResumoCobrancaAcaoSituacaoAcaoDetalhesHelper("
					+ "cotp.id, "
					+ "cotp.descricao, "
	...
	public Collection consultarCobrancaAcaoSituacaoPeriodo(InformarDadosGeracaoResumoAcaoConsultaPeriodoHelper informarDadosGeracaoResumoAcaoConsultaPeriodoHelper,
			Integer idCobrancaAcao) throws ErroRepositorioException {
