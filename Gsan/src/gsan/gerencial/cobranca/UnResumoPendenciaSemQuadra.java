...
public class UnResumoPendenciaSemQuadra implements Serializable {
    ...
    /** persistent field */
    private gsan.gerencial.cobranca.GDocumentoTipo gerDocumentoTipo;
    ...
    public gsan.gerencial.cobranca.GDocumentoTipo getGerDocumentoTipo() {
        return this.gerDocumentoTipo;
    }

    public void setGerDocumentoTipo(gsan.gerencial.cobranca.GDocumentoTipo gerDocumentoTipo) {
        this.gerDocumentoTipo = gerDocumentoTipo;
    }
