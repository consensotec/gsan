...
import gsan.gerencial.cadastro.bean.HistogramaAguaEconomiaHelper;
import gsan.gerencial.cadastro.bean.HistogramaAguaEconomiaSemQuadraHelper;
import gsan.gerencial.cadastro.bean.HistogramaAguaLigacaoHelper;
import gsan.gerencial.cadastro.bean.HistogramaAguaLigacaoSemQuadraHelper;
import gsan.gerencial.cadastro.bean.HistogramaEsgotoEconomiaHelper;
import gsan.gerencial.cadastro.bean.HistogramaEsgotoEconomiaSemQuadraHelper;
import gsan.gerencial.cadastro.bean.HistogramaEsgotoLigacaoHelper;
import gsan.gerencial.cadastro.bean.HistogramaEsgotoLigacaoSemQuadraHelper;
import gsan.gerencial.cadastro.bean.ResumoColetaEsgotoHelper;
import gsan.gerencial.cadastro.bean.ResumoColetaEsgotoPorAnoHelper;
import gsan.gerencial.cadastro.bean.ResumoConsumoAguaHelper;
import gsan.gerencial.cadastro.bean.ResumoConsumoAguaPorAnoHelper;
import gsan.gerencial.cadastro.bean.ResumoLigacaoEconomiaPorAnoHelper;
import gsan.gerencial.cadastro.bean.ResumoMetasHelper;
	...
	public List getHistoricosConsumoAgua(int idSetor)
		...
		try {
			...
			String hql = 
				...
				+" from "
				+" gsan.cadastro.sistemaparametro.SistemaParametro sistemaParametro ) and ( conta.debitoCreditoSituacaoAtual = 0 "
				...
				+" sistemaParametro.anoMesFaturamento "
				+" from "
				+" gsan.cadastro.sistemaparametro.SistemaParametro sistemaParametro ) ";
	...
	public List getPagamentosResumoArrecadacaoAguaEsgoto(Integer idLocalidade)
		...
		try {
			String hql = "SELECT "
					...
					+ "  gsan.arrecadacao.pagamento.Pagamento pagamento, "
	...
	public List getImoveisResumoParcelamento(int idLocalidade, int anoMes)
		...
		try {
			String hql = " select "
					...
					+ "  rota.codigo "//32
					+ " from "
					+ "  gsan.cobranca.parcelamento.Parcelamento parc "
	...
	public Integer pesquisaQuantidadeCategorias(Integer conta)
		...
		try {
			consulta = "select "
					+ "  count(*) "
					+ "from "
					+ "  gsan.faturamento.conta.ContaCategoria cc "
	...
	public Integer pesquisaQuantidadeEconomias(Integer idConta,
		...
		try {
			consulta = "select "
					...
					+ "from "
					+ "  gsan.faturamento.conta.ContaCategoria ccat "
					+ "where "
	...
	public Integer verificarConsumoReal(Integer idImovel)
		...
		try {
			consulta = "select "
					+ "  ch.consumoTipo.id "
					+ "from "
					+ "  gsan.micromedicao.consumo.ConsumoHistorico ch "
					+ "where "
	...
	public Integer verificarExistenciaHidrometro(Integer idImovel)
		...
		try {
			consulta = "select "
					+ "  count(*) "
					+ "from "
					+ "  gsan.micromedicao.medicao.MedicaoHistorico mh "
					+ "where "
	...
	public List pesquisarDadosResumoMetas(int idSetor, Date dataInicial,
		...
		try {
			String hql = "select "
					...
					+ "  from gsan.atendimentopublico.ligacaoagua.LigacaoAgua ligacaoAgua, "
					+ "   gsan.cadastro.imovel.Imovel imovel "
					+ "   left join imovel.ligacaoEsgoto ligacaoEsgoto "
...
//				 " from " + 
//				 "  gsan.micromedicao.consumo.ConsumoHistorico as consumoHistorico " + 				
...
//				 "    										      sistemaParametro.anoMesFaturamento " +  
//				 "    										    from " + 
//			 	 "      										  gsan.cadastro.sistemaparametro.SistemaParametro sistemaParametro  ) and ( conta.debitoCreditoSituacaoAtual = 0 or conta.debitoCreditoSituacaoAnterior = 0 ) ) " +
	...
	public Integer pesquisarMaiorAnoMesResumoLigacaoEconomia()
		...
		try {
			...
			consulta = "SELECT max(resLigEcon.referencia) "
					+ " FROM "
					+ " gsan.gerencial.cadastro.UnResumoLigacaoEconomia resLigEcon ";
	...
	public Integer pesquisarMaiorAnoMesResumoIndicadorLigacaoEconomia()
		...
		try {
			...
			consulta = "SELECT max(resIndLigEcon.anoMesReferencia) "
					+ " FROM "
					+ " gsan.gerencial.cadastro.UnResumoIndicadorLigacaoEconomia resIndLigEcon ";
	...
	public Integer getMotivoSituacaoFaturamento(Integer idImovel, Integer amReferenciaConta)
		...
		try {
			String hql = 
				...
				" FROM gsan.faturamento.FaturamentoSituacaoHistorico fsh " +
