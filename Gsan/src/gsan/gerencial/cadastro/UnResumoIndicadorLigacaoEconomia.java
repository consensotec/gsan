...
public class UnResumoIndicadorLigacaoEconomia implements Serializable {
	...
	/** identifier field */
    private gsan.gerencial.cadastro.UnResumoIndicadorLigacaoEconomiaPK comp_id;
    ...
    public gsan.gerencial.cadastro.UnResumoIndicadorLigacaoEconomiaPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.gerencial.cadastro.UnResumoIndicadorLigacaoEconomiaPK comp_id) {
        this.comp_id = comp_id;
    }
