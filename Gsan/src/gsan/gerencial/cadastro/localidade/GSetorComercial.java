...
public class GSetorComercial implements Serializable {
    ...
    /** full constructor */
    public GSetorComercial(int codigo, String descricao, Short indicadorUso, Date ultimaAlteracao, gsan.gerencial.cadastro.localidade.GLocalidade gLocalidade, Set unResumoColetaEsgotos, Set unResumoConsumoAguas, Set unResumoFaturamentos, Set UnResumoArrecadacao, Set unResumoLigacaoEconomias, Set gRotas, Set gQuadras) {
        this.codigo = codigo;
    ...
    /** minimal constructor */
    public GSetorComercial(int codigo, String descricao, gsan.gerencial.cadastro.localidade.GLocalidade gLocalidade, Set unResumoColetaEsgotos, Set unResumoConsumoAguas, Set unResumoFaturamentos, Set UnResumoArrecadacao, Set unResumoLigacaoEconomias, Set gRotas, Set gQuadras) {
        this.codigo = codigo;
        this.descricao = descricao;
        this.gerLocalidade = gLocalidade;
        this.unResumoColetaEsgotos = unResumoColetaEsgotos;
