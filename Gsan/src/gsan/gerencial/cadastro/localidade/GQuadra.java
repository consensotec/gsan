...
public class GQuadra implements Serializable {
    ...
    /** minimal constructor */
    public GQuadra(int numeroQuadra, gsan.gerencial.cadastro.localidade.GSetorComercial gSetorComercial, GRota gRota, Set unResumoColetaEsgotos, Set unResumoConsumoAguas, Set unResumoFaturamentos, Set unResumoArrecadacao, Set unResumoLigacaoEconomias) {
        this.numeroQuadra = numeroQuadra;
        this.gerSetorComercial = gSetorComercial;
        this.gerRota = gRota;
        this.unResumoColetaEsgotos = unResumoColetaEsgotos;
