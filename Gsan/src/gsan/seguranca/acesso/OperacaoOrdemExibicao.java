...
public class OperacaoOrdemExibicao implements Serializable {
	...
	/** identifier field */
    private gsan.seguranca.acesso.OperacaoOrdemExibicaoPK comp_id;
    ...
    /** full constructor */
    public OperacaoOrdemExibicao(gsan.seguranca.acesso.OperacaoOrdemExibicaoPK comp_id, Integer numeroOrdem, Date ultimaAlteracao, gsan.seguranca.acesso.Operacao operacao, TabelaColuna tabelaColuna) {
    ...
    /** minimal constructor */
    public OperacaoOrdemExibicao(gsan.seguranca.acesso.OperacaoOrdemExibicaoPK comp_id, Date ultimaAlteracao) {
        this.comp_id = comp_id;
        this.ultimaAlteracao = ultimaAlteracao;
    }

    public gsan.seguranca.acesso.OperacaoOrdemExibicaoPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.seguranca.acesso.OperacaoOrdemExibicaoPK comp_id) {
        this.comp_id = comp_id;
    }
