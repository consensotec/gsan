...
//	public static final Integer ATUALIZAR_IMPORTANCIA_LOGRADOURO = 1816;
	...
	public static final Integer OPERACAO_ATUALIZAR_DADOS_INCONSISTENTES_ATUALIZACAO_CADASTRAL = new Integer(1913);
	
	public static final Integer OPERACAO_ATUALIZAR_CLIENTE_ATUALIZACAO_CADASTRAL_BATCH = new Integer(2126);
	...
	/** persistent field */
	private gsan.seguranca.acesso.OperacaoTipo operacaoTipo;

	/** persistent field */
	private gsan.seguranca.acesso.Operacao idOperacaoPesquisa;

	/** persistent field */
	private gsan.seguranca.transacao.TabelaColuna tabelaColuna;

	private gsan.seguranca.transacao.TabelaColuna argumentoPesquisa;

	/** full constructor */
	public Operacao(String descricao, String descricaoAbreviada,
			String caminhoUrl, Date ultimaAlteracao,
			gsan.seguranca.acesso.Funcionalidade funcionalidade,
			gsan.seguranca.acesso.OperacaoTipo operacaoTipo,
			gsan.seguranca.acesso.Operacao idOperacaoPesquisa,
			gsan.seguranca.transacao.TabelaColuna tabelaColuna,
			gsan.seguranca.transacao.TabelaColuna argPesquisa) {
	...
	/** minimal constructor */
	public Operacao(gsan.seguranca.acesso.Funcionalidade funcionalidade) {
		this.funcionalidade = funcionalidade;
	}
	 ...
	 */
	public gsan.seguranca.acesso.Operacao getIdOperacaoPesquisa() {
	 ...
	 */
	public gsan.seguranca.acesso.OperacaoTipo getOperacaoTipo() {
		return operacaoTipo;
	}
	 ...
	 */
	public void setOperacaoTipo(gsan.seguranca.acesso.OperacaoTipo operacaoTipo) {
		this.operacaoTipo = operacaoTipo;
	}
	 ...
	 */
	public gsan.seguranca.transacao.TabelaColuna getTabelaColuna() {
		return tabelaColuna;
	}
	 ...
	 */
	public gsan.seguranca.transacao.TabelaColuna getArgumentoPesquisa() {
	...
	public void setArgumentoPesquisa(
			gsan.seguranca.transacao.TabelaColuna argumentoPesquisa) {
