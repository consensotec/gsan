...
public class PesquisarOperacao implements Serializable {
	...
	/** persistent field */
	private gsan.seguranca.acesso.PesquisarOperacao pesquisarOperacao;
	...
	public PesquisarOperacao(String descricaoOperacao, String siglaUnidade,
			...
			gsan.seguranca.acesso.PesquisarOperacao pesquisarOperacao,
			Operacao operacao) {
	...
	public PesquisarOperacao(
			gsan.cadastro.unidade.UnidadeOrganizacional unidadeEmpresa, Empresa empresa) {
		//this.pesquisarOperacao = pesquisarOperacao;
	...
	public gsan.seguranca.acesso.PesquisarOperacao getPesquisarOperacao() {
