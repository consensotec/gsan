...
public class UsuarioPermissaoEspecial extends ObjetoTransacao {
	...
	private gsan.seguranca.acesso.usuario.UsuarioPermissaoEspecialPK comp_id;
    ...
    private gsan.seguranca.acesso.usuario.Usuario usuario;

    /** nullable persistent field */
    @ControleAlteracao(value=FiltroUsuarioPemissaoEspecial.PERMISSAO_ESPECIAL_COMP_ID,funcionalidade={ATRIBUTOS_CONTROLAR_PERMISSOES_ESPECIAIS})
    private gsan.seguranca.acesso.PermissaoEspecial permissaoEspecial;
	...
	/** full constructor */
    public UsuarioPermissaoEspecial(gsan.seguranca.acesso.usuario.UsuarioPermissaoEspecialPK comp_id, gsan.seguranca.acesso.usuario.Usuario usuario, gsan.seguranca.acesso.PermissaoEspecial permissaoEspecial) {
    	this();
    ...
    /** minimal constructor */
    public UsuarioPermissaoEspecial(gsan.seguranca.acesso.usuario.UsuarioPermissaoEspecialPK comp_id) {
    	this();
        this.comp_id = comp_id;
    }

    public gsan.seguranca.acesso.usuario.UsuarioPermissaoEspecialPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(gsan.seguranca.acesso.usuario.UsuarioPermissaoEspecialPK comp_id) {
        this.comp_id = comp_id;
    }
    ...
    public gsan.seguranca.acesso.PermissaoEspecial getPermissaoEspecial() {
        return this.permissaoEspecial;
    }

    public void setPermissaoEspecial(gsan.seguranca.acesso.PermissaoEspecial permissaoEspecial) {
        this.permissaoEspecial = permissaoEspecial;
    }
