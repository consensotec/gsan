...
public class SolicitacaoAcessoGrupo implements Serializable {
	...
	/** identifier field */
    private gsan.seguranca.acesso.usuario.SolicitacaoAcessoGrupoPK comp_id;
    ...
    /** full constructor */
    public SolicitacaoAcessoGrupo(gsan.seguranca.acesso.usuario.SolicitacaoAcessoGrupoPK comp_id, 
    ...
    /** minimal constructor */
    public SolicitacaoAcessoGrupo(gsan.seguranca.acesso.usuario.SolicitacaoAcessoGrupoPK comp_id, Date ultimaAlteracao) {
        this.comp_id = comp_id;
        this.ultimaAlteracao = ultimaAlteracao;
    }

	public gsan.seguranca.acesso.usuario.SolicitacaoAcessoGrupoPK getComp_id() {
		return this.comp_id ;
	}

	public void setComp_id(
			gsan.seguranca.acesso.usuario.SolicitacaoAcessoGrupoPK comp_id) {
		this.comp_id = comp_id;
	}
