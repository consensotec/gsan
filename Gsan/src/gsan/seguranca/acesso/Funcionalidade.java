...
public class Funcionalidade extends TabelaAuxiliarAbreviada {
	...
	public Funcionalidade(String descricao, String descricaoAbreviada,
			...
			Short indicadorPontoEntrada, gsan.seguranca.acesso.Modulo modulo) {
	...
	/** minimal constructor */
	public Funcionalidade(gsan.seguranca.acesso.Modulo modulo) {
		this.modulo = modulo;
	}
	...
	public gsan.seguranca.acesso.Modulo getModulo() {
		return this.modulo;
	}

	public void setModulo(gsan.seguranca.acesso.Modulo modulo) {
		this.modulo = modulo;
	}
