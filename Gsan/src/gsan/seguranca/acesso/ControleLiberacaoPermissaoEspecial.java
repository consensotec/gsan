...
public class ControleLiberacaoPermissaoEspecial extends ObjetoTransacao {
	...
	/** minimal constructor */
	public ControleLiberacaoPermissaoEspecial(gsan.seguranca.acesso.Funcionalidade funcionalidade, gsan.seguranca.acesso.PermissaoEspecial permissaoEspecial) {
		this.permissaoEspecial = permissaoEspecial;
		this.funcionalidade = funcionalidade;
	}
	...
	public void setPermissaoEspecial(
			gsan.seguranca.acesso.PermissaoEspecial permissaoEspecial) {
		this.permissaoEspecial = permissaoEspecial;
	}
