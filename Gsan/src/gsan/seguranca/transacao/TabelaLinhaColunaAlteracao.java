...
public class TabelaLinhaColunaAlteracao implements Serializable {
    ...
    /** persistent field */
    private gsan.seguranca.transacao.TabelaLinhaAlteracao tabelaLinhaAlteracao;
	...
	/** full constructor */
    public TabelaLinhaColunaAlteracao(String conteudoColunaAnterior, String conteudoColunaAtual, Date ultimaAlteracao, gsan.seguranca.transacao.TabelaColuna tabelaColuna, gsan.seguranca.transacao.TabelaLinhaAlteracao tabelaLinhaAlteracao) {
    ...
    /** minimal constructor */
    public TabelaLinhaColunaAlteracao(gsan.seguranca.transacao.TabelaColuna tabelaColuna, gsan.seguranca.transacao.TabelaLinhaAlteracao tabelaLinhaAlteracao) {
        this.tabelaColuna = tabelaColuna;
        this.tabelaLinhaAlteracao = tabelaLinhaAlteracao;
    }
    ...
    public void setTabelaColuna(gsan.seguranca.transacao.TabelaColuna tabelaColuna) {
        this.tabelaColuna = tabelaColuna;
    }

    public gsan.seguranca.transacao.TabelaLinhaAlteracao getTabelaLinhaAlteracao() {
        return this.tabelaLinhaAlteracao;
    }

    public void setTabelaLinhaAlteracao(gsan.seguranca.transacao.TabelaLinhaAlteracao tabelaLinhaAlteracao) {
        this.tabelaLinhaAlteracao = tabelaLinhaAlteracao;
    }
