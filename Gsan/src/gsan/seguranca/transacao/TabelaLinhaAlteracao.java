...
public class TabelaLinhaAlteracao implements Serializable {
    ...
    /** persistent field */
    private gsan.seguranca.transacao.Tabela tabela;
    
    /** persistent field */
    private gsan.seguranca.acesso.OperacaoEfetuada operacaoEfetuada;
    ...
    public TabelaLinhaAlteracao(Integer id, Integer id1, Integer id2, Date ultimaAlteracao, 
    		gsan.seguranca.transacao.Tabela tabela, gsan.seguranca.acesso.OperacaoEfetuada operacaoEfetuada, Set tabelaLinhaColunaAlteracao, AlteracaoTipo alteracaoTipo) {
        this.id = id;
        this.id1 = id1;
        this.id2 = id2;
	...
	/** minimal constructor */
    public TabelaLinhaAlteracao(Integer id, gsan.seguranca.transacao.Tabela tabela, gsan.seguranca.acesso.OperacaoEfetuada operacaoEfetuada, Set tabelaLinhaColunaAlteracao) {
        this.id = id;
        this.tabela = tabela;
        this.operacaoEfetuada = operacaoEfetuada;
        this.tabelaLinhaColunaAlteracao = tabelaLinhaColunaAlteracao;
	 ...
	 */
	public gsan.seguranca.acesso.OperacaoEfetuada getOperacaoEfetuada() {
	...
	public void setOperacaoEfetuada(
			gsan.seguranca.acesso.OperacaoEfetuada operacaoEfetuada) {
		this.operacaoEfetuada = operacaoEfetuada;
	}
	 ...
	 */
	public gsan.seguranca.transacao.Tabela getTabela() {
		return tabela;
	}
	 ...
	 */
	public void setTabela(gsan.seguranca.transacao.Tabela tabela) {
		this.tabela = tabela;
	}
