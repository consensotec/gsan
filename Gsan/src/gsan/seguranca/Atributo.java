...
public class Atributo implements Serializable {
    ...
    /** persistent field */
    private gsan.seguranca.AtributoGrupo atributoGrupo;
    ...
    /** full constructor */
    public Atributo(Integer id, String nomeAtributo, Short indicadorVisita, Short numeroOrdemEmissao, Date ultimaAlteracao, gsan.seguranca.AtributoGrupo atributoGrupo, Set funcionalidadeAtributos) {
        this.id = id;
	...
	public gsan.seguranca.AtributoGrupo getAtributoGrupo() {
		return atributoGrupo;
	}

	public void setAtributoGrupo(gsan.seguranca.AtributoGrupo atributoGrupo) {
		this.atributoGrupo = atributoGrupo;
	}
