 ...
 */
public class RetornoWSIdLogImpl extends gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.impl.RetornoWSImpl implements gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.RetornoWSIdLog
{
     ...
     */
    public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog[] getLsRetornoIdLogArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog[] result = new gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog[targetList.size()];
     ...
     */
    public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog getLsRetornoIdLogArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog target = null;
            target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog)get_store().find_element_user(LSRETORNOIDLOG$4, i);
            if (target == null)
            {
     ...
     */
    public void setLsRetornoIdLogArray(gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog[] lsRetornoIdLogArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setLsRetornoIdLogArray(int i, gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog lsRetornoIdLog)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog insertNewLsRetornoIdLog(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog target = null;
            target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog)get_store().insert_element_user(LSRETORNOIDLOG$4, i);
            return target;
        }
    }
     ...
     */
    public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog addNewLsRetornoIdLog()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog target = null;
            target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.CampoWSIdLog)get_store().add_element_user(LSRETORNOIDLOG$4);
            return target;
        }
    }
