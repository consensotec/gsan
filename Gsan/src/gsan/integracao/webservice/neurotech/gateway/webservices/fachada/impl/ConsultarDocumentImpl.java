 ...
 */
public class ConsultarDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument
{
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar getConsultar()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar target = null;
            target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar)get_store().find_element_user(CONSULTAR$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setConsultar(gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar consultar)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar)get_store().add_element_user(CONSULTAR$0);
            }
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar addNewConsultar()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ConsultarImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarDocument.Consultar
    {
