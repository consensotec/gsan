 ...
 */
public class ConsultarGatewayDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayDocument
{
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayDocument.ConsultarGateway getConsultarGateway()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayDocument.ConsultarGateway target = null;
            target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayDocument.ConsultarGateway)get_store().find_element_user(CONSULTARGATEWAY$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setConsultarGateway(gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayDocument.ConsultarGateway consultarGateway)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayDocument.ConsultarGateway)get_store().add_element_user(CONSULTARGATEWAY$0);
            }
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayDocument.ConsultarGateway addNewConsultarGateway()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ConsultarGatewayImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayDocument.ConsultarGateway
    {
         ...
         */
        public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS[] getPConsultasArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS[] result = new gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS[targetList.size()];
         ...
         */
        public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS getPConsultasArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS target = null;
                target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS)get_store().find_element_user(PCONSULTAS$6, i);
                if (target == null)
                {
         ...
         */
        public void setPConsultasArray(gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS[] pConsultasArray)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void setPConsultasArray(int i, gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS pConsultas)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS insertNewPConsultas(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS target = null;
                target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS)get_store().insert_element_user(PCONSULTAS$6, i);
                return target;
            }
        }
         ...
         */
        public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS addNewPConsultas()
        {
            synchronized (monitor())
            {
                check_orphaned();
                gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS target = null;
                target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS)get_store().add_element_user(PCONSULTAS$6);
                return target;
            }
        }
