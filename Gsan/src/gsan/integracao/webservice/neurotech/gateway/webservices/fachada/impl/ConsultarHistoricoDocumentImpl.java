 ...
 */
public class ConsultarHistoricoDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoDocument
{
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoDocument.ConsultarHistorico getConsultarHistorico()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoDocument.ConsultarHistorico target = null;
            target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoDocument.ConsultarHistorico)get_store().find_element_user(CONSULTARHISTORICO$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setConsultarHistorico(gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoDocument.ConsultarHistorico consultarHistorico)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoDocument.ConsultarHistorico)get_store().add_element_user(CONSULTARHISTORICO$0);
            }
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoDocument.ConsultarHistorico addNewConsultarHistorico()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ConsultarHistoricoImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoDocument.ConsultarHistorico
    {
         ...
         */
        public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS getPConsulta()
        {
            synchronized (monitor())
            {
                check_orphaned();
                gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS target = null;
                target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS)get_store().find_element_user(PCONSULTA$6, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setPConsulta(gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS pConsulta)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS)get_store().add_element_user(PCONSULTA$6);
                }
         ...
         */
        public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWS addNewPConsulta()
        {
            synchronized (monitor())
            {
                check_orphaned();
