 ...
 */
public class AtualizarCacheDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.AtualizarCacheDocument
{
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.AtualizarCacheDocument.AtualizarCache getAtualizarCache()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gsan.integracao.webservice.neurotech.gateway.webservices.fachada.AtualizarCacheDocument.AtualizarCache target = null;
            target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.AtualizarCacheDocument.AtualizarCache)get_store().find_element_user(ATUALIZARCACHE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setAtualizarCache(gsan.integracao.webservice.neurotech.gateway.webservices.fachada.AtualizarCacheDocument.AtualizarCache atualizarCache)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.AtualizarCacheDocument.AtualizarCache)get_store().add_element_user(ATUALIZARCACHE$0);
            }
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.AtualizarCacheDocument.AtualizarCache addNewAtualizarCache()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class AtualizarCacheImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.AtualizarCacheDocument.AtualizarCache
    {
