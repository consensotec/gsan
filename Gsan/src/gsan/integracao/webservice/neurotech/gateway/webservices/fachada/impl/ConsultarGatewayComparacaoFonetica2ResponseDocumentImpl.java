 ...
 */
public class ConsultarGatewayComparacaoFonetica2ResponseDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2ResponseDocument
{
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2ResponseDocument.ConsultarGatewayComparacaoFonetica2Response getConsultarGatewayComparacaoFonetica2Response()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2ResponseDocument.ConsultarGatewayComparacaoFonetica2Response target = null;
            target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2ResponseDocument.ConsultarGatewayComparacaoFonetica2Response)get_store().find_element_user(CONSULTARGATEWAYCOMPARACAOFONETICA2RESPONSE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setConsultarGatewayComparacaoFonetica2Response(gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2ResponseDocument.ConsultarGatewayComparacaoFonetica2Response consultarGatewayComparacaoFonetica2Response)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2ResponseDocument.ConsultarGatewayComparacaoFonetica2Response)get_store().add_element_user(CONSULTARGATEWAYCOMPARACAOFONETICA2RESPONSE$0);
            }
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2ResponseDocument.ConsultarGatewayComparacaoFonetica2Response addNewConsultarGatewayComparacaoFonetica2Response()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ConsultarGatewayComparacaoFonetica2ResponseImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2ResponseDocument.ConsultarGatewayComparacaoFonetica2Response
    {
