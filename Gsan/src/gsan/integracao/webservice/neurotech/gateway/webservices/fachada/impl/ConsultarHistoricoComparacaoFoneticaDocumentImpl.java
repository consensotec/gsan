 ...
 */
public class ConsultarHistoricoComparacaoFoneticaDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoComparacaoFoneticaDocument
{
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoComparacaoFoneticaDocument.ConsultarHistoricoComparacaoFonetica getConsultarHistoricoComparacaoFonetica()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoComparacaoFoneticaDocument.ConsultarHistoricoComparacaoFonetica target = null;
            target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoComparacaoFoneticaDocument.ConsultarHistoricoComparacaoFonetica)get_store().find_element_user(CONSULTARHISTORICOCOMPARACAOFONETICA$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setConsultarHistoricoComparacaoFonetica(gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoComparacaoFoneticaDocument.ConsultarHistoricoComparacaoFonetica consultarHistoricoComparacaoFonetica)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoComparacaoFoneticaDocument.ConsultarHistoricoComparacaoFonetica)get_store().add_element_user(CONSULTARHISTORICOCOMPARACAOFONETICA$0);
            }
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoComparacaoFoneticaDocument.ConsultarHistoricoComparacaoFonetica addNewConsultarHistoricoComparacaoFonetica()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ConsultarHistoricoComparacaoFoneticaImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarHistoricoComparacaoFoneticaDocument.ConsultarHistoricoComparacaoFonetica
    {
         ...
         */
        public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica getPConsulta()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica)get_store().find_element_user(PCONSULTA$6, 0);
                if (target == null)
                {
                    return null;
                }
         ...
         */
        public void setPConsulta(gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica pConsulta)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica)get_store().add_element_user(PCONSULTA$6);
                }
         ...
         */
        public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica addNewPConsulta()
        {
            synchronized (monitor())
            {
                check_orphaned();
