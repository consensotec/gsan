 ...
 */
public class ConsultarGatewayComparacaoFonetica2DocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document
{
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2 getConsultarGatewayComparacaoFonetica2()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2 target = null;
            target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2)get_store().find_element_user(CONSULTARGATEWAYCOMPARACAOFONETICA2$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setConsultarGatewayComparacaoFonetica2(gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2 consultarGatewayComparacaoFonetica2)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2)get_store().add_element_user(CONSULTARGATEWAYCOMPARACAOFONETICA2$0);
            }
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2 addNewConsultarGatewayComparacaoFonetica2()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ConsultarGatewayComparacaoFonetica2Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFonetica2Document.ConsultarGatewayComparacaoFonetica2
    {
         ...
         */
        public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica[] getPConsultasArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica[] result = new gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica[targetList.size()];
         ...
         */
        public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica getPConsultasArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica target = null;
                target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica)get_store().find_element_user(PCONSULTAS$8, i);
                if (target == null)
                {
         ...
         */
        public void setPConsultasArray(gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica[] pConsultasArray)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void setPConsultasArray(int i, gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica pConsultas)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica insertNewPConsultas(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica target = null;
                target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica)get_store().insert_element_user(PCONSULTAS$8, i);
                return target;
            }
        }
         ...
         */
        public gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica addNewPConsultas()
        {
            synchronized (monitor())
            {
                check_orphaned();
                gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica target = null;
                target = (gsan.integracao.webservice.neurotech.gerenciadorconsulta.webservices.entidades.xsd.ConsultaWSComparacaoFonetica)get_store().add_element_user(PCONSULTAS$8);
                return target;
            }
        }
