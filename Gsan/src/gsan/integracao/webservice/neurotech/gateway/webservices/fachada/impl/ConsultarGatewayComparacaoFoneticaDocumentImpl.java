 ...
 */
public class ConsultarGatewayComparacaoFoneticaDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument
{
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica getConsultarGatewayComparacaoFonetica()
    {
        synchronized (monitor())
        {
            check_orphaned();
            gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica target = null;
            target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica)get_store().find_element_user(CONSULTARGATEWAYCOMPARACAOFONETICA$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setConsultarGatewayComparacaoFonetica(gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica consultarGatewayComparacaoFonetica)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica)get_store().add_element_user(CONSULTARGATEWAYCOMPARACAOFONETICA$0);
            }
     ...
     */
    public gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica addNewConsultarGatewayComparacaoFonetica()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ConsultarGatewayComparacaoFoneticaImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements gsan.integracao.webservice.neurotech.gateway.webservices.fachada.ConsultarGatewayComparacaoFoneticaDocument.ConsultarGatewayComparacaoFonetica
    {
