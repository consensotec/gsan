...
public class Cep extends ObjetoGcom {
     ...
     * persistent field
     */
    private gsan.cadastro.endereco.CepTipo cepTipo;
    ...
    public Cep(Integer codigo, String sigla, String municipio, String bairro,
            ...
            gsan.cadastro.endereco.CepTipo cepTipo) {
        this.codigo = codigo;
        this.sigla = sigla;
    ...
    public Cep(Integer codigo, String sigla, String municipio, String bairro,
            String logradouro, String descricaoTipoLogradouro,
            Short indicadorUso, Date ultimaAlteracao,
            gsan.cadastro.endereco.CepTipo cepTipo, String descricaoIntervaloNumeracao) {
        this.codigo = codigo;
        this.sigla = sigla;
        this.municipio = municipio;
        this.bairro = bairro;
     ...
     *            Descrição do parâmetro
     */
    public Cep(gsan.cadastro.endereco.CepTipo cepTipo) {
        this.cepTipo = cepTipo;
    }
     ...
     */
    public gsan.cadastro.endereco.CepTipo getCepTipo() {
        return this.cepTipo;
    }
     ...
     */
    public void setCepTipo(gsan.cadastro.endereco.CepTipo cepTipo) {
        this.cepTipo = cepTipo;
    }
