...
public class FiltroLogradouroImportanciaBairro extends Filtro implements Serializable {
    ...
    public FiltroLogradouroImportanciaBairro() {
    }

    public FiltroLogradouroImportanciaBairro(String campoOrderBy) {
