...
public class LogradouroBairroPK implements Serializable {
    ...
    /** identifier field */
    private gsan.cadastro.endereco.Logradouro logradouro;

    /** identifier field */
    private Bairro bairro;

    /** full constructor */
    public LogradouroBairroPK(gsan.cadastro.endereco.Logradouro logradouro,
            Bairro bairro) {
    ...
    public gsan.cadastro.endereco.Logradouro getLogradouro() {
        return this.logradouro;
    }

    public void setLogradouro(gsan.cadastro.endereco.Logradouro logradouro) {
        this.logradouro = logradouro;
    }
