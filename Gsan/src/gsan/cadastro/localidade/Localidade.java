...
public class Localidade extends ObjetoTransacao {
	...
	/** persistent field */
	private gsan.cadastro.localidade.LocalidadePorte localidadePorte;

	/** persistent field */
	private gsan.cadastro.localidade.Localidade localidade;

	/** persistent field */
	private gsan.cadastro.localidade.GerenciaRegional gerenciaRegional;

	/** persistent field */
	private EnderecoReferencia enderecoReferencia;

	/** persistent field */
	private gsan.cadastro.localidade.LocalidadeClasse localidadeClasse;
	...
	public Localidade(Integer id, String descricao, String numeroImovel,
			...
			gsan.cadastro.localidade.LocalidadePorte localidadePorte,
			gsan.cadastro.localidade.Localidade localidade,
			gsan.cadastro.localidade.GerenciaRegional gerenciaRegional,
			EnderecoReferencia enderecoReferencia,
			gsan.cadastro.localidade.LocalidadeClasse localidadeClasse,
	...
	public gsan.cadastro.localidade.LocalidadePorte getLocalidadePorte() {
	...
	public gsan.cadastro.localidade.GerenciaRegional getGerenciaRegional() {
	...
	public gsan.cadastro.localidade.LocalidadeClasse getLocalidadeClasse() {
