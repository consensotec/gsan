...
import gsan.cadastro.localidade.bean.InserirQuadraHelper;
import gsan.cadastro.localidade.bean.IntegracaoQuadraFaceHelper;
import gsan.cadastro.sistemaparametro.SistemaParametro;
import gsan.cadastro.unidade.IRepositorioUnidade;
import gsan.cadastro.unidade.RepositorioUnidadeHBM;
...
import gsan.micromedicao.bean.NumeroQuadraMinimoMaximoDaRotaHelper;
import gsan.operacional.Bacia;
import gsan.operacional.ControladorOperacionalLocal;
import gsan.operacional.ControladorOperacionalLocalHome;
...
import gsan.operacional.SetorFonteCaptacaoPK;
...
public class ControladorLocalidadeSEJB implements SessionBean {
    ...
    public Quadra validarQuadra(InserirQuadraHelper helper) throws ControladorException{
		...
		// Indicador de Atualização Cadastral
		
		if (helper.getIndicadorAtualizacaoCadastral() != null && !helper.getIndicadorAtualizacaoCadastral().equals("")){
			quadraInserir.setIndicadorAtualizacaoCadastral(Short.valueOf(helper.getIndicadorAtualizacaoCadastral()));
		}
		else{
			quadraInserir.setIndicadorAtualizacaoCadastral(ConstantesSistema.INDICADOR_USO_DESATIVO);
		}
