...
public class RepositorioQuadraHBM implements IRepositorioQuadra {
	...
	public Collection pesquisarQuadra(int idSetorComercial)
		...
		try {
			...
			consulta = "SELECT quadra.id, quadra.numeroQuadra, "
					+ "rota.id, ftgr.id "
					+ "FROM gsan.cadastro.localidade.Quadra as quadra "
	 ...
	 * gsan.relatorio.cadastro.localidade.RelatorioManterQuadraBean" +
	 ...
	 * "from gsan.cadastro.localidade.Localidade as localidade," +
	 * "gsan.cadastro.localidade.SetorComercial as setorComercial," +
	 * "gsan.cadastro.localidade.Quadra as quadra " + "left join quadra.bacia "+
