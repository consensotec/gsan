...
* 02111-1307, USA.
*/  
package gsan.cadastro.sistemaparametro;
...
public class SistemaAlteracaoHistorico implements Serializable {
    ...
    /** full constructor */
    public SistemaAlteracaoHistorico(Integer id, String nome, String descricao, Date data, Date ultimaAlteracao, gsan.seguranca.acesso.Funcionalidade funcionalidade) {
        this.id = id;
        this.nome = nome;
