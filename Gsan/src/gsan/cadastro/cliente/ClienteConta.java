...
public class ClienteConta extends ObjetoTransacao {
    ...
    /** full constructor */
    public ClienteConta(gsan.cadastro.cliente.Cliente cliente, gsan.cadastro.cliente.ClienteRelacaoTipo clienteRelacaoTipo, Conta conta) {
    ...
    public void setClienteRelacaoTipo(gsan.cadastro.cliente.ClienteRelacaoTipo clienteRelacaoTipo) {
        this.clienteRelacaoTipo = clienteRelacaoTipo;
    }
	...
	public String[] retornarLabelsInformacoesOperacaoEfetuada() {
		String []labels = {"Imóvel", "Conta", "Referencia"};
		return labels;		
	}
