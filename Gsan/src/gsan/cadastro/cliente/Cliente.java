...
public class Cliente extends ObjetoTransacao {
    ...
    private gsan.cadastro.cliente.OrgaoExpedidorRg orgaoExpedidorRg;
    ...
    private gsan.cadastro.cliente.PessoaSexo pessoaSexo;

    /** persistent field */
    @ControleAlteracao(value=FiltroCliente.PROFISSAO, 
    		funcionalidade={ATRIBUTOS_CLIENTE_INSERIR, ATRIBUTOS_CLIENTE_ATUALIZAR,OPERACAO_ATUALIZAR_DADOS_IMOVEL_ATUALIZACAO_CADASTRAL})
    private gsan.cadastro.cliente.Profissao profissao;
    ...
    @ControleAlteracao(value=FiltroCliente.RAMO_ATIVIDADE, 
    		funcionalidade={ATRIBUTOS_CLIENTE_INSERIR, ATRIBUTOS_CLIENTE_ATUALIZAR,OPERACAO_ATUALIZAR_DADOS_IMOVEL_ATUALIZACAO_CADASTRAL})
    private gsan.cadastro.cliente.RamoAtividade ramoAtividade;
...
//    		funcionalidade={ATRIBUTOS_CLIENTE_INSERIR, ATRIBUTOS_CLIENTE_ATUALIZAR})
	...
	public Cliente(String nome, String nomeAbreviado, String cpf, String rg,
			...
			gsan.cadastro.cliente.OrgaoExpedidorRg orgaoExpedidorRg,
			gsan.cadastro.cliente.Cliente cliente,
			gsan.cadastro.cliente.PessoaSexo pessoaSexo,
			gsan.cadastro.cliente.Profissao profissao,
			UnidadeFederacao unidadeFederacao,
			gsan.cadastro.cliente.ClienteTipo clienteTipo,
			gsan.cadastro.cliente.RamoAtividade ramoAtividade, Short diaVencimento) {
		this.nome = nome;
	...
	public Cliente(String nome, String nomeAbreviado, String cpf, String rg,
			...
			UnidadeFederacao unidadeFederacao,
			gsan.cadastro.cliente.ClienteTipo clienteTipo,
			gsan.cadastro.cliente.RamoAtividade ramoAtividade) {
		this.nome = nome;
		this.nomeAbreviado = nomeAbreviado;
		this.cpf = cpf;
		this.rg = rg;
	...
	public Cliente(Integer id, String nome,
			gsan.cadastro.cliente.ClienteTipo clienteTipo, String cpf,
			String cnpj) {
		this.id = id;
		this.nome = nome;
		this.clienteTipo = clienteTipo;
	 ...
	 *            Descrição do parâmetro
	 */
	public Cliente(gsan.cadastro.cliente.OrgaoExpedidorRg orgaoExpedidorRg,
			gsan.cadastro.cliente.Cliente cliente,
			gsan.cadastro.cliente.PessoaSexo pessoaSexo,
			gsan.cadastro.cliente.Profissao profissao,
			UnidadeFederacao unidadeFederacao,
	 ...
	 */
	public gsan.cadastro.cliente.OrgaoExpedidorRg getOrgaoExpedidorRg() {
	 ...
	 */
	public gsan.cadastro.cliente.PessoaSexo getPessoaSexo() {
	 ...
	 */
	public void setPessoaSexo(gsan.cadastro.cliente.PessoaSexo pessoaSexo) {
		this.pessoaSexo = pessoaSexo;
	}
	 ...
	 */
	public gsan.cadastro.cliente.Profissao getProfissao() {
	 ...
	 */
	public void setProfissao(gsan.cadastro.cliente.Profissao profissao) {
		this.profissao = profissao;
	}
	 ...
	 */
	public gsan.cadastro.cliente.RamoAtividade getRamoAtividade() {
