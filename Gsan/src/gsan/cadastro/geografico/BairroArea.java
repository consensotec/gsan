...
public class BairroArea extends ObjetoTransacao {
    ...
    /** full constructor */
    public BairroArea(String nome, Date ultimaAlteracao, Short codigoBairroArea, Short codigoMunicipio, gsan.cadastro.geografico.Bairro bairro,  DistritoOperacional distritoOperacional) {
        this.nome = nome;
