...
public class RepositorioGeograficoHBM implements IRepositorioGeografico {
	...
	public Collection pesquisarMunicipoPeloSetorComercial(
		...
		try {
			String query = "select municipio from gsan.cadastro.localidade.SetorComercial setor join setor.municipio  municipio where setor.municipio.id = :municipio and setor.codigo = :setor order by setor.municipio.nome";
	...
	public void removerTodosBairroAreaPorBairro(Integer idBairro)
		...
		try {
			Iterator iterator = session
					.createQuery(
							"from gsan.cadastro.geografico.BairroArea as bairroArea where bairroArea.bairro.id = :idBairro")
    ...
    public Collection pesquisarMunicipioDoImovel(Integer idImovel) 
		...
		try {
			String query =  "select m "+
						" from gsan.cadastro.imovel.Imovel as i"+
