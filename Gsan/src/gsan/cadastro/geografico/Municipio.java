...
public class Municipio extends ObjetoTransacao {
    ...
    /** persistent field */
    private gsan.cadastro.geografico.RegiaoDesenvolvimento regiaoDesenvolvimento;

    /** persistent field */
    private gsan.cadastro.geografico.UnidadeFederacao unidadeFederacao;
    ...
    public Municipio(
            ...
            gsan.cadastro.geografico.RegiaoDesenvolvimento regiaoDesenvolvimento,
            gsan.cadastro.geografico.UnidadeFederacao unidadeFederacao, String codigoIbge) {
        this.nome = nome;
    ...
    public Municipio(
            gsan.cadastro.geografico.Microrregiao microrregiao,
            gsan.cadastro.geografico.RegiaoDesenvolvimento regiaoDesenvolvimento,
            gsan.cadastro.geografico.UnidadeFederacao unidadeFederacao) {
        this.microrregiao = microrregiao;
        this.regiaoDesenvolvimento = regiaoDesenvolvimento;
        this.unidadeFederacao = unidadeFederacao;
    }
    ...
    public gsan.cadastro.geografico.RegiaoDesenvolvimento getRegiaoDesenvolvimento() {
    ...
    public gsan.cadastro.geografico.UnidadeFederacao getUnidadeFederacao() {
