...
public class ImovelSubcategoriaAtualizacaoCadastral extends ObjetoTransacao {
   ...
   private ImovelAtualizacaoCadastral imovelAtualizacaoCadastral;
    ...
    public ImovelSubcategoriaAtualizacaoCadastral(Integer id, Integer idImovel, Integer idCategoria, String descricaoCategoria, Integer idSubcategoria, String descricaoSubcategoria, short quantidadeEconomias, Date ultimaAlteracao, gsan.cadastro.imovel.ImovelAtualizacaoCadastral imovelAtualizacaoCadastral) {
		this.id = id;
