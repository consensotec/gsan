...
public class ImovelEconomia extends ObjetoTransacao {
    ...
    /** persistent field */
    private gsan.cadastro.imovel.ImovelSubcategoria imovelSubcategoria;
    ...
    public ImovelEconomia(String complementoEndereco, Short numeroMorador, Short numeroPontosUtilizacao, 
    		BigDecimal numeroIptu, Long numeroCelpe, BigDecimal areaConstruida, Date ultimaAlteracao, gsan.cadastro.imovel.AreaConstruidaFaixa areaConstruidaFaixa, gsan.cadastro.imovel.ImovelSubcategoria imovelSubcategoria, Set tarifaSocialDadoEconomias, Set clienteImovelEconomias) {
    ...
    /** minimal constructor */
    public ImovelEconomia(gsan.cadastro.imovel.AreaConstruidaFaixa areaConstruidaFaixa, gsan.cadastro.imovel.ImovelSubcategoria imovelSubcategoria, Set tarifaSocialDadoEconomias, Set clienteImovelEconomias) {
        this.areaConstruidaFaixa = areaConstruidaFaixa;
        this.imovelSubcategoria = imovelSubcategoria;
        this.tarifaSocialDadoEconomias = tarifaSocialDadoEconomias;
        this.clienteImovelEconomias = clienteImovelEconomias;
    ...
    public void setAreaConstruidaFaixa(gsan.cadastro.imovel.AreaConstruidaFaixa areaConstruidaFaixa) {
        this.areaConstruidaFaixa = areaConstruidaFaixa;
    }

    public gsan.cadastro.imovel.ImovelSubcategoria getImovelSubcategoria() {
        return this.imovelSubcategoria;
    }

    public void setImovelSubcategoria(gsan.cadastro.imovel.ImovelSubcategoria imovelSubcategoria) {
        this.imovelSubcategoria = imovelSubcategoria;
    }
	 ...
	 */
     ...
     public ImovelEconomia(String complementoEndereco, Short numeroMorador,
             ...
             gsan.cadastro.imovel.ImovelSubcategoria imovelSubcategoria,
