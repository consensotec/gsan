...
import gsan.util.tabelaauxiliar.FiltroTabelaAuxiliar;
...
public class CadastroOcorrencia extends ObjetoTransacao {
    ...
    private Short indicadorCamposObrigatoriosTablet;
	...
	public void setIndicadorSuspenderContratoDemanda(
			Short indicadorSuspenderContratoDemanda) {
		this.indicadorSuspenderContratoDemanda = indicadorSuspenderContratoDemanda;
	}

	public Short getIndicadorCamposObrigatoriosTablet() {
		return indicadorCamposObrigatoriosTablet;
	}

	public void setIndicadorCamposObrigatoriosTablet(
			Short indicadorCamposObrigatoriosTablet) {
		this.indicadorCamposObrigatoriosTablet = indicadorCamposObrigatoriosTablet;
	}
