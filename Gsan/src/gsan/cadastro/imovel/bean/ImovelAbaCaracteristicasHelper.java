...
public class ImovelAbaCaracteristicasHelper {
	...
	private String idImovelTipoHabitacao;
	private String idImovelTipoPropriedade;
	private String idImovelTipoConstrucao;
	private String idImovelTipoCobertura;
	...
	public String getIdImovelTipoHabitacao() {
		return idImovelTipoHabitacao;
	}
	
	public void setIdImovelTipoHabitacao(String idImovelTipoHabitacao) {
		this.idImovelTipoHabitacao = idImovelTipoHabitacao;
	}
	
	public String getIdImovelTipoPropriedade() {
		return idImovelTipoPropriedade;
	}
	
	public void setIdImovelTipoPropriedade(String idImovelTipoPropriedade) {
		this.idImovelTipoPropriedade = idImovelTipoPropriedade;
	}
	
	public String getIdImovelTipoConstrucao() {
		return idImovelTipoConstrucao;
	}
	
	public void setIdImovelTipoConstrucao(String idImovelTipoConstrucao) {
		this.idImovelTipoConstrucao = idImovelTipoConstrucao;
	}
	
	public String getIdImovelTipoCobertura() {
		return idImovelTipoCobertura;
	}
	
	public void setIdImovelTipoCobertura(String idImovelTipoCobertura) {
		this.idImovelTipoCobertura = idImovelTipoCobertura;
	}
