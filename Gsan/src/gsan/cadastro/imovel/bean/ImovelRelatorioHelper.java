...
public class ImovelRelatorioHelper implements Serializable {
	...
	private String descricaoAbreviadaSituacaoLigacaoAgua;
	
	private String descricaoAbreviadaSituacaoLigacaoEsgoto;
	
	private String descAbreviadaTipoPavimentoRua;
	
	private String descAbreviadaTipoPavimentoCalcada;
	...
	public String getDescricaoAbreviadaSituacaoLigacaoAgua() {
		return descricaoAbreviadaSituacaoLigacaoAgua;
	}

	public void setDescricaoAbreviadaSituacaoLigacaoAgua(String descricaoAbreviadaSituacaoLigacaoAgua) {
		this.descricaoAbreviadaSituacaoLigacaoAgua = descricaoAbreviadaSituacaoLigacaoAgua;
	}

	public String getDescricaoAbreviadaSituacaoLigacaoEsgoto() {
		return descricaoAbreviadaSituacaoLigacaoEsgoto;
	}

	public void setDescricaoAbreviadaSituacaoLigacaoEsgoto(String descricaoAbreviadaSituacaoLigacaoEsgoto) {
		this.descricaoAbreviadaSituacaoLigacaoEsgoto = descricaoAbreviadaSituacaoLigacaoEsgoto;
	}

	public String getDescAbreviadaTipoPavimentoRua() {
		return descAbreviadaTipoPavimentoRua;
	}

	public void setDescAbreviadaTipoPavimentoRua(String descAbreviadaTipoPavimentoRua) {
		this.descAbreviadaTipoPavimentoRua = descAbreviadaTipoPavimentoRua;
	}

	public String getDescAbreviadaTipoPavimentoCalcada() {
		return descAbreviadaTipoPavimentoCalcada;
	}

	public void setDescAbreviadaTipoPavimentoCalcada(String descAbreviadaTipoPavimentoCalcada) {
		this.descAbreviadaTipoPavimentoCalcada = descAbreviadaTipoPavimentoCalcada;
	}
