...
public class ImovelMicromedicao implements Serializable {
    ...
    private gsan.micromedicao.medicao.MedicaoHistorico medicaoHistorico;
    
    private gsan.micromedicao.consumo.ConsumoHistorico consumoHistorico;
    
    private gsan.micromedicao.consumo.ConsumoHistorico consumoHistoricoEsgoto;
	...
	public gsan.micromedicao.consumo.ConsumoHistorico getConsumoHistorico() {
	...
	public gsan.micromedicao.medicao.MedicaoHistorico getMedicaoHistorico() {
		return medicaoHistorico;
	}

	public void setMedicaoHistorico(
			gsan.micromedicao.medicao.MedicaoHistorico medicaoHistorico) {
	...
	public gsan.micromedicao.consumo.ConsumoHistorico getConsumoHistoricoEsgoto() {
		return consumoHistoricoEsgoto;
	}

	public void setConsumoHistoricoEsgoto(
			gsan.micromedicao.consumo.ConsumoHistorico consumoHistoricoEsgoto) {
