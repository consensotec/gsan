...
public class ImovelGeracaoTabelasTemporariasCadastroHelper  implements Serializable {
	...
	private ParametroTabelaAtualizacaoCadastro parametro;
	...
	public ParametroTabelaAtualizacaoCadastro getParametro() {
		return parametro;
	}

	public void setParametro(ParametroTabelaAtualizacaoCadastro parametro) {
