...
public class FiltroEmpresaContratoCobranca extends Filtro implements Serializable {
     ...
     */
    public FiltroEmpresaContratoCobranca(String campoOrderBy) {
     ...
     */
    public FiltroEmpresaContratoCobranca() {
    }
