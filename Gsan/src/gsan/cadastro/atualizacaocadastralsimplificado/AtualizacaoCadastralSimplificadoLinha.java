...
public class AtualizacaoCadastralSimplificadoLinha {
	...
	public AtualizacaoCadastralSimplificadoLinha(String[] dados, Integer numeroLinha) throws NumberFormatException {
		if (numeroLinha != null)
		...
		if (dados[10] != null && !"".equals(dados[10].trim())){
			numeroRG = removerCharInvalidos(dados[10]);
			try{
				if (numeroRG != null)
					new BigInteger(numeroRG);
			} catch (NumberFormatException numberFormatException) {
				throw new ActionServletException("erro.atualizacao_cadastral_simplificado.campo_nao_numerico", new String[]{"RG", dados[1], dados[10]});
			}
		}
		...
		if (dados[22] != null && !"".equals(dados[22].trim())){
			try{
				...
				throw new ActionServletException("erro.atualizacao_cadastral_simplificado.campo_nao_numerico", new String[]{"CEP", dados[1], removerCharInvalidos(dados[22])});
			}
		}
		...
		if (dados[26] != null && !"".equals(dados[26].trim()))
			sexoCliente = dados[26];
	}
	...
	public String toString() {
		...
		sb.append("Sexo do Cliente: 	" + getSexoCliente() + "\n");
		sb
				.append("------------------------------------------------------------\n");
		return sb.toString();
	}
