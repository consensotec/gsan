...
public class TarifaSocialDadoEconomia extends ObjetoTransacao { 
	...
	/** persistent field */
	// private gsan.cadastro.tarifasocial.TarifaSocialDado tarifaSocialDado;
	/** persistent field */
	...
	private gsan.cadastro.tarifasocial.RendaTipo rendaTipo;

	/** persistent field */
	@ControleAlteracao(value=FiltroTarifaSocialDadoEconomia.TARIFA_SOCIAL_CARTAO_TIPO, 
			funcionalidade={ATRIBUTOS_INSERIR_TARIFA_SOCIAL,ATRIBUTOS_MANTER_TARIFA_SOCIAL})	
	private gsan.cadastro.tarifasocial.TarifaSocialCartaoTipo tarifaSocialCartaoTipo;
...
//			funcionalidade={ATRIBUTOS_MANTER_TARIFA_SOCIAL, ATRIBUTOS_INSERIR_TARIFA_SOCIAL})		
	...
	public TarifaSocialDadoEconomia(
			...
			gsan.cadastro.tarifasocial.RendaTipo rendaTipo,
			gsan.cadastro.tarifasocial.TarifaSocialCartaoTipo tarifaSocialCartaoTipo,
	...
	public gsan.cadastro.tarifasocial.RendaTipo getRendaTipo() {
		return this.rendaTipo;
	}

	public void setRendaTipo(gsan.cadastro.tarifasocial.RendaTipo rendaTipo) {
		this.rendaTipo = rendaTipo;
	}

	public gsan.cadastro.tarifasocial.TarifaSocialCartaoTipo getTarifaSocialCartaoTipo() {
