...
public class UnidadeOrganizacional extends ObjetoTransacao {
    ...
    /** persistent field */
    private gsan.cadastro.unidade.UnidadeTipo unidadeTipo;
    ...
    /** persistent field */
    private gsan.cadastro.unidade.UnidadeOrganizacional unidadeCentralizadora;
    
    private gsan.cadastro.unidade.UnidadeOrganizacional unidadeRepavimentadora;    
 
    /** persistent field */
    private gsan.cadastro.unidade.UnidadeOrganizacional unidadeSuperior;
    ...
    public UnidadeOrganizacional(short indicadorEsgoto, short indicadorTramite, String descricao, 
    		...
    		short indicadorUso, gsan.cadastro.unidade.UnidadeTipo unidadeTipo, 
    		MeioSolicitacao meioSolicitacao, Empresa empresa, Localidade localidade, 
    		GerenciaRegional gerenciaRegional, gsan.cadastro.unidade.UnidadeOrganizacional unidadeCentralizadora, 
    		gsan.cadastro.unidade.UnidadeOrganizacional unidadeRepavimentadora,
    		gsan.cadastro.unidade.UnidadeOrganizacional unidadeSuperior,
    ...
    /** minimal constructor */
    public UnidadeOrganizacional(short indicadorEsgoto, short indicadorTramite, String descricao, 
    		Date ultimaAlteracao, short indicadorUso, gsan.cadastro.unidade.UnidadeTipo unidadeTipo, 
    		MeioSolicitacao meioSolicitacao, Empresa empresa, Localidade localidade, 
    		GerenciaRegional gerenciaRegional, gsan.cadastro.unidade.UnidadeOrganizacional unidadeCentralizadora, 
    		gsan.cadastro.unidade.UnidadeOrganizacional unidadeRepavimentadora,
    		gsan.cadastro.unidade.UnidadeOrganizacional unidadeSuperior,Short indicadorCentralAtendimento, 
    ...
    public gsan.cadastro.unidade.UnidadeTipo getUnidadeTipo() {
        return this.unidadeTipo;
    }

    public void setUnidadeTipo(gsan.cadastro.unidade.UnidadeTipo unidadeTipo) {
        this.unidadeTipo = unidadeTipo;
    }
    ...
    public gsan.cadastro.unidade.UnidadeOrganizacional getUnidadeCentralizadora() {
        return this.unidadeCentralizadora;
    }

    public void setUnidadeCentralizadora(gsan.cadastro.unidade.UnidadeOrganizacional unidadeCentralizadora) {
        this.unidadeCentralizadora = unidadeCentralizadora;
    }

    public gsan.cadastro.unidade.UnidadeOrganizacional getUnidadeSuperior() {
        return this.unidadeSuperior;
    }

    public void setUnidadeSuperior(gsan.cadastro.unidade.UnidadeOrganizacional unidadeSuperior) {
        this.unidadeSuperior = unidadeSuperior;
    }
	 ...
	 */
	public gsan.cadastro.unidade.UnidadeOrganizacional getUnidadeRepavimentadora() {
