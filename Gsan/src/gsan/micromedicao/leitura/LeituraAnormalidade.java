 ...
 * 02111-1307, USA.
 */
package gsan.micromedicao.leitura;
...
public class LeituraAnormalidade extends ObjetoTransacao {
	...
	public LeituraAnormalidade(
			...
			gsan.micromedicao.leitura.LeituraAnormalidadeLeitura leituraAnormalidadeLeituraComleitura,
			gsan.micromedicao.leitura.LeituraAnormalidadeLeitura leituraAnormalidadeLeituraSemleitura,
			gsan.micromedicao.leitura.LeituraAnormalidadeConsumo leituraAnormalidadeConsumoComleitura,
			gsan.micromedicao.leitura.LeituraAnormalidadeConsumo leituraAnormalidadeConsumoSemleitura,
	 ...
	 */
	public gsan.micromedicao.leitura.LeituraAnormalidadeLeitura getLeituraAnormalidadeLeituraComleitura() {
	 ...
	 */
	public gsan.micromedicao.leitura.LeituraAnormalidadeLeitura getLeituraAnormalidadeLeituraSemleitura() {
	 ...
	 */
	public gsan.micromedicao.leitura.LeituraAnormalidadeConsumo getLeituraAnormalidadeConsumoComleitura() {
	 ...
	 */
	public gsan.micromedicao.leitura.LeituraAnormalidadeConsumo getLeituraAnormalidadeConsumoSemleitura() {
