...
public class MovimentoRoteiroEmpresa implements Serializable {
   ...
   // private String descricaoAbreviadaCategoriaImovel2;
	...
	//RM12125 - Faturar consumo medido em ligações novas
    ...
    public MovimentoRoteiroEmpresa(Integer id, Integer anoMesMovimento, Integer codigoSetorComercial, 
    		...
    		gsan.micromedicao.RoteiroEmpresa roteiroEmpresa, LigacaoAguaSituacao ligacaoAguaSituacao, 
    ...
    public MovimentoRoteiroEmpresa(Integer id, Integer anoMesMovimento, Integer codigoSetorComercial, 
    		...
    		HidrometroLocalInstalacao hidrometroLocalInstalacao, gsan.micromedicao.RoteiroEmpresa roteiroEmpresa, 
