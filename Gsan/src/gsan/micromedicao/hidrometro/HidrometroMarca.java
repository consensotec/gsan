...
public class HidrometroMarca extends ObjetoTransacao {
	...
	public Short getIndicadorMicro() {
		return indicadorMicro;
	}

	public void setIndicadorMicro(Short indicadorMicro) {
		this.indicadorMicro = indicadorMicro;
	}
