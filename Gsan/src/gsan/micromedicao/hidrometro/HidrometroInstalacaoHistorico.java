...
public class HidrometroInstalacaoHistorico extends ObjetoTransacao {
	...
	private gsan.micromedicao.hidrometro.HidrometroProtecao hidrometroProtecao;
	...
	@ControleAlteracao(value=FiltroHidrometroInstalacaoHistorico.HIDROMETRO_LOCAL_INSTALACAO,
			funcionalidade={LigacaoAgua.ATRIBUTOS_EFETUAR_LIGACAO_AGUA_INSTALACAO_HIDROMETRO,
				...
				ATRIBUTOS_EFETUAR_INSTALACAO_HIDROMETRO, ATRIBUTOS_EFETUAR_SUBSTITUICAO_HIDROMETRO,
				ATRIBUTOS_ATUALIZAR_INSTALACAO_HIDROMETRO})
	private gsan.micromedicao.hidrometro.HidrometroLocalInstalacao hidrometroLocalInstalacao;
	...
	public HidrometroInstalacaoHistorico(
			...
			Imovel imovel,
			gsan.micromedicao.hidrometro.HidrometroProtecao hidrometroProtecao,
			gsan.micromedicao.hidrometro.Hidrometro hidrometro,
			RateioTipo rateioTipo,
			gsan.micromedicao.hidrometro.HidrometroLocalInstalacao hidrometroLocalInstalacao,
	...
	public gsan.micromedicao.hidrometro.HidrometroProtecao getHidrometroProtecao() {
	...
	public gsan.micromedicao.hidrometro.HidrometroLocalInstalacao getHidrometroLocalInstalacao() {
