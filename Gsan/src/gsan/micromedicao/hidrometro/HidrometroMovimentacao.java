...
public class HidrometroMovimentacao implements Serializable {
	...
	/** persistent field */
	private gsan.micromedicao.hidrometro.HidrometroMotivoMovimentacao hidrometroMotivoMovimentacao;

	/** persistent field */
	private gsan.micromedicao.hidrometro.HidrometroLocalArmazenagem hidrometroLocalArmazenagemDestino;

	/** persistent field */
	private gsan.micromedicao.hidrometro.HidrometroLocalArmazenagem hidrometroLocalArmazenagemOrigem;
	...
	public HidrometroMovimentacao(
			...
			gsan.micromedicao.hidrometro.HidrometroMotivoMovimentacao hidrometroMotivoMovimentacao,
			gsan.micromedicao.hidrometro.HidrometroLocalArmazenagem hidrometroLocalArmazenagemDestino,
			gsan.micromedicao.hidrometro.HidrometroLocalArmazenagem hidrometroLocalArmazenagemOrigem,
			Usuario usuario) {
		this.data = data;
		this.hora = hora;
	...
	public gsan.micromedicao.hidrometro.HidrometroMotivoMovimentacao getHidrometroMotivoMovimentacao() {
	...
	public gsan.micromedicao.hidrometro.HidrometroLocalArmazenagem getHidrometroLocalArmazenagemDestino() {
	...
	public gsan.micromedicao.hidrometro.HidrometroLocalArmazenagem getHidrometroLocalArmazenagemOrigem() {
