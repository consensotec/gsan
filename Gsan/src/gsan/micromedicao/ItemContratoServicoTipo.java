...
public class ItemContratoServicoTipo implements Serializable {
	...
	private gsan.micromedicao.ItemContratoServicoTipoPK comp_id;
	...
	public gsan.micromedicao.ItemContratoServicoTipoPK getComp_id() {
		return comp_id;
	}


	public void setComp_id(gsan.micromedicao.ItemContratoServicoTipoPK comp_id) {
		this.comp_id = comp_id;
	}
