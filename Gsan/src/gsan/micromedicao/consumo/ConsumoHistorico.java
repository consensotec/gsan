...
public class ConsumoHistorico extends ObjetoTransacao {
	...
	/** persistent field */
	private gsan.micromedicao.consumo.ConsumoHistorico consumoHistoricoCondominio;

	/** persistent field */
	private gsan.micromedicao.consumo.ConsumoTipo consumoTipo;

	/** persistent field */
	private RateioTipo rateioTipo;

	/** persistent field */
	private gsan.micromedicao.consumo.LigacaoTipo ligacaoTipo;

	/** persistent field */
	private gsan.micromedicao.consumo.ConsumoAnormalidade consumoAnormalidade;
	...
	public ConsumoHistorico(
			...
			gsan.micromedicao.consumo.ConsumoHistorico consumoHistoricoCondominio,
			gsan.micromedicao.consumo.ConsumoTipo consumoTipo,
			RateioTipo rateioTipo,
			gsan.micromedicao.consumo.LigacaoTipo ligacaoTipo,
			gsan.micromedicao.consumo.ConsumoAnormalidade consumoAnormalidade,
	...
	public gsan.micromedicao.consumo.ConsumoHistorico getConsumoHistoricoCondominio() {
	...
	public gsan.micromedicao.consumo.ConsumoTipo getConsumoTipo() {
		return this.consumoTipo;
	}

	public void setConsumoTipo(gsan.micromedicao.consumo.ConsumoTipo consumoTipo) {
		this.consumoTipo = consumoTipo;
	}
	...
	public gsan.micromedicao.consumo.LigacaoTipo getLigacaoTipo() {
		return this.ligacaoTipo;
	}

	public void setLigacaoTipo(gsan.micromedicao.consumo.LigacaoTipo ligacaoTipo) {
		this.ligacaoTipo = ligacaoTipo;
	}

	public gsan.micromedicao.consumo.ConsumoAnormalidade getConsumoAnormalidade() {
