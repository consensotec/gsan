...
* 02111-1307, USA.
*/  
package gsan.micromedicao.medicao;
...
public class MedicaoHistoricoAnterior implements Serializable {
    ...
    /** persistent field */
    private gsan.micromedicao.medicao.MedicaoTipo medicaoTipo;

    /** persistent field */
    private gsan.cadastro.imovel.Imovel imovel;

    /** persistent field */
    private gsan.cadastro.funcionario.Funcionario funcionario;

    /** persistent field */
    private gsan.micromedicao.leitura.LeituraSituacao leituraSituacaoAnterior;

    /** persistent field */
    private gsan.micromedicao.leitura.LeituraSituacao leituraSituacaoAtual;

    /** persistent field */
    private gsan.atendimentopublico.ligacaoagua.LigacaoAgua ligacaoAgua;

    /** persistent field */
    private gsan.micromedicao.leitura.LeituraAnormalidade leituraAnormalidadeInformada;

    /** persistent field */
    private gsan.micromedicao.leitura.LeituraAnormalidade leituraAnormalidadeFaturamento;
	...
	public gsan.cadastro.funcionario.Funcionario getFuncionario() {
		return funcionario;
	}
	...
	public void setFuncionario(gsan.cadastro.funcionario.Funcionario funcionario) {
	...
	public gsan.micromedicao.leitura.LeituraAnormalidade getLeituraAnormalidadeFaturamento() {
	...
	public void setLeituraAnormalidadeFaturamento(
			gsan.micromedicao.leitura.LeituraAnormalidade leituraAnormalidadeFaturamento) {
	...
	public gsan.micromedicao.leitura.LeituraAnormalidade getLeituraAnormalidadeInformada() {
	...
	public void setLeituraAnormalidadeInformada(
			gsan.micromedicao.leitura.LeituraAnormalidade leituraAnormalidadeInformada) {
	...
	public gsan.micromedicao.leitura.LeituraSituacao getLeituraSituacaoAnterior() {
	...
	public void setLeituraSituacaoAnterior(
			gsan.micromedicao.leitura.LeituraSituacao leituraSituacaoAnterior) {
	...
	public gsan.micromedicao.leitura.LeituraSituacao getLeituraSituacaoAtual() {
	...
	public void setLeituraSituacaoAtual(
			gsan.micromedicao.leitura.LeituraSituacao leituraSituacaoAtual) {
	...
	public gsan.atendimentopublico.ligacaoagua.LigacaoAgua getLigacaoAgua() {
		return ligacaoAgua;
	}
	...
	public gsan.micromedicao.medicao.MedicaoTipo getMedicaoTipo() {
		return medicaoTipo;
	}
	...
	public void setMedicaoTipo(gsan.micromedicao.medicao.MedicaoTipo medicaoTipo) {
