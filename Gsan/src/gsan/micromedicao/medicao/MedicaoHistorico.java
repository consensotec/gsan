...
public class MedicaoHistorico extends ObjetoTransacao {
	...
	private Usuario usuarioInformouLeitura;
	
	public Usuario getUsuarioInformouLeitura() {
		return usuarioInformouLeitura;
	}

	public void setUsuarioInformouLeitura(Usuario usuarioInformouLeitura) {
		this.usuarioInformouLeitura = usuarioInformouLeitura;
	}
	...
	public MedicaoHistorico(int anoMesReferencia,
			...
			gsan.micromedicao.medicao.MedicaoTipo medicaoTipo) {
