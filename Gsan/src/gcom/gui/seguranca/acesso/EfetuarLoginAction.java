			...
			if (login == null || login.trim().equals("")) {
				...
				if (!this.verificarExistenciaLogin(login)) {
					...
					if (usuarioLogado == null) {
						...
						//seta o tempo máximo que o usuario tem para expirar a sessão da aplicação
						//caso seja batch vai expirar 1500min
						//caso seja online vai expirar em 10min												
						String versaoTipo = (String) servlet.getServletContext().getAttribute("versaoTipo");
						if(versaoTipo.equals("Batch")){
							sessao.setMaxInactiveInterval(90000);
						}else{
