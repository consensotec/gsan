...
/*		FiltroResumoFaturamentoSituacaoEspecial filtroResumoFaturamentoSituacaoEspecial = new FiltroResumoFaturamentoSituacaoEspecial();
		...
		this.validarReferencia(informarResumoSituacaoEspecialFaturamentoActionForm.getMesAnoReferenciaFaturamento());
		
		informarResumoSituacaoEspecialFaturamentoActionForm.setMesAnoReferenciaFaturamento(Util.formatarMesAnoParaAnoMesSemBarra(
			informarResumoSituacaoEspecialFaturamentoActionForm.getMesAnoReferenciaFaturamento()));
		...
		//Formatação Para ser exibido na tela no formato (MM/AAAA)
		informarResumoSituacaoEspecialFaturamentoActionForm.setMesAnoReferenciaFaturamento(Util.formatarAnoMesParaMesAno(informarResumoSituacaoEspecialFaturamentoActionForm.getMesAnoReferenciaFaturamento()));
...
/*		for (Iterator iter = colecaoRFSE.iterator(); iter.hasNext();) {
	...
	private void validarReferencia(String mesAno) {
		if(mesAno != null && !mesAno.trim().equals("")){	
			if(Util.validarAnoMesInvalido(mesAno,"mm/yyyy")){
				throw new ActionServletException("atencao.mes_ano_faturamento_invalida",null,"");
			}
		}else{
	...
	private ConsultarResumoSituacaoEspecialHelper montarHelper(InformarResumoSituacaoEspecialFaturamentoActionForm form) {
		...
		if(form.getMesAnoReferenciaFaturamento() != null && !form.getMesAnoReferenciaFaturamento().trim().equals("")){
			retorno.setMesAnoReferenciaFaturamento(form.getMesAnoReferenciaFaturamento());			
		}
