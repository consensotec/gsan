 ...
 * a tela parcelamento_debitos_efetuar_portal_caer.jsp e para executar
...
public class EfetuarParcelamentoDebitosPortalSaaeActionForm extends ValidatorActionForm {
	...
	private String indicadorFormaCobranca;  
	...
	private String descontoSobreDebitoTotal;
	private String email;
	
	public String getDescontoSobreDebitoTotal() {
		return descontoSobreDebitoTotal;
	}

	public void setDescontoSobreDebitoTotal(String descontoSobreDebitoTotal) {
		this.descontoSobreDebitoTotal = descontoSobreDebitoTotal;
	}

	private String numeroReparcelamento;
	private String areaConstruidaImovel;
	...
	public String getIndicadorFormaCobranca() {
		return indicadorFormaCobranca;
	}

	public void setIndicadorFormaCobranca(String indicadorFormaCobranca) {
		this.indicadorFormaCobranca = indicadorFormaCobranca;
	}
	...
	public String getAreaConstruidaImovel() {
		return areaConstruidaImovel;
	}

	public void setAreaConstruidaImovel(String areaConstruidaImovel) {
