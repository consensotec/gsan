...
public class EfetuarParcelamentoDebitosPortalSaaeAction extends GcomAction {
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm,
		...
		// Usuário responsável por fazer o parcelamneto no portal será por padrão usuário internet.
        ...
        // Recupera da sessão as opções de parcelamento para verificar se foi selecionada alguma opção de parcelamento.
		...
		// Configura o cliente responsável pelo parcelamento que será o cliente cujo CPF foi digitado na tela
	...
	public boolean verificarValorEntradaMinimaPermitida(Short numeroPrestacoesSelecionada, BigDecimal valorEntrada,
		...
		if (ConstantesSistema.SIM.equals(parcelamentoPerfil.getIndicadorEntradaMinima())) {
			...
			// O sistema verifica se a entrada informada é menor que o valor 
