 ...
 * @date 08/07/2011
 */
public class RelatorioDocumentosParcelamentoPortalCaemaBean implements RelatorioBean {
	 ...
	 */
	public RelatorioDocumentosParcelamentoPortalCaemaBean(String matriculaImovel,
			String nomeCliente,
			String endereco, 
			String cpfCnpj,
			String telefone, 
