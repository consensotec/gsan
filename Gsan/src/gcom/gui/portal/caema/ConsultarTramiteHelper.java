...
public class ConsultarTramiteHelper{
	
	
	private String protocolo;
	
	private String raSituacao;
	...
	private String dataHoraTramite;
	...
	public String getRaSituacao() {
		return raSituacao;
	}

	public void setRaSituacao(String raSituacao) {
		this.raSituacao = raSituacao;
	}
	...
	public void setIdUnidadeAtual(String idUnicadeAtual) {
		this.idUnidadeAtual = idUnicadeAtual;
	}
	...
	public String getDataHoraTramite() {
		return dataHoraTramite;
	}

	public void setDataHoraTramite(String dataHoraTramite) {
