 ...
 * 
 */
public class GerarRelatorioDocumentosParcelamentoPortalCaemaAction extends ExibidorProcessamentoTarefaRelatorio {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		TarefaRelatorio relatorioParcelamento = (TarefaRelatorio) fachada.gerarRelatorioDocumentosParcelamentoCobrancaPortal(usuario, idParcelamento, 
				unidadeUsuario, colecaoFaturasEmAberto, colecaoGuiasPagamento, colecaoCreditoARealizar, colecaoServicosACobrar , "CAEMA");
