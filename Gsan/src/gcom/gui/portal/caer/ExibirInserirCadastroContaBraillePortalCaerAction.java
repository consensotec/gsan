 ...
 * @date 18/06/2015
 */
public class ExibirInserirCadastroContaBraillePortalCaerAction extends
		GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping.findForward("exibirInserirCadastroContaBraillePortalCaer");
		
		Fachada fachada = Fachada.getInstancia();
		
		InserirCadastroContaBraillePortalCaerActionForm form = (InserirCadastroContaBraillePortalCaerActionForm) actionForm;
		
		String ip = httpServletRequest.getRemoteAddr(); 
		Fachada.getInstancia().verificarExistenciaAcessoLojaVirtual(ip, AcessoLojaVirtual.SOLICITAR_CONTA_BRAILLE, AcessoLojaVirtual.INDICADOR_SERVICO_NAO_EXECUTADO); 
