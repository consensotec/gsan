...
public class RelatorioDocumentosParcelamentoPortalCaer extends TarefaRelatorio {
	...
	public Object executar() throws TarefaException {
		...
		if (parcelamentoRelatorioHelper != null) {
			...
			relatorioParcelamentoBean.setBairro(parcelamentoRelatorioHelper.getBairro());
			relatorioParcelamentoBean.setCodigoRota(parcelamentoRelatorioHelper.getCodigoRota().toString());
			relatorioParcelamentoBean.setRgClienteResponsavel(rgClienteResponsavel);
			relatorioParcelamentoBean.setEnderecoResponsavel(parcelamentoRelatorioHelper.getEnderecoResponsavel());
			relatorioParcelamentoBean.setBairroImovelResponsavel(parcelamentoRelatorioHelper.getBairroImovelResponsavel());
			...
			String mensagemReferenciaDocumentos = "";
			if(menorAnoMesReferenciaDocumento != null && !menorAnoMesReferenciaDocumento.equals(new Integer(0))){
				mensagemReferenciaDocumentos = "REFERENTE AOS MESES DE " + Util.formatarAnoMesParaMesAno(menorAnoMesReferenciaDocumento)
						+" A "+ Util.formatarAnoMesParaMesAno(maiorAnoMesReferenciaDocumento);
			}
			relatorioParcelamentoBean.setMensagemReferenciaDocumentos(mensagemReferenciaDocumentos);
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_DOCUMENTOS_PARCELAMENTO_LOJA_VIRTUAL_CAER, parametros, ds, tipoFormatoRelatorio);
