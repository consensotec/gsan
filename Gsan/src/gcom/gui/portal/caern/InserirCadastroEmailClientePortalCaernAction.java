...
/**
 * [RM1906] Inserir Cadastro Email Cliente - Loja Virtual da CAERN
 * 
 * @author Rafael Pinto
 * 
 * @date 22/07/2013
 */
public class InserirCadastroEmailClientePortalCaernAction extends GcomAction {
	public ActionForward execute(ActionMapping actionMapping,
		...
		InserirCadastroEmailClientePortalCaernActionForm form = 
				(InserirCadastroEmailClientePortalCaernActionForm) actionForm;
		...
		if (httpServletRequest.getParameter("confirmar") == null || 
			...
			if (httpServletRequest.getParameter("enviarEmail") != null && 
				...
				String url = urlAcessoInternet 
					+ "/inserirCadastroEmailClientePortalCaernAction.do?id=" 
					+ idIncluido
				    + "&confirmar=sim&idImovel=" 
					+ form.getMatricula();
				
				mensagem = mensagem
					+ " - Você acessou o site da CAERN para cadastrar seu email e/ou alterar os dados cadastrais ? Caso positivo clique no link abaixo:  \n \n \n"
					+ url
