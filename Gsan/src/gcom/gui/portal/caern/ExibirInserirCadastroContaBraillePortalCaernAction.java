 ...
 * @date 25/05/2015
 */
public class ExibirInserirCadastroContaBraillePortalCaernAction extends
		GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping.findForward("exibirInserirCadastroContaBraillePortalCaern");
