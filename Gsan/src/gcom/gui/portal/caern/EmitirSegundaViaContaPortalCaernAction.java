 ...
 * @date 17/07/2013
 */
public class EmitirSegundaViaContaPortalCaernAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		try {
			...
			EmitirSegundaViaContaPortalCaernActionForm form = (EmitirSegundaViaContaPortalCaernActionForm) actionForm;
			...
			if (form.getMatricula() != null && !form.getMatricula().equals("")) {
				...
				if (colecaoContasValores == null || colecaoContasValores.isEmpty()) {
					...
					retorno = actionMapping.findForward("emitirSegundaViaContaPortalCaernAction");
