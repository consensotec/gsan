...
public class SessaoHttpListener implements HttpSessionListener ,HttpSessionAttributeListener{
	...
	public static final Map<String, HttpSession> listaSessoesAtivasGis = new HashMap<String, HttpSession>();
	...
	public void sessionCreated(HttpSessionEvent e) {
		...
		session.setAttribute("org.apache.struts.action.LOCALE", new Locale("pt", "BR"));
	}	
