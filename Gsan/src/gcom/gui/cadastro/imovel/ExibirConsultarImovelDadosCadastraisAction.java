...
public class ExibirConsultarImovelDadosCadastraisAction extends GcomAction {
        ...
        if( isLimparDadosTela(httpServletRequest)){
            ...
            if (imovel != null) {
                ...
                if(indicadorClienteCorporativo != null && indicadorClienteCorporativo.equals(ConstantesSistema.SIM.toString())){
                	sessao.setAttribute("imovelPerfilEnquadramento", true);                
                }else{
                	sessao.removeAttribute("imovelPerfilEnquadramento");
                }
	...
	private void setarDadosImovelNoFormESessao(ConsultarImovelActionForm consultarImovelActionForm, 
		...
		if(imovel.getQuadra().getAreaTipo() != null){
			consultarImovelActionForm.setTipoAreaQuadraDadosCadastrais(imovel.getQuadra().getAreaTipo().getDescricao());
		} else {
			consultarImovelActionForm.setTipoAreaQuadraDadosCadastrais("");
		}
	...
	private void limparFormSessao(ConsultarImovelActionForm consultarImovelActionForm,
		...
		consultarImovelActionForm.setTipoAreaQuadraDadosCadastrais(null);
