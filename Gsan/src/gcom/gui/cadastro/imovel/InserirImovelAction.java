...
//		//Valida valores das coordenadas
		...
		//8.3 Caso tenha alterado o perfil e o perfil anterior ou o novo perfil tenha permissão especial
		//insere o histórico do enquadramento/desenquadramento na tabela CADASTRO.IMOVEL_HISTORICO_PERFIL
		inserirImovelHelper.getImovel().setId(id);		
		fachada.atualizarHistoricoEnquadramentoPerfil(inserirImovelHelper.getImovel(), inserirImovelHelper.getUsuario(), null, PerfilAlteracaoMotivo.INCLUSAO_CADASTRO);
