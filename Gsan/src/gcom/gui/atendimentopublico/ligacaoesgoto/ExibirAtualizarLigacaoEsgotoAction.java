...
public class ExibirAtualizarLigacaoEsgotoAction extends GcomAction {
	...
	private void setLigacaoEsgotoForm(
		...
		filtroLigacaoEsgoto.adicionarCaminhoParaCarregamentoEntidade("ligacaoOrigem");
		filtroLigacaoEsgoto.adicionarCaminhoParaCarregamentoEntidade("ligacaoEsgotoPerfil");
		Collection colecaoLigacaoEsgoto = getFachada().pesquisar(filtroLigacaoEsgoto, LigacaoEsgoto.class.getName());
...
//			 -----------------------------------------------------------
			...
			if(ligacaoEsgoto.getNumeroConsumoPercentualAlternativo()!=null)
				ligacaoEsgotoActionForm.setLimiteConsumoAlternativo(ligacaoEsgoto.getNumeroConsumoPercentualAlternativo().toString());
			
			if(ligacaoEsgoto.getPercentualAlternativo()!=null)
				ligacaoEsgotoActionForm.setPercentualAlternativoEsgoto(ligacaoEsgoto.getPercentualAlternativo().toString().replace(".",","));
