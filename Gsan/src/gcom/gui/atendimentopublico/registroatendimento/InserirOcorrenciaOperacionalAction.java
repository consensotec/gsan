 ...
 * @date 11/07/2013
 */
public class InserirOcorrenciaOperacionalAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest,
		...
		// INSERINDO OCORRENCIA OPERACIONAL
		Integer id = fachada.inserirOcorrenciaOperacional(ocorrenciaOperacional, usuarioLogado);

		montarPaginaSucesso(httpServletRequest, "Ocorrência Operacional de código "
				+ id
				+ " inserida com sucesso.", "Inserir outra Ocorrência Operacional", "exibirInserirOcorrenciaOperacionalAction.do?menu=sim", 
				"exibirAtualizarOcorrenciaOperacionalAction.do?idOcorrenciaOperacional="
				+ id, "Atualizar Ocorrência Operacional inserida");
	...
	private OcorrenciaOperacional getOcorrenciaOperacional(InserirOcorrenciaOperacionalActionForm form, Fachada fachada) {
