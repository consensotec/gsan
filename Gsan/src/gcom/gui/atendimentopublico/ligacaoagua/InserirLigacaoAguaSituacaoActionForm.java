...
public class InserirLigacaoAguaSituacaoActionForm extends ValidatorActionForm {
	...
	private String indicadorFaturarLeituraReal;
	
	private String indicadorFaturarConsumoReal;
	...
	public String getIndicadorFaturarLeituraReal() {
		return indicadorFaturarLeituraReal;
	}

	public void setIndicadorFaturarLeituraReal(String indicadorFaturarLeituraReal) {
		this.indicadorFaturarLeituraReal = indicadorFaturarLeituraReal;
	}

	public String getIndicadorFaturarConsumoReal() {
		return indicadorFaturarConsumoReal;
	}

	public void setIndicadorFaturarConsumoReal(String indicadorFaturarConsumoReal) {
		this.indicadorFaturarConsumoReal = indicadorFaturarConsumoReal;
	}
