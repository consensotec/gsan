...
public class ExibirInserirLigacaoAguaSituacaoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		inserirLigacaoAguaSituacaoActionForm.setIndicadorFaturarConsumoReal(""+ ConstantesSistema.INDICADOR_USO_ATIVO);
		inserirLigacaoAguaSituacaoActionForm.setIndicadorFaturarLeituraReal(""+ ConstantesSistema.INDICADOR_USO_ATIVO);
		...
		if (httpServletRequest.getParameter("desfazer") != null && httpServletRequest
			...
			inserirLigacaoAguaSituacaoActionForm.setIndicadorFaturarConsumoReal("");
			inserirLigacaoAguaSituacaoActionForm.setIndicadorFaturarLeituraReal("");
