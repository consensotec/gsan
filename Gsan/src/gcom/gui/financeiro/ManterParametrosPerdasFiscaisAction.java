...
/**
 * [UC1388] Manter Parametros de Perdas Fiscais
 *
...
public class ManterParametrosPerdasFiscaisAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
    	...
    	if(form.getValorABaixar() != null && !form.getValorABaixar().equals("")){
			...
			fachada.atualizarValorABaixarParametrosDevedoresDuvidosos(parametrosPerdasFiscaisHelper);
		} else {
			throw new ActionServletException("atencao.campo_selecionado.obrigatorio",null,"o Valor máximo das perdas fiscais");
		}

   		// Monta a página de sucesso
    	montarPaginaSucesso(httpServletRequest, "Vigência a partir da referencia contabil "+ form.getAnoMesReferenciaContabil() +
				" atualizada com sucesso.", "Realizar outra Manutenção dos Parametros de Perdas Fiscais",
