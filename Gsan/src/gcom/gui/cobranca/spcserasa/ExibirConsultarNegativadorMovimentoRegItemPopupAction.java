...
public class ExibirConsultarNegativadorMovimentoRegItemPopupAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (negativadorMovimentoReg == null) {
			...
			filtroNegativadorMovimento.adicionarCaminhoParaCarregamentoEntidade("imovel.ligacaoAguaSituacao");
			filtroNegativadorMovimento.adicionarCaminhoParaCarregamentoEntidade("imovel.ligacaoEsgotoSituacao");
		...
		if((negativadorMovimentoReg != null && !negativadorMovimentoReg.equals("")) ||
			...
			if (negativadorMovimentoReg != null){
			  ...
			  if(negativadorMovimentoReg.getImovel()!= null){
				  ...
				  imovel = fachada.pesquisarImovelDigitado(Integer.parseInt(form.getMatriculaImovel()));
			 ...
			 }else if(imovel.getLigacaoAguaSituacao() != null){
			 ...
			 }else if(imovel.getLigacaoEsgotoSituacao() != null){
