...
//\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\		
		...
		}else if(dadosConsultaNegativacaoHelper.getTituloComando() != null && !dadosConsultaNegativacaoHelper.getTituloComando().equals("")){
		...
		}else if(dadosConsultaNegativacaoHelper.getPeriodoEnvioNegativacaoInicio() != null && !dadosConsultaNegativacaoHelper.getPeriodoEnvioNegativacaoInicio().equals("")){
		...
		}else if(dadosConsultaNegativacaoHelper.getPeriodoEnvioNegativacaoFim() != null && !dadosConsultaNegativacaoHelper.getPeriodoEnvioNegativacaoFim().equals("")){
		...
		}else if(dadosConsultaNegativacaoHelper.getIdEloPolo() != null && !dadosConsultaNegativacaoHelper.getIdEloPolo().equals("")){
		...
		}else if(dadosConsultaNegativacaoHelper.getDescricaoEloPolo() != null && !dadosConsultaNegativacaoHelper.getDescricaoEloPolo().equals("")){
		...
		}else if(dadosConsultaNegativacaoHelper.getIdLocalidade() != null && !dadosConsultaNegativacaoHelper.getIdLocalidade().equals("")){
		...
		}else if(dadosConsultaNegativacaoHelper.getDescricaoLocalidade() != null && !dadosConsultaNegativacaoHelper.getDescricaoLocalidade().equals("")){
		...
		}else if(dadosConsultaNegativacaoHelper.getIdSetorComercial() != null && !dadosConsultaNegativacaoHelper.getIdSetorComercial().equals("")){
		...
		}else if(dadosConsultaNegativacaoHelper.getDescricaoSetorComercial() != null && !dadosConsultaNegativacaoHelper.getDescricaoSetorComercial().equals("")){
		...
		}else if(dadosConsultaNegativacaoHelper.getIdQuadra() != null && !dadosConsultaNegativacaoHelper.getIdQuadra().equals("")){
		...
		}else if(dadosConsultaNegativacaoHelper.getDescricaoQuadra() != null && !dadosConsultaNegativacaoHelper.getDescricaoQuadra().equals("")){
			form.setDescricaoQuadra(String.valueOf(dadosConsultaNegativacaoHelper.getDescricaoQuadra()));			
		}
		
		form.setCollCobrancaGrupo(dadosConsultaNegativacaoHelper.getColecaoCobrancaGrupo());
