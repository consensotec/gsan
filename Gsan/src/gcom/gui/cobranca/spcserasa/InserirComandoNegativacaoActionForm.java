...
public class InserirComandoNegativacaoActionForm extends ValidatorActionForm {
	...
	public void reset(){
		...
		this.clienteObrigatorio = null;
		this.idNegativador = null;
		this.tipo = null;
		this.nomeNegativador = null;
		this.identificacaoCI = null;
		this.idImovelDebitos = null;
		this.matriculaImovelDebitos = null;
		this.situacaoEsgotoDebitos = null;
		this.situacaoAguaDebitos = null;
		this.codigoImovel = null;
		this.tipoRelacao = null;
		this.referenciaInicial = null;
		this.referenciaFinal = null;
		this.dataVencimentoInicial = null;
		this.dataVencimentoFinal = null;
		this.ligacaoAgua = null;
		this.ligacaoEsgoto = null;
		this.maticula = null;
		this.inscricao = null;
		this.nomeCliente = null;
		this.tipoRelacaoCliente = null;
		this.cpf = null;
		this.cnpj = null;
		this.refInicial = null;
		this.refFinal = null;
		this.dtInicial = null;
		this.dtFinal = null;
		this.enderecoFormatado = null;
		this.clienteSelecionado = null;
		this.idComandoSimulado = null;
		this.descricaoComandoSimulado = null;
		this.dataPrevista = null;
		this.cobrancaSituacaoTipo = null;
		this.cobrancaSituacao = null;
		this.ligacaoAguaSituacao = null;
		this.ligacaoEsgotoSituacao = null;
		this.usuarioInclusao = null;
		this.indicadorImovelCategoriaPublico = null;
	}
