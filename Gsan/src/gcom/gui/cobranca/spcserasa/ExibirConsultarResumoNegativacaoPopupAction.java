...
//  		Collection <DadosConsultaNegativacaoHelper> dadosConsultaNegativacaoHelper = (Collection <DadosConsultaNegativacaoHelper>)sessao.getAttribute("dadosConsultaNegativacaoHelper");
		...
		BigDecimal valorOutros = new BigDecimal(0);
		Integer quantidadeOutros = new Integer(0);
		...
		while(itcolecaoResumoNegativacao.hasNext()){
			...
			if(retumoTotais.getIdSituacaoCobranca() != null && retumoTotais.getIdSituacaoCobranca().equals(1)){ // POTENCIAL
				...
				quantidadeOutros += retumoTotais.getSomatorioQuantidadeInclusoes();

				if (idSituacaoDebito.equals(ConstantesSistema.PENDENTE)){
					quantidadePendente += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorOutros = valorOutros.add(retumoTotais.getSomatorioValorPendente());
				}
				else if (idSituacaoDebito.equals(ConstantesSistema.PAGO)){
					quantidadePago += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorOutros = valorOutros.add(retumoTotais.getSomatorioValorPago());
				}
				else if (idSituacaoDebito.equals(ConstantesSistema.PARCELADO)){
					quantidadeParcelado += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorOutros = valorOutros.add(retumoTotais.getSomatorioValorParcelado());
				}
				else{
					quantidadeCancelado += retumoTotais.getSomatorioQuantidadeInclusoes();
					valorOutros = valorOutros.add(retumoTotais.getSomatorioValorCancelado());
				}
		...
		somatorioTotalQuantidade += quantidadeOutros;
		...
		if(dadosConsultaNegativacaoHelper.getTituloComando() != null && !dadosConsultaNegativacaoHelper.getTituloComando().equals("")){
			form.setTituloComando(dadosConsultaNegativacaoHelper.getTituloComando());
		}
		
		if(dadosConsultaNegativacaoHelper.getPeriodoEnvioNegativacaoInicio() != null && !dadosConsultaNegativacaoHelper.getPeriodoEnvioNegativacaoInicio().equals("")){
			form.setPeriodoEnvioNegativacaoInicio(Util.formatarData(dadosConsultaNegativacaoHelper.getPeriodoEnvioNegativacaoInicio()));			
		}
		
		if(dadosConsultaNegativacaoHelper.getPeriodoEnvioNegativacaoFim() != null && !dadosConsultaNegativacaoHelper.getPeriodoEnvioNegativacaoFim().equals("")){
			form.setPeriodoEnvioNegativacaoFim(Util.formatarData(dadosConsultaNegativacaoHelper.getPeriodoEnvioNegativacaoFim()));			
		}
		
		if(dadosConsultaNegativacaoHelper.getIdEloPolo() != null && !dadosConsultaNegativacaoHelper.getIdEloPolo().equals("")){
			form.setIdEloPolo(Integer.toString(dadosConsultaNegativacaoHelper.getIdEloPolo()));			
		}
		
		if(dadosConsultaNegativacaoHelper.getDescricaoEloPolo() != null && !dadosConsultaNegativacaoHelper.getDescricaoEloPolo().equals("")){
			form.setDescricaoEloPolo(dadosConsultaNegativacaoHelper.getDescricaoEloPolo());			
		}
		
		if(dadosConsultaNegativacaoHelper.getIdLocalidade() != null && !dadosConsultaNegativacaoHelper.getIdLocalidade().equals("")){
			form.setIdLocalidade(String.valueOf(dadosConsultaNegativacaoHelper.getIdLocalidade()));			
		}
		
		if(dadosConsultaNegativacaoHelper.getDescricaoLocalidade() != null && !dadosConsultaNegativacaoHelper.getDescricaoLocalidade().equals("")){
			form.setDescricaoLocalidade(String.valueOf(dadosConsultaNegativacaoHelper.getDescricaoLocalidade()));			
		}
		
		if(dadosConsultaNegativacaoHelper.getIdSetorComercial() != null && !dadosConsultaNegativacaoHelper.getIdSetorComercial().equals("")){
			form.setIdSetorComercial(String.valueOf(dadosConsultaNegativacaoHelper.getIdSetorComercial()));			
		}
		
		if(dadosConsultaNegativacaoHelper.getIdQuadra() != null && !dadosConsultaNegativacaoHelper.getIdQuadra().equals("")){
			form.setIdQuadra(String.valueOf(dadosConsultaNegativacaoHelper.getIdQuadra()));			
		}
		
		if(dadosConsultaNegativacaoHelper.getDescricaoQuadra() != null && !dadosConsultaNegativacaoHelper.getDescricaoQuadra().equals("")){
			form.setDescricaoQuadra(String.valueOf(dadosConsultaNegativacaoHelper.getDescricaoQuadra()));			
		}
