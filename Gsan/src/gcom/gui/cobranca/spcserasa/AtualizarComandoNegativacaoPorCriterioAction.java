...
public class AtualizarComandoNegativacaoPorCriterioAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if (form.getQtdMaximaInclusao() != null
			...
			validarParametroNumerico(form.getQtdMaximaInclusao());
	...
	private void validarParametroNumerico(String valor) {
		if (!valor.matches("[0-9]+")) {
				throw new ActionServletException("atencao.campo.invalido", null,"Quantidade maxima de inclusões");
		}
	}
