...
public class CriterioCobrancaActionForm extends ValidatorActionForm {
	...
	private String indicadorImovelComSitCob;
	...
	public String getIndicadorImovelComSitCob() {
		return indicadorImovelComSitCob;
	}

	public void setIndicadorImovelComSitCob(String indicadorImovelComSitCob) {
		this.indicadorImovelComSitCob = indicadorImovelComSitCob;
	}
