...
public class InserirContratoParcelamentoPorClienteActionForm extends ValidatorActionForm {
	...
	private String indicadorDebitoAutomaticoAnterior;
	...
	public String getIndicadorDebitoAutomaticoAnterior() {
		return indicadorDebitoAutomaticoAnterior;
	}

	public void setIndicadorDebitoAutomaticoAnterior(
			String indicadorDebitoAutomaticoAnterior) {
		this.indicadorDebitoAutomaticoAnterior = indicadorDebitoAutomaticoAnterior;
	}
