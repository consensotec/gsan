...
public class LeituraConsumoActionForm extends ValidatorForm {
	...
	private String loginUsuarioInformouLeitura;
	
	private String nomeUsuarioInformouLeitura;	
	...
	public String getLoginUsuarioInformouLeitura() {
		return loginUsuarioInformouLeitura;
	}

	public void setLoginUsuarioInformouLeitura(String loginUsuarioInformouLeitura) {
		this.loginUsuarioInformouLeitura = loginUsuarioInformouLeitura;
	}

	public String getNomeUsuarioInformouLeitura() {
		return nomeUsuarioInformouLeitura;
	}

	public void setNomeUsuarioInformouLeitura(String nomeUsuarioInformouLeitura) {
		this.nomeUsuarioInformouLeitura = nomeUsuarioInformouLeitura;
	}
}