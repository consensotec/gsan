...
public class InserirDebitoACobrarActionForm extends ActionForm {
	...
	private String mesAnoInicialDaCobranca;
	private String valorMinimoMesAnoInicialDaCobranca;
...
public String getMesAnoInicialDaCobranca() {
	return mesAnoInicialDaCobranca;
}
public void setMesAnoInicialDaCobranca(String mesAnoInicialDaCobranca) {
	this.mesAnoInicialDaCobranca = mesAnoInicialDaCobranca;
}
public String getValorMinimoMesAnoInicialDaCobranca() {
	return valorMinimoMesAnoInicialDaCobranca;
}
public void setValorMinimoMesAnoInicialDaCobranca(String valorMinimoMesAnoInicialDaCobranca) {
	this.valorMinimoMesAnoInicialDaCobranca = valorMinimoMesAnoInicialDaCobranca;
}
