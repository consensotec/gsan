 ...
 */
public class ExibirInserirContaComunicadoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		ActionForward retorno = actionMapping
				.findForward("exibirInserirContaComunicadoAction");
		...
		if(acao != null && !acao.equals("") && acao.equalsIgnoreCase("limparColecoes")){
			this.limparCamposAoSelecionarGrupoFaturamento( sessao,  inserirContaComunicadoActionForm,  httpServletRequest);
		...
		if (idLocalidade != null && !idLocalidade.trim().equals("")) {
			...
			if (colecaoLocalidade != null && !colecaoLocalidade.isEmpty()) {
				...
				inserirContaComunicadoActionForm.setLocalidadeDescricao(localidade.getDescricao());
				...
				String[] idSetor = inserirContaComunicadoActionForm.getSetorComercial();
				...
				if(idSetor!= null && idSetor.length == 1 && !idSetor[0].isEmpty() && !idSetor[0].equals("-1")){
					...
					String[] idRota = inserirContaComunicadoActionForm.getRota();
				...
				inserirContaComunicadoActionForm.setLocalidade("");
				inserirContaComunicadoActionForm.setLocalidadeDescricao("LOCALIDADE INEXISTENTE");
	...
	public void limparCamposAoSelecionarGrupoFaturamento(HttpSession sessao, InserirContaComunicadoActionForm form, HttpServletRequest httpServletRequest){
