...
public class RemoverSelecaoDebitoCobradoAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        }else if(httpServletRequest.getParameter("removerTodos") != null &&
                !httpServletRequest.getParameter("removerTodos").equalsIgnoreCase("")){
        	colecaoDebitoCobrado.clear();
        }
