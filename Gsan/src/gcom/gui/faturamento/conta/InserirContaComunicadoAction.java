...
public class InserirContaComunicadoAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		InserirContaComunicadoActionForm inserirContaComunicadoActionForm = (InserirContaComunicadoActionForm) actionForm;

		Fachada fachada = Fachada.getInstancia();
		
		SistemaParametro sistemaParamentro = fachada.pesquisarParametrosDoSistema();

		String referencia = inserirContaComunicadoActionForm.getReferencia();
		String titulo = inserirContaComunicadoActionForm.getTitulo();
		String comunicado = inserirContaComunicadoActionForm.getComunicado();
		String[] grupoFaturamento = inserirContaComunicadoActionForm.getGrupoFaturamento();
		String gerenciaRegional = inserirContaComunicadoActionForm.getGerenciaRegional();
		String localidade = inserirContaComunicadoActionForm.getLocalidade();
		String[] setorComercial = inserirContaComunicadoActionForm.getSetorComercial();
		String[] rota = inserirContaComunicadoActionForm.getRota();
		String[] quadra = inserirContaComunicadoActionForm.getQuadra();
...
//		registradorOperacao.registrarOperacao(contaComunicado);
		...
		contaComunicado.setIndicadorUso(ConstantesSistema.INDICADOR_USO_ATIVO);
		
		fachada.verificaComunicadoExisteMesmoMesAno(contaComunicado, gerenciaRegional, localidade, grupoFaturamento ,setorComercial, rota, quadra);

		fachada.inserirContaComunicado(contaComunicado, gerenciaRegional, localidade, grupoFaturamento ,setorComercial, rota, quadra);

		
		montarPaginaSucesso(httpServletRequest, "Comunicado na Conta " + titulo +" incluída com sucesso.",
				"Inserir outro Comunicado na Conta",
				"exibirInserirContaComunicadoAction.do?menu=sim" );
