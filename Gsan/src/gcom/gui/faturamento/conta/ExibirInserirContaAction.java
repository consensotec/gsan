...
public class ExibirInserirContaAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if (idImovel != null && !idImovel.equalsIgnoreCase("") &&
            ...
            filtroImovel.adicionarCaminhoParaCarregamentoEntidade(FiltroImovel.IMOVEL_PERFIL_PERMISSAO);
        	...
        	if (colecaoImovel == null || colecaoImovel.isEmpty()){
	        	...
	        	ImovelPerfil imovelPerfil = objetoImovel.getImovelPerfil();
	        	
	        	if(imovelPerfil.getPermissaoEspecial() != null && !fachada.verificarPermissaoGrandeCorporativoCliente(imovelPerfil, usuarioLogado)){
        ...
        if (requestMap.get("percentualEsgoto") != null){
        	String percentualEsgoto = requestMap.get("percentualEsgoto")[0];
