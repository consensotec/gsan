...
public class RetificarConjuntoContaAction extends GcomAction {
	...
	public ActionForward execute(ActionMapping actionMapping,
        ...
        String substituirClienteContaString = retificarConjuntoContaActionForm.getSubstituirClienteConta();
        ...
        if (colecaoContaImovel != null){
        	...
        	ligacaoEsgotoSituacao, consumoEsgoto, dataVencimentoConta, contaMotivoRetificacao, indicadorCategoriaEconomiaConta, usuarioLogado, substituirClienteConta);
