...
public class ExibirRetificarConjuntoContaAction extends GcomAction {
	...
	private void recebimentoParametrosManterConta(HttpServletRequest httpServletRequest,
          ...
          */            
	         ...
	         * e se o cliente da conta for diferente do cliente do imovel e se o parâmetro para exibir pergunta estiver com sim. (mensagem exibida pelo jsp)
	         * 
	    	...
	    	if (indicadorPerguntarSubstituicaoCliente != null && 
			    ...
			    Collection<Conta> contas = gerarColecaoContaSelecaoParaRetificacao(colecaoContaImovel, contaSelected);
		    	boolean perguntarSubstituicaoCliente = this.getFachada().verificarClienteImovelDiferenteClienteConta(contas);
		    	httpServletRequest.setAttribute("perguntarSubstituicaoCliente", perguntarSubstituicaoCliente);
	    	}
		 }
	 }
	...
	public Collection<Conta> gerarColecaoContaSelecaoParaRetificacao(Collection<Conta> colecaoContas, String identificadores){
		...
		for (Conta contaColecao : colecaoContas) {
