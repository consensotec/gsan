...
public class GerarArquivoOrcamentoSinpActionForm extends ValidatorActionForm {
	...
	private String indicadorArquivoARSBAN;
	...
	public String getIndicadorArquivoARSBAN() {
		return indicadorArquivoARSBAN;
	}

	public void setIndicadorArquivoARSBAN(String indicadorArquivoARSBAN) {
		this.indicadorArquivoARSBAN = indicadorArquivoARSBAN;
	}	
