...
import gcom.gui.gerencial.faturamento.InformarResumoSituacaoEspecialFaturamentoActionForm;
...
public class GerarRelatorioResumoFaturamentoSituacaoEspecialAction extends
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		InformarResumoSituacaoEspecialFaturamentoActionForm form =
		 (InformarResumoSituacaoEspecialFaturamentoActionForm) actionForm;
		...
		try {
			...
			relatorioResumoFaturamentoSituacaoEspecial.addParametro("mesAnoReferencia", form.getMesAnoReferenciaFaturamento());
