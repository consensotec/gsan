...
public class ExibirGerarRelatorioMultasAutosInfracaoPendentesAction extends GcomAction {
    ...
    public ActionForward execute(ActionMapping actionMapping,
        ...
        if(limparForm != null && !"".equals(limparForm)){
        	form.setGrupo("");
        	form.setIdFuncionario("");
        	form.setDescricaoFuncionario("");
        	form.setPeriodoAtuacaoInicial("");
        	form.setPeriodoAtuacaoFinal("");
        	form.setIdRota("");
        ...
        if(form.getIdRota() != null && !"".equals(form.getIdRota())){
