...
public class GerarRelatorioAcessoSPCAction extends ExibidorProcessamentoTarefaRelatorio{
	...
	public ActionForward execute(ActionMapping actionMapping,
		...
		if(loginUsuarioResponsavel != null && !loginUsuarioResponsavel.equals("")){
			...
			if(!Util.validarStringNumerica(loginUsuarioResponsavel)){
				throw new ActionServletException("atencao.campo.invalido",null, "Usuário");
			}
		...
		if(unidadeOrganizacional != null && !unidadeOrganizacional.equals("")){
			...
			if (!Util.validarStringNumerica(unidadeOrganizacional)) {
				throw new ActionServletException("atencao.long", null, "Unidade Organizacional");
			}
