				...
				if (obj instanceof Object[]) {
					...
					while (iteCategoriaImovel.hasNext()) {
						...
						if ( idTipoLigacao.equals( LigacaoTipo.LIGACAO_AGUA ) ){
							...
							quantidadeEconomiaLigacaoAgua += quantidadeEconomiasImovelporCategoria.get( index ); 
	
							// Obtemos o consumo faturado de agua
							// Se o consumo de agua for menor do que o minimo * as
							// economias
							// Devemos pegar o mï¿½nimo
							if (consumosImovelporCategoria.get( index ) < categoria.getConsumoMinimo() ){
							...
							/**	***** FIM DADOS PARA A TABELA HISTOGRAMA AGUA LIGACAO ******* **/
							/**	**** DADOS PARA A TABELA HISTOGRAMA AGUA ECONOMIA ****** **/
							quantidadeEconomiaAgua += quantidadeEconomiasImovelporCategoria.get( index );
						...
						if ( idTipoLigacao.equals( LigacaoTipo.LIGACAO_ESGOTO ) ){
							...
							quantidadeEconomiaLigacaoEsgoto = quantidadeEconomiasImovelporCategoria.get( index );
							...
							if (consumosImovelporCategoria.get( index ) < categoria.getConsumoMinimo() ){
								...
								volumeFaturadoLigacaoEsgoto += (consumosImovelporCategoria.get( index ) ).intValue();
							}
							...
							/**	**** DADOS PARA A TABELA HISTOGRAMA ESGOTO ECONOMIA ****** **/
							quantidadeEconomiaEsgoto += quantidadeEconomiasImovelporCategoria.get( index );
