...
public final class Criptografia {
    ...
    /**
     * Calcula o hash de um arquivo usando o algoritmo SHA-1.
     * 
     * @author André Miranda
     * @date 19/05/2015
     * 
     * @param file Arquivo para ser computado o seu hash
     * @return String do hash em hexadecimal
     * 
     * @throws ErroCriptografiaException 
     */
    public static String hash(File file) throws ErroCriptografiaException {
    	...
    	try {
			...
			throw new ErroCriptografiaException(e.getMessage(), e, 0);
		} finally {
			try {
				fis.close();
