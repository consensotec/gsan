...
public class ConstantesJNDI {
	...
	public static String BATCH_ATUALIZAR_PERFIL_IMOVEL_LOTE = "";
	
	public static String BATCH_GERAR_DEBITO_A_COBRAR_DEPRECIACAO_HIDROMETRO = "";
	
	public static String BATCH_GERAR_RELATORIO_DEBITOS_CLIENTES = "";
	
	public static String BATCH_GERAR_DADOS_FINANCEIROS_ATUALIZACAO_CADASTRAL = "";
	...
	public static void inicializarPropriedades() {
		...
		try {
			...
			BATCH_ATUALIZAR_PERFIL_IMOVEL_LOTE = propriedades
					.getProperty("QueueBatchAtualizarPerfilImovelLoteMDB");
			
			BATCH_GERAR_DEBITO_A_COBRAR_DEPRECIACAO_HIDROMETRO = propriedades
					.getProperty("QueueBatchGerarDebitoACobrarDepreciacaoHidrometroMDB");
			
			BATCH_GERAR_RELATORIO_DEBITOS_CLIENTES = propriedades
					.getProperty("QueueBatchGerarRelatorioDebitosClientesMDB");
			
			BATCH_GERAR_DADOS_FINANCEIROS_ATUALIZACAO_CADASTRAL = propriedades
					.getProperty("BatchGerarDadosFinanceirosAtualizacaoCadastralMDB");
