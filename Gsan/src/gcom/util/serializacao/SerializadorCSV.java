...
/**
 * Implementação de Serializador para o formato CSV
 * 
 ...
 */
public class SerializadorCSV implements Serializador {
	private String separador = ";";

	public void iniciar(Object bean, StringBuilder sb) throws Exception {
		...
		for (Method m : bean.getClass().getMethods()) {
			...
			resultado.put(c.posicao(), c.nome());
		}
