...
public interface MetodosBatch {
	...
	int GERAR_ARQUIVO_TEXTO_FATURAS_AGRUPADAS = 21;
	int GERAR_MOVIMENTO_DEBITO_AUTOMATICO_PARC_CLIENTE = 22;
	int REGERAR_MOVIMENTO_DEBITO_AUTOMATICO_BANCO_PARC_CLIENTE = 23;
