...
public class RepositorioUtilHBM implements IRepositorioUtil {
	 ...
	 * @return Objeto após ser inserido no banco de dados
	 * @exception ErroRepositorioException
	 */
	 ...
	 * 
	 * @param objeto Objeto a ser inserido no banco de dados
	 * @param session Sessão que representa a conexão com o banco de dados
	 * @return Objeto após ser inserido no banco de dados
	 * @exception ErroRepositorioException
	 */
	...
	/**
	 * 
	 * Método que calcula já na base e levando em consideração os feriados municipais e nacionais
	 * a quantidade de dias úteis entre duas data. MÉTODO EXCLUSIVO PARA POSGTRES
	 * 
	 * @author Bruno Barros	 * 
	 * 
	 * @param dataInicio - Data inicial
	 * @param dataFim - Data final
	 * @param municipio - Id do município que terá seus feriados analisados ( Tabela cadastro.municipio_feriado )
	 * 
	 * @return quantidade de dias úteis entre as duas datas
	 * 
	 * @throws ErroRepositorioException
	 */	
