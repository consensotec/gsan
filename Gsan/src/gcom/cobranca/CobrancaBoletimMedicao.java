...
public class CobrancaBoletimMedicao extends ObjetoTransacao {
    ...
    /** nullable persistent field */
    private CobrancaBoletimContrato cobrancaBoletimContrato;
    ...
    public CobrancaBoletimContrato getCobrancaBoletimContrato() {
		return cobrancaBoletimContrato;
	}

	public void setCobrancaBoletimContrato(CobrancaBoletimContrato cobrancaBoletimContrato) {
		this.cobrancaBoletimContrato = cobrancaBoletimContrato;
	}
