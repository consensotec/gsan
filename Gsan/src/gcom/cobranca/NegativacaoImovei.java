...
public class NegativacaoImovei implements Serializable {
    ...
    /** full constructor */
    public NegativacaoImovei(Integer id, Date ultimaAlteracao, short indicadorExcluido, Date dataExclusao, Imovel imovel, gcom.cobranca.NegativacaoComando negativacaoComando) {
        this.id = id;
    ...
    /** minimal constructor */
    public NegativacaoImovei(Integer id, Date ultimaAlteracao, short indicadorExcluido, Imovel imovel, gcom.cobranca.NegativacaoComando negativacaoComando) {
        this.id = id;
        this.ultimaAlteracao = ultimaAlteracao;
        this.indicadorExcluido = indicadorExcluido;
        this.imovel = imovel;
