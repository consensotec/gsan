...
public class NegativacaoComandoImovel implements Serializable {
    ...
    /** default constructor */
    public NegativacaoComandoImovel() {
    }


    public NegativacaoComandoImovel(
			Integer id, Imovel imovel, Cliente cliente, Usuario usuarioInclusao, Date ultimaAlteracao,
			NegativacaoComando negativacaoComando) {
		super();
		this.id = id;
		this.imovel = imovel;
