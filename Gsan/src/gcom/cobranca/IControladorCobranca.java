...
//			CobrancaAcao cobrancaAcao, int inicio, int fim) throws ControladorException;	
	...
	public void confirmarCartaoCredito(Integer idParcelamentoSelecionado, 
		Collection colecaoTransacao, Usuario usuarioLogado,BigDecimal valorParcelamento) throws ControladorException;
...
/** 
	...
	**/
	...
	public Collection<ContaValoresHelper> pesquisarContasDebito(
			...
			String anoMesFinalReferenciaDebito,
			Date anoMesInicialVencimentoDebito,
			Date anoMesFinalVencimentoDebito, String anoMesArrecadacao, int indicadorDividaAtiva, SistemaParametro sp)throws ControladorException;
	...
	public Object[] pesquisarClienteResponsavel(Integer idImovel)throws ControladorException;
	 ...
	 * @throws ControladorException
	 */
	public Object[] obterValorDebitoTotalAtualizadoEQtdeContas(Integer idImovel) throws ControladorException;
