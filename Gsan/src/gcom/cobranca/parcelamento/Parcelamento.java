...
public class Parcelamento extends ObjetoTransacao {
    ...
    public BigDecimal getValorTotalParcelado() {
		BigDecimal retorno = new BigDecimal("0.00");
		retorno = getValorNegociado().subtract(this.valorEntradaComDesconto != null && this.getValorEntradaComDesconto().floatValue() != 0 ? this.valorEntradaComDesconto : valorEntrada);
		retorno = retorno.setScale(2, BigDecimal.ROUND_HALF_UP);
		return retorno;
	}
