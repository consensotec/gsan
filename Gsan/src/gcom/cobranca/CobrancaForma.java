...
public class CobrancaForma extends ObjetoTransacao {
    ...
    public final static Integer COBRANCA_EM_CARNE = new Integer(6);
    //>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>	
    ...
    private Short indicadorGuiaCarneParcelamento;
	...
	public Short getIndicadorGuiaCarneParcelamento() {
		return indicadorGuiaCarneParcelamento;
	}

	public void setIndicadorGuiaCarneParcelamento(Short indicadorGuiaCarneParcelamento) {
		this.indicadorGuiaCarneParcelamento = indicadorGuiaCarneParcelamento;
	}
