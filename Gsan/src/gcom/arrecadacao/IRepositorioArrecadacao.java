...
public interface IRepositorioArrecadacao {
	 ...
	 * @throws ErroRepositorioException
	 */
	public Collection consultarResumoArrecadacaoRelatorioPorEstadoPorMunicipio(int anoMesReferencia, Collection<Integer> idsPerfilImovel)
		throws ErroRepositorioException;
	 ...
	 * @throws ErroRepositorioException
	 */
	public Collection consultarResumoArrecadacaoRelatorioPorMunicipio(int anoMesReferencia, Integer idMunicipio, Collection<Integer> idsPerfilImovel)
		throws ErroRepositorioException;
	...
	public Collection consultarResumoArrecadacaoRelatorioPorGerenciaRegional(
			int anoMesReferencia, Integer gerenciaRegional, Collection<Integer> idsPerfilImovel)
			throws ErroRepositorioException;
	...
	public Collection consultarResumoArrecadacaoRelatorioPorLocalidade(
			int anoMesReferencia, Integer localidade, Collection<Integer> idsPerfilImovel)
			throws ErroRepositorioException;
	 ...
	 * Acumula o valor do dÃ©bitos cobrados por localidade, categoria dos
	 * pagamentos classificados de conta para tipo de financiamento igual a
	 * parcelamento de serviÃ§o e grupo de parcelamento diferente de juros
	 * cobrados
	 * 
	 * @author Pedro Alexandre
	 * @date 22/05/2006
	 ...
	 * Acumula o valor do dÃ©bitos cobrados por localidade, categoria dos
	 * pagamentos classificados de conta para tipo de financiamento igual a
	 * parcelamento de serviÃ§o e grupo de parcelamento igual a juros cobrados
	 * 
	 * @author Pedro Alexandre
	 * @date 22/05/2006
	 * 
	 ...
	 * financiamento igual a serviÃ§o
	 * 
	 * @author Pedro Alexandre
	 * @date 22/05/2006
	 * 
...
*/
	 ...
	 * PGMT_AMREFERENCIAARRECADACAO igual ou menor ao
	 * PARM_AMREFERENCIAARRECADACAO), com o tipo do documento correspondente a
	 * guia de pagamento e o campo GPAG_ID nÃ£o informado
	 * 
	 * @author Raphael Rossiter
	 * @data 18/04/2006
	 * 
	...
	/**
	 * Filtra os pagamento historicos do aviso bancario para paginaÃ§Ã£o
	 * 
	 * [UC0255] Filtrar Pagamentos
	 * 
	 * @author Rafael Santos
	...
	/**
	 * Atualiza o valor excedente e a situaÃ§Ã£o dos pagamentos informados para o
	 * tipode situaÃ§Ã£o informada.
	 * 
	 * @author Raphael Rossiter, Pedro Alexandre
	...
	/**
	 * Atualiza logradouroCep de um ou mais imÃ³veis  
	 * 
	 * [UC0] Atualizar Logradouro
	 * 
	 * @author Raphael Rossiter
	...
	/**
	 * 
	 * [UC0619] Gerar RelaÃ§Ã£o de Acompanhamento dos Movimentos Arrecadadores por NSA
	 * 
	 * @author Ana Maria
	 * @date 12/07/2007
	 * 
	...
	public Collection pesquisarDadosComparativosFaturamentoArrecadacaoExpurgo(Integer anoMesReferencia,
			String idGerenciaRegional,String idUnidadeNegocio, Collection<Integer> idsPerfilImovel)
			throws ErroRepositorioException;
	 ...
	 * @data 26/10/2008
	 * Pesquisa Quantidadede contas faturas para localidade/ referÃªncia
	*/
	 ...
	 * Anormalidades do Imóvel
	 * 
	 * @author Carlos Chaves
	 * @date 24/10/2012
	 */
	public Collection<MovimentoRoteiroEmpresaFoto> pesquisarFotoAnormalidadeImovel(Integer idImovel,
			Integer anoMesReferencia, Integer idTipoMedicao,
				Integer idFotoTipoLeituraConsumoAnormalidade,Integer idAnormalidade) throws ErroRepositorioException;
