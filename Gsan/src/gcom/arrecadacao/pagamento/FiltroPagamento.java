...
public class FiltroPagamento extends Filtro {
	...
	public final static String GUIA_PAGAMENTO_DEBITO_TIPO = "guiaPagamento.debitoTipo";
    ...
    public final static String PAGAMENTO_CARTAO_DEBITO_ID = "pagamentoCartaoDebito.id";
