...
public interface IControladorArrecadacao {
	...
	/**
	 * Metodo que atualiza o aviso bancario, adiciona as deducoes e acertos
	...
	/**
	 * Metodo que recebe um array de Integer e remove os Avisos Bancarios dos
	...
	public Collection consultarResumoArrecadacaoRelatorio(String opcaoTotalizacao, int mesAnoReferencia,
			...
			Collection<Integer> idsPerfilImovel)
			throws ControladorException;
	...
	/**
	 * 
	 * Este metodo se destina a validar todas as situacoes e particularidades da
	 * inserir guia de devolucao no momento da exibicao.
	 * 
	 ...
	 /**
		...
		public Collection<MovimentoRoteiroEmpresaFoto> pesquisarFotoAnormalidadeImovel(Integer idImovel,
				Integer anoMesReferencia, Integer idTipoMedicao,
					Integer idFotoTipoLeituraConsumoAnormalidade,Integer idAnormalidade)
				throws ControladorException;
		 ...
		 * @throws ControladorException
		 */
		public void gerarResumoArrecadacaoAtualizaDados(int idFuncionalidadeIniciada) throws ControladorException;
