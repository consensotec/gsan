...
public class HelperDebitoListarDebitosWebService {
	...
	@SerializedName("f")
	String anoMesCobranca;
	@SerializedName("g")
	String anoMesContabil;
	@SerializedName("h")
	String numeroPrestacao;
	@SerializedName("i")
	String numeroPrestacaoCobradas;
	...
	public void setAnoMesContabil(String anoMesContabil) {
	...
	public void setNumeroPrestacaoCobradas(String numeroPrestacaoCobradas) {
