...
import gcom.batch.atendimentopublico.TarefaBatchGerarResumoAtendimentoPublicoAtualizaDados;
...
import gcom.batch.atualizacaocadastral.TarefaBatchGerarDadosFinanceirosAtualizacaoCadastral;
import gcom.batch.atualizacaocadastral.TarefaBatchGerarResumoDadosFinanceirosAtualizacaoCadastral;
...
import gcom.batch.cadastro.TarefaBatchAtualizarPerfilImovelLote;
...
import gcom.batch.cadastro.TarefaBatchGerarResumoCadastroAtualizaDados;
...
import gcom.batch.cobranca.TarefaBatchGerarResumoCobrancaAtualizaDados;
import gcom.batch.cobranca.TarefaBatchGerarResumoDividaAtivaAnual;
import gcom.batch.cobranca.TarefaBatchGerarResumoParcelamentoAtualizaDados;
...
import gcom.batch.faturamento.TarefaBatchGerarDebitoACobrarDepreciacaoHidrometro;
...
import gcom.batch.faturamento.TarefaBatchGerarResumoFaturamentoAtualizaDados;
...
import gcom.batch.faturamento.TarefaBatchReligarImoveisCortadosComLeituraRealConsumo;
...
import gcom.batch.micromedicao.TarefaBatchGerarResumoMicromedicaoAtualizaDados;
		...
		try {
			...
			while (iterator.hasNext()) {
				...
				try {
					...
					case Funcionalidade.BATCH_ATUALIZAR_PERFIL_IMOVEL_LOTE:
						
						TarefaBatchAtualizarPerfilImovelLote tarefaBatchAtualizarPerfilImovelLote = new TarefaBatchAtualizarPerfilImovelLote(processoIniciado.getUsuario(),
								funcionalidadeIniciada.getId());
						
						@SuppressWarnings("unchecked")
						Collection<Integer> colecaoIdsLocalidadeAtualizarPerfilImovelLote = getControladorLocalidade().pesquisarTodosIdsLocalidade();
						
						tarefaBatchAtualizarPerfilImovelLote.addParametro(ConstantesSistema.COLECAO_UNIDADES_PROCESSAMENTO_BATCH, colecaoIdsLocalidadeAtualizarPerfilImovelLote);

						/*
						 *  Seta o objeto para ser serializado no banco, onde
						 *  depois sera executado por uma thread
						 */
						funcionalidadeIniciada.setTarefaBatch(IoUtil.transformarObjetoParaBytes(tarefaBatchAtualizarPerfilImovelLote));
...
//						}
					...
					case Funcionalidade.GERAR_RESUMO_DIVIDA_ATIVA_ANUAL:
						...
						case Funcionalidade.BATCH_GERAR_DADOS_FINANCEIRO_ATUALIZACAO_CADASTRAL:
							TarefaBatch tarefa = new TarefaBatchGerarDadosFinanceirosAtualizacaoCadastral(
									processoIniciado.getUsuario(), funcionalidadeIniciada.getId());
							
							Collection<Integer> colecaoParametroTabelaAtualizacaoCadastral = getControladorAtualizacaoCadastral().pesquisarParametroTabelaAtualizacaoCadastralNaoFinalizado();
							tarefa.addParametro(ConstantesSistema.COLECAO_UNIDADES_PROCESSAMENTO_BATCH, colecaoParametroTabelaAtualizacaoCadastral);

							funcionalidadeIniciada.setTarefaBatch(IoUtil.transformarObjetoParaBytes(tarefa));
							getControladorUtil().atualizar(funcionalidadeIniciada);
							break;

						case Funcionalidade.BATCH_GERAR_RESUMO_DADOS_FINANCEIROS_ATUALIZACAO_CADASTRAL:
							TarefaBatch tarefaResumo = new TarefaBatchGerarResumoDadosFinanceirosAtualizacaoCadastral(
									processoIniciado.getUsuario(), funcionalidadeIniciada.getId());
							
							Collection<Integer> colecaoParametroTabelaAtuCadastral = getControladorAtualizacaoCadastral().pesquisarParametroTabelaAtualizacaoCadastralNaoFinalizado();
							tarefaResumo.addParametro(ConstantesSistema.COLECAO_UNIDADES_PROCESSAMENTO_BATCH, colecaoParametroTabelaAtuCadastral);
			...
			while (iteratorFaturamentoAtividadeCronograma.hasNext()) {
				...
				while (iterator.hasNext()) {
					...
					case Funcionalidade.GERAR_TXT_IMPRESSAO_CONTAS_FORMATO_BRAILLE:
						...
						TarefaBatchGerarTxtImpressaoContasBraille gerarTxtContasBraille = new TarefaBatchGerarTxtImpressaoContasBraille(processoIniciado.getUsuario(),
																																		funcionalidadeIniciada.getId());
						gerarTxtContasBraille.addParametro("anoMesFaturamentoGrupo", faturamentoAtividadeCronograma.getFaturamentoGrupoCronogramaMensal().getFaturamentoGrupo().getAnoMesReferencia());
						gerarTxtContasBraille.addParametro("faturamentoGrupo", faturamentoAtividadeCronograma.getFaturamentoGrupoCronogramaMensal().getFaturamentoGrupo());
						funcionalidadeIniciada.setTarefaBatch(IoUtil.transformarObjetoParaBytes(gerarTxtContasBraille));
						getControladorUtil().atualizar(funcionalidadeIniciada);
					...
					case Funcionalidade.BATCH_GERAR_DEBITO_A_COBRAR_DEPRECIACAO_HIDROMETRO:

						TarefaBatchGerarDebitoACobrarDepreciacaoHidrometro dadosGerarDebito = new TarefaBatchGerarDebitoACobrarDepreciacaoHidrometro(	processoIniciado.getUsuario(),
																													funcionalidadeIniciada.getId());
						// Seta os parametros para rodar a funcionalidade
						dadosGerarDebito.addParametro("anoMesFaturamentoGrupo", faturamentoAtividadeCronograma.getFaturamentoGrupoCronogramaMensal().getFaturamentoGrupo().getAnoMesReferencia());
						dadosGerarDebito.addParametro("idFaturamentoGrupo", faturamentoAtividadeCronograma.getFaturamentoGrupoCronogramaMensal().getFaturamentoGrupo().getId());
						dadosGerarDebito.addParametro("sistemaParametro", sistemaParametro);
						dadosGerarDebito.addParametro(ConstantesSistema.COLECAO_UNIDADES_PROCESSAMENTO_BATCH, colecaoFaturamentoAtivCronRota);

						// Seta o objeto para ser serializado no banco, onde
						// depois sera executado por uma thread
						funcionalidadeIniciada.setTarefaBatch(IoUtil.transformarObjetoParaBytes(dadosGerarDebito));
	...
	/**
	 * Retorna o valor de controladorAtualizacaoCadastral
	 * @return O valor de controladorAtualizacaoCadastral
	 */
