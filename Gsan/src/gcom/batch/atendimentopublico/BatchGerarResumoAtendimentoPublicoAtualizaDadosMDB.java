 ...
 * @date 03/02/2014
 */
public class BatchGerarResumoAtendimentoPublicoAtualizaDadosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoAtendimentoPublicoAtualizaDadosMDB() {
		super();
	}
    ...
    public void onMessage(Message message) {
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        .getControladorAtendimentoPublicoLocal()
                        .gerarResumoAtendimentoPublicoAtualizaDados(
	 ...
	 */
	private ControladorAtendimentoPublicoLocal getControladorAtendimentoPublicoLocal() {
