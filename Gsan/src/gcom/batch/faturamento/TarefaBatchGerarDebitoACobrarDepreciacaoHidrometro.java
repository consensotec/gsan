 ...
 * @created 22/06/2015
 */
public class TarefaBatchGerarDebitoACobrarDepreciacaoHidrometro extends TarefaBatch {

	private static final long serialVersionUID = 1L;

	public TarefaBatchGerarDebitoACobrarDepreciacaoHidrometro(Usuario usuario,
	...
	@Deprecated
	public TarefaBatchGerarDebitoACobrarDepreciacaoHidrometro() {
		super(null, 0);
	}
	...
	public Object executar() throws TarefaException {
		...
		while (iterator.hasNext()) {
			...
			enviarMensagemControladorBatch(
				ConstantesJNDI.BATCH_GERAR_DEBITO_A_COBRAR_DEPRECIACAO_HIDROMETRO,
				new Object[] { 
					rota,
