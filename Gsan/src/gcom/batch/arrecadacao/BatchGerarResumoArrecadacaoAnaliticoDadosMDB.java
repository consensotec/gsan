 ...
 * @date 26/12/2011
 */
public class BatchGerarResumoArrecadacaoAnaliticoDadosMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumoArrecadacaoAnaliticoDadosMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .gerarResumoArrecadacaoAnaliticoDados(
