 ...
 * @date 22/11/2011
 */
public class BatchGerarDebitoACobrarContratoDemandaImovelResidencialMDB implements
			MessageDrivenBean, MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarDebitoACobrarContratoDemandaImovelResidencialMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorArrecadacao().gerarDebitoACobrarContratoDemandaImovelResidencial(
