 ...
 * @date 03/11/2015
 */
public class BatchGerarResumosArrecadacaoPentahoMDB implements MessageDrivenBean,
		MessageListener {
	
	private static final long serialVersionUID = 1L;

	public BatchGerarResumosArrecadacaoPentahoMDB() {
		super();
	}
        ...
        if (message instanceof ObjectMessage) {
            ...
            try {
                this
                        ...
                        .gerarResumosArrecadacaoPentaho(
