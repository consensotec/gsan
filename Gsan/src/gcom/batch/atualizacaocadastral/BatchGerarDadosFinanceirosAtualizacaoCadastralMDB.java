 ...
 * @date 09/07/2015
 */
public class BatchGerarDadosFinanceirosAtualizacaoCadastralMDB implements MessageDrivenBean, MessageListener {
	private static final long serialVersionUID = 1L;

	public BatchGerarDadosFinanceirosAtualizacaoCadastralMDB() {
		super();
	}
	...
	public void onMessage(Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				this.getControladorAtualizacaoCadastral().gerarDadosFinanceirosAtualizacaoCadastral(
