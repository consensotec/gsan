...
public class Processo extends ObjetoGcom {
	...
	public static final int GERAR_RESUMO_CADASTRO_ATUALIZA_DADOS = 335;
	
	public static final int GERAR_RELATORIO_HIDROMETRO_FAIXA_IDADE_SINTETICO = 347;
	
	public static final int GERAR_RELATORIO_HIDROMETRO_POR_FAIXA_IDADE_ANALITICO = 346;

	public static final int RELATORIO_ACOMPANHAMENTO_GRANDES_CLIENTE = 348;

	public static final int GERAR_DADOS_FINANCEIROS_ATUALIZACAO_CADASTRAL = 349;
