...
public class Relatorio implements Serializable {
	...
	public static final int RELATORIO_RESUMO_SITUACAO_IMOVEIS_ANALISTA_CADASTRADOR = 246;
	
	public static final int RELATORIO_MENSAGENS_PENDENTES_CADASTRADOR = 247;
	
	public static final int RELATORIO_QUANTITATIVO_MENSAGENS_PENDENTES = 248;
	
	public static final int RELATORIO_FILTRO_CANTRATO_ADESAO = 249;
	
	public static final int RELATORIO_HIDROMETRO_FAIXA_IDADE_SINTETICO = 255;

	public static final int RELATORIO_HIDROMETRO_FAIXA_IDADE_ANALITICO = 254;
