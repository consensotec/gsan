...
import gcom.util.serializacao.SerializadorCSV;
...
//				exporterXLS.setParameter(JRXlsExporterParameter.IS_REMOVE_EMPTY_SPACE_BETWEEN_ROWS, true);
			...
			case TIPO_CSV:
				...
				tarefa.executar(relatorioDataSource.getData(), retorno, new SerializadorCSV());
				break;
			default:
				throw new RelatorioVazioException("Escolha um tipo de relatório");
			}
