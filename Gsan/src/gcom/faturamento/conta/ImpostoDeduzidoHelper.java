...
public class ImpostoDeduzidoHelper {
	 ...
	 */
	public ImpostoDeduzidoHelper(Integer idImpostoTipo, BigDecimal valor, BigDecimal percentualAliquota) {
	...
	public boolean equals(Object obj) {
		...
		if (descricaoImposto == null) {
			if (other.descricaoImposto != null) return false;
		...
		if (idImpostoTipo == null) {
			if (other.idImpostoTipo != null) return false;
		} else if (!idImpostoTipo.equals(other.idImpostoTipo))
			return false;

		if (nomeCliente == null) {
			if (other.nomeCliente != null) return false;
		} else if (!nomeCliente.equals(other.nomeCliente))
			return false;

		if (percentualAliquota == null) {
			if (other.percentualAliquota != null) return false;
