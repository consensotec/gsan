 ...
 */
public class FiltroContaComunicado extends Filtro {

	private static final long serialVersionUID = 1L;
    public FiltroContaComunicado() {
    }

    public final static String ID = "id";
    
    public final static String ANO_MES_REFERECIA = "anoMesReferencia";
     ...
     */
    public FiltroContaComunicado(String campoOrderBy) {
