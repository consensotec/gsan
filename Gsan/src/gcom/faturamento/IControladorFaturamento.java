...
public interface IControladorFaturamento {
	...
	public Integer retificarConta(Integer mesAnoConta, Conta contaAtual,
            ...
            boolean substituirClienteConta)
			throws ControladorException;
	...
	public Collection consultarResumoFaturamentoRelatorio(
			...
			Integer municipio, Integer unidadeNegocio,
	...
	*/
	...
	public void retificarConjuntoConta(Collection<Conta> colecaoContas,
			...
			ContaMotivoRetificacao contaMotivoRetificacao, Short indicadorCategoriaEconomiaConta, Usuario usuarioLogado, 
	...
	*/
	...
	/**
	 * [UC1684] - Gerar Arquivo Exportação Faturas Agrupadas
	 * 
	 ...
	 */
	public byte[] gerarArquivoExportacaoFaturasAgrupadas(Integer anoMes, String idCliente,
			String idClienteSuperior, StringBuilder nomeArquivo) throws ControladorException;
