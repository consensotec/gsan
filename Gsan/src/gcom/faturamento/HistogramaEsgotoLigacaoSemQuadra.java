...
public class HistogramaEsgotoLigacaoSemQuadra implements Serializable {
    ...
    /** persistent field */
    private Integer percentualEsgoto;
	...
	public HistogramaEsgotoLigacaoSemQuadra() {
		super();
	}

	public HistogramaEsgotoLigacaoSemQuadra(Integer id, int referencia, int codigoSetorComercial, short indicadorLigacaoMista, short indicadorConsumoReal, short indicadorHidrometro, short indicadorPoco, short indicadorVolumeFixadoEsgoto, int quantidadeConsumo, int quantidadeLigacao, int quantidadeEconomiaLigacao, BigDecimal valorFaturadoLigacao, int volumeFaturadoLigacao, Date ultimaAlteracao, GerenciaRegional gerenciaRegional, Localidade localidade, Localidade localidadeEelo, ConsumoTarifa consumoTarifa, ImovelPerfil imovelPerfil, LigacaoEsgotoSituacao ligacaoEsgotoSituacao, UnidadeNegocio unidadeNegocio, EsferaPoder esferaPoder, Categoria categoria, Subcategoria subcategoria, CategoriaTipo categoriaTipo, SetorComercial setorComercial, Integer percentualEsgoto) {
		super();
	...
	public Integer getPercentualEsgoto() {
		return percentualEsgoto;
	}

	public void setPercentualEsgoto(Integer percentualEsgoto) {
		this.percentualEsgoto = percentualEsgoto;
	}
