...
//			emitirContaHelper.setTerceiraParte(parmsPartesConta[2]);
	...
	public String obterMensagemContaBraille(EmitirContaHelper emitirContaHelper,
		...
		try {
			Integer tipoConta = repositorioFaturamento.pesquisarTipoConta(emitirContaHelper.getIdConta());
			if (tipoConta != null){
				Collection colecaoNacionalFeriado = getControladorUtil().pesquisarFeriadosNacionais();
				String[] msgConta = obterMensagemConta(emitirContaHelper, sistemaParametro, tipoConta, colecaoNacionalFeriado);
