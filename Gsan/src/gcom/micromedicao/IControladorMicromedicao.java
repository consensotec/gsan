...
import gcom.micromedicao.bean.TelemetriaRetornarDadosImovelHelper;
...
import gcom.relatorio.micromedicao.RelatorioHidrometroFaixaIdadeSinteticoBean;
import gcom.relatorio.micromedicao.RelatorioHidrometroPorFaixaIdadeAnaliticoBean;
...
public interface IControladorMicromedicao {
	...
	public int obterConsumoMinimoLigacao(Imovel imovel, Collection colecaoCategorias,
			boolean multiplicarQtdEconomias) throws ControladorException;
...
//			Integer anoMesFaturamento)throws ControladorException;
   ...
   public boolean releituraJaRealizada( String matricula )
	...
	public void inserirFotoMovimentoRoteiroEmpresa(int numeroImovel,
			int idAnormalidade,int idFotoTipoLeituraConsumoAnormalidade, int anoMesReferencia, int tipoFoto,int tipoMedicao, byte[] bytesFoto) throws ControladorException;
	 ...
	 * @param idImovel
	 * */
	public Integer pesquisarDadosRejeitadosTelemetriaCount(String periodoEnvioDadosInicial, String periodoEnvioDadosFinal, 
			String indicadorEnvioDadosTotalmenteRejeitados, String motivoRejeicao) throws ControladorException;
	 ...
	 * @throws ControladorException	 
	 */	
	public Collection<TelemetriaLogErro> pesquisarDadosRejeitadosDetalhadoTelemetria(String idTelemetriaLog) throws ControladorException;
	 ...
	 * @date 29/04/2015 
	 */
	public Collection<TelemetriaLog> pesquisarDadosRejeitadosTelemetriaParaPaginacao(String periodoEnvioDadosInicial, String periodoEnvioDadosFinal, 
			String envioDadosTotalmenteRejeitados, String motivoRejeicao, Integer numeroPagina) throws ControladorException;
	 ...
	 * @return helper
	 */
	public TelemetriaRetornarDadosImovelHelper retornarDadosImovelTelemetria(String matriculaImovel, String tipoLigacao)
			throws ControladorException;
	 ...
	 * @param helper
	 */
	public Collection<RelatorioHidrometroFaixaIdadeSinteticoBean> retornarDadosRelatorioHidrometroFaixaIdadeSintetico
						(FiltroRelatorioHidrometroFaixaIdadeHelper helper) throws ControladorException;
	 ...
	 * @date 10/06/2015
	 */
	public Collection<RelatorioHidrometroPorFaixaIdadeAnaliticoBean> obterDadosRelatorioHidrometroPorFaixaIdadeAnalitico(FiltroRelatorioHidrometroFaixaIdadeHelper helper) throws ControladorException;
