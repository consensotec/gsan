...
public class TelemetriaLogErro implements Serializable {
	private static final long serialVersionUID = 1L;

    private Integer id;
    private String conteudoDadoErrado;
    private Date ultimaAlteracao;
    private TelemetriaLog telemetriaLog;
    private TelemetriaRetMot telemetriaRetMot;

    public TelemetriaLogErro() {}

	public TelemetriaLogErro(String conteudoDadoErrado,
			TelemetriaLog telemetriaLog,
			TelemetriaRetMot telemetriaRetMot) {
		super();
		this.conteudoDadoErrado = conteudoDadoErrado;
		this.telemetriaLog = telemetriaLog;
		this.telemetriaRetMot = telemetriaRetMot;
		this.ultimaAlteracao = new Date();
	}

	public TelemetriaLogErro(Integer id, String conteudoDadoErrado,
			Date ultimaAlteracao, TelemetriaLog telemetriaLog,
			TelemetriaRetMot telemetriaRetMot) {
		super();
		this.id = id;
		this.conteudoDadoErrado = conteudoDadoErrado;
	...
	public String getConteudoDadoErrado() {
		return conteudoDadoErrado;
	}

	public void setConteudoDadoErrado(String conteudoDadoErrado) {
		this.conteudoDadoErrado = conteudoDadoErrado;
	}
