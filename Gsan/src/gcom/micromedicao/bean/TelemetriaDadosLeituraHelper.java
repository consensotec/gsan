...
public class TelemetriaDadosLeituraHelper implements Serializable {
	...
	private List<TelemetriaMovReg> listRegistros;
	private boolean houveErro = false;
	private int qtdRegistros = 0;

	public List<TelemetriaMovReg> getListRegistros() {
		return listRegistros;
	}
	public void setListRegistros(List<TelemetriaMovReg> listRegistros) {
