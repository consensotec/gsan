		...
		if (imoveisPorRota != null && !imoveisPorRota.isEmpty()) {
			...
			while (imovelporRotaIterator.hasNext()) {
				...
				if (arrayImoveis[50] != null) {
					ligacaoAgua.setDataLigacao((Date) arrayImoveis[50]);
				}
				
				if (arrayImoveis[51] != null) {
					ligacaoAgua.setDataReligacao((Date) arrayImoveis[51]);
				}
				
				if (arrayImoveis[52] != null) {
					ligacaoAgua.setDataRestabelecimentoAgua((Date) arrayImoveis[52]);
				}
