...
public class Leiturista extends ObjetoTransacao implements Comparable<Leiturista>{
	...
	public int compareTo(Leiturista o) {
		
		String nomeLocal ="";
		
		if ( this.getCliente() != null )
			nomeLocal = this.getCliente().getNome();
		else
			nomeLocal = this.getFuncionario().getNome();
		
		String nomeObjeto ="";
		
		if ( o.getCliente() != null )
			nomeObjeto = o.getCliente().getNome();
		else
			nomeObjeto = o.getFuncionario().getNome();		
		
		return nomeLocal.compareTo( nomeObjeto );
	}
}