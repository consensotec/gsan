 ...
 * @date 17/08/2006
 */
public class PesquisarFiscalizarOSEncerradaAcompanhamentoHelper {
	
	private static final long serialVersionUID = 1L;
	
	
	private String idFiscalizarOSAcompanhamento = null;

	private String dsEndereco = null;
	
	private String idOsAs = null;
	
	private Integer idRA= null;
	...
	public PesquisarFiscalizarOSEncerradaAcompanhamentoHelper() {
	}
	...
	public String getIdOsAs() {
		return idOsAs;
	}


	public void setIdOsAs(String idOsAs) {
		this.idOsAs = idOsAs;
	}
