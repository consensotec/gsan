 ...
 * @date 12/07/2013
 */
public class OcorrenciaOperacionalHelper {
	...
	private String reprogramacao;
	
	private String areaAfetada;
	
	public OcorrenciaOperacionalHelper(){}
	...
	public String getReprogramacao() {
		return reprogramacao;
	}

	public void setReprogramacao(String reprogramacao) {
		this.reprogramacao = reprogramacao;
	}
