...
/**
 * FiltroArquivoProcedimentoOperacionalPadrao 
 * @author Amélia Pessoa
 * @date 09/12/2011
 */
public class FiltroArquivoProcedimentoOperacionalPadrao extends Filtro implements Serializable {
		
	private static final long serialVersionUID = 1L;
	
	public FiltroArquivoProcedimentoOperacionalPadrao() {  }

    /**
     * Constructor for the FiltroArquivoProcedimentoOperacionalPadrao object
     * @param campoOrderBy
     *            Description of the Parameter
     */
    public FiltroArquivoProcedimentoOperacionalPadrao(String campoOrderBy) {
    ...
    public final static String ARQUIVO = "arquivo";
