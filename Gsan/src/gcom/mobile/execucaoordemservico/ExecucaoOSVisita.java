...
public class ExecucaoOSVisita extends ObjetoTransacao {
    ...
    /** full constructor */
    public ExecucaoOSVisita(ArquivoTextoOSCobranca arquivoTextoOSCobranca, OrdemServico ordemServico, Date ultimaAlteracao) {
        this.arquivoTextoOSCobranca = arquivoTextoOSCobranca;
        this.ordemServico = ordemServico;
        this.ultimaAlteracao = ultimaAlteracao;
    }
    
    public ExecucaoOSVisita( Integer idArquivoTexto, String linha ) {
