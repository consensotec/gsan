...
public class ExecucaoOSSituacoesEncontradas extends ObjetoTransacao {
    ...
    /** full constructor */
    public ExecucaoOSSituacoesEncontradas(ArquivoTextoOSCobranca arquivoTextoOSCobranca,
    		OrdemServico ordemServico, FiscalizacaoSituacao fiscalizacaoSituacao, Date ultimaAlteracao) {
    ...
    public ExecucaoOSSituacoesEncontradas( Integer idArquivoTexto, String linha ) {
        ...
        FiscalizacaoSituacao fs = new FiscalizacaoSituacao();
        fs.setId( new Integer( colunas[2] ) );
        this.fiscalizacaoSituacao = fs;
        
        this.setUltimaAlteracao( new Date() );
    }

    /** default constructor */
    public ExecucaoOSSituacoesEncontradas() {
    }
