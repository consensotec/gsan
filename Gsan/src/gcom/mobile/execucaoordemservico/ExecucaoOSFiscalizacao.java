...
public class ExecucaoOSFiscalizacao extends ObjetoTransacao {
    ...
    /** full constructor */
    public ExecucaoOSFiscalizacao(ArquivoTextoOSCobranca arquivoTextoOSCobranca, OrdemServico ordemServico, DocumentoTipo documentoTipo, Date ultimaAlteracao) {
    ...
    public ExecucaoOSFiscalizacao( Integer idArquivoTexto, String linha ) {
    	String[] colunas = linha.split( "\\|" );
        
        Integer idOs = Integer.parseInt( colunas[1] );
        Integer idDocumentoTipo = Integer.parseInt( colunas[2] );
        ...
        this.setDocumentoTipo(documentoTipo);    
