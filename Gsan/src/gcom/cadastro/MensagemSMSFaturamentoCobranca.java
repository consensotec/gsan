...
public class MensagemSMSFaturamentoCobranca implements Serializable {		private static final long serialVersionUID = 1L;
	public final static int DOC_GERADO = 0;
	public final static int INVALIDO = 1;
	public final static int TRANSMITIDO = 2;
	public final static int ERRO_OPERADORA = 3;
	public final static int ENVIADO = 4;
	...
	private SMSSequenciaEnvio smsSequenciaEnvio;
	...
	public SMSSequenciaEnvio getSmsSequenciaEnvio() {
		return smsSequenciaEnvio;
	}
	public void setSmsSequenciaEnvio(SMSSequenciaEnvio smsSequenciaEnvio) {
		this.smsSequenciaEnvio = smsSequenciaEnvio;
	}
