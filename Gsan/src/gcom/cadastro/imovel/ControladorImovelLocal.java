...
public interface ControladorImovelLocal extends javax.ejb.EJBLocalObject {
	...
	public void transferirImovel(Imovel imovel,Usuario usuario, String tipoTransferencia) throws ControladorException;
...
//	
	 ...
	 * @throws ControladorException
	 */
	public Boolean verificarPermissaoGrandeCorporativoCliente(ImovelPerfil imovelPerfil, Usuario usuario) throws ControladorException;
	 ...
	 * 
	 * Este método pesquisa a situação do arquivo de texto do roteiro
	 ...
	 * @throws ErroRepositorioException
	 */
	public Integer alterarSituacaoAguaParaLigado(Imovel imovelGsan,Usuario usuario, Integer ligacaoAguaSituacaoAtual, Integer fiscalizacaoSituacao) 
