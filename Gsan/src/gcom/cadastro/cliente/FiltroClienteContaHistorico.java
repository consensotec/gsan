 ...
 * @date 10/05/2006
 */
public class FiltroClienteContaHistorico extends Filtro implements Serializable {
	
	private static final long serialVersionUID = 1L;
	/**
	 * Constructor for the FiltroClienteConta object
	 */
	public FiltroClienteContaHistorico() {
	}
	 ...
	 */
	public FiltroClienteContaHistorico(String campoOrderBy) {
	...
	public final static String CONTA_ID = "contaHistorico";
	
	public final static String CONTA = "contaHistorico";
