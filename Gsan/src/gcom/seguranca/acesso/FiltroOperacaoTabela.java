...
public class FiltroOperacaoTabela extends Filtro implements Serializable {
    ...
    public static final String TABELA_ID = "tabela.id";
    
    public static final String TABELA = "tabela";
    
    public static final String TABELA_COLUNAS = "tabela.tabelaColunas";
    
    public static final String OPERACAO = "operacao";
    
    public static final String OPERACAO_ARGUMENTO_ID = "operacao.argumentoPesquisa.id";
    
    public static final String OPERACAO_DESCRICAO = "operacao.descricao";
}
