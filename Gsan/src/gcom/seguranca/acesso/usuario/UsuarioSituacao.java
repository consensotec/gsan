...
public class UsuarioSituacao extends ObjetoTransacao implements Serializable {
	...
	public static final Integer ATIVO = new Integer(1);
	public static final Integer PENDENTE_SENHA = new Integer(2);
	public static final Integer SENHA_BLOQUEADA = new Integer(3);
	public static final Integer INATIVO = new Integer(4);
