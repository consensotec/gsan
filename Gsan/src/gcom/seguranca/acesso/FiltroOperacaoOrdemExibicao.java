...
public class FiltroOperacaoOrdemExibicao extends Filtro implements Serializable {
    ...
    public static final String OPERACAO_ID = "operacao.id";

    public static final String TABELA_COLUNA = "tabelaColuna";
    
    public static final String TABELA_COLUNA_TABELA = "tabelaColuna.tabela";
    
    public static final String TABELA_COLUNA_TABELA_ID = "tabelaColuna.tabela.id";
    
    public static final String TABELA_COLUNA_ID = "tabelaColuna.id";
}
