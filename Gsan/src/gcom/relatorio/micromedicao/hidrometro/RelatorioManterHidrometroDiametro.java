...
//		Integer idFuncionalidadeIniciada = this.getIdFuncionalidadeIniciada();
		...
		if (colecaoHidrometrosDiametro != null && !colecaoHidrometrosDiametro.isEmpty()) {
			...
			for (HidrometroDiametro hidrometroDiametro : colecaoHidrometrosDiametro) {
				...
				RelatorioManterHidrometroDiametroBean bean = new RelatorioManterHidrometroDiametroBean();

				// Código
				if(hidrometroDiametro.getId() != null){
					bean.setCodigo(hidrometroDiametro.getId().toString());
				}

				// Descrição
				if(hidrometroDiametro.getDescricao() != null){
					bean.setDescricao(hidrometroDiametro.getDescricao());
				}

				// Descrição Abreviada
				if(hidrometroDiametro.getDescricaoAbreviada() != null){
					bean.setDescricaoAbreviada(hidrometroDiametro.getDescricaoAbreviada());
				}
				
				// Valor Cobrado Por Depreciação
				if(hidrometroDiametro.getValorCobradoPorDepreciacao() != null){
					bean.setValorCobradoPorDepreciacao(hidrometroDiametro.getValorCobradoPorDepreciacao().toString());
				}

				// Indicador de Uso
				if(hidrometroDiametro.getIndicadorUso() != null){
					bean.setIndicadorUso(ativoInativo);
				}
		...
		if(hidrometroDiametroParametros.getDescricao() != null){
		parametros.put("descricao", hidrometroDiametroParametros.getDescricao());
		}
		if(hidrometroDiametroParametros.getDescricaoAbreviada() != null){
		parametros.put("descricaoAbreviada", hidrometroDiametroParametros.getDescricaoAbreviada());
		}
		if(hidrometroDiametroParametros.getNumeroOrdem() != null){
