...
public class RelatorioResumoDadosCasBean implements RelatorioBean{
	...
	private BigDecimal valorPendenciaVencido;
	private BigDecimal valorPendenciaAVencer;
	...
	public BigDecimal getValorPendenciaVencido() {
		return valorPendenciaVencido;
	}
	public void setValorPendenciaVencido(BigDecimal valorPendenciaVencido) {
		this.valorPendenciaVencido = valorPendenciaVencido;
	}
	public BigDecimal getValorPendenciaAVencer() {
		return valorPendenciaAVencer;
	}
	public void setValorPendenciaAVencer(BigDecimal valorPendenciaAVencer) {
		this.valorPendenciaAVencer = valorPendenciaAVencer;
	}
