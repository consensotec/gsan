 ...
 * @date 21/12/2011
 */
public class RelatorioContasNaoImpressasBean implements RelatorioBean {
	...
	public RelatorioContasNaoImpressasBean(RelatorioContasNaoImpressasHelper helper) {
		this.mesAnoReferencia = Util.formatarAnoMesParaMesAno(helper.getMesAnoReferencia());
		this.conta = helper.getConta().toString();
		this.imovel = helper.getImovel().toString();
		this.inscricaoImovel = helper.getInscricaoImovel();
		this.cliente = helper.getCliente();
		this.anormalidadeLeitura = helper.getAnormalidadeLeitura();
