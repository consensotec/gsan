...
public class ConstantesRelatorios {
	...
	public static final String RELATORIO_GRANDES_CLIENTES_CORPORATIVO = "/relatorioClientesEspeciais.jasper";
	...
	public static final String RELATORIO_NOVOS_LOGRADOUROS = "/relatorioNovosLogradouros.jasper";
	...
	public static final String RELATORIO_RESUMO_SITUACAO_IMOVEIS_ANALISTA_CADASTRADOR = "/relatorioResumoSituacaoImoveisAnalistaCadastrador.jasper";
	
	public static final String RELATORIO_MENSAGENS_PENDENTES_CADASTRADOR= "/relatorioQuantitativoMensagensPendentesPorCadastrador.jasper";
	
	public static final String RELATORIO_QUANTITATIVO_MENSAGENS_PENDENTES = "/relatorioQuantitativoMensagensPendentes.jasper";
	
	public static final String RELATORIO_RESUMO_POSICAO_ATUALIZACAO_CADASTRAL = "/relatorioResumoPosicaoAtualizacaoCadastral.jasper";

	public static final String RELATORIO_RESUMO_IMOVEIS_INCONSISTENTES_COM_OCORRENCIA = "/relatorioResumoImoveisInconsistentesComOcorrencia.jasper";
	
	public static final String RELATORIO_IMOVEIS_INCONSISTENTES_COM_OCORRENCIA = "/relatorioImoveisInconsistentesComOcorrencia.jasper";
	
	public static final String RELATORIO_IMOVEIS_NOVOS_INCONSISTENTES = "/relatorioImoveisNovosInconsistentes.jasper";
	
	public static final String RELATORIO_CONSULTA_IMOVEL_PRE_GSAN = "/relatorioConsultaImovelPreGsan.jasper";
	
	public static final String RELATORIO_IMOVEIS_INCONSISTENTES_MOVIMENTO = "/relatorioImoveisInconsistentesMovimento.jasper";
	
	public static final String RELATORIO_FILTRO_PARAMETRO_SISTEMA_NOVO = "/relatorioFiltroParametroSistemaNovo.jasper";
	
	public static final String RELATORIO_FILTRO_CONTRATO_ADESAO = "/relatorioFiltroContratoAdesao.jasper";
	
	public static final String RELATORIO_COMUNICADO_CONTA = "/relatorioComunicadoConta.jasper";
	
	public static final String RELATORIO_CONSULTAR_DEBITOS_RESPONSAVEL = "/relatorioConsultarDebitosResumoResponsavel.jasper";
	
	public static final String RELATORIO_HIDROMETRO_FAIXA_IDADE_SINTETICO = "/relatorioHidrometroFaixaIdadeSintetico.jasper";
	
	public static final String RELATORIO_HIDROMETRO_POR_FAIXA_IDADE_ANALITICO = "/relatorioHidrometroPorIdadeAnalitico.jasper";
