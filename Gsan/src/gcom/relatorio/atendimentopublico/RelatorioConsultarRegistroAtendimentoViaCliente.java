 ...
 */
public class RelatorioConsultarRegistroAtendimentoViaCliente extends TarefaRelatorio {
	private static final long serialVersionUID = 1L;
	public RelatorioConsultarRegistroAtendimentoViaCliente(Usuario usuario) {
		super(usuario,
	...
	public Object executar() throws TarefaException {
		...
		retorno = gerarRelatorio(
				ConstantesRelatorios.RELATORIO_CONSULTAR_REGISTRO_ATENDIMENTO_VIA_CLIENTE,
				parametros, ds, tipoFormatoRelatorio);
		
		// ------------------------------------
		// Grava o relatório no sistema
		try {
			persistirRelatorioConcluido(retorno, Relatorio.CONSULTAR_REGISTRO_ATENDIMENTO_VIA_CLIENTE,
	...
	public void agendarTarefaBatch() {
		AgendadorTarefas.agendarTarefa("RelatorioConsultarRegistroAtendimentoViaCliente", this);
	}
}