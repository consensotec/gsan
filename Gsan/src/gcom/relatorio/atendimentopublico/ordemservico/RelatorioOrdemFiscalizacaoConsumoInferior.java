 ...
 * 
 */
public class RelatorioOrdemFiscalizacaoConsumoInferior extends TarefaRelatorio {

	private static final long serialVersionUID = 1L;
	public RelatorioOrdemFiscalizacaoConsumoInferior(Usuario usuario) {
		super(usuario, ConstantesRelatorios.RELATORIO_ORDEM_FISCALIZACAO_CONSUMO_INFERIOR);
	}
...
//		 ------------------------------------
		...
		RelatorioOrdemFiscalizacaoConsumoInferiorBean bean = (RelatorioOrdemFiscalizacaoConsumoInferiorBean) fachada.gerarRelatorioOrdemFiscalizacaoConsumoInferior(
		...
		retorno = gerarRelatorio(ConstantesRelatorios.RELATORIO_ORDEM_FISCALIZACAO_CONSUMO_INFERIOR,
