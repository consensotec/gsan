 ...
 * 
 */
public class RelatorioOrdemFiscalizacaoConsumoSuperiorBean implements RelatorioBean {
	...
	public RelatorioOrdemFiscalizacaoConsumoSuperiorBean() {
		super();
	}

	public RelatorioOrdemFiscalizacaoConsumoSuperiorBean(String sequencial, String ordemServico,
