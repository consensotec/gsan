 ...
 * 
 */
public class RelatorioOrdemFiscalizacaoConsumoInferiorBean implements RelatorioBean {
	...
	public RelatorioOrdemFiscalizacaoConsumoInferiorBean() {
		super();
	}

	public RelatorioOrdemFiscalizacaoConsumoInferiorBean(String sequencial, String ordemServico,
