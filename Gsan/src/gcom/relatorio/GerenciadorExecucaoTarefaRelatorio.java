...
public class GerenciadorExecucaoTarefaRelatorio {
	...
	public static RelatorioProcessado analisarExecucao(
		...
		tarefaRelatorio.setTipoTarefa(tipoTarefa);
	...
	public static int obterProcessoRelatorio(String nomeRelatorio) {
		...
		} else if (nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_GRANDES_CLIENTES_CORPORATIVO)) {
    	...
    	}  else if(nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_HIDROMETRO_FAIXA_IDADE_SINTETICO)){
    		retornoCodigoProcesso =  Processo.GERAR_RELATORIO_HIDROMETRO_FAIXA_IDADE_SINTETICO;
    		
    	} else if(nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_HIDROMETRO_POR_FAIXA_IDADE_ANALITICO)){
    		retornoCodigoProcesso =  Processo.GERAR_RELATORIO_HIDROMETRO_POR_FAIXA_IDADE_ANALITICO;
    		
    	} else if(nomeRelatorio.equals(ConstantesRelatorios.RELATORIO_ENQUADRAMENTO_DESENQUADRAMENTO_GRANDE_CLIENTE_CORPORATIVO)){
    		retornoCodigoProcesso = Processo.RELATORIO_ACOMPANHAMENTO_GRANDES_CLIENTE;
    	}
