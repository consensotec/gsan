...
public class RelatorioAnaliticoPrevisaoPagamentoCartaoCredito extends TarefaRelatorio {
	
	private static final long serialVersionUID = 1L;
	
	public RelatorioAnaliticoPrevisaoPagamentoCartaoCredito(Usuario usuario) {
		super(usuario,
				ConstantesRelatorios.RELATORIO_ANALITICO_PREVISAO_PAGAMENTO_CARTAO_CREDITO);				
	}	
	...
	public Object executar() throws TarefaException {
		...
		Collection<RelatorioAnaliticoPrevisaoPagamentoCartaoCreditoBean> colecaoRelatorioBean = null;
		colecaoRelatorioBean = (Collection<RelatorioAnaliticoPrevisaoPagamentoCartaoCreditoBean>) fachada.obterRelatorioAnaliticoPrevisaoPagamentoCartaoCredito(dataVencimentoInicial, dataVencimentoFinal, idCliente);
		...
		try {
			persistirRelatorioConcluido(retorno,
					Relatorio.RELATORIO_ANALITICO_PREVISAO_PAGAMENTO_CARTAO_CREDITO,
