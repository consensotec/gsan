...
public class RelatorioExtratoDebitoCliente extends TarefaRelatorio {
	...
	private Collection<RelatorioExtratoDebitoClienteBean> inicializarBeanRelatorio(
			...
			while (iteratorDebitoACobrar.hasNext()) {
				...
				if(debitoACobrar.getParcelamento() != null){
					...
					RelatorioExtratoDebitoClienteServicosDetailBean relatorioExtratoDebitoClienteServicosDetailBean = 
						new RelatorioExtratoDebitoClienteServicosDetailBean(descricaoServico,referenciaServico,parcelasServico,valorServico, "", null);
					colecaoServicosDetailBean.add(relatorioExtratoDebitoClienteServicosDetailBean);
		...
		if(colecaoGuiaPagamentoValores != null && !colecaoGuiaPagamentoValores.isEmpty()){
			...
			while (iteratorGuiaPagamento.hasNext()) {
				...
				if ( indicadorIncluirAcrescimosImpontualidade != null && indicadorIncluirAcrescimosImpontualidade.equals(CobrancaDocumento.INCLUIR_ACRESCIMOS) ) {
					valorAcrescimoImpontualidade = Util.formatarMoedaReal(guiaPagamentoValoresHelper.getValorAcrescimosImpontualidade());		
				}
				
				RelatorioExtratoDebitoClienteServicosDetailBean relatorioExtratoDebitoClienteServicosDetailBean = 
					new RelatorioExtratoDebitoClienteServicosDetailBean(descricaoServico,
							referenciaServico,parcelasServico,valorServico,vencimentoServico, valorAcrescimoImpontualidade);
				colecaoServicosDetailBean.add(relatorioExtratoDebitoClienteServicosDetailBean);
		...
		if(!descricaoServicoParcelamento.equalsIgnoreCase("")){
			...
			RelatorioExtratoDebitoClienteServicosDetailBean relatorioExtratoDebitoClienteServicosDetailBean = 
				new RelatorioExtratoDebitoClienteServicosDetailBean(descricaoServicoParcelamento,
						...
						Util.formatarMoedaReal(valorServicoParcelamento),"", null);
			colecaoServicosDetailBean.add(relatorioExtratoDebitoClienteServicosDetailBean);
	...
	public Object executar() throws TarefaException {
		...
		String extratoGuiaCliente = (String) getParametro("extratoGuiaCliente");
		...
		String indicadorIncluirAcrescimosImpontualidade = (String) getParametro("indicadorIncluirAcrescimosImpontualidade");
		...
		Collection<RelatorioExtratoDebitoClienteBean> colecaoBean = this
				...
				sistemaParametro,valorTotalContasBigDecimal, indicadorIncluirAcrescimosImpontualidade);
		...
		parametros.put("extratoGuiaCliente", extratoGuiaCliente);
