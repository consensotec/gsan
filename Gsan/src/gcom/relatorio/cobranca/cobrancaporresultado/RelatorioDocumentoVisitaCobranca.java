	    	...
	    	while(iterator.hasNext()) {
				...
				if(sistemaParametro.getResolucaoDiretoria() != null){
					...
					ObterOpcoesDeParcelamentoHelper helper = new ObterOpcoesDeParcelamentoHelper(
							...
							imovel.getId(), 
							new BigDecimal("0.00"), 
							new Integer("3"),// new Integer(consultarDebitoImovelActionForm.getLigacaoAguaId()), 
							new Integer("1"),// new Integer(consultarDebitoImovelActionForm.getLigacaoEsgotoId()), 
							imovelPerfil.getId(), 
							"01/0001", 
