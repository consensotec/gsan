		...
		if (colecaoCobrancaAcaoAtividade != null){
			for (Iterator colecaoCobrancaAcaoAtividadeIterator = colecaoCobrancaAcaoAtividade.iterator(); colecaoCobrancaAcaoAtividadeIterator
				...
				if (cobrancaAcaoAtividadeComando.getQuantidadeSmsGerados() != null) {
					bean.setQtdSmsGerados(cobrancaAcaoAtividadeComando.getQuantidadeSmsGerados().toString());
				}
				if (cobrancaAcaoAtividadeComando.getQuantidadeSmsEnviados() != null) {
					bean.setQtdSmsEnviados(cobrancaAcaoAtividadeComando.getQuantidadeSmsEnviados().toString());
				}
				if (cobrancaAcaoAtividadeComando.getQuantidadeEmailGerados() != null) {
					bean.setQtdEmailGerados(cobrancaAcaoAtividadeComando.getQuantidadeEmailGerados().toString());
				}
				if (cobrancaAcaoAtividadeComando.getQuantidadeEmailEnviados() != null) {
					bean.setQtdEmailEnviados(cobrancaAcaoAtividadeComando.getQuantidadeEmailEnviados().toString());
				}
