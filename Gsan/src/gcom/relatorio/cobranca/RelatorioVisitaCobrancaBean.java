...
public class RelatorioVisitaCobrancaBean implements RelatorioBean {
	...
	private ArrayList arrayRelatorioVisitaCobrancaMotivosEncerramentoBean;
	...
	public RelatorioVisitaCobrancaBean(String inscricao, String nomeClienteUsuario, String grupo,
			...
			String sequencialDocumentoCobranca, String enderecoImovel, String hidrometro,
			RelatorioDocumentoCobrancaMotivosEncerramentoBean relatorioVisitaCobrancaMotivosEncerramentoBean) {
		super();
		...
		this.arrayRelatorioVisitaCobrancaMotivosEncerramentoBean = new ArrayList();
		this.arrayRelatorioVisitaCobrancaMotivosEncerramentoBean.add(relatorioVisitaCobrancaMotivosEncerramentoBean);
		this.arrayJRMotivosBean = new JRBeanCollectionDataSource(this.arrayRelatorioVisitaCobrancaMotivosEncerramentoBean);
	}
	...
	public ArrayList getArrayRelatorioVisitaCobrancaMotivosEncerramentoBean() {
		return arrayRelatorioVisitaCobrancaMotivosEncerramentoBean;
	}

	public void setArrayRelatorioVisitaCobrancaMotivosEncerramentoBean(
			ArrayList arrayRelatorioVisitaCobrancaMotivosEncerramentoBean) {
		this.arrayRelatorioVisitaCobrancaMotivosEncerramentoBean = arrayRelatorioVisitaCobrancaMotivosEncerramentoBean;
	}
	public void setRelatorioVisitaCobrancaMotivosEncerramentoBean(Collection<RelatorioDocumentoCobrancaMotivosEncerramentoBean> colecaoRelatorioVisitaCobrancaMotivosEncerramentoBean) {
		this.arrayRelatorioVisitaCobrancaMotivosEncerramentoBean = new ArrayList();
		this.arrayRelatorioVisitaCobrancaMotivosEncerramentoBean.addAll(colecaoRelatorioVisitaCobrancaMotivosEncerramentoBean);
		this.arrayJRMotivosBean = new JRBeanCollectionDataSource(this.arrayRelatorioVisitaCobrancaMotivosEncerramentoBean);
	}
